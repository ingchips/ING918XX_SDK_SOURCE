...
1. Frequency Offset Tunning (not available on ING918)

    1. Download this example to a device (or dev-board);
    2. Start Frequency Offset Tester from Wizard;
    3. Use RF Test Tool to control the device to send test signal
