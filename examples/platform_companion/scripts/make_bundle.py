...
print(f"""Note: If you are using customized RTOS (i.e. not using built-in RTOS in ROM),
you have to use `update_for_rtos.py` to update `platform.bin` generated by this script.""")
