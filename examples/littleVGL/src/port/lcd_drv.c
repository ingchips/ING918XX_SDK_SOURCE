...
void lcd_init()
{
    ...
    static const uint8_t init[] = {
        ...
        0xC5,  1, 0x1F,
        0xE0,  7, 0x02, 0x1C, 0x07, 0x12, 0x37, 0x32, 0x29,
        0xE1,  7, 0x03, 0x1D, 0x07, 0x06, 0x2E, 0x2C, 0x29,
...
void lcd_init(void)
{
    ...
    static const uint8_t init[] = {
        ...
        0x3A,  1, 0x05,
        0xC5,  1, 0x1A,
        0x36,  1,// 0x8 240*240 0x68 240*320 
#if (DISPLAY_HORIZONTAL)
        0x68,
#else
        0x08,
...
#elif (SPI_LCD_DRIVER == LCD_DRIVER_ILI9341)
