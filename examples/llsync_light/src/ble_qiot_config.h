...
// timestamp
#define BLE_QIOT_LOG_PRINT(...) platform_printf(__VA_ARGS__)

// some sdk info needs to stored on the device and the address is up to you
#define BLE_QIOT_RECORD_FLASH_ADDR     0x42000
#define BLE_QIOT_RECORD_FLASH_PAGESIZE 8192     // flash page size, see chip datasheet
#define BLE_QIOT_RECORD_FLASH_PAGENUM  1        // how many pages qiot use
