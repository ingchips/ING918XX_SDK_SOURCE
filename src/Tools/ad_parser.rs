...
#[test]
fn bindgen_test_layout_ad_context() {
    assert_eq!(
        ::core::mem::size_of::<ad_context>(),
        16usize,
        concat!("Size of: ", stringify!(ad_context))
    );
    assert_eq!(
        ::core::mem::align_of::<ad_context>(),
        8usize,
        concat!("Alignment of ", stringify!(ad_context))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ad_context>())).data as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ad_context),
            "::",
            stringify!(data)
        )
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ad_context>())).offset as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ad_context),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ad_context>())).length as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(ad_context),
...
extern "C" {
    pub fn ad_iterator_init(context: *mut ad_context_t, ad_len: u16, ad_data: *const u8);
}
extern "C" {
    pub fn ad_iterator_has_more(context: *mut ad_context_t) -> cty::c_int;
}
extern "C" {
    pub fn ad_iterator_next(context: *mut ad_context_t);
}
extern "C" {
    pub fn ad_iterator_get_data_type(context: *mut ad_context_t) -> u8;
}
extern "C" {
    pub fn ad_iterator_get_data_len(context: *mut ad_context_t) -> u8;
}
extern "C" {
    pub fn ad_iterator_get_data(context: *mut ad_context_t) -> *const u8;
}
extern "C" {
    pub fn ad_data_contains_uuid16(ad_len: u16, ad_data: *const u8, uuid: u16) -> cty::c_int;
}
extern "C" {
    pub fn ad_data_contains_uuid128(
        ad_len: u16,
        ad_data: *const u8,
        uuid128: *const u8,
    ) -> cty::c_int;
...
extern "C" {
    pub fn ad_data_from_type(
        ad_len: u16,
        ad_data: *mut u8,
        ad_type: u8,
        found_length: *mut u16,
    ) -> *const u8;
}
