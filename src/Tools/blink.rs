...
pub const blink_style_t_BLINK_ON: blink_style_t = 0;
pub const blink_style_t_BLINK_OFF: blink_style_t = 1;
pub const blink_style_t_BLINK_SINGLE: blink_style_t = 2;
pub const blink_style_t_BLINK_FAST: blink_style_t = 3;
pub const blink_style_t_BLINK_NORMAL: blink_style_t = 4;
pub const blink_style_t_BLINK_SLOW: blink_style_t = 5;
pub const blink_style_t_BLINK_MORSE_A: blink_style_t = 6;
pub const blink_style_t_BLINK_MORSE_D: blink_style_t = 7;
pub const blink_style_t_BLINK_MORSE_E: blink_style_t = 8;
pub const blink_style_t_BLINK_MORSE_I: blink_style_t = 9;
pub const blink_style_t_BLINK_MORSE_K: blink_style_t = 10;
pub const blink_style_t_BLINK_MORSE_M: blink_style_t = 11;
pub const blink_style_t_BLINK_MORSE_N: blink_style_t = 12;
pub const blink_style_t_BLINK_MORSE_O: blink_style_t = 13;
pub const blink_style_t_BLINK_MORSE_R: blink_style_t = 14;
pub const blink_style_t_BLINK_MORSE_S: blink_style_t = 15;
pub const blink_style_t_BLINK_MORSE_T: blink_style_t = 16;
pub const blink_style_t_BLINK_MORSE_U: blink_style_t = 17;
pub const blink_style_t_BLINK_MORSE_W: blink_style_t = 18;
pub type blink_style_t = u32;
extern "C" {
    pub fn blink_style(pwm_channel_index: u8, style: blink_style_t);
}
extern "C" {
    pub fn blink_lightness(pwm_channel_index: u8, lightness: u8);
}
