...
pub const OTA_CTRL_START: u32 = 170;
pub const OTA_CTRL_PAGE_BEGIN: u32 = 176;
pub const OTA_CTRL_PAGE_END: u32 = 177;
pub const OTA_CTRL_READ_PAGE: u32 = 192;
pub const OTA_CTRL_REBOOT: u32 = 255;
pub const OTA_STATUS_DISABLED: u32 = 0;
pub const OTA_STATUS_OK: u32 = 1;
pub const OTA_STATUS_ERROR: u32 = 2;
...
#[derive(Debug, Copy, Clone)]
pub struct prog_ver {
    pub major: cty::c_short,
    pub minor: cty::c_char,
    pub patch: cty::c_char,
}
#[test]
fn bindgen_test_layout_prog_ver() {
    assert_eq!(
        ::core::mem::size_of::<prog_ver>(),
        4usize,
        concat!("Size of: ", stringify!(prog_ver))
    );
    assert_eq!(
        ::core::mem::align_of::<prog_ver>(),
        2usize,
        concat!("Alignment of ", stringify!(prog_ver))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<prog_ver>())).major as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(prog_ver),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<prog_ver>())).minor as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(prog_ver),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<prog_ver>())).patch as *const _ as usize },
        3usize,
        concat!(
            "Offset of field: ",
            stringify!(prog_ver),
...
pub type prog_ver_t = prog_ver;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ota_ver {
    pub platform: prog_ver_t,
    pub app: prog_ver_t,
}
#[test]
fn bindgen_test_layout_ota_ver() {
    assert_eq!(
        ::core::mem::size_of::<ota_ver>(),
        8usize,
        concat!("Size of: ", stringify!(ota_ver))
    );
    assert_eq!(
        ::core::mem::align_of::<ota_ver>(),
        2usize,
        concat!("Alignment of ", stringify!(ota_ver))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ota_ver>())).platform as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ota_ver),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ota_ver>())).app as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(ota_ver),
...
pub type ota_ver_t = ota_ver;
extern "C" {
    #[doc = "@brief initialize FOTA related GATT service by code"]
    pub fn ota_init_service();
}
extern "C" {
    #[doc = "@brief Tell this module handles used by FOTA service"]
    #[doc = ""]
    #[doc = "   If FOTA related GATT service is *not* initialized by `ota_init_service`, then call this function."]
    pub fn ota_init_handles(handler_ver: u16, handle_ctrl: u16, handle_data: u16);
}
extern "C" {
    pub fn ota_write_callback(
        att_handle: u16,
