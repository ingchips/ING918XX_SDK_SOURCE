...
extern "C" {
    ...
    pub fn att_db_util_init(att_db_storage: *mut u8, db_max_size: i16);
}
extern "C" {
    #[doc = " @brief Add primary service for 16-bit UUID"]
    pub fn att_db_util_add_service_uuid16(uuid16: u16);
}
extern "C" {
    #[doc = " @brief Add primary service for 128-bit UUID"]
    pub fn att_db_util_add_service_uuid128(uuid128: *mut u8);
}
extern "C" {
    #[doc = " @brief Add Characteristic with 16-bit UUID, properties, and data"]
    #[doc = " @returns attribute value handle"]
    #[doc = " @see ATT_PROPERTY_* in ble/att_db.h"]
...
extern "C" {
    pub fn att_db_util_add_descriptor_uuid16(uuid16: u16, flags: u16, data: *mut u8, data_len: u16);
}
extern "C" {
