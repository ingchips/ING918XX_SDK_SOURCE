...
proc RTC_Enable*(flag: uint8) {.importc: "RTC_Enable", header: "peripheral_rtc.h".}
## *
## ***************************************************************************************
...
proc RTC_Current*(): uint32 {.importc: "RTC_Current", header: "peripheral_rtc.h".}
## *
## ***************************************************************************************
...
proc RTC_ClearInt*() {.importc: "RTC_ClearInt", header: "peripheral_rtc.h".}