...
typedef enum
{
    ...
    IO_SOURCE_SPI1_HOLD_OUT                            = 13,
    IO_SOURCE_SPI1_WP_OUT                              = 14,
    IO_SOURCE_UART0_TXD                                = 15,
    IO_SOURCE_UART0_RTS                                = 16,
    IO_SOURCE_UART1_TXD                                = 17,
    IO_SOURCE_UART1_RTS                                = 18,
    IO_SOURCE_I2C0_SCL_OUT                             = 19,
    IO_SOURCE_I2C0_SDA_OUT                             = 20,
    IO_SOURCE_I2S_BCLK_OUT                             = 21,
    IO_SOURCE_I2S_LRCLK_OUT                            = 22,
    IO_SOURCE_I2S_DATA_OUT                             = 23,

    // below PWM outputs are from TIMERs
    IO_SOURCE_TIMER0_PWM0_A                            = 24,
    IO_SOURCE_TIMER0_PWM0_B                            = 25,
    IO_SOURCE_TIMER0_PWM1_A                            = 26,
    IO_SOURCE_TIMER0_PWM1_B                            = 27,
    IO_SOURCE_TIMER1_PWM0_A                            = 28,
    IO_SOURCE_TIMER1_PWM0_B                            = 29,
    IO_SOURCE_TIMER1_PWM1_A                            = 30,
    IO_SOURCE_TIMER1_PWM1_B                            = 31,
    ...
    IO_SOURCE_PWM2_A                                   = 36,
    IO_SOURCE_PWM2_B                                   = 37,
    IO_SOURCE_ANT_SW0                                  = 38,
    IO_SOURCE_ANT_SW1                                  = 39,
    IO_SOURCE_ANT_SW2                                  = 40,
    IO_SOURCE_ANT_SW3                                  = 41,
    IO_SOURCE_ANT_SW4                                  = 42,
    IO_SOURCE_ANT_SW5                                  = 43,
    IO_SOURCE_ANT_SW6                                  = 44,
    IO_SOURCE_ANT_SW7                                  = 45,
    IO_SOURCE_PA_TXEN                                  = 46,
    IO_SOURCE_PA_RXEN                                  = 47,
    IO_SOURCE_KEYSCN_ROW_0                             = 48,
    IO_SOURCE_KEYSCN_ROW_1                             = 49,
    IO_SOURCE_KEYSCN_ROW_2                             = 50,
    IO_SOURCE_KEYSCN_ROW_3                             = 51,
    IO_SOURCE_KEYSCN_ROW_4                             = 52,
    IO_SOURCE_KEYSCN_ROW_5                             = 53,
    IO_SOURCE_KEYSCN_ROW_6                             = 54,
    IO_SOURCE_KEYSCN_ROW_7                             = 55,
    IO_SOURCE_KEYSCN_COL_0                             = 56,
    IO_SOURCE_KEYSCN_COL_1                             = 57,
    IO_SOURCE_KEYSCN_COL_2                             = 58,
    IO_SOURCE_KEYSCN_COL_3                             = 59,
    IO_SOURCE_KEYSCN_COL_4                             = 60,
    IO_SOURCE_KEYSCN_COL_5                             = 61,
    IO_SOURCE_KEYSCN_COL_6                             = 62,
    IO_SOURCE_KEYSCN_COL_7                             = 63,
    IO_SOURCE_KEYSCN_COL_8                             = 64,
    IO_SOURCE_KEYSCN_COL_9                             = 65,
    IO_SOURCE_KEYSCN_COL_10                            = 66,
    IO_SOURCE_KEYSCN_COL_11                            = 67,
    IO_SOURCE_KEYSCN_COL_12                            = 68,
    IO_SOURCE_KEYSCN_COL_13                            = 69,
    IO_SOURCE_KEYSCN_COL_14                            = 70,
    IO_SOURCE_KEYSCN_COL_15                            = 71,
    IO_SOURCE_KEYSCN_COL_16                            = 72,
    IO_SOURCE_KEYSCN_COL_17                            = 73,
    IO_SOURCE_KEYSCN_COL_18                            = 74,
    IO_SOURCE_KEYSCN_COL_19                            = 75,
    IO_SOURCE_KEYSCN_COL_20                            = 76,
    IO_SOURCE_KEYSCN_COL_21                            = 77,
    ...
    IO_SOURCE_QDEC_TIMER_EXT_OUT1_B                    = 82,
    IO_SOURCE_QDEC_TIMER_EXT_OUT2_B                    = 83,
    IO_SOURCE_UART0_SIR                                = 84,
    IO_SOURCE_UART1_SIR                                = 85,
    IO_SOURCE_ASDM_DMIC_MCLK                           = 86,

    // below sources are for input
    IO_SOURCE_SW_DIO                                   = 87,
    IO_SOURCE_SW_CLK                                   = 88,
    IO_SOURCE_SPI0_CLK_IN                              = 89,
    IO_SOURCE_SPI0_CSN_IN                              = 90,
    IO_SOURCE_SPI0_HOLD_IN                             = 91,
    IO_SOURCE_SPI0_WP_IN                               = 92,
    IO_SOURCE_SPI0_MISO_IN                             = 93,
    IO_SOURCE_SPI0_MOSI_IN                             = 94,
    IO_SOURCE_SPI1_CLK_IN                              = 95,
    IO_SOURCE_SPI1_CSN_IN                              = 96,
    IO_SOURCE_SPI1_MISO_IN                             = 97,
    IO_SOURCE_SPI1_MOSI_IN                             = 98,
    IO_SOURCE_SPI1_HOLD_IN                             = 99,
    IO_SOURCE_SPI1_WP_IN                               = 100,
    IO_SOURCE_UART0_RXD                                = 101,
    IO_SOURCE_UART0_CTS                                = 102,
    IO_SOURCE_UART1_RXD                                = 103,
    IO_SOURCE_UART1_CTS                                = 104,
    IO_SOURCE_I2C0_SCL_IN                              = 105,
    IO_SOURCE_I2C0_SDA_IN                              = 106,
    IO_SOURCE_I2S_BCLK_IN                              = 107,
    IO_SOURCE_I2S_LRCLK_IN                             = 108,
    IO_SOURCE_I2S_DATA_IN                              = 109,

    IO_SOURCE_KEYSCN_IN_COL_0                          = 110,
    IO_SOURCE_KEYSCN_IN_COL_1                          = 111,
    IO_SOURCE_KEYSCN_IN_COL_2                          = 112,
    IO_SOURCE_KEYSCN_IN_COL_3                          = 113,
    IO_SOURCE_KEYSCN_IN_COL_4                          = 114,
    IO_SOURCE_KEYSCN_IN_COL_5                          = 115,
    IO_SOURCE_KEYSCN_IN_COL_6                          = 116,
    IO_SOURCE_KEYSCN_IN_COL_7                          = 117,
    IO_SOURCE_KEYSCN_IN_COL_8                          = 118,
    IO_SOURCE_KEYSCN_IN_COL_9                          = 119,
    IO_SOURCE_KEYSCN_IN_COL_10                         = 120,
    IO_SOURCE_KEYSCN_IN_COL_11                         = 121,
    IO_SOURCE_KEYSCN_IN_COL_12                         = 122,
    IO_SOURCE_KEYSCN_IN_COL_13                         = 123,
    IO_SOURCE_KEYSCN_IN_COL_14                         = 124,
    IO_SOURCE_KEYSCN_IN_COL_15                         = 125,
    IO_SOURCE_KEYSCN_IN_COL_16                         = 126,
    IO_SOURCE_KEYSCN_IN_COL_17                         = 127,
    IO_SOURCE_KEYSCN_IN_COL_18                         = 128,
    IO_SOURCE_KEYSCN_IN_COL_19                         = 129,
    IO_SOURCE_KEYSCN_IN_COL_20                         = 130,
    IO_SOURCE_KEYSCN_IN_COL_21                         = 131,
    IO_SOURCE_KEYSCN_IN_ROW_0                          = 132,
    IO_SOURCE_KEYSCN_IN_ROW_1                          = 133,
    IO_SOURCE_KEYSCN_IN_ROW_2                          = 134,
    IO_SOURCE_KEYSCN_IN_ROW_3                          = 135,
    IO_SOURCE_KEYSCN_IN_ROW_4                          = 136,
    IO_SOURCE_KEYSCN_IN_ROW_5                          = 137,
    IO_SOURCE_KEYSCN_IN_ROW_6                          = 138,
    IO_SOURCE_KEYSCN_IN_ROW_7                          = 139,
    IO_SOURCE_QDEC_PHASEA                              = 140,
    IO_SOURCE_QDEC_PHASEB                              = 141,
    IO_SOURCE_QDEC_INDEX                               = 142,
    IO_SOURCE_QDEC_EXT_IN_CLK                          = 143,
    IO_SOURCE_QDEC_TIMER_EXT_IN1_A                     = 144,
    IO_SOURCE_QDEC_TIMER_EXT_IN2_A                     = 145,
    IO_SOURCE_QDEC_TIMER_EXT_IN2_B                     = 146,
    IO_SOURCE_PCAP0_IN                                 = 147,
    IO_SOURCE_PCAP1_IN                                 = 148,
    IO_SOURCE_PCAP2_IN                                 = 149,
    IO_SOURCE_PCAP3_IN                                 = 150,
    IO_SOURCE_PCAP4_IN                                 = 151,
    IO_SOURCE_PCAP5_IN                                 = 152,
    IO_SOURCE_UART0_SIR_IN                             = 153,
    IO_SOURCE_UART1_SIR_IN                             = 154,
    IO_SOURCE_ASDM_DMIC_IN                             = 155,
