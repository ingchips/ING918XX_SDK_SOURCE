...
pub const RTC_ENABLED: u32 = 1;
pub const RTC_DISABLED: u32 = 0;
...
extern "C" {
    #[doc = " @brief Enable RTC module"]
    #[doc = ""]
    #[doc = " @param[in] flag     RTC_ENABLED or RTC_DISABLED"]
    #[doc = ""]
    pub fn RTC_Enable(flag: u8);
}
extern "C" {
    #[doc = " @brief Get current RTC value (lower 32bit)"]
    #[doc = ""]
    #[doc = " @return              Current value"]
    #[doc = ""]
    pub fn RTC_Current() -> u32;
}
extern "C" {
    #[doc = " @brief Get current full RTC value (full 48bit)"]
    #[doc = ""]
    #[doc = " @return              Current value"]
    #[doc = ""]
    pub fn RTC_CurrentFull() -> u64;
}
extern "C" {
    #[doc = " @brief Set timing offset (number of cycles) of next RTC interrupt"]
    #[doc = ""]
    #[doc = " @param[in] offset    Offset in cycles"]
    #[doc = ""]
    pub fn RTC_SetNextIntOffset(offset: u32);
}
extern "C" {
    #[doc = " @brief Clear RTC interrupt status"]
    #[doc = ""]
    pub fn RTC_ClearInt();
}
