 ...
 */
uint8_t DMA_PingPangSetup(DMA_PingPang *PingPang, 
                          SYSCTRL_DMA  srcDev, 
 ...
 */
uint32_t * DMA_PingPangIntProc(DMA_PingPang *PingPang, uint8_t ch);
 ...
 */
uint32_t DMA_PingPangGetTransSize(DMA_PingPang *PingPang);
 ...
 * @param[in] ch                        DMA channel ID(0-7)
 */
void DMA_PingPangEnable(DMA_PingPang *PingPang, uint8_t ch);
 ...
 * @param[in] ch                        DMA channel ID(0-7)
 */
void DMA_PingPangDisable(DMA_PingPang *PingPang, uint8_t ch);
#endif
