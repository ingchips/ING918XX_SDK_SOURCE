...
extern "C" {
    #[doc = " @brief Write a block of data to flash"]
    #[doc = " @param[in] dest_addr         target address (unified address) in flash"]
    #[doc = " @param[in] buffer            buffer to be written"]
    #[doc = " @param[in] size              byte number to be written"]
    #[doc = " @return                      0 if successful else non-0"]
    pub fn program_flash(dest_addr: u32, buffer: *const u8, size: u32) -> cty::c_int;
}
