...
extern struct bt_mesh_gen_model_cli gen_light_hsl_cli;
extern const struct bt_mesh_model_op gen_light_hsl_op[];
#define BT_MESH_MODEL_GEN_LEVEL_CLI(pub) 		\
	BT_MESH_MODEL(BT_MESH_MODEL_ID_GEN_LEVEL_CLI, 	\
		      gen_level_cli_op, NULL, &gen_level_cli)


#define BT_MESH_MODEL_LIGHT_HSL_CLI(pub)    \
	BT_MESH_MODEL(BT_MESH_MODEL_ID_LIGHT_HSL_CLI,	\
		      gen_light_hsl_op, NULL, &gen_light_hsl_cli)
