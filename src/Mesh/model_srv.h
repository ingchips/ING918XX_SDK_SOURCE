...
struct bt_mesh_gen_onoff_srv_cb {
    int (*get)(struct bt_mesh_model *model, u8_t *state, void *user_data);
    int (*set)(struct bt_mesh_model *model, u8_t state, void *user_data);
    void *user_data;
};
...
struct bt_mesh_gen_level_srv_cb {
    int (*get)(struct bt_mesh_model *model, s16_t *level, void *user_data);
    int (*set)(struct bt_mesh_model *model, s16_t level, void *user_data);
    void *user_data;
};
...
struct bt_mesh_light_lightness_srv_cb {
    int (*get)(struct bt_mesh_model *model, u16_t *lightness, void *user_data);
    int (*set)(struct bt_mesh_model *model, u16_t lightness, void *user_data);
    void *user_data;
};
...
struct bt_mesh_light_hsl_srv_cb {
    int (*get)(struct bt_mesh_model *model, u16_t *lightness, u16_t *hue, u16_t *saturation, void *user_data);
    int (*set)(struct bt_mesh_model *model, u16_t  lightness, u16_t  hue, u16_t  saturation, void *user_data);
    void *user_data;
};
