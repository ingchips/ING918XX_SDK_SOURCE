...
type
  ADC_Type* {.importc: "ADC_Type", header: "peripheral_adc.h", bycopy.} = object
...
type
  ADC_Pwr_Ctrl_Type* {.importc: "ADC_Pwr_Ctrl_Type", header: "peripheral_adc.h",
                      bycopy.} = object
...
proc ADC_PowerCtrl*(flag: uint8) {.importc: "ADC_PowerCtrl",
                                header: "peripheral_adc.h".}
## * \brief ADC global enable/disable
##  flag: 1: power on
##        0: power off
##

proc ADC_Enable*(flag: uint8) {.importc: "ADC_Enable", header: "peripheral_adc.h".}
## * \brief ADC reset
##

proc ADC_Reset*() {.importc: "ADC_Reset", header: "peripheral_adc.h".}
...
proc ADC_SetMode*(mode: uint8) {.importc: "ADC_SetMode", header: "peripheral_adc.h".}
...
proc ADC_EnableChannel*(channel_id: uint8; flag: uint8) {.
    importc: "ADC_EnableChannel", header: "peripheral_adc.h".}
proc ADC_ClearChannelDataValid*(channel_id: uint8) {.
    importc: "ADC_ClearChannelDataValid", header: "peripheral_adc.h".}
proc ADC_IsChannelDataValid*(channel_id: uint8): uint8 {.
    importc: "ADC_IsChannelDataValid", header: "peripheral_adc.h".}
proc ADC_ReadChannelData*(channel_id: uint8): uint16 {.
    importc: "ADC_ReadChannelData", header: "peripheral_adc.h".}