...
--define_symbol l2cap_register_fixed_channel=0x0000c5c9
--define_symbol l2cap_register_packet_handler=0x0000c5e5
--define_symbol l2cap_register_service=0x0000c5f1
--define_symbol l2cap_request_can_send_fix_channel_now_event=0x0000c6d5
...
--define_symbol l2cap_send=0x0000caad
--define_symbol l2cap_send_connectionless=0x0000cb25
--define_symbol l2cap_send_connectionless3=0x0000cbb5
--define_symbol l2cap_send_echo_request=0x0000cc4d
--define_symbol l2cap_unregister_service=0x0000cd09
--define_symbol le_device_db_add=0x0000cd61
--define_symbol le_device_db_find=0x0000ce35
--define_symbol le_device_db_from_key=0x0000ce61
--define_symbol le_device_db_iter_cur=0x0000ce69
--define_symbol le_device_db_iter_cur_key=0x0000ce6d
--define_symbol le_device_db_iter_init=0x0000ce71
--define_symbol le_device_db_iter_next=0x0000ce79
--define_symbol le_device_db_remove_key=0x0000ce9f
--define_symbol ll_free=0x0000cecb
--define_symbol ll_hint_on_ce_len=0x0000ced5
--define_symbol ll_legacy_adv_set_interval=0x0000cf0d
--define_symbol ll_malloc=0x0000cf1d
--define_symbol ll_query_timing_info=0x0000d055
--define_symbol ll_scan_set_fixed_channel=0x0000d0f9
--define_symbol ll_set_adv_access_address=0x0000d20d
--define_symbol ll_set_adv_coded_scheme=0x0000d219
--define_symbol ll_set_conn_coded_scheme=0x0000d249
--define_symbol ll_set_conn_latency=0x0000d275
--define_symbol ll_set_conn_tx_power=0x0000d2a5
--define_symbol ll_set_def_antenna=0x0000d2ed
--define_symbol ll_set_initiating_coded_scheme=0x0000d309
--define_symbol ll_set_max_conn_number=0x0000d315
--define_symbol nibble_for_char=0x0001e03d
--define_symbol platform_32k_rc_auto_tune=0x0001e0d9
--define_symbol platform_32k_rc_tune=0x0001e155
--define_symbol platform_calibrate_32k=0x0001e169
--define_symbol platform_config=0x0001e16d
--define_symbol platform_controller_run=0x0001e23d
--define_symbol platform_get_task_handle=0x0001e275
...
--define_symbol platform_init_controller=0x0001e2a1
--define_symbol platform_os_idle_resumed_hook=0x0001e2bd
--define_symbol platform_patch_rf_init_data=0x0001e2c1
--define_symbol platform_post_sleep_processing=0x0001e2cd
--define_symbol platform_pre_sleep_processing=0x0001e2d3
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001e2d9
...
--define_symbol platform_set_irq_callback=0x0001e36d
--define_symbol platform_set_rf_clk_source=0x0001e3a5
--define_symbol platform_set_rf_init_data=0x0001e3b1
--define_symbol platform_set_rf_power_mapping=0x0001e3bd
--define_symbol platform_set_timer=0x0001e3c9
--define_symbol platform_shutdown=0x0001e3cd
--define_symbol platform_switch_app=0x0001e3d1
--define_symbol platform_trace_raw=0x0001e3fd
...
--define_symbol reverse_48=0x0001e7a5
--define_symbol reverse_56=0x0001e7ab
--define_symbol reverse_64=0x0001e7b1
--define_symbol reverse_bd_addr=0x0001e7b7
--define_symbol reverse_bytes=0x0001e7bd
--define_symbol sm_add_event_handler=0x0001ea7d
--define_symbol sm_address_resolution_lookup=0x0001ebd5
--define_symbol sm_authenticated=0x0001ef2d
--define_symbol sm_authorization_decline=0x0001ef3b
--define_symbol sm_authorization_grant=0x0001ef5b
--define_symbol sm_authorization_state=0x0001ef7b
--define_symbol sm_bonding_decline=0x0001ef95
--define_symbol sm_config=0x0001f3b5
--define_symbol sm_config_conn=0x0001f3cd
--define_symbol sm_encryption_key_size=0x0001f583
--define_symbol sm_just_works_confirm=0x0001fa8d
--define_symbol sm_le_device_key=0x0001fdc9
--define_symbol sm_passkey_input=0x0001fe5f
--define_symbol sm_private_random_address_generation_get=0x0002020d
--define_symbol sm_private_random_address_generation_get_mode=0x00020215
--define_symbol sm_private_random_address_generation_set_mode=0x00020221
--define_symbol sm_private_random_address_generation_set_update_period=0x00020249
--define_symbol sm_register_oob_data_callback=0x00020385
--define_symbol sm_request_pairing=0x00020391
--define_symbol sm_send_security_request=0x00020daf
--define_symbol sm_set_accepted_stk_generation_methods=0x00020dd5
--define_symbol sm_set_authentication_requirements=0x00020de1
--define_symbol sm_set_encryption_key_size_range=0x00020ded
--define_symbol sscanf_bd_addr=0x00021149
--define_symbol sysSetPublicDeviceAddr=0x000214b1
--define_symbol uuid128_to_str=0x00021c2d
--define_symbol uuid_add_bluetooth_prefix=0x00021c85
--define_symbol uuid_has_bluetooth_prefix=0x00021ca5
