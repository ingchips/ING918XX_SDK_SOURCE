...
--define_symbol platform_32k_rc_auto_tune=0x0001e0a1
--define_symbol platform_32k_rc_tune=0x0001e11d
--define_symbol platform_calibrate_32k=0x0001e131
--define_symbol platform_config=0x0001e135
--define_symbol platform_controller_run=0x0001e205
--define_symbol platform_get_task_handle=0x0001e23d
--define_symbol platform_get_us_time=0x0001e255
--define_symbol platform_get_version=0x0001e259
--define_symbol platform_hrng=0x0001e261
--define_symbol platform_init_controller=0x0001e269
--define_symbol platform_os_idle_resumed_hook=0x0001e285
--define_symbol platform_patch_rf_init_data=0x0001e289
--define_symbol platform_post_sleep_processing=0x0001e295
--define_symbol platform_pre_sleep_processing=0x0001e29b
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001e2a1
...
--define_symbol platform_set_evt_callback=0x0001e321
--define_symbol platform_set_irq_callback=0x0001e335
--define_symbol platform_set_rf_clk_source=0x0001e36d
--define_symbol platform_set_rf_init_data=0x0001e379
--define_symbol platform_set_rf_power_mapping=0x0001e385
--define_symbol platform_set_timer=0x0001e391
--define_symbol platform_shutdown=0x0001e395
--define_symbol platform_switch_app=0x0001e399
--define_symbol platform_trace_raw=0x0001e3c5
--define_symbol platform_write_persistent_reg=0x0001e3dd
--define_symbol printf_hexdump=0x0001e3ed
--define_symbol reverse_128=0x0001e761
--define_symbol reverse_24=0x0001e767
--define_symbol reverse_48=0x0001e76d
--define_symbol reverse_56=0x0001e773
--define_symbol reverse_64=0x0001e779
--define_symbol reverse_bd_addr=0x0001e77f
--define_symbol reverse_bytes=0x0001e785
--define_symbol sm_add_event_handler=0x0001ea45
--define_symbol sm_address_resolution_lookup=0x0001eb9d
--define_symbol sm_authenticated=0x0001eef5
--define_symbol sm_authorization_decline=0x0001ef03
--define_symbol sm_authorization_grant=0x0001ef23
--define_symbol sm_authorization_state=0x0001ef43
--define_symbol sm_bonding_decline=0x0001ef5d
--define_symbol sm_config=0x0001f37d
--define_symbol sm_config_conn=0x0001f395
--define_symbol sm_encryption_key_size=0x0001f54b
--define_symbol sm_just_works_confirm=0x0001fa55
--define_symbol sm_le_device_key=0x0001fd91
--define_symbol sm_passkey_input=0x0001fe27
...
--define_symbol sm_register_oob_data_callback=0x0002034d
--define_symbol sm_request_pairing=0x00020359
--define_symbol sm_send_security_request=0x00020d77
--define_symbol sm_set_accepted_stk_generation_methods=0x00020d9d
--define_symbol sm_set_authentication_requirements=0x00020da9
--define_symbol sm_set_encryption_key_size_range=0x00020db5
--define_symbol sscanf_bd_addr=0x00021111
--define_symbol sysSetPublicDeviceAddr=0x00021479
--define_symbol uuid128_to_str=0x00021bf5
--define_symbol uuid_add_bluetooth_prefix=0x00021c4d
--define_symbol uuid_has_bluetooth_prefix=0x00021c6d
