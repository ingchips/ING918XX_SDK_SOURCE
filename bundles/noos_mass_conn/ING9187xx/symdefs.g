...
l2cap_max_le_mtu = 0x0000c0c9;
l2cap_max_mtu = 0x0000c0cd;
l2cap_next_local_cid = 0x0000c0d1;
l2cap_next_sig_id = 0x0000c0e1;
l2cap_register_fixed_channel = 0x0000c179;
l2cap_register_packet_handler = 0x0000c195;
l2cap_register_service = 0x0000c1a1;
l2cap_request_can_send_fix_channel_now_event = 0x0000c285;
l2cap_request_can_send_now_event = 0x0000c2a9;
l2cap_request_connection_parameter_update = 0x0000c2c3;
l2cap_send = 0x0000c665;
l2cap_send_connectionless = 0x0000c6dd;
l2cap_send_connectionless3 = 0x0000c76d;
l2cap_send_echo_request = 0x0000c805;
l2cap_send_signaling_le = 0x0000c869;
l2cap_unregister_service = 0x0000c8c1;
le_device_db_add = 0x0000c919;
le_device_db_find = 0x0000c9ed;
le_device_db_from_key = 0x0000ca19;
le_device_db_iter_cur = 0x0000ca21;
le_device_db_iter_cur_key = 0x0000ca25;
le_device_db_iter_init = 0x0000ca29;
le_device_db_iter_next = 0x0000ca31;
le_device_db_remove_key = 0x0000ca57;
ll_free = 0x0000ca83;
ll_hint_on_ce_len = 0x0000ca8d;
ll_legacy_adv_set_interval = 0x0000cac5;
ll_malloc = 0x0000cad5;
ll_query_timing_info = 0x0000cc0d;
ll_scan_set_fixed_channel = 0x0000ccb1;
ll_set_adv_access_address = 0x0000cdc5;
ll_set_adv_coded_scheme = 0x0000cdd1;
ll_set_conn_coded_scheme = 0x0000ce01;
ll_set_conn_latency = 0x0000ce2d;
ll_set_conn_tx_power = 0x0000ce5d;
ll_set_def_antenna = 0x0000cea5;
ll_set_initiating_coded_scheme = 0x0000cec1;
ll_set_max_conn_number = 0x0000cecd;
nibble_for_char = 0x0001cd0d;
platform_32k_rc_auto_tune = 0x0001cda9;
platform_32k_rc_tune = 0x0001ce25;
platform_calibrate_32k = 0x0001ce39;
platform_config = 0x0001ce3d;
platform_controller_run = 0x0001cf0d;
platform_get_task_handle = 0x0001cf45;
platform_get_us_time = 0x0001cf5d;
platform_get_version = 0x0001cf61;
platform_hrng = 0x0001cf69;
platform_init_controller = 0x0001cf71;
platform_os_idle_resumed_hook = 0x0001cf8d;
platform_patch_rf_init_data = 0x0001cf91;
platform_post_sleep_processing = 0x0001cf9d;
platform_pre_sleep_processing = 0x0001cfa3;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001cfa9;
platform_printf = 0x0001cfad;
platform_raise_assertion = 0x0001cfc1;
platform_rand = 0x0001cfd5;
platform_read_info = 0x0001cfd9;
platform_read_persistent_reg = 0x0001cff5;
platform_reset = 0x0001d005;
...
platform_set_timer = 0x0001d099;
platform_shutdown = 0x0001d09d;
platform_switch_app = 0x0001d0a1;
platform_trace_raw = 0x0001d0cd;
platform_write_persistent_reg = 0x0001d0e5;
printf_hexdump = 0x0001d0f5;
reverse_128 = 0x0001d431;
reverse_24 = 0x0001d437;
reverse_48 = 0x0001d43d;
reverse_56 = 0x0001d443;
reverse_64 = 0x0001d449;
reverse_bd_addr = 0x0001d44f;
reverse_bytes = 0x0001d455;
sm_add_event_handler = 0x0001d5c1;
sm_address_resolution_lookup = 0x0001d719;
sm_authenticated = 0x0001da71;
sm_authorization_decline = 0x0001da7f;
sm_authorization_grant = 0x0001da9f;
sm_authorization_state = 0x0001dabf;
sm_bonding_decline = 0x0001dad9;
sm_config = 0x0001def9;
sm_config_conn = 0x0001df11;
sm_encryption_key_size = 0x0001e0c7;
sm_just_works_confirm = 0x0001e5d1;
sm_le_device_key = 0x0001e90d;
sm_passkey_input = 0x0001e9a3;
sm_private_random_address_generation_get = 0x0001ed51;
sm_private_random_address_generation_get_mode = 0x0001ed59;
sm_private_random_address_generation_set_mode = 0x0001ed65;
sm_private_random_address_generation_set_update_period = 0x0001ed8d;
sm_register_oob_data_callback = 0x0001eec9;
sm_request_pairing = 0x0001eed5;
sm_send_security_request = 0x0001f8f3;
sm_set_accepted_stk_generation_methods = 0x0001f919;
sm_set_authentication_requirements = 0x0001f925;
sm_set_encryption_key_size_range = 0x0001f931;
sscanf_bd_addr = 0x0001fc8d;
sysSetPublicDeviceAddr = 0x0001fff5;
uuid128_to_str = 0x000205dd;
uuid_add_bluetooth_prefix = 0x00020635;
uuid_has_bluetooth_prefix = 0x00020655;
