...
sm_just_works_confirm = 0x0001e699;
sm_le_device_key = 0x0001e9d5;
sm_passkey_input = 0x0001ea6b;
sm_private_random_address_generation_get = 0x0001ee19;
sm_private_random_address_generation_get_mode = 0x0001ee21;
sm_private_random_address_generation_set_mode = 0x0001ee2d;
sm_private_random_address_generation_set_update_period = 0x0001ee55;
sm_register_oob_data_callback = 0x0001ef91;
sm_request_pairing = 0x0001ef9d;
sm_send_security_request = 0x0001f9bb;
sm_set_accepted_stk_generation_methods = 0x0001f9e1;
sm_set_authentication_requirements = 0x0001f9ed;
sm_set_encryption_key_size_range = 0x0001f9f9;
sscanf_bd_addr = 0x0001fd55;
sysSetPublicDeviceAddr = 0x000200bd;
uuid128_to_str = 0x000206a5;
uuid_add_bluetooth_prefix = 0x000206fd;
uuid_has_bluetooth_prefix = 0x0002071d;
