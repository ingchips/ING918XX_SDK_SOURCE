...
nibble_for_char = 0x0001ccd1;
platform_32k_rc_auto_tune = 0x0001cd6d;
platform_32k_rc_tune = 0x0001cde9;
platform_calibrate_32k = 0x0001cdfd;
platform_config = 0x0001ce01;
platform_controller_run = 0x0001cebd;
platform_get_task_handle = 0x0001cef5;
platform_get_us_time = 0x0001cf0d;
platform_get_version = 0x0001cf11;
platform_hrng = 0x0001cf19;
platform_init_controller = 0x0001cf21;
platform_os_idle_resumed_hook = 0x0001cf3d;
platform_patch_rf_init_data = 0x0001cf41;
platform_post_sleep_processing = 0x0001cf4d;
platform_pre_sleep_processing = 0x0001cf53;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001cf59;
platform_printf = 0x0001cf5d;
platform_raise_assertion = 0x0001cf71;
platform_rand = 0x0001cf85;
platform_read_info = 0x0001cf89;
platform_read_persistent_reg = 0x0001cfa5;
platform_reset = 0x0001cfb5;
...
platform_set_timer = 0x0001d049;
platform_shutdown = 0x0001d04d;
platform_switch_app = 0x0001d051;
platform_trace_raw = 0x0001d07d;
platform_write_persistent_reg = 0x0001d095;
printf_hexdump = 0x0001d0a5;
reverse_128 = 0x0001d3e1;
reverse_24 = 0x0001d3e7;
reverse_48 = 0x0001d3ed;
reverse_56 = 0x0001d3f3;
reverse_64 = 0x0001d3f9;
reverse_bd_addr = 0x0001d3ff;
reverse_bytes = 0x0001d405;
sm_add_event_handler = 0x0001d571;
sm_address_resolution_lookup = 0x0001d6c9;
sm_authenticated = 0x0001da21;
sm_authorization_decline = 0x0001da2f;
sm_authorization_grant = 0x0001da4f;
sm_authorization_state = 0x0001da6f;
sm_bonding_decline = 0x0001da89;
sm_config = 0x0001dea9;
sm_config_conn = 0x0001dec1;
sm_encryption_key_size = 0x0001e077;
sm_just_works_confirm = 0x0001e5b1;
sm_le_device_key = 0x0001e8ed;
sm_passkey_input = 0x0001e983;
sm_private_random_address_generation_get = 0x0001ed31;
sm_private_random_address_generation_get_mode = 0x0001ed39;
sm_private_random_address_generation_set_mode = 0x0001ed45;
sm_private_random_address_generation_set_update_period = 0x0001ed6d;
sm_register_oob_data_callback = 0x0001eea9;
sm_request_pairing = 0x0001eeb5;
sm_send_security_request = 0x0001f8bb;
sm_set_accepted_stk_generation_methods = 0x0001f8e1;
sm_set_authentication_requirements = 0x0001f8ed;
sm_set_encryption_key_size_range = 0x0001f8f9;
sscanf_bd_addr = 0x0001fc49;
sysSetPublicDeviceAddr = 0x0001ffb1;
