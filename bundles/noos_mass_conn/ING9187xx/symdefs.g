...
platform_controller_run = 0x0001cf01;
platform_get_task_handle = 0x0001cf39;
platform_get_us_time = 0x0001cf51;
platform_get_version = 0x0001cf55;
platform_hrng = 0x0001cf5d;
platform_init_controller = 0x0001cf65;
platform_os_idle_resumed_hook = 0x0001cf81;
platform_patch_rf_init_data = 0x0001cf85;
platform_post_sleep_processing = 0x0001cf91;
platform_pre_sleep_processing = 0x0001cf97;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001cf9d;
platform_printf = 0x0001cfa1;
platform_raise_assertion = 0x0001cfb5;
platform_rand = 0x0001cfc9;
platform_read_info = 0x0001cfcd;
platform_read_persistent_reg = 0x0001cfe9;
platform_reset = 0x0001cff9;
...
reverse_128 = 0x0001d425;
reverse_24 = 0x0001d42b;
reverse_48 = 0x0001d431;
reverse_56 = 0x0001d437;
reverse_64 = 0x0001d43d;
reverse_bd_addr = 0x0001d443;
reverse_bytes = 0x0001d449;
sm_add_event_handler = 0x0001d5b5;
sm_address_resolution_lookup = 0x0001d70d;
sm_authenticated = 0x0001da65;
sm_authorization_decline = 0x0001da73;
sm_authorization_grant = 0x0001da93;
sm_authorization_state = 0x0001dab3;
sm_bonding_decline = 0x0001dacd;
sm_config = 0x0001deed;
sm_config_conn = 0x0001df05;
sm_encryption_key_size = 0x0001e0bb;
sm_just_works_confirm = 0x0001e5c5;
sm_le_device_key = 0x0001e901;
sm_passkey_input = 0x0001e997;
sm_private_random_address_generation_get = 0x0001ed45;
sm_private_random_address_generation_get_mode = 0x0001ed4d;
sm_private_random_address_generation_set_mode = 0x0001ed59;
sm_private_random_address_generation_set_update_period = 0x0001ed81;
sm_register_oob_data_callback = 0x0001eebd;
sm_request_pairing = 0x0001eec9;
sm_send_security_request = 0x0001f8e7;
sm_set_accepted_stk_generation_methods = 0x0001f90d;
sm_set_authentication_requirements = 0x0001f919;
sm_set_encryption_key_size_range = 0x0001f925;
sscanf_bd_addr = 0x0001fc81;
sysSetPublicDeviceAddr = 0x0001ffe9;
uuid128_to_str = 0x000205d1;
uuid_add_bluetooth_prefix = 0x00020629;
uuid_has_bluetooth_prefix = 0x00020649;
