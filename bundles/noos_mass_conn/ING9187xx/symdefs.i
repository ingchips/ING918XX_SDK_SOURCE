...
--define_symbol sm_authenticated=0x0001d9f5
--define_symbol sm_authorization_decline=0x0001da03
--define_symbol sm_authorization_grant=0x0001da23
--define_symbol sm_authorization_state=0x0001da43
--define_symbol sm_bonding_decline=0x0001da5d
--define_symbol sm_config=0x0001de7d
--define_symbol sm_config_conn=0x0001de95
--define_symbol sm_encryption_key_size=0x0001e04b
--define_symbol sm_just_works_confirm=0x0001e585
--define_symbol sm_le_device_key=0x0001e8c1
--define_symbol sm_passkey_input=0x0001e957
--define_symbol sm_private_random_address_generation_get=0x0001ed05
--define_symbol sm_private_random_address_generation_get_mode=0x0001ed0d
--define_symbol sm_private_random_address_generation_set_mode=0x0001ed19
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ed41
--define_symbol sm_register_oob_data_callback=0x0001ee7d
--define_symbol sm_request_pairing=0x0001ee89
--define_symbol sm_send_security_request=0x0001f88f
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f8b5
--define_symbol sm_set_authentication_requirements=0x0001f8c1
--define_symbol sm_set_encryption_key_size_range=0x0001f8cd
--define_symbol sscanf_bd_addr=0x0001fc1d
--define_symbol sysSetPublicDeviceAddr=0x0001ff85
--define_symbol uuid128_to_str=0x0002057d
--define_symbol uuid_add_bluetooth_prefix=0x000205d5
--define_symbol uuid_has_bluetooth_prefix=0x000205f5
