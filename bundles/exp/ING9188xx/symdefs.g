...
sm_just_works_confirm = 0x00022a99;
sm_le_device_key = 0x00022dd5;
sm_passkey_input = 0x00022e6b;
sm_private_random_address_generation_get = 0x00023219;
sm_private_random_address_generation_get_mode = 0x00023221;
sm_private_random_address_generation_set_mode = 0x0002322d;
sm_private_random_address_generation_set_update_period = 0x00023255;
sm_register_oob_data_callback = 0x00023391;
sm_request_pairing = 0x0002339d;
sm_send_security_request = 0x00023dbb;
sm_set_accepted_stk_generation_methods = 0x00023de1;
sm_set_authentication_requirements = 0x00023ded;
sm_set_encryption_key_size_range = 0x00023df9;
sscanf_bd_addr = 0x000241c9;
sysSetPublicDeviceAddr = 0x00024531;
uuid128_to_str = 0x00024cd1;
uuid_add_bluetooth_prefix = 0x00024d29;
uuid_has_bluetooth_prefix = 0x00024d49;
uxListRemove = 0x00024d65;
uxQueueMessagesWaiting = 0x00024d8d;
uxQueueMessagesWaitingFromISR = 0x00024db5;
uxQueueSpacesAvailable = 0x00024dd1;
uxTaskGetStackHighWaterMark = 0x00024dfd;
uxTaskPriorityGet = 0x00024e1d;
uxTaskPriorityGetFromISR = 0x00024e39;
vListInitialise = 0x00024eeb;
vListInitialiseItem = 0x00024f01;
vListInsert = 0x00024f07;
vListInsertEnd = 0x00024f37;
vPortEndScheduler = 0x00024f51;
vPortEnterCritical = 0x00024f79;
vPortExitCritical = 0x00024fbd;
vPortFree = 0x00024fed;
vPortSuppressTicksAndSleep = 0x00025081;
vPortValidateInterruptPriority = 0x00025189;
vQueueDelete = 0x000251e1;
vQueueWaitForMessageRestricted = 0x0002520d;
vTaskDelay = 0x00025255;
vTaskInternalSetTimeOutState = 0x000252a1;
vTaskMissedYield = 0x000252b1;
vTaskPlaceOnEventList = 0x000252bd;
vTaskPlaceOnEventListRestricted = 0x000252f5;
vTaskPriorityDisinheritAfterTimeout = 0x00025335;
vTaskPrioritySet = 0x000253e1;
vTaskResume = 0x000254a9;
vTaskStartScheduler = 0x0002552d;
vTaskStepTick = 0x000255bd;
vTaskSuspend = 0x000255ed;
vTaskSuspendAll = 0x000256a9;
vTaskSwitchContext = 0x000256b9;
xPortStartScheduler = 0x00025761;
xQueueAddToSet = 0x00025821;
xQueueCreateCountingSemaphore = 0x00025845;
xQueueCreateCountingSemaphoreStatic = 0x00025881;
xQueueCreateMutex = 0x000258c5;
xQueueCreateMutexStatic = 0x000258db;
xQueueCreateSet = 0x000258f5;
xQueueGenericCreate = 0x000258fd;
xQueueGenericCreateStatic = 0x00025949;
xQueueGenericReset = 0x000259b1;
xQueueGenericSend = 0x00025a3d;
xQueueGenericSendFromISR = 0x00025ba9;
xQueueGiveFromISR = 0x00025c69;
xQueueGiveMutexRecursive = 0x00025d0d;
xQueueIsQueueEmptyFromISR = 0x00025d4d;
xQueueIsQueueFullFromISR = 0x00025d71;
xQueuePeek = 0x00025d99;
xQueuePeekFromISR = 0x00025ec1;
xQueueReceive = 0x00025f2d;
xQueueReceiveFromISR = 0x00026059;
xQueueRemoveFromSet = 0x000260ed;
xQueueSelectFromSet = 0x0002610f;
xQueueSelectFromSetFromISR = 0x00026121;
xQueueSemaphoreTake = 0x00026135;
xQueueTakeMutexRecursive = 0x000262a1;
xTaskCheckForTimeOut = 0x000262e5;
xTaskCreate = 0x00026355;
xTaskCreateStatic = 0x000263b1;
xTaskGetCurrentTaskHandle = 0x00026421;
xTaskGetSchedulerState = 0x0002642d;
xTaskGetTickCount = 0x00026449;
xTaskGetTickCountFromISR = 0x00026455;
xTaskIncrementTick = 0x00026465;
xTaskPriorityDisinherit = 0x00026531;
xTaskPriorityInherit = 0x000265c5;
xTaskRemoveFromEventList = 0x00026659;
xTaskResumeAll = 0x000266d9;
xTaskResumeFromISR = 0x000267a1;
xTimerCreate = 0x0002682d;
xTimerCreateStatic = 0x00026861;
xTimerCreateTimerTask = 0x00026899;
xTimerGenericCommand = 0x00026905;
xTimerGetExpiryTime = 0x00026975;
xTimerGetTimerDaemonTaskHandle = 0x00026995;
