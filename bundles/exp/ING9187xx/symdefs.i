...
--define_symbol nibble_for_char=0x0001ef55
--define_symbol platform_32k_rc_auto_tune=0x0001eff1
--define_symbol platform_32k_rc_tune=0x0001f06d
--define_symbol platform_calibrate_32k=0x0001f081
--define_symbol platform_config=0x0001f085
--define_symbol platform_get_heap_status=0x0001f159
--define_symbol platform_get_task_handle=0x0001f171
--define_symbol platform_get_us_time=0x0001f191
--define_symbol platform_get_version=0x0001f195
--define_symbol platform_hrng=0x0001f19d
--define_symbol platform_install_isr_stack=0x0001f1a5
--define_symbol platform_patch_rf_init_data=0x0001f1b1
--define_symbol platform_printf=0x0001f1bd
--define_symbol platform_raise_assertion=0x0001f1d1
--define_symbol platform_rand=0x0001f1e5
--define_symbol platform_read_info=0x0001f1e9
--define_symbol platform_read_persistent_reg=0x0001f205
--define_symbol platform_reset=0x0001f215
--define_symbol platform_set_evt_callback=0x0001f249
--define_symbol platform_set_irq_callback=0x0001f25d
--define_symbol platform_set_rf_clk_source=0x0001f295
--define_symbol platform_set_rf_init_data=0x0001f2a1
--define_symbol platform_set_rf_power_mapping=0x0001f2ad
--define_symbol platform_set_timer=0x0001f2b9
--define_symbol platform_shutdown=0x0001f2bd
--define_symbol platform_switch_app=0x0001f2c1
--define_symbol platform_trace_raw=0x0001f2ed
--define_symbol platform_write_persistent_reg=0x0001f305
--define_symbol printf_hexdump=0x0001f315
--define_symbol pvPortMalloc=0x0001fe1d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ff05
--define_symbol pvTimerGetTimerID=0x0001ff1d
--define_symbol pxPortInitialiseStack=0x0001ff49
--define_symbol reverse_128=0x000200f1
--define_symbol reverse_24=0x000200f7
--define_symbol reverse_48=0x000200fd
--define_symbol reverse_56=0x00020103
--define_symbol reverse_64=0x00020109
--define_symbol reverse_bd_addr=0x0002010f
--define_symbol reverse_bytes=0x00020115
--define_symbol sm_add_event_handler=0x000202a1
--define_symbol sm_address_resolution_lookup=0x000203f9
--define_symbol sm_authenticated=0x00020751
--define_symbol sm_authorization_decline=0x0002075f
--define_symbol sm_authorization_grant=0x0002077f
--define_symbol sm_authorization_state=0x0002079f
--define_symbol sm_bonding_decline=0x000207b9
--define_symbol sm_config=0x00020bd9
--define_symbol sm_config_conn=0x00020bf1
--define_symbol sm_encryption_key_size=0x00020da7
--define_symbol sm_just_works_confirm=0x000212e1
--define_symbol sm_le_device_key=0x0002161d
--define_symbol sm_passkey_input=0x000216b3
--define_symbol sm_private_random_address_generation_get=0x00021a61
--define_symbol sm_private_random_address_generation_get_mode=0x00021a69
--define_symbol sm_private_random_address_generation_set_mode=0x00021a75
--define_symbol sm_private_random_address_generation_set_update_period=0x00021a9d
--define_symbol sm_register_oob_data_callback=0x00021bd9
--define_symbol sm_request_pairing=0x00021be5
--define_symbol sm_send_security_request=0x00022603
--define_symbol sm_set_accepted_stk_generation_methods=0x00022629
--define_symbol sm_set_authentication_requirements=0x00022635
--define_symbol sm_set_encryption_key_size_range=0x00022641
--define_symbol sscanf_bd_addr=0x00022a11
--define_symbol sysSetPublicDeviceAddr=0x00022d79
--define_symbol uuid128_to_str=0x00023385
--define_symbol uuid_add_bluetooth_prefix=0x000233dd
--define_symbol uuid_has_bluetooth_prefix=0x000233fd
--define_symbol uxListRemove=0x00023419
--define_symbol uxQueueMessagesWaiting=0x00023441
--define_symbol uxQueueMessagesWaitingFromISR=0x00023469
--define_symbol uxQueueSpacesAvailable=0x00023485
--define_symbol uxTaskGetStackHighWaterMark=0x000234b1
--define_symbol uxTaskPriorityGet=0x000234d1
--define_symbol uxTaskPriorityGetFromISR=0x000234ed
--define_symbol vListInitialise=0x0002359f
--define_symbol vListInitialiseItem=0x000235b5
--define_symbol vListInsert=0x000235bb
--define_symbol vListInsertEnd=0x000235eb
--define_symbol vPortEndScheduler=0x00023605
--define_symbol vPortEnterCritical=0x0002362d
--define_symbol vPortExitCritical=0x00023671
--define_symbol vPortFree=0x000236a1
--define_symbol vPortSuppressTicksAndSleep=0x00023735
--define_symbol vPortValidateInterruptPriority=0x0002383d
--define_symbol vQueueDelete=0x00023895
--define_symbol vQueueWaitForMessageRestricted=0x000238c1
--define_symbol vTaskDelay=0x00023909
--define_symbol vTaskInternalSetTimeOutState=0x00023955
--define_symbol vTaskMissedYield=0x00023965
--define_symbol vTaskPlaceOnEventList=0x00023971
--define_symbol vTaskPlaceOnEventListRestricted=0x000239a9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000239e9
--define_symbol vTaskPrioritySet=0x00023a95
--define_symbol vTaskResume=0x00023b5d
--define_symbol vTaskStartScheduler=0x00023be1
--define_symbol vTaskStepTick=0x00023c71
--define_symbol vTaskSuspend=0x00023ca1
--define_symbol vTaskSuspendAll=0x00023d5d
--define_symbol vTaskSwitchContext=0x00023d6d
--define_symbol xPortStartScheduler=0x00023e15
--define_symbol xQueueAddToSet=0x00023ed5
--define_symbol xQueueCreateCountingSemaphore=0x00023ef9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023f35
--define_symbol xQueueCreateMutex=0x00023f79
--define_symbol xQueueCreateMutexStatic=0x00023f8f
--define_symbol xQueueCreateSet=0x00023fa9
--define_symbol xQueueGenericCreate=0x00023fb1
--define_symbol xQueueGenericCreateStatic=0x00023ffd
--define_symbol xQueueGenericReset=0x00024065
--define_symbol xQueueGenericSend=0x000240f1
--define_symbol xQueueGenericSendFromISR=0x0002425d
--define_symbol xQueueGiveFromISR=0x0002431d
--define_symbol xQueueGiveMutexRecursive=0x000243c1
--define_symbol xQueueIsQueueEmptyFromISR=0x00024401
--define_symbol xQueueIsQueueFullFromISR=0x00024425
--define_symbol xQueuePeek=0x0002444d
--define_symbol xQueuePeekFromISR=0x00024575
--define_symbol xQueueReceive=0x000245e1
--define_symbol xQueueReceiveFromISR=0x0002470d
--define_symbol xQueueRemoveFromSet=0x000247a1
--define_symbol xQueueSelectFromSet=0x000247c3
--define_symbol xQueueSelectFromSetFromISR=0x000247d5
--define_symbol xQueueSemaphoreTake=0x000247e9
--define_symbol xQueueTakeMutexRecursive=0x00024955
--define_symbol xTaskCheckForTimeOut=0x00024999
--define_symbol xTaskCreate=0x00024a09
--define_symbol xTaskCreateStatic=0x00024a65
--define_symbol xTaskGetCurrentTaskHandle=0x00024ad5
--define_symbol xTaskGetSchedulerState=0x00024ae1
--define_symbol xTaskGetTickCount=0x00024afd
--define_symbol xTaskGetTickCountFromISR=0x00024b09
--define_symbol xTaskIncrementTick=0x00024b19
--define_symbol xTaskPriorityDisinherit=0x00024be5
--define_symbol xTaskPriorityInherit=0x00024c79
--define_symbol xTaskRemoveFromEventList=0x00024d0d
--define_symbol xTaskResumeAll=0x00024d8d
--define_symbol xTaskResumeFromISR=0x00024e55
--define_symbol xTimerCreate=0x00024ee1
--define_symbol xTimerCreateStatic=0x00024f15
--define_symbol xTimerCreateTimerTask=0x00024f4d
--define_symbol xTimerGenericCommand=0x00024fb9
--define_symbol xTimerGetExpiryTime=0x00025029
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00025049
