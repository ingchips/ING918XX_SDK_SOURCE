...
--define_symbol sm_just_works_confirm=0x000212b1
--define_symbol sm_le_device_key=0x000215ed
--define_symbol sm_passkey_input=0x00021683
--define_symbol sm_private_random_address_generation_get=0x00021a31
--define_symbol sm_private_random_address_generation_get_mode=0x00021a39
--define_symbol sm_private_random_address_generation_set_mode=0x00021a45
--define_symbol sm_private_random_address_generation_set_update_period=0x00021a6d
--define_symbol sm_register_oob_data_callback=0x00021ba9
--define_symbol sm_request_pairing=0x00021bb5
--define_symbol sm_send_security_request=0x000225d3
--define_symbol sm_set_accepted_stk_generation_methods=0x000225f9
--define_symbol sm_set_authentication_requirements=0x00022605
--define_symbol sm_set_encryption_key_size_range=0x00022611
--define_symbol sscanf_bd_addr=0x000229e1
--define_symbol sysSetPublicDeviceAddr=0x00022d49
--define_symbol uuid128_to_str=0x00023355
--define_symbol uuid_add_bluetooth_prefix=0x000233ad
--define_symbol uuid_has_bluetooth_prefix=0x000233cd
--define_symbol uxListRemove=0x000233e9
--define_symbol uxQueueMessagesWaiting=0x00023411
--define_symbol uxQueueMessagesWaitingFromISR=0x00023439
--define_symbol uxQueueSpacesAvailable=0x00023455
--define_symbol uxTaskGetStackHighWaterMark=0x00023481
--define_symbol uxTaskPriorityGet=0x000234a1
--define_symbol uxTaskPriorityGetFromISR=0x000234bd
--define_symbol vListInitialise=0x0002356f
--define_symbol vListInitialiseItem=0x00023585
--define_symbol vListInsert=0x0002358b
--define_symbol vListInsertEnd=0x000235bb
--define_symbol vPortEndScheduler=0x000235d5
--define_symbol vPortEnterCritical=0x000235fd
--define_symbol vPortExitCritical=0x00023641
--define_symbol vPortFree=0x00023671
--define_symbol vPortSuppressTicksAndSleep=0x00023705
--define_symbol vPortValidateInterruptPriority=0x0002380d
--define_symbol vQueueDelete=0x00023865
--define_symbol vQueueWaitForMessageRestricted=0x00023891
--define_symbol vTaskDelay=0x000238d9
--define_symbol vTaskInternalSetTimeOutState=0x00023925
--define_symbol vTaskMissedYield=0x00023935
--define_symbol vTaskPlaceOnEventList=0x00023941
--define_symbol vTaskPlaceOnEventListRestricted=0x00023979
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000239b9
--define_symbol vTaskPrioritySet=0x00023a65
--define_symbol vTaskResume=0x00023b2d
--define_symbol vTaskStartScheduler=0x00023bb1
--define_symbol vTaskStepTick=0x00023c41
--define_symbol vTaskSuspend=0x00023c71
--define_symbol vTaskSuspendAll=0x00023d2d
--define_symbol vTaskSwitchContext=0x00023d3d
--define_symbol xPortStartScheduler=0x00023de5
--define_symbol xQueueAddToSet=0x00023ea5
--define_symbol xQueueCreateCountingSemaphore=0x00023ec9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023f05
--define_symbol xQueueCreateMutex=0x00023f49
--define_symbol xQueueCreateMutexStatic=0x00023f5f
--define_symbol xQueueCreateSet=0x00023f79
--define_symbol xQueueGenericCreate=0x00023f81
--define_symbol xQueueGenericCreateStatic=0x00023fcd
--define_symbol xQueueGenericReset=0x00024035
--define_symbol xQueueGenericSend=0x000240c1
--define_symbol xQueueGenericSendFromISR=0x0002422d
--define_symbol xQueueGiveFromISR=0x000242ed
--define_symbol xQueueGiveMutexRecursive=0x00024391
--define_symbol xQueueIsQueueEmptyFromISR=0x000243d1
--define_symbol xQueueIsQueueFullFromISR=0x000243f5
--define_symbol xQueuePeek=0x0002441d
--define_symbol xQueuePeekFromISR=0x00024545
--define_symbol xQueueReceive=0x000245b1
--define_symbol xQueueReceiveFromISR=0x000246dd
--define_symbol xQueueRemoveFromSet=0x00024771
--define_symbol xQueueSelectFromSet=0x00024793
--define_symbol xQueueSelectFromSetFromISR=0x000247a5
--define_symbol xQueueSemaphoreTake=0x000247b9
--define_symbol xQueueTakeMutexRecursive=0x00024925
--define_symbol xTaskCheckForTimeOut=0x00024969
--define_symbol xTaskCreate=0x000249d9
--define_symbol xTaskCreateStatic=0x00024a35
--define_symbol xTaskGetCurrentTaskHandle=0x00024aa5
--define_symbol xTaskGetSchedulerState=0x00024ab1
--define_symbol xTaskGetTickCount=0x00024acd
--define_symbol xTaskGetTickCountFromISR=0x00024ad9
--define_symbol xTaskIncrementTick=0x00024ae9
--define_symbol xTaskPriorityDisinherit=0x00024bb5
--define_symbol xTaskPriorityInherit=0x00024c49
--define_symbol xTaskRemoveFromEventList=0x00024cdd
--define_symbol xTaskResumeAll=0x00024d5d
--define_symbol xTaskResumeFromISR=0x00024e25
--define_symbol xTimerCreate=0x00024eb1
--define_symbol xTimerCreateStatic=0x00024ee5
--define_symbol xTimerCreateTimerTask=0x00024f1d
--define_symbol xTimerGenericCommand=0x00024f89
--define_symbol xTimerGetExpiryTime=0x00024ff9
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00025019
