...
typedef int  (*f_os_mqueue_init)(struct os_mqueue *mq, ble_npl_event_fn *ev_cb, void *arg);
#define os_mqueue_init ((f_os_mqueue_init)(0x000285bf))
...
#define os_mqueue_get ((f_os_mqueue_get)(0x00028599))
...
typedef int  (*f_os_mqueue_put)(struct os_mqueue *, struct ble_npl_eventq *, struct os_mbuf *);
#define os_mqueue_put ((f_os_mqueue_put)(0x000285d1))
...
typedef int  (*f_os_msys_register)(struct os_mbuf_pool *);
#define os_msys_register ((f_os_msys_register)(0x000286b9))
...
typedef struct os_mbuf * (*f_os_msys_get)(uint16_t dsize, uint16_t leadingspace);
#define os_msys_get ((f_os_msys_get)(0x00028625))
...
typedef void  (*f_os_msys_reset)(void);
#define os_msys_reset ((f_os_msys_reset)(0x000286f5))
...
typedef struct os_mbuf * (*f_os_msys_get_pkthdr)(uint16_t dsize, uint16_t user_hdr_len);
#define os_msys_get_pkthdr ((f_os_msys_get_pkthdr)(0x0002863d))
...
typedef int  (*f_os_msys_count)(void);
#define os_msys_count ((f_os_msys_count)(0x00028609))
...
typedef int  (*f_os_msys_num_free)(void);
#define os_msys_num_free ((f_os_msys_num_free)(0x0002869d))
...
//         uint16_t, uint16_t);
typedef int  (*f_os_mbuf_pool_init)(struct os_mbuf_pool *, struct os_mempool *mp,         uint16_t, uint16_t);
#define os_mbuf_pool_init ((f_os_mbuf_pool_init)(0x00028307))
...
typedef struct os_mbuf * (*f_os_mbuf_get)(struct os_mbuf_pool *omp, uint16_t);
#define os_mbuf_get ((f_os_mbuf_get)(0x0002828d))
...
#define os_mbuf_get_pkthdr ((f_os_mbuf_get_pkthdr)(0x000282b9))
...
typedef struct os_mbuf * (*f_os_mbuf_dup)(struct os_mbuf *m);
#define os_mbuf_dup ((f_os_mbuf_dup)(0x0002819f))
...
//                             uint16_t *out_off);
typedef struct os_mbuf * (*f_os_mbuf_off)(const struct os_mbuf *om, int off,                             uint16_t *out_off);
#define os_mbuf_off ((f_os_mbuf_off)(0x000282e9))
...
typedef int  (*f_os_mbuf_copydata)(const struct os_mbuf *m, int off, int len, void *dst);
#define os_mbuf_copydata ((f_os_mbuf_copydata)(0x000280c9))
...
typedef int  (*f_os_mbuf_append)(struct os_mbuf *m, const void *, uint16_t);
#define os_mbuf_append ((f_os_mbuf_append)(0x00027e81))
...
typedef int  (*f_os_mbuf_appendfrom)(struct os_mbuf *dst, const struct os_mbuf *src,                        uint16_t src_off, uint16_t len);
#define os_mbuf_appendfrom ((f_os_mbuf_appendfrom)(0x00027f19))
...
typedef int  (*f_os_mbuf_free)(struct os_mbuf *mb);
#define os_mbuf_free ((f_os_mbuf_free)(0x0002825f))
...
typedef int  (*f_os_mbuf_free_chain)(struct os_mbuf *om);
#define os_mbuf_free_chain ((f_os_mbuf_free_chain)(0x00028277))
...
typedef void  (*f_os_mbuf_adj)(struct os_mbuf *mp, int req_len);
#define os_mbuf_adj ((f_os_mbuf_adj)(0x00027de9))
...
typedef int  (*f_os_mbuf_cmpf)(const struct os_mbuf *om, int off, const void *data, int len);
#define os_mbuf_cmpf ((f_os_mbuf_cmpf)(0x00027f6f))
...
//                  uint16_t len);
typedef int  (*f_os_mbuf_cmpm)(const struct os_mbuf *om1, uint16_t offset1,                  const struct os_mbuf *om2, uint16_t offset2,                  uint16_t len);
#define os_mbuf_cmpm ((f_os_mbuf_cmpm)(0x00027fcf))
...
typedef struct os_mbuf * (*f_os_mbuf_prepend)(struct os_mbuf *om, int len);
#define os_mbuf_prepend ((f_os_mbuf_prepend)(0x00028311))
...
typedef struct os_mbuf * (*f_os_mbuf_prepend_pullup)(struct os_mbuf *om, uint16_t len);
#define os_mbuf_prepend_pullup ((f_os_mbuf_prepend_pullup)(0x00028393))
...
typedef int  (*f_os_mbuf_copyinto)(struct os_mbuf *om, int off, const void *src, int len);
#define os_mbuf_copyinto ((f_os_mbuf_copyinto)(0x00028121))
...
typedef void  (*f_os_mbuf_concat)(struct os_mbuf *first, struct os_mbuf *second);
#define os_mbuf_concat ((f_os_mbuf_concat)(0x0002808d))
...
typedef void * (*f_os_mbuf_extend)(struct os_mbuf *om, uint16_t len);
#define os_mbuf_extend ((f_os_mbuf_extend)(0x0002820f))
...
typedef struct os_mbuf * (*f_os_mbuf_pullup)(struct os_mbuf *om, uint16_t len);
#define os_mbuf_pullup ((f_os_mbuf_pullup)(0x000283ab))
...
typedef struct os_mbuf * (*f_os_mbuf_trim_front)(struct os_mbuf *om);
#define os_mbuf_trim_front ((f_os_mbuf_trim_front)(0x00028477))
