...
--define_symbol nibble_for_char=0x0001e1a5
...
--define_symbol platform_get_heap_status=0x0001e3a9
--define_symbol platform_get_task_handle=0x0001e3c1
--define_symbol platform_get_us_time=0x0001e3e1
--define_symbol platform_get_version=0x0001e3e5
--define_symbol platform_hrng=0x0001e3ed
--define_symbol platform_install_isr_stack=0x0001e3f5
--define_symbol platform_patch_rf_init_data=0x0001e401
--define_symbol platform_printf=0x0001e40d
--define_symbol platform_raise_assertion=0x0001e421
--define_symbol platform_rand=0x0001e435
--define_symbol platform_read_info=0x0001e439
--define_symbol platform_read_persistent_reg=0x0001e455
--define_symbol platform_reset=0x0001e465
--define_symbol platform_set_evt_callback=0x0001e499
--define_symbol platform_set_irq_callback=0x0001e4ad
--define_symbol platform_set_rf_clk_source=0x0001e4e5
--define_symbol platform_set_rf_init_data=0x0001e4f1
--define_symbol platform_set_rf_power_mapping=0x0001e4fd
--define_symbol platform_set_timer=0x0001e509
--define_symbol platform_shutdown=0x0001e50d
--define_symbol platform_switch_app=0x0001e511
--define_symbol platform_trace_raw=0x0001e53d
--define_symbol platform_write_persistent_reg=0x0001e555
--define_symbol printf_hexdump=0x0001e565
--define_symbol pvPortMalloc=0x0001f071
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f159
--define_symbol pvTimerGetTimerID=0x0001f171
--define_symbol pxPortInitialiseStack=0x0001f19d
--define_symbol reverse_128=0x0001f37d
--define_symbol reverse_24=0x0001f383
--define_symbol reverse_48=0x0001f389
--define_symbol reverse_56=0x0001f38f
--define_symbol reverse_64=0x0001f395
--define_symbol reverse_bd_addr=0x0001f39b
--define_symbol reverse_bytes=0x0001f3a1
--define_symbol sm_add_event_handler=0x0001f661
--define_symbol sm_address_resolution_lookup=0x0001f7b9
--define_symbol sm_authenticated=0x0001fb11
--define_symbol sm_authorization_decline=0x0001fb1f
--define_symbol sm_authorization_grant=0x0001fb3f
--define_symbol sm_authorization_state=0x0001fb5f
--define_symbol sm_bonding_decline=0x0001fb79
--define_symbol sm_config=0x0001ff99
--define_symbol sm_config_conn=0x0001ffb1
--define_symbol sm_encryption_key_size=0x00020167
--define_symbol sm_just_works_confirm=0x00020671
--define_symbol sm_le_device_key=0x000209ad
--define_symbol sm_passkey_input=0x00020a43
--define_symbol sm_private_random_address_generation_get=0x00020df1
--define_symbol sm_private_random_address_generation_get_mode=0x00020df9
--define_symbol sm_private_random_address_generation_set_mode=0x00020e05
--define_symbol sm_private_random_address_generation_set_update_period=0x00020e2d
--define_symbol sm_register_oob_data_callback=0x00020f69
--define_symbol sm_request_pairing=0x00020f75
--define_symbol sm_send_security_request=0x00021993
--define_symbol sm_set_accepted_stk_generation_methods=0x000219b9
--define_symbol sm_set_authentication_requirements=0x000219c5
--define_symbol sm_set_encryption_key_size_range=0x000219d1
--define_symbol sscanf_bd_addr=0x00021d2d
--define_symbol sysSetPublicDeviceAddr=0x00022095
--define_symbol uuid128_to_str=0x0002280d
--define_symbol uuid_add_bluetooth_prefix=0x00022865
--define_symbol uuid_has_bluetooth_prefix=0x00022885
--define_symbol uxListRemove=0x000228a1
--define_symbol uxQueueMessagesWaiting=0x000228c9
--define_symbol uxQueueMessagesWaitingFromISR=0x000228f1
--define_symbol uxQueueSpacesAvailable=0x0002290d
--define_symbol uxTaskGetStackHighWaterMark=0x00022939
--define_symbol uxTaskPriorityGet=0x00022959
--define_symbol uxTaskPriorityGetFromISR=0x00022975
--define_symbol vListInitialise=0x00022a27
--define_symbol vListInitialiseItem=0x00022a3d
--define_symbol vListInsert=0x00022a43
--define_symbol vListInsertEnd=0x00022a73
--define_symbol vPortEndScheduler=0x00022a8d
--define_symbol vPortEnterCritical=0x00022ab5
--define_symbol vPortExitCritical=0x00022af9
--define_symbol vPortFree=0x00022b29
--define_symbol vPortSuppressTicksAndSleep=0x00022bbd
--define_symbol vPortValidateInterruptPriority=0x00022cc5
--define_symbol vQueueDelete=0x00022d1d
--define_symbol vQueueWaitForMessageRestricted=0x00022d49
--define_symbol vTaskDelay=0x00022d91
--define_symbol vTaskInternalSetTimeOutState=0x00022ddd
--define_symbol vTaskMissedYield=0x00022ded
--define_symbol vTaskPlaceOnEventList=0x00022df9
--define_symbol vTaskPlaceOnEventListRestricted=0x00022e31
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022e71
--define_symbol vTaskPrioritySet=0x00022f1d
...
--define_symbol xQueueAddToSet=0x0002335d
--define_symbol xQueueCreateCountingSemaphore=0x00023381
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000233bd
--define_symbol xQueueCreateMutex=0x00023401
--define_symbol xQueueCreateMutexStatic=0x00023417
--define_symbol xQueueCreateSet=0x00023431
--define_symbol xQueueGenericCreate=0x00023439
--define_symbol xQueueGenericCreateStatic=0x00023485
--define_symbol xQueueGenericReset=0x000234ed
--define_symbol xQueueGenericSend=0x00023579
--define_symbol xQueueGenericSendFromISR=0x000236e5
--define_symbol xQueueGiveFromISR=0x000237a5
--define_symbol xQueueGiveMutexRecursive=0x00023849
--define_symbol xQueueIsQueueEmptyFromISR=0x00023889
--define_symbol xQueueIsQueueFullFromISR=0x000238ad
--define_symbol xQueuePeek=0x000238d5
--define_symbol xQueuePeekFromISR=0x000239fd
--define_symbol xQueueReceive=0x00023a69
--define_symbol xQueueReceiveFromISR=0x00023b95
--define_symbol xQueueRemoveFromSet=0x00023c29
--define_symbol xQueueSelectFromSet=0x00023c4b
--define_symbol xQueueSelectFromSetFromISR=0x00023c5d
--define_symbol xQueueSemaphoreTake=0x00023c71
--define_symbol xQueueTakeMutexRecursive=0x00023ddd
--define_symbol xTaskCheckForTimeOut=0x00023e21
--define_symbol xTaskCreate=0x00023e91
--define_symbol xTaskCreateStatic=0x00023eed
--define_symbol xTaskGetCurrentTaskHandle=0x00023f5d
--define_symbol xTaskGetSchedulerState=0x00023f69
--define_symbol xTaskGetTickCount=0x00023f85
--define_symbol xTaskGetTickCountFromISR=0x00023f91
--define_symbol xTaskIncrementTick=0x00023fa1
--define_symbol xTaskPriorityDisinherit=0x0002406d
--define_symbol xTaskPriorityInherit=0x00024101
--define_symbol xTaskRemoveFromEventList=0x00024195
--define_symbol xTaskResumeAll=0x00024215
--define_symbol xTaskResumeFromISR=0x000242dd
--define_symbol xTimerCreate=0x00024369
--define_symbol xTimerCreateStatic=0x0002439d
--define_symbol xTimerCreateTimerTask=0x000243d5
--define_symbol xTimerGenericCommand=0x00024441
--define_symbol xTimerGetExpiryTime=0x000244b1
--define_symbol xTimerGetTimerDaemonTaskHandle=0x000244d1
