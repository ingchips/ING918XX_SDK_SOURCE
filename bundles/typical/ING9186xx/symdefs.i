...
--define_symbol nibble_for_char=0x0001e0e1
--define_symbol platform_32k_rc_auto_tune=0x0001e17d
--define_symbol platform_32k_rc_tune=0x0001e1f9
--define_symbol platform_calibrate_32k=0x0001e20d
--define_symbol platform_config=0x0001e211
--define_symbol platform_get_heap_status=0x0001e2e5
--define_symbol platform_get_task_handle=0x0001e2fd
...
--define_symbol platform_set_timer=0x0001e445
--define_symbol platform_shutdown=0x0001e449
--define_symbol platform_switch_app=0x0001e44d
--define_symbol platform_trace_raw=0x0001e479
--define_symbol platform_write_persistent_reg=0x0001e491
--define_symbol printf_hexdump=0x0001e4a1
--define_symbol pvPortMalloc=0x0001efad
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f095
--define_symbol pvTimerGetTimerID=0x0001f0ad
--define_symbol pxPortInitialiseStack=0x0001f0d9
--define_symbol reverse_128=0x0001f2b9
--define_symbol reverse_24=0x0001f2bf
--define_symbol reverse_48=0x0001f2c5
--define_symbol reverse_56=0x0001f2cb
--define_symbol reverse_64=0x0001f2d1
--define_symbol reverse_bd_addr=0x0001f2d7
--define_symbol reverse_bytes=0x0001f2dd
--define_symbol sm_add_event_handler=0x0001f59d
--define_symbol sm_address_resolution_lookup=0x0001f6f5
--define_symbol sm_authenticated=0x0001fa4d
--define_symbol sm_authorization_decline=0x0001fa5b
--define_symbol sm_authorization_grant=0x0001fa7b
--define_symbol sm_authorization_state=0x0001fa9b
--define_symbol sm_bonding_decline=0x0001fab5
--define_symbol sm_config=0x0001fed5
--define_symbol sm_config_conn=0x0001feed
--define_symbol sm_encryption_key_size=0x000200a3
--define_symbol sm_just_works_confirm=0x000205ad
--define_symbol sm_le_device_key=0x000208e9
--define_symbol sm_passkey_input=0x0002097f
--define_symbol sm_private_random_address_generation_get=0x00020d2d
--define_symbol sm_private_random_address_generation_get_mode=0x00020d35
--define_symbol sm_private_random_address_generation_set_mode=0x00020d41
--define_symbol sm_private_random_address_generation_set_update_period=0x00020d69
--define_symbol sm_register_oob_data_callback=0x00020ea5
--define_symbol sm_request_pairing=0x00020eb1
...
--define_symbol sscanf_bd_addr=0x00021c69
--define_symbol sysSetPublicDeviceAddr=0x00021fd1
--define_symbol uuid128_to_str=0x00022749
--define_symbol uuid_add_bluetooth_prefix=0x000227a1
--define_symbol uuid_has_bluetooth_prefix=0x000227c1
--define_symbol uxListRemove=0x000227dd
--define_symbol uxQueueMessagesWaiting=0x00022805
--define_symbol uxQueueMessagesWaitingFromISR=0x0002282d
--define_symbol uxQueueSpacesAvailable=0x00022849
--define_symbol uxTaskGetStackHighWaterMark=0x00022875
--define_symbol uxTaskPriorityGet=0x00022895
--define_symbol uxTaskPriorityGetFromISR=0x000228b1
--define_symbol vListInitialise=0x00022963
--define_symbol vListInitialiseItem=0x00022979
--define_symbol vListInsert=0x0002297f
--define_symbol vListInsertEnd=0x000229af
--define_symbol vPortEndScheduler=0x000229c9
--define_symbol vPortEnterCritical=0x000229f1
--define_symbol vPortExitCritical=0x00022a35
--define_symbol vPortFree=0x00022a65
--define_symbol vPortSuppressTicksAndSleep=0x00022af9
--define_symbol vPortValidateInterruptPriority=0x00022c01
--define_symbol vQueueDelete=0x00022c59
--define_symbol vQueueWaitForMessageRestricted=0x00022c85
--define_symbol vTaskDelay=0x00022ccd
--define_symbol vTaskInternalSetTimeOutState=0x00022d19
--define_symbol vTaskMissedYield=0x00022d29
--define_symbol vTaskPlaceOnEventList=0x00022d35
--define_symbol vTaskPlaceOnEventListRestricted=0x00022d6d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022dad
--define_symbol vTaskPrioritySet=0x00022e59
--define_symbol vTaskResume=0x00022f21
--define_symbol vTaskStartScheduler=0x00022fa5
--define_symbol vTaskStepTick=0x00023035
--define_symbol vTaskSuspend=0x00023065
--define_symbol vTaskSuspendAll=0x00023121
--define_symbol vTaskSwitchContext=0x00023131
--define_symbol xPortStartScheduler=0x000231d9
--define_symbol xQueueAddToSet=0x00023299
--define_symbol xQueueCreateCountingSemaphore=0x000232bd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000232f9
--define_symbol xQueueCreateMutex=0x0002333d
--define_symbol xQueueCreateMutexStatic=0x00023353
--define_symbol xQueueCreateSet=0x0002336d
--define_symbol xQueueGenericCreate=0x00023375
--define_symbol xQueueGenericCreateStatic=0x000233c1
--define_symbol xQueueGenericReset=0x00023429
--define_symbol xQueueGenericSend=0x000234b5
--define_symbol xQueueGenericSendFromISR=0x00023621
--define_symbol xQueueGiveFromISR=0x000236e1
--define_symbol xQueueGiveMutexRecursive=0x00023785
--define_symbol xQueueIsQueueEmptyFromISR=0x000237c5
--define_symbol xQueueIsQueueFullFromISR=0x000237e9
--define_symbol xQueuePeek=0x00023811
--define_symbol xQueuePeekFromISR=0x00023939
--define_symbol xQueueReceive=0x000239a5
--define_symbol xQueueReceiveFromISR=0x00023ad1
--define_symbol xQueueRemoveFromSet=0x00023b65
--define_symbol xQueueSelectFromSet=0x00023b87
--define_symbol xQueueSelectFromSetFromISR=0x00023b99
--define_symbol xQueueSemaphoreTake=0x00023bad
--define_symbol xQueueTakeMutexRecursive=0x00023d19
--define_symbol xTaskCheckForTimeOut=0x00023d5d
--define_symbol xTaskCreate=0x00023dcd
--define_symbol xTaskCreateStatic=0x00023e29
--define_symbol xTaskGetCurrentTaskHandle=0x00023e99
--define_symbol xTaskGetSchedulerState=0x00023ea5
--define_symbol xTaskGetTickCount=0x00023ec1
--define_symbol xTaskGetTickCountFromISR=0x00023ecd
--define_symbol xTaskIncrementTick=0x00023edd
--define_symbol xTaskPriorityDisinherit=0x00023fa9
--define_symbol xTaskPriorityInherit=0x0002403d
--define_symbol xTaskRemoveFromEventList=0x000240d1
--define_symbol xTaskResumeAll=0x00024151
--define_symbol xTaskResumeFromISR=0x00024219
--define_symbol xTimerCreate=0x000242a5
--define_symbol xTimerCreateStatic=0x000242d9
--define_symbol xTimerCreateTimerTask=0x00024311
--define_symbol xTimerGenericCommand=0x0002437d
--define_symbol xTimerGetExpiryTime=0x000243ed
--define_symbol xTimerGetTimerDaemonTaskHandle=0x0002440d
