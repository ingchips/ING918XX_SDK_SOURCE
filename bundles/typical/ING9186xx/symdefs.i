...
--define_symbol sysSetPublicDeviceAddr=0x00021a51
--define_symbol uuid128_to_str=0x00022185
--define_symbol uuid_add_bluetooth_prefix=0x000221dd
--define_symbol uuid_has_bluetooth_prefix=0x000221fd
--define_symbol uxQueueMessagesWaiting=0x00022241
--define_symbol uxQueueMessagesWaitingFromISR=0x00022269
--define_symbol uxQueueSpacesAvailable=0x00022285
--define_symbol uxTaskGetStackHighWaterMark=0x000222b1
--define_symbol vPortEnterCritical=0x00022369
--define_symbol vPortExitCritical=0x000223a9
--define_symbol vPortFree=0x000223d5
--define_symbol vPortSuppressTicksAndSleep=0x00022469
--define_symbol vPortValidateInterruptPriority=0x00022541
--define_symbol vQueueDelete=0x00022595
--define_symbol vQueueWaitForMessageRestricted=0x000225c1
--define_symbol vTaskDelay=0x00022609
--define_symbol vTaskInternalSetTimeOutState=0x00022655
--define_symbol vTaskMissedYield=0x00022665
--define_symbol vTaskPlaceOnEventList=0x00022671
--define_symbol vTaskPlaceOnEventListRestricted=0x000226a9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000226e9
--define_symbol vTaskStartScheduler=0x00022795
--define_symbol vTaskStepTick=0x00022825
--define_symbol vTaskSuspendAll=0x00022855
--define_symbol vTaskSwitchContext=0x00022865
--define_symbol xPortStartScheduler=0x0002290d
--define_symbol xQueueAddToSet=0x000229c9
--define_symbol xQueueCreateCountingSemaphore=0x000229ed
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a29
--define_symbol xQueueCreateMutex=0x00022a6d
--define_symbol xQueueCreateMutexStatic=0x00022a83
--define_symbol xQueueCreateSet=0x00022a9d
--define_symbol xQueueGenericCreate=0x00022aa5
--define_symbol xQueueGenericCreateStatic=0x00022af1
--define_symbol xQueueGenericReset=0x00022b59
--define_symbol xQueueGenericSend=0x00022be5
--define_symbol xQueueGenericSendFromISR=0x00022d51
--define_symbol xQueueGiveFromISR=0x00022e11
--define_symbol xQueueGiveMutexRecursive=0x00022eb5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022ef5
--define_symbol xQueueIsQueueFullFromISR=0x00022f19
--define_symbol xQueuePeek=0x00022f41
--define_symbol xQueuePeekFromISR=0x00023069
--define_symbol xQueueReceive=0x000230d5
--define_symbol xQueueReceiveFromISR=0x00023201
--define_symbol xQueueRemoveFromSet=0x00023295
--define_symbol xQueueSelectFromSet=0x000232b7
--define_symbol xQueueSelectFromSetFromISR=0x000232c9
--define_symbol xQueueSemaphoreTake=0x000232dd
--define_symbol xQueueTakeMutexRecursive=0x00023449
--define_symbol xTaskCheckForTimeOut=0x0002348d
--define_symbol xTaskCreate=0x000234fd
--define_symbol xTaskCreateStatic=0x00023559
--define_symbol xTaskGetCurrentTaskHandle=0x000235c9
--define_symbol xTaskGetSchedulerState=0x000235d5
--define_symbol xTaskGetTickCount=0x000235f1
--define_symbol xTaskGetTickCountFromISR=0x000235fd
--define_symbol xTaskIncrementTick=0x0002360d
--define_symbol xTaskPriorityDisinherit=0x000236d9
--define_symbol xTaskPriorityInherit=0x0002376d
--define_symbol xTaskRemoveFromEventList=0x00023801
--define_symbol xTaskResumeAll=0x00023881
--define_symbol xTimerCreate=0x00023949
--define_symbol xTimerCreateStatic=0x0002397d
--define_symbol xTimerCreateTimerTask=0x000239b5
--define_symbol xTimerGenericCommand=0x00023a21
--define_symbol xTimerGetExpiryTime=0x00023a91
