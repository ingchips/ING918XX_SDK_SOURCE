...
--define_symbol ll_set_conn_coded_scheme=0x0000d35d
--define_symbol ll_set_conn_tx_power=0x0000d389
--define_symbol ll_set_def_antenna=0x0000d3c5
--define_symbol ll_set_initiating_coded_scheme=0x0000d3e1
--define_symbol nibble_for_char=0x0001dbfd
--define_symbol platform_32k_rc_auto_tune=0x0001dcb5
--define_symbol platform_32k_rc_tune=0x0001dd31
--define_symbol platform_calibrate_32k=0x0001dd45
--define_symbol platform_config=0x0001dd49
--define_symbol platform_get_heap_status=0x0001ddf9
--define_symbol platform_get_us_time=0x0001de11
--define_symbol platform_get_version=0x0001de15
--define_symbol platform_hrng=0x0001de1d
--define_symbol platform_patch_rf_init_data=0x0001de25
--define_symbol platform_printf=0x0001de31
--define_symbol platform_raise_assertion=0x0001de45
--define_symbol platform_rand=0x0001de59
--define_symbol platform_read_info=0x0001de5d
--define_symbol platform_read_persistent_reg=0x0001de79
--define_symbol platform_reset=0x0001de89
--define_symbol platform_set_evt_callback=0x0001debd
--define_symbol platform_set_irq_callback=0x0001ded1
--define_symbol platform_set_rf_clk_source=0x0001df09
--define_symbol platform_set_rf_init_data=0x0001df15
--define_symbol platform_set_rf_power_mapping=0x0001df21
--define_symbol platform_shutdown=0x0001df2d
--define_symbol platform_switch_app=0x0001df31
--define_symbol platform_trace_raw=0x0001df5d
--define_symbol platform_write_persistent_reg=0x0001df71
--define_symbol printf_hexdump=0x0001df81
--define_symbol pvPortMalloc=0x0001ea7d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001eb65
--define_symbol pvTimerGetTimerID=0x0001eb7d
--define_symbol pxPortInitialiseStack=0x0001eba9
--define_symbol reverse_128=0x0001ed89
--define_symbol reverse_24=0x0001ed8f
--define_symbol reverse_48=0x0001ed95
--define_symbol reverse_56=0x0001ed9b
--define_symbol reverse_64=0x0001eda1
--define_symbol reverse_bd_addr=0x0001eda7
--define_symbol reverse_bytes=0x0001edad
--define_symbol sm_add_event_handler=0x0001f04d
--define_symbol sm_address_resolution_lookup=0x0001f179
--define_symbol sm_authenticated=0x0001f253
--define_symbol sm_authorization_decline=0x0001f261
--define_symbol sm_authorization_grant=0x0001f281
--define_symbol sm_authorization_state=0x0001f2a1
--define_symbol sm_bonding_decline=0x0001f2bd
--define_symbol sm_config=0x0001f695
--define_symbol sm_encryption_key_size=0x0001f7a1
--define_symbol sm_just_works_confirm=0x0001ff71
--define_symbol sm_le_device_key=0x000201c1
--define_symbol sm_passkey_input=0x00020259
--define_symbol sm_private_random_address_generation_get=0x000205e5
--define_symbol sm_private_random_address_generation_get_mode=0x000205ed
--define_symbol sm_private_random_address_generation_set_mode=0x000205f9
--define_symbol sm_private_random_address_generation_set_update_period=0x00020621
--define_symbol sm_register_oob_data_callback=0x00020659
--define_symbol sm_request_pairing=0x00020665
--define_symbol sm_send_security_request=0x0002109f
--define_symbol sm_set_accepted_stk_generation_methods=0x000210c5
--define_symbol sm_set_authentication_requirements=0x000210d1
--define_symbol sm_set_encryption_key_size_range=0x000210dd
--define_symbol sscanf_bd_addr=0x000213d9
--define_symbol sysSetPublicDeviceAddr=0x000216f1
--define_symbol uuid128_to_str=0x00021e25
--define_symbol uuid_add_bluetooth_prefix=0x00021e7d
--define_symbol uuid_has_bluetooth_prefix=0x00021e9d
--define_symbol uxQueueMessagesWaiting=0x00021ee1
--define_symbol uxQueueMessagesWaitingFromISR=0x00021f09
--define_symbol uxQueueSpacesAvailable=0x00021f25
--define_symbol vPortEnterCritical=0x00021fe9
--define_symbol vPortExitCritical=0x00022029
--define_symbol vPortFree=0x00022055
--define_symbol vPortSuppressTicksAndSleep=0x000220e9
--define_symbol vPortValidateInterruptPriority=0x000221c1
...
--define_symbol vTaskSuspendAll=0x000224d5
--define_symbol vTaskSwitchContext=0x000224e5
--define_symbol xPortStartScheduler=0x0002258d
--define_symbol xQueueAddToSet=0x00022649
--define_symbol xQueueCreateCountingSemaphore=0x0002266d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000226a9
--define_symbol xQueueCreateMutex=0x000226ed
--define_symbol xQueueCreateMutexStatic=0x00022703
--define_symbol xQueueCreateSet=0x0002271d
--define_symbol xQueueGenericCreate=0x00022725
--define_symbol xQueueGenericCreateStatic=0x00022771
--define_symbol xQueueGenericReset=0x000227d9
--define_symbol xQueueGenericSend=0x00022865
--define_symbol xQueueGenericSendFromISR=0x000229d1
--define_symbol xQueueGiveFromISR=0x00022a91
--define_symbol xQueueGiveMutexRecursive=0x00022b35
--define_symbol xQueueIsQueueEmptyFromISR=0x00022b75
--define_symbol xQueueIsQueueFullFromISR=0x00022b99
--define_symbol xQueuePeek=0x00022bc1
--define_symbol xQueuePeekFromISR=0x00022ce9
--define_symbol xQueueReceive=0x00022d55
--define_symbol xQueueReceiveFromISR=0x00022e81
--define_symbol xQueueRemoveFromSet=0x00022f15
--define_symbol xQueueSelectFromSet=0x00022f37
--define_symbol xQueueSelectFromSetFromISR=0x00022f49
--define_symbol xQueueSemaphoreTake=0x00022f5d
--define_symbol xQueueTakeMutexRecursive=0x000230c9
--define_symbol xTaskCheckForTimeOut=0x0002310d
--define_symbol xTaskCreate=0x0002317d
--define_symbol xTaskCreateStatic=0x000231d9
--define_symbol xTaskGetCurrentTaskHandle=0x00023249
--define_symbol xTaskGetSchedulerState=0x00023255
--define_symbol xTaskGetTickCount=0x00023271
--define_symbol xTaskGetTickCountFromISR=0x0002327d
--define_symbol xTaskIncrementTick=0x0002328d
--define_symbol xTaskPriorityDisinherit=0x00023359
--define_symbol xTaskPriorityInherit=0x000233ed
--define_symbol xTaskRemoveFromEventList=0x00023481
--define_symbol xTaskResumeAll=0x00023501
--define_symbol xTimerCreate=0x000235c9
--define_symbol xTimerCreateStatic=0x000235fd
--define_symbol xTimerCreateTimerTask=0x00023635
--define_symbol xTimerGenericCommand=0x000236a1
--define_symbol xTimerGetExpiryTime=0x00023711
