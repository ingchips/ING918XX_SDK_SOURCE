...
--define_symbol sm_just_works_confirm=0x000206a1
--define_symbol sm_le_device_key=0x000209dd
--define_symbol sm_passkey_input=0x00020a73
--define_symbol sm_private_random_address_generation_get=0x00020e21
--define_symbol sm_private_random_address_generation_get_mode=0x00020e29
--define_symbol sm_private_random_address_generation_set_mode=0x00020e35
--define_symbol sm_private_random_address_generation_set_update_period=0x00020e5d
--define_symbol sm_register_oob_data_callback=0x00020f99
--define_symbol sm_request_pairing=0x00020fa5
--define_symbol sm_send_security_request=0x000219c3
--define_symbol sm_set_accepted_stk_generation_methods=0x000219e9
--define_symbol sm_set_authentication_requirements=0x000219f5
--define_symbol sm_set_encryption_key_size_range=0x00021a01
--define_symbol sscanf_bd_addr=0x00021d5d
--define_symbol sysSetPublicDeviceAddr=0x000220c5
...
--define_symbol uxListRemove=0x000228d1
...
--define_symbol uxTaskPriorityGet=0x00022989
--define_symbol uxTaskPriorityGetFromISR=0x000229a5
--define_symbol vListInitialise=0x00022a57
--define_symbol vListInitialiseItem=0x00022a6d
--define_symbol vListInsert=0x00022a73
--define_symbol vListInsertEnd=0x00022aa3
--define_symbol vPortEndScheduler=0x00022abd
--define_symbol vPortEnterCritical=0x00022ae5
--define_symbol vPortExitCritical=0x00022b29
--define_symbol vPortFree=0x00022b59
--define_symbol vPortSuppressTicksAndSleep=0x00022bed
--define_symbol vPortValidateInterruptPriority=0x00022cf5
--define_symbol vQueueDelete=0x00022d4d
--define_symbol vQueueWaitForMessageRestricted=0x00022d79
--define_symbol vTaskDelay=0x00022dc1
--define_symbol vTaskInternalSetTimeOutState=0x00022e0d
--define_symbol vTaskMissedYield=0x00022e1d
--define_symbol vTaskPlaceOnEventList=0x00022e29
--define_symbol vTaskPlaceOnEventListRestricted=0x00022e61
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022ea1
--define_symbol vTaskPrioritySet=0x00022f4d
--define_symbol vTaskResume=0x00023015
--define_symbol vTaskStartScheduler=0x00023099
--define_symbol vTaskStepTick=0x00023129
--define_symbol vTaskSuspend=0x00023159
--define_symbol vTaskSuspendAll=0x00023215
--define_symbol vTaskSwitchContext=0x00023225
--define_symbol xPortStartScheduler=0x000232cd
--define_symbol xQueueAddToSet=0x0002338d
--define_symbol xQueueCreateCountingSemaphore=0x000233b1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000233ed
--define_symbol xQueueCreateMutex=0x00023431
--define_symbol xQueueCreateMutexStatic=0x00023447
--define_symbol xQueueCreateSet=0x00023461
--define_symbol xQueueGenericCreate=0x00023469
--define_symbol xQueueGenericCreateStatic=0x000234b5
--define_symbol xQueueGenericReset=0x0002351d
--define_symbol xQueueGenericSend=0x000235a9
--define_symbol xQueueGenericSendFromISR=0x00023715
--define_symbol xQueueGiveFromISR=0x000237d5
--define_symbol xQueueGiveMutexRecursive=0x00023879
--define_symbol xQueueIsQueueEmptyFromISR=0x000238b9
--define_symbol xQueueIsQueueFullFromISR=0x000238dd
--define_symbol xQueuePeek=0x00023905
--define_symbol xQueuePeekFromISR=0x00023a2d
--define_symbol xQueueReceive=0x00023a99
--define_symbol xQueueReceiveFromISR=0x00023bc5
--define_symbol xQueueRemoveFromSet=0x00023c59
--define_symbol xQueueSelectFromSet=0x00023c7b
--define_symbol xQueueSelectFromSetFromISR=0x00023c8d
--define_symbol xQueueSemaphoreTake=0x00023ca1
--define_symbol xQueueTakeMutexRecursive=0x00023e0d
--define_symbol xTaskCheckForTimeOut=0x00023e51
--define_symbol xTaskCreate=0x00023ec1
--define_symbol xTaskCreateStatic=0x00023f1d
--define_symbol xTaskGetCurrentTaskHandle=0x00023f8d
--define_symbol xTaskGetSchedulerState=0x00023f99
--define_symbol xTaskGetTickCount=0x00023fb5
--define_symbol xTaskGetTickCountFromISR=0x00023fc1
--define_symbol xTaskIncrementTick=0x00023fd1
--define_symbol xTaskPriorityDisinherit=0x0002409d
--define_symbol xTaskPriorityInherit=0x00024131
--define_symbol xTaskRemoveFromEventList=0x000241c5
--define_symbol xTaskResumeAll=0x00024245
--define_symbol xTaskResumeFromISR=0x0002430d
--define_symbol xTimerCreate=0x00024399
--define_symbol xTimerCreateStatic=0x000243cd
--define_symbol xTimerCreateTimerTask=0x00024405
--define_symbol xTimerGenericCommand=0x00024471
--define_symbol xTimerGetExpiryTime=0x000244e1
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00024501
