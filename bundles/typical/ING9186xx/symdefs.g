...
ll_set_conn_coded_scheme = 0x0000d35d;
ll_set_conn_tx_power = 0x0000d389;
ll_set_def_antenna = 0x0000d3c5;
ll_set_initiating_coded_scheme = 0x0000d3e1;
nibble_for_char = 0x0001dbfd;
platform_32k_rc_auto_tune = 0x0001dcb5;
platform_32k_rc_tune = 0x0001dd31;
platform_calibrate_32k = 0x0001dd45;
platform_config = 0x0001dd49;
platform_get_heap_status = 0x0001ddf9;
platform_get_us_time = 0x0001de11;
platform_get_version = 0x0001de15;
platform_hrng = 0x0001de1d;
platform_patch_rf_init_data = 0x0001de25;
platform_printf = 0x0001de31;
platform_raise_assertion = 0x0001de45;
platform_rand = 0x0001de59;
platform_read_info = 0x0001de5d;
platform_read_persistent_reg = 0x0001de79;
platform_reset = 0x0001de89;
platform_set_evt_callback = 0x0001debd;
platform_set_irq_callback = 0x0001ded1;
platform_set_rf_clk_source = 0x0001df09;
platform_set_rf_init_data = 0x0001df15;
platform_set_rf_power_mapping = 0x0001df21;
platform_shutdown = 0x0001df2d;
platform_switch_app = 0x0001df31;
platform_trace_raw = 0x0001df5d;
platform_write_persistent_reg = 0x0001df71;
printf_hexdump = 0x0001df81;
pvPortMalloc = 0x0001ea7d;
pvTaskIncrementMutexHeldCount = 0x0001eb65;
pvTimerGetTimerID = 0x0001eb7d;
pxPortInitialiseStack = 0x0001eba9;
reverse_128 = 0x0001ed89;
reverse_24 = 0x0001ed8f;
reverse_48 = 0x0001ed95;
reverse_56 = 0x0001ed9b;
reverse_64 = 0x0001eda1;
reverse_bd_addr = 0x0001eda7;
reverse_bytes = 0x0001edad;
sm_add_event_handler = 0x0001f04d;
sm_address_resolution_lookup = 0x0001f179;
sm_authenticated = 0x0001f253;
sm_authorization_decline = 0x0001f261;
sm_authorization_grant = 0x0001f281;
sm_authorization_state = 0x0001f2a1;
sm_bonding_decline = 0x0001f2bd;
sm_config = 0x0001f695;
sm_encryption_key_size = 0x0001f7a1;
sm_just_works_confirm = 0x0001ff71;
sm_le_device_key = 0x000201c1;
sm_passkey_input = 0x00020259;
sm_private_random_address_generation_get = 0x000205e5;
sm_private_random_address_generation_get_mode = 0x000205ed;
sm_private_random_address_generation_set_mode = 0x000205f9;
sm_private_random_address_generation_set_update_period = 0x00020621;
sm_register_oob_data_callback = 0x00020659;
sm_request_pairing = 0x00020665;
sm_send_security_request = 0x0002109f;
sm_set_accepted_stk_generation_methods = 0x000210c5;
sm_set_authentication_requirements = 0x000210d1;
sm_set_encryption_key_size_range = 0x000210dd;
sscanf_bd_addr = 0x000213d9;
sysSetPublicDeviceAddr = 0x000216f1;
uuid128_to_str = 0x00021e25;
uuid_add_bluetooth_prefix = 0x00021e7d;
uuid_has_bluetooth_prefix = 0x00021e9d;
uxQueueMessagesWaiting = 0x00021ee1;
uxQueueMessagesWaitingFromISR = 0x00021f09;
uxQueueSpacesAvailable = 0x00021f25;
vPortEnterCritical = 0x00021fe9;
vPortExitCritical = 0x00022029;
vPortFree = 0x00022055;
vPortSuppressTicksAndSleep = 0x000220e9;
vPortValidateInterruptPriority = 0x000221c1;
...
vTaskStartScheduler = 0x00022415;
vTaskStepTick = 0x000224a5;
vTaskSuspendAll = 0x000224d5;
vTaskSwitchContext = 0x000224e5;
xPortStartScheduler = 0x0002258d;
xQueueAddToSet = 0x00022649;
xQueueCreateCountingSemaphore = 0x0002266d;
xQueueCreateCountingSemaphoreStatic = 0x000226a9;
xQueueCreateMutex = 0x000226ed;
xQueueCreateMutexStatic = 0x00022703;
xQueueCreateSet = 0x0002271d;
xQueueGenericCreate = 0x00022725;
xQueueGenericCreateStatic = 0x00022771;
xQueueGenericReset = 0x000227d9;
xQueueGenericSend = 0x00022865;
xQueueGenericSendFromISR = 0x000229d1;
xQueueGiveFromISR = 0x00022a91;
xQueueGiveMutexRecursive = 0x00022b35;
xQueueIsQueueEmptyFromISR = 0x00022b75;
xQueueIsQueueFullFromISR = 0x00022b99;
xQueuePeek = 0x00022bc1;
xQueuePeekFromISR = 0x00022ce9;
xQueueReceive = 0x00022d55;
xQueueReceiveFromISR = 0x00022e81;
xQueueRemoveFromSet = 0x00022f15;
xQueueSelectFromSet = 0x00022f37;
xQueueSelectFromSetFromISR = 0x00022f49;
xQueueSemaphoreTake = 0x00022f5d;
xQueueTakeMutexRecursive = 0x000230c9;
xTaskCheckForTimeOut = 0x0002310d;
xTaskCreate = 0x0002317d;
xTaskCreateStatic = 0x000231d9;
xTaskGetCurrentTaskHandle = 0x00023249;
xTaskGetSchedulerState = 0x00023255;
xTaskGetTickCount = 0x00023271;
xTaskGetTickCountFromISR = 0x0002327d;
xTaskIncrementTick = 0x0002328d;
xTaskPriorityDisinherit = 0x00023359;
xTaskPriorityInherit = 0x000233ed;
xTaskRemoveFromEventList = 0x00023481;
xTaskResumeAll = 0x00023501;
xTimerCreate = 0x000235c9;
xTimerCreateStatic = 0x000235fd;
xTimerCreateTimerTask = 0x00023635;
xTimerGenericCommand = 0x000236a1;
xTimerGetExpiryTime = 0x00023711;
