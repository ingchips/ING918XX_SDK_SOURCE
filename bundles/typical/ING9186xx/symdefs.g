...
sysSetPublicDeviceAddr = 0x00021c65;
uuid128_to_str = 0x000223cd;
uuid_add_bluetooth_prefix = 0x00022425;
uuid_has_bluetooth_prefix = 0x00022445;
uxQueueMessagesWaiting = 0x00022489;
uxQueueMessagesWaitingFromISR = 0x000224b1;
uxQueueSpacesAvailable = 0x000224cd;
uxTaskGetStackHighWaterMark = 0x000224f9;
vPortEnterCritical = 0x0002261d;
vPortExitCritical = 0x0002265d;
vPortFree = 0x00022689;
vPortSuppressTicksAndSleep = 0x0002271d;
vPortValidateInterruptPriority = 0x000227f5;
vQueueDelete = 0x00022849;
vQueueWaitForMessageRestricted = 0x00022875;
vTaskDelay = 0x000228bd;
vTaskInternalSetTimeOutState = 0x00022909;
vTaskMissedYield = 0x00022919;
vTaskPlaceOnEventList = 0x00022925;
vTaskPlaceOnEventListRestricted = 0x0002295d;
vTaskPriorityDisinheritAfterTimeout = 0x0002299d;
vTaskResume = 0x00022a49;
vTaskStartScheduler = 0x00022acd;
vTaskStepTick = 0x00022b5d;
vTaskSuspend = 0x00022b8d;
vTaskSuspendAll = 0x00022c49;
vTaskSwitchContext = 0x00022c59;
xPortStartScheduler = 0x00022d01;
xQueueAddToSet = 0x00022dbd;
xQueueCreateCountingSemaphore = 0x00022de1;
xQueueCreateCountingSemaphoreStatic = 0x00022e1d;
xQueueCreateMutex = 0x00022e61;
xQueueCreateMutexStatic = 0x00022e77;
xQueueCreateSet = 0x00022e91;
xQueueGenericCreate = 0x00022e99;
xQueueGenericCreateStatic = 0x00022ee5;
xQueueGenericReset = 0x00022f4d;
xQueueGenericSend = 0x00022fd9;
xQueueGenericSendFromISR = 0x00023145;
xQueueGiveFromISR = 0x00023205;
xQueueGiveMutexRecursive = 0x000232a9;
xQueueIsQueueEmptyFromISR = 0x000232e9;
xQueueIsQueueFullFromISR = 0x0002330d;
xQueuePeek = 0x00023335;
xQueuePeekFromISR = 0x0002345d;
xQueueReceive = 0x000234c9;
xQueueReceiveFromISR = 0x000235f5;
xQueueRemoveFromSet = 0x00023689;
xQueueSelectFromSet = 0x000236ab;
xQueueSelectFromSetFromISR = 0x000236bd;
xQueueSemaphoreTake = 0x000236d1;
xQueueTakeMutexRecursive = 0x0002383d;
xTaskCheckForTimeOut = 0x00023881;
xTaskCreate = 0x000238f1;
xTaskCreateStatic = 0x0002394d;
xTaskGetCurrentTaskHandle = 0x000239bd;
xTaskGetSchedulerState = 0x000239c9;
xTaskGetTickCount = 0x000239e5;
xTaskGetTickCountFromISR = 0x000239f1;
xTaskIncrementTick = 0x00023a01;
xTaskPriorityDisinherit = 0x00023acd;
xTaskPriorityInherit = 0x00023b61;
xTaskRemoveFromEventList = 0x00023bf5;
xTaskResumeAll = 0x00023c75;
xTaskResumeFromISR = 0x00023d3d;
xTimerCreate = 0x00023dc9;
xTimerCreateStatic = 0x00023dfd;
xTimerCreateTimerTask = 0x00023e35;
xTimerGenericCommand = 0x00023ea1;
xTimerGetExpiryTime = 0x00023f11;
