...
pvPortMalloc = 0x0001f099;
pvTaskIncrementMutexHeldCount = 0x0001f181;
pvTimerGetTimerID = 0x0001f199;
pxPortInitialiseStack = 0x0001f1c5;
reverse_128 = 0x0001f3a5;
reverse_24 = 0x0001f3ab;
reverse_48 = 0x0001f3b1;
reverse_56 = 0x0001f3b7;
reverse_64 = 0x0001f3bd;
reverse_bd_addr = 0x0001f3c3;
reverse_bytes = 0x0001f3c9;
sm_add_event_handler = 0x0001f689;
sm_address_resolution_lookup = 0x0001f7b5;
sm_authenticated = 0x0001fb01;
sm_authorization_decline = 0x0001fb0f;
sm_authorization_grant = 0x0001fb2f;
sm_authorization_state = 0x0001fb4f;
sm_bonding_decline = 0x0001fb69;
sm_config = 0x0001ff35;
sm_config_conn = 0x0001ff4d;
sm_encryption_key_size = 0x000200ab;
sm_just_works_confirm = 0x000204d1;
sm_le_device_key = 0x000206fd;
sm_passkey_input = 0x00020793;
...
sm_register_oob_data_callback = 0x00020c51;
sm_request_pairing = 0x00020c5d;
sm_send_security_request = 0x0002159b;
...
sscanf_bd_addr = 0x000218ad;
sysSetPublicDeviceAddr = 0x00021bf1;
uuid128_to_str = 0x00022359;
uuid_add_bluetooth_prefix = 0x000223b1;
uuid_has_bluetooth_prefix = 0x000223d1;
uxQueueMessagesWaiting = 0x00022415;
uxQueueMessagesWaitingFromISR = 0x0002243d;
uxQueueSpacesAvailable = 0x00022459;
uxTaskGetStackHighWaterMark = 0x00022485;
vPortEnterCritical = 0x000225a9;
vPortExitCritical = 0x000225e9;
vPortFree = 0x00022615;
vPortSuppressTicksAndSleep = 0x000226a9;
vPortValidateInterruptPriority = 0x00022781;
vQueueDelete = 0x000227d5;
vQueueWaitForMessageRestricted = 0x00022801;
vTaskDelay = 0x00022849;
vTaskInternalSetTimeOutState = 0x00022895;
vTaskMissedYield = 0x000228a5;
vTaskPlaceOnEventList = 0x000228b1;
vTaskPlaceOnEventListRestricted = 0x000228e9;
vTaskPriorityDisinheritAfterTimeout = 0x00022929;
vTaskResume = 0x000229d5;
vTaskStartScheduler = 0x00022a59;
vTaskStepTick = 0x00022ae9;
vTaskSuspend = 0x00022b19;
vTaskSuspendAll = 0x00022bd5;
vTaskSwitchContext = 0x00022be5;
xPortStartScheduler = 0x00022c8d;
xQueueAddToSet = 0x00022d49;
xQueueCreateCountingSemaphore = 0x00022d6d;
xQueueCreateCountingSemaphoreStatic = 0x00022da9;
xQueueCreateMutex = 0x00022ded;
xQueueCreateMutexStatic = 0x00022e03;
xQueueCreateSet = 0x00022e1d;
xQueueGenericCreate = 0x00022e25;
xQueueGenericCreateStatic = 0x00022e71;
xQueueGenericReset = 0x00022ed9;
xQueueGenericSend = 0x00022f65;
xQueueGenericSendFromISR = 0x000230d1;
xQueueGiveFromISR = 0x00023191;
xQueueGiveMutexRecursive = 0x00023235;
xQueueIsQueueEmptyFromISR = 0x00023275;
xQueueIsQueueFullFromISR = 0x00023299;
xQueuePeek = 0x000232c1;
xQueuePeekFromISR = 0x000233e9;
xQueueReceive = 0x00023455;
xQueueReceiveFromISR = 0x00023581;
xQueueRemoveFromSet = 0x00023615;
xQueueSelectFromSet = 0x00023637;
xQueueSelectFromSetFromISR = 0x00023649;
xQueueSemaphoreTake = 0x0002365d;
xQueueTakeMutexRecursive = 0x000237c9;
xTaskCheckForTimeOut = 0x0002380d;
xTaskCreate = 0x0002387d;
xTaskCreateStatic = 0x000238d9;
xTaskGetCurrentTaskHandle = 0x00023949;
xTaskGetSchedulerState = 0x00023955;
xTaskGetTickCount = 0x00023971;
xTaskGetTickCountFromISR = 0x0002397d;
xTaskIncrementTick = 0x0002398d;
xTaskPriorityDisinherit = 0x00023a59;
xTaskPriorityInherit = 0x00023aed;
xTaskRemoveFromEventList = 0x00023b81;
xTaskResumeAll = 0x00023c01;
xTaskResumeFromISR = 0x00023cc9;
xTimerCreate = 0x00023d55;
xTimerCreateStatic = 0x00023d89;
xTimerCreateTimerTask = 0x00023dc1;
xTimerGenericCommand = 0x00023e2d;
xTimerGetExpiryTime = 0x00023e9d;
