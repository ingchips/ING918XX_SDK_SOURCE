...
platform_get_us_time = 0x0001e2ad;
platform_get_version = 0x0001e2b1;
platform_hrng = 0x0001e2b9;
platform_install_isr_stack = 0x0001e2c1;
platform_patch_rf_init_data = 0x0001e2cd;
platform_printf = 0x0001e2d9;
platform_raise_assertion = 0x0001e2ed;
platform_rand = 0x0001e301;
platform_read_info = 0x0001e305;
platform_read_persistent_reg = 0x0001e321;
platform_reset = 0x0001e331;
platform_set_evt_callback = 0x0001e365;
platform_set_irq_callback = 0x0001e379;
platform_set_rf_clk_source = 0x0001e3b1;
platform_set_rf_init_data = 0x0001e3bd;
platform_set_rf_power_mapping = 0x0001e3c9;
platform_shutdown = 0x0001e3d5;
platform_switch_app = 0x0001e3d9;
platform_trace_raw = 0x0001e405;
platform_write_persistent_reg = 0x0001e419;
printf_hexdump = 0x0001e429;
pvPortMalloc = 0x0001eef9;
pvTaskIncrementMutexHeldCount = 0x0001efe1;
pvTimerGetTimerID = 0x0001eff9;
pxPortInitialiseStack = 0x0001f025;
reverse_128 = 0x0001f205;
reverse_24 = 0x0001f20b;
reverse_48 = 0x0001f211;
reverse_56 = 0x0001f217;
reverse_64 = 0x0001f21d;
reverse_bd_addr = 0x0001f223;
reverse_bytes = 0x0001f229;
sm_add_event_handler = 0x0001f4e9;
sm_address_resolution_lookup = 0x0001f615;
sm_authenticated = 0x0001f6ef;
sm_authorization_decline = 0x0001f6fd;
sm_authorization_grant = 0x0001f71d;
sm_authorization_state = 0x0001f73d;
sm_bonding_decline = 0x0001f759;
sm_config = 0x0001fb31;
sm_encryption_key_size = 0x0001fc3d;
sm_just_works_confirm = 0x000203f1;
sm_le_device_key = 0x00020649;
sm_passkey_input = 0x000206e1;
sm_private_random_address_generation_get = 0x00020a6d;
sm_private_random_address_generation_get_mode = 0x00020a75;
sm_private_random_address_generation_set_mode = 0x00020a81;
sm_private_random_address_generation_set_update_period = 0x00020aa9;
sm_register_oob_data_callback = 0x00020ae1;
sm_request_pairing = 0x00020aed;
sm_send_security_request = 0x0002153d;
...
sscanf_bd_addr = 0x0002186d;
sysSetPublicDeviceAddr = 0x00021bb1;
...
vPortEnterCritical = 0x00022539;
vPortExitCritical = 0x00022579;
vPortFree = 0x000225a5;
vPortSuppressTicksAndSleep = 0x00022639;
vPortValidateInterruptPriority = 0x00022711;
vQueueDelete = 0x00022765;
vQueueWaitForMessageRestricted = 0x00022791;
vTaskDelay = 0x000227d9;
vTaskInternalSetTimeOutState = 0x00022825;
vTaskMissedYield = 0x00022835;
vTaskPlaceOnEventList = 0x00022841;
vTaskPlaceOnEventListRestricted = 0x00022879;
vTaskPriorityDisinheritAfterTimeout = 0x000228b9;
vTaskStartScheduler = 0x00022965;
vTaskStepTick = 0x000229f5;
vTaskSuspendAll = 0x00022a25;
vTaskSwitchContext = 0x00022a35;
xPortStartScheduler = 0x00022add;
xQueueAddToSet = 0x00022b99;
xQueueCreateCountingSemaphore = 0x00022bbd;
xQueueCreateCountingSemaphoreStatic = 0x00022bf9;
xQueueCreateMutex = 0x00022c3d;
xQueueCreateMutexStatic = 0x00022c53;
xQueueCreateSet = 0x00022c6d;
xQueueGenericCreate = 0x00022c75;
xQueueGenericCreateStatic = 0x00022cc1;
xQueueGenericReset = 0x00022d29;
xQueueGenericSend = 0x00022db5;
xQueueGenericSendFromISR = 0x00022f21;
xQueueGiveFromISR = 0x00022fe1;
xQueueGiveMutexRecursive = 0x00023085;
xQueueIsQueueEmptyFromISR = 0x000230c5;
xQueueIsQueueFullFromISR = 0x000230e9;
xQueuePeek = 0x00023111;
xQueuePeekFromISR = 0x00023239;
xQueueReceive = 0x000232a5;
xQueueReceiveFromISR = 0x000233d1;
xQueueRemoveFromSet = 0x00023465;
xQueueSelectFromSet = 0x00023487;
xQueueSelectFromSetFromISR = 0x00023499;
xQueueSemaphoreTake = 0x000234ad;
xQueueTakeMutexRecursive = 0x00023619;
xTaskCheckForTimeOut = 0x0002365d;
xTaskCreate = 0x000236cd;
xTaskCreateStatic = 0x00023729;
xTaskGetCurrentTaskHandle = 0x00023799;
xTaskGetSchedulerState = 0x000237a5;
xTaskGetTickCount = 0x000237c1;
xTaskGetTickCountFromISR = 0x000237cd;
xTaskIncrementTick = 0x000237dd;
xTaskPriorityDisinherit = 0x000238a9;
xTaskPriorityInherit = 0x0002393d;
xTaskRemoveFromEventList = 0x000239d1;
xTaskResumeAll = 0x00023a51;
xTimerCreate = 0x00023b19;
xTimerCreateStatic = 0x00023b4d;
xTimerCreateTimerTask = 0x00023b85;
xTimerGenericCommand = 0x00023bf1;
xTimerGetExpiryTime = 0x00023c61;
