...
nibble_for_char = 0x0001e1e9;
platform_32k_rc_auto_tune = 0x0001e285;
platform_32k_rc_tune = 0x0001e301;
platform_calibrate_32k = 0x0001e315;
platform_config = 0x0001e319;
platform_get_heap_status = 0x0001e3d1;
platform_get_us_time = 0x0001e3e9;
platform_get_version = 0x0001e3ed;
platform_hrng = 0x0001e3f5;
platform_install_isr_stack = 0x0001e3fd;
platform_patch_rf_init_data = 0x0001e409;
platform_printf = 0x0001e415;
platform_raise_assertion = 0x0001e429;
platform_rand = 0x0001e43d;
platform_read_info = 0x0001e441;
platform_read_persistent_reg = 0x0001e45d;
platform_reset = 0x0001e46d;
platform_set_evt_callback = 0x0001e4a1;
platform_set_irq_callback = 0x0001e4b5;
platform_set_rf_clk_source = 0x0001e4ed;
platform_set_rf_init_data = 0x0001e4f9;
platform_set_rf_power_mapping = 0x0001e505;
platform_shutdown = 0x0001e511;
platform_switch_app = 0x0001e515;
platform_trace_raw = 0x0001e541;
platform_write_persistent_reg = 0x0001e555;
printf_hexdump = 0x0001e565;
pvPortMalloc = 0x0001f035;
pvTaskIncrementMutexHeldCount = 0x0001f11d;
pvTimerGetTimerID = 0x0001f135;
pxPortInitialiseStack = 0x0001f161;
reverse_128 = 0x0001f341;
reverse_24 = 0x0001f347;
reverse_48 = 0x0001f34d;
reverse_56 = 0x0001f353;
reverse_64 = 0x0001f359;
reverse_bd_addr = 0x0001f35f;
reverse_bytes = 0x0001f365;
sm_add_event_handler = 0x0001f625;
sm_address_resolution_lookup = 0x0001f751;
sm_authenticated = 0x0001fa9d;
sm_authorization_decline = 0x0001faab;
sm_authorization_grant = 0x0001facb;
sm_authorization_state = 0x0001faeb;
sm_bonding_decline = 0x0001fb05;
sm_config = 0x0001fed1;
sm_config_conn = 0x0001fee9;
sm_encryption_key_size = 0x00020047;
sm_just_works_confirm = 0x0002046d;
sm_le_device_key = 0x00020699;
sm_passkey_input = 0x0002072f;
sm_private_random_address_generation_get = 0x00020a75;
sm_private_random_address_generation_get_mode = 0x00020a7d;
sm_private_random_address_generation_set_mode = 0x00020a89;
sm_private_random_address_generation_set_update_period = 0x00020ab1;
sm_register_oob_data_callback = 0x00020bed;
sm_request_pairing = 0x00020bf9;
sm_send_security_request = 0x00021537;
sm_set_accepted_stk_generation_methods = 0x0002155d;
sm_set_authentication_requirements = 0x00021569;
sm_set_encryption_key_size_range = 0x00021575;
sscanf_bd_addr = 0x00021849;
sysSetPublicDeviceAddr = 0x00021b8d;
...
vPortEnterCritical = 0x00022515;
vPortExitCritical = 0x00022555;
vPortFree = 0x00022581;
vPortSuppressTicksAndSleep = 0x00022615;
vPortValidateInterruptPriority = 0x000226ed;
vQueueDelete = 0x00022741;
vQueueWaitForMessageRestricted = 0x0002276d;
vTaskDelay = 0x000227b5;
vTaskInternalSetTimeOutState = 0x00022801;
vTaskMissedYield = 0x00022811;
vTaskPlaceOnEventList = 0x0002281d;
vTaskPlaceOnEventListRestricted = 0x00022855;
vTaskPriorityDisinheritAfterTimeout = 0x00022895;
vTaskStartScheduler = 0x00022941;
vTaskStepTick = 0x000229d1;
vTaskSuspendAll = 0x00022a01;
vTaskSwitchContext = 0x00022a11;
xPortStartScheduler = 0x00022ab9;
xQueueAddToSet = 0x00022b75;
xQueueCreateCountingSemaphore = 0x00022b99;
xQueueCreateCountingSemaphoreStatic = 0x00022bd5;
xQueueCreateMutex = 0x00022c19;
xQueueCreateMutexStatic = 0x00022c2f;
xQueueCreateSet = 0x00022c49;
xQueueGenericCreate = 0x00022c51;
xQueueGenericCreateStatic = 0x00022c9d;
xQueueGenericReset = 0x00022d05;
xQueueGenericSend = 0x00022d91;
xQueueGenericSendFromISR = 0x00022efd;
xQueueGiveFromISR = 0x00022fbd;
xQueueGiveMutexRecursive = 0x00023061;
xQueueIsQueueEmptyFromISR = 0x000230a1;
xQueueIsQueueFullFromISR = 0x000230c5;
xQueuePeek = 0x000230ed;
xQueuePeekFromISR = 0x00023215;
xQueueReceive = 0x00023281;
xQueueReceiveFromISR = 0x000233ad;
xQueueRemoveFromSet = 0x00023441;
xQueueSelectFromSet = 0x00023463;
xQueueSelectFromSetFromISR = 0x00023475;
xQueueSemaphoreTake = 0x00023489;
xQueueTakeMutexRecursive = 0x000235f5;
xTaskCheckForTimeOut = 0x00023639;
xTaskCreate = 0x000236a9;
xTaskCreateStatic = 0x00023705;
xTaskGetCurrentTaskHandle = 0x00023775;
xTaskGetSchedulerState = 0x00023781;
xTaskGetTickCount = 0x0002379d;
xTaskGetTickCountFromISR = 0x000237a9;
xTaskIncrementTick = 0x000237b9;
xTaskPriorityDisinherit = 0x00023885;
xTaskPriorityInherit = 0x00023919;
xTaskRemoveFromEventList = 0x000239ad;
xTaskResumeAll = 0x00023a2d;
xTimerCreate = 0x00023af5;
xTimerCreateStatic = 0x00023b29;
xTimerCreateTimerTask = 0x00023b61;
xTimerGenericCommand = 0x00023bcd;
xTimerGetExpiryTime = 0x00023c3d;
