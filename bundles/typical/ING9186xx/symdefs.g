...
nibble_for_char = 0x0001e2a9;
platform_32k_rc_auto_tune = 0x0001e345;
platform_32k_rc_tune = 0x0001e3c1;
platform_calibrate_32k = 0x0001e3d5;
platform_config = 0x0001e3d9;
platform_get_heap_status = 0x0001e499;
platform_get_us_time = 0x0001e4b1;
platform_get_version = 0x0001e4b5;
platform_hrng = 0x0001e4bd;
platform_install_isr_stack = 0x0001e4c5;
platform_patch_rf_init_data = 0x0001e4d1;
...
platform_set_evt_callback = 0x0001e569;
platform_set_irq_callback = 0x0001e57d;
platform_set_rf_clk_source = 0x0001e5b5;
platform_set_rf_init_data = 0x0001e5c1;
platform_set_rf_power_mapping = 0x0001e5cd;
platform_shutdown = 0x0001e5d9;
platform_switch_app = 0x0001e5dd;
platform_trace_raw = 0x0001e609;
platform_write_persistent_reg = 0x0001e621;
printf_hexdump = 0x0001e631;
pvPortMalloc = 0x0001f13d;
pvTaskIncrementMutexHeldCount = 0x0001f225;
pvTimerGetTimerID = 0x0001f23d;
pxPortInitialiseStack = 0x0001f269;
reverse_128 = 0x0001f449;
reverse_24 = 0x0001f44f;
reverse_48 = 0x0001f455;
reverse_56 = 0x0001f45b;
reverse_64 = 0x0001f461;
reverse_bd_addr = 0x0001f467;
reverse_bytes = 0x0001f46d;
sm_add_event_handler = 0x0001f72d;
sm_address_resolution_lookup = 0x0001f885;
sm_authenticated = 0x0001fbd1;
sm_authorization_decline = 0x0001fbdf;
sm_authorization_grant = 0x0001fbff;
sm_authorization_state = 0x0001fc1f;
sm_bonding_decline = 0x0001fc39;
sm_config = 0x00020059;
sm_config_conn = 0x00020071;
sm_encryption_key_size = 0x000201f7;
sm_just_works_confirm = 0x00020725;
sm_le_device_key = 0x00020a61;
sm_passkey_input = 0x00020af7;
sm_private_random_address_generation_get = 0x00020e9d;
sm_private_random_address_generation_get_mode = 0x00020ea5;
sm_private_random_address_generation_set_mode = 0x00020eb1;
sm_private_random_address_generation_set_update_period = 0x00020ed9;
sm_register_oob_data_callback = 0x00021015;
sm_request_pairing = 0x00021021;
sm_send_security_request = 0x00021a1b;
sm_set_accepted_stk_generation_methods = 0x00021a41;
sm_set_authentication_requirements = 0x00021a4d;
sm_set_encryption_key_size_range = 0x00021a59;
sscanf_bd_addr = 0x00021db5;
sysSetPublicDeviceAddr = 0x0002211d;
uuid128_to_str = 0x000228a1;
uuid_add_bluetooth_prefix = 0x000228f9;
uuid_has_bluetooth_prefix = 0x00022919;
uxQueueMessagesWaiting = 0x0002295d;
uxQueueMessagesWaitingFromISR = 0x00022985;
uxQueueSpacesAvailable = 0x000229a1;
uxTaskGetStackHighWaterMark = 0x000229cd;
vPortEnterCritical = 0x00022ad9;
vPortExitCritical = 0x00022b1d;
vPortFree = 0x00022b4d;
vPortSuppressTicksAndSleep = 0x00022be1;
vPortValidateInterruptPriority = 0x00022d01;
vQueueDelete = 0x00022d59;
vQueueWaitForMessageRestricted = 0x00022d85;
vTaskDelay = 0x00022dcd;
vTaskInternalSetTimeOutState = 0x00022e19;
vTaskMissedYield = 0x00022e29;
vTaskPlaceOnEventList = 0x00022e35;
vTaskPlaceOnEventListRestricted = 0x00022e6d;
vTaskPriorityDisinheritAfterTimeout = 0x00022ead;
vTaskResume = 0x00022f59;
vTaskStartScheduler = 0x00022fdd;
vTaskStepTick = 0x0002306d;
vTaskSuspend = 0x0002309d;
vTaskSuspendAll = 0x00023159;
vTaskSwitchContext = 0x00023169;
xPortStartScheduler = 0x00023211;
xQueueAddToSet = 0x000232d5;
xQueueCreateCountingSemaphore = 0x000232f9;
xQueueCreateCountingSemaphoreStatic = 0x00023335;
xQueueCreateMutex = 0x00023379;
xQueueCreateMutexStatic = 0x0002338f;
xQueueCreateSet = 0x000233a9;
xQueueGenericCreate = 0x000233b1;
xQueueGenericCreateStatic = 0x000233fd;
xQueueGenericReset = 0x00023465;
xQueueGenericSend = 0x000234f1;
xQueueGenericSendFromISR = 0x0002365d;
xQueueGiveFromISR = 0x0002371d;
xQueueGiveMutexRecursive = 0x000237c1;
xQueueIsQueueEmptyFromISR = 0x00023801;
xQueueIsQueueFullFromISR = 0x00023825;
xQueuePeek = 0x0002384d;
xQueuePeekFromISR = 0x00023975;
xQueueReceive = 0x000239e1;
xQueueReceiveFromISR = 0x00023b0d;
xQueueRemoveFromSet = 0x00023ba1;
xQueueSelectFromSet = 0x00023bc3;
xQueueSelectFromSetFromISR = 0x00023bd5;
xQueueSemaphoreTake = 0x00023be9;
xQueueTakeMutexRecursive = 0x00023d55;
xTaskCheckForTimeOut = 0x00023d99;
xTaskCreate = 0x00023e09;
xTaskCreateStatic = 0x00023e65;
xTaskGetCurrentTaskHandle = 0x00023ed5;
xTaskGetSchedulerState = 0x00023ee1;
xTaskGetTickCount = 0x00023efd;
xTaskGetTickCountFromISR = 0x00023f09;
xTaskIncrementTick = 0x00023f19;
xTaskPriorityDisinherit = 0x00023fe5;
xTaskPriorityInherit = 0x00024079;
xTaskRemoveFromEventList = 0x0002410d;
xTaskResumeAll = 0x0002418d;
xTaskResumeFromISR = 0x00024255;
xTimerCreate = 0x000242e1;
xTimerCreateStatic = 0x00024315;
xTimerCreateTimerTask = 0x0002434d;
xTimerGenericCommand = 0x000243b9;
xTimerGetExpiryTime = 0x00024429;
