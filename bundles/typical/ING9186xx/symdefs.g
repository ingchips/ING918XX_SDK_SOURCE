...
platform_get_heap_status = 0x0001e489;
platform_get_us_time = 0x0001e4a1;
platform_get_version = 0x0001e4a5;
platform_hrng = 0x0001e4ad;
platform_install_isr_stack = 0x0001e4b5;
...
platform_read_persistent_reg = 0x0001e515;
platform_reset = 0x0001e525;
...
pvPortMalloc = 0x0001f125;
pvTaskIncrementMutexHeldCount = 0x0001f20d;
pvTimerGetTimerID = 0x0001f225;
pxPortInitialiseStack = 0x0001f251;
reverse_128 = 0x0001f431;
reverse_24 = 0x0001f437;
reverse_48 = 0x0001f43d;
reverse_56 = 0x0001f443;
reverse_64 = 0x0001f449;
reverse_bd_addr = 0x0001f44f;
reverse_bytes = 0x0001f455;
sm_add_event_handler = 0x0001f715;
sm_address_resolution_lookup = 0x0001f841;
sm_authenticated = 0x0001fb8d;
sm_authorization_decline = 0x0001fb9b;
sm_authorization_grant = 0x0001fbbb;
sm_authorization_state = 0x0001fbdb;
sm_bonding_decline = 0x0001fbf5;
sm_config = 0x0001ffc1;
sm_config_conn = 0x0001ffd9;
sm_encryption_key_size = 0x00020137;
sm_just_works_confirm = 0x0002055d;
sm_le_device_key = 0x00020789;
sm_passkey_input = 0x0002081f;
sm_private_random_address_generation_get = 0x00020b65;
sm_private_random_address_generation_get_mode = 0x00020b6d;
sm_private_random_address_generation_set_mode = 0x00020b79;
sm_private_random_address_generation_set_update_period = 0x00020ba1;
sm_register_oob_data_callback = 0x00020cdd;
sm_request_pairing = 0x00020ce9;
sm_send_security_request = 0x00021627;
sm_set_accepted_stk_generation_methods = 0x0002164d;
sm_set_authentication_requirements = 0x00021659;
sm_set_encryption_key_size_range = 0x00021665;
sscanf_bd_addr = 0x00021939;
sysSetPublicDeviceAddr = 0x00021c71;
uuid128_to_str = 0x000223d9;
uuid_add_bluetooth_prefix = 0x00022431;
uuid_has_bluetooth_prefix = 0x00022451;
uxQueueMessagesWaiting = 0x00022495;
uxQueueMessagesWaitingFromISR = 0x000224bd;
uxQueueSpacesAvailable = 0x000224d9;
uxTaskGetStackHighWaterMark = 0x00022505;
vPortEnterCritical = 0x00022629;
vPortExitCritical = 0x00022669;
vPortFree = 0x00022695;
vPortSuppressTicksAndSleep = 0x00022729;
vPortValidateInterruptPriority = 0x00022801;
vQueueDelete = 0x00022855;
vQueueWaitForMessageRestricted = 0x00022881;
vTaskDelay = 0x000228c9;
vTaskInternalSetTimeOutState = 0x00022915;
vTaskMissedYield = 0x00022925;
vTaskPlaceOnEventList = 0x00022931;
vTaskPlaceOnEventListRestricted = 0x00022969;
vTaskPriorityDisinheritAfterTimeout = 0x000229a9;
vTaskResume = 0x00022a55;
vTaskStartScheduler = 0x00022ad9;
vTaskStepTick = 0x00022b69;
vTaskSuspend = 0x00022b99;
vTaskSuspendAll = 0x00022c55;
vTaskSwitchContext = 0x00022c65;
xPortStartScheduler = 0x00022d0d;
xQueueAddToSet = 0x00022dc9;
xQueueCreateCountingSemaphore = 0x00022ded;
xQueueCreateCountingSemaphoreStatic = 0x00022e29;
xQueueCreateMutex = 0x00022e6d;
xQueueCreateMutexStatic = 0x00022e83;
xQueueCreateSet = 0x00022e9d;
xQueueGenericCreate = 0x00022ea5;
xQueueGenericCreateStatic = 0x00022ef1;
xQueueGenericReset = 0x00022f59;
xQueueGenericSend = 0x00022fe5;
xQueueGenericSendFromISR = 0x00023151;
xQueueGiveFromISR = 0x00023211;
xQueueGiveMutexRecursive = 0x000232b5;
xQueueIsQueueEmptyFromISR = 0x000232f5;
xQueueIsQueueFullFromISR = 0x00023319;
xQueuePeek = 0x00023341;
xQueuePeekFromISR = 0x00023469;
xQueueReceive = 0x000234d5;
xQueueReceiveFromISR = 0x00023601;
xQueueRemoveFromSet = 0x00023695;
xQueueSelectFromSet = 0x000236b7;
xQueueSelectFromSetFromISR = 0x000236c9;
xQueueSemaphoreTake = 0x000236dd;
xQueueTakeMutexRecursive = 0x00023849;
xTaskCheckForTimeOut = 0x0002388d;
xTaskCreate = 0x000238fd;
xTaskCreateStatic = 0x00023959;
xTaskGetCurrentTaskHandle = 0x000239c9;
xTaskGetSchedulerState = 0x000239d5;
xTaskGetTickCount = 0x000239f1;
xTaskGetTickCountFromISR = 0x000239fd;
xTaskIncrementTick = 0x00023a0d;
xTaskPriorityDisinherit = 0x00023ad9;
xTaskPriorityInherit = 0x00023b6d;
xTaskRemoveFromEventList = 0x00023c01;
xTaskResumeAll = 0x00023c81;
xTaskResumeFromISR = 0x00023d49;
xTimerCreate = 0x00023dd5;
xTimerCreateStatic = 0x00023e09;
xTimerCreateTimerTask = 0x00023e41;
xTimerGenericCommand = 0x00023ead;
xTimerGetExpiryTime = 0x00023f1d;
