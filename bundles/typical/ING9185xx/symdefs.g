...
nibble_for_char = 0x0001cde9;
platform_32k_rc_auto_tune = 0x0001ce85;
platform_32k_rc_tune = 0x0001cf01;
platform_calibrate_32k = 0x0001cf15;
platform_config = 0x0001cf19;
platform_get_heap_status = 0x0001cfed;
...
platform_set_timer = 0x0001d14d;
platform_shutdown = 0x0001d151;
platform_switch_app = 0x0001d155;
platform_trace_raw = 0x0001d181;
platform_write_persistent_reg = 0x0001d199;
printf_hexdump = 0x0001d1a9;
pvPortMalloc = 0x0001dcb5;
pvTaskIncrementMutexHeldCount = 0x0001dd9d;
pvTimerGetTimerID = 0x0001ddb5;
pxPortInitialiseStack = 0x0001dde1;
...
sm_add_event_handler = 0x0001e119;
sm_address_resolution_lookup = 0x0001e271;
sm_authenticated = 0x0001e5c9;
sm_authorization_decline = 0x0001e5d7;
sm_authorization_grant = 0x0001e5f7;
sm_authorization_state = 0x0001e617;
sm_bonding_decline = 0x0001e631;
sm_config = 0x0001ea51;
sm_config_conn = 0x0001ea69;
sm_encryption_key_size = 0x0001ec1f;
sm_just_works_confirm = 0x0001f129;
sm_le_device_key = 0x0001f465;
sm_passkey_input = 0x0001f4fb;
...
uxTaskPriorityGet = 0x0002127d;
uxTaskPriorityGetFromISR = 0x00021299;
vListInitialise = 0x0002134b;
vListInitialiseItem = 0x00021361;
vListInsert = 0x00021367;
vListInsertEnd = 0x00021397;
vPortEndScheduler = 0x000213b1;
vPortEnterCritical = 0x000213d9;
vPortExitCritical = 0x0002141d;
vPortFree = 0x0002144d;
vPortSuppressTicksAndSleep = 0x000214e1;
vPortValidateInterruptPriority = 0x000215e9;
vQueueDelete = 0x00021641;
vQueueWaitForMessageRestricted = 0x0002166d;
vTaskDelay = 0x000216b5;
vTaskInternalSetTimeOutState = 0x00021701;
vTaskMissedYield = 0x00021711;
vTaskPlaceOnEventList = 0x0002171d;
vTaskPlaceOnEventListRestricted = 0x00021755;
vTaskPriorityDisinheritAfterTimeout = 0x00021795;
vTaskPrioritySet = 0x00021841;
vTaskResume = 0x00021909;
vTaskStartScheduler = 0x0002198d;
vTaskStepTick = 0x00021a1d;
vTaskSuspend = 0x00021a4d;
vTaskSuspendAll = 0x00021b09;
vTaskSwitchContext = 0x00021b19;
xPortStartScheduler = 0x00021bc1;
