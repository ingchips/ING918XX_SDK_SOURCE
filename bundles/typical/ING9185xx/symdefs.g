...
platform_get_us_time = 0x0001d0c9;
platform_get_version = 0x0001d0cd;
platform_hrng = 0x0001d0d5;
platform_install_isr_stack = 0x0001d0dd;
platform_patch_rf_init_data = 0x0001d0e9;
platform_printf = 0x0001d0f5;
platform_raise_assertion = 0x0001d109;
platform_rand = 0x0001d11d;
platform_read_info = 0x0001d121;
platform_read_persistent_reg = 0x0001d13d;
platform_reset = 0x0001d14d;
platform_set_evt_callback = 0x0001d181;
platform_set_irq_callback = 0x0001d195;
platform_set_rf_clk_source = 0x0001d1cd;
platform_set_rf_init_data = 0x0001d1d9;
platform_set_rf_power_mapping = 0x0001d1e5;
platform_shutdown = 0x0001d1f1;
platform_switch_app = 0x0001d1f5;
platform_trace_raw = 0x0001d221;
platform_write_persistent_reg = 0x0001d235;
printf_hexdump = 0x0001d245;
pvPortMalloc = 0x0001dd15;
pvTaskIncrementMutexHeldCount = 0x0001ddfd;
pvTimerGetTimerID = 0x0001de15;
pxPortInitialiseStack = 0x0001de41;
reverse_128 = 0x0001dfe9;
reverse_24 = 0x0001dfef;
reverse_48 = 0x0001dff5;
reverse_56 = 0x0001dffb;
reverse_64 = 0x0001e001;
reverse_bd_addr = 0x0001e007;
reverse_bytes = 0x0001e00d;
sm_add_event_handler = 0x0001e179;
sm_address_resolution_lookup = 0x0001e2a5;
sm_authenticated = 0x0001e5f1;
sm_authorization_decline = 0x0001e5ff;
sm_authorization_grant = 0x0001e61f;
sm_authorization_state = 0x0001e63f;
sm_bonding_decline = 0x0001e659;
sm_config = 0x0001ea25;
sm_config_conn = 0x0001ea3d;
sm_encryption_key_size = 0x0001eb9b;
sm_just_works_confirm = 0x0001efc1;
...
sm_register_oob_data_callback = 0x0001f741;
sm_request_pairing = 0x0001f74d;
sm_send_security_request = 0x0002008b;
...
vPortEnterCritical = 0x00020ed9;
vPortExitCritical = 0x00020f19;
vPortFree = 0x00020f45;
vPortSuppressTicksAndSleep = 0x00020fd9;
vPortValidateInterruptPriority = 0x000210b1;
vQueueDelete = 0x00021105;
vQueueWaitForMessageRestricted = 0x00021131;
vTaskDelay = 0x00021179;
vTaskInternalSetTimeOutState = 0x000211c5;
vTaskMissedYield = 0x000211d5;
vTaskPlaceOnEventList = 0x000211e1;
vTaskPlaceOnEventListRestricted = 0x00021219;
vTaskPriorityDisinheritAfterTimeout = 0x00021259;
vTaskStartScheduler = 0x00021305;
vTaskStepTick = 0x00021395;
vTaskSuspendAll = 0x000213c5;
vTaskSwitchContext = 0x000213d5;
xPortStartScheduler = 0x0002147d;
xQueueAddToSet = 0x00021539;
xQueueCreateCountingSemaphore = 0x0002155d;
xQueueCreateCountingSemaphoreStatic = 0x00021599;
xQueueCreateMutex = 0x000215dd;
xQueueCreateMutexStatic = 0x000215f3;
xQueueCreateSet = 0x0002160d;
xQueueGenericCreate = 0x00021615;
xQueueGenericCreateStatic = 0x00021661;
xQueueGenericReset = 0x000216c9;
xQueueGenericSend = 0x00021755;
xQueueGenericSendFromISR = 0x000218c1;
xQueueGiveFromISR = 0x00021981;
xQueueGiveMutexRecursive = 0x00021a25;
xQueueIsQueueEmptyFromISR = 0x00021a65;
xQueueIsQueueFullFromISR = 0x00021a89;
xQueuePeek = 0x00021ab1;
xQueuePeekFromISR = 0x00021bd9;
xQueueReceive = 0x00021c45;
xQueueReceiveFromISR = 0x00021d71;
xQueueRemoveFromSet = 0x00021e05;
xQueueSelectFromSet = 0x00021e27;
xQueueSelectFromSetFromISR = 0x00021e39;
xQueueSemaphoreTake = 0x00021e4d;
xQueueTakeMutexRecursive = 0x00021fb9;
xTaskCheckForTimeOut = 0x00021ffd;
xTaskCreate = 0x0002206d;
xTaskCreateStatic = 0x000220c9;
xTaskGetCurrentTaskHandle = 0x00022139;
xTaskGetSchedulerState = 0x00022145;
xTaskGetTickCount = 0x00022161;
xTaskGetTickCountFromISR = 0x0002216d;
xTaskIncrementTick = 0x0002217d;
xTaskPriorityDisinherit = 0x00022249;
xTaskPriorityInherit = 0x000222dd;
xTaskRemoveFromEventList = 0x00022371;
xTaskResumeAll = 0x000223f1;
xTimerCreate = 0x000224b9;
xTimerCreateStatic = 0x000224ed;
xTimerCreateTimerTask = 0x00022525;
xTimerGenericCommand = 0x00022591;
xTimerGetExpiryTime = 0x00022601;
