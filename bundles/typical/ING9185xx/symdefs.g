...
platform_get_heap_status = 0x0001cfa9;
platform_get_task_handle = 0x0001cfc1;
...
platform_set_timer = 0x0001d109;
platform_shutdown = 0x0001d10d;
platform_switch_app = 0x0001d111;
platform_trace_raw = 0x0001d13d;
platform_write_persistent_reg = 0x0001d155;
printf_hexdump = 0x0001d165;
...
sm_address_resolution_lookup = 0x0001e22d;
sm_authenticated = 0x0001e585;
sm_authorization_decline = 0x0001e593;
sm_authorization_grant = 0x0001e5b3;
sm_authorization_state = 0x0001e5d3;
sm_bonding_decline = 0x0001e5ed;
sm_config = 0x0001ea0d;
sm_config_conn = 0x0001ea25;
sm_encryption_key_size = 0x0001ebdb;
sm_just_works_confirm = 0x0001f115;
sm_le_device_key = 0x0001f451;
sm_passkey_input = 0x0001f4e7;
sm_private_random_address_generation_get = 0x0001f895;
sm_private_random_address_generation_get_mode = 0x0001f89d;
sm_private_random_address_generation_set_mode = 0x0001f8a9;
sm_private_random_address_generation_set_update_period = 0x0001f8d1;
sm_register_oob_data_callback = 0x0001fa0d;
sm_request_pairing = 0x0001fa19;
sm_send_security_request = 0x0002041f;
sm_set_accepted_stk_generation_methods = 0x00020445;
sm_set_authentication_requirements = 0x00020451;
sm_set_encryption_key_size_range = 0x0002045d;
sscanf_bd_addr = 0x000207ad;
sysSetPublicDeviceAddr = 0x00020b15;
uuid128_to_str = 0x00021109;
uuid_add_bluetooth_prefix = 0x00021161;
uuid_has_bluetooth_prefix = 0x00021181;
uxListRemove = 0x0002119d;
uxQueueMessagesWaiting = 0x000211c5;
uxQueueMessagesWaitingFromISR = 0x000211ed;
uxQueueSpacesAvailable = 0x00021209;
uxTaskGetStackHighWaterMark = 0x00021235;
uxTaskPriorityGet = 0x00021255;
uxTaskPriorityGetFromISR = 0x00021271;
vListInitialise = 0x00021323;
vListInitialiseItem = 0x00021339;
vListInsert = 0x0002133f;
vListInsertEnd = 0x0002136f;
vPortEnterCritical = 0x00021389;
vPortExitCritical = 0x000213cd;
vPortFree = 0x000213fd;
vPortSuppressTicksAndSleep = 0x00021491;
vPortValidateInterruptPriority = 0x000215b1;
vQueueDelete = 0x00021609;
vQueueWaitForMessageRestricted = 0x00021635;
vTaskDelay = 0x0002167d;
vTaskInternalSetTimeOutState = 0x000216c9;
vTaskMissedYield = 0x000216d9;
vTaskPlaceOnEventList = 0x000216e5;
vTaskPlaceOnEventListRestricted = 0x0002171d;
vTaskPriorityDisinheritAfterTimeout = 0x0002175d;
vTaskPrioritySet = 0x00021809;
vTaskResume = 0x000218d1;
vTaskStartScheduler = 0x00021955;
vTaskStepTick = 0x000219e5;
vTaskSuspend = 0x00021a15;
vTaskSuspendAll = 0x00021ad1;
vTaskSwitchContext = 0x00021ae1;
xPortStartScheduler = 0x00021b89;
xQueueAddToSet = 0x00021c4d;
xQueueCreateCountingSemaphore = 0x00021c71;
xQueueCreateCountingSemaphoreStatic = 0x00021cad;
xQueueCreateMutex = 0x00021cf1;
xQueueCreateMutexStatic = 0x00021d07;
xQueueCreateSet = 0x00021d21;
xQueueGenericCreate = 0x00021d29;
xQueueGenericCreateStatic = 0x00021d75;
xQueueGenericReset = 0x00021ddd;
xQueueGenericSend = 0x00021e69;
xQueueGenericSendFromISR = 0x00021fd5;
xQueueGiveFromISR = 0x00022095;
xQueueGiveMutexRecursive = 0x00022139;
xQueueIsQueueEmptyFromISR = 0x00022179;
xQueueIsQueueFullFromISR = 0x0002219d;
xQueuePeek = 0x000221c5;
xQueuePeekFromISR = 0x000222ed;
xQueueReceive = 0x00022359;
xQueueReceiveFromISR = 0x00022485;
xQueueRemoveFromSet = 0x00022519;
xQueueSelectFromSet = 0x0002253b;
xQueueSelectFromSetFromISR = 0x0002254d;
xQueueSemaphoreTake = 0x00022561;
xQueueTakeMutexRecursive = 0x000226cd;
xTaskCheckForTimeOut = 0x00022711;
xTaskCreate = 0x00022781;
xTaskCreateStatic = 0x000227dd;
xTaskGetCurrentTaskHandle = 0x0002284d;
xTaskGetSchedulerState = 0x00022859;
xTaskGetTickCount = 0x00022875;
xTaskGetTickCountFromISR = 0x00022881;
xTaskIncrementTick = 0x00022891;
xTaskPriorityDisinherit = 0x0002295d;
xTaskPriorityInherit = 0x000229f1;
xTaskRemoveFromEventList = 0x00022a85;
xTaskResumeAll = 0x00022b05;
xTaskResumeFromISR = 0x00022bcd;
xTimerCreate = 0x00022c59;
xTimerCreateStatic = 0x00022c8d;
xTimerCreateTimerTask = 0x00022cc5;
xTimerGenericCommand = 0x00022d31;
xTimerGetExpiryTime = 0x00022da1;
xTimerGetTimerDaemonTaskHandle = 0x00022dc1;
