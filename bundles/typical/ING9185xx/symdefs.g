...
sm_just_works_confirm = 0x0001ef9d;
sm_le_device_key = 0x0001f1f5;
sm_passkey_input = 0x0001f28d;
...
sm_register_oob_data_callback = 0x0001f68d;
sm_request_pairing = 0x0001f699;
sm_send_security_request = 0x000200e9;
sm_set_accepted_stk_generation_methods = 0x00020111;
sm_set_authentication_requirements = 0x0002011d;
sm_set_encryption_key_size_range = 0x00020129;
sscanf_bd_addr = 0x00020419;
...
vPortEnterCritical = 0x00020f39;
vPortExitCritical = 0x00020f79;
vPortFree = 0x00020fa5;
vPortSuppressTicksAndSleep = 0x00021039;
vPortValidateInterruptPriority = 0x00021111;
vQueueDelete = 0x00021165;
vQueueWaitForMessageRestricted = 0x00021191;
vTaskDelay = 0x000211d9;
vTaskInternalSetTimeOutState = 0x00021225;
vTaskMissedYield = 0x00021235;
vTaskPlaceOnEventList = 0x00021241;
vTaskPlaceOnEventListRestricted = 0x00021279;
vTaskPriorityDisinheritAfterTimeout = 0x000212b9;
vTaskStartScheduler = 0x00021365;
vTaskStepTick = 0x000213f5;
vTaskSuspendAll = 0x00021425;
vTaskSwitchContext = 0x00021435;
xPortStartScheduler = 0x000214dd;
xQueueAddToSet = 0x00021599;
xQueueCreateCountingSemaphore = 0x000215bd;
xQueueCreateCountingSemaphoreStatic = 0x000215f9;
xQueueCreateMutex = 0x0002163d;
xQueueCreateMutexStatic = 0x00021653;
xQueueCreateSet = 0x0002166d;
xQueueGenericCreate = 0x00021675;
xQueueGenericCreateStatic = 0x000216c1;
xQueueGenericReset = 0x00021729;
xQueueGenericSend = 0x000217b5;
xQueueGenericSendFromISR = 0x00021921;
xQueueGiveFromISR = 0x000219e1;
xQueueGiveMutexRecursive = 0x00021a85;
xQueueIsQueueEmptyFromISR = 0x00021ac5;
xQueueIsQueueFullFromISR = 0x00021ae9;
xQueuePeek = 0x00021b11;
xQueuePeekFromISR = 0x00021c39;
xQueueReceive = 0x00021ca5;
xQueueReceiveFromISR = 0x00021dd1;
xQueueRemoveFromSet = 0x00021e65;
xQueueSelectFromSet = 0x00021e87;
xQueueSelectFromSetFromISR = 0x00021e99;
xQueueSemaphoreTake = 0x00021ead;
xQueueTakeMutexRecursive = 0x00022019;
xTaskCheckForTimeOut = 0x0002205d;
xTaskCreate = 0x000220cd;
xTaskCreateStatic = 0x00022129;
xTaskGetCurrentTaskHandle = 0x00022199;
xTaskGetSchedulerState = 0x000221a5;
xTaskGetTickCount = 0x000221c1;
xTaskGetTickCountFromISR = 0x000221cd;
xTaskIncrementTick = 0x000221dd;
xTaskPriorityDisinherit = 0x000222a9;
xTaskPriorityInherit = 0x0002233d;
xTaskRemoveFromEventList = 0x000223d1;
xTaskResumeAll = 0x00022451;
xTimerCreate = 0x00022519;
xTimerCreateStatic = 0x0002254d;
xTimerCreateTimerTask = 0x00022585;
xTimerGenericCommand = 0x000225f1;
xTimerGetExpiryTime = 0x00022661;
