...
nibble_for_char = 0x0001cf69;
platform_32k_rc_auto_tune = 0x0001d005;
platform_32k_rc_tune = 0x0001d081;
platform_calibrate_32k = 0x0001d095;
platform_config = 0x0001d099;
platform_get_heap_status = 0x0001d151;
platform_get_us_time = 0x0001d169;
platform_get_version = 0x0001d16d;
platform_hrng = 0x0001d175;
platform_install_isr_stack = 0x0001d17d;
platform_patch_rf_init_data = 0x0001d189;
platform_printf = 0x0001d195;
platform_raise_assertion = 0x0001d1a9;
platform_rand = 0x0001d1bd;
platform_read_info = 0x0001d1c1;
platform_read_persistent_reg = 0x0001d1dd;
platform_reset = 0x0001d1ed;
platform_set_evt_callback = 0x0001d221;
platform_set_irq_callback = 0x0001d235;
platform_set_rf_clk_source = 0x0001d26d;
platform_set_rf_init_data = 0x0001d279;
platform_set_rf_power_mapping = 0x0001d285;
platform_shutdown = 0x0001d291;
platform_switch_app = 0x0001d295;
platform_trace_raw = 0x0001d2c1;
platform_write_persistent_reg = 0x0001d2d5;
printf_hexdump = 0x0001d2e5;
pvPortMalloc = 0x0001dded;
pvTaskIncrementMutexHeldCount = 0x0001ded5;
pvTimerGetTimerID = 0x0001deed;
pxPortInitialiseStack = 0x0001df19;
reverse_128 = 0x0001e0c1;
reverse_24 = 0x0001e0c7;
reverse_48 = 0x0001e0cd;
reverse_56 = 0x0001e0d3;
reverse_64 = 0x0001e0d9;
reverse_bd_addr = 0x0001e0df;
reverse_bytes = 0x0001e0e5;
sm_add_event_handler = 0x0001e251;
sm_address_resolution_lookup = 0x0001e37d;
sm_authenticated = 0x0001e6c9;
sm_authorization_decline = 0x0001e6d7;
sm_authorization_grant = 0x0001e6f7;
sm_authorization_state = 0x0001e717;
sm_bonding_decline = 0x0001e731;
sm_config = 0x0001eafd;
sm_config_conn = 0x0001eb15;
sm_encryption_key_size = 0x0001ec73;
sm_just_works_confirm = 0x0001f099;
sm_le_device_key = 0x0001f2c5;
sm_passkey_input = 0x0001f35b;
sm_private_random_address_generation_get = 0x0001f6a1;
sm_private_random_address_generation_get_mode = 0x0001f6a9;
sm_private_random_address_generation_set_mode = 0x0001f6b5;
sm_private_random_address_generation_set_update_period = 0x0001f6dd;
sm_register_oob_data_callback = 0x0001f819;
sm_request_pairing = 0x0001f825;
...
sscanf_bd_addr = 0x00020475;
sysSetPublicDeviceAddr = 0x000207ad;
uuid128_to_str = 0x00020d85;
uuid_add_bluetooth_prefix = 0x00020ddd;
uuid_has_bluetooth_prefix = 0x00020dfd;
uxQueueMessagesWaiting = 0x00020e41;
uxQueueMessagesWaitingFromISR = 0x00020e69;
uxQueueSpacesAvailable = 0x00020e85;
uxTaskGetStackHighWaterMark = 0x00020eb1;
vPortEnterCritical = 0x00020fd5;
vPortExitCritical = 0x00021015;
vPortFree = 0x00021041;
vPortSuppressTicksAndSleep = 0x000210d5;
vPortValidateInterruptPriority = 0x000211ad;
vQueueDelete = 0x00021201;
vQueueWaitForMessageRestricted = 0x0002122d;
vTaskDelay = 0x00021275;
vTaskInternalSetTimeOutState = 0x000212c1;
vTaskMissedYield = 0x000212d1;
vTaskPlaceOnEventList = 0x000212dd;
vTaskPlaceOnEventListRestricted = 0x00021315;
vTaskPriorityDisinheritAfterTimeout = 0x00021355;
vTaskResume = 0x00021401;
vTaskStartScheduler = 0x00021485;
vTaskStepTick = 0x00021515;
vTaskSuspend = 0x00021545;
vTaskSuspendAll = 0x00021601;
vTaskSwitchContext = 0x00021611;
xPortStartScheduler = 0x000216b9;
xQueueAddToSet = 0x00021775;
xQueueCreateCountingSemaphore = 0x00021799;
xQueueCreateCountingSemaphoreStatic = 0x000217d5;
xQueueCreateMutex = 0x00021819;
xQueueCreateMutexStatic = 0x0002182f;
xQueueCreateSet = 0x00021849;
xQueueGenericCreate = 0x00021851;
xQueueGenericCreateStatic = 0x0002189d;
xQueueGenericReset = 0x00021905;
xQueueGenericSend = 0x00021991;
xQueueGenericSendFromISR = 0x00021afd;
xQueueGiveFromISR = 0x00021bbd;
xQueueGiveMutexRecursive = 0x00021c61;
xQueueIsQueueEmptyFromISR = 0x00021ca1;
xQueueIsQueueFullFromISR = 0x00021cc5;
xQueuePeek = 0x00021ced;
xQueuePeekFromISR = 0x00021e15;
xQueueReceive = 0x00021e81;
xQueueReceiveFromISR = 0x00021fad;
xQueueRemoveFromSet = 0x00022041;
xQueueSelectFromSet = 0x00022063;
xQueueSelectFromSetFromISR = 0x00022075;
xQueueSemaphoreTake = 0x00022089;
xQueueTakeMutexRecursive = 0x000221f5;
xTaskCheckForTimeOut = 0x00022239;
xTaskCreate = 0x000222a9;
xTaskCreateStatic = 0x00022305;
xTaskGetCurrentTaskHandle = 0x00022375;
xTaskGetSchedulerState = 0x00022381;
xTaskGetTickCount = 0x0002239d;
xTaskGetTickCountFromISR = 0x000223a9;
xTaskIncrementTick = 0x000223b9;
xTaskPriorityDisinherit = 0x00022485;
xTaskPriorityInherit = 0x00022519;
xTaskRemoveFromEventList = 0x000225ad;
xTaskResumeAll = 0x0002262d;
xTaskResumeFromISR = 0x000226f5;
xTimerCreate = 0x00022781;
xTimerCreateStatic = 0x000227b5;
xTimerCreateTimerTask = 0x000227ed;
xTimerGenericCommand = 0x00022859;
xTimerGetExpiryTime = 0x000228c9;
