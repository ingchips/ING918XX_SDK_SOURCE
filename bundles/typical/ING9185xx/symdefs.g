...
sysSetPublicDeviceAddr = 0x000207b9;
uuid128_to_str = 0x00020d91;
uuid_add_bluetooth_prefix = 0x00020de9;
uuid_has_bluetooth_prefix = 0x00020e09;
uxQueueMessagesWaiting = 0x00020e4d;
uxQueueMessagesWaitingFromISR = 0x00020e75;
uxQueueSpacesAvailable = 0x00020e91;
uxTaskGetStackHighWaterMark = 0x00020ebd;
vPortEnterCritical = 0x00020fe1;
vPortExitCritical = 0x00021021;
vPortFree = 0x0002104d;
vPortSuppressTicksAndSleep = 0x000210e1;
vPortValidateInterruptPriority = 0x000211b9;
vQueueDelete = 0x0002120d;
vQueueWaitForMessageRestricted = 0x00021239;
vTaskDelay = 0x00021281;
vTaskInternalSetTimeOutState = 0x000212cd;
vTaskMissedYield = 0x000212dd;
vTaskPlaceOnEventList = 0x000212e9;
vTaskPlaceOnEventListRestricted = 0x00021321;
vTaskPriorityDisinheritAfterTimeout = 0x00021361;
vTaskResume = 0x0002140d;
vTaskStartScheduler = 0x00021491;
vTaskStepTick = 0x00021521;
vTaskSuspend = 0x00021551;
vTaskSuspendAll = 0x0002160d;
vTaskSwitchContext = 0x0002161d;
xPortStartScheduler = 0x000216c5;
xQueueAddToSet = 0x00021781;
xQueueCreateCountingSemaphore = 0x000217a5;
xQueueCreateCountingSemaphoreStatic = 0x000217e1;
xQueueCreateMutex = 0x00021825;
xQueueCreateMutexStatic = 0x0002183b;
xQueueCreateSet = 0x00021855;
xQueueGenericCreate = 0x0002185d;
xQueueGenericCreateStatic = 0x000218a9;
xQueueGenericReset = 0x00021911;
xQueueGenericSend = 0x0002199d;
xQueueGenericSendFromISR = 0x00021b09;
xQueueGiveFromISR = 0x00021bc9;
xQueueGiveMutexRecursive = 0x00021c6d;
xQueueIsQueueEmptyFromISR = 0x00021cad;
xQueueIsQueueFullFromISR = 0x00021cd1;
xQueuePeek = 0x00021cf9;
xQueuePeekFromISR = 0x00021e21;
xQueueReceive = 0x00021e8d;
xQueueReceiveFromISR = 0x00021fb9;
xQueueRemoveFromSet = 0x0002204d;
xQueueSelectFromSet = 0x0002206f;
xQueueSelectFromSetFromISR = 0x00022081;
xQueueSemaphoreTake = 0x00022095;
xQueueTakeMutexRecursive = 0x00022201;
xTaskCheckForTimeOut = 0x00022245;
xTaskCreate = 0x000222b5;
xTaskCreateStatic = 0x00022311;
xTaskGetCurrentTaskHandle = 0x00022381;
xTaskGetSchedulerState = 0x0002238d;
xTaskGetTickCount = 0x000223a9;
xTaskGetTickCountFromISR = 0x000223b5;
xTaskIncrementTick = 0x000223c5;
xTaskPriorityDisinherit = 0x00022491;
xTaskPriorityInherit = 0x00022525;
xTaskRemoveFromEventList = 0x000225b9;
xTaskResumeAll = 0x00022639;
xTaskResumeFromISR = 0x00022701;
xTimerCreate = 0x0002278d;
xTimerCreateStatic = 0x000227c1;
xTimerCreateTimerTask = 0x000227f9;
xTimerGenericCommand = 0x00022865;
xTimerGetExpiryTime = 0x000228d5;
