...
nibble_for_char = 0x0001cdb1;
platform_32k_rc_auto_tune = 0x0001ce4d;
platform_32k_rc_tune = 0x0001cec9;
platform_calibrate_32k = 0x0001cedd;
platform_config = 0x0001cee1;
platform_get_heap_status = 0x0001cfa1;
...
platform_set_timer = 0x0001d101;
platform_shutdown = 0x0001d105;
platform_switch_app = 0x0001d109;
platform_trace_raw = 0x0001d135;
platform_write_persistent_reg = 0x0001d14d;
printf_hexdump = 0x0001d15d;
pvPortMalloc = 0x0001dc69;
pvTaskIncrementMutexHeldCount = 0x0001dd51;
pvTimerGetTimerID = 0x0001dd69;
pxPortInitialiseStack = 0x0001dd95;
reverse_128 = 0x0001df3d;
reverse_24 = 0x0001df43;
reverse_48 = 0x0001df49;
reverse_56 = 0x0001df4f;
reverse_64 = 0x0001df55;
reverse_bd_addr = 0x0001df5b;
reverse_bytes = 0x0001df61;
sm_add_event_handler = 0x0001e0cd;
sm_address_resolution_lookup = 0x0001e225;
sm_authenticated = 0x0001e571;
sm_authorization_decline = 0x0001e57f;
sm_authorization_grant = 0x0001e59f;
sm_authorization_state = 0x0001e5bf;
sm_bonding_decline = 0x0001e5d9;
sm_config = 0x0001e9f9;
sm_config_conn = 0x0001ea11;
sm_encryption_key_size = 0x0001ebc7;
sm_just_works_confirm = 0x0001f101;
sm_le_device_key = 0x0001f43d;
sm_passkey_input = 0x0001f4d3;
sm_private_random_address_generation_get = 0x0001f881;
sm_private_random_address_generation_get_mode = 0x0001f889;
sm_private_random_address_generation_set_mode = 0x0001f895;
sm_private_random_address_generation_set_update_period = 0x0001f8bd;
sm_register_oob_data_callback = 0x0001f9f9;
sm_request_pairing = 0x0001fa05;
sm_send_security_request = 0x0002040b;
sm_set_accepted_stk_generation_methods = 0x00020431;
sm_set_authentication_requirements = 0x0002043d;
sm_set_encryption_key_size_range = 0x00020449;
sscanf_bd_addr = 0x00020799;
sysSetPublicDeviceAddr = 0x00020b01;
uuid128_to_str = 0x000210f5;
uuid_add_bluetooth_prefix = 0x0002114d;
uuid_has_bluetooth_prefix = 0x0002116d;
uxListRemove = 0x00021189;
uxQueueMessagesWaiting = 0x000211b1;
uxQueueMessagesWaitingFromISR = 0x000211d9;
uxQueueSpacesAvailable = 0x000211f5;
uxTaskGetStackHighWaterMark = 0x00021221;
uxTaskPriorityGet = 0x00021241;
uxTaskPriorityGetFromISR = 0x0002125d;
vListInitialise = 0x0002130f;
vListInitialiseItem = 0x00021325;
vListInsert = 0x0002132b;
vListInsertEnd = 0x0002135b;
vPortEnterCritical = 0x00021375;
vPortExitCritical = 0x000213b9;
vPortFree = 0x000213e9;
vPortSuppressTicksAndSleep = 0x0002147d;
vPortValidateInterruptPriority = 0x0002159d;
vQueueDelete = 0x000215f5;
vQueueWaitForMessageRestricted = 0x00021621;
vTaskDelay = 0x00021669;
vTaskInternalSetTimeOutState = 0x000216b5;
vTaskMissedYield = 0x000216c5;
vTaskPlaceOnEventList = 0x000216d1;
vTaskPlaceOnEventListRestricted = 0x00021709;
vTaskPriorityDisinheritAfterTimeout = 0x00021749;
vTaskPrioritySet = 0x000217f5;
vTaskResume = 0x000218bd;
vTaskStartScheduler = 0x00021941;
vTaskStepTick = 0x000219d1;
vTaskSuspend = 0x00021a01;
vTaskSuspendAll = 0x00021abd;
vTaskSwitchContext = 0x00021acd;
xPortStartScheduler = 0x00021b75;
xQueueAddToSet = 0x00021c39;
xQueueCreateCountingSemaphore = 0x00021c5d;
xQueueCreateCountingSemaphoreStatic = 0x00021c99;
xQueueCreateMutex = 0x00021cdd;
xQueueCreateMutexStatic = 0x00021cf3;
xQueueCreateSet = 0x00021d0d;
xQueueGenericCreate = 0x00021d15;
xQueueGenericCreateStatic = 0x00021d61;
xQueueGenericReset = 0x00021dc9;
xQueueGenericSend = 0x00021e55;
xQueueGenericSendFromISR = 0x00021fc1;
xQueueGiveFromISR = 0x00022081;
xQueueGiveMutexRecursive = 0x00022125;
xQueueIsQueueEmptyFromISR = 0x00022165;
xQueueIsQueueFullFromISR = 0x00022189;
xQueuePeek = 0x000221b1;
xQueuePeekFromISR = 0x000222d9;
xQueueReceive = 0x00022345;
xQueueReceiveFromISR = 0x00022471;
xQueueRemoveFromSet = 0x00022505;
xQueueSelectFromSet = 0x00022527;
xQueueSelectFromSetFromISR = 0x00022539;
xQueueSemaphoreTake = 0x0002254d;
xQueueTakeMutexRecursive = 0x000226b9;
xTaskCheckForTimeOut = 0x000226fd;
xTaskCreate = 0x0002276d;
xTaskCreateStatic = 0x000227c9;
xTaskGetCurrentTaskHandle = 0x00022839;
xTaskGetSchedulerState = 0x00022845;
xTaskGetTickCount = 0x00022861;
xTaskGetTickCountFromISR = 0x0002286d;
xTaskIncrementTick = 0x0002287d;
xTaskPriorityDisinherit = 0x00022949;
xTaskPriorityInherit = 0x000229dd;
xTaskRemoveFromEventList = 0x00022a71;
xTaskResumeAll = 0x00022af1;
xTaskResumeFromISR = 0x00022bb9;
xTimerCreate = 0x00022c45;
xTimerCreateStatic = 0x00022c79;
xTimerCreateTimerTask = 0x00022cb1;
xTimerGenericCommand = 0x00022d1d;
xTimerGetExpiryTime = 0x00022d8d;
xTimerGetTimerDaemonTaskHandle = 0x00022dad;
