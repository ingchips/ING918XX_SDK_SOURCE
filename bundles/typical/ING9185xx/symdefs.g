...
sm_authenticated = 0x0001e579;
sm_authorization_decline = 0x0001e587;
sm_authorization_grant = 0x0001e5a7;
sm_authorization_state = 0x0001e5c7;
sm_bonding_decline = 0x0001e5e1;
sm_config = 0x0001ea01;
sm_config_conn = 0x0001ea19;
sm_encryption_key_size = 0x0001ebcf;
sm_just_works_confirm = 0x0001f109;
sm_le_device_key = 0x0001f445;
sm_passkey_input = 0x0001f4db;
sm_private_random_address_generation_get = 0x0001f889;
sm_private_random_address_generation_get_mode = 0x0001f891;
sm_private_random_address_generation_set_mode = 0x0001f89d;
sm_private_random_address_generation_set_update_period = 0x0001f8c5;
sm_register_oob_data_callback = 0x0001fa01;
sm_request_pairing = 0x0001fa0d;
sm_send_security_request = 0x00020413;
sm_set_accepted_stk_generation_methods = 0x00020439;
sm_set_authentication_requirements = 0x00020445;
sm_set_encryption_key_size_range = 0x00020451;
sscanf_bd_addr = 0x000207a1;
sysSetPublicDeviceAddr = 0x00020b09;
uuid128_to_str = 0x000210fd;
uuid_add_bluetooth_prefix = 0x00021155;
uuid_has_bluetooth_prefix = 0x00021175;
uxListRemove = 0x00021191;
uxQueueMessagesWaiting = 0x000211b9;
uxQueueMessagesWaitingFromISR = 0x000211e1;
uxQueueSpacesAvailable = 0x000211fd;
uxTaskGetStackHighWaterMark = 0x00021229;
uxTaskPriorityGet = 0x00021249;
uxTaskPriorityGetFromISR = 0x00021265;
vListInitialise = 0x00021317;
vListInitialiseItem = 0x0002132d;
vListInsert = 0x00021333;
vListInsertEnd = 0x00021363;
vPortEnterCritical = 0x0002137d;
vPortExitCritical = 0x000213c1;
vPortFree = 0x000213f1;
vPortSuppressTicksAndSleep = 0x00021485;
vPortValidateInterruptPriority = 0x000215a5;
vQueueDelete = 0x000215fd;
vQueueWaitForMessageRestricted = 0x00021629;
vTaskDelay = 0x00021671;
vTaskInternalSetTimeOutState = 0x000216bd;
vTaskMissedYield = 0x000216cd;
vTaskPlaceOnEventList = 0x000216d9;
vTaskPlaceOnEventListRestricted = 0x00021711;
vTaskPriorityDisinheritAfterTimeout = 0x00021751;
vTaskPrioritySet = 0x000217fd;
vTaskResume = 0x000218c5;
vTaskStartScheduler = 0x00021949;
vTaskStepTick = 0x000219d9;
vTaskSuspend = 0x00021a09;
vTaskSuspendAll = 0x00021ac5;
vTaskSwitchContext = 0x00021ad5;
xPortStartScheduler = 0x00021b7d;
xQueueAddToSet = 0x00021c41;
xQueueCreateCountingSemaphore = 0x00021c65;
xQueueCreateCountingSemaphoreStatic = 0x00021ca1;
xQueueCreateMutex = 0x00021ce5;
xQueueCreateMutexStatic = 0x00021cfb;
xQueueCreateSet = 0x00021d15;
xQueueGenericCreate = 0x00021d1d;
xQueueGenericCreateStatic = 0x00021d69;
xQueueGenericReset = 0x00021dd1;
xQueueGenericSend = 0x00021e5d;
xQueueGenericSendFromISR = 0x00021fc9;
xQueueGiveFromISR = 0x00022089;
xQueueGiveMutexRecursive = 0x0002212d;
xQueueIsQueueEmptyFromISR = 0x0002216d;
xQueueIsQueueFullFromISR = 0x00022191;
xQueuePeek = 0x000221b9;
xQueuePeekFromISR = 0x000222e1;
xQueueReceive = 0x0002234d;
xQueueReceiveFromISR = 0x00022479;
xQueueRemoveFromSet = 0x0002250d;
xQueueSelectFromSet = 0x0002252f;
xQueueSelectFromSetFromISR = 0x00022541;
xQueueSemaphoreTake = 0x00022555;
xQueueTakeMutexRecursive = 0x000226c1;
xTaskCheckForTimeOut = 0x00022705;
xTaskCreate = 0x00022775;
xTaskCreateStatic = 0x000227d1;
xTaskGetCurrentTaskHandle = 0x00022841;
xTaskGetSchedulerState = 0x0002284d;
xTaskGetTickCount = 0x00022869;
xTaskGetTickCountFromISR = 0x00022875;
xTaskIncrementTick = 0x00022885;
xTaskPriorityDisinherit = 0x00022951;
xTaskPriorityInherit = 0x000229e5;
xTaskRemoveFromEventList = 0x00022a79;
xTaskResumeAll = 0x00022af9;
xTaskResumeFromISR = 0x00022bc1;
xTimerCreate = 0x00022c4d;
xTimerCreateStatic = 0x00022c81;
xTimerCreateTimerTask = 0x00022cb9;
xTimerGenericCommand = 0x00022d25;
xTimerGetExpiryTime = 0x00022d95;
xTimerGetTimerDaemonTaskHandle = 0x00022db5;
