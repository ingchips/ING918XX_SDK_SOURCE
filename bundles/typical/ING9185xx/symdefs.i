...
--define_symbol platform_get_us_time=0x0001d0c9
--define_symbol platform_get_version=0x0001d0cd
--define_symbol platform_hrng=0x0001d0d5
--define_symbol platform_install_isr_stack=0x0001d0dd
--define_symbol platform_patch_rf_init_data=0x0001d0e9
--define_symbol platform_printf=0x0001d0f5
--define_symbol platform_raise_assertion=0x0001d109
--define_symbol platform_rand=0x0001d11d
--define_symbol platform_read_info=0x0001d121
--define_symbol platform_read_persistent_reg=0x0001d13d
--define_symbol platform_reset=0x0001d14d
--define_symbol platform_set_evt_callback=0x0001d181
--define_symbol platform_set_irq_callback=0x0001d195
--define_symbol platform_set_rf_clk_source=0x0001d1cd
--define_symbol platform_set_rf_init_data=0x0001d1d9
--define_symbol platform_set_rf_power_mapping=0x0001d1e5
--define_symbol platform_shutdown=0x0001d1f1
--define_symbol platform_switch_app=0x0001d1f5
--define_symbol platform_trace_raw=0x0001d221
--define_symbol platform_write_persistent_reg=0x0001d235
--define_symbol printf_hexdump=0x0001d245
--define_symbol pvPortMalloc=0x0001dd15
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ddfd
--define_symbol pvTimerGetTimerID=0x0001de15
--define_symbol pxPortInitialiseStack=0x0001de41
--define_symbol reverse_128=0x0001dfe9
--define_symbol reverse_24=0x0001dfef
--define_symbol reverse_48=0x0001dff5
--define_symbol reverse_56=0x0001dffb
--define_symbol reverse_64=0x0001e001
--define_symbol reverse_bd_addr=0x0001e007
--define_symbol reverse_bytes=0x0001e00d
--define_symbol sm_add_event_handler=0x0001e179
--define_symbol sm_address_resolution_lookup=0x0001e2a5
--define_symbol sm_authenticated=0x0001e5f1
--define_symbol sm_authorization_decline=0x0001e5ff
--define_symbol sm_authorization_grant=0x0001e61f
--define_symbol sm_authorization_state=0x0001e63f
--define_symbol sm_bonding_decline=0x0001e659
--define_symbol sm_config=0x0001ea25
--define_symbol sm_config_conn=0x0001ea3d
--define_symbol sm_encryption_key_size=0x0001eb9b
--define_symbol sm_just_works_confirm=0x0001efc1
--define_symbol sm_le_device_key=0x0001f1ed
--define_symbol sm_passkey_input=0x0001f283
...
--define_symbol sm_register_oob_data_callback=0x0001f741
--define_symbol sm_request_pairing=0x0001f74d
--define_symbol sm_send_security_request=0x0002008b
...
--define_symbol vPortEnterCritical=0x00020ed9
--define_symbol vPortExitCritical=0x00020f19
--define_symbol vPortFree=0x00020f45
--define_symbol vPortSuppressTicksAndSleep=0x00020fd9
--define_symbol vPortValidateInterruptPriority=0x000210b1
--define_symbol vQueueDelete=0x00021105
--define_symbol vQueueWaitForMessageRestricted=0x00021131
--define_symbol vTaskDelay=0x00021179
--define_symbol vTaskInternalSetTimeOutState=0x000211c5
--define_symbol vTaskMissedYield=0x000211d5
--define_symbol vTaskPlaceOnEventList=0x000211e1
--define_symbol vTaskPlaceOnEventListRestricted=0x00021219
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021259
--define_symbol vTaskStartScheduler=0x00021305
--define_symbol vTaskStepTick=0x00021395
--define_symbol vTaskSuspendAll=0x000213c5
--define_symbol vTaskSwitchContext=0x000213d5
--define_symbol xPortStartScheduler=0x0002147d
--define_symbol xQueueAddToSet=0x00021539
--define_symbol xQueueCreateCountingSemaphore=0x0002155d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021599
--define_symbol xQueueCreateMutex=0x000215dd
--define_symbol xQueueCreateMutexStatic=0x000215f3
--define_symbol xQueueCreateSet=0x0002160d
--define_symbol xQueueGenericCreate=0x00021615
--define_symbol xQueueGenericCreateStatic=0x00021661
--define_symbol xQueueGenericReset=0x000216c9
--define_symbol xQueueGenericSend=0x00021755
--define_symbol xQueueGenericSendFromISR=0x000218c1
--define_symbol xQueueGiveFromISR=0x00021981
--define_symbol xQueueGiveMutexRecursive=0x00021a25
--define_symbol xQueueIsQueueEmptyFromISR=0x00021a65
--define_symbol xQueueIsQueueFullFromISR=0x00021a89
--define_symbol xQueuePeek=0x00021ab1
--define_symbol xQueuePeekFromISR=0x00021bd9
--define_symbol xQueueReceive=0x00021c45
--define_symbol xQueueReceiveFromISR=0x00021d71
--define_symbol xQueueRemoveFromSet=0x00021e05
--define_symbol xQueueSelectFromSet=0x00021e27
--define_symbol xQueueSelectFromSetFromISR=0x00021e39
--define_symbol xQueueSemaphoreTake=0x00021e4d
--define_symbol xQueueTakeMutexRecursive=0x00021fb9
...
--define_symbol xTaskGetCurrentTaskHandle=0x00022139
--define_symbol xTaskGetSchedulerState=0x00022145
--define_symbol xTaskGetTickCount=0x00022161
--define_symbol xTaskGetTickCountFromISR=0x0002216d
--define_symbol xTaskIncrementTick=0x0002217d
--define_symbol xTaskPriorityDisinherit=0x00022249
--define_symbol xTaskPriorityInherit=0x000222dd
--define_symbol xTaskRemoveFromEventList=0x00022371
--define_symbol xTaskResumeAll=0x000223f1
--define_symbol xTimerCreate=0x000224b9
--define_symbol xTimerCreateStatic=0x000224ed
--define_symbol xTimerCreateTimerTask=0x00022525
--define_symbol xTimerGenericCommand=0x00022591
--define_symbol xTimerGetExpiryTime=0x00022601
