...
--define_symbol nibble_for_char=0x0001cf81
--define_symbol platform_32k_rc_auto_tune=0x0001d01d
--define_symbol platform_32k_rc_tune=0x0001d099
--define_symbol platform_calibrate_32k=0x0001d0ad
--define_symbol platform_config=0x0001d0b1
--define_symbol platform_get_heap_status=0x0001d169
...
--define_symbol platform_install_isr_stack=0x0001d195
--define_symbol platform_patch_rf_init_data=0x0001d1a1
--define_symbol platform_printf=0x0001d1ad
--define_symbol platform_raise_assertion=0x0001d1c1
--define_symbol platform_rand=0x0001d1d5
--define_symbol platform_read_info=0x0001d1d9
--define_symbol platform_read_persistent_reg=0x0001d1f5
--define_symbol platform_reset=0x0001d205
--define_symbol platform_set_evt_callback=0x0001d239
--define_symbol platform_set_irq_callback=0x0001d24d
--define_symbol platform_set_rf_clk_source=0x0001d285
--define_symbol platform_set_rf_init_data=0x0001d291
--define_symbol platform_set_rf_power_mapping=0x0001d29d
...
--define_symbol platform_write_persistent_reg=0x0001d2ed
--define_symbol printf_hexdump=0x0001d2fd
--define_symbol pvPortMalloc=0x0001de05
--define_symbol pvTaskIncrementMutexHeldCount=0x0001deed
--define_symbol pvTimerGetTimerID=0x0001df05
--define_symbol pxPortInitialiseStack=0x0001df31
--define_symbol reverse_128=0x0001e0d9
--define_symbol reverse_24=0x0001e0df
--define_symbol reverse_48=0x0001e0e5
--define_symbol reverse_56=0x0001e0eb
--define_symbol reverse_64=0x0001e0f1
--define_symbol reverse_bd_addr=0x0001e0f7
--define_symbol reverse_bytes=0x0001e0fd
--define_symbol sm_add_event_handler=0x0001e269
--define_symbol sm_address_resolution_lookup=0x0001e395
--define_symbol sm_authenticated=0x0001e6e1
--define_symbol sm_authorization_decline=0x0001e6ef
--define_symbol sm_authorization_grant=0x0001e70f
--define_symbol sm_authorization_state=0x0001e72f
--define_symbol sm_bonding_decline=0x0001e749
--define_symbol sm_config=0x0001eb15
--define_symbol sm_config_conn=0x0001eb2d
--define_symbol sm_encryption_key_size=0x0001ec8b
--define_symbol sm_just_works_confirm=0x0001f0b1
--define_symbol sm_le_device_key=0x0001f2dd
--define_symbol sm_passkey_input=0x0001f373
...
--define_symbol sm_send_security_request=0x0002017b
--define_symbol sm_set_accepted_stk_generation_methods=0x000201a1
--define_symbol sm_set_authentication_requirements=0x000201ad
--define_symbol sm_set_encryption_key_size_range=0x000201b9
--define_symbol sscanf_bd_addr=0x0002048d
--define_symbol sysSetPublicDeviceAddr=0x000207c5
--define_symbol uuid128_to_str=0x00020d9d
--define_symbol uuid_add_bluetooth_prefix=0x00020df5
--define_symbol uuid_has_bluetooth_prefix=0x00020e15
--define_symbol uxQueueMessagesWaiting=0x00020e59
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e81
--define_symbol uxQueueSpacesAvailable=0x00020e9d
--define_symbol uxTaskGetStackHighWaterMark=0x00020ec9
--define_symbol vPortEnterCritical=0x00020fed
--define_symbol vPortExitCritical=0x0002102d
--define_symbol vPortFree=0x00021059
--define_symbol vPortSuppressTicksAndSleep=0x000210ed
--define_symbol vPortValidateInterruptPriority=0x000211c5
--define_symbol vQueueDelete=0x00021219
--define_symbol vQueueWaitForMessageRestricted=0x00021245
--define_symbol vTaskDelay=0x0002128d
--define_symbol vTaskInternalSetTimeOutState=0x000212d9
--define_symbol vTaskMissedYield=0x000212e9
--define_symbol vTaskPlaceOnEventList=0x000212f5
--define_symbol vTaskPlaceOnEventListRestricted=0x0002132d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002136d
--define_symbol vTaskResume=0x00021419
--define_symbol vTaskStartScheduler=0x0002149d
--define_symbol vTaskStepTick=0x0002152d
--define_symbol vTaskSuspend=0x0002155d
--define_symbol vTaskSuspendAll=0x00021619
--define_symbol vTaskSwitchContext=0x00021629
--define_symbol xPortStartScheduler=0x000216d1
--define_symbol xQueueAddToSet=0x0002178d
--define_symbol xQueueCreateCountingSemaphore=0x000217b1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000217ed
--define_symbol xQueueCreateMutex=0x00021831
--define_symbol xQueueCreateMutexStatic=0x00021847
--define_symbol xQueueCreateSet=0x00021861
--define_symbol xQueueGenericCreate=0x00021869
--define_symbol xQueueGenericCreateStatic=0x000218b5
--define_symbol xQueueGenericReset=0x0002191d
--define_symbol xQueueGenericSend=0x000219a9
--define_symbol xQueueGenericSendFromISR=0x00021b15
--define_symbol xQueueGiveFromISR=0x00021bd5
--define_symbol xQueueGiveMutexRecursive=0x00021c79
--define_symbol xQueueIsQueueEmptyFromISR=0x00021cb9
--define_symbol xQueueIsQueueFullFromISR=0x00021cdd
--define_symbol xQueuePeek=0x00021d05
--define_symbol xQueuePeekFromISR=0x00021e2d
--define_symbol xQueueReceive=0x00021e99
--define_symbol xQueueReceiveFromISR=0x00021fc5
--define_symbol xQueueRemoveFromSet=0x00022059
--define_symbol xQueueSelectFromSet=0x0002207b
--define_symbol xQueueSelectFromSetFromISR=0x0002208d
--define_symbol xQueueSemaphoreTake=0x000220a1
--define_symbol xQueueTakeMutexRecursive=0x0002220d
--define_symbol xTaskCheckForTimeOut=0x00022251
--define_symbol xTaskCreate=0x000222c1
--define_symbol xTaskCreateStatic=0x0002231d
--define_symbol xTaskGetCurrentTaskHandle=0x0002238d
--define_symbol xTaskGetSchedulerState=0x00022399
--define_symbol xTaskGetTickCount=0x000223b5
--define_symbol xTaskGetTickCountFromISR=0x000223c1
--define_symbol xTaskIncrementTick=0x000223d1
--define_symbol xTaskPriorityDisinherit=0x0002249d
--define_symbol xTaskPriorityInherit=0x00022531
--define_symbol xTaskRemoveFromEventList=0x000225c5
--define_symbol xTaskResumeAll=0x00022645
--define_symbol xTaskResumeFromISR=0x0002270d
--define_symbol xTimerCreate=0x00022799
--define_symbol xTimerCreateStatic=0x000227cd
--define_symbol xTimerCreateTimerTask=0x00022805
--define_symbol xTimerGenericCommand=0x00022871
--define_symbol xTimerGetExpiryTime=0x000228e1
