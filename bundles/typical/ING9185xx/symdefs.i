...
--define_symbol nibble_for_char=0x0001cff5
--define_symbol platform_32k_rc_auto_tune=0x0001d091
--define_symbol platform_32k_rc_tune=0x0001d10d
--define_symbol platform_calibrate_32k=0x0001d121
--define_symbol platform_config=0x0001d125
--define_symbol platform_get_heap_status=0x0001d1e5
...
--define_symbol platform_read_persistent_reg=0x0001d271
--define_symbol platform_reset=0x0001d281
--define_symbol platform_set_evt_callback=0x0001d2b5
--define_symbol platform_set_irq_callback=0x0001d2c9
...
--define_symbol platform_shutdown=0x0001d325
--define_symbol platform_switch_app=0x0001d329
--define_symbol platform_trace_raw=0x0001d355
--define_symbol platform_write_persistent_reg=0x0001d36d
--define_symbol printf_hexdump=0x0001d37d
--define_symbol pvPortMalloc=0x0001de89
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df71
--define_symbol pvTimerGetTimerID=0x0001df89
--define_symbol pxPortInitialiseStack=0x0001dfb5
--define_symbol reverse_128=0x0001e15d
--define_symbol reverse_24=0x0001e163
--define_symbol reverse_48=0x0001e169
--define_symbol reverse_56=0x0001e16f
--define_symbol reverse_64=0x0001e175
--define_symbol reverse_bd_addr=0x0001e17b
--define_symbol reverse_bytes=0x0001e181
--define_symbol sm_add_event_handler=0x0001e2ed
--define_symbol sm_address_resolution_lookup=0x0001e445
--define_symbol sm_authenticated=0x0001e791
--define_symbol sm_authorization_decline=0x0001e79f
--define_symbol sm_authorization_grant=0x0001e7bf
--define_symbol sm_authorization_state=0x0001e7df
--define_symbol sm_bonding_decline=0x0001e7f9
--define_symbol sm_config=0x0001ec19
--define_symbol sm_config_conn=0x0001ec31
--define_symbol sm_encryption_key_size=0x0001edb7
--define_symbol sm_just_works_confirm=0x0001f2e5
--define_symbol sm_le_device_key=0x0001f621
--define_symbol sm_passkey_input=0x0001f6b7
--define_symbol sm_private_random_address_generation_get=0x0001fa5d
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa65
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa71
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fa99
--define_symbol sm_register_oob_data_callback=0x0001fbd5
--define_symbol sm_request_pairing=0x0001fbe1
--define_symbol sm_send_security_request=0x000205db
--define_symbol sm_set_accepted_stk_generation_methods=0x00020601
--define_symbol sm_set_authentication_requirements=0x0002060d
--define_symbol sm_set_encryption_key_size_range=0x00020619
--define_symbol sscanf_bd_addr=0x00020975
--define_symbol sysSetPublicDeviceAddr=0x00020cdd
...
--define_symbol uxListRemove=0x00021365
...
--define_symbol vListInitialise=0x000214a3
--define_symbol vListInitialiseItem=0x000214b9
--define_symbol vListInsert=0x000214bf
--define_symbol vListInsertEnd=0x000214ef
--define_symbol vPortEnterCritical=0x00021509
--define_symbol vPortExitCritical=0x0002154d
--define_symbol vPortFree=0x0002157d
--define_symbol vPortSuppressTicksAndSleep=0x00021611
--define_symbol vPortValidateInterruptPriority=0x00021731
--define_symbol vQueueDelete=0x00021789
--define_symbol vQueueWaitForMessageRestricted=0x000217b5
--define_symbol vTaskDelay=0x000217fd
--define_symbol vTaskInternalSetTimeOutState=0x00021849
--define_symbol vTaskMissedYield=0x00021859
--define_symbol vTaskPlaceOnEventList=0x00021865
--define_symbol vTaskPlaceOnEventListRestricted=0x0002189d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218dd
--define_symbol vTaskResume=0x00021989
--define_symbol vTaskStartScheduler=0x00021a0d
--define_symbol vTaskStepTick=0x00021a9d
--define_symbol vTaskSuspend=0x00021acd
--define_symbol vTaskSuspendAll=0x00021b89
--define_symbol vTaskSwitchContext=0x00021b99
--define_symbol xPortStartScheduler=0x00021c41
