...
--define_symbol sm_just_works_confirm=0x0001f1ed
--define_symbol sm_le_device_key=0x0001f529
--define_symbol sm_passkey_input=0x0001f5bf
...
--define_symbol sm_register_oob_data_callback=0x0001fae5
--define_symbol sm_request_pairing=0x0001faf1
--define_symbol sm_send_security_request=0x0002050f
--define_symbol sm_set_accepted_stk_generation_methods=0x00020535
--define_symbol sm_set_authentication_requirements=0x00020541
--define_symbol sm_set_encryption_key_size_range=0x0002054d
--define_symbol sscanf_bd_addr=0x000208a9
--define_symbol sysSetPublicDeviceAddr=0x00020c11
--define_symbol uuid128_to_str=0x000211f5
--define_symbol uuid_add_bluetooth_prefix=0x0002124d
--define_symbol uuid_has_bluetooth_prefix=0x0002126d
--define_symbol uxListRemove=0x00021289
--define_symbol uxQueueMessagesWaiting=0x000212b1
--define_symbol uxQueueMessagesWaitingFromISR=0x000212d9
--define_symbol uxQueueSpacesAvailable=0x000212f5
--define_symbol uxTaskGetStackHighWaterMark=0x00021321
--define_symbol uxTaskPriorityGet=0x00021341
--define_symbol uxTaskPriorityGetFromISR=0x0002135d
--define_symbol vListInitialise=0x0002140f
--define_symbol vListInitialiseItem=0x00021425
--define_symbol vListInsert=0x0002142b
--define_symbol vListInsertEnd=0x0002145b
--define_symbol vPortEndScheduler=0x00021475
...
--define_symbol vPortValidateInterruptPriority=0x000216ad
--define_symbol vQueueDelete=0x00021705
--define_symbol vQueueWaitForMessageRestricted=0x00021731
--define_symbol vTaskDelay=0x00021779
--define_symbol vTaskInternalSetTimeOutState=0x000217c5
--define_symbol vTaskMissedYield=0x000217d5
--define_symbol vTaskPlaceOnEventList=0x000217e1
--define_symbol vTaskPlaceOnEventListRestricted=0x00021819
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021859
--define_symbol vTaskPrioritySet=0x00021905
...
--define_symbol xQueueAddToSet=0x00021d45
--define_symbol xQueueCreateCountingSemaphore=0x00021d69
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021da5
--define_symbol xQueueCreateMutex=0x00021de9
--define_symbol xQueueCreateMutexStatic=0x00021dff
--define_symbol xQueueCreateSet=0x00021e19
--define_symbol xQueueGenericCreate=0x00021e21
--define_symbol xQueueGenericCreateStatic=0x00021e6d
--define_symbol xQueueGenericReset=0x00021ed5
--define_symbol xQueueGenericSend=0x00021f61
--define_symbol xQueueGenericSendFromISR=0x000220cd
--define_symbol xQueueGiveFromISR=0x0002218d
--define_symbol xQueueGiveMutexRecursive=0x00022231
--define_symbol xQueueIsQueueEmptyFromISR=0x00022271
--define_symbol xQueueIsQueueFullFromISR=0x00022295
--define_symbol xQueuePeek=0x000222bd
--define_symbol xQueuePeekFromISR=0x000223e5
--define_symbol xQueueReceive=0x00022451
--define_symbol xQueueReceiveFromISR=0x0002257d
--define_symbol xQueueRemoveFromSet=0x00022611
--define_symbol xQueueSelectFromSet=0x00022633
--define_symbol xQueueSelectFromSetFromISR=0x00022645
--define_symbol xQueueSemaphoreTake=0x00022659
--define_symbol xQueueTakeMutexRecursive=0x000227c5
--define_symbol xTaskCheckForTimeOut=0x00022809
--define_symbol xTaskCreate=0x00022879
--define_symbol xTaskCreateStatic=0x000228d5
--define_symbol xTaskGetCurrentTaskHandle=0x00022945
--define_symbol xTaskGetSchedulerState=0x00022951
--define_symbol xTaskGetTickCount=0x0002296d
--define_symbol xTaskGetTickCountFromISR=0x00022979
--define_symbol xTaskIncrementTick=0x00022989
--define_symbol xTaskPriorityDisinherit=0x00022a55
--define_symbol xTaskPriorityInherit=0x00022ae9
--define_symbol xTaskRemoveFromEventList=0x00022b7d
--define_symbol xTaskResumeAll=0x00022bfd
--define_symbol xTaskResumeFromISR=0x00022cc5
--define_symbol xTimerCreate=0x00022d51
--define_symbol xTimerCreateStatic=0x00022d85
--define_symbol xTimerCreateTimerTask=0x00022dbd
--define_symbol xTimerGenericCommand=0x00022e29
--define_symbol xTimerGetExpiryTime=0x00022e99
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00022eb9
