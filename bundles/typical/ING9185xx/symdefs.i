...
--define_symbol sysSetPublicDeviceAddr=0x000207ad
--define_symbol uuid128_to_str=0x00020d85
--define_symbol uuid_add_bluetooth_prefix=0x00020ddd
--define_symbol uuid_has_bluetooth_prefix=0x00020dfd
--define_symbol uxQueueMessagesWaiting=0x00020e41
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e69
--define_symbol uxQueueSpacesAvailable=0x00020e85
--define_symbol uxTaskGetStackHighWaterMark=0x00020eb1
--define_symbol vPortEnterCritical=0x00020fd5
--define_symbol vPortExitCritical=0x00021015
--define_symbol vPortFree=0x00021041
--define_symbol vPortSuppressTicksAndSleep=0x000210d5
--define_symbol vPortValidateInterruptPriority=0x000211ad
--define_symbol vQueueDelete=0x00021201
--define_symbol vQueueWaitForMessageRestricted=0x0002122d
--define_symbol vTaskDelay=0x00021275
--define_symbol vTaskInternalSetTimeOutState=0x000212c1
--define_symbol vTaskMissedYield=0x000212d1
--define_symbol vTaskPlaceOnEventList=0x000212dd
--define_symbol vTaskPlaceOnEventListRestricted=0x00021315
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021355
--define_symbol vTaskResume=0x00021401
--define_symbol vTaskStartScheduler=0x00021485
--define_symbol vTaskStepTick=0x00021515
--define_symbol vTaskSuspend=0x00021545
--define_symbol vTaskSuspendAll=0x00021601
--define_symbol vTaskSwitchContext=0x00021611
--define_symbol xPortStartScheduler=0x000216b9
--define_symbol xQueueAddToSet=0x00021775
--define_symbol xQueueCreateCountingSemaphore=0x00021799
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000217d5
--define_symbol xQueueCreateMutex=0x00021819
--define_symbol xQueueCreateMutexStatic=0x0002182f
--define_symbol xQueueCreateSet=0x00021849
--define_symbol xQueueGenericCreate=0x00021851
--define_symbol xQueueGenericCreateStatic=0x0002189d
--define_symbol xQueueGenericReset=0x00021905
--define_symbol xQueueGenericSend=0x00021991
--define_symbol xQueueGenericSendFromISR=0x00021afd
--define_symbol xQueueGiveFromISR=0x00021bbd
--define_symbol xQueueGiveMutexRecursive=0x00021c61
--define_symbol xQueueIsQueueEmptyFromISR=0x00021ca1
--define_symbol xQueueIsQueueFullFromISR=0x00021cc5
--define_symbol xQueuePeek=0x00021ced
--define_symbol xQueuePeekFromISR=0x00021e15
--define_symbol xQueueReceive=0x00021e81
--define_symbol xQueueReceiveFromISR=0x00021fad
--define_symbol xQueueRemoveFromSet=0x00022041
--define_symbol xQueueSelectFromSet=0x00022063
--define_symbol xQueueSelectFromSetFromISR=0x00022075
--define_symbol xQueueSemaphoreTake=0x00022089
--define_symbol xQueueTakeMutexRecursive=0x000221f5
--define_symbol xTaskCheckForTimeOut=0x00022239
--define_symbol xTaskCreate=0x000222a9
--define_symbol xTaskCreateStatic=0x00022305
--define_symbol xTaskGetCurrentTaskHandle=0x00022375
--define_symbol xTaskGetSchedulerState=0x00022381
--define_symbol xTaskGetTickCount=0x0002239d
--define_symbol xTaskGetTickCountFromISR=0x000223a9
--define_symbol xTaskIncrementTick=0x000223b9
--define_symbol xTaskPriorityDisinherit=0x00022485
--define_symbol xTaskPriorityInherit=0x00022519
--define_symbol xTaskRemoveFromEventList=0x000225ad
--define_symbol xTaskResumeAll=0x0002262d
--define_symbol xTaskResumeFromISR=0x000226f5
--define_symbol xTimerCreate=0x00022781
--define_symbol xTimerCreateStatic=0x000227b5
--define_symbol xTimerCreateTimerTask=0x000227ed
--define_symbol xTimerGenericCommand=0x00022859
--define_symbol xTimerGetExpiryTime=0x000228c9
