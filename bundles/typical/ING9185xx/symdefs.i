...
--define_symbol pvPortMalloc=0x0001dea1
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df89
--define_symbol pvTimerGetTimerID=0x0001dfa1
--define_symbol pxPortInitialiseStack=0x0001dfcd
--define_symbol reverse_128=0x0001e175
--define_symbol reverse_24=0x0001e17b
--define_symbol reverse_48=0x0001e181
--define_symbol reverse_56=0x0001e187
--define_symbol reverse_64=0x0001e18d
--define_symbol reverse_bd_addr=0x0001e193
--define_symbol reverse_bytes=0x0001e199
--define_symbol sm_add_event_handler=0x0001e305
--define_symbol sm_address_resolution_lookup=0x0001e45d
--define_symbol sm_authenticated=0x0001e7a9
--define_symbol sm_authorization_decline=0x0001e7b7
--define_symbol sm_authorization_grant=0x0001e7d7
--define_symbol sm_authorization_state=0x0001e7f7
--define_symbol sm_bonding_decline=0x0001e811
--define_symbol sm_config=0x0001ec31
--define_symbol sm_config_conn=0x0001ec49
--define_symbol sm_encryption_key_size=0x0001edcf
--define_symbol sm_just_works_confirm=0x0001f2fd
--define_symbol sm_le_device_key=0x0001f639
--define_symbol sm_passkey_input=0x0001f6cf
--define_symbol sm_private_random_address_generation_get=0x0001fa75
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa7d
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa89
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fab1
--define_symbol sm_register_oob_data_callback=0x0001fbed
--define_symbol sm_request_pairing=0x0001fbf9
--define_symbol sm_send_security_request=0x000205f3
--define_symbol sm_set_accepted_stk_generation_methods=0x00020619
--define_symbol sm_set_authentication_requirements=0x00020625
--define_symbol sm_set_encryption_key_size_range=0x00020631
--define_symbol sscanf_bd_addr=0x0002098d
--define_symbol sysSetPublicDeviceAddr=0x00020cf5
--define_symbol uuid128_to_str=0x000212e9
--define_symbol uuid_add_bluetooth_prefix=0x00021341
--define_symbol uuid_has_bluetooth_prefix=0x00021361
--define_symbol uxListRemove=0x0002137d
--define_symbol uxQueueMessagesWaiting=0x000213a5
--define_symbol uxQueueMessagesWaitingFromISR=0x000213cd
--define_symbol uxQueueSpacesAvailable=0x000213e9
--define_symbol uxTaskGetStackHighWaterMark=0x00021415
--define_symbol vListInitialise=0x000214bb
--define_symbol vListInitialiseItem=0x000214d1
--define_symbol vListInsert=0x000214d7
--define_symbol vListInsertEnd=0x00021507
--define_symbol vPortEnterCritical=0x00021521
--define_symbol vPortExitCritical=0x00021565
--define_symbol vPortFree=0x00021595
--define_symbol vPortSuppressTicksAndSleep=0x00021629
...
--define_symbol vTaskResume=0x000219a1
--define_symbol vTaskStartScheduler=0x00021a25
--define_symbol vTaskStepTick=0x00021ab5
--define_symbol vTaskSuspend=0x00021ae5
--define_symbol vTaskSuspendAll=0x00021ba1
--define_symbol vTaskSwitchContext=0x00021bb1
--define_symbol xPortStartScheduler=0x00021c59
--define_symbol xQueueAddToSet=0x00021d1d
--define_symbol xQueueCreateCountingSemaphore=0x00021d41
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d7d
--define_symbol xQueueCreateMutex=0x00021dc1
--define_symbol xQueueCreateMutexStatic=0x00021dd7
--define_symbol xQueueCreateSet=0x00021df1
--define_symbol xQueueGenericCreate=0x00021df9
--define_symbol xQueueGenericCreateStatic=0x00021e45
--define_symbol xQueueGenericReset=0x00021ead
--define_symbol xQueueGenericSend=0x00021f39
--define_symbol xQueueGenericSendFromISR=0x000220a5
--define_symbol xQueueGiveFromISR=0x00022165
--define_symbol xQueueGiveMutexRecursive=0x00022209
--define_symbol xQueueIsQueueEmptyFromISR=0x00022249
--define_symbol xQueueIsQueueFullFromISR=0x0002226d
--define_symbol xQueuePeek=0x00022295
--define_symbol xQueuePeekFromISR=0x000223bd
--define_symbol xQueueReceive=0x00022429
--define_symbol xQueueReceiveFromISR=0x00022555
--define_symbol xQueueRemoveFromSet=0x000225e9
--define_symbol xQueueSelectFromSet=0x0002260b
--define_symbol xQueueSelectFromSetFromISR=0x0002261d
--define_symbol xQueueSemaphoreTake=0x00022631
--define_symbol xQueueTakeMutexRecursive=0x0002279d
--define_symbol xTaskCheckForTimeOut=0x000227e1
--define_symbol xTaskCreate=0x00022851
--define_symbol xTaskCreateStatic=0x000228ad
--define_symbol xTaskGetCurrentTaskHandle=0x0002291d
--define_symbol xTaskGetSchedulerState=0x00022929
--define_symbol xTaskGetTickCount=0x00022945
--define_symbol xTaskGetTickCountFromISR=0x00022951
--define_symbol xTaskIncrementTick=0x00022961
--define_symbol xTaskPriorityDisinherit=0x00022a2d
--define_symbol xTaskPriorityInherit=0x00022ac1
--define_symbol xTaskRemoveFromEventList=0x00022b55
--define_symbol xTaskResumeAll=0x00022bd5
--define_symbol xTaskResumeFromISR=0x00022c9d
--define_symbol xTimerCreate=0x00022d29
--define_symbol xTimerCreateStatic=0x00022d5d
--define_symbol xTimerCreateTimerTask=0x00022d95
--define_symbol xTimerGenericCommand=0x00022e01
--define_symbol xTimerGetExpiryTime=0x00022e71
