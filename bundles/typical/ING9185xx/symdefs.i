...
--define_symbol nibble_for_char=0x0001ce65
--define_symbol platform_32k_rc_auto_tune=0x0001cf01
--define_symbol platform_32k_rc_tune=0x0001cf7d
--define_symbol platform_calibrate_32k=0x0001cf91
--define_symbol platform_config=0x0001cf95
--define_symbol platform_get_heap_status=0x0001d04d
...
--define_symbol platform_shutdown=0x0001d18d
--define_symbol platform_switch_app=0x0001d191
--define_symbol platform_trace_raw=0x0001d1bd
--define_symbol platform_write_persistent_reg=0x0001d1d1
--define_symbol printf_hexdump=0x0001d1e1
...
--define_symbol sm_config=0x0001e9c1
--define_symbol sm_config_conn=0x0001e9d9
--define_symbol sm_encryption_key_size=0x0001eb37
--define_symbol sm_just_works_confirm=0x0001ef5d
--define_symbol sm_le_device_key=0x0001f189
--define_symbol sm_passkey_input=0x0001f21f
...
--define_symbol sm_register_oob_data_callback=0x0001f6dd
--define_symbol sm_request_pairing=0x0001f6e9
--define_symbol sm_send_security_request=0x00020027
--define_symbol sm_set_accepted_stk_generation_methods=0x0002004d
--define_symbol sm_set_authentication_requirements=0x00020059
--define_symbol sm_set_encryption_key_size_range=0x00020065
--define_symbol sscanf_bd_addr=0x00020339
--define_symbol sysSetPublicDeviceAddr=0x0002067d
--define_symbol uuid128_to_str=0x00020c25
--define_symbol uuid_add_bluetooth_prefix=0x00020c7d
--define_symbol uuid_has_bluetooth_prefix=0x00020c9d
--define_symbol uxQueueMessagesWaiting=0x00020ce1
--define_symbol uxQueueMessagesWaitingFromISR=0x00020d09
--define_symbol uxQueueSpacesAvailable=0x00020d25
--define_symbol uxTaskGetStackHighWaterMark=0x00020d51
--define_symbol vPortEnterCritical=0x00020e75
--define_symbol vPortExitCritical=0x00020eb5
--define_symbol vPortFree=0x00020ee1
--define_symbol vPortSuppressTicksAndSleep=0x00020f75
--define_symbol vPortValidateInterruptPriority=0x0002104d
--define_symbol vQueueDelete=0x000210a1
--define_symbol vQueueWaitForMessageRestricted=0x000210cd
--define_symbol vTaskDelay=0x00021115
--define_symbol vTaskInternalSetTimeOutState=0x00021161
--define_symbol vTaskMissedYield=0x00021171
--define_symbol vTaskPlaceOnEventList=0x0002117d
--define_symbol vTaskPlaceOnEventListRestricted=0x000211b5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000211f5
--define_symbol vTaskStartScheduler=0x000212a1
--define_symbol vTaskStepTick=0x00021331
--define_symbol vTaskSuspendAll=0x00021361
--define_symbol vTaskSwitchContext=0x00021371
--define_symbol xPortStartScheduler=0x00021419
--define_symbol xQueueAddToSet=0x000214d5
--define_symbol xQueueCreateCountingSemaphore=0x000214f9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021535
--define_symbol xQueueCreateMutex=0x00021579
--define_symbol xQueueCreateMutexStatic=0x0002158f
--define_symbol xQueueCreateSet=0x000215a9
--define_symbol xQueueGenericCreate=0x000215b1
--define_symbol xQueueGenericCreateStatic=0x000215fd
--define_symbol xQueueGenericReset=0x00021665
--define_symbol xQueueGenericSend=0x000216f1
--define_symbol xQueueGenericSendFromISR=0x0002185d
--define_symbol xQueueGiveFromISR=0x0002191d
--define_symbol xQueueGiveMutexRecursive=0x000219c1
--define_symbol xQueueIsQueueEmptyFromISR=0x00021a01
--define_symbol xQueueIsQueueFullFromISR=0x00021a25
--define_symbol xQueuePeek=0x00021a4d
--define_symbol xQueuePeekFromISR=0x00021b75
--define_symbol xQueueReceive=0x00021be1
--define_symbol xQueueReceiveFromISR=0x00021d0d
--define_symbol xQueueRemoveFromSet=0x00021da1
--define_symbol xQueueSelectFromSet=0x00021dc3
--define_symbol xQueueSelectFromSetFromISR=0x00021dd5
--define_symbol xQueueSemaphoreTake=0x00021de9
--define_symbol xQueueTakeMutexRecursive=0x00021f55
--define_symbol xTaskCheckForTimeOut=0x00021f99
--define_symbol xTaskCreate=0x00022009
--define_symbol xTaskCreateStatic=0x00022065
--define_symbol xTaskGetCurrentTaskHandle=0x000220d5
--define_symbol xTaskGetSchedulerState=0x000220e1
--define_symbol xTaskGetTickCount=0x000220fd
--define_symbol xTaskGetTickCountFromISR=0x00022109
--define_symbol xTaskIncrementTick=0x00022119
--define_symbol xTaskPriorityDisinherit=0x000221e5
--define_symbol xTaskPriorityInherit=0x00022279
--define_symbol xTaskRemoveFromEventList=0x0002230d
--define_symbol xTaskResumeAll=0x0002238d
--define_symbol xTimerCreate=0x00022455
--define_symbol xTimerCreateStatic=0x00022489
--define_symbol xTimerCreateTimerTask=0x000224c1
--define_symbol xTimerGenericCommand=0x0002252d
--define_symbol xTimerGetExpiryTime=0x0002259d
