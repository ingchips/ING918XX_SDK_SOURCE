...
--define_symbol sm_address_resolution_lookup=0x0001e309
--define_symbol sm_authenticated=0x0001e655
--define_symbol sm_authorization_decline=0x0001e663
--define_symbol sm_authorization_grant=0x0001e683
--define_symbol sm_authorization_state=0x0001e6a3
--define_symbol sm_bonding_decline=0x0001e6bd
--define_symbol sm_config=0x0001ea89
--define_symbol sm_config_conn=0x0001eaa1
--define_symbol sm_encryption_key_size=0x0001ebff
--define_symbol sm_just_works_confirm=0x0001f025
--define_symbol sm_le_device_key=0x0001f251
--define_symbol sm_passkey_input=0x0001f2e7
...
--define_symbol sm_register_oob_data_callback=0x0001f7a5
--define_symbol sm_request_pairing=0x0001f7b1
--define_symbol sm_send_security_request=0x000200ef
...
--define_symbol uuid128_to_str=0x00020d1d
--define_symbol uuid_add_bluetooth_prefix=0x00020d75
--define_symbol uuid_has_bluetooth_prefix=0x00020d95
--define_symbol uxQueueMessagesWaiting=0x00020dd9
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e01
--define_symbol uxQueueSpacesAvailable=0x00020e1d
--define_symbol uxTaskGetStackHighWaterMark=0x00020e49
--define_symbol vPortEnterCritical=0x00020f6d
--define_symbol vPortExitCritical=0x00020fad
--define_symbol vPortFree=0x00020fd9
--define_symbol vPortSuppressTicksAndSleep=0x0002106d
--define_symbol vPortValidateInterruptPriority=0x00021145
--define_symbol vQueueDelete=0x00021199
--define_symbol vQueueWaitForMessageRestricted=0x000211c5
--define_symbol vTaskDelay=0x0002120d
--define_symbol vTaskInternalSetTimeOutState=0x00021259
--define_symbol vTaskMissedYield=0x00021269
--define_symbol vTaskPlaceOnEventList=0x00021275
--define_symbol vTaskPlaceOnEventListRestricted=0x000212ad
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000212ed
--define_symbol vTaskResume=0x00021399
--define_symbol vTaskStartScheduler=0x0002141d
--define_symbol vTaskStepTick=0x000214ad
--define_symbol vTaskSuspend=0x000214dd
--define_symbol vTaskSuspendAll=0x00021599
--define_symbol vTaskSwitchContext=0x000215a9
--define_symbol xPortStartScheduler=0x00021651
--define_symbol xQueueAddToSet=0x0002170d
--define_symbol xQueueCreateCountingSemaphore=0x00021731
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002176d
--define_symbol xQueueCreateMutex=0x000217b1
--define_symbol xQueueCreateMutexStatic=0x000217c7
--define_symbol xQueueCreateSet=0x000217e1
--define_symbol xQueueGenericCreate=0x000217e9
--define_symbol xQueueGenericCreateStatic=0x00021835
--define_symbol xQueueGenericReset=0x0002189d
--define_symbol xQueueGenericSend=0x00021929
--define_symbol xQueueGenericSendFromISR=0x00021a95
--define_symbol xQueueGiveFromISR=0x00021b55
--define_symbol xQueueGiveMutexRecursive=0x00021bf9
--define_symbol xQueueIsQueueEmptyFromISR=0x00021c39
--define_symbol xQueueIsQueueFullFromISR=0x00021c5d
--define_symbol xQueuePeek=0x00021c85
--define_symbol xQueuePeekFromISR=0x00021dad
--define_symbol xQueueReceive=0x00021e19
--define_symbol xQueueReceiveFromISR=0x00021f45
--define_symbol xQueueRemoveFromSet=0x00021fd9
--define_symbol xQueueSelectFromSet=0x00021ffb
--define_symbol xQueueSelectFromSetFromISR=0x0002200d
--define_symbol xQueueSemaphoreTake=0x00022021
--define_symbol xQueueTakeMutexRecursive=0x0002218d
--define_symbol xTaskCheckForTimeOut=0x000221d1
--define_symbol xTaskCreate=0x00022241
--define_symbol xTaskCreateStatic=0x0002229d
--define_symbol xTaskGetCurrentTaskHandle=0x0002230d
--define_symbol xTaskGetSchedulerState=0x00022319
--define_symbol xTaskGetTickCount=0x00022335
--define_symbol xTaskGetTickCountFromISR=0x00022341
--define_symbol xTaskIncrementTick=0x00022351
--define_symbol xTaskPriorityDisinherit=0x0002241d
--define_symbol xTaskPriorityInherit=0x000224b1
--define_symbol xTaskRemoveFromEventList=0x00022545
--define_symbol xTaskResumeAll=0x000225c5
--define_symbol xTaskResumeFromISR=0x0002268d
--define_symbol xTimerCreate=0x00022719
--define_symbol xTimerCreateStatic=0x0002274d
--define_symbol xTimerCreateTimerTask=0x00022785
--define_symbol xTimerGenericCommand=0x000227f1
--define_symbol xTimerGetExpiryTime=0x00022861
