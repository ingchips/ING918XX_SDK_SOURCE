...
--define_symbol pvPortMalloc=0x0001de95
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df7d
--define_symbol pvTimerGetTimerID=0x0001df95
--define_symbol pxPortInitialiseStack=0x0001dfc1
--define_symbol reverse_128=0x0001e169
--define_symbol reverse_24=0x0001e16f
--define_symbol reverse_48=0x0001e175
--define_symbol reverse_56=0x0001e17b
--define_symbol reverse_64=0x0001e181
--define_symbol reverse_bd_addr=0x0001e187
--define_symbol reverse_bytes=0x0001e18d
--define_symbol sm_add_event_handler=0x0001e2f9
--define_symbol sm_address_resolution_lookup=0x0001e451
--define_symbol sm_authenticated=0x0001e79d
--define_symbol sm_authorization_decline=0x0001e7ab
--define_symbol sm_authorization_grant=0x0001e7cb
--define_symbol sm_authorization_state=0x0001e7eb
--define_symbol sm_bonding_decline=0x0001e805
--define_symbol sm_config=0x0001ec25
--define_symbol sm_config_conn=0x0001ec3d
--define_symbol sm_encryption_key_size=0x0001edc3
--define_symbol sm_just_works_confirm=0x0001f2f1
--define_symbol sm_le_device_key=0x0001f62d
--define_symbol sm_passkey_input=0x0001f6c3
...
--define_symbol sm_send_security_request=0x000205e7
--define_symbol sm_set_accepted_stk_generation_methods=0x0002060d
--define_symbol sm_set_authentication_requirements=0x00020619
--define_symbol sm_set_encryption_key_size_range=0x00020625
--define_symbol sscanf_bd_addr=0x00020981
--define_symbol sysSetPublicDeviceAddr=0x00020ce9
--define_symbol uuid128_to_str=0x000212dd
--define_symbol uuid_add_bluetooth_prefix=0x00021335
--define_symbol uuid_has_bluetooth_prefix=0x00021355
--define_symbol uxListRemove=0x00021371
--define_symbol uxQueueMessagesWaiting=0x00021399
--define_symbol uxQueueMessagesWaitingFromISR=0x000213c1
--define_symbol uxQueueSpacesAvailable=0x000213dd
--define_symbol uxTaskGetStackHighWaterMark=0x00021409
--define_symbol vListInitialise=0x000214af
--define_symbol vListInitialiseItem=0x000214c5
--define_symbol vListInsert=0x000214cb
--define_symbol vListInsertEnd=0x000214fb
--define_symbol vPortEnterCritical=0x00021515
--define_symbol vPortExitCritical=0x00021559
--define_symbol vPortFree=0x00021589
--define_symbol vPortSuppressTicksAndSleep=0x0002161d
--define_symbol vPortValidateInterruptPriority=0x0002173d
--define_symbol vQueueDelete=0x00021795
--define_symbol vQueueWaitForMessageRestricted=0x000217c1
--define_symbol vTaskDelay=0x00021809
--define_symbol vTaskInternalSetTimeOutState=0x00021855
--define_symbol vTaskMissedYield=0x00021865
--define_symbol vTaskPlaceOnEventList=0x00021871
--define_symbol vTaskPlaceOnEventListRestricted=0x000218a9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218e9
--define_symbol vTaskResume=0x00021995
--define_symbol vTaskStartScheduler=0x00021a19
--define_symbol vTaskStepTick=0x00021aa9
--define_symbol vTaskSuspend=0x00021ad9
--define_symbol vTaskSuspendAll=0x00021b95
--define_symbol vTaskSwitchContext=0x00021ba5
--define_symbol xPortStartScheduler=0x00021c4d
--define_symbol xQueueAddToSet=0x00021d11
--define_symbol xQueueCreateCountingSemaphore=0x00021d35
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d71
--define_symbol xQueueCreateMutex=0x00021db5
--define_symbol xQueueCreateMutexStatic=0x00021dcb
--define_symbol xQueueCreateSet=0x00021de5
--define_symbol xQueueGenericCreate=0x00021ded
--define_symbol xQueueGenericCreateStatic=0x00021e39
--define_symbol xQueueGenericReset=0x00021ea1
--define_symbol xQueueGenericSend=0x00021f2d
--define_symbol xQueueGenericSendFromISR=0x00022099
--define_symbol xQueueGiveFromISR=0x00022159
--define_symbol xQueueGiveMutexRecursive=0x000221fd
--define_symbol xQueueIsQueueEmptyFromISR=0x0002223d
--define_symbol xQueueIsQueueFullFromISR=0x00022261
--define_symbol xQueuePeek=0x00022289
--define_symbol xQueuePeekFromISR=0x000223b1
--define_symbol xQueueReceive=0x0002241d
--define_symbol xQueueReceiveFromISR=0x00022549
--define_symbol xQueueRemoveFromSet=0x000225dd
--define_symbol xQueueSelectFromSet=0x000225ff
--define_symbol xQueueSelectFromSetFromISR=0x00022611
--define_symbol xQueueSemaphoreTake=0x00022625
--define_symbol xQueueTakeMutexRecursive=0x00022791
--define_symbol xTaskCheckForTimeOut=0x000227d5
--define_symbol xTaskCreate=0x00022845
--define_symbol xTaskCreateStatic=0x000228a1
--define_symbol xTaskGetCurrentTaskHandle=0x00022911
--define_symbol xTaskGetSchedulerState=0x0002291d
--define_symbol xTaskGetTickCount=0x00022939
--define_symbol xTaskGetTickCountFromISR=0x00022945
--define_symbol xTaskIncrementTick=0x00022955
--define_symbol xTaskPriorityDisinherit=0x00022a21
--define_symbol xTaskPriorityInherit=0x00022ab5
--define_symbol xTaskRemoveFromEventList=0x00022b49
--define_symbol xTaskResumeAll=0x00022bc9
--define_symbol xTaskResumeFromISR=0x00022c91
--define_symbol xTimerCreate=0x00022d1d
--define_symbol xTimerCreateStatic=0x00022d51
--define_symbol xTimerCreateTimerTask=0x00022d89
--define_symbol xTimerGenericCommand=0x00022df5
--define_symbol xTimerGetExpiryTime=0x00022e65
