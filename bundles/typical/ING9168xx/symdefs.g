...
sm_just_works_confirm = 0x0201ddc9;
sm_le_device_key = 0x0201e105;
sm_passkey_input = 0x0201e19b;
sm_private_random_address_generation_get = 0x0201e549;
sm_private_random_address_generation_get_mode = 0x0201e551;
sm_private_random_address_generation_set_mode = 0x0201e55d;
sm_private_random_address_generation_set_update_period = 0x0201e585;
sm_register_oob_data_callback = 0x0201e6c1;
sm_request_pairing = 0x0201e6cd;
sm_send_security_request = 0x0201f0d3;
sm_set_accepted_stk_generation_methods = 0x0201f0f9;
sm_set_authentication_requirements = 0x0201f105;
sm_set_encryption_key_size_range = 0x0201f111;
sscanf_bd_addr = 0x0201f465;
sysSetPublicDeviceAddr = 0x0201f4f1;
uuid128_to_str = 0x0201fa4d;
uuid_add_bluetooth_prefix = 0x0201faa5;
uuid_has_bluetooth_prefix = 0x0201fac5;
uxListRemove = 0x0201fae1;
uxQueueMessagesWaiting = 0x0201fb09;
uxQueueMessagesWaitingFromISR = 0x0201fb31;
uxQueueSpacesAvailable = 0x0201fb4d;
uxTaskGetStackHighWaterMark = 0x0201fb79;
uxTaskPriorityGet = 0x0201fb99;
uxTaskPriorityGetFromISR = 0x0201fbb5;
vListInitialise = 0x0201fc13;
vListInitialiseItem = 0x0201fc29;
vListInsert = 0x0201fc2f;
vListInsertEnd = 0x0201fc5f;
vPortEnterCritical = 0x0201fc79;
vPortExitCritical = 0x0201fcb9;
vPortFree = 0x0201fce5;
vPortValidateInterruptPriority = 0x0201fd65;
vQueueDelete = 0x0201fdb9;
vQueueWaitForMessageRestricted = 0x0201fde5;
vTaskDelay = 0x0201fe2d;
vTaskInternalSetTimeOutState = 0x0201fe79;
vTaskMissedYield = 0x0201fe89;
vTaskPlaceOnEventList = 0x0201fe95;
vTaskPlaceOnEventListRestricted = 0x0201fecd;
vTaskPriorityDisinheritAfterTimeout = 0x0201ff0d;
vTaskPrioritySet = 0x0201ffb9;
vTaskResume = 0x02020081;
vTaskStartScheduler = 0x02020105;
vTaskSuspend = 0x02020195;
vTaskSuspendAll = 0x02020251;
vTaskSwitchContext = 0x02020261;
xPortStartScheduler = 0x02020309;
xQueueAddToSet = 0x02020405;
xQueueCreateCountingSemaphore = 0x02020429;
xQueueCreateCountingSemaphoreStatic = 0x02020465;
xQueueCreateMutex = 0x020204a9;
xQueueCreateMutexStatic = 0x020204bf;
xQueueCreateSet = 0x020204d9;
xQueueGenericCreate = 0x020204e1;
xQueueGenericCreateStatic = 0x0202052d;
xQueueGenericReset = 0x02020595;
xQueueGenericSend = 0x02020621;
xQueueGenericSendFromISR = 0x0202078d;
xQueueGiveFromISR = 0x0202084d;
xQueueGiveMutexRecursive = 0x020208f1;
xQueueIsQueueEmptyFromISR = 0x02020931;
xQueueIsQueueFullFromISR = 0x02020955;
xQueuePeek = 0x0202097d;
xQueuePeekFromISR = 0x02020aa5;
xQueueReceive = 0x02020b11;
xQueueReceiveFromISR = 0x02020c3d;
xQueueRemoveFromSet = 0x02020cd1;
xQueueSelectFromSet = 0x02020cf3;
xQueueSelectFromSetFromISR = 0x02020d05;
xQueueSemaphoreTake = 0x02020d19;
xQueueTakeMutexRecursive = 0x02020e85;
xTaskCheckForTimeOut = 0x02020ec9;
xTaskCreate = 0x02020f39;
xTaskCreateStatic = 0x02020f95;
xTaskGetCurrentTaskHandle = 0x02021005;
xTaskGetSchedulerState = 0x02021011;
xTaskGetTickCount = 0x0202102d;
xTaskGetTickCountFromISR = 0x02021039;
xTaskIncrementTick = 0x02021049;
xTaskPriorityDisinherit = 0x02021115;
xTaskPriorityInherit = 0x020211a9;
xTaskRemoveFromEventList = 0x0202123d;
xTaskResumeAll = 0x020212b9;
xTaskResumeFromISR = 0x02021381;
xTimerCreate = 0x0202140d;
xTimerCreateStatic = 0x02021441;
xTimerCreateTimerTask = 0x02021479;
xTimerGenericCommand = 0x020214e5;
xTimerGetExpiryTime = 0x02021555;
xTimerGetTimerDaemonTaskHandle = 0x02021575;
