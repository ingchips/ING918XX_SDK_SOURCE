...
platform_get_heap_status = 0x0001e4a5;
platform_get_us_time = 0x0001e4bd;
platform_get_version = 0x0001e4c1;
platform_hrng = 0x0001e4c9;
platform_install_isr_stack = 0x0001e4d1;
platform_patch_rf_init_data = 0x0001e4dd;
platform_printf = 0x0001e4e9;
platform_raise_assertion = 0x0001e4fd;
platform_rand = 0x0001e511;
platform_read_info = 0x0001e515;
platform_read_persistent_reg = 0x0001e531;
platform_reset = 0x0001e541;
platform_set_evt_callback = 0x0001e575;
platform_set_irq_callback = 0x0001e589;
platform_set_rf_clk_source = 0x0001e5c1;
platform_set_rf_init_data = 0x0001e5cd;
platform_set_rf_power_mapping = 0x0001e5d9;
...
reverse_128 = 0x0001f451;
reverse_24 = 0x0001f457;
reverse_48 = 0x0001f45d;
reverse_56 = 0x0001f463;
reverse_64 = 0x0001f469;
reverse_bd_addr = 0x0001f46f;
reverse_bytes = 0x0001f475;
sm_add_event_handler = 0x0001f735;
sm_address_resolution_lookup = 0x0001f88d;
sm_authenticated = 0x0001fbd9;
sm_authorization_decline = 0x0001fbe7;
sm_authorization_grant = 0x0001fc07;
sm_authorization_state = 0x0001fc27;
sm_bonding_decline = 0x0001fc41;
sm_config = 0x00020061;
sm_config_conn = 0x00020079;
sm_encryption_key_size = 0x000201ff;
sm_just_works_confirm = 0x0002072d;
sm_le_device_key = 0x00020a69;
sm_passkey_input = 0x00020aff;
sm_private_random_address_generation_get = 0x00020ea5;
sm_private_random_address_generation_get_mode = 0x00020ead;
sm_private_random_address_generation_set_mode = 0x00020eb9;
sm_private_random_address_generation_set_update_period = 0x00020ee1;
sm_register_oob_data_callback = 0x0002101d;
sm_request_pairing = 0x00021029;
sm_send_security_request = 0x00021a23;
sm_set_accepted_stk_generation_methods = 0x00021a49;
sm_set_authentication_requirements = 0x00021a55;
sm_set_encryption_key_size_range = 0x00021a61;
sscanf_bd_addr = 0x00021dbd;
sysSetPublicDeviceAddr = 0x00022125;
uuid128_to_str = 0x000228a9;
uuid_add_bluetooth_prefix = 0x00022901;
uuid_has_bluetooth_prefix = 0x00022921;
uxQueueMessagesWaiting = 0x00022965;
uxQueueMessagesWaitingFromISR = 0x0002298d;
uxQueueSpacesAvailable = 0x000229a9;
uxTaskGetStackHighWaterMark = 0x000229d5;
vPortEnterCritical = 0x00022ae1;
vPortExitCritical = 0x00022b25;
vPortFree = 0x00022b55;
vPortSuppressTicksAndSleep = 0x00022be9;
vPortValidateInterruptPriority = 0x00022d09;
