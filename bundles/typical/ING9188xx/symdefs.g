...
nibble_for_char = 0x0001e2ad;
platform_32k_rc_auto_tune = 0x0001e349;
platform_32k_rc_tune = 0x0001e3c5;
platform_calibrate_32k = 0x0001e3d9;
platform_config = 0x0001e3dd;
...
platform_write_persistent_reg = 0x0001e619;
printf_hexdump = 0x0001e629;
pvPortMalloc = 0x0001f12d;
pvTaskIncrementMutexHeldCount = 0x0001f215;
pvTimerGetTimerID = 0x0001f22d;
pxPortInitialiseStack = 0x0001f259;
reverse_128 = 0x0001f439;
reverse_24 = 0x0001f43f;
reverse_48 = 0x0001f445;
reverse_56 = 0x0001f44b;
reverse_64 = 0x0001f451;
reverse_bd_addr = 0x0001f457;
reverse_bytes = 0x0001f45d;
sm_add_event_handler = 0x0001f71d;
sm_address_resolution_lookup = 0x0001f849;
...
sm_config = 0x0001ffc9;
sm_config_conn = 0x0001ffe1;
sm_encryption_key_size = 0x0002013f;
sm_just_works_confirm = 0x00020565;
sm_le_device_key = 0x00020791;
sm_passkey_input = 0x00020827;
sm_private_random_address_generation_get = 0x00020b6d;
sm_private_random_address_generation_get_mode = 0x00020b75;
sm_private_random_address_generation_set_mode = 0x00020b81;
sm_private_random_address_generation_set_update_period = 0x00020ba9;
sm_register_oob_data_callback = 0x00020ce5;
sm_request_pairing = 0x00020cf1;
sm_send_security_request = 0x0002162f;
sm_set_accepted_stk_generation_methods = 0x00021655;
sm_set_authentication_requirements = 0x00021661;
sm_set_encryption_key_size_range = 0x0002166d;
sscanf_bd_addr = 0x00021941;
sysSetPublicDeviceAddr = 0x00021c79;
uuid128_to_str = 0x000223e1;
uuid_add_bluetooth_prefix = 0x00022439;
uuid_has_bluetooth_prefix = 0x00022459;
uxQueueMessagesWaiting = 0x0002249d;
uxQueueMessagesWaitingFromISR = 0x000224c5;
uxQueueSpacesAvailable = 0x000224e1;
uxTaskGetStackHighWaterMark = 0x0002250d;
vPortEnterCritical = 0x00022631;
vPortExitCritical = 0x00022671;
vPortFree = 0x0002269d;
vPortSuppressTicksAndSleep = 0x00022731;
vPortValidateInterruptPriority = 0x00022809;
vQueueDelete = 0x0002285d;
vQueueWaitForMessageRestricted = 0x00022889;
vTaskDelay = 0x000228d1;
vTaskInternalSetTimeOutState = 0x0002291d;
vTaskMissedYield = 0x0002292d;
vTaskPlaceOnEventList = 0x00022939;
vTaskPlaceOnEventListRestricted = 0x00022971;
vTaskPriorityDisinheritAfterTimeout = 0x000229b1;
vTaskResume = 0x00022a5d;
vTaskStartScheduler = 0x00022ae1;
vTaskStepTick = 0x00022b71;
vTaskSuspend = 0x00022ba1;
vTaskSuspendAll = 0x00022c5d;
vTaskSwitchContext = 0x00022c6d;
xPortStartScheduler = 0x00022d15;
xQueueAddToSet = 0x00022dd1;
xQueueCreateCountingSemaphore = 0x00022df5;
xQueueCreateCountingSemaphoreStatic = 0x00022e31;
xQueueCreateMutex = 0x00022e75;
xQueueCreateMutexStatic = 0x00022e8b;
xQueueCreateSet = 0x00022ea5;
xQueueGenericCreate = 0x00022ead;
xQueueGenericCreateStatic = 0x00022ef9;
xQueueGenericReset = 0x00022f61;
xQueueGenericSend = 0x00022fed;
xQueueGenericSendFromISR = 0x00023159;
xQueueGiveFromISR = 0x00023219;
xQueueGiveMutexRecursive = 0x000232bd;
xQueueIsQueueEmptyFromISR = 0x000232fd;
xQueueIsQueueFullFromISR = 0x00023321;
xQueuePeek = 0x00023349;
xQueuePeekFromISR = 0x00023471;
xQueueReceive = 0x000234dd;
xQueueReceiveFromISR = 0x00023609;
xQueueRemoveFromSet = 0x0002369d;
xQueueSelectFromSet = 0x000236bf;
xQueueSelectFromSetFromISR = 0x000236d1;
xQueueSemaphoreTake = 0x000236e5;
xQueueTakeMutexRecursive = 0x00023851;
xTaskCheckForTimeOut = 0x00023895;
xTaskCreate = 0x00023905;
xTaskCreateStatic = 0x00023961;
xTaskGetCurrentTaskHandle = 0x000239d1;
xTaskGetSchedulerState = 0x000239dd;
xTaskGetTickCount = 0x000239f9;
xTaskGetTickCountFromISR = 0x00023a05;
xTaskIncrementTick = 0x00023a15;
xTaskPriorityDisinherit = 0x00023ae1;
xTaskPriorityInherit = 0x00023b75;
xTaskRemoveFromEventList = 0x00023c09;
xTaskResumeAll = 0x00023c89;
xTaskResumeFromISR = 0x00023d51;
xTimerCreate = 0x00023ddd;
xTimerCreateStatic = 0x00023e11;
xTimerCreateTimerTask = 0x00023e49;
xTimerGenericCommand = 0x00023eb5;
xTimerGetExpiryTime = 0x00023f25;
