...
sysSetPublicDeviceAddr = 0x00021c6d;
uuid128_to_str = 0x000223d5;
uuid_add_bluetooth_prefix = 0x0002242d;
uuid_has_bluetooth_prefix = 0x0002244d;
uxQueueMessagesWaiting = 0x00022491;
uxQueueMessagesWaitingFromISR = 0x000224b9;
uxQueueSpacesAvailable = 0x000224d5;
uxTaskGetStackHighWaterMark = 0x00022501;
vPortEnterCritical = 0x00022625;
vPortExitCritical = 0x00022665;
vPortFree = 0x00022691;
vPortSuppressTicksAndSleep = 0x00022725;
vPortValidateInterruptPriority = 0x000227fd;
vQueueDelete = 0x00022851;
vQueueWaitForMessageRestricted = 0x0002287d;
vTaskDelay = 0x000228c5;
vTaskInternalSetTimeOutState = 0x00022911;
vTaskMissedYield = 0x00022921;
vTaskPlaceOnEventList = 0x0002292d;
vTaskPlaceOnEventListRestricted = 0x00022965;
vTaskPriorityDisinheritAfterTimeout = 0x000229a5;
vTaskResume = 0x00022a51;
vTaskStartScheduler = 0x00022ad5;
vTaskStepTick = 0x00022b65;
vTaskSuspend = 0x00022b95;
vTaskSuspendAll = 0x00022c51;
vTaskSwitchContext = 0x00022c61;
xPortStartScheduler = 0x00022d09;
xQueueAddToSet = 0x00022dc5;
xQueueCreateCountingSemaphore = 0x00022de9;
xQueueCreateCountingSemaphoreStatic = 0x00022e25;
xQueueCreateMutex = 0x00022e69;
xQueueCreateMutexStatic = 0x00022e7f;
xQueueCreateSet = 0x00022e99;
xQueueGenericCreate = 0x00022ea1;
xQueueGenericCreateStatic = 0x00022eed;
xQueueGenericReset = 0x00022f55;
xQueueGenericSend = 0x00022fe1;
xQueueGenericSendFromISR = 0x0002314d;
xQueueGiveFromISR = 0x0002320d;
xQueueGiveMutexRecursive = 0x000232b1;
xQueueIsQueueEmptyFromISR = 0x000232f1;
xQueueIsQueueFullFromISR = 0x00023315;
xQueuePeek = 0x0002333d;
xQueuePeekFromISR = 0x00023465;
xQueueReceive = 0x000234d1;
xQueueReceiveFromISR = 0x000235fd;
xQueueRemoveFromSet = 0x00023691;
xQueueSelectFromSet = 0x000236b3;
xQueueSelectFromSetFromISR = 0x000236c5;
xQueueSemaphoreTake = 0x000236d9;
xQueueTakeMutexRecursive = 0x00023845;
xTaskCheckForTimeOut = 0x00023889;
xTaskCreate = 0x000238f9;
xTaskCreateStatic = 0x00023955;
xTaskGetCurrentTaskHandle = 0x000239c5;
xTaskGetSchedulerState = 0x000239d1;
xTaskGetTickCount = 0x000239ed;
xTaskGetTickCountFromISR = 0x000239f9;
xTaskIncrementTick = 0x00023a09;
xTaskPriorityDisinherit = 0x00023ad5;
xTaskPriorityInherit = 0x00023b69;
xTaskRemoveFromEventList = 0x00023bfd;
xTaskResumeAll = 0x00023c7d;
xTaskResumeFromISR = 0x00023d45;
xTimerCreate = 0x00023dd1;
xTimerCreateStatic = 0x00023e05;
xTimerCreateTimerTask = 0x00023e3d;
xTimerGenericCommand = 0x00023ea9;
xTimerGetExpiryTime = 0x00023f19;
