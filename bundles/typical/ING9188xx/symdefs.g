...
platform_get_heap_status = 0x0001e409;
...
platform_shutdown = 0x0001e549;
platform_switch_app = 0x0001e54d;
platform_trace_raw = 0x0001e579;
platform_write_persistent_reg = 0x0001e58d;
printf_hexdump = 0x0001e59d;
pvPortMalloc = 0x0001f0a1;
pvTaskIncrementMutexHeldCount = 0x0001f189;
pvTimerGetTimerID = 0x0001f1a1;
pxPortInitialiseStack = 0x0001f1cd;
reverse_128 = 0x0001f3ad;
reverse_24 = 0x0001f3b3;
reverse_48 = 0x0001f3b9;
reverse_56 = 0x0001f3bf;
reverse_64 = 0x0001f3c5;
reverse_bd_addr = 0x0001f3cb;
reverse_bytes = 0x0001f3d1;
sm_add_event_handler = 0x0001f691;
sm_address_resolution_lookup = 0x0001f7bd;
sm_authenticated = 0x0001fb09;
sm_authorization_decline = 0x0001fb17;
sm_authorization_grant = 0x0001fb37;
sm_authorization_state = 0x0001fb57;
sm_bonding_decline = 0x0001fb71;
sm_config = 0x0001ff3d;
sm_config_conn = 0x0001ff55;
sm_encryption_key_size = 0x000200b3;
sm_just_works_confirm = 0x000204d9;
sm_le_device_key = 0x00020705;
sm_passkey_input = 0x0002079b;
sm_private_random_address_generation_get = 0x00020ae1;
sm_private_random_address_generation_get_mode = 0x00020ae9;
sm_private_random_address_generation_set_mode = 0x00020af5;
sm_private_random_address_generation_set_update_period = 0x00020b1d;
sm_register_oob_data_callback = 0x00020c59;
sm_request_pairing = 0x00020c65;
...
sscanf_bd_addr = 0x000218b5;
sysSetPublicDeviceAddr = 0x00021bf9;
uuid128_to_str = 0x00022361;
uuid_add_bluetooth_prefix = 0x000223b9;
uuid_has_bluetooth_prefix = 0x000223d9;
uxQueueMessagesWaiting = 0x0002241d;
uxQueueMessagesWaitingFromISR = 0x00022445;
uxQueueSpacesAvailable = 0x00022461;
uxTaskGetStackHighWaterMark = 0x0002248d;
vPortEnterCritical = 0x000225b1;
vPortExitCritical = 0x000225f1;
vPortFree = 0x0002261d;
vPortSuppressTicksAndSleep = 0x000226b1;
vPortValidateInterruptPriority = 0x00022789;
vQueueDelete = 0x000227dd;
vQueueWaitForMessageRestricted = 0x00022809;
vTaskDelay = 0x00022851;
vTaskInternalSetTimeOutState = 0x0002289d;
vTaskMissedYield = 0x000228ad;
vTaskPlaceOnEventList = 0x000228b9;
vTaskPlaceOnEventListRestricted = 0x000228f1;
vTaskPriorityDisinheritAfterTimeout = 0x00022931;
vTaskResume = 0x000229dd;
vTaskStartScheduler = 0x00022a61;
vTaskStepTick = 0x00022af1;
vTaskSuspend = 0x00022b21;
vTaskSuspendAll = 0x00022bdd;
vTaskSwitchContext = 0x00022bed;
xPortStartScheduler = 0x00022c95;
xQueueAddToSet = 0x00022d51;
xQueueCreateCountingSemaphore = 0x00022d75;
xQueueCreateCountingSemaphoreStatic = 0x00022db1;
xQueueCreateMutex = 0x00022df5;
xQueueCreateMutexStatic = 0x00022e0b;
xQueueCreateSet = 0x00022e25;
xQueueGenericCreate = 0x00022e2d;
xQueueGenericCreateStatic = 0x00022e79;
xQueueGenericReset = 0x00022ee1;
xQueueGenericSend = 0x00022f6d;
xQueueGenericSendFromISR = 0x000230d9;
xQueueGiveFromISR = 0x00023199;
xQueueGiveMutexRecursive = 0x0002323d;
xQueueIsQueueEmptyFromISR = 0x0002327d;
xQueueIsQueueFullFromISR = 0x000232a1;
xQueuePeek = 0x000232c9;
xQueuePeekFromISR = 0x000233f1;
xQueueReceive = 0x0002345d;
xQueueReceiveFromISR = 0x00023589;
xQueueRemoveFromSet = 0x0002361d;
xQueueSelectFromSet = 0x0002363f;
xQueueSelectFromSetFromISR = 0x00023651;
xQueueSemaphoreTake = 0x00023665;
xQueueTakeMutexRecursive = 0x000237d1;
xTaskCheckForTimeOut = 0x00023815;
xTaskCreate = 0x00023885;
xTaskCreateStatic = 0x000238e1;
xTaskGetCurrentTaskHandle = 0x00023951;
xTaskGetSchedulerState = 0x0002395d;
xTaskGetTickCount = 0x00023979;
xTaskGetTickCountFromISR = 0x00023985;
xTaskIncrementTick = 0x00023995;
xTaskPriorityDisinherit = 0x00023a61;
xTaskPriorityInherit = 0x00023af5;
xTaskRemoveFromEventList = 0x00023b89;
xTaskResumeAll = 0x00023c09;
xTaskResumeFromISR = 0x00023cd1;
xTimerCreate = 0x00023d5d;
xTimerCreateStatic = 0x00023d91;
xTimerCreateTimerTask = 0x00023dc9;
xTimerGenericCommand = 0x00023e35;
xTimerGetExpiryTime = 0x00023ea5;
