...
nibble_for_char = 0x0001e295;
platform_32k_rc_auto_tune = 0x0001e331;
platform_32k_rc_tune = 0x0001e3ad;
platform_calibrate_32k = 0x0001e3c1;
platform_config = 0x0001e3c5;
platform_get_heap_status = 0x0001e47d;
platform_get_us_time = 0x0001e495;
platform_get_version = 0x0001e499;
platform_hrng = 0x0001e4a1;
platform_install_isr_stack = 0x0001e4a9;
platform_patch_rf_init_data = 0x0001e4b5;
platform_printf = 0x0001e4c1;
platform_raise_assertion = 0x0001e4d5;
platform_rand = 0x0001e4e9;
platform_read_info = 0x0001e4ed;
platform_read_persistent_reg = 0x0001e509;
platform_reset = 0x0001e519;
platform_set_evt_callback = 0x0001e54d;
platform_set_irq_callback = 0x0001e561;
platform_set_rf_clk_source = 0x0001e599;
platform_set_rf_init_data = 0x0001e5a5;
platform_set_rf_power_mapping = 0x0001e5b1;
platform_shutdown = 0x0001e5bd;
platform_switch_app = 0x0001e5c1;
platform_trace_raw = 0x0001e5ed;
platform_write_persistent_reg = 0x0001e601;
printf_hexdump = 0x0001e611;
...
sm_add_event_handler = 0x0001f705;
sm_address_resolution_lookup = 0x0001f831;
sm_authenticated = 0x0001fb7d;
sm_authorization_decline = 0x0001fb8b;
sm_authorization_grant = 0x0001fbab;
sm_authorization_state = 0x0001fbcb;
sm_bonding_decline = 0x0001fbe5;
sm_config = 0x0001ffb1;
sm_config_conn = 0x0001ffc9;
sm_encryption_key_size = 0x00020127;
sm_just_works_confirm = 0x0002054d;
sm_le_device_key = 0x00020779;
sm_passkey_input = 0x0002080f;
sm_private_random_address_generation_get = 0x00020b55;
sm_private_random_address_generation_get_mode = 0x00020b5d;
sm_private_random_address_generation_set_mode = 0x00020b69;
sm_private_random_address_generation_set_update_period = 0x00020b91;
sm_register_oob_data_callback = 0x00020ccd;
sm_request_pairing = 0x00020cd9;
sm_send_security_request = 0x00021617;
sm_set_accepted_stk_generation_methods = 0x0002163d;
sm_set_authentication_requirements = 0x00021649;
sm_set_encryption_key_size_range = 0x00021655;
sscanf_bd_addr = 0x00021929;
sysSetPublicDeviceAddr = 0x00021c61;
uuid128_to_str = 0x000223c9;
uuid_add_bluetooth_prefix = 0x00022421;
uuid_has_bluetooth_prefix = 0x00022441;
uxQueueMessagesWaiting = 0x00022485;
uxQueueMessagesWaitingFromISR = 0x000224ad;
uxQueueSpacesAvailable = 0x000224c9;
uxTaskGetStackHighWaterMark = 0x000224f5;
vPortEnterCritical = 0x00022619;
vPortExitCritical = 0x00022659;
vPortFree = 0x00022685;
vPortSuppressTicksAndSleep = 0x00022719;
vPortValidateInterruptPriority = 0x000227f1;
vQueueDelete = 0x00022845;
vQueueWaitForMessageRestricted = 0x00022871;
vTaskDelay = 0x000228b9;
vTaskInternalSetTimeOutState = 0x00022905;
vTaskMissedYield = 0x00022915;
vTaskPlaceOnEventList = 0x00022921;
vTaskPlaceOnEventListRestricted = 0x00022959;
vTaskPriorityDisinheritAfterTimeout = 0x00022999;
vTaskResume = 0x00022a45;
vTaskStartScheduler = 0x00022ac9;
vTaskStepTick = 0x00022b59;
vTaskSuspend = 0x00022b89;
vTaskSuspendAll = 0x00022c45;
vTaskSwitchContext = 0x00022c55;
xPortStartScheduler = 0x00022cfd;
xQueueAddToSet = 0x00022db9;
xQueueCreateCountingSemaphore = 0x00022ddd;
xQueueCreateCountingSemaphoreStatic = 0x00022e19;
xQueueCreateMutex = 0x00022e5d;
xQueueCreateMutexStatic = 0x00022e73;
xQueueCreateSet = 0x00022e8d;
xQueueGenericCreate = 0x00022e95;
xQueueGenericCreateStatic = 0x00022ee1;
xQueueGenericReset = 0x00022f49;
xQueueGenericSend = 0x00022fd5;
xQueueGenericSendFromISR = 0x00023141;
xQueueGiveFromISR = 0x00023201;
xQueueGiveMutexRecursive = 0x000232a5;
xQueueIsQueueEmptyFromISR = 0x000232e5;
xQueueIsQueueFullFromISR = 0x00023309;
xQueuePeek = 0x00023331;
xQueuePeekFromISR = 0x00023459;
xQueueReceive = 0x000234c5;
xQueueReceiveFromISR = 0x000235f1;
xQueueRemoveFromSet = 0x00023685;
xQueueSelectFromSet = 0x000236a7;
xQueueSelectFromSetFromISR = 0x000236b9;
xQueueSemaphoreTake = 0x000236cd;
xQueueTakeMutexRecursive = 0x00023839;
xTaskCheckForTimeOut = 0x0002387d;
xTaskCreate = 0x000238ed;
xTaskCreateStatic = 0x00023949;
xTaskGetCurrentTaskHandle = 0x000239b9;
xTaskGetSchedulerState = 0x000239c5;
xTaskGetTickCount = 0x000239e1;
xTaskGetTickCountFromISR = 0x000239ed;
xTaskIncrementTick = 0x000239fd;
xTaskPriorityDisinherit = 0x00023ac9;
xTaskPriorityInherit = 0x00023b5d;
xTaskRemoveFromEventList = 0x00023bf1;
xTaskResumeAll = 0x00023c71;
xTaskResumeFromISR = 0x00023d39;
xTimerCreate = 0x00023dc5;
xTimerCreateStatic = 0x00023df9;
xTimerCreateTimerTask = 0x00023e31;
xTimerGenericCommand = 0x00023e9d;
xTimerGetExpiryTime = 0x00023f0d;
