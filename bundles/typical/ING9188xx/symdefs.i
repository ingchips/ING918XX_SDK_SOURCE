...
--define_symbol nibble_for_char=0x0001de15
--define_symbol platform_32k_rc_auto_tune=0x0001decd
--define_symbol platform_32k_rc_tune=0x0001df49
--define_symbol platform_calibrate_32k=0x0001df5d
--define_symbol platform_config=0x0001df61
--define_symbol platform_get_heap_status=0x0001e011
--define_symbol platform_get_us_time=0x0001e029
--define_symbol platform_get_version=0x0001e02d
--define_symbol platform_hrng=0x0001e035
--define_symbol platform_install_isr_stack=0x0001e03d
--define_symbol platform_patch_rf_init_data=0x0001e049
--define_symbol platform_printf=0x0001e055
--define_symbol platform_raise_assertion=0x0001e069
--define_symbol platform_rand=0x0001e07d
--define_symbol platform_read_info=0x0001e081
--define_symbol platform_read_persistent_reg=0x0001e09d
--define_symbol platform_reset=0x0001e0ad
--define_symbol platform_set_evt_callback=0x0001e0e1
--define_symbol platform_set_irq_callback=0x0001e0f5
--define_symbol platform_set_rf_clk_source=0x0001e12d
--define_symbol platform_set_rf_init_data=0x0001e139
--define_symbol platform_set_rf_power_mapping=0x0001e145
--define_symbol platform_shutdown=0x0001e151
--define_symbol platform_switch_app=0x0001e155
--define_symbol platform_trace_raw=0x0001e181
--define_symbol platform_write_persistent_reg=0x0001e195
--define_symbol printf_hexdump=0x0001e1a5
--define_symbol pvPortMalloc=0x0001ecd5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001edbd
--define_symbol pvTimerGetTimerID=0x0001edd5
--define_symbol pxPortInitialiseStack=0x0001ee01
--define_symbol reverse_128=0x0001efe1
--define_symbol reverse_24=0x0001efe7
--define_symbol reverse_48=0x0001efed
--define_symbol reverse_56=0x0001eff3
--define_symbol reverse_64=0x0001eff9
--define_symbol reverse_bd_addr=0x0001efff
--define_symbol reverse_bytes=0x0001f005
--define_symbol sm_add_event_handler=0x0001f2a5
--define_symbol sm_address_resolution_lookup=0x0001f3d1
--define_symbol sm_authenticated=0x0001f4ab
--define_symbol sm_authorization_decline=0x0001f4b9
--define_symbol sm_authorization_grant=0x0001f4d9
--define_symbol sm_authorization_state=0x0001f4f9
--define_symbol sm_bonding_decline=0x0001f515
--define_symbol sm_config=0x0001f8ed
--define_symbol sm_encryption_key_size=0x0001f9f9
--define_symbol sm_just_works_confirm=0x000201c9
--define_symbol sm_le_device_key=0x00020419
--define_symbol sm_passkey_input=0x000204b1
--define_symbol sm_private_random_address_generation_get=0x0002083d
--define_symbol sm_private_random_address_generation_get_mode=0x00020845
--define_symbol sm_private_random_address_generation_set_mode=0x00020851
--define_symbol sm_private_random_address_generation_set_update_period=0x00020879
--define_symbol sm_register_oob_data_callback=0x000208b1
--define_symbol sm_request_pairing=0x000208bd
...
--define_symbol sscanf_bd_addr=0x00021631
--define_symbol sysSetPublicDeviceAddr=0x0002194d
--define_symbol uuid128_to_str=0x00022081
--define_symbol uuid_add_bluetooth_prefix=0x000220d9
--define_symbol uuid_has_bluetooth_prefix=0x000220f9
--define_symbol uxQueueMessagesWaiting=0x0002213d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022165
--define_symbol uxQueueSpacesAvailable=0x00022181
--define_symbol uxTaskGetStackHighWaterMark=0x000221ad
--define_symbol vPortEnterCritical=0x00022265
--define_symbol vPortExitCritical=0x000222a5
--define_symbol vPortFree=0x000222d1
--define_symbol vPortSuppressTicksAndSleep=0x00022365
--define_symbol vPortValidateInterruptPriority=0x0002243d
--define_symbol vQueueDelete=0x00022491
--define_symbol vQueueWaitForMessageRestricted=0x000224bd
--define_symbol vTaskDelay=0x00022505
--define_symbol vTaskInternalSetTimeOutState=0x00022551
--define_symbol vTaskMissedYield=0x00022561
--define_symbol vTaskPlaceOnEventList=0x0002256d
--define_symbol vTaskPlaceOnEventListRestricted=0x000225a5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000225e5
--define_symbol vTaskStartScheduler=0x00022691
--define_symbol vTaskStepTick=0x00022721
--define_symbol vTaskSuspendAll=0x00022751
--define_symbol vTaskSwitchContext=0x00022761
--define_symbol xPortStartScheduler=0x00022809
--define_symbol xQueueAddToSet=0x000228c5
--define_symbol xQueueCreateCountingSemaphore=0x000228e9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022925
--define_symbol xQueueCreateMutex=0x00022969
--define_symbol xQueueCreateMutexStatic=0x0002297f
--define_symbol xQueueCreateSet=0x00022999
--define_symbol xQueueGenericCreate=0x000229a1
--define_symbol xQueueGenericCreateStatic=0x000229ed
--define_symbol xQueueGenericReset=0x00022a55
--define_symbol xQueueGenericSend=0x00022ae1
--define_symbol xQueueGenericSendFromISR=0x00022c4d
--define_symbol xQueueGiveFromISR=0x00022d0d
--define_symbol xQueueGiveMutexRecursive=0x00022db1
--define_symbol xQueueIsQueueEmptyFromISR=0x00022df1
--define_symbol xQueueIsQueueFullFromISR=0x00022e15
--define_symbol xQueuePeek=0x00022e3d
--define_symbol xQueuePeekFromISR=0x00022f65
--define_symbol xQueueReceive=0x00022fd1
--define_symbol xQueueReceiveFromISR=0x000230fd
--define_symbol xQueueRemoveFromSet=0x00023191
--define_symbol xQueueSelectFromSet=0x000231b3
--define_symbol xQueueSelectFromSetFromISR=0x000231c5
--define_symbol xQueueSemaphoreTake=0x000231d9
--define_symbol xQueueTakeMutexRecursive=0x00023345
--define_symbol xTaskCheckForTimeOut=0x00023389
--define_symbol xTaskCreate=0x000233f9
--define_symbol xTaskCreateStatic=0x00023455
--define_symbol xTaskGetCurrentTaskHandle=0x000234c5
--define_symbol xTaskGetSchedulerState=0x000234d1
--define_symbol xTaskGetTickCount=0x000234ed
--define_symbol xTaskGetTickCountFromISR=0x000234f9
--define_symbol xTaskIncrementTick=0x00023509
--define_symbol xTaskPriorityDisinherit=0x000235d5
--define_symbol xTaskPriorityInherit=0x00023669
--define_symbol xTaskRemoveFromEventList=0x000236fd
--define_symbol xTaskResumeAll=0x0002377d
--define_symbol xTimerCreate=0x00023845
--define_symbol xTimerCreateStatic=0x00023879
--define_symbol xTimerCreateTimerTask=0x000238b1
--define_symbol xTimerGenericCommand=0x0002391d
--define_symbol xTimerGetExpiryTime=0x0002398d
