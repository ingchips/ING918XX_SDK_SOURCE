...
--define_symbol sm_le_device_key=0x000209e5
--define_symbol sm_passkey_input=0x00020a7b
--define_symbol sm_private_random_address_generation_get=0x00020e29
--define_symbol sm_private_random_address_generation_get_mode=0x00020e31
--define_symbol sm_private_random_address_generation_set_mode=0x00020e3d
--define_symbol sm_private_random_address_generation_set_update_period=0x00020e65
--define_symbol sm_register_oob_data_callback=0x00020fa1
--define_symbol sm_request_pairing=0x00020fad
--define_symbol sm_send_security_request=0x000219cb
--define_symbol sm_set_accepted_stk_generation_methods=0x000219f1
--define_symbol sm_set_authentication_requirements=0x000219fd
--define_symbol sm_set_encryption_key_size_range=0x00021a09
--define_symbol sscanf_bd_addr=0x00021d65
--define_symbol sysSetPublicDeviceAddr=0x000220cd
--define_symbol uuid128_to_str=0x00022845
--define_symbol uuid_add_bluetooth_prefix=0x0002289d
--define_symbol uuid_has_bluetooth_prefix=0x000228bd
--define_symbol uxListRemove=0x000228d9
--define_symbol uxQueueMessagesWaiting=0x00022901
--define_symbol uxQueueMessagesWaitingFromISR=0x00022929
--define_symbol uxQueueSpacesAvailable=0x00022945
--define_symbol uxTaskGetStackHighWaterMark=0x00022971
--define_symbol uxTaskPriorityGet=0x00022991
--define_symbol uxTaskPriorityGetFromISR=0x000229ad
--define_symbol vListInitialise=0x00022a5f
--define_symbol vListInitialiseItem=0x00022a75
--define_symbol vListInsert=0x00022a7b
--define_symbol vListInsertEnd=0x00022aab
--define_symbol vPortEndScheduler=0x00022ac5
--define_symbol vPortEnterCritical=0x00022aed
--define_symbol vPortExitCritical=0x00022b31
--define_symbol vPortFree=0x00022b61
--define_symbol vPortSuppressTicksAndSleep=0x00022bf5
...
--define_symbol vTaskPrioritySet=0x00022f55
...
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00024509
