...
--define_symbol platform_32k_rc_tune=0x0001dcbd
--define_symbol platform_calibrate_32k=0x0001dcd1
--define_symbol platform_config=0x0001dcd5
--define_symbol platform_get_heap_status=0x0001dd85
--define_symbol platform_get_us_time=0x0001dd9d
--define_symbol platform_get_version=0x0001dda1
--define_symbol platform_hrng=0x0001dda9
--define_symbol platform_patch_rf_init_data=0x0001ddb1
--define_symbol platform_printf=0x0001ddbd
--define_symbol platform_raise_assertion=0x0001ddd1
--define_symbol platform_rand=0x0001dde5
--define_symbol platform_read_info=0x0001dde9
--define_symbol platform_read_persistent_reg=0x0001de05
--define_symbol platform_reset=0x0001de15
--define_symbol platform_set_evt_callback=0x0001de49
--define_symbol platform_set_irq_callback=0x0001de5d
--define_symbol platform_set_rf_clk_source=0x0001de95
--define_symbol platform_set_rf_init_data=0x0001dea1
--define_symbol platform_set_rf_power_mapping=0x0001dead
--define_symbol platform_shutdown=0x0001deb9
--define_symbol platform_switch_app=0x0001debd
--define_symbol platform_trace_raw=0x0001dee9
--define_symbol platform_write_persistent_reg=0x0001defd
--define_symbol printf_hexdump=0x0001df0d
--define_symbol pvPortMalloc=0x0001ea09
--define_symbol pvTaskIncrementMutexHeldCount=0x0001eaf1
--define_symbol pvTimerGetTimerID=0x0001eb09
--define_symbol pxPortInitialiseStack=0x0001eb35
--define_symbol reverse_128=0x0001ed15
--define_symbol reverse_24=0x0001ed1b
--define_symbol reverse_48=0x0001ed21
--define_symbol reverse_56=0x0001ed27
--define_symbol reverse_64=0x0001ed2d
--define_symbol reverse_bd_addr=0x0001ed33
--define_symbol reverse_bytes=0x0001ed39
--define_symbol sm_add_event_handler=0x0001efd9
--define_symbol sm_address_resolution_lookup=0x0001f105
--define_symbol sm_authenticated=0x0001f1df
--define_symbol sm_authorization_decline=0x0001f1ed
--define_symbol sm_authorization_grant=0x0001f20d
--define_symbol sm_authorization_state=0x0001f22d
--define_symbol sm_bonding_decline=0x0001f249
--define_symbol sm_config=0x0001f621
--define_symbol sm_encryption_key_size=0x0001f72d
--define_symbol sm_just_works_confirm=0x0001fefd
--define_symbol sm_le_device_key=0x0002014d
--define_symbol sm_passkey_input=0x000201e5
--define_symbol sm_private_random_address_generation_get=0x00020571
--define_symbol sm_private_random_address_generation_get_mode=0x00020579
--define_symbol sm_private_random_address_generation_set_mode=0x00020585
--define_symbol sm_private_random_address_generation_set_update_period=0x000205ad
--define_symbol sm_register_oob_data_callback=0x000205e5
--define_symbol sm_request_pairing=0x000205f1
--define_symbol sm_send_security_request=0x0002102b
--define_symbol sm_set_accepted_stk_generation_methods=0x00021051
--define_symbol sm_set_authentication_requirements=0x0002105d
--define_symbol sm_set_encryption_key_size_range=0x00021069
--define_symbol sscanf_bd_addr=0x00021365
--define_symbol sysSetPublicDeviceAddr=0x0002167d
--define_symbol uuid128_to_str=0x00021d95
--define_symbol uuid_add_bluetooth_prefix=0x00021ded
--define_symbol uuid_has_bluetooth_prefix=0x00021e0d
--define_symbol uxQueueMessagesWaiting=0x00021e51
--define_symbol uxQueueMessagesWaitingFromISR=0x00021e79
--define_symbol uxQueueSpacesAvailable=0x00021e95
--define_symbol vPortEnterCritical=0x00021f59
--define_symbol vPortExitCritical=0x00021f99
--define_symbol vPortFree=0x00021fc5
--define_symbol vPortSuppressTicksAndSleep=0x00022059
--define_symbol vPortValidateInterruptPriority=0x00022131
--define_symbol vQueueDelete=0x00022185
--define_symbol vQueueWaitForMessageRestricted=0x000221b1
--define_symbol vTaskDelay=0x000221f9
--define_symbol vTaskInternalSetTimeOutState=0x00022245
--define_symbol vTaskMissedYield=0x00022255
--define_symbol vTaskPlaceOnEventList=0x00022261
--define_symbol vTaskPlaceOnEventListRestricted=0x00022299
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000222d9
--define_symbol vTaskStartScheduler=0x00022385
--define_symbol vTaskStepTick=0x00022415
--define_symbol vTaskSuspendAll=0x00022445
--define_symbol vTaskSwitchContext=0x00022455
--define_symbol xPortStartScheduler=0x000224fd
--define_symbol xQueueAddToSet=0x000225b9
--define_symbol xQueueCreateCountingSemaphore=0x000225dd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022619
--define_symbol xQueueCreateMutex=0x0002265d
--define_symbol xQueueCreateMutexStatic=0x00022673
--define_symbol xQueueCreateSet=0x0002268d
--define_symbol xQueueGenericCreate=0x00022695
--define_symbol xQueueGenericCreateStatic=0x000226e1
--define_symbol xQueueGenericReset=0x00022749
--define_symbol xQueueGenericSend=0x000227d5
--define_symbol xQueueGenericSendFromISR=0x00022941
--define_symbol xQueueGiveFromISR=0x00022a01
--define_symbol xQueueGiveMutexRecursive=0x00022aa5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022ae5
--define_symbol xQueueIsQueueFullFromISR=0x00022b09
--define_symbol xQueuePeek=0x00022b31
--define_symbol xQueuePeekFromISR=0x00022c59
--define_symbol xQueueReceive=0x00022cc5
--define_symbol xQueueReceiveFromISR=0x00022df1
--define_symbol xQueueRemoveFromSet=0x00022e85
--define_symbol xQueueSelectFromSet=0x00022ea7
--define_symbol xQueueSelectFromSetFromISR=0x00022eb9
--define_symbol xQueueSemaphoreTake=0x00022ecd
--define_symbol xQueueTakeMutexRecursive=0x00023039
--define_symbol xTaskCheckForTimeOut=0x0002307d
--define_symbol xTaskCreate=0x000230ed
--define_symbol xTaskCreateStatic=0x00023149
--define_symbol xTaskGetCurrentTaskHandle=0x000231b9
--define_symbol xTaskGetSchedulerState=0x000231c5
--define_symbol xTaskGetTickCount=0x000231e1
--define_symbol xTaskGetTickCountFromISR=0x000231ed
--define_symbol xTaskIncrementTick=0x000231fd
--define_symbol xTaskPriorityDisinherit=0x000232c9
--define_symbol xTaskPriorityInherit=0x0002335d
--define_symbol xTaskRemoveFromEventList=0x000233f1
--define_symbol xTaskResumeAll=0x00023471
--define_symbol xTimerCreate=0x00023539
--define_symbol xTimerCreateStatic=0x0002356d
--define_symbol xTimerCreateTimerTask=0x000235a5
--define_symbol xTimerGenericCommand=0x00023611
--define_symbol xTimerGetExpiryTime=0x00023681
