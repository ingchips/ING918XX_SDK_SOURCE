...
--define_symbol nibble_for_char=0x0001e095
--define_symbol platform_32k_rc_auto_tune=0x0001e131
--define_symbol platform_32k_rc_tune=0x0001e1ad
--define_symbol platform_calibrate_32k=0x0001e1c1
--define_symbol platform_config=0x0001e1c5
--define_symbol platform_get_heap_status=0x0001e27d
--define_symbol platform_get_us_time=0x0001e295
--define_symbol platform_get_version=0x0001e299
--define_symbol platform_hrng=0x0001e2a1
--define_symbol platform_install_isr_stack=0x0001e2a9
--define_symbol platform_patch_rf_init_data=0x0001e2b5
--define_symbol platform_printf=0x0001e2c1
--define_symbol platform_raise_assertion=0x0001e2d5
--define_symbol platform_rand=0x0001e2e9
--define_symbol platform_read_info=0x0001e2ed
--define_symbol platform_read_persistent_reg=0x0001e309
--define_symbol platform_reset=0x0001e319
--define_symbol platform_set_evt_callback=0x0001e34d
--define_symbol platform_set_irq_callback=0x0001e361
--define_symbol platform_set_rf_clk_source=0x0001e399
--define_symbol platform_set_rf_init_data=0x0001e3a5
--define_symbol platform_set_rf_power_mapping=0x0001e3b1
--define_symbol platform_shutdown=0x0001e3bd
--define_symbol platform_switch_app=0x0001e3c1
--define_symbol platform_trace_raw=0x0001e3ed
--define_symbol platform_write_persistent_reg=0x0001e401
--define_symbol printf_hexdump=0x0001e411
--define_symbol pvPortMalloc=0x0001eed9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001efc1
--define_symbol pvTimerGetTimerID=0x0001efd9
--define_symbol pxPortInitialiseStack=0x0001f005
--define_symbol reverse_128=0x0001f1e5
--define_symbol reverse_24=0x0001f1eb
--define_symbol reverse_48=0x0001f1f1
--define_symbol reverse_56=0x0001f1f7
--define_symbol reverse_64=0x0001f1fd
--define_symbol reverse_bd_addr=0x0001f203
--define_symbol reverse_bytes=0x0001f209
--define_symbol sm_add_event_handler=0x0001f4c9
--define_symbol sm_address_resolution_lookup=0x0001f5f5
--define_symbol sm_authenticated=0x0001f6cf
--define_symbol sm_authorization_decline=0x0001f6dd
--define_symbol sm_authorization_grant=0x0001f6fd
--define_symbol sm_authorization_state=0x0001f71d
--define_symbol sm_bonding_decline=0x0001f739
--define_symbol sm_config=0x0001fb11
--define_symbol sm_encryption_key_size=0x0001fc1d
--define_symbol sm_just_works_confirm=0x000203d5
--define_symbol sm_le_device_key=0x0002062d
--define_symbol sm_passkey_input=0x000206c5
--define_symbol sm_private_random_address_generation_get=0x00020a51
--define_symbol sm_private_random_address_generation_get_mode=0x00020a59
--define_symbol sm_private_random_address_generation_set_mode=0x00020a65
--define_symbol sm_private_random_address_generation_set_update_period=0x00020a8d
--define_symbol sm_register_oob_data_callback=0x00020ac5
--define_symbol sm_request_pairing=0x00020ad1
--define_symbol sm_send_security_request=0x00021521
...
--define_symbol uuid128_to_str=0x000222ed
--define_symbol uuid_add_bluetooth_prefix=0x00022345
--define_symbol uuid_has_bluetooth_prefix=0x00022365
--define_symbol uxQueueMessagesWaiting=0x000223a9
--define_symbol uxQueueMessagesWaitingFromISR=0x000223d1
--define_symbol uxQueueSpacesAvailable=0x000223ed
--define_symbol uxTaskGetStackHighWaterMark=0x00022419
--define_symbol vPortEnterCritical=0x000224d1
--define_symbol vPortExitCritical=0x00022511
--define_symbol vPortFree=0x0002253d
--define_symbol vPortSuppressTicksAndSleep=0x000225d1
--define_symbol vPortValidateInterruptPriority=0x000226a9
--define_symbol vQueueDelete=0x000226fd
--define_symbol vQueueWaitForMessageRestricted=0x00022729
--define_symbol vTaskDelay=0x00022771
--define_symbol vTaskInternalSetTimeOutState=0x000227bd
--define_symbol vTaskMissedYield=0x000227cd
--define_symbol vTaskPlaceOnEventList=0x000227d9
--define_symbol vTaskPlaceOnEventListRestricted=0x00022811
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022851
--define_symbol vTaskStartScheduler=0x000228fd
--define_symbol vTaskStepTick=0x0002298d
--define_symbol vTaskSuspendAll=0x000229bd
--define_symbol vTaskSwitchContext=0x000229cd
--define_symbol xPortStartScheduler=0x00022a75
--define_symbol xQueueAddToSet=0x00022b31
--define_symbol xQueueCreateCountingSemaphore=0x00022b55
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022b91
--define_symbol xQueueCreateMutex=0x00022bd5
--define_symbol xQueueCreateMutexStatic=0x00022beb
--define_symbol xQueueCreateSet=0x00022c05
--define_symbol xQueueGenericCreate=0x00022c0d
--define_symbol xQueueGenericCreateStatic=0x00022c59
--define_symbol xQueueGenericReset=0x00022cc1
--define_symbol xQueueGenericSend=0x00022d4d
--define_symbol xQueueGenericSendFromISR=0x00022eb9
--define_symbol xQueueGiveFromISR=0x00022f79
--define_symbol xQueueGiveMutexRecursive=0x0002301d
--define_symbol xQueueIsQueueEmptyFromISR=0x0002305d
--define_symbol xQueueIsQueueFullFromISR=0x00023081
--define_symbol xQueuePeek=0x000230a9
--define_symbol xQueuePeekFromISR=0x000231d1
--define_symbol xQueueReceive=0x0002323d
--define_symbol xQueueReceiveFromISR=0x00023369
--define_symbol xQueueRemoveFromSet=0x000233fd
--define_symbol xQueueSelectFromSet=0x0002341f
--define_symbol xQueueSelectFromSetFromISR=0x00023431
--define_symbol xQueueSemaphoreTake=0x00023445
--define_symbol xQueueTakeMutexRecursive=0x000235b1
--define_symbol xTaskCheckForTimeOut=0x000235f5
--define_symbol xTaskCreate=0x00023665
--define_symbol xTaskCreateStatic=0x000236c1
--define_symbol xTaskGetCurrentTaskHandle=0x00023731
--define_symbol xTaskGetSchedulerState=0x0002373d
--define_symbol xTaskGetTickCount=0x00023759
--define_symbol xTaskGetTickCountFromISR=0x00023765
--define_symbol xTaskIncrementTick=0x00023775
--define_symbol xTaskPriorityDisinherit=0x00023841
--define_symbol xTaskPriorityInherit=0x000238d5
--define_symbol xTaskRemoveFromEventList=0x00023969
--define_symbol xTaskResumeAll=0x000239e9
--define_symbol xTimerCreate=0x00023ab1
--define_symbol xTimerCreateStatic=0x00023ae5
--define_symbol xTimerCreateTimerTask=0x00023b1d
--define_symbol xTimerGenericCommand=0x00023b89
--define_symbol xTimerGetExpiryTime=0x00023bf9
