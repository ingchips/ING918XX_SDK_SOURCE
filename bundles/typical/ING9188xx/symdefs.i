...
--define_symbol nibble_for_char=0x0001e1c1
--define_symbol platform_32k_rc_auto_tune=0x0001e25d
--define_symbol platform_32k_rc_tune=0x0001e2d9
--define_symbol platform_calibrate_32k=0x0001e2ed
--define_symbol platform_config=0x0001e2f1
--define_symbol platform_get_heap_status=0x0001e3c5
--define_symbol platform_get_task_handle=0x0001e3dd
--define_symbol platform_get_us_time=0x0001e3fd
--define_symbol platform_get_version=0x0001e401
--define_symbol platform_hrng=0x0001e409
--define_symbol platform_install_isr_stack=0x0001e411
--define_symbol platform_patch_rf_init_data=0x0001e41d
--define_symbol platform_printf=0x0001e429
--define_symbol platform_raise_assertion=0x0001e43d
--define_symbol platform_rand=0x0001e451
--define_symbol platform_read_info=0x0001e455
--define_symbol platform_read_persistent_reg=0x0001e471
--define_symbol platform_reset=0x0001e481
--define_symbol platform_set_evt_callback=0x0001e4b5
--define_symbol platform_set_irq_callback=0x0001e4c9
--define_symbol platform_set_rf_clk_source=0x0001e501
--define_symbol platform_set_rf_init_data=0x0001e50d
--define_symbol platform_set_rf_power_mapping=0x0001e519
--define_symbol platform_set_timer=0x0001e525
--define_symbol platform_shutdown=0x0001e529
--define_symbol platform_switch_app=0x0001e52d
--define_symbol platform_trace_raw=0x0001e559
--define_symbol platform_write_persistent_reg=0x0001e571
--define_symbol printf_hexdump=0x0001e581
--define_symbol pvPortMalloc=0x0001f089
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f171
--define_symbol pvTimerGetTimerID=0x0001f189
--define_symbol pxPortInitialiseStack=0x0001f1b5
--define_symbol reverse_128=0x0001f395
--define_symbol reverse_24=0x0001f39b
--define_symbol reverse_48=0x0001f3a1
--define_symbol reverse_56=0x0001f3a7
--define_symbol reverse_64=0x0001f3ad
--define_symbol reverse_bd_addr=0x0001f3b3
--define_symbol reverse_bytes=0x0001f3b9
--define_symbol sm_add_event_handler=0x0001f679
--define_symbol sm_address_resolution_lookup=0x0001f7d1
--define_symbol sm_authenticated=0x0001fb29
--define_symbol sm_authorization_decline=0x0001fb37
--define_symbol sm_authorization_grant=0x0001fb57
--define_symbol sm_authorization_state=0x0001fb77
--define_symbol sm_bonding_decline=0x0001fb91
--define_symbol sm_config=0x0001ffb1
--define_symbol sm_config_conn=0x0001ffc9
--define_symbol sm_encryption_key_size=0x0002017f
--define_symbol sm_just_works_confirm=0x000206b9
--define_symbol sm_le_device_key=0x000209f5
--define_symbol sm_passkey_input=0x00020a8b
--define_symbol sm_private_random_address_generation_get=0x00020e39
--define_symbol sm_private_random_address_generation_get_mode=0x00020e41
--define_symbol sm_private_random_address_generation_set_mode=0x00020e4d
--define_symbol sm_private_random_address_generation_set_update_period=0x00020e75
--define_symbol sm_register_oob_data_callback=0x00020fb1
--define_symbol sm_request_pairing=0x00020fbd
--define_symbol sm_send_security_request=0x000219db
--define_symbol sm_set_accepted_stk_generation_methods=0x00021a01
--define_symbol sm_set_authentication_requirements=0x00021a0d
--define_symbol sm_set_encryption_key_size_range=0x00021a19
--define_symbol sscanf_bd_addr=0x00021d75
--define_symbol sysSetPublicDeviceAddr=0x000220dd
--define_symbol uuid128_to_str=0x00022855
--define_symbol uuid_add_bluetooth_prefix=0x000228ad
--define_symbol uuid_has_bluetooth_prefix=0x000228cd
--define_symbol uxListRemove=0x000228e9
--define_symbol uxQueueMessagesWaiting=0x00022911
--define_symbol uxQueueMessagesWaitingFromISR=0x00022939
--define_symbol uxQueueSpacesAvailable=0x00022955
--define_symbol uxTaskGetStackHighWaterMark=0x00022981
--define_symbol uxTaskPriorityGet=0x000229a1
--define_symbol uxTaskPriorityGetFromISR=0x000229bd
...
--define_symbol vPortEndScheduler=0x00022ad5
--define_symbol vPortEnterCritical=0x00022afd
--define_symbol vPortExitCritical=0x00022b41
--define_symbol vPortFree=0x00022b71
--define_symbol vPortSuppressTicksAndSleep=0x00022c05
--define_symbol vPortValidateInterruptPriority=0x00022d0d
--define_symbol vQueueDelete=0x00022d65
--define_symbol vQueueWaitForMessageRestricted=0x00022d91
--define_symbol vTaskDelay=0x00022dd9
--define_symbol vTaskInternalSetTimeOutState=0x00022e25
--define_symbol vTaskMissedYield=0x00022e35
--define_symbol vTaskPlaceOnEventList=0x00022e41
--define_symbol vTaskPlaceOnEventListRestricted=0x00022e79
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022eb9
--define_symbol vTaskPrioritySet=0x00022f65
--define_symbol vTaskResume=0x0002302d
--define_symbol vTaskStartScheduler=0x000230b1
--define_symbol vTaskStepTick=0x00023141
--define_symbol vTaskSuspend=0x00023171
--define_symbol vTaskSuspendAll=0x0002322d
--define_symbol vTaskSwitchContext=0x0002323d
--define_symbol xPortStartScheduler=0x000232e5
--define_symbol xQueueAddToSet=0x000233a5
--define_symbol xQueueCreateCountingSemaphore=0x000233c9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023405
--define_symbol xQueueCreateMutex=0x00023449
--define_symbol xQueueCreateMutexStatic=0x0002345f
--define_symbol xQueueCreateSet=0x00023479
--define_symbol xQueueGenericCreate=0x00023481
--define_symbol xQueueGenericCreateStatic=0x000234cd
--define_symbol xQueueGenericReset=0x00023535
--define_symbol xQueueGenericSend=0x000235c1
--define_symbol xQueueGenericSendFromISR=0x0002372d
--define_symbol xQueueGiveFromISR=0x000237ed
--define_symbol xQueueGiveMutexRecursive=0x00023891
--define_symbol xQueueIsQueueEmptyFromISR=0x000238d1
--define_symbol xQueueIsQueueFullFromISR=0x000238f5
--define_symbol xQueuePeek=0x0002391d
--define_symbol xQueuePeekFromISR=0x00023a45
--define_symbol xQueueReceive=0x00023ab1
--define_symbol xQueueReceiveFromISR=0x00023bdd
--define_symbol xQueueRemoveFromSet=0x00023c71
--define_symbol xQueueSelectFromSet=0x00023c93
--define_symbol xQueueSelectFromSetFromISR=0x00023ca5
--define_symbol xQueueSemaphoreTake=0x00023cb9
--define_symbol xQueueTakeMutexRecursive=0x00023e25
--define_symbol xTaskCheckForTimeOut=0x00023e69
--define_symbol xTaskCreate=0x00023ed9
--define_symbol xTaskCreateStatic=0x00023f35
--define_symbol xTaskGetCurrentTaskHandle=0x00023fa5
--define_symbol xTaskGetSchedulerState=0x00023fb1
--define_symbol xTaskGetTickCount=0x00023fcd
--define_symbol xTaskGetTickCountFromISR=0x00023fd9
--define_symbol xTaskIncrementTick=0x00023fe9
--define_symbol xTaskPriorityDisinherit=0x000240b5
--define_symbol xTaskPriorityInherit=0x00024149
--define_symbol xTaskRemoveFromEventList=0x000241dd
--define_symbol xTaskResumeAll=0x0002425d
--define_symbol xTaskResumeFromISR=0x00024325
--define_symbol xTimerCreate=0x000243b1
--define_symbol xTimerCreateStatic=0x000243e5
--define_symbol xTimerCreateTimerTask=0x0002441d
--define_symbol xTimerGenericCommand=0x00024489
--define_symbol xTimerGetExpiryTime=0x000244f9
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00024519
