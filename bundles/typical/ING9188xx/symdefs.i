...
--define_symbol sysSetPublicDeviceAddr=0x00021a85
--define_symbol uuid128_to_str=0x000221b9
--define_symbol uuid_add_bluetooth_prefix=0x00022211
--define_symbol uuid_has_bluetooth_prefix=0x00022231
--define_symbol uxQueueMessagesWaiting=0x00022275
--define_symbol uxQueueMessagesWaitingFromISR=0x0002229d
--define_symbol uxQueueSpacesAvailable=0x000222b9
--define_symbol uxTaskGetStackHighWaterMark=0x000222e5
--define_symbol vPortEnterCritical=0x0002239d
--define_symbol vPortExitCritical=0x000223dd
--define_symbol vPortFree=0x00022409
--define_symbol vPortSuppressTicksAndSleep=0x0002249d
--define_symbol vPortValidateInterruptPriority=0x00022575
--define_symbol vQueueDelete=0x000225c9
--define_symbol vQueueWaitForMessageRestricted=0x000225f5
--define_symbol vTaskDelay=0x0002263d
--define_symbol vTaskInternalSetTimeOutState=0x00022689
--define_symbol vTaskMissedYield=0x00022699
--define_symbol vTaskPlaceOnEventList=0x000226a5
--define_symbol vTaskPlaceOnEventListRestricted=0x000226dd
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002271d
--define_symbol vTaskStartScheduler=0x000227c9
--define_symbol vTaskStepTick=0x00022859
--define_symbol vTaskSuspendAll=0x00022889
--define_symbol vTaskSwitchContext=0x00022899
--define_symbol xPortStartScheduler=0x00022941
--define_symbol xQueueAddToSet=0x000229fd
--define_symbol xQueueCreateCountingSemaphore=0x00022a21
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a5d
--define_symbol xQueueCreateMutex=0x00022aa1
--define_symbol xQueueCreateMutexStatic=0x00022ab7
--define_symbol xQueueCreateSet=0x00022ad1
--define_symbol xQueueGenericCreate=0x00022ad9
--define_symbol xQueueGenericCreateStatic=0x00022b25
--define_symbol xQueueGenericReset=0x00022b8d
--define_symbol xQueueGenericSend=0x00022c19
--define_symbol xQueueGenericSendFromISR=0x00022d85
--define_symbol xQueueGiveFromISR=0x00022e45
--define_symbol xQueueGiveMutexRecursive=0x00022ee9
--define_symbol xQueueIsQueueEmptyFromISR=0x00022f29
--define_symbol xQueueIsQueueFullFromISR=0x00022f4d
--define_symbol xQueuePeek=0x00022f75
--define_symbol xQueuePeekFromISR=0x0002309d
--define_symbol xQueueReceive=0x00023109
--define_symbol xQueueReceiveFromISR=0x00023235
--define_symbol xQueueRemoveFromSet=0x000232c9
--define_symbol xQueueSelectFromSet=0x000232eb
--define_symbol xQueueSelectFromSetFromISR=0x000232fd
--define_symbol xQueueSemaphoreTake=0x00023311
--define_symbol xQueueTakeMutexRecursive=0x0002347d
--define_symbol xTaskCheckForTimeOut=0x000234c1
--define_symbol xTaskCreate=0x00023531
--define_symbol xTaskCreateStatic=0x0002358d
--define_symbol xTaskGetCurrentTaskHandle=0x000235fd
--define_symbol xTaskGetSchedulerState=0x00023609
--define_symbol xTaskGetTickCount=0x00023625
--define_symbol xTaskGetTickCountFromISR=0x00023631
--define_symbol xTaskIncrementTick=0x00023641
--define_symbol xTaskPriorityDisinherit=0x0002370d
--define_symbol xTaskPriorityInherit=0x000237a1
--define_symbol xTaskRemoveFromEventList=0x00023835
--define_symbol xTaskResumeAll=0x000238b5
--define_symbol xTimerCreate=0x0002397d
--define_symbol xTimerCreateStatic=0x000239b1
--define_symbol xTimerCreateTimerTask=0x000239e9
--define_symbol xTimerGenericCommand=0x00023a55
--define_symbol xTimerGetExpiryTime=0x00023ac5
