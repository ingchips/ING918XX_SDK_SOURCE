...
--define_symbol ll_set_adv_coded_scheme=0x0000d385
--define_symbol ll_set_conn_coded_scheme=0x0000d3b5
--define_symbol ll_set_conn_latency=0x0000d3e1
--define_symbol ll_set_conn_tx_power=0x0000d411
--define_symbol ll_set_def_antenna=0x0000d459
--define_symbol ll_set_initiating_coded_scheme=0x0000d475
--define_symbol ll_set_max_conn_number=0x0000d481
--define_symbol nibble_for_char=0x0001df31
...
--define_symbol platform_install_isr_stack=0x0001e141
--define_symbol platform_patch_rf_init_data=0x0001e14d
--define_symbol platform_printf=0x0001e159
--define_symbol platform_raise_assertion=0x0001e16d
--define_symbol platform_rand=0x0001e181
--define_symbol platform_read_info=0x0001e185
--define_symbol platform_read_persistent_reg=0x0001e1a1
--define_symbol platform_reset=0x0001e1b1
--define_symbol platform_set_evt_callback=0x0001e1e5
--define_symbol platform_set_irq_callback=0x0001e1f9
--define_symbol platform_set_rf_clk_source=0x0001e231
--define_symbol platform_set_rf_init_data=0x0001e23d
--define_symbol platform_set_rf_power_mapping=0x0001e249
--define_symbol platform_shutdown=0x0001e255
--define_symbol platform_switch_app=0x0001e259
--define_symbol platform_trace_raw=0x0001e285
--define_symbol platform_write_persistent_reg=0x0001e299
--define_symbol printf_hexdump=0x0001e2a9
...
--define_symbol sm_just_works_confirm=0x00020249
--define_symbol sm_le_device_key=0x00020499
--define_symbol sm_passkey_input=0x00020531
...
--define_symbol sm_register_oob_data_callback=0x00020931
--define_symbol sm_request_pairing=0x0002093d
--define_symbol sm_send_security_request=0x00021377
--define_symbol sm_set_accepted_stk_generation_methods=0x0002139d
--define_symbol sm_set_authentication_requirements=0x000213a9
--define_symbol sm_set_encryption_key_size_range=0x000213b5
--define_symbol sscanf_bd_addr=0x000216b1
--define_symbol sysSetPublicDeviceAddr=0x00021a15
--define_symbol uuid128_to_str=0x00022149
--define_symbol uuid_add_bluetooth_prefix=0x000221a1
--define_symbol uuid_has_bluetooth_prefix=0x000221c1
--define_symbol uxQueueMessagesWaiting=0x00022205
--define_symbol uxQueueMessagesWaitingFromISR=0x0002222d
--define_symbol uxQueueSpacesAvailable=0x00022249
--define_symbol uxTaskGetStackHighWaterMark=0x00022275
--define_symbol vPortEnterCritical=0x0002232d
--define_symbol vPortExitCritical=0x0002236d
--define_symbol vPortFree=0x00022399
--define_symbol vPortSuppressTicksAndSleep=0x0002242d
--define_symbol vPortValidateInterruptPriority=0x00022505
--define_symbol vQueueDelete=0x00022559
--define_symbol vQueueWaitForMessageRestricted=0x00022585
--define_symbol vTaskDelay=0x000225cd
--define_symbol vTaskInternalSetTimeOutState=0x00022619
--define_symbol vTaskMissedYield=0x00022629
--define_symbol vTaskPlaceOnEventList=0x00022635
--define_symbol vTaskPlaceOnEventListRestricted=0x0002266d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000226ad
--define_symbol vTaskStartScheduler=0x00022759
--define_symbol vTaskStepTick=0x000227e9
--define_symbol vTaskSuspendAll=0x00022819
--define_symbol vTaskSwitchContext=0x00022829
--define_symbol xPortStartScheduler=0x000228d1
--define_symbol xQueueAddToSet=0x0002298d
--define_symbol xQueueCreateCountingSemaphore=0x000229b1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000229ed
--define_symbol xQueueCreateMutex=0x00022a31
--define_symbol xQueueCreateMutexStatic=0x00022a47
--define_symbol xQueueCreateSet=0x00022a61
--define_symbol xQueueGenericCreate=0x00022a69
--define_symbol xQueueGenericCreateStatic=0x00022ab5
--define_symbol xQueueGenericReset=0x00022b1d
--define_symbol xQueueGenericSend=0x00022ba9
--define_symbol xQueueGenericSendFromISR=0x00022d15
--define_symbol xQueueGiveFromISR=0x00022dd5
--define_symbol xQueueGiveMutexRecursive=0x00022e79
--define_symbol xQueueIsQueueEmptyFromISR=0x00022eb9
--define_symbol xQueueIsQueueFullFromISR=0x00022edd
--define_symbol xQueuePeek=0x00022f05
--define_symbol xQueuePeekFromISR=0x0002302d
--define_symbol xQueueReceive=0x00023099
--define_symbol xQueueReceiveFromISR=0x000231c5
--define_symbol xQueueRemoveFromSet=0x00023259
--define_symbol xQueueSelectFromSet=0x0002327b
--define_symbol xQueueSelectFromSetFromISR=0x0002328d
--define_symbol xQueueSemaphoreTake=0x000232a1
--define_symbol xQueueTakeMutexRecursive=0x0002340d
--define_symbol xTaskCheckForTimeOut=0x00023451
--define_symbol xTaskCreate=0x000234c1
--define_symbol xTaskCreateStatic=0x0002351d
--define_symbol xTaskGetCurrentTaskHandle=0x0002358d
--define_symbol xTaskGetSchedulerState=0x00023599
--define_symbol xTaskGetTickCount=0x000235b5
--define_symbol xTaskGetTickCountFromISR=0x000235c1
--define_symbol xTaskIncrementTick=0x000235d1
--define_symbol xTaskPriorityDisinherit=0x0002369d
--define_symbol xTaskPriorityInherit=0x00023731
--define_symbol xTaskRemoveFromEventList=0x000237c5
--define_symbol xTaskResumeAll=0x00023845
