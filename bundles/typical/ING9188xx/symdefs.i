...
--define_symbol sm_just_works_confirm=0x00020201
--define_symbol sm_le_device_key=0x00020451
--define_symbol sm_passkey_input=0x000204e9
--define_symbol sm_private_random_address_generation_get=0x00020875
--define_symbol sm_private_random_address_generation_get_mode=0x0002087d
--define_symbol sm_private_random_address_generation_set_mode=0x00020889
--define_symbol sm_private_random_address_generation_set_update_period=0x000208b1
--define_symbol sm_register_oob_data_callback=0x000208e9
--define_symbol sm_request_pairing=0x000208f5
--define_symbol sm_send_security_request=0x0002132f
--define_symbol sm_set_accepted_stk_generation_methods=0x00021355
--define_symbol sm_set_authentication_requirements=0x00021361
--define_symbol sm_set_encryption_key_size_range=0x0002136d
--define_symbol sscanf_bd_addr=0x00021669
--define_symbol sysSetPublicDeviceAddr=0x000219cd
--define_symbol uuid128_to_str=0x00022101
--define_symbol uuid_add_bluetooth_prefix=0x00022159
--define_symbol uuid_has_bluetooth_prefix=0x00022179
--define_symbol uxQueueMessagesWaiting=0x000221bd
--define_symbol uxQueueMessagesWaitingFromISR=0x000221e5
--define_symbol uxQueueSpacesAvailable=0x00022201
--define_symbol uxTaskGetStackHighWaterMark=0x0002222d
--define_symbol vPortEnterCritical=0x000222e5
--define_symbol vPortExitCritical=0x00022325
--define_symbol vPortFree=0x00022351
--define_symbol vPortSuppressTicksAndSleep=0x000223e5
--define_symbol vPortValidateInterruptPriority=0x000224bd
--define_symbol vQueueDelete=0x00022511
--define_symbol vQueueWaitForMessageRestricted=0x0002253d
--define_symbol vTaskDelay=0x00022585
--define_symbol vTaskInternalSetTimeOutState=0x000225d1
--define_symbol vTaskMissedYield=0x000225e1
--define_symbol vTaskPlaceOnEventList=0x000225ed
--define_symbol vTaskPlaceOnEventListRestricted=0x00022625
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022665
--define_symbol vTaskStartScheduler=0x00022711
--define_symbol vTaskStepTick=0x000227a1
--define_symbol vTaskSuspendAll=0x000227d1
--define_symbol vTaskSwitchContext=0x000227e1
--define_symbol xPortStartScheduler=0x00022889
...
--define_symbol xTimerCreate=0x000238c5
--define_symbol xTimerCreateStatic=0x000238f9
--define_symbol xTimerCreateTimerTask=0x00023931
--define_symbol xTimerGenericCommand=0x0002399d
--define_symbol xTimerGetExpiryTime=0x00023a0d
