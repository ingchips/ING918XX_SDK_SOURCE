...
--define_symbol platform_get_heap_status=0x0001e4a5
--define_symbol platform_get_us_time=0x0001e4bd
--define_symbol platform_get_version=0x0001e4c1
--define_symbol platform_hrng=0x0001e4c9
--define_symbol platform_install_isr_stack=0x0001e4d1
--define_symbol platform_patch_rf_init_data=0x0001e4dd
--define_symbol platform_printf=0x0001e4e9
--define_symbol platform_raise_assertion=0x0001e4fd
--define_symbol platform_rand=0x0001e511
--define_symbol platform_read_info=0x0001e515
--define_symbol platform_read_persistent_reg=0x0001e531
--define_symbol platform_reset=0x0001e541
--define_symbol platform_set_evt_callback=0x0001e575
--define_symbol platform_set_irq_callback=0x0001e589
--define_symbol platform_set_rf_clk_source=0x0001e5c1
--define_symbol platform_set_rf_init_data=0x0001e5cd
--define_symbol platform_set_rf_power_mapping=0x0001e5d9
--define_symbol platform_shutdown=0x0001e5e5
--define_symbol platform_switch_app=0x0001e5e9
--define_symbol platform_trace_raw=0x0001e615
--define_symbol platform_write_persistent_reg=0x0001e62d
--define_symbol printf_hexdump=0x0001e63d
...
--define_symbol reverse_128=0x0001f451
--define_symbol reverse_24=0x0001f457
--define_symbol reverse_48=0x0001f45d
--define_symbol reverse_56=0x0001f463
--define_symbol reverse_64=0x0001f469
--define_symbol reverse_bd_addr=0x0001f46f
--define_symbol reverse_bytes=0x0001f475
--define_symbol sm_add_event_handler=0x0001f735
--define_symbol sm_address_resolution_lookup=0x0001f88d
--define_symbol sm_authenticated=0x0001fbd9
--define_symbol sm_authorization_decline=0x0001fbe7
--define_symbol sm_authorization_grant=0x0001fc07
--define_symbol sm_authorization_state=0x0001fc27
--define_symbol sm_bonding_decline=0x0001fc41
--define_symbol sm_config=0x00020061
--define_symbol sm_config_conn=0x00020079
--define_symbol sm_encryption_key_size=0x000201ff
--define_symbol sm_just_works_confirm=0x0002072d
--define_symbol sm_le_device_key=0x00020a69
--define_symbol sm_passkey_input=0x00020aff
--define_symbol sm_private_random_address_generation_get=0x00020ea5
--define_symbol sm_private_random_address_generation_get_mode=0x00020ead
--define_symbol sm_private_random_address_generation_set_mode=0x00020eb9
--define_symbol sm_private_random_address_generation_set_update_period=0x00020ee1
--define_symbol sm_register_oob_data_callback=0x0002101d
--define_symbol sm_request_pairing=0x00021029
--define_symbol sm_send_security_request=0x00021a23
--define_symbol sm_set_accepted_stk_generation_methods=0x00021a49
--define_symbol sm_set_authentication_requirements=0x00021a55
--define_symbol sm_set_encryption_key_size_range=0x00021a61
--define_symbol sscanf_bd_addr=0x00021dbd
--define_symbol sysSetPublicDeviceAddr=0x00022125
--define_symbol uuid128_to_str=0x000228a9
--define_symbol uuid_add_bluetooth_prefix=0x00022901
--define_symbol uuid_has_bluetooth_prefix=0x00022921
--define_symbol uxQueueMessagesWaiting=0x00022965
--define_symbol uxQueueMessagesWaitingFromISR=0x0002298d
--define_symbol uxQueueSpacesAvailable=0x000229a9
--define_symbol uxTaskGetStackHighWaterMark=0x000229d5
--define_symbol vPortEnterCritical=0x00022ae1
--define_symbol vPortExitCritical=0x00022b25
--define_symbol vPortFree=0x00022b55
--define_symbol vPortSuppressTicksAndSleep=0x00022be9
--define_symbol vPortValidateInterruptPriority=0x00022d09
...
--define_symbol vTaskResume=0x00022f61
--define_symbol vTaskStartScheduler=0x00022fe5
--define_symbol vTaskStepTick=0x00023075
--define_symbol vTaskSuspend=0x000230a5
--define_symbol vTaskSuspendAll=0x00023161
--define_symbol vTaskSwitchContext=0x00023171
--define_symbol xPortStartScheduler=0x00023219
