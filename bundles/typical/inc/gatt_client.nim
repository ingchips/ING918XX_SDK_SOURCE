...
type
  ...
  gatt_event_query_complete_t* {.importc: "gatt_event_query_complete_t",
                                header: "gatt_client.h", bycopy.} = object
    handle* {.importc: "handle".}: hci_con_handle_t
  ...
  gatt_client_service_t* {.importc: "gatt_client_service_t",
    ...
    uuid128* {.importc: "uuid128".}: array[UUID128_LEN, uint8]

  gatt_event_service_query_result_t* {.importc: "gatt_event_service_query_result_t",
                                      header: "gatt_client.h", bycopy.} = object
    handle* {.importc: "handle".}: hci_con_handle_t
    service* {.importc: "service".}: gatt_client_service_t
  ...
  gatt_event_characteristic_query_result_t* {.
      importc: "gatt_event_characteristic_query_result_t",
      header: "gatt_client.h", bycopy.} = object
    handle* {.importc: "handle".}: hci_con_handle_t
    characteristic* {.importc: "characteristic".}: gatt_client_characteristic_t
  ...
  gatt_event_characteristic_descriptor_query_result_t* {.
      importc: "gatt_event_characteristic_descriptor_query_result_t",
      header: "gatt_client.h", bycopy.} = object
    handle* {.importc: "handle".}: hci_con_handle_t
    descriptor* {.importc: "descriptor".}: gatt_client_characteristic_descriptor_t

  gatt_event_included_service_query_result_t* {.
      importc: "gatt_event_included_service_query_result_t",
      header: "gatt_client.h", bycopy.} = object
    handle* {.importc: "handle".}: hci_con_handle_t
    include_handle* {.importc: "include_handle".}: uint16
    service* {.importc: "service".}: gatt_client_service_t
...
proc gatt_client_find_included_services_for_service*(
    callback: user_packet_handler_t; con_handle: hci_con_handle_t;
    start_group_handle: uint16; end_group_handle: uint16): uint8 {.
...
proc gatt_client_listen_for_characteristic_value_updates*(
    ...
    value_handle: uint16) {.importc: "gatt_client_listen_for_characteristic_value_updates",
                          header: "gatt_client.h".}
## *
...
proc gatt_event_query_complete_parse*(event: ptr uint8): ptr gatt_event_query_complete_t =
...
proc gatt_event_service_query_result_parse*(event: ptr uint8): ptr gatt_event_service_query_result_t =
...
proc gatt_event_characteristic_query_result_parse*(event: ptr uint8): ptr gatt_event_characteristic_query_result_t =
...
proc gatt_event_included_service_query_result_parse*(event: ptr uint8): ptr gatt_event_included_service_query_result_t =
...
proc gatt_event_all_characteristic_descriptors_query_result_parse*(
    event: ptr uint8): ptr gatt_event_all_characteristic_descriptors_query_result_t =
  return decode_event_offset(event, gatt_event_all_characteristic_descriptors_query_result_t,
                            2)
