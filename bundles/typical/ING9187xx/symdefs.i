...
--define_symbol nibble_for_char=0x0001cf8d
--define_symbol platform_32k_rc_auto_tune=0x0001d029
--define_symbol platform_32k_rc_tune=0x0001d0a5
--define_symbol platform_calibrate_32k=0x0001d0b9
--define_symbol platform_config=0x0001d0bd
...
--define_symbol platform_write_persistent_reg=0x0001d2f9
--define_symbol printf_hexdump=0x0001d309
--define_symbol pvPortMalloc=0x0001de0d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001def5
--define_symbol pvTimerGetTimerID=0x0001df0d
--define_symbol pxPortInitialiseStack=0x0001df39
--define_symbol reverse_128=0x0001e0e1
--define_symbol reverse_24=0x0001e0e7
--define_symbol reverse_48=0x0001e0ed
--define_symbol reverse_56=0x0001e0f3
--define_symbol reverse_64=0x0001e0f9
--define_symbol reverse_bd_addr=0x0001e0ff
--define_symbol reverse_bytes=0x0001e105
--define_symbol sm_add_event_handler=0x0001e271
--define_symbol sm_address_resolution_lookup=0x0001e39d
--define_symbol sm_authenticated=0x0001e6e9
--define_symbol sm_authorization_decline=0x0001e6f7
--define_symbol sm_authorization_grant=0x0001e717
--define_symbol sm_authorization_state=0x0001e737
--define_symbol sm_bonding_decline=0x0001e751
--define_symbol sm_config=0x0001eb1d
--define_symbol sm_config_conn=0x0001eb35
--define_symbol sm_encryption_key_size=0x0001ec93
--define_symbol sm_just_works_confirm=0x0001f0b9
--define_symbol sm_le_device_key=0x0001f2e5
--define_symbol sm_passkey_input=0x0001f37b
--define_symbol sm_private_random_address_generation_get=0x0001f6c1
--define_symbol sm_private_random_address_generation_get_mode=0x0001f6c9
--define_symbol sm_private_random_address_generation_set_mode=0x0001f6d5
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f6fd
--define_symbol sm_register_oob_data_callback=0x0001f839
--define_symbol sm_request_pairing=0x0001f845
--define_symbol sm_send_security_request=0x00020183
--define_symbol sm_set_accepted_stk_generation_methods=0x000201a9
--define_symbol sm_set_authentication_requirements=0x000201b5
--define_symbol sm_set_encryption_key_size_range=0x000201c1
--define_symbol sscanf_bd_addr=0x00020495
--define_symbol sysSetPublicDeviceAddr=0x000207cd
--define_symbol uuid128_to_str=0x00020da5
--define_symbol uuid_add_bluetooth_prefix=0x00020dfd
--define_symbol uuid_has_bluetooth_prefix=0x00020e1d
--define_symbol uxQueueMessagesWaiting=0x00020e61
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e89
--define_symbol uxQueueSpacesAvailable=0x00020ea5
--define_symbol uxTaskGetStackHighWaterMark=0x00020ed1
--define_symbol vPortEnterCritical=0x00020ff5
--define_symbol vPortExitCritical=0x00021035
--define_symbol vPortFree=0x00021061
--define_symbol vPortSuppressTicksAndSleep=0x000210f5
--define_symbol vPortValidateInterruptPriority=0x000211cd
--define_symbol vQueueDelete=0x00021221
--define_symbol vQueueWaitForMessageRestricted=0x0002124d
--define_symbol vTaskDelay=0x00021295
--define_symbol vTaskInternalSetTimeOutState=0x000212e1
--define_symbol vTaskMissedYield=0x000212f1
--define_symbol vTaskPlaceOnEventList=0x000212fd
--define_symbol vTaskPlaceOnEventListRestricted=0x00021335
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021375
--define_symbol vTaskResume=0x00021421
--define_symbol vTaskStartScheduler=0x000214a5
--define_symbol vTaskStepTick=0x00021535
--define_symbol vTaskSuspend=0x00021565
--define_symbol vTaskSuspendAll=0x00021621
--define_symbol vTaskSwitchContext=0x00021631
--define_symbol xPortStartScheduler=0x000216d9
--define_symbol xQueueAddToSet=0x00021795
--define_symbol xQueueCreateCountingSemaphore=0x000217b9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000217f5
--define_symbol xQueueCreateMutex=0x00021839
--define_symbol xQueueCreateMutexStatic=0x0002184f
--define_symbol xQueueCreateSet=0x00021869
--define_symbol xQueueGenericCreate=0x00021871
--define_symbol xQueueGenericCreateStatic=0x000218bd
--define_symbol xQueueGenericReset=0x00021925
--define_symbol xQueueGenericSend=0x000219b1
--define_symbol xQueueGenericSendFromISR=0x00021b1d
--define_symbol xQueueGiveFromISR=0x00021bdd
--define_symbol xQueueGiveMutexRecursive=0x00021c81
--define_symbol xQueueIsQueueEmptyFromISR=0x00021cc1
--define_symbol xQueueIsQueueFullFromISR=0x00021ce5
--define_symbol xQueuePeek=0x00021d0d
--define_symbol xQueuePeekFromISR=0x00021e35
--define_symbol xQueueReceive=0x00021ea1
--define_symbol xQueueReceiveFromISR=0x00021fcd
--define_symbol xQueueRemoveFromSet=0x00022061
--define_symbol xQueueSelectFromSet=0x00022083
--define_symbol xQueueSelectFromSetFromISR=0x00022095
--define_symbol xQueueSemaphoreTake=0x000220a9
--define_symbol xQueueTakeMutexRecursive=0x00022215
--define_symbol xTaskCheckForTimeOut=0x00022259
--define_symbol xTaskCreate=0x000222c9
--define_symbol xTaskCreateStatic=0x00022325
--define_symbol xTaskGetCurrentTaskHandle=0x00022395
--define_symbol xTaskGetSchedulerState=0x000223a1
--define_symbol xTaskGetTickCount=0x000223bd
--define_symbol xTaskGetTickCountFromISR=0x000223c9
--define_symbol xTaskIncrementTick=0x000223d9
--define_symbol xTaskPriorityDisinherit=0x000224a5
--define_symbol xTaskPriorityInherit=0x00022539
--define_symbol xTaskRemoveFromEventList=0x000225cd
--define_symbol xTaskResumeAll=0x0002264d
--define_symbol xTaskResumeFromISR=0x00022715
--define_symbol xTimerCreate=0x000227a1
--define_symbol xTimerCreateStatic=0x000227d5
--define_symbol xTimerCreateTimerTask=0x0002280d
--define_symbol xTimerGenericCommand=0x00022879
--define_symbol xTimerGetExpiryTime=0x000228e9
