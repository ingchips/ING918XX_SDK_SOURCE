...
--define_symbol nibble_for_char=0x0001ce71
--define_symbol platform_32k_rc_auto_tune=0x0001cf0d
--define_symbol platform_32k_rc_tune=0x0001cf89
--define_symbol platform_calibrate_32k=0x0001cf9d
--define_symbol platform_config=0x0001cfa1
--define_symbol platform_get_heap_status=0x0001d059
...
--define_symbol platform_shutdown=0x0001d199
--define_symbol platform_switch_app=0x0001d19d
--define_symbol platform_trace_raw=0x0001d1c9
--define_symbol platform_write_persistent_reg=0x0001d1dd
--define_symbol printf_hexdump=0x0001d1ed
--define_symbol pvPortMalloc=0x0001dcb9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dda1
--define_symbol pvTimerGetTimerID=0x0001ddb9
--define_symbol pxPortInitialiseStack=0x0001dde5
--define_symbol reverse_128=0x0001df8d
--define_symbol reverse_24=0x0001df93
--define_symbol reverse_48=0x0001df99
--define_symbol reverse_56=0x0001df9f
--define_symbol reverse_64=0x0001dfa5
--define_symbol reverse_bd_addr=0x0001dfab
--define_symbol reverse_bytes=0x0001dfb1
--define_symbol sm_add_event_handler=0x0001e11d
--define_symbol sm_address_resolution_lookup=0x0001e249
--define_symbol sm_authenticated=0x0001e595
--define_symbol sm_authorization_decline=0x0001e5a3
--define_symbol sm_authorization_grant=0x0001e5c3
--define_symbol sm_authorization_state=0x0001e5e3
--define_symbol sm_bonding_decline=0x0001e5fd
--define_symbol sm_config=0x0001e9c9
--define_symbol sm_config_conn=0x0001e9e1
--define_symbol sm_encryption_key_size=0x0001eb3f
--define_symbol sm_just_works_confirm=0x0001ef65
--define_symbol sm_le_device_key=0x0001f191
--define_symbol sm_passkey_input=0x0001f227
--define_symbol sm_private_random_address_generation_get=0x0001f56d
--define_symbol sm_private_random_address_generation_get_mode=0x0001f575
--define_symbol sm_private_random_address_generation_set_mode=0x0001f581
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f5a9
--define_symbol sm_register_oob_data_callback=0x0001f6e5
--define_symbol sm_request_pairing=0x0001f6f1
--define_symbol sm_send_security_request=0x0002002f
--define_symbol sm_set_accepted_stk_generation_methods=0x00020055
--define_symbol sm_set_authentication_requirements=0x00020061
--define_symbol sm_set_encryption_key_size_range=0x0002006d
--define_symbol sscanf_bd_addr=0x00020341
--define_symbol sysSetPublicDeviceAddr=0x00020685
--define_symbol uuid128_to_str=0x00020c2d
--define_symbol uuid_add_bluetooth_prefix=0x00020c85
--define_symbol uuid_has_bluetooth_prefix=0x00020ca5
--define_symbol uxQueueMessagesWaiting=0x00020ce9
--define_symbol uxQueueMessagesWaitingFromISR=0x00020d11
--define_symbol uxQueueSpacesAvailable=0x00020d2d
--define_symbol uxTaskGetStackHighWaterMark=0x00020d59
