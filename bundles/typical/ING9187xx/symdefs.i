...
--define_symbol nibble_for_char=0x0001d001
--define_symbol platform_32k_rc_auto_tune=0x0001d09d
--define_symbol platform_32k_rc_tune=0x0001d119
--define_symbol platform_calibrate_32k=0x0001d12d
--define_symbol platform_config=0x0001d131
--define_symbol platform_get_heap_status=0x0001d1f1
--define_symbol platform_get_us_time=0x0001d209
--define_symbol platform_get_version=0x0001d20d
--define_symbol platform_hrng=0x0001d215
--define_symbol platform_install_isr_stack=0x0001d21d
--define_symbol platform_patch_rf_init_data=0x0001d229
--define_symbol platform_printf=0x0001d235
--define_symbol platform_raise_assertion=0x0001d249
--define_symbol platform_rand=0x0001d25d
--define_symbol platform_read_info=0x0001d261
--define_symbol platform_read_persistent_reg=0x0001d27d
--define_symbol platform_reset=0x0001d28d
--define_symbol platform_set_evt_callback=0x0001d2c1
--define_symbol platform_set_irq_callback=0x0001d2d5
--define_symbol platform_set_rf_clk_source=0x0001d30d
--define_symbol platform_set_rf_init_data=0x0001d319
--define_symbol platform_set_rf_power_mapping=0x0001d325
--define_symbol platform_shutdown=0x0001d331
--define_symbol platform_switch_app=0x0001d335
--define_symbol platform_trace_raw=0x0001d361
--define_symbol platform_write_persistent_reg=0x0001d379
--define_symbol printf_hexdump=0x0001d389
--define_symbol pvPortMalloc=0x0001de91
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df79
--define_symbol pvTimerGetTimerID=0x0001df91
--define_symbol pxPortInitialiseStack=0x0001dfbd
--define_symbol reverse_128=0x0001e165
--define_symbol reverse_24=0x0001e16b
--define_symbol reverse_48=0x0001e171
--define_symbol reverse_56=0x0001e177
--define_symbol reverse_64=0x0001e17d
--define_symbol reverse_bd_addr=0x0001e183
--define_symbol reverse_bytes=0x0001e189
--define_symbol sm_add_event_handler=0x0001e2f5
--define_symbol sm_address_resolution_lookup=0x0001e44d
--define_symbol sm_authenticated=0x0001e799
--define_symbol sm_authorization_decline=0x0001e7a7
--define_symbol sm_authorization_grant=0x0001e7c7
--define_symbol sm_authorization_state=0x0001e7e7
--define_symbol sm_bonding_decline=0x0001e801
--define_symbol sm_config=0x0001ec21
--define_symbol sm_config_conn=0x0001ec39
--define_symbol sm_encryption_key_size=0x0001edbf
--define_symbol sm_just_works_confirm=0x0001f2ed
--define_symbol sm_le_device_key=0x0001f629
--define_symbol sm_passkey_input=0x0001f6bf
...
--define_symbol sm_register_oob_data_callback=0x0001fbdd
--define_symbol sm_request_pairing=0x0001fbe9
--define_symbol sm_send_security_request=0x000205e3
--define_symbol sm_set_accepted_stk_generation_methods=0x00020609
--define_symbol sm_set_authentication_requirements=0x00020615
--define_symbol sm_set_encryption_key_size_range=0x00020621
--define_symbol sscanf_bd_addr=0x0002097d
--define_symbol sysSetPublicDeviceAddr=0x00020ce5
--define_symbol uuid128_to_str=0x000212d9
--define_symbol uuid_add_bluetooth_prefix=0x00021331
--define_symbol uuid_has_bluetooth_prefix=0x00021351
--define_symbol uxListRemove=0x0002136d
--define_symbol uxQueueMessagesWaiting=0x00021395
--define_symbol uxQueueMessagesWaitingFromISR=0x000213bd
--define_symbol uxQueueSpacesAvailable=0x000213d9
--define_symbol uxTaskGetStackHighWaterMark=0x00021405
--define_symbol vListInitialise=0x000214ab
--define_symbol vListInitialiseItem=0x000214c1
--define_symbol vListInsert=0x000214c7
--define_symbol vListInsertEnd=0x000214f7
--define_symbol vPortEnterCritical=0x00021511
--define_symbol vPortExitCritical=0x00021555
--define_symbol vPortFree=0x00021585
--define_symbol vPortSuppressTicksAndSleep=0x00021619
--define_symbol vPortValidateInterruptPriority=0x00021739
--define_symbol vQueueDelete=0x00021791
--define_symbol vQueueWaitForMessageRestricted=0x000217bd
--define_symbol vTaskDelay=0x00021805
--define_symbol vTaskInternalSetTimeOutState=0x00021851
--define_symbol vTaskMissedYield=0x00021861
--define_symbol vTaskPlaceOnEventList=0x0002186d
--define_symbol vTaskPlaceOnEventListRestricted=0x000218a5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218e5
--define_symbol vTaskResume=0x00021991
--define_symbol vTaskStartScheduler=0x00021a15
--define_symbol vTaskStepTick=0x00021aa5
--define_symbol vTaskSuspend=0x00021ad5
--define_symbol vTaskSuspendAll=0x00021b91
--define_symbol vTaskSwitchContext=0x00021ba1
--define_symbol xPortStartScheduler=0x00021c49
--define_symbol xQueueAddToSet=0x00021d0d
--define_symbol xQueueCreateCountingSemaphore=0x00021d31
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d6d
--define_symbol xQueueCreateMutex=0x00021db1
--define_symbol xQueueCreateMutexStatic=0x00021dc7
--define_symbol xQueueCreateSet=0x00021de1
--define_symbol xQueueGenericCreate=0x00021de9
--define_symbol xQueueGenericCreateStatic=0x00021e35
--define_symbol xQueueGenericReset=0x00021e9d
--define_symbol xQueueGenericSend=0x00021f29
--define_symbol xQueueGenericSendFromISR=0x00022095
--define_symbol xQueueGiveFromISR=0x00022155
--define_symbol xQueueGiveMutexRecursive=0x000221f9
--define_symbol xQueueIsQueueEmptyFromISR=0x00022239
--define_symbol xQueueIsQueueFullFromISR=0x0002225d
--define_symbol xQueuePeek=0x00022285
--define_symbol xQueuePeekFromISR=0x000223ad
--define_symbol xQueueReceive=0x00022419
--define_symbol xQueueReceiveFromISR=0x00022545
--define_symbol xQueueRemoveFromSet=0x000225d9
--define_symbol xQueueSelectFromSet=0x000225fb
--define_symbol xQueueSelectFromSetFromISR=0x0002260d
--define_symbol xQueueSemaphoreTake=0x00022621
--define_symbol xQueueTakeMutexRecursive=0x0002278d
--define_symbol xTaskCheckForTimeOut=0x000227d1
--define_symbol xTaskCreate=0x00022841
--define_symbol xTaskCreateStatic=0x0002289d
--define_symbol xTaskGetCurrentTaskHandle=0x0002290d
--define_symbol xTaskGetSchedulerState=0x00022919
--define_symbol xTaskGetTickCount=0x00022935
--define_symbol xTaskGetTickCountFromISR=0x00022941
--define_symbol xTaskIncrementTick=0x00022951
--define_symbol xTaskPriorityDisinherit=0x00022a1d
--define_symbol xTaskPriorityInherit=0x00022ab1
--define_symbol xTaskRemoveFromEventList=0x00022b45
--define_symbol xTaskResumeAll=0x00022bc5
--define_symbol xTaskResumeFromISR=0x00022c8d
--define_symbol xTimerCreate=0x00022d19
--define_symbol xTimerCreateStatic=0x00022d4d
--define_symbol xTimerCreateTimerTask=0x00022d85
--define_symbol xTimerGenericCommand=0x00022df1
--define_symbol xTimerGetExpiryTime=0x00022e61
