...
--define_symbol nibble_for_char=0x0001d00d
--define_symbol platform_32k_rc_auto_tune=0x0001d0a9
--define_symbol platform_32k_rc_tune=0x0001d125
--define_symbol platform_calibrate_32k=0x0001d139
--define_symbol platform_config=0x0001d13d
--define_symbol platform_get_heap_status=0x0001d1fd
--define_symbol platform_get_us_time=0x0001d215
--define_symbol platform_get_version=0x0001d219
--define_symbol platform_hrng=0x0001d221
--define_symbol platform_install_isr_stack=0x0001d229
--define_symbol platform_patch_rf_init_data=0x0001d235
--define_symbol platform_printf=0x0001d241
--define_symbol platform_raise_assertion=0x0001d255
--define_symbol platform_rand=0x0001d269
--define_symbol platform_read_info=0x0001d26d
--define_symbol platform_read_persistent_reg=0x0001d289
--define_symbol platform_reset=0x0001d299
--define_symbol platform_set_evt_callback=0x0001d2cd
--define_symbol platform_set_irq_callback=0x0001d2e1
--define_symbol platform_set_rf_clk_source=0x0001d319
--define_symbol platform_set_rf_init_data=0x0001d325
--define_symbol platform_set_rf_power_mapping=0x0001d331
--define_symbol platform_shutdown=0x0001d33d
--define_symbol platform_switch_app=0x0001d341
--define_symbol platform_trace_raw=0x0001d36d
--define_symbol platform_write_persistent_reg=0x0001d385
--define_symbol printf_hexdump=0x0001d395
--define_symbol pvPortMalloc=0x0001de9d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df85
--define_symbol pvTimerGetTimerID=0x0001df9d
--define_symbol pxPortInitialiseStack=0x0001dfc9
--define_symbol reverse_128=0x0001e171
--define_symbol reverse_24=0x0001e177
--define_symbol reverse_48=0x0001e17d
--define_symbol reverse_56=0x0001e183
--define_symbol reverse_64=0x0001e189
--define_symbol reverse_bd_addr=0x0001e18f
--define_symbol reverse_bytes=0x0001e195
--define_symbol sm_add_event_handler=0x0001e301
--define_symbol sm_address_resolution_lookup=0x0001e459
--define_symbol sm_authenticated=0x0001e7a5
--define_symbol sm_authorization_decline=0x0001e7b3
--define_symbol sm_authorization_grant=0x0001e7d3
--define_symbol sm_authorization_state=0x0001e7f3
--define_symbol sm_bonding_decline=0x0001e80d
--define_symbol sm_config=0x0001ec2d
--define_symbol sm_config_conn=0x0001ec45
--define_symbol sm_encryption_key_size=0x0001edcb
--define_symbol sm_just_works_confirm=0x0001f2f9
--define_symbol sm_le_device_key=0x0001f635
--define_symbol sm_passkey_input=0x0001f6cb
--define_symbol sm_private_random_address_generation_get=0x0001fa71
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa79
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa85
--define_symbol sm_private_random_address_generation_set_update_period=0x0001faad
--define_symbol sm_register_oob_data_callback=0x0001fbe9
--define_symbol sm_request_pairing=0x0001fbf5
--define_symbol sm_send_security_request=0x000205ef
--define_symbol sm_set_accepted_stk_generation_methods=0x00020615
--define_symbol sm_set_authentication_requirements=0x00020621
--define_symbol sm_set_encryption_key_size_range=0x0002062d
--define_symbol sscanf_bd_addr=0x00020989
--define_symbol sysSetPublicDeviceAddr=0x00020cf1
--define_symbol uuid128_to_str=0x000212e5
--define_symbol uuid_add_bluetooth_prefix=0x0002133d
--define_symbol uuid_has_bluetooth_prefix=0x0002135d
--define_symbol uxListRemove=0x00021379
--define_symbol uxQueueMessagesWaiting=0x000213a1
--define_symbol uxQueueMessagesWaitingFromISR=0x000213c9
--define_symbol uxQueueSpacesAvailable=0x000213e5
--define_symbol uxTaskGetStackHighWaterMark=0x00021411
--define_symbol vListInitialise=0x000214b7
--define_symbol vListInitialiseItem=0x000214cd
--define_symbol vListInsert=0x000214d3
--define_symbol vListInsertEnd=0x00021503
...
--define_symbol vPortValidateInterruptPriority=0x00021745
...
--define_symbol vTaskResume=0x0002199d
--define_symbol vTaskStartScheduler=0x00021a21
--define_symbol vTaskStepTick=0x00021ab1
--define_symbol vTaskSuspend=0x00021ae1
--define_symbol vTaskSuspendAll=0x00021b9d
--define_symbol vTaskSwitchContext=0x00021bad
--define_symbol xPortStartScheduler=0x00021c55
--define_symbol xQueueAddToSet=0x00021d19
--define_symbol xQueueCreateCountingSemaphore=0x00021d3d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d79
--define_symbol xQueueCreateMutex=0x00021dbd
--define_symbol xQueueCreateMutexStatic=0x00021dd3
--define_symbol xQueueCreateSet=0x00021ded
--define_symbol xQueueGenericCreate=0x00021df5
--define_symbol xQueueGenericCreateStatic=0x00021e41
--define_symbol xQueueGenericReset=0x00021ea9
--define_symbol xQueueGenericSend=0x00021f35
--define_symbol xQueueGenericSendFromISR=0x000220a1
--define_symbol xQueueGiveFromISR=0x00022161
--define_symbol xQueueGiveMutexRecursive=0x00022205
--define_symbol xQueueIsQueueEmptyFromISR=0x00022245
--define_symbol xQueueIsQueueFullFromISR=0x00022269
--define_symbol xQueuePeek=0x00022291
--define_symbol xQueuePeekFromISR=0x000223b9
--define_symbol xQueueReceive=0x00022425
--define_symbol xQueueReceiveFromISR=0x00022551
--define_symbol xQueueRemoveFromSet=0x000225e5
--define_symbol xQueueSelectFromSet=0x00022607
--define_symbol xQueueSelectFromSetFromISR=0x00022619
--define_symbol xQueueSemaphoreTake=0x0002262d
--define_symbol xQueueTakeMutexRecursive=0x00022799
--define_symbol xTaskCheckForTimeOut=0x000227dd
--define_symbol xTaskCreate=0x0002284d
--define_symbol xTaskCreateStatic=0x000228a9
--define_symbol xTaskGetCurrentTaskHandle=0x00022919
--define_symbol xTaskGetSchedulerState=0x00022925
--define_symbol xTaskGetTickCount=0x00022941
--define_symbol xTaskGetTickCountFromISR=0x0002294d
--define_symbol xTaskIncrementTick=0x0002295d
--define_symbol xTaskPriorityDisinherit=0x00022a29
--define_symbol xTaskPriorityInherit=0x00022abd
--define_symbol xTaskRemoveFromEventList=0x00022b51
--define_symbol xTaskResumeAll=0x00022bd1
--define_symbol xTaskResumeFromISR=0x00022c99
--define_symbol xTimerCreate=0x00022d25
--define_symbol xTimerCreateStatic=0x00022d59
--define_symbol xTimerCreateTimerTask=0x00022d91
--define_symbol xTimerGenericCommand=0x00022dfd
--define_symbol xTimerGetExpiryTime=0x00022e6d
