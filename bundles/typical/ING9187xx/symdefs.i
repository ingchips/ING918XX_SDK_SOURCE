...
--define_symbol nibble_for_char=0x0001d019
--define_symbol platform_32k_rc_auto_tune=0x0001d0b5
--define_symbol platform_32k_rc_tune=0x0001d131
--define_symbol platform_calibrate_32k=0x0001d145
--define_symbol platform_config=0x0001d149
--define_symbol platform_get_heap_status=0x0001d209
--define_symbol platform_get_us_time=0x0001d221
--define_symbol platform_get_version=0x0001d225
--define_symbol platform_hrng=0x0001d22d
--define_symbol platform_install_isr_stack=0x0001d235
--define_symbol platform_patch_rf_init_data=0x0001d241
--define_symbol platform_printf=0x0001d24d
--define_symbol platform_raise_assertion=0x0001d261
--define_symbol platform_rand=0x0001d275
--define_symbol platform_read_info=0x0001d279
--define_symbol platform_read_persistent_reg=0x0001d295
--define_symbol platform_reset=0x0001d2a5
--define_symbol platform_set_evt_callback=0x0001d2d9
--define_symbol platform_set_irq_callback=0x0001d2ed
--define_symbol platform_set_rf_clk_source=0x0001d325
--define_symbol platform_set_rf_init_data=0x0001d331
--define_symbol platform_set_rf_power_mapping=0x0001d33d
--define_symbol platform_shutdown=0x0001d349
--define_symbol platform_switch_app=0x0001d34d
--define_symbol platform_trace_raw=0x0001d379
--define_symbol platform_write_persistent_reg=0x0001d391
--define_symbol printf_hexdump=0x0001d3a1
--define_symbol pvPortMalloc=0x0001dea9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df91
--define_symbol pvTimerGetTimerID=0x0001dfa9
--define_symbol pxPortInitialiseStack=0x0001dfd5
--define_symbol reverse_128=0x0001e17d
--define_symbol reverse_24=0x0001e183
--define_symbol reverse_48=0x0001e189
--define_symbol reverse_56=0x0001e18f
--define_symbol reverse_64=0x0001e195
--define_symbol reverse_bd_addr=0x0001e19b
--define_symbol reverse_bytes=0x0001e1a1
--define_symbol sm_add_event_handler=0x0001e30d
--define_symbol sm_address_resolution_lookup=0x0001e465
--define_symbol sm_authenticated=0x0001e7b1
--define_symbol sm_authorization_decline=0x0001e7bf
--define_symbol sm_authorization_grant=0x0001e7df
--define_symbol sm_authorization_state=0x0001e7ff
--define_symbol sm_bonding_decline=0x0001e819
--define_symbol sm_config=0x0001ec39
--define_symbol sm_config_conn=0x0001ec51
--define_symbol sm_encryption_key_size=0x0001edd7
--define_symbol sm_just_works_confirm=0x0001f305
--define_symbol sm_le_device_key=0x0001f641
--define_symbol sm_passkey_input=0x0001f6d7
--define_symbol sm_private_random_address_generation_get=0x0001fa7d
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa85
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa91
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fab9
--define_symbol sm_register_oob_data_callback=0x0001fbf5
--define_symbol sm_request_pairing=0x0001fc01
--define_symbol sm_send_security_request=0x000205fb
--define_symbol sm_set_accepted_stk_generation_methods=0x00020621
--define_symbol sm_set_authentication_requirements=0x0002062d
--define_symbol sm_set_encryption_key_size_range=0x00020639
--define_symbol sscanf_bd_addr=0x00020995
--define_symbol sysSetPublicDeviceAddr=0x00020cfd
--define_symbol uuid128_to_str=0x000212f1
--define_symbol uuid_add_bluetooth_prefix=0x00021349
--define_symbol uuid_has_bluetooth_prefix=0x00021369
--define_symbol uxListRemove=0x00021385
--define_symbol uxQueueMessagesWaiting=0x000213ad
--define_symbol uxQueueMessagesWaitingFromISR=0x000213d5
--define_symbol uxQueueSpacesAvailable=0x000213f1
--define_symbol uxTaskGetStackHighWaterMark=0x0002141d
--define_symbol vListInitialise=0x000214c3
--define_symbol vListInitialiseItem=0x000214d9
--define_symbol vListInsert=0x000214df
--define_symbol vListInsertEnd=0x0002150f
--define_symbol vPortEnterCritical=0x00021529
--define_symbol vPortExitCritical=0x0002156d
--define_symbol vPortFree=0x0002159d
--define_symbol vPortSuppressTicksAndSleep=0x00021631
--define_symbol vPortValidateInterruptPriority=0x00021751
--define_symbol vQueueDelete=0x000217a9
--define_symbol vQueueWaitForMessageRestricted=0x000217d5
--define_symbol vTaskDelay=0x0002181d
--define_symbol vTaskInternalSetTimeOutState=0x00021869
--define_symbol vTaskMissedYield=0x00021879
--define_symbol vTaskPlaceOnEventList=0x00021885
--define_symbol vTaskPlaceOnEventListRestricted=0x000218bd
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218fd
--define_symbol vTaskResume=0x000219a9
--define_symbol vTaskStartScheduler=0x00021a2d
--define_symbol vTaskStepTick=0x00021abd
--define_symbol vTaskSuspend=0x00021aed
--define_symbol vTaskSuspendAll=0x00021ba9
--define_symbol vTaskSwitchContext=0x00021bb9
--define_symbol xPortStartScheduler=0x00021c61
--define_symbol xQueueAddToSet=0x00021d25
--define_symbol xQueueCreateCountingSemaphore=0x00021d49
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d85
--define_symbol xQueueCreateMutex=0x00021dc9
--define_symbol xQueueCreateMutexStatic=0x00021ddf
--define_symbol xQueueCreateSet=0x00021df9
--define_symbol xQueueGenericCreate=0x00021e01
--define_symbol xQueueGenericCreateStatic=0x00021e4d
--define_symbol xQueueGenericReset=0x00021eb5
--define_symbol xQueueGenericSend=0x00021f41
--define_symbol xQueueGenericSendFromISR=0x000220ad
--define_symbol xQueueGiveFromISR=0x0002216d
--define_symbol xQueueGiveMutexRecursive=0x00022211
--define_symbol xQueueIsQueueEmptyFromISR=0x00022251
--define_symbol xQueueIsQueueFullFromISR=0x00022275
--define_symbol xQueuePeek=0x0002229d
--define_symbol xQueuePeekFromISR=0x000223c5
--define_symbol xQueueReceive=0x00022431
--define_symbol xQueueReceiveFromISR=0x0002255d
--define_symbol xQueueRemoveFromSet=0x000225f1
--define_symbol xQueueSelectFromSet=0x00022613
--define_symbol xQueueSelectFromSetFromISR=0x00022625
--define_symbol xQueueSemaphoreTake=0x00022639
--define_symbol xQueueTakeMutexRecursive=0x000227a5
--define_symbol xTaskCheckForTimeOut=0x000227e9
--define_symbol xTaskCreate=0x00022859
--define_symbol xTaskCreateStatic=0x000228b5
--define_symbol xTaskGetCurrentTaskHandle=0x00022925
--define_symbol xTaskGetSchedulerState=0x00022931
--define_symbol xTaskGetTickCount=0x0002294d
--define_symbol xTaskGetTickCountFromISR=0x00022959
--define_symbol xTaskIncrementTick=0x00022969
--define_symbol xTaskPriorityDisinherit=0x00022a35
--define_symbol xTaskPriorityInherit=0x00022ac9
--define_symbol xTaskRemoveFromEventList=0x00022b5d
--define_symbol xTaskResumeAll=0x00022bdd
--define_symbol xTaskResumeFromISR=0x00022ca5
--define_symbol xTimerCreate=0x00022d31
--define_symbol xTimerCreateStatic=0x00022d65
--define_symbol xTimerCreateTimerTask=0x00022d9d
--define_symbol xTimerGenericCommand=0x00022e09
--define_symbol xTimerGetExpiryTime=0x00022e79
