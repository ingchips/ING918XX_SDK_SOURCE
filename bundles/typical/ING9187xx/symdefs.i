...
--define_symbol nibble_for_char=0x0001cf95
--define_symbol platform_32k_rc_auto_tune=0x0001d031
--define_symbol platform_32k_rc_tune=0x0001d0ad
--define_symbol platform_calibrate_32k=0x0001d0c1
--define_symbol platform_config=0x0001d0c5
--define_symbol platform_get_heap_status=0x0001d185
--define_symbol platform_get_us_time=0x0001d19d
--define_symbol platform_get_version=0x0001d1a1
--define_symbol platform_hrng=0x0001d1a9
--define_symbol platform_install_isr_stack=0x0001d1b1
--define_symbol platform_patch_rf_init_data=0x0001d1bd
--define_symbol platform_printf=0x0001d1c9
--define_symbol platform_raise_assertion=0x0001d1dd
--define_symbol platform_rand=0x0001d1f1
--define_symbol platform_read_info=0x0001d1f5
--define_symbol platform_read_persistent_reg=0x0001d211
--define_symbol platform_reset=0x0001d221
--define_symbol platform_set_evt_callback=0x0001d255
--define_symbol platform_set_irq_callback=0x0001d269
--define_symbol platform_set_rf_clk_source=0x0001d2a1
--define_symbol platform_set_rf_init_data=0x0001d2ad
--define_symbol platform_set_rf_power_mapping=0x0001d2b9
--define_symbol platform_shutdown=0x0001d2c5
--define_symbol platform_switch_app=0x0001d2c9
--define_symbol platform_trace_raw=0x0001d2f5
--define_symbol platform_write_persistent_reg=0x0001d30d
--define_symbol printf_hexdump=0x0001d31d
--define_symbol pvPortMalloc=0x0001de25
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df0d
--define_symbol pvTimerGetTimerID=0x0001df25
--define_symbol pxPortInitialiseStack=0x0001df51
--define_symbol reverse_128=0x0001e0f9
--define_symbol reverse_24=0x0001e0ff
--define_symbol reverse_48=0x0001e105
--define_symbol reverse_56=0x0001e10b
--define_symbol reverse_64=0x0001e111
--define_symbol reverse_bd_addr=0x0001e117
--define_symbol reverse_bytes=0x0001e11d
--define_symbol sm_add_event_handler=0x0001e289
--define_symbol sm_address_resolution_lookup=0x0001e3e1
--define_symbol sm_authenticated=0x0001e72d
--define_symbol sm_authorization_decline=0x0001e73b
--define_symbol sm_authorization_grant=0x0001e75b
--define_symbol sm_authorization_state=0x0001e77b
--define_symbol sm_bonding_decline=0x0001e795
--define_symbol sm_config=0x0001ebb5
--define_symbol sm_config_conn=0x0001ebcd
--define_symbol sm_encryption_key_size=0x0001ed53
--define_symbol sm_just_works_confirm=0x0001f281
--define_symbol sm_le_device_key=0x0001f5bd
--define_symbol sm_passkey_input=0x0001f653
--define_symbol sm_private_random_address_generation_get=0x0001f9f9
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa01
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa0d
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fa35
--define_symbol sm_register_oob_data_callback=0x0001fb71
--define_symbol sm_request_pairing=0x0001fb7d
--define_symbol sm_send_security_request=0x00020577
--define_symbol sm_set_accepted_stk_generation_methods=0x0002059d
--define_symbol sm_set_authentication_requirements=0x000205a9
--define_symbol sm_set_encryption_key_size_range=0x000205b5
--define_symbol sscanf_bd_addr=0x00020911
--define_symbol sysSetPublicDeviceAddr=0x00020c79
...
--define_symbol uxTaskGetStackHighWaterMark=0x00021399
--define_symbol vPortEnterCritical=0x000214a5
--define_symbol vPortExitCritical=0x000214e9
--define_symbol vPortFree=0x00021519
--define_symbol vPortSuppressTicksAndSleep=0x000215ad
--define_symbol vPortValidateInterruptPriority=0x000216cd
--define_symbol vQueueDelete=0x00021725
--define_symbol vQueueWaitForMessageRestricted=0x00021751
--define_symbol vTaskDelay=0x00021799
--define_symbol vTaskInternalSetTimeOutState=0x000217e5
--define_symbol vTaskMissedYield=0x000217f5
--define_symbol vTaskPlaceOnEventList=0x00021801
--define_symbol vTaskPlaceOnEventListRestricted=0x00021839
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021879
--define_symbol vTaskResume=0x00021925
--define_symbol vTaskStartScheduler=0x000219a9
--define_symbol vTaskStepTick=0x00021a39
--define_symbol vTaskSuspend=0x00021a69
--define_symbol vTaskSuspendAll=0x00021b25
--define_symbol vTaskSwitchContext=0x00021b35
--define_symbol xPortStartScheduler=0x00021bdd
--define_symbol xQueueAddToSet=0x00021ca1
--define_symbol xQueueCreateCountingSemaphore=0x00021cc5
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021d01
--define_symbol xQueueCreateMutex=0x00021d45
--define_symbol xQueueCreateMutexStatic=0x00021d5b
--define_symbol xQueueCreateSet=0x00021d75
--define_symbol xQueueGenericCreate=0x00021d7d
--define_symbol xQueueGenericCreateStatic=0x00021dc9
--define_symbol xQueueGenericReset=0x00021e31
--define_symbol xQueueGenericSend=0x00021ebd
--define_symbol xQueueGenericSendFromISR=0x00022029
--define_symbol xQueueGiveFromISR=0x000220e9
--define_symbol xQueueGiveMutexRecursive=0x0002218d
--define_symbol xQueueIsQueueEmptyFromISR=0x000221cd
--define_symbol xQueueIsQueueFullFromISR=0x000221f1
--define_symbol xQueuePeek=0x00022219
--define_symbol xQueuePeekFromISR=0x00022341
--define_symbol xQueueReceive=0x000223ad
--define_symbol xQueueReceiveFromISR=0x000224d9
--define_symbol xQueueRemoveFromSet=0x0002256d
--define_symbol xQueueSelectFromSet=0x0002258f
--define_symbol xQueueSelectFromSetFromISR=0x000225a1
--define_symbol xQueueSemaphoreTake=0x000225b5
--define_symbol xQueueTakeMutexRecursive=0x00022721
--define_symbol xTaskCheckForTimeOut=0x00022765
--define_symbol xTaskCreate=0x000227d5
--define_symbol xTaskCreateStatic=0x00022831
--define_symbol xTaskGetCurrentTaskHandle=0x000228a1
--define_symbol xTaskGetSchedulerState=0x000228ad
--define_symbol xTaskGetTickCount=0x000228c9
--define_symbol xTaskGetTickCountFromISR=0x000228d5
--define_symbol xTaskIncrementTick=0x000228e5
--define_symbol xTaskPriorityDisinherit=0x000229b1
--define_symbol xTaskPriorityInherit=0x00022a45
--define_symbol xTaskRemoveFromEventList=0x00022ad9
--define_symbol xTaskResumeAll=0x00022b59
--define_symbol xTaskResumeFromISR=0x00022c21
--define_symbol xTimerCreate=0x00022cad
--define_symbol xTimerCreateStatic=0x00022ce1
--define_symbol xTimerCreateTimerTask=0x00022d19
--define_symbol xTimerGenericCommand=0x00022d85
--define_symbol xTimerGetExpiryTime=0x00022df5
