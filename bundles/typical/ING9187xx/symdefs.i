...
--define_symbol nibble_for_char=0x0001ced5
--define_symbol platform_32k_rc_auto_tune=0x0001cf71
--define_symbol platform_32k_rc_tune=0x0001cfed
--define_symbol platform_calibrate_32k=0x0001d001
--define_symbol platform_config=0x0001d005
--define_symbol platform_get_heap_status=0x0001d0bd
--define_symbol platform_get_us_time=0x0001d0d5
--define_symbol platform_get_version=0x0001d0d9
--define_symbol platform_hrng=0x0001d0e1
--define_symbol platform_install_isr_stack=0x0001d0e9
--define_symbol platform_patch_rf_init_data=0x0001d0f5
--define_symbol platform_printf=0x0001d101
--define_symbol platform_raise_assertion=0x0001d115
--define_symbol platform_rand=0x0001d129
--define_symbol platform_read_info=0x0001d12d
--define_symbol platform_read_persistent_reg=0x0001d149
--define_symbol platform_reset=0x0001d159
--define_symbol platform_set_evt_callback=0x0001d18d
--define_symbol platform_set_irq_callback=0x0001d1a1
--define_symbol platform_set_rf_clk_source=0x0001d1d9
--define_symbol platform_set_rf_init_data=0x0001d1e5
--define_symbol platform_set_rf_power_mapping=0x0001d1f1
--define_symbol platform_shutdown=0x0001d1fd
--define_symbol platform_switch_app=0x0001d201
--define_symbol platform_trace_raw=0x0001d22d
--define_symbol platform_write_persistent_reg=0x0001d241
--define_symbol printf_hexdump=0x0001d251
--define_symbol pvPortMalloc=0x0001dd1d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001de05
--define_symbol pvTimerGetTimerID=0x0001de1d
--define_symbol pxPortInitialiseStack=0x0001de49
--define_symbol reverse_128=0x0001dff1
--define_symbol reverse_24=0x0001dff7
--define_symbol reverse_48=0x0001dffd
--define_symbol reverse_56=0x0001e003
--define_symbol reverse_64=0x0001e009
--define_symbol reverse_bd_addr=0x0001e00f
--define_symbol reverse_bytes=0x0001e015
--define_symbol sm_add_event_handler=0x0001e181
--define_symbol sm_address_resolution_lookup=0x0001e2ad
--define_symbol sm_authenticated=0x0001e5f9
--define_symbol sm_authorization_decline=0x0001e607
--define_symbol sm_authorization_grant=0x0001e627
--define_symbol sm_authorization_state=0x0001e647
--define_symbol sm_bonding_decline=0x0001e661
--define_symbol sm_config=0x0001ea2d
--define_symbol sm_config_conn=0x0001ea45
--define_symbol sm_encryption_key_size=0x0001eba3
--define_symbol sm_just_works_confirm=0x0001efc9
--define_symbol sm_le_device_key=0x0001f1f5
--define_symbol sm_passkey_input=0x0001f28b
...
--define_symbol sm_register_oob_data_callback=0x0001f749
--define_symbol sm_request_pairing=0x0001f755
--define_symbol sm_send_security_request=0x00020093
--define_symbol sm_set_accepted_stk_generation_methods=0x000200b9
--define_symbol sm_set_authentication_requirements=0x000200c5
--define_symbol sm_set_encryption_key_size_range=0x000200d1
--define_symbol sscanf_bd_addr=0x000203a5
--define_symbol sysSetPublicDeviceAddr=0x000206e9
--define_symbol uuid128_to_str=0x00020c91
--define_symbol uuid_add_bluetooth_prefix=0x00020ce9
--define_symbol uuid_has_bluetooth_prefix=0x00020d09
--define_symbol uxQueueMessagesWaiting=0x00020d4d
--define_symbol uxQueueMessagesWaitingFromISR=0x00020d75
--define_symbol uxQueueSpacesAvailable=0x00020d91
--define_symbol uxTaskGetStackHighWaterMark=0x00020dbd
--define_symbol vPortEnterCritical=0x00020ee1
--define_symbol vPortExitCritical=0x00020f21
--define_symbol vPortFree=0x00020f4d
--define_symbol vPortSuppressTicksAndSleep=0x00020fe1
--define_symbol vPortValidateInterruptPriority=0x000210b9
--define_symbol vQueueDelete=0x0002110d
--define_symbol vQueueWaitForMessageRestricted=0x00021139
--define_symbol vTaskDelay=0x00021181
--define_symbol vTaskInternalSetTimeOutState=0x000211cd
--define_symbol vTaskMissedYield=0x000211dd
--define_symbol vTaskPlaceOnEventList=0x000211e9
--define_symbol vTaskPlaceOnEventListRestricted=0x00021221
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021261
--define_symbol vTaskStartScheduler=0x0002130d
--define_symbol vTaskStepTick=0x0002139d
--define_symbol vTaskSuspendAll=0x000213cd
--define_symbol vTaskSwitchContext=0x000213dd
--define_symbol xPortStartScheduler=0x00021485
--define_symbol xQueueAddToSet=0x00021541
--define_symbol xQueueCreateCountingSemaphore=0x00021565
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000215a1
--define_symbol xQueueCreateMutex=0x000215e5
--define_symbol xQueueCreateMutexStatic=0x000215fb
--define_symbol xQueueCreateSet=0x00021615
--define_symbol xQueueGenericCreate=0x0002161d
--define_symbol xQueueGenericCreateStatic=0x00021669
--define_symbol xQueueGenericReset=0x000216d1
--define_symbol xQueueGenericSend=0x0002175d
--define_symbol xQueueGenericSendFromISR=0x000218c9
--define_symbol xQueueGiveFromISR=0x00021989
--define_symbol xQueueGiveMutexRecursive=0x00021a2d
--define_symbol xQueueIsQueueEmptyFromISR=0x00021a6d
--define_symbol xQueueIsQueueFullFromISR=0x00021a91
--define_symbol xQueuePeek=0x00021ab9
--define_symbol xQueuePeekFromISR=0x00021be1
--define_symbol xQueueReceive=0x00021c4d
--define_symbol xQueueReceiveFromISR=0x00021d79
--define_symbol xQueueRemoveFromSet=0x00021e0d
--define_symbol xQueueSelectFromSet=0x00021e2f
--define_symbol xQueueSelectFromSetFromISR=0x00021e41
--define_symbol xQueueSemaphoreTake=0x00021e55
--define_symbol xQueueTakeMutexRecursive=0x00021fc1
--define_symbol xTaskCheckForTimeOut=0x00022005
--define_symbol xTaskCreate=0x00022075
--define_symbol xTaskCreateStatic=0x000220d1
--define_symbol xTaskGetCurrentTaskHandle=0x00022141
--define_symbol xTaskGetSchedulerState=0x0002214d
--define_symbol xTaskGetTickCount=0x00022169
--define_symbol xTaskGetTickCountFromISR=0x00022175
--define_symbol xTaskIncrementTick=0x00022185
--define_symbol xTaskPriorityDisinherit=0x00022251
--define_symbol xTaskPriorityInherit=0x000222e5
--define_symbol xTaskRemoveFromEventList=0x00022379
--define_symbol xTaskResumeAll=0x000223f9
--define_symbol xTimerCreate=0x000224c1
--define_symbol xTimerCreateStatic=0x000224f5
--define_symbol xTimerCreateTimerTask=0x0002252d
--define_symbol xTimerGenericCommand=0x00022599
--define_symbol xTimerGetExpiryTime=0x00022609
