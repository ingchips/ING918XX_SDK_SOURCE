...
--define_symbol nibble_for_char=0x0001cec9
--define_symbol platform_32k_rc_auto_tune=0x0001cf65
--define_symbol platform_32k_rc_tune=0x0001cfe1
--define_symbol platform_calibrate_32k=0x0001cff5
--define_symbol platform_config=0x0001cff9
--define_symbol platform_get_heap_status=0x0001d0cd
--define_symbol platform_get_task_handle=0x0001d0e5
--define_symbol platform_get_us_time=0x0001d105
--define_symbol platform_get_version=0x0001d109
--define_symbol platform_hrng=0x0001d111
--define_symbol platform_install_isr_stack=0x0001d119
--define_symbol platform_patch_rf_init_data=0x0001d125
--define_symbol platform_printf=0x0001d131
--define_symbol platform_raise_assertion=0x0001d145
--define_symbol platform_rand=0x0001d159
--define_symbol platform_read_info=0x0001d15d
--define_symbol platform_read_persistent_reg=0x0001d179
--define_symbol platform_reset=0x0001d189
--define_symbol platform_set_evt_callback=0x0001d1bd
--define_symbol platform_set_irq_callback=0x0001d1d1
--define_symbol platform_set_rf_clk_source=0x0001d209
--define_symbol platform_set_rf_init_data=0x0001d215
--define_symbol platform_set_rf_power_mapping=0x0001d221
--define_symbol platform_set_timer=0x0001d22d
--define_symbol platform_shutdown=0x0001d231
--define_symbol platform_switch_app=0x0001d235
--define_symbol platform_trace_raw=0x0001d261
--define_symbol platform_write_persistent_reg=0x0001d279
--define_symbol printf_hexdump=0x0001d289
--define_symbol pvPortMalloc=0x0001dd91
--define_symbol pvTaskIncrementMutexHeldCount=0x0001de79
--define_symbol pvTimerGetTimerID=0x0001de91
--define_symbol pxPortInitialiseStack=0x0001debd
--define_symbol reverse_128=0x0001e065
--define_symbol reverse_24=0x0001e06b
--define_symbol reverse_48=0x0001e071
--define_symbol reverse_56=0x0001e077
--define_symbol reverse_64=0x0001e07d
--define_symbol reverse_bd_addr=0x0001e083
--define_symbol reverse_bytes=0x0001e089
--define_symbol sm_add_event_handler=0x0001e1f5
--define_symbol sm_address_resolution_lookup=0x0001e34d
--define_symbol sm_authenticated=0x0001e6a5
--define_symbol sm_authorization_decline=0x0001e6b3
--define_symbol sm_authorization_grant=0x0001e6d3
--define_symbol sm_authorization_state=0x0001e6f3
--define_symbol sm_bonding_decline=0x0001e70d
--define_symbol sm_config=0x0001eb2d
--define_symbol sm_config_conn=0x0001eb45
--define_symbol sm_encryption_key_size=0x0001ecfb
--define_symbol sm_just_works_confirm=0x0001f235
--define_symbol sm_le_device_key=0x0001f571
--define_symbol sm_passkey_input=0x0001f607
--define_symbol sm_private_random_address_generation_get=0x0001f9b5
--define_symbol sm_private_random_address_generation_get_mode=0x0001f9bd
--define_symbol sm_private_random_address_generation_set_mode=0x0001f9c9
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f9f1
--define_symbol sm_register_oob_data_callback=0x0001fb2d
--define_symbol sm_request_pairing=0x0001fb39
--define_symbol sm_send_security_request=0x00020557
--define_symbol sm_set_accepted_stk_generation_methods=0x0002057d
--define_symbol sm_set_authentication_requirements=0x00020589
--define_symbol sm_set_encryption_key_size_range=0x00020595
--define_symbol sscanf_bd_addr=0x000208f1
--define_symbol sysSetPublicDeviceAddr=0x00020c59
--define_symbol uuid128_to_str=0x0002123d
--define_symbol uuid_add_bluetooth_prefix=0x00021295
--define_symbol uuid_has_bluetooth_prefix=0x000212b5
--define_symbol uxListRemove=0x000212d1
--define_symbol uxQueueMessagesWaiting=0x000212f9
--define_symbol uxQueueMessagesWaitingFromISR=0x00021321
--define_symbol uxQueueSpacesAvailable=0x0002133d
--define_symbol uxTaskGetStackHighWaterMark=0x00021369
--define_symbol uxTaskPriorityGet=0x00021389
--define_symbol uxTaskPriorityGetFromISR=0x000213a5
--define_symbol vListInitialise=0x00021457
--define_symbol vListInitialiseItem=0x0002146d
--define_symbol vListInsert=0x00021473
--define_symbol vListInsertEnd=0x000214a3
--define_symbol vPortEndScheduler=0x000214bd
--define_symbol vPortEnterCritical=0x000214e5
--define_symbol vPortExitCritical=0x00021529
--define_symbol vPortFree=0x00021559
--define_symbol vPortSuppressTicksAndSleep=0x000215ed
--define_symbol vPortValidateInterruptPriority=0x000216f5
--define_symbol vQueueDelete=0x0002174d
--define_symbol vQueueWaitForMessageRestricted=0x00021779
--define_symbol vTaskDelay=0x000217c1
--define_symbol vTaskInternalSetTimeOutState=0x0002180d
--define_symbol vTaskMissedYield=0x0002181d
--define_symbol vTaskPlaceOnEventList=0x00021829
--define_symbol vTaskPlaceOnEventListRestricted=0x00021861
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218a1
--define_symbol vTaskPrioritySet=0x0002194d
--define_symbol vTaskResume=0x00021a15
--define_symbol vTaskStartScheduler=0x00021a99
--define_symbol vTaskStepTick=0x00021b29
--define_symbol vTaskSuspend=0x00021b59
--define_symbol vTaskSuspendAll=0x00021c15
--define_symbol vTaskSwitchContext=0x00021c25
--define_symbol xPortStartScheduler=0x00021ccd
--define_symbol xQueueAddToSet=0x00021d8d
--define_symbol xQueueCreateCountingSemaphore=0x00021db1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021ded
--define_symbol xQueueCreateMutex=0x00021e31
--define_symbol xQueueCreateMutexStatic=0x00021e47
--define_symbol xQueueCreateSet=0x00021e61
--define_symbol xQueueGenericCreate=0x00021e69
--define_symbol xQueueGenericCreateStatic=0x00021eb5
--define_symbol xQueueGenericReset=0x00021f1d
--define_symbol xQueueGenericSend=0x00021fa9
--define_symbol xQueueGenericSendFromISR=0x00022115
--define_symbol xQueueGiveFromISR=0x000221d5
--define_symbol xQueueGiveMutexRecursive=0x00022279
--define_symbol xQueueIsQueueEmptyFromISR=0x000222b9
--define_symbol xQueueIsQueueFullFromISR=0x000222dd
--define_symbol xQueuePeek=0x00022305
--define_symbol xQueuePeekFromISR=0x0002242d
--define_symbol xQueueReceive=0x00022499
--define_symbol xQueueReceiveFromISR=0x000225c5
--define_symbol xQueueRemoveFromSet=0x00022659
--define_symbol xQueueSelectFromSet=0x0002267b
--define_symbol xQueueSelectFromSetFromISR=0x0002268d
--define_symbol xQueueSemaphoreTake=0x000226a1
--define_symbol xQueueTakeMutexRecursive=0x0002280d
--define_symbol xTaskCheckForTimeOut=0x00022851
--define_symbol xTaskCreate=0x000228c1
--define_symbol xTaskCreateStatic=0x0002291d
--define_symbol xTaskGetCurrentTaskHandle=0x0002298d
--define_symbol xTaskGetSchedulerState=0x00022999
--define_symbol xTaskGetTickCount=0x000229b5
--define_symbol xTaskGetTickCountFromISR=0x000229c1
--define_symbol xTaskIncrementTick=0x000229d1
--define_symbol xTaskPriorityDisinherit=0x00022a9d
--define_symbol xTaskPriorityInherit=0x00022b31
--define_symbol xTaskRemoveFromEventList=0x00022bc5
--define_symbol xTaskResumeAll=0x00022c45
--define_symbol xTaskResumeFromISR=0x00022d0d
--define_symbol xTimerCreate=0x00022d99
--define_symbol xTimerCreateStatic=0x00022dcd
--define_symbol xTimerCreateTimerTask=0x00022e05
--define_symbol xTimerGenericCommand=0x00022e71
--define_symbol xTimerGetExpiryTime=0x00022ee1
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00022f01
