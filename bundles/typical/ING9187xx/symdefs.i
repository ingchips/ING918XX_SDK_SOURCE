...
--define_symbol sm_just_works_confirm=0x0001f1f5
--define_symbol sm_le_device_key=0x0001f531
--define_symbol sm_passkey_input=0x0001f5c7
--define_symbol sm_private_random_address_generation_get=0x0001f975
--define_symbol sm_private_random_address_generation_get_mode=0x0001f97d
--define_symbol sm_private_random_address_generation_set_mode=0x0001f989
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f9b1
--define_symbol sm_register_oob_data_callback=0x0001faed
--define_symbol sm_request_pairing=0x0001faf9
--define_symbol sm_send_security_request=0x00020517
--define_symbol sm_set_accepted_stk_generation_methods=0x0002053d
--define_symbol sm_set_authentication_requirements=0x00020549
--define_symbol sm_set_encryption_key_size_range=0x00020555
--define_symbol sscanf_bd_addr=0x000208b1
--define_symbol sysSetPublicDeviceAddr=0x00020c19
...
--define_symbol uxListRemove=0x00021291
--define_symbol uxQueueMessagesWaiting=0x000212b9
--define_symbol uxQueueMessagesWaitingFromISR=0x000212e1
--define_symbol uxQueueSpacesAvailable=0x000212fd
--define_symbol uxTaskGetStackHighWaterMark=0x00021329
--define_symbol uxTaskPriorityGet=0x00021349
--define_symbol uxTaskPriorityGetFromISR=0x00021365
--define_symbol vListInitialise=0x00021417
--define_symbol vListInitialiseItem=0x0002142d
--define_symbol vListInsert=0x00021433
--define_symbol vListInsertEnd=0x00021463
--define_symbol vPortEndScheduler=0x0002147d
...
--define_symbol vPortValidateInterruptPriority=0x000216b5
--define_symbol vQueueDelete=0x0002170d
--define_symbol vQueueWaitForMessageRestricted=0x00021739
--define_symbol vTaskDelay=0x00021781
--define_symbol vTaskInternalSetTimeOutState=0x000217cd
--define_symbol vTaskMissedYield=0x000217dd
--define_symbol vTaskPlaceOnEventList=0x000217e9
--define_symbol vTaskPlaceOnEventListRestricted=0x00021821
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021861
--define_symbol vTaskPrioritySet=0x0002190d
--define_symbol vTaskResume=0x000219d5
--define_symbol vTaskStartScheduler=0x00021a59
--define_symbol vTaskStepTick=0x00021ae9
--define_symbol vTaskSuspend=0x00021b19
--define_symbol vTaskSuspendAll=0x00021bd5
--define_symbol vTaskSwitchContext=0x00021be5
--define_symbol xPortStartScheduler=0x00021c8d
...
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00022ec1
