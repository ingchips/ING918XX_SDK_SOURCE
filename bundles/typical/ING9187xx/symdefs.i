...
--define_symbol nibble_for_char=0x0001cf75
...
--define_symbol platform_get_heap_status=0x0001d15d
--define_symbol platform_get_us_time=0x0001d175
--define_symbol platform_get_version=0x0001d179
--define_symbol platform_hrng=0x0001d181
--define_symbol platform_install_isr_stack=0x0001d189
--define_symbol platform_patch_rf_init_data=0x0001d195
--define_symbol platform_printf=0x0001d1a1
--define_symbol platform_raise_assertion=0x0001d1b5
--define_symbol platform_rand=0x0001d1c9
--define_symbol platform_read_info=0x0001d1cd
--define_symbol platform_read_persistent_reg=0x0001d1e9
--define_symbol platform_reset=0x0001d1f9
--define_symbol platform_set_evt_callback=0x0001d22d
--define_symbol platform_set_irq_callback=0x0001d241
--define_symbol platform_set_rf_clk_source=0x0001d279
--define_symbol platform_set_rf_init_data=0x0001d285
--define_symbol platform_set_rf_power_mapping=0x0001d291
--define_symbol platform_shutdown=0x0001d29d
--define_symbol platform_switch_app=0x0001d2a1
--define_symbol platform_trace_raw=0x0001d2cd
--define_symbol platform_write_persistent_reg=0x0001d2e1
--define_symbol printf_hexdump=0x0001d2f1
--define_symbol pvPortMalloc=0x0001ddf5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dedd
--define_symbol pvTimerGetTimerID=0x0001def5
--define_symbol pxPortInitialiseStack=0x0001df21
--define_symbol reverse_128=0x0001e0c9
--define_symbol reverse_24=0x0001e0cf
--define_symbol reverse_48=0x0001e0d5
--define_symbol reverse_56=0x0001e0db
--define_symbol reverse_64=0x0001e0e1
--define_symbol reverse_bd_addr=0x0001e0e7
--define_symbol reverse_bytes=0x0001e0ed
--define_symbol sm_add_event_handler=0x0001e259
--define_symbol sm_address_resolution_lookup=0x0001e385
--define_symbol sm_authenticated=0x0001e6d1
--define_symbol sm_authorization_decline=0x0001e6df
--define_symbol sm_authorization_grant=0x0001e6ff
--define_symbol sm_authorization_state=0x0001e71f
--define_symbol sm_bonding_decline=0x0001e739
--define_symbol sm_config=0x0001eb05
--define_symbol sm_config_conn=0x0001eb1d
--define_symbol sm_encryption_key_size=0x0001ec7b
--define_symbol sm_just_works_confirm=0x0001f0a1
--define_symbol sm_le_device_key=0x0001f2cd
--define_symbol sm_passkey_input=0x0001f363
--define_symbol sm_private_random_address_generation_get=0x0001f6a9
--define_symbol sm_private_random_address_generation_get_mode=0x0001f6b1
--define_symbol sm_private_random_address_generation_set_mode=0x0001f6bd
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f6e5
--define_symbol sm_register_oob_data_callback=0x0001f821
--define_symbol sm_request_pairing=0x0001f82d
--define_symbol sm_send_security_request=0x0002016b
--define_symbol sm_set_accepted_stk_generation_methods=0x00020191
--define_symbol sm_set_authentication_requirements=0x0002019d
--define_symbol sm_set_encryption_key_size_range=0x000201a9
--define_symbol sscanf_bd_addr=0x0002047d
--define_symbol sysSetPublicDeviceAddr=0x000207c1
--define_symbol uuid128_to_str=0x00020d99
--define_symbol uuid_add_bluetooth_prefix=0x00020df1
--define_symbol uuid_has_bluetooth_prefix=0x00020e11
--define_symbol uxQueueMessagesWaiting=0x00020e55
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e7d
--define_symbol uxQueueSpacesAvailable=0x00020e99
--define_symbol uxTaskGetStackHighWaterMark=0x00020ec5
--define_symbol vPortEnterCritical=0x00020fe9
--define_symbol vPortExitCritical=0x00021029
--define_symbol vPortFree=0x00021055
--define_symbol vPortSuppressTicksAndSleep=0x000210e9
--define_symbol vPortValidateInterruptPriority=0x000211c1
--define_symbol vQueueDelete=0x00021215
--define_symbol vQueueWaitForMessageRestricted=0x00021241
--define_symbol vTaskDelay=0x00021289
--define_symbol vTaskInternalSetTimeOutState=0x000212d5
--define_symbol vTaskMissedYield=0x000212e5
--define_symbol vTaskPlaceOnEventList=0x000212f1
--define_symbol vTaskPlaceOnEventListRestricted=0x00021329
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021369
--define_symbol vTaskResume=0x00021415
--define_symbol vTaskStartScheduler=0x00021499
--define_symbol vTaskStepTick=0x00021529
--define_symbol vTaskSuspend=0x00021559
--define_symbol vTaskSuspendAll=0x00021615
--define_symbol vTaskSwitchContext=0x00021625
--define_symbol xPortStartScheduler=0x000216cd
--define_symbol xQueueAddToSet=0x00021789
--define_symbol xQueueCreateCountingSemaphore=0x000217ad
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000217e9
--define_symbol xQueueCreateMutex=0x0002182d
--define_symbol xQueueCreateMutexStatic=0x00021843
--define_symbol xQueueCreateSet=0x0002185d
...
--define_symbol xQueueGiveMutexRecursive=0x00021c75
--define_symbol xQueueIsQueueEmptyFromISR=0x00021cb5
--define_symbol xQueueIsQueueFullFromISR=0x00021cd9
--define_symbol xQueuePeek=0x00021d01
--define_symbol xQueuePeekFromISR=0x00021e29
--define_symbol xQueueReceive=0x00021e95
--define_symbol xQueueReceiveFromISR=0x00021fc1
--define_symbol xQueueRemoveFromSet=0x00022055
--define_symbol xQueueSelectFromSet=0x00022077
--define_symbol xQueueSelectFromSetFromISR=0x00022089
--define_symbol xQueueSemaphoreTake=0x0002209d
--define_symbol xQueueTakeMutexRecursive=0x00022209
--define_symbol xTaskCheckForTimeOut=0x0002224d
--define_symbol xTaskCreate=0x000222bd
--define_symbol xTaskCreateStatic=0x00022319
--define_symbol xTaskGetCurrentTaskHandle=0x00022389
--define_symbol xTaskGetSchedulerState=0x00022395
--define_symbol xTaskGetTickCount=0x000223b1
--define_symbol xTaskGetTickCountFromISR=0x000223bd
--define_symbol xTaskIncrementTick=0x000223cd
--define_symbol xTaskPriorityDisinherit=0x00022499
--define_symbol xTaskPriorityInherit=0x0002252d
--define_symbol xTaskRemoveFromEventList=0x000225c1
--define_symbol xTaskResumeAll=0x00022641
--define_symbol xTaskResumeFromISR=0x00022709
--define_symbol xTimerCreate=0x00022795
--define_symbol xTimerCreateStatic=0x000227c9
--define_symbol xTimerCreateTimerTask=0x00022801
--define_symbol xTimerGenericCommand=0x0002286d
--define_symbol xTimerGetExpiryTime=0x000228dd
