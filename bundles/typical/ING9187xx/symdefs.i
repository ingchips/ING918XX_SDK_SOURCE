...
--define_symbol sysSetPublicDeviceAddr=0x000207b5
--define_symbol uuid128_to_str=0x00020d8d
--define_symbol uuid_add_bluetooth_prefix=0x00020de5
--define_symbol uuid_has_bluetooth_prefix=0x00020e05
--define_symbol uxQueueMessagesWaiting=0x00020e49
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e71
--define_symbol uxQueueSpacesAvailable=0x00020e8d
--define_symbol uxTaskGetStackHighWaterMark=0x00020eb9
...
--define_symbol vTaskResume=0x00021409
--define_symbol vTaskStartScheduler=0x0002148d
--define_symbol vTaskStepTick=0x0002151d
--define_symbol vTaskSuspend=0x0002154d
--define_symbol vTaskSuspendAll=0x00021609
--define_symbol vTaskSwitchContext=0x00021619
--define_symbol xPortStartScheduler=0x000216c1
--define_symbol xQueueAddToSet=0x0002177d
--define_symbol xQueueCreateCountingSemaphore=0x000217a1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000217dd
--define_symbol xQueueCreateMutex=0x00021821
--define_symbol xQueueCreateMutexStatic=0x00021837
--define_symbol xQueueCreateSet=0x00021851
--define_symbol xQueueGenericCreate=0x00021859
--define_symbol xQueueGenericCreateStatic=0x000218a5
--define_symbol xQueueGenericReset=0x0002190d
--define_symbol xQueueGenericSend=0x00021999
--define_symbol xQueueGenericSendFromISR=0x00021b05
--define_symbol xQueueGiveFromISR=0x00021bc5
--define_symbol xQueueGiveMutexRecursive=0x00021c69
--define_symbol xQueueIsQueueEmptyFromISR=0x00021ca9
--define_symbol xQueueIsQueueFullFromISR=0x00021ccd
--define_symbol xQueuePeek=0x00021cf5
--define_symbol xQueuePeekFromISR=0x00021e1d
--define_symbol xQueueReceive=0x00021e89
--define_symbol xQueueReceiveFromISR=0x00021fb5
--define_symbol xQueueRemoveFromSet=0x00022049
--define_symbol xQueueSelectFromSet=0x0002206b
--define_symbol xQueueSelectFromSetFromISR=0x0002207d
--define_symbol xQueueSemaphoreTake=0x00022091
--define_symbol xQueueTakeMutexRecursive=0x000221fd
--define_symbol xTaskCheckForTimeOut=0x00022241
--define_symbol xTaskCreate=0x000222b1
--define_symbol xTaskCreateStatic=0x0002230d
--define_symbol xTaskGetCurrentTaskHandle=0x0002237d
--define_symbol xTaskGetSchedulerState=0x00022389
--define_symbol xTaskGetTickCount=0x000223a5
--define_symbol xTaskGetTickCountFromISR=0x000223b1
--define_symbol xTaskIncrementTick=0x000223c1
--define_symbol xTaskPriorityDisinherit=0x0002248d
--define_symbol xTaskPriorityInherit=0x00022521
--define_symbol xTaskRemoveFromEventList=0x000225b5
--define_symbol xTaskResumeAll=0x00022635
--define_symbol xTaskResumeFromISR=0x000226fd
--define_symbol xTimerCreate=0x00022789
--define_symbol xTimerCreateStatic=0x000227bd
--define_symbol xTimerCreateTimerTask=0x000227f5
--define_symbol xTimerGenericCommand=0x00022861
--define_symbol xTimerGetExpiryTime=0x000228d1
