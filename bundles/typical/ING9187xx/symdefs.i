...
--define_symbol platform_32k_rc_auto_tune=0x0001cf9d
--define_symbol platform_32k_rc_tune=0x0001d019
--define_symbol platform_calibrate_32k=0x0001d02d
--define_symbol platform_config=0x0001d031
--define_symbol platform_get_heap_status=0x0001d0e9
--define_symbol platform_get_us_time=0x0001d101
--define_symbol platform_get_version=0x0001d105
--define_symbol platform_hrng=0x0001d10d
--define_symbol platform_install_isr_stack=0x0001d115
--define_symbol platform_patch_rf_init_data=0x0001d121
--define_symbol platform_printf=0x0001d12d
--define_symbol platform_raise_assertion=0x0001d141
--define_symbol platform_rand=0x0001d155
--define_symbol platform_read_info=0x0001d159
--define_symbol platform_read_persistent_reg=0x0001d175
--define_symbol platform_reset=0x0001d185
--define_symbol platform_set_evt_callback=0x0001d1b9
--define_symbol platform_set_irq_callback=0x0001d1cd
--define_symbol platform_set_rf_clk_source=0x0001d205
--define_symbol platform_set_rf_init_data=0x0001d211
--define_symbol platform_set_rf_power_mapping=0x0001d21d
--define_symbol platform_shutdown=0x0001d229
--define_symbol platform_switch_app=0x0001d22d
--define_symbol platform_trace_raw=0x0001d259
...
--define_symbol sm_address_resolution_lookup=0x0001e311
--define_symbol sm_authenticated=0x0001e65d
--define_symbol sm_authorization_decline=0x0001e66b
--define_symbol sm_authorization_grant=0x0001e68b
--define_symbol sm_authorization_state=0x0001e6ab
--define_symbol sm_bonding_decline=0x0001e6c5
--define_symbol sm_config=0x0001ea91
--define_symbol sm_config_conn=0x0001eaa9
--define_symbol sm_encryption_key_size=0x0001ec07
--define_symbol sm_just_works_confirm=0x0001f02d
--define_symbol sm_le_device_key=0x0001f259
--define_symbol sm_passkey_input=0x0001f2ef
--define_symbol sm_private_random_address_generation_get=0x0001f635
--define_symbol sm_private_random_address_generation_get_mode=0x0001f63d
--define_symbol sm_private_random_address_generation_set_mode=0x0001f649
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f671
--define_symbol sm_register_oob_data_callback=0x0001f7ad
--define_symbol sm_request_pairing=0x0001f7b9
--define_symbol sm_send_security_request=0x000200f7
...
--define_symbol sscanf_bd_addr=0x00020409
--define_symbol sysSetPublicDeviceAddr=0x0002074d
--define_symbol uuid128_to_str=0x00020d25
--define_symbol uuid_add_bluetooth_prefix=0x00020d7d
--define_symbol uuid_has_bluetooth_prefix=0x00020d9d
--define_symbol uxQueueMessagesWaiting=0x00020de1
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e09
--define_symbol uxQueueSpacesAvailable=0x00020e25
--define_symbol uxTaskGetStackHighWaterMark=0x00020e51
--define_symbol vPortEnterCritical=0x00020f75
--define_symbol vPortExitCritical=0x00020fb5
--define_symbol vPortFree=0x00020fe1
--define_symbol vPortSuppressTicksAndSleep=0x00021075
--define_symbol vPortValidateInterruptPriority=0x0002114d
--define_symbol vQueueDelete=0x000211a1
--define_symbol vQueueWaitForMessageRestricted=0x000211cd
--define_symbol vTaskDelay=0x00021215
--define_symbol vTaskInternalSetTimeOutState=0x00021261
--define_symbol vTaskMissedYield=0x00021271
--define_symbol vTaskPlaceOnEventList=0x0002127d
--define_symbol vTaskPlaceOnEventListRestricted=0x000212b5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000212f5
--define_symbol vTaskResume=0x000213a1
--define_symbol vTaskStartScheduler=0x00021425
--define_symbol vTaskStepTick=0x000214b5
--define_symbol vTaskSuspend=0x000214e5
--define_symbol vTaskSuspendAll=0x000215a1
--define_symbol vTaskSwitchContext=0x000215b1
--define_symbol xPortStartScheduler=0x00021659
--define_symbol xQueueAddToSet=0x00021715
--define_symbol xQueueCreateCountingSemaphore=0x00021739
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021775
--define_symbol xQueueCreateMutex=0x000217b9
--define_symbol xQueueCreateMutexStatic=0x000217cf
--define_symbol xQueueCreateSet=0x000217e9
--define_symbol xQueueGenericCreate=0x000217f1
--define_symbol xQueueGenericCreateStatic=0x0002183d
--define_symbol xQueueGenericReset=0x000218a5
--define_symbol xQueueGenericSend=0x00021931
--define_symbol xQueueGenericSendFromISR=0x00021a9d
--define_symbol xQueueGiveFromISR=0x00021b5d
--define_symbol xQueueGiveMutexRecursive=0x00021c01
--define_symbol xQueueIsQueueEmptyFromISR=0x00021c41
--define_symbol xQueueIsQueueFullFromISR=0x00021c65
--define_symbol xQueuePeek=0x00021c8d
--define_symbol xQueuePeekFromISR=0x00021db5
--define_symbol xQueueReceive=0x00021e21
--define_symbol xQueueReceiveFromISR=0x00021f4d
--define_symbol xQueueRemoveFromSet=0x00021fe1
--define_symbol xQueueSelectFromSet=0x00022003
--define_symbol xQueueSelectFromSetFromISR=0x00022015
--define_symbol xQueueSemaphoreTake=0x00022029
--define_symbol xQueueTakeMutexRecursive=0x00022195
--define_symbol xTaskCheckForTimeOut=0x000221d9
--define_symbol xTaskCreate=0x00022249
--define_symbol xTaskCreateStatic=0x000222a5
--define_symbol xTaskGetCurrentTaskHandle=0x00022315
--define_symbol xTaskGetSchedulerState=0x00022321
--define_symbol xTaskGetTickCount=0x0002233d
--define_symbol xTaskGetTickCountFromISR=0x00022349
--define_symbol xTaskIncrementTick=0x00022359
--define_symbol xTaskPriorityDisinherit=0x00022425
--define_symbol xTaskPriorityInherit=0x000224b9
--define_symbol xTaskRemoveFromEventList=0x0002254d
--define_symbol xTaskResumeAll=0x000225cd
--define_symbol xTaskResumeFromISR=0x00022695
--define_symbol xTimerCreate=0x00022721
--define_symbol xTimerCreateStatic=0x00022755
--define_symbol xTimerCreateTimerTask=0x0002278d
--define_symbol xTimerGenericCommand=0x000227f9
--define_symbol xTimerGetExpiryTime=0x00022869
