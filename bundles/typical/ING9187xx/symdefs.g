...
pvPortMalloc = 0x0001dcbd;
pvTaskIncrementMutexHeldCount = 0x0001dda5;
pvTimerGetTimerID = 0x0001ddbd;
pxPortInitialiseStack = 0x0001dde9;
reverse_128 = 0x0001df91;
reverse_24 = 0x0001df97;
reverse_48 = 0x0001df9d;
reverse_56 = 0x0001dfa3;
reverse_64 = 0x0001dfa9;
reverse_bd_addr = 0x0001dfaf;
reverse_bytes = 0x0001dfb5;
sm_add_event_handler = 0x0001e121;
sm_address_resolution_lookup = 0x0001e279;
sm_authenticated = 0x0001e5d1;
sm_authorization_decline = 0x0001e5df;
sm_authorization_grant = 0x0001e5ff;
sm_authorization_state = 0x0001e61f;
sm_bonding_decline = 0x0001e639;
sm_config = 0x0001ea59;
sm_config_conn = 0x0001ea71;
sm_encryption_key_size = 0x0001ec27;
...
uxTaskPriorityGet = 0x00021285;
uxTaskPriorityGetFromISR = 0x000212a1;
vListInitialise = 0x00021353;
vListInitialiseItem = 0x00021369;
vListInsert = 0x0002136f;
vListInsertEnd = 0x0002139f;
vPortEndScheduler = 0x000213b9;
vPortEnterCritical = 0x000213e1;
vPortExitCritical = 0x00021425;
vPortFree = 0x00021455;
vPortSuppressTicksAndSleep = 0x000214e9;
...
xQueueAddToSet = 0x00021c89;
xQueueCreateCountingSemaphore = 0x00021cad;
xQueueCreateCountingSemaphoreStatic = 0x00021ce9;
xQueueCreateMutex = 0x00021d2d;
xQueueCreateMutexStatic = 0x00021d43;
xQueueCreateSet = 0x00021d5d;
xQueueGenericCreate = 0x00021d65;
xQueueGenericCreateStatic = 0x00021db1;
xQueueGenericReset = 0x00021e19;
xQueueGenericSend = 0x00021ea5;
xQueueGenericSendFromISR = 0x00022011;
xQueueGiveFromISR = 0x000220d1;
xQueueGiveMutexRecursive = 0x00022175;
xQueueIsQueueEmptyFromISR = 0x000221b5;
xQueueIsQueueFullFromISR = 0x000221d9;
xQueuePeek = 0x00022201;
xQueuePeekFromISR = 0x00022329;
xQueueReceive = 0x00022395;
xQueueReceiveFromISR = 0x000224c1;
xQueueRemoveFromSet = 0x00022555;
xQueueSelectFromSet = 0x00022577;
xQueueSelectFromSetFromISR = 0x00022589;
xQueueSemaphoreTake = 0x0002259d;
xQueueTakeMutexRecursive = 0x00022709;
xTaskCheckForTimeOut = 0x0002274d;
xTaskCreate = 0x000227bd;
xTaskCreateStatic = 0x00022819;
xTaskGetCurrentTaskHandle = 0x00022889;
xTaskGetSchedulerState = 0x00022895;
xTaskGetTickCount = 0x000228b1;
xTaskGetTickCountFromISR = 0x000228bd;
xTaskIncrementTick = 0x000228cd;
xTaskPriorityDisinherit = 0x00022999;
xTaskPriorityInherit = 0x00022a2d;
xTaskRemoveFromEventList = 0x00022ac1;
xTaskResumeAll = 0x00022b41;
xTaskResumeFromISR = 0x00022c09;
xTimerCreate = 0x00022c95;
xTimerCreateStatic = 0x00022cc9;
xTimerCreateTimerTask = 0x00022d01;
xTimerGenericCommand = 0x00022d6d;
xTimerGetExpiryTime = 0x00022ddd;
xTimerGetTimerDaemonTaskHandle = 0x00022dfd;
