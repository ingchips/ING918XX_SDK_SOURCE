...
nibble_for_char = 0x0001ced5;
platform_32k_rc_auto_tune = 0x0001cf71;
platform_32k_rc_tune = 0x0001cfed;
platform_calibrate_32k = 0x0001d001;
platform_config = 0x0001d005;
platform_get_heap_status = 0x0001d0bd;
platform_get_us_time = 0x0001d0d5;
platform_get_version = 0x0001d0d9;
platform_hrng = 0x0001d0e1;
platform_install_isr_stack = 0x0001d0e9;
platform_patch_rf_init_data = 0x0001d0f5;
platform_printf = 0x0001d101;
platform_raise_assertion = 0x0001d115;
platform_rand = 0x0001d129;
platform_read_info = 0x0001d12d;
platform_read_persistent_reg = 0x0001d149;
platform_reset = 0x0001d159;
platform_set_evt_callback = 0x0001d18d;
platform_set_irq_callback = 0x0001d1a1;
platform_set_rf_clk_source = 0x0001d1d9;
platform_set_rf_init_data = 0x0001d1e5;
platform_set_rf_power_mapping = 0x0001d1f1;
platform_shutdown = 0x0001d1fd;
platform_switch_app = 0x0001d201;
platform_trace_raw = 0x0001d22d;
platform_write_persistent_reg = 0x0001d241;
printf_hexdump = 0x0001d251;
pvPortMalloc = 0x0001dd1d;
pvTaskIncrementMutexHeldCount = 0x0001de05;
pvTimerGetTimerID = 0x0001de1d;
pxPortInitialiseStack = 0x0001de49;
reverse_128 = 0x0001dff1;
reverse_24 = 0x0001dff7;
reverse_48 = 0x0001dffd;
reverse_56 = 0x0001e003;
reverse_64 = 0x0001e009;
reverse_bd_addr = 0x0001e00f;
reverse_bytes = 0x0001e015;
sm_add_event_handler = 0x0001e181;
sm_address_resolution_lookup = 0x0001e2ad;
sm_authenticated = 0x0001e5f9;
sm_authorization_decline = 0x0001e607;
sm_authorization_grant = 0x0001e627;
sm_authorization_state = 0x0001e647;
sm_bonding_decline = 0x0001e661;
sm_config = 0x0001ea2d;
sm_config_conn = 0x0001ea45;
sm_encryption_key_size = 0x0001eba3;
sm_just_works_confirm = 0x0001efc9;
...
sm_register_oob_data_callback = 0x0001f749;
sm_request_pairing = 0x0001f755;
sm_send_security_request = 0x00020093;
sm_set_accepted_stk_generation_methods = 0x000200b9;
sm_set_authentication_requirements = 0x000200c5;
sm_set_encryption_key_size_range = 0x000200d1;
sscanf_bd_addr = 0x000203a5;
sysSetPublicDeviceAddr = 0x000206e9;
uuid128_to_str = 0x00020c91;
uuid_add_bluetooth_prefix = 0x00020ce9;
uuid_has_bluetooth_prefix = 0x00020d09;
uxQueueMessagesWaiting = 0x00020d4d;
uxQueueMessagesWaitingFromISR = 0x00020d75;
uxQueueSpacesAvailable = 0x00020d91;
uxTaskGetStackHighWaterMark = 0x00020dbd;
vPortEnterCritical = 0x00020ee1;
vPortExitCritical = 0x00020f21;
vPortFree = 0x00020f4d;
vPortSuppressTicksAndSleep = 0x00020fe1;
vPortValidateInterruptPriority = 0x000210b9;
vQueueDelete = 0x0002110d;
vQueueWaitForMessageRestricted = 0x00021139;
vTaskDelay = 0x00021181;
vTaskInternalSetTimeOutState = 0x000211cd;
vTaskMissedYield = 0x000211dd;
vTaskPlaceOnEventList = 0x000211e9;
vTaskPlaceOnEventListRestricted = 0x00021221;
vTaskPriorityDisinheritAfterTimeout = 0x00021261;
vTaskStartScheduler = 0x0002130d;
vTaskStepTick = 0x0002139d;
vTaskSuspendAll = 0x000213cd;
vTaskSwitchContext = 0x000213dd;
xPortStartScheduler = 0x00021485;
xQueueAddToSet = 0x00021541;
xQueueCreateCountingSemaphore = 0x00021565;
xQueueCreateCountingSemaphoreStatic = 0x000215a1;
xQueueCreateMutex = 0x000215e5;
xQueueCreateMutexStatic = 0x000215fb;
xQueueCreateSet = 0x00021615;
xQueueGenericCreate = 0x0002161d;
xQueueGenericCreateStatic = 0x00021669;
xQueueGenericReset = 0x000216d1;
xQueueGenericSend = 0x0002175d;
xQueueGenericSendFromISR = 0x000218c9;
xQueueGiveFromISR = 0x00021989;
xQueueGiveMutexRecursive = 0x00021a2d;
xQueueIsQueueEmptyFromISR = 0x00021a6d;
xQueueIsQueueFullFromISR = 0x00021a91;
xQueuePeek = 0x00021ab9;
xQueuePeekFromISR = 0x00021be1;
xQueueReceive = 0x00021c4d;
xQueueReceiveFromISR = 0x00021d79;
xQueueRemoveFromSet = 0x00021e0d;
xQueueSelectFromSet = 0x00021e2f;
xQueueSelectFromSetFromISR = 0x00021e41;
xQueueSemaphoreTake = 0x00021e55;
xQueueTakeMutexRecursive = 0x00021fc1;
xTaskCheckForTimeOut = 0x00022005;
xTaskCreate = 0x00022075;
xTaskCreateStatic = 0x000220d1;
xTaskGetCurrentTaskHandle = 0x00022141;
xTaskGetSchedulerState = 0x0002214d;
xTaskGetTickCount = 0x00022169;
xTaskGetTickCountFromISR = 0x00022175;
xTaskIncrementTick = 0x00022185;
xTaskPriorityDisinherit = 0x00022251;
xTaskPriorityInherit = 0x000222e5;
xTaskRemoveFromEventList = 0x00022379;
xTaskResumeAll = 0x000223f9;
xTimerCreate = 0x000224c1;
xTimerCreateStatic = 0x000224f5;
xTimerCreateTimerTask = 0x0002252d;
xTimerGenericCommand = 0x00022599;
xTimerGetExpiryTime = 0x00022609;
