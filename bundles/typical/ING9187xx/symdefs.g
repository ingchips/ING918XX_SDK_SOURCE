...
sysSetPublicDeviceAddr = 0x000207c1;
uuid128_to_str = 0x00020d99;
uuid_add_bluetooth_prefix = 0x00020df1;
uuid_has_bluetooth_prefix = 0x00020e11;
uxQueueMessagesWaiting = 0x00020e55;
uxQueueMessagesWaitingFromISR = 0x00020e7d;
uxQueueSpacesAvailable = 0x00020e99;
uxTaskGetStackHighWaterMark = 0x00020ec5;
vPortEnterCritical = 0x00020fe9;
vPortExitCritical = 0x00021029;
vPortFree = 0x00021055;
vPortSuppressTicksAndSleep = 0x000210e9;
vPortValidateInterruptPriority = 0x000211c1;
vQueueDelete = 0x00021215;
vQueueWaitForMessageRestricted = 0x00021241;
vTaskDelay = 0x00021289;
vTaskInternalSetTimeOutState = 0x000212d5;
vTaskMissedYield = 0x000212e5;
vTaskPlaceOnEventList = 0x000212f1;
vTaskPlaceOnEventListRestricted = 0x00021329;
vTaskPriorityDisinheritAfterTimeout = 0x00021369;
vTaskResume = 0x00021415;
vTaskStartScheduler = 0x00021499;
vTaskStepTick = 0x00021529;
vTaskSuspend = 0x00021559;
vTaskSuspendAll = 0x00021615;
vTaskSwitchContext = 0x00021625;
xPortStartScheduler = 0x000216cd;
xQueueAddToSet = 0x00021789;
xQueueCreateCountingSemaphore = 0x000217ad;
xQueueCreateCountingSemaphoreStatic = 0x000217e9;
xQueueCreateMutex = 0x0002182d;
xQueueCreateMutexStatic = 0x00021843;
xQueueCreateSet = 0x0002185d;
...
xQueueGiveMutexRecursive = 0x00021c75;
xQueueIsQueueEmptyFromISR = 0x00021cb5;
xQueueIsQueueFullFromISR = 0x00021cd9;
xQueuePeek = 0x00021d01;
xQueuePeekFromISR = 0x00021e29;
xQueueReceive = 0x00021e95;
xQueueReceiveFromISR = 0x00021fc1;
xQueueRemoveFromSet = 0x00022055;
xQueueSelectFromSet = 0x00022077;
xQueueSelectFromSetFromISR = 0x00022089;
xQueueSemaphoreTake = 0x0002209d;
xQueueTakeMutexRecursive = 0x00022209;
xTaskCheckForTimeOut = 0x0002224d;
xTaskCreate = 0x000222bd;
xTaskCreateStatic = 0x00022319;
xTaskGetCurrentTaskHandle = 0x00022389;
xTaskGetSchedulerState = 0x00022395;
xTaskGetTickCount = 0x000223b1;
xTaskGetTickCountFromISR = 0x000223bd;
xTaskIncrementTick = 0x000223cd;
xTaskPriorityDisinherit = 0x00022499;
xTaskPriorityInherit = 0x0002252d;
xTaskRemoveFromEventList = 0x000225c1;
xTaskResumeAll = 0x00022641;
xTaskResumeFromISR = 0x00022709;
xTimerCreate = 0x00022795;
xTimerCreateStatic = 0x000227c9;
xTimerCreateTimerTask = 0x00022801;
xTimerGenericCommand = 0x0002286d;
xTimerGetExpiryTime = 0x000228dd;
