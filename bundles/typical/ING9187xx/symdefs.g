...
sm_just_works_confirm = 0x0001efad;
sm_le_device_key = 0x0001f205;
sm_passkey_input = 0x0001f29d;
sm_private_random_address_generation_get = 0x0001f629;
sm_private_random_address_generation_get_mode = 0x0001f631;
sm_private_random_address_generation_set_mode = 0x0001f63d;
sm_private_random_address_generation_set_update_period = 0x0001f665;
sm_register_oob_data_callback = 0x0001f69d;
sm_request_pairing = 0x0001f6a9;
sm_send_security_request = 0x000200f9;
sm_set_accepted_stk_generation_methods = 0x00020121;
sm_set_authentication_requirements = 0x0002012d;
sm_set_encryption_key_size_range = 0x00020139;
sscanf_bd_addr = 0x00020429;
sysSetPublicDeviceAddr = 0x00020755;
