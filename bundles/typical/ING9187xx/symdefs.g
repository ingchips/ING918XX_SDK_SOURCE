...
platform_get_heap_status = 0x0001d15d;
platform_get_us_time = 0x0001d175;
platform_get_version = 0x0001d179;
platform_hrng = 0x0001d181;
platform_install_isr_stack = 0x0001d189;
platform_patch_rf_init_data = 0x0001d195;
platform_printf = 0x0001d1a1;
platform_raise_assertion = 0x0001d1b5;
platform_rand = 0x0001d1c9;
platform_read_info = 0x0001d1cd;
platform_read_persistent_reg = 0x0001d1e9;
platform_reset = 0x0001d1f9;
platform_set_evt_callback = 0x0001d22d;
platform_set_irq_callback = 0x0001d241;
platform_set_rf_clk_source = 0x0001d279;
platform_set_rf_init_data = 0x0001d285;
platform_set_rf_power_mapping = 0x0001d291;
platform_shutdown = 0x0001d29d;
platform_switch_app = 0x0001d2a1;
platform_trace_raw = 0x0001d2cd;
platform_write_persistent_reg = 0x0001d2e1;
printf_hexdump = 0x0001d2f1;
pvPortMalloc = 0x0001ddf5;
pvTaskIncrementMutexHeldCount = 0x0001dedd;
pvTimerGetTimerID = 0x0001def5;
pxPortInitialiseStack = 0x0001df21;
reverse_128 = 0x0001e0c9;
reverse_24 = 0x0001e0cf;
reverse_48 = 0x0001e0d5;
reverse_56 = 0x0001e0db;
reverse_64 = 0x0001e0e1;
reverse_bd_addr = 0x0001e0e7;
reverse_bytes = 0x0001e0ed;
sm_add_event_handler = 0x0001e259;
sm_address_resolution_lookup = 0x0001e385;
sm_authenticated = 0x0001e6d1;
sm_authorization_decline = 0x0001e6df;
sm_authorization_grant = 0x0001e6ff;
sm_authorization_state = 0x0001e71f;
sm_bonding_decline = 0x0001e739;
sm_config = 0x0001eb05;
sm_config_conn = 0x0001eb1d;
sm_encryption_key_size = 0x0001ec7b;
sm_just_works_confirm = 0x0001f0a1;
sm_le_device_key = 0x0001f2cd;
sm_passkey_input = 0x0001f363;
sm_private_random_address_generation_get = 0x0001f6a9;
sm_private_random_address_generation_get_mode = 0x0001f6b1;
sm_private_random_address_generation_set_mode = 0x0001f6bd;
sm_private_random_address_generation_set_update_period = 0x0001f6e5;
sm_register_oob_data_callback = 0x0001f821;
sm_request_pairing = 0x0001f82d;
sm_send_security_request = 0x0002016b;
sm_set_accepted_stk_generation_methods = 0x00020191;
sm_set_authentication_requirements = 0x0002019d;
sm_set_encryption_key_size_range = 0x000201a9;
sscanf_bd_addr = 0x0002047d;
sysSetPublicDeviceAddr = 0x000207b5;
uuid128_to_str = 0x00020d8d;
uuid_add_bluetooth_prefix = 0x00020de5;
uuid_has_bluetooth_prefix = 0x00020e05;
uxQueueMessagesWaiting = 0x00020e49;
uxQueueMessagesWaitingFromISR = 0x00020e71;
uxQueueSpacesAvailable = 0x00020e8d;
uxTaskGetStackHighWaterMark = 0x00020eb9;
...
vTaskResume = 0x00021409;
vTaskStartScheduler = 0x0002148d;
vTaskStepTick = 0x0002151d;
vTaskSuspend = 0x0002154d;
vTaskSuspendAll = 0x00021609;
vTaskSwitchContext = 0x00021619;
xPortStartScheduler = 0x000216c1;
xQueueAddToSet = 0x0002177d;
xQueueCreateCountingSemaphore = 0x000217a1;
xQueueCreateCountingSemaphoreStatic = 0x000217dd;
xQueueCreateMutex = 0x00021821;
xQueueCreateMutexStatic = 0x00021837;
xQueueCreateSet = 0x00021851;
xQueueGenericCreate = 0x00021859;
xQueueGenericCreateStatic = 0x000218a5;
xQueueGenericReset = 0x0002190d;
xQueueGenericSend = 0x00021999;
xQueueGenericSendFromISR = 0x00021b05;
xQueueGiveFromISR = 0x00021bc5;
xQueueGiveMutexRecursive = 0x00021c69;
xQueueIsQueueEmptyFromISR = 0x00021ca9;
xQueueIsQueueFullFromISR = 0x00021ccd;
xQueuePeek = 0x00021cf5;
xQueuePeekFromISR = 0x00021e1d;
xQueueReceive = 0x00021e89;
xQueueReceiveFromISR = 0x00021fb5;
xQueueRemoveFromSet = 0x00022049;
xQueueSelectFromSet = 0x0002206b;
xQueueSelectFromSetFromISR = 0x0002207d;
xQueueSemaphoreTake = 0x00022091;
xQueueTakeMutexRecursive = 0x000221fd;
xTaskCheckForTimeOut = 0x00022241;
xTaskCreate = 0x000222b1;
xTaskCreateStatic = 0x0002230d;
xTaskGetCurrentTaskHandle = 0x0002237d;
xTaskGetSchedulerState = 0x00022389;
xTaskGetTickCount = 0x000223a5;
xTaskGetTickCountFromISR = 0x000223b1;
xTaskIncrementTick = 0x000223c1;
xTaskPriorityDisinherit = 0x0002248d;
xTaskPriorityInherit = 0x00022521;
xTaskRemoveFromEventList = 0x000225b5;
xTaskResumeAll = 0x00022635;
xTaskResumeFromISR = 0x000226fd;
xTimerCreate = 0x00022789;
xTimerCreateStatic = 0x000227bd;
xTimerCreateTimerTask = 0x000227f5;
xTimerGenericCommand = 0x00022861;
xTimerGetExpiryTime = 0x000228d1;
