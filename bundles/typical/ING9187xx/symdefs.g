...
ll_malloc = 0x0000cc65;
ll_query_timing_info = 0x0000cd9d;
ll_set_adv_coded_scheme = 0x0000cf49;
ll_set_conn_coded_scheme = 0x0000cf79;
ll_set_conn_latency = 0x0000cfa5;
ll_set_conn_tx_power = 0x0000cfd5;
ll_set_def_antenna = 0x0000d01d;
ll_set_initiating_coded_scheme = 0x0000d039;
ll_set_max_conn_number = 0x0000d045;
nibble_for_char = 0x0001cc05;
platform_32k_rc_auto_tune = 0x0001cca5;
platform_32k_rc_tune = 0x0001cd21;
platform_calibrate_32k = 0x0001cd35;
platform_config = 0x0001cd39;
platform_get_heap_status = 0x0001cde9;
platform_get_us_time = 0x0001ce01;
platform_get_version = 0x0001ce05;
platform_hrng = 0x0001ce0d;
platform_install_isr_stack = 0x0001ce15;
platform_patch_rf_init_data = 0x0001ce21;
platform_printf = 0x0001ce2d;
platform_raise_assertion = 0x0001ce41;
platform_rand = 0x0001ce55;
platform_read_info = 0x0001ce59;
platform_read_persistent_reg = 0x0001ce75;
platform_reset = 0x0001ce85;
platform_set_evt_callback = 0x0001ceb9;
platform_set_irq_callback = 0x0001cecd;
platform_set_rf_clk_source = 0x0001cf05;
platform_set_rf_init_data = 0x0001cf11;
platform_set_rf_power_mapping = 0x0001cf1d;
platform_shutdown = 0x0001cf29;
platform_switch_app = 0x0001cf2d;
platform_trace_raw = 0x0001cf59;
platform_write_persistent_reg = 0x0001cf6d;
printf_hexdump = 0x0001cf7d;
pvPortMalloc = 0x0001da3d;
pvTaskIncrementMutexHeldCount = 0x0001db25;
pvTimerGetTimerID = 0x0001db3d;
pxPortInitialiseStack = 0x0001db69;
reverse_128 = 0x0001dd11;
reverse_24 = 0x0001dd17;
reverse_48 = 0x0001dd1d;
reverse_56 = 0x0001dd23;
reverse_64 = 0x0001dd29;
reverse_bd_addr = 0x0001dd2f;
reverse_bytes = 0x0001dd35;
sm_add_event_handler = 0x0001de81;
sm_address_resolution_lookup = 0x0001dfad;
sm_authenticated = 0x0001e087;
sm_authorization_decline = 0x0001e095;
sm_authorization_grant = 0x0001e0b5;
sm_authorization_state = 0x0001e0d5;
sm_bonding_decline = 0x0001e0f1;
sm_config = 0x0001e4c9;
sm_encryption_key_size = 0x0001e5d5;
sm_just_works_confirm = 0x0001ed91;
sm_le_device_key = 0x0001efe1;
sm_passkey_input = 0x0001f079;
sm_private_random_address_generation_get = 0x0001f405;
sm_private_random_address_generation_get_mode = 0x0001f40d;
sm_private_random_address_generation_set_mode = 0x0001f419;
sm_private_random_address_generation_set_update_period = 0x0001f441;
sm_register_oob_data_callback = 0x0001f479;
sm_request_pairing = 0x0001f485;
sm_send_security_request = 0x0001febf;
sm_set_accepted_stk_generation_methods = 0x0001fee5;
sm_set_authentication_requirements = 0x0001fef1;
sm_set_encryption_key_size_range = 0x0001fefd;
sscanf_bd_addr = 0x000201f9;
