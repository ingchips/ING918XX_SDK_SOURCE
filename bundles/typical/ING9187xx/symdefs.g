...
sm_config = 0x0001ea15;
sm_config_conn = 0x0001ea2d;
sm_encryption_key_size = 0x0001ebe3;
sm_just_works_confirm = 0x0001f11d;
sm_le_device_key = 0x0001f459;
sm_passkey_input = 0x0001f4ef;
sm_private_random_address_generation_get = 0x0001f89d;
sm_private_random_address_generation_get_mode = 0x0001f8a5;
sm_private_random_address_generation_set_mode = 0x0001f8b1;
sm_private_random_address_generation_set_update_period = 0x0001f8d9;
sm_register_oob_data_callback = 0x0001fa15;
sm_request_pairing = 0x0001fa21;
...
sscanf_bd_addr = 0x000207b5;
sysSetPublicDeviceAddr = 0x00020b1d;
uuid128_to_str = 0x00021111;
uuid_add_bluetooth_prefix = 0x00021169;
uuid_has_bluetooth_prefix = 0x00021189;
uxListRemove = 0x000211a5;
uxQueueMessagesWaiting = 0x000211cd;
uxQueueMessagesWaitingFromISR = 0x000211f5;
uxQueueSpacesAvailable = 0x00021211;
uxTaskGetStackHighWaterMark = 0x0002123d;
uxTaskPriorityGet = 0x0002125d;
uxTaskPriorityGetFromISR = 0x00021279;
vListInitialise = 0x0002132b;
vListInitialiseItem = 0x00021341;
vListInsert = 0x00021347;
vListInsertEnd = 0x00021377;
vPortEnterCritical = 0x00021391;
vPortExitCritical = 0x000213d5;
vPortFree = 0x00021405;
vPortSuppressTicksAndSleep = 0x00021499;
vPortValidateInterruptPriority = 0x000215b9;
vQueueDelete = 0x00021611;
vQueueWaitForMessageRestricted = 0x0002163d;
vTaskDelay = 0x00021685;
vTaskInternalSetTimeOutState = 0x000216d1;
vTaskMissedYield = 0x000216e1;
vTaskPlaceOnEventList = 0x000216ed;
vTaskPlaceOnEventListRestricted = 0x00021725;
vTaskPriorityDisinheritAfterTimeout = 0x00021765;
vTaskPrioritySet = 0x00021811;
vTaskResume = 0x000218d9;
vTaskStartScheduler = 0x0002195d;
vTaskStepTick = 0x000219ed;
vTaskSuspend = 0x00021a1d;
vTaskSuspendAll = 0x00021ad9;
vTaskSwitchContext = 0x00021ae9;
xPortStartScheduler = 0x00021b91;
xQueueAddToSet = 0x00021c55;
xQueueCreateCountingSemaphore = 0x00021c79;
xQueueCreateCountingSemaphoreStatic = 0x00021cb5;
xQueueCreateMutex = 0x00021cf9;
xQueueCreateMutexStatic = 0x00021d0f;
xQueueCreateSet = 0x00021d29;
xQueueGenericCreate = 0x00021d31;
xQueueGenericCreateStatic = 0x00021d7d;
xQueueGenericReset = 0x00021de5;
xQueueGenericSend = 0x00021e71;
xQueueGenericSendFromISR = 0x00021fdd;
xQueueGiveFromISR = 0x0002209d;
xQueueGiveMutexRecursive = 0x00022141;
xQueueIsQueueEmptyFromISR = 0x00022181;
xQueueIsQueueFullFromISR = 0x000221a5;
xQueuePeek = 0x000221cd;
xQueuePeekFromISR = 0x000222f5;
xQueueReceive = 0x00022361;
xQueueReceiveFromISR = 0x0002248d;
xQueueRemoveFromSet = 0x00022521;
xQueueSelectFromSet = 0x00022543;
xQueueSelectFromSetFromISR = 0x00022555;
xQueueSemaphoreTake = 0x00022569;
xQueueTakeMutexRecursive = 0x000226d5;
xTaskCheckForTimeOut = 0x00022719;
xTaskCreate = 0x00022789;
xTaskCreateStatic = 0x000227e5;
xTaskGetCurrentTaskHandle = 0x00022855;
xTaskGetSchedulerState = 0x00022861;
xTaskGetTickCount = 0x0002287d;
xTaskGetTickCountFromISR = 0x00022889;
xTaskIncrementTick = 0x00022899;
xTaskPriorityDisinherit = 0x00022965;
xTaskPriorityInherit = 0x000229f9;
xTaskRemoveFromEventList = 0x00022a8d;
xTaskResumeAll = 0x00022b0d;
xTaskResumeFromISR = 0x00022bd5;
xTimerCreate = 0x00022c61;
xTimerCreateStatic = 0x00022c95;
xTimerCreateTimerTask = 0x00022ccd;
xTimerGenericCommand = 0x00022d39;
xTimerGetExpiryTime = 0x00022da9;
xTimerGetTimerDaemonTaskHandle = 0x00022dc9;
