...
nibble_for_char = 0x0001edf9;
platform_32k_rc_auto_tune = 0x0001ee95;
platform_32k_rc_tune = 0x0001ef11;
platform_calibrate_32k = 0x0001ef25;
platform_config = 0x0001ef29;
platform_controller_run = 0x0001efe5;
platform_get_task_handle = 0x0001f01d;
platform_get_us_time = 0x0001f035;
platform_get_version = 0x0001f039;
platform_hrng = 0x0001f041;
platform_init_controller = 0x0001f049;
platform_os_idle_resumed_hook = 0x0001f065;
platform_patch_rf_init_data = 0x0001f069;
platform_post_sleep_processing = 0x0001f075;
platform_pre_sleep_processing = 0x0001f07b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001f081;
platform_printf = 0x0001f085;
platform_raise_assertion = 0x0001f099;
platform_rand = 0x0001f0ad;
platform_read_info = 0x0001f0b1;
platform_read_persistent_reg = 0x0001f0cd;
platform_reset = 0x0001f0dd;
platform_set_evt_callback = 0x0001f101;
platform_set_irq_callback = 0x0001f115;
platform_set_rf_clk_source = 0x0001f14d;
platform_set_rf_init_data = 0x0001f159;
platform_set_rf_power_mapping = 0x0001f165;
platform_set_timer = 0x0001f171;
platform_shutdown = 0x0001f175;
platform_switch_app = 0x0001f179;
platform_trace_raw = 0x0001f1a5;
platform_write_persistent_reg = 0x0001f1bd;
printf_hexdump = 0x0001f1cd;
reverse_128 = 0x0001f54d;
reverse_24 = 0x0001f553;
reverse_48 = 0x0001f559;
reverse_56 = 0x0001f55f;
reverse_64 = 0x0001f565;
reverse_bd_addr = 0x0001f56b;
reverse_bytes = 0x0001f571;
sm_add_event_handler = 0x0001f851;
sm_address_resolution_lookup = 0x0001f9a9;
sm_authenticated = 0x0001fd01;
sm_authorization_decline = 0x0001fd0f;
sm_authorization_grant = 0x0001fd2f;
sm_authorization_state = 0x0001fd4f;
sm_bonding_decline = 0x0001fd69;
sm_config = 0x00020189;
sm_config_conn = 0x000201a1;
sm_encryption_key_size = 0x00020357;
...
sm_send_security_request = 0x00021b9b;
sm_set_accepted_stk_generation_methods = 0x00021bc1;
sm_set_authentication_requirements = 0x00021bcd;
sm_set_encryption_key_size_range = 0x00021bd9;
sscanf_bd_addr = 0x00021f9d;
sysSetPublicDeviceAddr = 0x00022305;
