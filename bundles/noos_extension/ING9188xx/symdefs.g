...
sm_authenticated = 0x0001fcf5;
sm_authorization_decline = 0x0001fd03;
sm_authorization_grant = 0x0001fd23;
sm_authorization_state = 0x0001fd43;
sm_bonding_decline = 0x0001fd5d;
sm_config = 0x0002017d;
sm_config_conn = 0x00020195;
sm_encryption_key_size = 0x0002034b;
sm_just_works_confirm = 0x00020885;
sm_le_device_key = 0x00020bc1;
sm_passkey_input = 0x00020c57;
sm_private_random_address_generation_get = 0x00021005;
sm_private_random_address_generation_get_mode = 0x0002100d;
sm_private_random_address_generation_set_mode = 0x00021019;
sm_private_random_address_generation_set_update_period = 0x00021041;
sm_register_oob_data_callback = 0x0002117d;
sm_request_pairing = 0x00021189;
sm_send_security_request = 0x00021b8f;
sm_set_accepted_stk_generation_methods = 0x00021bb5;
sm_set_authentication_requirements = 0x00021bc1;
sm_set_encryption_key_size_range = 0x00021bcd;
sscanf_bd_addr = 0x00021f91;
sysSetPublicDeviceAddr = 0x000222f9;
