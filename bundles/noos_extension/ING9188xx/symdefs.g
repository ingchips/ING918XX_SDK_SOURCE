...
sm_just_works_confirm = 0x0002096d;
sm_le_device_key = 0x00020ca9;
sm_passkey_input = 0x00020d3f;
sm_private_random_address_generation_get = 0x000210ed;
sm_private_random_address_generation_get_mode = 0x000210f5;
sm_private_random_address_generation_set_mode = 0x00021101;
sm_private_random_address_generation_set_update_period = 0x00021129;
sm_register_oob_data_callback = 0x00021265;
sm_request_pairing = 0x00021271;
...
sm_set_encryption_key_size_range = 0x00021ccd;
sscanf_bd_addr = 0x0002209d;
sysSetPublicDeviceAddr = 0x00022405;
uuid128_to_str = 0x00022b81;
uuid_add_bluetooth_prefix = 0x00022bd9;
uuid_has_bluetooth_prefix = 0x00022bf9;
