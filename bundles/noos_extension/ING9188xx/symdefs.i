...
--define_symbol nibble_for_char=0x0001ede1
--define_symbol platform_32k_rc_auto_tune=0x0001ee7d
--define_symbol platform_32k_rc_tune=0x0001eef9
--define_symbol platform_calibrate_32k=0x0001ef0d
--define_symbol platform_config=0x0001ef11
--define_symbol platform_controller_run=0x0001efcd
--define_symbol platform_get_task_handle=0x0001f005
--define_symbol platform_get_us_time=0x0001f01d
--define_symbol platform_get_version=0x0001f021
--define_symbol platform_hrng=0x0001f029
--define_symbol platform_init_controller=0x0001f031
--define_symbol platform_os_idle_resumed_hook=0x0001f04d
--define_symbol platform_patch_rf_init_data=0x0001f051
--define_symbol platform_post_sleep_processing=0x0001f05d
--define_symbol platform_pre_sleep_processing=0x0001f063
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001f069
--define_symbol platform_printf=0x0001f06d
--define_symbol platform_raise_assertion=0x0001f081
--define_symbol platform_rand=0x0001f095
--define_symbol platform_read_info=0x0001f099
--define_symbol platform_read_persistent_reg=0x0001f0b5
--define_symbol platform_reset=0x0001f0c5
--define_symbol platform_set_evt_callback=0x0001f0e9
--define_symbol platform_set_irq_callback=0x0001f0fd
--define_symbol platform_set_rf_clk_source=0x0001f135
--define_symbol platform_set_rf_init_data=0x0001f141
--define_symbol platform_set_rf_power_mapping=0x0001f14d
--define_symbol platform_set_timer=0x0001f159
--define_symbol platform_shutdown=0x0001f15d
--define_symbol platform_switch_app=0x0001f161
--define_symbol platform_trace_raw=0x0001f18d
--define_symbol platform_write_persistent_reg=0x0001f1a5
--define_symbol printf_hexdump=0x0001f1b5
--define_symbol reverse_128=0x0001f529
--define_symbol reverse_24=0x0001f52f
--define_symbol reverse_48=0x0001f535
--define_symbol reverse_56=0x0001f53b
--define_symbol reverse_64=0x0001f541
--define_symbol reverse_bd_addr=0x0001f547
--define_symbol reverse_bytes=0x0001f54d
--define_symbol sm_add_event_handler=0x0001f82d
--define_symbol sm_address_resolution_lookup=0x0001f985
--define_symbol sm_authenticated=0x0001fcdd
--define_symbol sm_authorization_decline=0x0001fceb
--define_symbol sm_authorization_grant=0x0001fd0b
--define_symbol sm_authorization_state=0x0001fd2b
--define_symbol sm_bonding_decline=0x0001fd45
--define_symbol sm_config=0x00020165
--define_symbol sm_config_conn=0x0002017d
--define_symbol sm_encryption_key_size=0x00020333
--define_symbol sm_just_works_confirm=0x0002086d
--define_symbol sm_le_device_key=0x00020ba9
--define_symbol sm_passkey_input=0x00020c3f
--define_symbol sm_private_random_address_generation_get=0x00020fed
--define_symbol sm_private_random_address_generation_get_mode=0x00020ff5
--define_symbol sm_private_random_address_generation_set_mode=0x00021001
--define_symbol sm_private_random_address_generation_set_update_period=0x00021029
--define_symbol sm_register_oob_data_callback=0x00021165
--define_symbol sm_request_pairing=0x00021171
--define_symbol sm_send_security_request=0x00021b77
--define_symbol sm_set_accepted_stk_generation_methods=0x00021b9d
--define_symbol sm_set_authentication_requirements=0x00021ba9
--define_symbol sm_set_encryption_key_size_range=0x00021bb5
--define_symbol sscanf_bd_addr=0x00021f79
--define_symbol sysSetPublicDeviceAddr=0x000222e1
