...
--define_symbol ll_raw_packet_recv=0x0000d759
--define_symbol ll_raw_packet_send=0x0000d815
--define_symbol ll_raw_packet_set_bare_data=0x0000d8fd
--define_symbol ll_raw_packet_set_bare_mode=0x0000d93b
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000da41
--define_symbol ll_raw_packet_set_param=0x0000da63
--define_symbol ll_raw_packet_set_rx_cte=0x0000dac1
--define_symbol ll_raw_packet_set_tx_cte=0x0000db57
--define_symbol ll_raw_packet_set_tx_data=0x0000db95
--define_symbol ll_scan_set_fixed_channel=0x0000dc51
--define_symbol ll_scanner_enable_iq_sampling=0x0000dc5d
--define_symbol ll_set_adv_access_address=0x0000de0d
--define_symbol ll_set_adv_coded_scheme=0x0000de19
--define_symbol ll_set_conn_coded_scheme=0x0000de49
--define_symbol ll_set_conn_interval_unit=0x0000de75
--define_symbol ll_set_conn_latency=0x0000de81
--define_symbol ll_set_conn_tx_power=0x0000deb1
--define_symbol ll_set_def_antenna=0x0000def9
--define_symbol ll_set_initiating_coded_scheme=0x0000df15
--define_symbol ll_set_max_conn_number=0x0000df21
--define_symbol nibble_for_char=0x0001ee65
--define_symbol platform_32k_rc_auto_tune=0x0001ef01
--define_symbol platform_32k_rc_tune=0x0001ef7d
--define_symbol platform_calibrate_32k=0x0001ef91
--define_symbol platform_config=0x0001ef95
--define_symbol platform_controller_run=0x0001f065
--define_symbol platform_get_task_handle=0x0001f09d
--define_symbol platform_get_us_time=0x0001f0b5
--define_symbol platform_get_version=0x0001f0b9
--define_symbol platform_hrng=0x0001f0c1
--define_symbol platform_init_controller=0x0001f0c9
--define_symbol platform_os_idle_resumed_hook=0x0001f0e5
--define_symbol platform_patch_rf_init_data=0x0001f0e9
--define_symbol platform_post_sleep_processing=0x0001f0f5
--define_symbol platform_pre_sleep_processing=0x0001f0fb
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001f101
--define_symbol platform_printf=0x0001f105
--define_symbol platform_raise_assertion=0x0001f119
--define_symbol platform_rand=0x0001f12d
--define_symbol platform_read_info=0x0001f131
--define_symbol platform_read_persistent_reg=0x0001f14d
--define_symbol platform_reset=0x0001f15d
--define_symbol platform_set_evt_callback=0x0001f181
--define_symbol platform_set_irq_callback=0x0001f195
--define_symbol platform_set_rf_clk_source=0x0001f1cd
--define_symbol platform_set_rf_init_data=0x0001f1d9
--define_symbol platform_set_rf_power_mapping=0x0001f1e5
--define_symbol platform_set_timer=0x0001f1f1
--define_symbol platform_shutdown=0x0001f1f5
--define_symbol platform_switch_app=0x0001f1f9
--define_symbol platform_trace_raw=0x0001f225
--define_symbol platform_write_persistent_reg=0x0001f23d
--define_symbol printf_hexdump=0x0001f24d
--define_symbol reverse_128=0x0001f5c1
--define_symbol reverse_24=0x0001f5c7
--define_symbol reverse_48=0x0001f5cd
--define_symbol reverse_56=0x0001f5d3
--define_symbol reverse_64=0x0001f5d9
--define_symbol reverse_bd_addr=0x0001f5df
--define_symbol reverse_bytes=0x0001f5e5
--define_symbol sm_add_event_handler=0x0001f8c5
--define_symbol sm_address_resolution_lookup=0x0001fa1d
--define_symbol sm_authenticated=0x0001fd75
--define_symbol sm_authorization_decline=0x0001fd83
--define_symbol sm_authorization_grant=0x0001fda3
--define_symbol sm_authorization_state=0x0001fdc3
--define_symbol sm_bonding_decline=0x0001fddd
--define_symbol sm_config=0x000201fd
--define_symbol sm_config_conn=0x00020215
--define_symbol sm_encryption_key_size=0x000203cb
--define_symbol sm_just_works_confirm=0x000208d5
--define_symbol sm_le_device_key=0x00020c11
--define_symbol sm_passkey_input=0x00020ca7
...
--define_symbol sm_register_oob_data_callback=0x000211cd
--define_symbol sm_request_pairing=0x000211d9
--define_symbol sm_send_security_request=0x00021bf7
--define_symbol sm_set_accepted_stk_generation_methods=0x00021c1d
--define_symbol sm_set_authentication_requirements=0x00021c29
--define_symbol sm_set_encryption_key_size_range=0x00021c35
--define_symbol sscanf_bd_addr=0x00022005
--define_symbol sysSetPublicDeviceAddr=0x0002236d
