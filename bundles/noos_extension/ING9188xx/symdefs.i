...
--define_symbol l2cap_register_fixed_channel=0x0000c5c5
--define_symbol l2cap_register_packet_handler=0x0000c5e1
--define_symbol l2cap_register_service=0x0000c5ed
--define_symbol l2cap_request_can_send_fix_channel_now_event=0x0000c6d1
--define_symbol l2cap_request_can_send_now_event=0x0000c6f5
--define_symbol l2cap_request_connection_parameter_update=0x0000c70f
--define_symbol l2cap_send=0x0000caa9
--define_symbol l2cap_send_connectionless=0x0000cb21
--define_symbol l2cap_send_connectionless3=0x0000cbb1
--define_symbol l2cap_send_echo_request=0x0000cc49
...
--define_symbol ll_ackable_packet_alloc=0x0000cec7
--define_symbol ll_ackable_packet_get_status=0x0000cfcf
--define_symbol ll_ackable_packet_run=0x0000d041
--define_symbol ll_ackable_packet_set_tx_data=0x0000d0e9
--define_symbol ll_attach_cte_to_adv_set=0x0000d105
--define_symbol ll_free=0x0000d29d
--define_symbol ll_hint_on_ce_len=0x0000d2a9
--define_symbol ll_legacy_adv_set_interval=0x0000d2e1
...
--define_symbol ll_raw_packet_get_iq_samples=0x0000d639
--define_symbol ll_raw_packet_get_rx_data=0x0000d6d3
--define_symbol ll_raw_packet_recv=0x0000d789
--define_symbol ll_raw_packet_send=0x0000d845
--define_symbol ll_raw_packet_set_bare_data=0x0000d92d
--define_symbol ll_raw_packet_set_bare_mode=0x0000d96b
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000da71
--define_symbol ll_raw_packet_set_param=0x0000da93
--define_symbol ll_raw_packet_set_rx_cte=0x0000daf1
--define_symbol ll_raw_packet_set_tx_cte=0x0000db87
--define_symbol ll_raw_packet_set_tx_data=0x0000dbc5
--define_symbol ll_scan_set_fixed_channel=0x0000dc81
--define_symbol ll_scanner_enable_iq_sampling=0x0000dc8d
--define_symbol ll_set_adv_access_address=0x0000de3d
--define_symbol ll_set_adv_coded_scheme=0x0000de49
--define_symbol ll_set_conn_coded_scheme=0x0000de79
--define_symbol ll_set_conn_interval_unit=0x0000dea5
--define_symbol ll_set_conn_latency=0x0000deb1
--define_symbol ll_set_conn_tx_power=0x0000dee1
--define_symbol ll_set_def_antenna=0x0000df29
--define_symbol ll_set_initiating_coded_scheme=0x0000df45
--define_symbol ll_set_max_conn_number=0x0000df51
--define_symbol nibble_for_char=0x0001ee9d
--define_symbol platform_32k_rc_auto_tune=0x0001ef39
--define_symbol platform_32k_rc_tune=0x0001efb5
--define_symbol platform_calibrate_32k=0x0001efc9
--define_symbol platform_config=0x0001efcd
--define_symbol platform_controller_run=0x0001f09d
--define_symbol platform_get_task_handle=0x0001f0d5
--define_symbol platform_get_us_time=0x0001f0ed
--define_symbol platform_get_version=0x0001f0f1
--define_symbol platform_hrng=0x0001f0f9
--define_symbol platform_init_controller=0x0001f101
--define_symbol platform_os_idle_resumed_hook=0x0001f11d
--define_symbol platform_patch_rf_init_data=0x0001f121
--define_symbol platform_post_sleep_processing=0x0001f12d
--define_symbol platform_pre_sleep_processing=0x0001f133
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001f139
--define_symbol platform_printf=0x0001f13d
--define_symbol platform_raise_assertion=0x0001f151
--define_symbol platform_rand=0x0001f165
--define_symbol platform_read_info=0x0001f169
--define_symbol platform_read_persistent_reg=0x0001f185
--define_symbol platform_reset=0x0001f195
--define_symbol platform_set_evt_callback=0x0001f1b9
--define_symbol platform_set_irq_callback=0x0001f1cd
--define_symbol platform_set_rf_clk_source=0x0001f205
--define_symbol platform_set_rf_init_data=0x0001f211
--define_symbol platform_set_rf_power_mapping=0x0001f21d
--define_symbol platform_set_timer=0x0001f229
--define_symbol platform_shutdown=0x0001f22d
--define_symbol platform_switch_app=0x0001f231
--define_symbol platform_trace_raw=0x0001f25d
--define_symbol platform_write_persistent_reg=0x0001f275
--define_symbol printf_hexdump=0x0001f285
--define_symbol reverse_128=0x0001f5f9
--define_symbol reverse_24=0x0001f5ff
--define_symbol reverse_48=0x0001f605
--define_symbol reverse_56=0x0001f60b
--define_symbol reverse_64=0x0001f611
--define_symbol reverse_bd_addr=0x0001f617
--define_symbol reverse_bytes=0x0001f61d
--define_symbol sm_add_event_handler=0x0001f8fd
--define_symbol sm_address_resolution_lookup=0x0001fa55
--define_symbol sm_authenticated=0x0001fdad
--define_symbol sm_authorization_decline=0x0001fdbb
--define_symbol sm_authorization_grant=0x0001fddb
--define_symbol sm_authorization_state=0x0001fdfb
--define_symbol sm_bonding_decline=0x0001fe15
--define_symbol sm_config=0x00020235
--define_symbol sm_config_conn=0x0002024d
--define_symbol sm_encryption_key_size=0x00020403
--define_symbol sm_just_works_confirm=0x0002090d
--define_symbol sm_le_device_key=0x00020c49
--define_symbol sm_passkey_input=0x00020cdf
--define_symbol sm_private_random_address_generation_get=0x0002108d
--define_symbol sm_private_random_address_generation_get_mode=0x00021095
--define_symbol sm_private_random_address_generation_set_mode=0x000210a1
--define_symbol sm_private_random_address_generation_set_update_period=0x000210c9
--define_symbol sm_register_oob_data_callback=0x00021205
--define_symbol sm_request_pairing=0x00021211
--define_symbol sm_send_security_request=0x00021c2f
--define_symbol sm_set_accepted_stk_generation_methods=0x00021c55
--define_symbol sm_set_authentication_requirements=0x00021c61
--define_symbol sm_set_encryption_key_size_range=0x00021c6d
--define_symbol sscanf_bd_addr=0x0002203d
--define_symbol sysSetPublicDeviceAddr=0x000223a5
