...
ll_raw_packet_recv = 0x0000d109;
ll_raw_packet_send = 0x0000d1c5;
ll_raw_packet_set_bare_data = 0x0000d2ad;
ll_raw_packet_set_bare_mode = 0x0000d2eb;
ll_raw_packet_set_param = 0x0000d3f1;
ll_raw_packet_set_tx_data = 0x0000d44f;
ll_scan_set_fixed_channel = 0x0000d50d;
ll_set_adv_access_address = 0x0000d621;
ll_set_adv_coded_scheme = 0x0000d62d;
ll_set_conn_coded_scheme = 0x0000d65d;
ll_set_conn_interval_unit = 0x0000d689;
...
ll_set_max_conn_number = 0x0000d735;
nibble_for_char = 0x0001d699;
platform_32k_rc_auto_tune = 0x0001d735;
platform_32k_rc_tune = 0x0001d7b1;
platform_calibrate_32k = 0x0001d7c5;
platform_config = 0x0001d7c9;
platform_controller_run = 0x0001d899;
platform_get_task_handle = 0x0001d8d1;
platform_get_us_time = 0x0001d8e9;
platform_get_version = 0x0001d8ed;
platform_hrng = 0x0001d8f5;
platform_init_controller = 0x0001d8fd;
platform_os_idle_resumed_hook = 0x0001d919;
platform_patch_rf_init_data = 0x0001d91d;
platform_post_sleep_processing = 0x0001d929;
platform_pre_sleep_processing = 0x0001d92f;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001d935;
platform_printf = 0x0001d939;
platform_raise_assertion = 0x0001d94d;
platform_rand = 0x0001d961;
platform_read_info = 0x0001d965;
platform_read_persistent_reg = 0x0001d981;
platform_reset = 0x0001d991;
platform_set_evt_callback = 0x0001d9b5;
...
reverse_128 = 0x0001ddbd;
reverse_24 = 0x0001ddc3;
reverse_48 = 0x0001ddc9;
reverse_56 = 0x0001ddcf;
reverse_64 = 0x0001ddd5;
reverse_bd_addr = 0x0001dddb;
reverse_bytes = 0x0001dde1;
sm_add_event_handler = 0x0001df6d;
sm_address_resolution_lookup = 0x0001e0c5;
sm_authenticated = 0x0001e41d;
sm_authorization_decline = 0x0001e42b;
sm_authorization_grant = 0x0001e44b;
sm_authorization_state = 0x0001e46b;
sm_bonding_decline = 0x0001e485;
sm_config = 0x0001e8a5;
sm_config_conn = 0x0001e8bd;
sm_encryption_key_size = 0x0001ea73;
sm_just_works_confirm = 0x0001ef7d;
sm_le_device_key = 0x0001f2b9;
sm_passkey_input = 0x0001f34f;
sm_private_random_address_generation_get = 0x0001f6fd;
sm_private_random_address_generation_get_mode = 0x0001f705;
sm_private_random_address_generation_set_mode = 0x0001f711;
sm_private_random_address_generation_set_update_period = 0x0001f739;
sm_register_oob_data_callback = 0x0001f875;
sm_request_pairing = 0x0001f881;
sm_send_security_request = 0x0002029f;
sm_set_accepted_stk_generation_methods = 0x000202c5;
sm_set_authentication_requirements = 0x000202d1;
sm_set_encryption_key_size_range = 0x000202dd;
sscanf_bd_addr = 0x000206ad;
sysSetPublicDeviceAddr = 0x00020a15;
uuid128_to_str = 0x00020ffd;
uuid_add_bluetooth_prefix = 0x00021055;
uuid_has_bluetooth_prefix = 0x00021075;
