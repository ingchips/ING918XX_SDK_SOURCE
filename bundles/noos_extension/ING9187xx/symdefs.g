...
nibble_for_char = 0x0001d639;
platform_32k_rc_auto_tune = 0x0001d6d5;
platform_32k_rc_tune = 0x0001d751;
platform_calibrate_32k = 0x0001d765;
platform_config = 0x0001d769;
platform_controller_run = 0x0001d825;
platform_get_task_handle = 0x0001d85d;
platform_get_us_time = 0x0001d875;
platform_get_version = 0x0001d879;
platform_hrng = 0x0001d881;
platform_init_controller = 0x0001d889;
platform_os_idle_resumed_hook = 0x0001d8a5;
platform_patch_rf_init_data = 0x0001d8a9;
platform_post_sleep_processing = 0x0001d8b5;
platform_pre_sleep_processing = 0x0001d8bb;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001d8c1;
platform_printf = 0x0001d8c5;
platform_raise_assertion = 0x0001d8d9;
platform_rand = 0x0001d8ed;
platform_read_info = 0x0001d8f1;
platform_read_persistent_reg = 0x0001d90d;
platform_reset = 0x0001d91d;
platform_set_evt_callback = 0x0001d941;
platform_set_irq_callback = 0x0001d955;
platform_set_rf_clk_source = 0x0001d98d;
platform_set_rf_init_data = 0x0001d999;
platform_set_rf_power_mapping = 0x0001d9a5;
platform_set_timer = 0x0001d9b1;
platform_shutdown = 0x0001d9b5;
platform_switch_app = 0x0001d9b9;
platform_trace_raw = 0x0001d9e5;
platform_write_persistent_reg = 0x0001d9fd;
printf_hexdump = 0x0001da0d;
reverse_128 = 0x0001dd49;
reverse_24 = 0x0001dd4f;
reverse_48 = 0x0001dd55;
reverse_56 = 0x0001dd5b;
reverse_64 = 0x0001dd61;
reverse_bd_addr = 0x0001dd67;
reverse_bytes = 0x0001dd6d;
sm_add_event_handler = 0x0001def9;
sm_address_resolution_lookup = 0x0001e051;
sm_authenticated = 0x0001e3a9;
sm_authorization_decline = 0x0001e3b7;
sm_authorization_grant = 0x0001e3d7;
sm_authorization_state = 0x0001e3f7;
sm_bonding_decline = 0x0001e411;
sm_config = 0x0001e831;
sm_config_conn = 0x0001e849;
sm_encryption_key_size = 0x0001e9ff;
sm_just_works_confirm = 0x0001ef39;
sm_le_device_key = 0x0001f275;
sm_passkey_input = 0x0001f30b;
...
sm_set_encryption_key_size_range = 0x00020281;
sscanf_bd_addr = 0x00020645;
sysSetPublicDeviceAddr = 0x000209ad;
uuid128_to_str = 0x00020fa5;
uuid_add_bluetooth_prefix = 0x00020ffd;
uuid_has_bluetooth_prefix = 0x0002101d;
