...
--define_symbol nibble_for_char=0x0001d669
--define_symbol platform_32k_rc_auto_tune=0x0001d705
--define_symbol platform_32k_rc_tune=0x0001d781
--define_symbol platform_calibrate_32k=0x0001d795
--define_symbol platform_config=0x0001d799
--define_symbol platform_controller_run=0x0001d869
--define_symbol platform_get_task_handle=0x0001d8a1
--define_symbol platform_get_us_time=0x0001d8b9
--define_symbol platform_get_version=0x0001d8bd
--define_symbol platform_hrng=0x0001d8c5
--define_symbol platform_init_controller=0x0001d8cd
--define_symbol platform_os_idle_resumed_hook=0x0001d8e9
--define_symbol platform_patch_rf_init_data=0x0001d8ed
--define_symbol platform_post_sleep_processing=0x0001d8f9
--define_symbol platform_pre_sleep_processing=0x0001d8ff
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001d905
--define_symbol platform_printf=0x0001d909
--define_symbol platform_raise_assertion=0x0001d91d
--define_symbol platform_rand=0x0001d931
--define_symbol platform_read_info=0x0001d935
--define_symbol platform_read_persistent_reg=0x0001d951
--define_symbol platform_reset=0x0001d961
--define_symbol platform_set_evt_callback=0x0001d985
--define_symbol platform_set_irq_callback=0x0001d999
--define_symbol platform_set_rf_clk_source=0x0001d9d1
--define_symbol platform_set_rf_init_data=0x0001d9dd
--define_symbol platform_set_rf_power_mapping=0x0001d9e9
--define_symbol platform_set_timer=0x0001d9f5
--define_symbol platform_shutdown=0x0001d9f9
--define_symbol platform_switch_app=0x0001d9fd
--define_symbol platform_trace_raw=0x0001da29
--define_symbol platform_write_persistent_reg=0x0001da41
--define_symbol printf_hexdump=0x0001da51
--define_symbol reverse_128=0x0001dd8d
--define_symbol reverse_24=0x0001dd93
--define_symbol reverse_48=0x0001dd99
--define_symbol reverse_56=0x0001dd9f
--define_symbol reverse_64=0x0001dda5
--define_symbol reverse_bd_addr=0x0001ddab
--define_symbol reverse_bytes=0x0001ddb1
--define_symbol sm_add_event_handler=0x0001df3d
--define_symbol sm_address_resolution_lookup=0x0001e095
--define_symbol sm_authenticated=0x0001e3ed
--define_symbol sm_authorization_decline=0x0001e3fb
--define_symbol sm_authorization_grant=0x0001e41b
--define_symbol sm_authorization_state=0x0001e43b
--define_symbol sm_bonding_decline=0x0001e455
--define_symbol sm_config=0x0001e875
--define_symbol sm_config_conn=0x0001e88d
--define_symbol sm_encryption_key_size=0x0001ea43
--define_symbol sm_just_works_confirm=0x0001ef4d
--define_symbol sm_le_device_key=0x0001f289
--define_symbol sm_passkey_input=0x0001f31f
...
--define_symbol sm_send_security_request=0x0002026f
--define_symbol sm_set_accepted_stk_generation_methods=0x00020295
--define_symbol sm_set_authentication_requirements=0x000202a1
--define_symbol sm_set_encryption_key_size_range=0x000202ad
--define_symbol sscanf_bd_addr=0x0002067d
--define_symbol sysSetPublicDeviceAddr=0x000209e5
--define_symbol uuid128_to_str=0x00020fcd
--define_symbol uuid_add_bluetooth_prefix=0x00021025
--define_symbol uuid_has_bluetooth_prefix=0x00021045
