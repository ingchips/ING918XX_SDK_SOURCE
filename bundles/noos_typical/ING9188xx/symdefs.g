...
sm_authenticated = 0x0001ee45;
sm_authorization_decline = 0x0001ee53;
sm_authorization_grant = 0x0001ee73;
sm_authorization_state = 0x0001ee93;
sm_bonding_decline = 0x0001eead;
sm_config = 0x0001f2cd;
sm_config_conn = 0x0001f2e5;
sm_encryption_key_size = 0x0001f49b;
sm_just_works_confirm = 0x0001f9d5;
sm_le_device_key = 0x0001fd11;
sm_passkey_input = 0x0001fda7;
sm_private_random_address_generation_get = 0x00020155;
sm_private_random_address_generation_get_mode = 0x0002015d;
sm_private_random_address_generation_set_mode = 0x00020169;
sm_private_random_address_generation_set_update_period = 0x00020191;
sm_register_oob_data_callback = 0x000202cd;
sm_request_pairing = 0x000202d9;
sm_send_security_request = 0x00020cdf;
sm_set_accepted_stk_generation_methods = 0x00020d05;
sm_set_authentication_requirements = 0x00020d11;
sm_set_encryption_key_size_range = 0x00020d1d;
sscanf_bd_addr = 0x0002106d;
sysSetPublicDeviceAddr = 0x000213d5;
uuid128_to_str = 0x00021b61;
uuid_add_bluetooth_prefix = 0x00021bb9;
uuid_has_bluetooth_prefix = 0x00021bd9;
