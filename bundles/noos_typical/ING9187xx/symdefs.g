...
gap_vendor_tx_continuous_wave = 0x00007da9;
gatt_client_cancel_write = 0x000082d1;
gatt_client_discover_characteristic_descriptors = 0x000082f7;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x00008337;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x00008387;
gatt_client_discover_characteristics_for_service = 0x000083d7;
gatt_client_discover_primary_services = 0x0000840d;
gatt_client_discover_primary_services_by_uuid128 = 0x0000843f;
gatt_client_discover_primary_services_by_uuid16 = 0x00008483;
gatt_client_execute_write = 0x000084bf;
gatt_client_find_included_services_for_service = 0x000084e5;
gatt_client_get_mtu = 0x00008513;
gatt_client_is_ready = 0x000085b5;
gatt_client_listen_for_characteristic_value_updates = 0x000085cb;
gatt_client_prepare_write = 0x000085ed;
...
hci_add_event_handler = 0x0000a331;
hci_power_control = 0x0000ab25;
hci_register_acl_packet_handler = 0x0000acd9;
...
l2cap_max_le_mtu = 0x0000c115;
l2cap_max_mtu = 0x0000c119;
l2cap_register_fixed_channel = 0x0000c225;
l2cap_register_packet_handler = 0x0000c241;
l2cap_register_service = 0x0000c24d;
l2cap_request_can_send_fix_channel_now_event = 0x0000c331;
l2cap_request_can_send_now_event = 0x0000c355;
l2cap_request_connection_parameter_update = 0x0000c36f;
l2cap_send = 0x0000c709;
l2cap_send_connectionless = 0x0000c781;
l2cap_send_connectionless3 = 0x0000c811;
l2cap_send_echo_request = 0x0000c8a9;
l2cap_unregister_service = 0x0000c965;
le_device_db_add = 0x0000c9bd;
...
ll_free = 0x0000cb27;
ll_hint_on_ce_len = 0x0000cb31;
ll_legacy_adv_set_interval = 0x0000cb69;
ll_malloc = 0x0000cb79;
ll_query_timing_info = 0x0000ccb1;
ll_scan_set_fixed_channel = 0x0000cd55;
ll_set_adv_access_address = 0x0000ce69;
ll_set_adv_coded_scheme = 0x0000ce75;
ll_set_conn_coded_scheme = 0x0000cea5;
ll_set_conn_latency = 0x0000ced1;
ll_set_conn_tx_power = 0x0000cf01;
ll_set_def_antenna = 0x0000cf49;
ll_set_initiating_coded_scheme = 0x0000cf65;
ll_set_max_conn_number = 0x0000cf71;
...
platform_set_evt_callback = 0x0001d0c9;
platform_set_irq_callback = 0x0001d0dd;
platform_set_rf_clk_source = 0x0001d115;
platform_set_rf_init_data = 0x0001d121;
platform_set_rf_power_mapping = 0x0001d12d;
platform_set_timer = 0x0001d139;
platform_shutdown = 0x0001d13d;
platform_switch_app = 0x0001d141;
platform_trace_raw = 0x0001d16d;
platform_write_persistent_reg = 0x0001d185;
printf_hexdump = 0x0001d195;
reverse_128 = 0x0001d4d1;
reverse_24 = 0x0001d4d7;
reverse_48 = 0x0001d4dd;
reverse_56 = 0x0001d4e3;
reverse_64 = 0x0001d4e9;
reverse_bd_addr = 0x0001d4ef;
reverse_bytes = 0x0001d4f5;
sm_add_event_handler = 0x0001d661;
sm_address_resolution_lookup = 0x0001d7b9;
sm_authenticated = 0x0001db11;
sm_authorization_decline = 0x0001db1f;
sm_authorization_grant = 0x0001db3f;
sm_authorization_state = 0x0001db5f;
sm_bonding_decline = 0x0001db79;
sm_config = 0x0001df99;
sm_config_conn = 0x0001dfb1;
sm_encryption_key_size = 0x0001e167;
sm_just_works_confirm = 0x0001e6a1;
sm_le_device_key = 0x0001e9dd;
sm_passkey_input = 0x0001ea73;
sm_private_random_address_generation_get = 0x0001ee21;
sm_private_random_address_generation_get_mode = 0x0001ee29;
sm_private_random_address_generation_set_mode = 0x0001ee35;
sm_private_random_address_generation_set_update_period = 0x0001ee5d;
sm_register_oob_data_callback = 0x0001ef99;
sm_request_pairing = 0x0001efa5;
sm_send_security_request = 0x0001f9c3;
sm_set_accepted_stk_generation_methods = 0x0001f9e9;
sm_set_authentication_requirements = 0x0001f9f5;
sm_set_encryption_key_size_range = 0x0001fa01;
sscanf_bd_addr = 0x0001fd5d;
sysSetPublicDeviceAddr = 0x000200c5;
uuid128_to_str = 0x000206ad;
uuid_add_bluetooth_prefix = 0x00020705;
uuid_has_bluetooth_prefix = 0x00020725;
