...
--define_symbol platform_32k_rc_auto_tune=0x0001cd39
--define_symbol platform_32k_rc_tune=0x0001cdb5
--define_symbol platform_calibrate_32k=0x0001cdc9
--define_symbol platform_config=0x0001cdcd
--define_symbol platform_controller_run=0x0001ce89
--define_symbol platform_get_task_handle=0x0001cec1
--define_symbol platform_get_us_time=0x0001ced9
--define_symbol platform_get_version=0x0001cedd
--define_symbol platform_hrng=0x0001cee5
--define_symbol platform_init_controller=0x0001ceed
--define_symbol platform_os_idle_resumed_hook=0x0001cf09
--define_symbol platform_patch_rf_init_data=0x0001cf0d
--define_symbol platform_post_sleep_processing=0x0001cf19
--define_symbol platform_pre_sleep_processing=0x0001cf1f
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001cf25
...
--define_symbol platform_set_evt_callback=0x0001cfa5
--define_symbol platform_set_irq_callback=0x0001cfb9
--define_symbol platform_set_rf_clk_source=0x0001cff1
--define_symbol platform_set_rf_init_data=0x0001cffd
--define_symbol platform_set_rf_power_mapping=0x0001d009
--define_symbol platform_set_timer=0x0001d015
--define_symbol platform_shutdown=0x0001d019
--define_symbol platform_switch_app=0x0001d01d
--define_symbol platform_trace_raw=0x0001d049
...
--define_symbol sm_authenticated=0x0001d9ed
--define_symbol sm_authorization_decline=0x0001d9fb
--define_symbol sm_authorization_grant=0x0001da1b
--define_symbol sm_authorization_state=0x0001da3b
--define_symbol sm_bonding_decline=0x0001da55
--define_symbol sm_config=0x0001de75
--define_symbol sm_config_conn=0x0001de8d
--define_symbol sm_encryption_key_size=0x0001e043
--define_symbol sm_just_works_confirm=0x0001e57d
--define_symbol sm_le_device_key=0x0001e8b9
--define_symbol sm_passkey_input=0x0001e94f
--define_symbol sm_private_random_address_generation_get=0x0001ecfd
--define_symbol sm_private_random_address_generation_get_mode=0x0001ed05
--define_symbol sm_private_random_address_generation_set_mode=0x0001ed11
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ed39
--define_symbol sm_register_oob_data_callback=0x0001ee75
--define_symbol sm_request_pairing=0x0001ee81
--define_symbol sm_send_security_request=0x0001f887
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f8ad
--define_symbol sm_set_authentication_requirements=0x0001f8b9
--define_symbol sm_set_encryption_key_size_range=0x0001f8c5
--define_symbol sscanf_bd_addr=0x0001fc15
--define_symbol sysSetPublicDeviceAddr=0x0001ff7d
--define_symbol uuid128_to_str=0x00020575
--define_symbol uuid_add_bluetooth_prefix=0x000205cd
--define_symbol uuid_has_bluetooth_prefix=0x000205ed
