...
--define_symbol sm_authenticated=0x0001d9c1
--define_symbol sm_authorization_decline=0x0001d9cf
--define_symbol sm_authorization_grant=0x0001d9ef
--define_symbol sm_authorization_state=0x0001da0f
--define_symbol sm_bonding_decline=0x0001da29
--define_symbol sm_config=0x0001de49
--define_symbol sm_config_conn=0x0001de61
--define_symbol sm_encryption_key_size=0x0001e017
--define_symbol sm_just_works_confirm=0x0001e551
--define_symbol sm_le_device_key=0x0001e88d
--define_symbol sm_passkey_input=0x0001e923
--define_symbol sm_private_random_address_generation_get=0x0001ecd1
--define_symbol sm_private_random_address_generation_get_mode=0x0001ecd9
--define_symbol sm_private_random_address_generation_set_mode=0x0001ece5
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ed0d
--define_symbol sm_register_oob_data_callback=0x0001ee49
--define_symbol sm_request_pairing=0x0001ee55
--define_symbol sm_send_security_request=0x0001f85b
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f881
--define_symbol sm_set_authentication_requirements=0x0001f88d
--define_symbol sm_set_encryption_key_size_range=0x0001f899
--define_symbol sscanf_bd_addr=0x0001fbe9
--define_symbol sysSetPublicDeviceAddr=0x0001ff51
--define_symbol uuid128_to_str=0x00020549
--define_symbol uuid_add_bluetooth_prefix=0x000205a1
--define_symbol uuid_has_bluetooth_prefix=0x000205c1
