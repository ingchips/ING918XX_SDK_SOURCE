...
--define_symbol nibble_for_char=0x0001ccd9
--define_symbol platform_32k_rc_auto_tune=0x0001cd75
--define_symbol platform_32k_rc_tune=0x0001cdf1
--define_symbol platform_calibrate_32k=0x0001ce05
--define_symbol platform_config=0x0001ce09
--define_symbol platform_controller_run=0x0001ced9
--define_symbol platform_get_task_handle=0x0001cf11
...
--define_symbol platform_init_controller=0x0001cf3d
--define_symbol platform_os_idle_resumed_hook=0x0001cf59
--define_symbol platform_patch_rf_init_data=0x0001cf5d
--define_symbol platform_post_sleep_processing=0x0001cf69
--define_symbol platform_pre_sleep_processing=0x0001cf6f
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001cf75
--define_symbol platform_printf=0x0001cf79
--define_symbol platform_raise_assertion=0x0001cf8d
--define_symbol platform_rand=0x0001cfa1
--define_symbol platform_read_info=0x0001cfa5
--define_symbol platform_read_persistent_reg=0x0001cfc1
--define_symbol platform_reset=0x0001cfd1
--define_symbol platform_set_evt_callback=0x0001cff5
--define_symbol platform_set_irq_callback=0x0001d009
--define_symbol platform_set_rf_clk_source=0x0001d041
--define_symbol platform_set_rf_init_data=0x0001d04d
--define_symbol platform_set_rf_power_mapping=0x0001d059
--define_symbol platform_set_timer=0x0001d065
...
--define_symbol platform_write_persistent_reg=0x0001d0b1
--define_symbol printf_hexdump=0x0001d0c1
--define_symbol reverse_128=0x0001d3fd
--define_symbol reverse_24=0x0001d403
--define_symbol reverse_48=0x0001d409
--define_symbol reverse_56=0x0001d40f
--define_symbol reverse_64=0x0001d415
--define_symbol reverse_bd_addr=0x0001d41b
--define_symbol reverse_bytes=0x0001d421
--define_symbol sm_add_event_handler=0x0001d58d
--define_symbol sm_address_resolution_lookup=0x0001d6e5
--define_symbol sm_authenticated=0x0001da3d
--define_symbol sm_authorization_decline=0x0001da4b
--define_symbol sm_authorization_grant=0x0001da6b
--define_symbol sm_authorization_state=0x0001da8b
--define_symbol sm_bonding_decline=0x0001daa5
--define_symbol sm_config=0x0001dec5
--define_symbol sm_config_conn=0x0001dedd
--define_symbol sm_encryption_key_size=0x0001e093
--define_symbol sm_just_works_confirm=0x0001e59d
--define_symbol sm_le_device_key=0x0001e8d9
--define_symbol sm_passkey_input=0x0001e96f
--define_symbol sm_private_random_address_generation_get=0x0001ed1d
--define_symbol sm_private_random_address_generation_get_mode=0x0001ed25
--define_symbol sm_private_random_address_generation_set_mode=0x0001ed31
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ed59
--define_symbol sm_register_oob_data_callback=0x0001ee95
--define_symbol sm_request_pairing=0x0001eea1
--define_symbol sm_send_security_request=0x0001f8bf
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f8e5
--define_symbol sm_set_authentication_requirements=0x0001f8f1
--define_symbol sm_set_encryption_key_size_range=0x0001f8fd
--define_symbol sscanf_bd_addr=0x0001fc59
--define_symbol sysSetPublicDeviceAddr=0x0001ffc1
