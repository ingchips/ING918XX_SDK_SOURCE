...
--define_symbol platform_controller_run=0x0001cf81
--define_symbol platform_get_task_handle=0x0001cfb9
--define_symbol platform_get_us_time=0x0001cfd1
--define_symbol platform_get_version=0x0001cfd5
--define_symbol platform_hrng=0x0001cfdd
--define_symbol platform_init_controller=0x0001cfe5
--define_symbol platform_os_idle_resumed_hook=0x0001d001
--define_symbol platform_patch_rf_init_data=0x0001d005
--define_symbol platform_post_sleep_processing=0x0001d011
--define_symbol platform_pre_sleep_processing=0x0001d017
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001d01d
...
--define_symbol reverse_128=0x0001d4a5
--define_symbol reverse_24=0x0001d4ab
--define_symbol reverse_48=0x0001d4b1
--define_symbol reverse_56=0x0001d4b7
--define_symbol reverse_64=0x0001d4bd
--define_symbol reverse_bd_addr=0x0001d4c3
--define_symbol reverse_bytes=0x0001d4c9
--define_symbol sm_add_event_handler=0x0001d635
--define_symbol sm_address_resolution_lookup=0x0001d78d
--define_symbol sm_authenticated=0x0001dae5
--define_symbol sm_authorization_decline=0x0001daf3
--define_symbol sm_authorization_grant=0x0001db13
--define_symbol sm_authorization_state=0x0001db33
--define_symbol sm_bonding_decline=0x0001db4d
--define_symbol sm_config=0x0001df6d
--define_symbol sm_config_conn=0x0001df85
--define_symbol sm_encryption_key_size=0x0001e13b
--define_symbol sm_just_works_confirm=0x0001e675
--define_symbol sm_le_device_key=0x0001e9b1
--define_symbol sm_passkey_input=0x0001ea47
--define_symbol sm_private_random_address_generation_get=0x0001edf5
--define_symbol sm_private_random_address_generation_get_mode=0x0001edfd
--define_symbol sm_private_random_address_generation_set_mode=0x0001ee09
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ee31
--define_symbol sm_register_oob_data_callback=0x0001ef6d
--define_symbol sm_request_pairing=0x0001ef79
--define_symbol sm_send_security_request=0x0001f997
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f9bd
--define_symbol sm_set_authentication_requirements=0x0001f9c9
--define_symbol sm_set_encryption_key_size_range=0x0001f9d5
--define_symbol sscanf_bd_addr=0x0001fd31
--define_symbol sysSetPublicDeviceAddr=0x00020099
--define_symbol uuid128_to_str=0x00020681
--define_symbol uuid_add_bluetooth_prefix=0x000206d9
--define_symbol uuid_has_bluetooth_prefix=0x000206f9
