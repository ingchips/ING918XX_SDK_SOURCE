...
--define_symbol l2cap_register_fixed_channel=0x0000c1a5
--define_symbol l2cap_register_packet_handler=0x0000c1c1
--define_symbol l2cap_register_service=0x0000c1cd
--define_symbol l2cap_request_can_send_fix_channel_now_event=0x0000c2b1
--define_symbol l2cap_request_can_send_now_event=0x0000c2d5
--define_symbol l2cap_request_connection_parameter_update=0x0000c2ef
--define_symbol l2cap_send=0x0000c689
--define_symbol l2cap_send_connectionless=0x0000c701
--define_symbol l2cap_send_connectionless3=0x0000c791
--define_symbol l2cap_send_echo_request=0x0000c829
--define_symbol l2cap_unregister_service=0x0000c8e5
--define_symbol le_device_db_add=0x0000c93d
--define_symbol le_device_db_find=0x0000ca11
--define_symbol le_device_db_from_key=0x0000ca3d
--define_symbol le_device_db_iter_cur=0x0000ca45
--define_symbol le_device_db_iter_cur_key=0x0000ca49
--define_symbol le_device_db_iter_init=0x0000ca4d
--define_symbol le_device_db_iter_next=0x0000ca55
--define_symbol le_device_db_remove_key=0x0000ca7b
--define_symbol ll_free=0x0000caa7
...
--define_symbol ll_set_conn_coded_scheme=0x0000ce25
--define_symbol ll_set_conn_latency=0x0000ce51
--define_symbol ll_set_conn_tx_power=0x0000ce81
--define_symbol ll_set_def_antenna=0x0000cec9
--define_symbol ll_set_initiating_coded_scheme=0x0000cee5
--define_symbol ll_set_max_conn_number=0x0000cef1
--define_symbol nibble_for_char=0x0001cd11
--define_symbol platform_32k_rc_auto_tune=0x0001cdad
--define_symbol platform_32k_rc_tune=0x0001ce29
--define_symbol platform_calibrate_32k=0x0001ce3d
--define_symbol platform_config=0x0001ce41
--define_symbol platform_controller_run=0x0001cf11
--define_symbol platform_get_task_handle=0x0001cf49
--define_symbol platform_get_us_time=0x0001cf61
--define_symbol platform_get_version=0x0001cf65
--define_symbol platform_hrng=0x0001cf6d
--define_symbol platform_init_controller=0x0001cf75
--define_symbol platform_os_idle_resumed_hook=0x0001cf91
--define_symbol platform_patch_rf_init_data=0x0001cf95
--define_symbol platform_post_sleep_processing=0x0001cfa1
--define_symbol platform_pre_sleep_processing=0x0001cfa7
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001cfad
...
--define_symbol platform_set_evt_callback=0x0001d02d
--define_symbol platform_set_irq_callback=0x0001d041
--define_symbol platform_set_rf_clk_source=0x0001d079
--define_symbol platform_set_rf_init_data=0x0001d085
--define_symbol platform_set_rf_power_mapping=0x0001d091
--define_symbol platform_set_timer=0x0001d09d
--define_symbol platform_shutdown=0x0001d0a1
--define_symbol platform_switch_app=0x0001d0a5
--define_symbol platform_trace_raw=0x0001d0d1
--define_symbol platform_write_persistent_reg=0x0001d0e9
--define_symbol printf_hexdump=0x0001d0f9
--define_symbol reverse_128=0x0001d435
--define_symbol reverse_24=0x0001d43b
--define_symbol reverse_48=0x0001d441
--define_symbol reverse_56=0x0001d447
--define_symbol reverse_64=0x0001d44d
--define_symbol reverse_bd_addr=0x0001d453
--define_symbol reverse_bytes=0x0001d459
--define_symbol sm_add_event_handler=0x0001d5c5
--define_symbol sm_address_resolution_lookup=0x0001d71d
--define_symbol sm_authenticated=0x0001da75
--define_symbol sm_authorization_decline=0x0001da83
--define_symbol sm_authorization_grant=0x0001daa3
--define_symbol sm_authorization_state=0x0001dac3
--define_symbol sm_bonding_decline=0x0001dadd
--define_symbol sm_config=0x0001defd
--define_symbol sm_config_conn=0x0001df15
--define_symbol sm_encryption_key_size=0x0001e0cb
--define_symbol sm_just_works_confirm=0x0001e5d5
--define_symbol sm_le_device_key=0x0001e911
--define_symbol sm_passkey_input=0x0001e9a7
--define_symbol sm_private_random_address_generation_get=0x0001ed55
--define_symbol sm_private_random_address_generation_get_mode=0x0001ed5d
--define_symbol sm_private_random_address_generation_set_mode=0x0001ed69
--define_symbol sm_private_random_address_generation_set_update_period=0x0001ed91
--define_symbol sm_register_oob_data_callback=0x0001eecd
--define_symbol sm_request_pairing=0x0001eed9
--define_symbol sm_send_security_request=0x0001f8f7
--define_symbol sm_set_accepted_stk_generation_methods=0x0001f91d
--define_symbol sm_set_authentication_requirements=0x0001f929
--define_symbol sm_set_encryption_key_size_range=0x0001f935
--define_symbol sscanf_bd_addr=0x0001fc91
--define_symbol sysSetPublicDeviceAddr=0x0001fff9
--define_symbol uuid128_to_str=0x000205e1
--define_symbol uuid_add_bluetooth_prefix=0x00020639
--define_symbol uuid_has_bluetooth_prefix=0x00020659
