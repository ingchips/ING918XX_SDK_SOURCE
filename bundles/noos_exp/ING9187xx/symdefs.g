...
platform_controller_run = 0x0001e575;
platform_get_task_handle = 0x0001e5ad;
platform_get_us_time = 0x0001e5c5;
platform_get_version = 0x0001e5c9;
platform_hrng = 0x0001e5d1;
platform_init_controller = 0x0001e5d9;
platform_os_idle_resumed_hook = 0x0001e5f5;
platform_patch_rf_init_data = 0x0001e5f9;
platform_post_sleep_processing = 0x0001e605;
platform_pre_sleep_processing = 0x0001e60b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001e611;
platform_printf = 0x0001e615;
platform_raise_assertion = 0x0001e629;
platform_rand = 0x0001e63d;
platform_read_info = 0x0001e641;
platform_read_persistent_reg = 0x0001e65d;
platform_reset = 0x0001e66d;
...
platform_set_timer = 0x0001e701;
platform_shutdown = 0x0001e705;
platform_switch_app = 0x0001e709;
platform_trace_raw = 0x0001e735;
platform_write_persistent_reg = 0x0001e74d;
printf_hexdump = 0x0001e75d;
reverse_128 = 0x0001ea99;
reverse_24 = 0x0001ea9f;
reverse_48 = 0x0001eaa5;
reverse_56 = 0x0001eaab;
reverse_64 = 0x0001eab1;
reverse_bd_addr = 0x0001eab7;
reverse_bytes = 0x0001eabd;
sm_add_event_handler = 0x0001ec29;
sm_address_resolution_lookup = 0x0001ed81;
sm_authenticated = 0x0001f0d9;
sm_authorization_decline = 0x0001f0e7;
sm_authorization_grant = 0x0001f107;
sm_authorization_state = 0x0001f127;
sm_bonding_decline = 0x0001f141;
sm_config = 0x0001f561;
sm_config_conn = 0x0001f579;
sm_encryption_key_size = 0x0001f72f;
sm_just_works_confirm = 0x0001fc39;
sm_le_device_key = 0x0001ff75;
sm_passkey_input = 0x0002000b;
sm_private_random_address_generation_get = 0x000203b9;
sm_private_random_address_generation_get_mode = 0x000203c1;
sm_private_random_address_generation_set_mode = 0x000203cd;
sm_private_random_address_generation_set_update_period = 0x000203f5;
sm_register_oob_data_callback = 0x00020531;
sm_request_pairing = 0x0002053d;
sm_send_security_request = 0x00020f5b;
sm_set_accepted_stk_generation_methods = 0x00020f81;
sm_set_authentication_requirements = 0x00020f8d;
sm_set_encryption_key_size_range = 0x00020f99;
sscanf_bd_addr = 0x000212f5;
sysSetPublicDeviceAddr = 0x0002165d;
uuid128_to_str = 0x00021c6d;
uuid_add_bluetooth_prefix = 0x00021cc5;
uuid_has_bluetooth_prefix = 0x00021ce5;
