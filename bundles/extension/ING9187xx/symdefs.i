...
--define_symbol nibble_for_char=0x0001d52d
--define_symbol platform_32k_rc_auto_tune=0x0001d5c9
--define_symbol platform_32k_rc_tune=0x0001d645
--define_symbol platform_calibrate_32k=0x0001d659
--define_symbol platform_config=0x0001d65d
--define_symbol platform_get_heap_status=0x0001d715
--define_symbol platform_get_us_time=0x0001d72d
--define_symbol platform_get_version=0x0001d731
--define_symbol platform_hrng=0x0001d739
--define_symbol platform_install_isr_stack=0x0001d741
--define_symbol platform_patch_rf_init_data=0x0001d74d
--define_symbol platform_printf=0x0001d759
--define_symbol platform_raise_assertion=0x0001d76d
--define_symbol platform_rand=0x0001d781
--define_symbol platform_read_info=0x0001d785
--define_symbol platform_read_persistent_reg=0x0001d7a1
--define_symbol platform_reset=0x0001d7b1
--define_symbol platform_set_evt_callback=0x0001d7e5
--define_symbol platform_set_irq_callback=0x0001d7f9
--define_symbol platform_set_rf_clk_source=0x0001d831
--define_symbol platform_set_rf_init_data=0x0001d83d
--define_symbol platform_set_rf_power_mapping=0x0001d849
--define_symbol platform_shutdown=0x0001d855
--define_symbol platform_switch_app=0x0001d859
--define_symbol platform_trace_raw=0x0001d885
--define_symbol platform_write_persistent_reg=0x0001d899
--define_symbol printf_hexdump=0x0001d8a9
--define_symbol pvPortMalloc=0x0001e3ad
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e495
--define_symbol pvTimerGetTimerID=0x0001e4ad
--define_symbol pxPortInitialiseStack=0x0001e4d9
--define_symbol reverse_128=0x0001e681
--define_symbol reverse_24=0x0001e687
--define_symbol reverse_48=0x0001e68d
--define_symbol reverse_56=0x0001e693
--define_symbol reverse_64=0x0001e699
--define_symbol reverse_bd_addr=0x0001e69f
--define_symbol reverse_bytes=0x0001e6a5
--define_symbol sm_add_event_handler=0x0001e811
--define_symbol sm_address_resolution_lookup=0x0001e93d
--define_symbol sm_authenticated=0x0001ec89
--define_symbol sm_authorization_decline=0x0001ec97
--define_symbol sm_authorization_grant=0x0001ecb7
--define_symbol sm_authorization_state=0x0001ecd7
--define_symbol sm_bonding_decline=0x0001ecf1
--define_symbol sm_config=0x0001f0bd
--define_symbol sm_config_conn=0x0001f0d5
--define_symbol sm_encryption_key_size=0x0001f233
--define_symbol sm_just_works_confirm=0x0001f659
--define_symbol sm_le_device_key=0x0001f885
--define_symbol sm_passkey_input=0x0001f91b
--define_symbol sm_private_random_address_generation_get=0x0001fc61
--define_symbol sm_private_random_address_generation_get_mode=0x0001fc69
--define_symbol sm_private_random_address_generation_set_mode=0x0001fc75
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fc9d
--define_symbol sm_register_oob_data_callback=0x0001fdd9
--define_symbol sm_request_pairing=0x0001fde5
--define_symbol sm_send_security_request=0x00020723
...
--define_symbol sscanf_bd_addr=0x00020a35
--define_symbol sysSetPublicDeviceAddr=0x00020d79
--define_symbol uuid128_to_str=0x00021351
--define_symbol uuid_add_bluetooth_prefix=0x000213a9
--define_symbol uuid_has_bluetooth_prefix=0x000213c9
--define_symbol uxQueueMessagesWaiting=0x0002140d
--define_symbol uxQueueMessagesWaitingFromISR=0x00021435
--define_symbol uxQueueSpacesAvailable=0x00021451
--define_symbol uxTaskGetStackHighWaterMark=0x0002147d
--define_symbol vPortEnterCritical=0x000215a1
--define_symbol vPortExitCritical=0x000215e1
...
--define_symbol vQueueDelete=0x000217cd
--define_symbol vQueueWaitForMessageRestricted=0x000217f9
--define_symbol vTaskDelay=0x00021841
--define_symbol vTaskInternalSetTimeOutState=0x0002188d
--define_symbol vTaskMissedYield=0x0002189d
--define_symbol vTaskPlaceOnEventList=0x000218a9
--define_symbol vTaskPlaceOnEventListRestricted=0x000218e1
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021921
--define_symbol vTaskResume=0x000219cd
--define_symbol vTaskStartScheduler=0x00021a51
--define_symbol vTaskStepTick=0x00021ae1
--define_symbol vTaskSuspend=0x00021b11
--define_symbol vTaskSuspendAll=0x00021bcd
--define_symbol vTaskSwitchContext=0x00021bdd
--define_symbol xPortStartScheduler=0x00021c85
