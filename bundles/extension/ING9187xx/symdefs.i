...
--define_symbol ll_config=0x0000d069
--define_symbol ll_free=0x0000d075
--define_symbol ll_hint_on_ce_len=0x0000d081
--define_symbol ll_legacy_adv_set_interval=0x0000d0c1
--define_symbol ll_malloc=0x0000d0d1
--define_symbol ll_query_timing_info=0x0000d209
--define_symbol ll_raw_packet_alloc=0x0000d255
--define_symbol ll_raw_packet_free=0x0000d309
--define_symbol ll_raw_packet_get_rx_data=0x0000d333
--define_symbol ll_raw_packet_recv=0x0000d3c9
--define_symbol ll_raw_packet_send=0x0000d45d
--define_symbol ll_raw_packet_set_param=0x0000d4cd
--define_symbol ll_raw_packet_set_tx_data=0x0000d533
--define_symbol ll_scan_set_fixed_channel=0x0000d5f5
--define_symbol ll_set_adv_access_address=0x0000d709
--define_symbol ll_set_adv_coded_scheme=0x0000d715
--define_symbol ll_set_conn_coded_scheme=0x0000d745
...
--define_symbol platform_32k_rc_auto_tune=0x0001d67d
--define_symbol platform_32k_rc_tune=0x0001d6f9
--define_symbol platform_calibrate_32k=0x0001d70d
--define_symbol platform_config=0x0001d711
--define_symbol platform_get_heap_status=0x0001d7d1
--define_symbol platform_get_us_time=0x0001d7e9
--define_symbol platform_get_version=0x0001d7ed
--define_symbol platform_hrng=0x0001d7f5
--define_symbol platform_install_isr_stack=0x0001d7fd
--define_symbol platform_patch_rf_init_data=0x0001d809
--define_symbol platform_printf=0x0001d815
--define_symbol platform_raise_assertion=0x0001d829
--define_symbol platform_rand=0x0001d83d
--define_symbol platform_read_info=0x0001d841
--define_symbol platform_read_persistent_reg=0x0001d85d
--define_symbol platform_reset=0x0001d86d
--define_symbol platform_set_evt_callback=0x0001d8a1
--define_symbol platform_set_irq_callback=0x0001d8b5
--define_symbol platform_set_rf_clk_source=0x0001d8ed
--define_symbol platform_set_rf_init_data=0x0001d8f9
--define_symbol platform_set_rf_power_mapping=0x0001d905
--define_symbol platform_shutdown=0x0001d911
--define_symbol platform_switch_app=0x0001d915
--define_symbol platform_trace_raw=0x0001d941
--define_symbol platform_write_persistent_reg=0x0001d959
--define_symbol printf_hexdump=0x0001d969
...
--define_symbol reverse_48=0x0001e751
--define_symbol reverse_56=0x0001e757
--define_symbol reverse_64=0x0001e75d
--define_symbol reverse_bd_addr=0x0001e763
--define_symbol reverse_bytes=0x0001e769
--define_symbol sm_add_event_handler=0x0001e8d5
--define_symbol sm_address_resolution_lookup=0x0001ea2d
--define_symbol sm_authenticated=0x0001ed79
--define_symbol sm_authorization_decline=0x0001ed87
--define_symbol sm_authorization_grant=0x0001eda7
--define_symbol sm_authorization_state=0x0001edc7
--define_symbol sm_bonding_decline=0x0001ede1
--define_symbol sm_config=0x0001f201
--define_symbol sm_config_conn=0x0001f219
--define_symbol sm_encryption_key_size=0x0001f39f
--define_symbol sm_just_works_confirm=0x0001f8cd
--define_symbol sm_le_device_key=0x0001fc09
--define_symbol sm_passkey_input=0x0001fc9f
--define_symbol sm_private_random_address_generation_get=0x00020045
--define_symbol sm_private_random_address_generation_get_mode=0x0002004d
--define_symbol sm_private_random_address_generation_set_mode=0x00020059
--define_symbol sm_private_random_address_generation_set_update_period=0x00020081
--define_symbol sm_register_oob_data_callback=0x000201bd
--define_symbol sm_request_pairing=0x000201c9
--define_symbol sm_send_security_request=0x00020bc3
--define_symbol sm_set_accepted_stk_generation_methods=0x00020be9
--define_symbol sm_set_authentication_requirements=0x00020bf5
--define_symbol sm_set_encryption_key_size_range=0x00020c01
--define_symbol sscanf_bd_addr=0x00020f5d
--define_symbol sysSetPublicDeviceAddr=0x000212c5
--define_symbol uuid128_to_str=0x000218b9
--define_symbol uuid_add_bluetooth_prefix=0x00021911
--define_symbol uuid_has_bluetooth_prefix=0x00021931
--define_symbol uxQueueMessagesWaiting=0x00021975
--define_symbol uxQueueMessagesWaitingFromISR=0x0002199d
--define_symbol uxQueueSpacesAvailable=0x000219b9
--define_symbol uxTaskGetStackHighWaterMark=0x000219e5
--define_symbol vPortEnterCritical=0x00021af1
--define_symbol vPortExitCritical=0x00021b35
--define_symbol vPortFree=0x00021b65
--define_symbol vPortSuppressTicksAndSleep=0x00021bf9
--define_symbol vPortValidateInterruptPriority=0x00021d19
--define_symbol vQueueDelete=0x00021d71
--define_symbol vQueueWaitForMessageRestricted=0x00021d9d
--define_symbol vTaskDelay=0x00021de5
--define_symbol vTaskInternalSetTimeOutState=0x00021e31
--define_symbol vTaskMissedYield=0x00021e41
--define_symbol vTaskPlaceOnEventList=0x00021e4d
--define_symbol vTaskPlaceOnEventListRestricted=0x00021e85
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021ec5
--define_symbol vTaskResume=0x00021f71
--define_symbol vTaskStartScheduler=0x00021ff5
--define_symbol vTaskStepTick=0x00022085
--define_symbol vTaskSuspend=0x000220b5
--define_symbol vTaskSuspendAll=0x00022171
--define_symbol vTaskSwitchContext=0x00022181
--define_symbol xPortStartScheduler=0x00022229
--define_symbol xQueueAddToSet=0x000222ed
--define_symbol xQueueCreateCountingSemaphore=0x00022311
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002234d
--define_symbol xQueueCreateMutex=0x00022391
--define_symbol xQueueCreateMutexStatic=0x000223a7
--define_symbol xQueueCreateSet=0x000223c1
--define_symbol xQueueGenericCreate=0x000223c9
--define_symbol xQueueGenericCreateStatic=0x00022415
--define_symbol xQueueGenericReset=0x0002247d
--define_symbol xQueueGenericSend=0x00022509
--define_symbol xQueueGenericSendFromISR=0x00022675
--define_symbol xQueueGiveFromISR=0x00022735
--define_symbol xQueueGiveMutexRecursive=0x000227d9
--define_symbol xQueueIsQueueEmptyFromISR=0x00022819
--define_symbol xQueueIsQueueFullFromISR=0x0002283d
--define_symbol xQueuePeek=0x00022865
--define_symbol xQueuePeekFromISR=0x0002298d
--define_symbol xQueueReceive=0x000229f9
--define_symbol xQueueReceiveFromISR=0x00022b25
--define_symbol xQueueRemoveFromSet=0x00022bb9
--define_symbol xQueueSelectFromSet=0x00022bdb
--define_symbol xQueueSelectFromSetFromISR=0x00022bed
--define_symbol xQueueSemaphoreTake=0x00022c01
--define_symbol xQueueTakeMutexRecursive=0x00022d6d
--define_symbol xTaskCheckForTimeOut=0x00022db1
--define_symbol xTaskCreate=0x00022e21
--define_symbol xTaskCreateStatic=0x00022e7d
--define_symbol xTaskGetCurrentTaskHandle=0x00022eed
--define_symbol xTaskGetSchedulerState=0x00022ef9
--define_symbol xTaskGetTickCount=0x00022f15
--define_symbol xTaskGetTickCountFromISR=0x00022f21
--define_symbol xTaskIncrementTick=0x00022f31
--define_symbol xTaskPriorityDisinherit=0x00022ffd
--define_symbol xTaskPriorityInherit=0x00023091
--define_symbol xTaskRemoveFromEventList=0x00023125
--define_symbol xTaskResumeAll=0x000231a5
--define_symbol xTaskResumeFromISR=0x0002326d
--define_symbol xTimerCreate=0x000232f9
--define_symbol xTimerCreateStatic=0x0002332d
--define_symbol xTimerCreateTimerTask=0x00023365
--define_symbol xTimerGenericCommand=0x000233d1
--define_symbol xTimerGetExpiryTime=0x00023441
