...
--define_symbol nibble_for_char=0x0001d41d
--define_symbol platform_32k_rc_auto_tune=0x0001d4b9
--define_symbol platform_32k_rc_tune=0x0001d535
--define_symbol platform_calibrate_32k=0x0001d549
--define_symbol platform_config=0x0001d54d
--define_symbol platform_get_heap_status=0x0001d605
--define_symbol platform_get_us_time=0x0001d61d
--define_symbol platform_get_version=0x0001d621
--define_symbol platform_hrng=0x0001d629
--define_symbol platform_install_isr_stack=0x0001d631
--define_symbol platform_patch_rf_init_data=0x0001d63d
...
--define_symbol platform_read_persistent_reg=0x0001d691
--define_symbol platform_reset=0x0001d6a1
--define_symbol platform_set_evt_callback=0x0001d6d5
--define_symbol platform_set_irq_callback=0x0001d6e9
--define_symbol platform_set_rf_clk_source=0x0001d721
--define_symbol platform_set_rf_init_data=0x0001d72d
--define_symbol platform_set_rf_power_mapping=0x0001d739
--define_symbol platform_shutdown=0x0001d745
--define_symbol platform_switch_app=0x0001d749
--define_symbol platform_trace_raw=0x0001d775
--define_symbol platform_write_persistent_reg=0x0001d789
--define_symbol printf_hexdump=0x0001d799
--define_symbol pvPortMalloc=0x0001e265
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e34d
--define_symbol pvTimerGetTimerID=0x0001e365
--define_symbol pxPortInitialiseStack=0x0001e391
--define_symbol reverse_128=0x0001e539
--define_symbol reverse_24=0x0001e53f
--define_symbol reverse_48=0x0001e545
--define_symbol reverse_56=0x0001e54b
--define_symbol reverse_64=0x0001e551
--define_symbol reverse_bd_addr=0x0001e557
--define_symbol reverse_bytes=0x0001e55d
--define_symbol sm_add_event_handler=0x0001e6c9
--define_symbol sm_address_resolution_lookup=0x0001e7f5
--define_symbol sm_authenticated=0x0001e8cf
--define_symbol sm_authorization_decline=0x0001e8dd
--define_symbol sm_authorization_grant=0x0001e8fd
--define_symbol sm_authorization_state=0x0001e91d
--define_symbol sm_bonding_decline=0x0001e939
--define_symbol sm_config=0x0001ed11
--define_symbol sm_encryption_key_size=0x0001ee1d
--define_symbol sm_just_works_confirm=0x0001f5d1
--define_symbol sm_le_device_key=0x0001f829
--define_symbol sm_passkey_input=0x0001f8c1
--define_symbol sm_private_random_address_generation_get=0x0001fc4d
--define_symbol sm_private_random_address_generation_get_mode=0x0001fc55
--define_symbol sm_private_random_address_generation_set_mode=0x0001fc61
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fc89
--define_symbol sm_register_oob_data_callback=0x0001fcc1
--define_symbol sm_request_pairing=0x0001fccd
--define_symbol sm_send_security_request=0x0002071d
--define_symbol sm_set_accepted_stk_generation_methods=0x00020745
--define_symbol sm_set_authentication_requirements=0x00020751
--define_symbol sm_set_encryption_key_size_range=0x0002075d
--define_symbol sscanf_bd_addr=0x00020a4d
--define_symbol sysSetPublicDeviceAddr=0x00020d91
--define_symbol uuid128_to_str=0x00021339
--define_symbol uuid_add_bluetooth_prefix=0x00021391
--define_symbol uuid_has_bluetooth_prefix=0x000213b1
--define_symbol uxQueueMessagesWaiting=0x000213f5
--define_symbol uxQueueMessagesWaitingFromISR=0x0002141d
--define_symbol uxQueueSpacesAvailable=0x00021439
--define_symbol uxTaskGetStackHighWaterMark=0x00021465
--define_symbol vPortEnterCritical=0x00021589
--define_symbol vPortExitCritical=0x000215c9
--define_symbol vPortFree=0x000215f5
--define_symbol vPortSuppressTicksAndSleep=0x00021689
--define_symbol vPortValidateInterruptPriority=0x00021761
--define_symbol vQueueDelete=0x000217b5
--define_symbol vQueueWaitForMessageRestricted=0x000217e1
--define_symbol vTaskDelay=0x00021829
--define_symbol vTaskInternalSetTimeOutState=0x00021875
--define_symbol vTaskMissedYield=0x00021885
--define_symbol vTaskPlaceOnEventList=0x00021891
--define_symbol vTaskPlaceOnEventListRestricted=0x000218c9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021909
--define_symbol vTaskStartScheduler=0x000219b5
--define_symbol vTaskStepTick=0x00021a45
--define_symbol vTaskSuspendAll=0x00021a75
--define_symbol vTaskSwitchContext=0x00021a85
--define_symbol xPortStartScheduler=0x00021b2d
--define_symbol xQueueAddToSet=0x00021be9
--define_symbol xQueueCreateCountingSemaphore=0x00021c0d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021c49
--define_symbol xQueueCreateMutex=0x00021c8d
--define_symbol xQueueCreateMutexStatic=0x00021ca3
--define_symbol xQueueCreateSet=0x00021cbd
--define_symbol xQueueGenericCreate=0x00021cc5
--define_symbol xQueueGenericCreateStatic=0x00021d11
--define_symbol xQueueGenericReset=0x00021d79
--define_symbol xQueueGenericSend=0x00021e05
--define_symbol xQueueGenericSendFromISR=0x00021f71
--define_symbol xQueueGiveFromISR=0x00022031
--define_symbol xQueueGiveMutexRecursive=0x000220d5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022115
--define_symbol xQueueIsQueueFullFromISR=0x00022139
--define_symbol xQueuePeek=0x00022161
--define_symbol xQueuePeekFromISR=0x00022289
--define_symbol xQueueReceive=0x000222f5
--define_symbol xQueueReceiveFromISR=0x00022421
--define_symbol xQueueRemoveFromSet=0x000224b5
--define_symbol xQueueSelectFromSet=0x000224d7
--define_symbol xQueueSelectFromSetFromISR=0x000224e9
--define_symbol xQueueSemaphoreTake=0x000224fd
--define_symbol xQueueTakeMutexRecursive=0x00022669
--define_symbol xTaskCheckForTimeOut=0x000226ad
--define_symbol xTaskCreate=0x0002271d
--define_symbol xTaskCreateStatic=0x00022779
--define_symbol xTaskGetCurrentTaskHandle=0x000227e9
--define_symbol xTaskGetSchedulerState=0x000227f5
--define_symbol xTaskGetTickCount=0x00022811
--define_symbol xTaskGetTickCountFromISR=0x0002281d
--define_symbol xTaskIncrementTick=0x0002282d
--define_symbol xTaskPriorityDisinherit=0x000228f9
--define_symbol xTaskPriorityInherit=0x0002298d
--define_symbol xTaskRemoveFromEventList=0x00022a21
--define_symbol xTaskResumeAll=0x00022aa1
--define_symbol xTimerCreate=0x00022b69
--define_symbol xTimerCreateStatic=0x00022b9d
--define_symbol xTimerCreateTimerTask=0x00022bd5
--define_symbol xTimerGenericCommand=0x00022c41
--define_symbol xTimerGetExpiryTime=0x00022cb1
