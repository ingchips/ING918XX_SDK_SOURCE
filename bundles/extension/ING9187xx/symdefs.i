...
--define_symbol nibble_for_char=0x0001d5b9
--define_symbol platform_32k_rc_auto_tune=0x0001d655
--define_symbol platform_32k_rc_tune=0x0001d6d1
--define_symbol platform_calibrate_32k=0x0001d6e5
--define_symbol platform_config=0x0001d6e9
--define_symbol platform_get_heap_status=0x0001d7a1
--define_symbol platform_get_us_time=0x0001d7b9
--define_symbol platform_get_version=0x0001d7bd
--define_symbol platform_hrng=0x0001d7c5
--define_symbol platform_install_isr_stack=0x0001d7cd
--define_symbol platform_patch_rf_init_data=0x0001d7d9
--define_symbol platform_printf=0x0001d7e5
--define_symbol platform_raise_assertion=0x0001d7f9
--define_symbol platform_rand=0x0001d80d
--define_symbol platform_read_info=0x0001d811
--define_symbol platform_read_persistent_reg=0x0001d82d
--define_symbol platform_reset=0x0001d83d
--define_symbol platform_set_evt_callback=0x0001d871
--define_symbol platform_set_irq_callback=0x0001d885
--define_symbol platform_set_rf_clk_source=0x0001d8bd
--define_symbol platform_set_rf_init_data=0x0001d8c9
--define_symbol platform_set_rf_power_mapping=0x0001d8d5
--define_symbol platform_shutdown=0x0001d8e1
--define_symbol platform_switch_app=0x0001d8e5
--define_symbol platform_trace_raw=0x0001d911
--define_symbol platform_write_persistent_reg=0x0001d925
--define_symbol printf_hexdump=0x0001d935
--define_symbol pvPortMalloc=0x0001e439
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e521
--define_symbol pvTimerGetTimerID=0x0001e539
--define_symbol pxPortInitialiseStack=0x0001e565
--define_symbol reverse_128=0x0001e70d
--define_symbol reverse_24=0x0001e713
--define_symbol reverse_48=0x0001e719
--define_symbol reverse_56=0x0001e71f
--define_symbol reverse_64=0x0001e725
--define_symbol reverse_bd_addr=0x0001e72b
--define_symbol reverse_bytes=0x0001e731
--define_symbol sm_add_event_handler=0x0001e89d
--define_symbol sm_address_resolution_lookup=0x0001e9c9
--define_symbol sm_authenticated=0x0001ed15
--define_symbol sm_authorization_decline=0x0001ed23
--define_symbol sm_authorization_grant=0x0001ed43
--define_symbol sm_authorization_state=0x0001ed63
--define_symbol sm_bonding_decline=0x0001ed7d
--define_symbol sm_config=0x0001f149
--define_symbol sm_config_conn=0x0001f161
--define_symbol sm_encryption_key_size=0x0001f2bf
--define_symbol sm_just_works_confirm=0x0001f6e5
--define_symbol sm_le_device_key=0x0001f911
--define_symbol sm_passkey_input=0x0001f9a7
--define_symbol sm_private_random_address_generation_get=0x0001fced
--define_symbol sm_private_random_address_generation_get_mode=0x0001fcf5
--define_symbol sm_private_random_address_generation_set_mode=0x0001fd01
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fd29
--define_symbol sm_register_oob_data_callback=0x0001fe65
--define_symbol sm_request_pairing=0x0001fe71
--define_symbol sm_send_security_request=0x000207af
--define_symbol sm_set_accepted_stk_generation_methods=0x000207d5
--define_symbol sm_set_authentication_requirements=0x000207e1
--define_symbol sm_set_encryption_key_size_range=0x000207ed
--define_symbol sscanf_bd_addr=0x00020ac1
--define_symbol sysSetPublicDeviceAddr=0x00020df9
--define_symbol uuid128_to_str=0x000213d1
--define_symbol uuid_add_bluetooth_prefix=0x00021429
--define_symbol uuid_has_bluetooth_prefix=0x00021449
--define_symbol uxQueueMessagesWaiting=0x0002148d
--define_symbol uxQueueMessagesWaitingFromISR=0x000214b5
--define_symbol uxQueueSpacesAvailable=0x000214d1
--define_symbol uxTaskGetStackHighWaterMark=0x000214fd
--define_symbol vPortEnterCritical=0x00021621
--define_symbol vPortExitCritical=0x00021661
--define_symbol vPortFree=0x0002168d
--define_symbol vPortSuppressTicksAndSleep=0x00021721
--define_symbol vPortValidateInterruptPriority=0x000217f9
--define_symbol vQueueDelete=0x0002184d
--define_symbol vQueueWaitForMessageRestricted=0x00021879
--define_symbol vTaskDelay=0x000218c1
--define_symbol vTaskInternalSetTimeOutState=0x0002190d
--define_symbol vTaskMissedYield=0x0002191d
--define_symbol vTaskPlaceOnEventList=0x00021929
--define_symbol vTaskPlaceOnEventListRestricted=0x00021961
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000219a1
...
--define_symbol xQueueAddToSet=0x00021dc1
--define_symbol xQueueCreateCountingSemaphore=0x00021de5
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021e21
--define_symbol xQueueCreateMutex=0x00021e65
--define_symbol xQueueCreateMutexStatic=0x00021e7b
--define_symbol xQueueCreateSet=0x00021e95
--define_symbol xQueueGenericCreate=0x00021e9d
--define_symbol xQueueGenericCreateStatic=0x00021ee9
--define_symbol xQueueGenericReset=0x00021f51
--define_symbol xQueueGenericSend=0x00021fdd
--define_symbol xQueueGenericSendFromISR=0x00022149
--define_symbol xQueueGiveFromISR=0x00022209
--define_symbol xQueueGiveMutexRecursive=0x000222ad
--define_symbol xQueueIsQueueEmptyFromISR=0x000222ed
--define_symbol xQueueIsQueueFullFromISR=0x00022311
--define_symbol xQueuePeek=0x00022339
--define_symbol xQueuePeekFromISR=0x00022461
--define_symbol xQueueReceive=0x000224cd
--define_symbol xQueueReceiveFromISR=0x000225f9
--define_symbol xQueueRemoveFromSet=0x0002268d
--define_symbol xQueueSelectFromSet=0x000226af
--define_symbol xQueueSelectFromSetFromISR=0x000226c1
--define_symbol xQueueSemaphoreTake=0x000226d5
--define_symbol xQueueTakeMutexRecursive=0x00022841
--define_symbol xTaskCheckForTimeOut=0x00022885
--define_symbol xTaskCreate=0x000228f5
--define_symbol xTaskCreateStatic=0x00022951
--define_symbol xTaskGetCurrentTaskHandle=0x000229c1
--define_symbol xTaskGetSchedulerState=0x000229cd
--define_symbol xTaskGetTickCount=0x000229e9
--define_symbol xTaskGetTickCountFromISR=0x000229f5
--define_symbol xTaskIncrementTick=0x00022a05
--define_symbol xTaskPriorityDisinherit=0x00022ad1
--define_symbol xTaskPriorityInherit=0x00022b65
--define_symbol xTaskRemoveFromEventList=0x00022bf9
--define_symbol xTaskResumeAll=0x00022c79
--define_symbol xTaskResumeFromISR=0x00022d41
--define_symbol xTimerCreate=0x00022dcd
--define_symbol xTimerCreateStatic=0x00022e01
--define_symbol xTimerCreateTimerTask=0x00022e39
--define_symbol xTimerGenericCommand=0x00022ea5
--define_symbol xTimerGetExpiryTime=0x00022f15
