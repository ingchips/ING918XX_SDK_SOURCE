...
--define_symbol platform_32k_rc_auto_tune=0x0001d435
--define_symbol platform_32k_rc_tune=0x0001d4b1
--define_symbol platform_calibrate_32k=0x0001d4c5
--define_symbol platform_config=0x0001d4c9
--define_symbol platform_get_heap_status=0x0001d581
--define_symbol platform_get_us_time=0x0001d599
--define_symbol platform_get_version=0x0001d59d
--define_symbol platform_hrng=0x0001d5a5
--define_symbol platform_install_isr_stack=0x0001d5ad
--define_symbol platform_patch_rf_init_data=0x0001d5b9
--define_symbol platform_printf=0x0001d5c5
--define_symbol platform_raise_assertion=0x0001d5d9
--define_symbol platform_rand=0x0001d5ed
--define_symbol platform_read_info=0x0001d5f1
--define_symbol platform_read_persistent_reg=0x0001d60d
--define_symbol platform_reset=0x0001d61d
--define_symbol platform_set_evt_callback=0x0001d651
--define_symbol platform_set_irq_callback=0x0001d665
--define_symbol platform_set_rf_clk_source=0x0001d69d
--define_symbol platform_set_rf_init_data=0x0001d6a9
--define_symbol platform_set_rf_power_mapping=0x0001d6b5
--define_symbol platform_shutdown=0x0001d6c1
--define_symbol platform_switch_app=0x0001d6c5
--define_symbol platform_trace_raw=0x0001d6f1
--define_symbol platform_write_persistent_reg=0x0001d705
--define_symbol printf_hexdump=0x0001d715
--define_symbol pvPortMalloc=0x0001e1dd
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e2c5
--define_symbol pvTimerGetTimerID=0x0001e2dd
--define_symbol pxPortInitialiseStack=0x0001e309
--define_symbol reverse_128=0x0001e4b1
--define_symbol reverse_24=0x0001e4b7
--define_symbol reverse_48=0x0001e4bd
--define_symbol reverse_56=0x0001e4c3
--define_symbol reverse_64=0x0001e4c9
--define_symbol reverse_bd_addr=0x0001e4cf
--define_symbol reverse_bytes=0x0001e4d5
--define_symbol sm_add_event_handler=0x0001e641
--define_symbol sm_address_resolution_lookup=0x0001e76d
--define_symbol sm_authenticated=0x0001e847
--define_symbol sm_authorization_decline=0x0001e855
--define_symbol sm_authorization_grant=0x0001e875
--define_symbol sm_authorization_state=0x0001e895
--define_symbol sm_bonding_decline=0x0001e8b1
--define_symbol sm_config=0x0001ec89
--define_symbol sm_encryption_key_size=0x0001ed95
--define_symbol sm_just_works_confirm=0x0001f54d
--define_symbol sm_le_device_key=0x0001f7a5
--define_symbol sm_passkey_input=0x0001f83d
--define_symbol sm_private_random_address_generation_get=0x0001fbc9
--define_symbol sm_private_random_address_generation_get_mode=0x0001fbd1
--define_symbol sm_private_random_address_generation_set_mode=0x0001fbdd
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fc05
--define_symbol sm_register_oob_data_callback=0x0001fc3d
--define_symbol sm_request_pairing=0x0001fc49
--define_symbol sm_send_security_request=0x00020699
--define_symbol sm_set_accepted_stk_generation_methods=0x000206c1
--define_symbol sm_set_authentication_requirements=0x000206cd
--define_symbol sm_set_encryption_key_size_range=0x000206d9
--define_symbol sscanf_bd_addr=0x000209c9
--define_symbol sysSetPublicDeviceAddr=0x00020d31
--define_symbol uuid128_to_str=0x000212d5
--define_symbol uuid_add_bluetooth_prefix=0x0002132d
--define_symbol uuid_has_bluetooth_prefix=0x0002134d
--define_symbol uxQueueMessagesWaiting=0x00021391
--define_symbol uxQueueMessagesWaitingFromISR=0x000213b9
--define_symbol uxQueueSpacesAvailable=0x000213d5
--define_symbol uxTaskGetStackHighWaterMark=0x00021401
--define_symbol vPortEnterCritical=0x000214b9
--define_symbol vPortExitCritical=0x000214f9
--define_symbol vPortFree=0x00021525
--define_symbol vPortSuppressTicksAndSleep=0x000215b9
--define_symbol vPortValidateInterruptPriority=0x00021691
--define_symbol vQueueDelete=0x000216e5
--define_symbol vQueueWaitForMessageRestricted=0x00021711
--define_symbol vTaskDelay=0x00021759
--define_symbol vTaskInternalSetTimeOutState=0x000217a5
--define_symbol vTaskMissedYield=0x000217b5
--define_symbol vTaskPlaceOnEventList=0x000217c1
--define_symbol vTaskPlaceOnEventListRestricted=0x000217f9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021839
--define_symbol vTaskStartScheduler=0x000218e5
--define_symbol vTaskStepTick=0x00021975
--define_symbol vTaskSuspendAll=0x000219a5
--define_symbol vTaskSwitchContext=0x000219b5
--define_symbol xPortStartScheduler=0x00021a5d
--define_symbol xQueueAddToSet=0x00021b19
--define_symbol xQueueCreateCountingSemaphore=0x00021b3d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021b79
--define_symbol xQueueCreateMutex=0x00021bbd
--define_symbol xQueueCreateMutexStatic=0x00021bd3
--define_symbol xQueueCreateSet=0x00021bed
--define_symbol xQueueGenericCreate=0x00021bf5
--define_symbol xQueueGenericCreateStatic=0x00021c41
--define_symbol xQueueGenericReset=0x00021ca9
--define_symbol xQueueGenericSend=0x00021d35
--define_symbol xQueueGenericSendFromISR=0x00021ea1
--define_symbol xQueueGiveFromISR=0x00021f61
--define_symbol xQueueGiveMutexRecursive=0x00022005
--define_symbol xQueueIsQueueEmptyFromISR=0x00022045
--define_symbol xQueueIsQueueFullFromISR=0x00022069
--define_symbol xQueuePeek=0x00022091
--define_symbol xQueuePeekFromISR=0x000221b9
--define_symbol xQueueReceive=0x00022225
--define_symbol xQueueReceiveFromISR=0x00022351
--define_symbol xQueueRemoveFromSet=0x000223e5
--define_symbol xQueueSelectFromSet=0x00022407
--define_symbol xQueueSelectFromSetFromISR=0x00022419
--define_symbol xQueueSemaphoreTake=0x0002242d
--define_symbol xQueueTakeMutexRecursive=0x00022599
--define_symbol xTaskCheckForTimeOut=0x000225dd
--define_symbol xTaskCreate=0x0002264d
--define_symbol xTaskCreateStatic=0x000226a9
--define_symbol xTaskGetCurrentTaskHandle=0x00022719
--define_symbol xTaskGetSchedulerState=0x00022725
--define_symbol xTaskGetTickCount=0x00022741
--define_symbol xTaskGetTickCountFromISR=0x0002274d
--define_symbol xTaskIncrementTick=0x0002275d
--define_symbol xTaskPriorityDisinherit=0x00022829
--define_symbol xTaskPriorityInherit=0x000228bd
--define_symbol xTaskRemoveFromEventList=0x00022951
--define_symbol xTaskResumeAll=0x000229d1
--define_symbol xTimerCreate=0x00022a99
--define_symbol xTimerCreateStatic=0x00022acd
--define_symbol xTimerCreateTimerTask=0x00022b05
--define_symbol xTimerGenericCommand=0x00022b71
--define_symbol xTimerGetExpiryTime=0x00022be1
