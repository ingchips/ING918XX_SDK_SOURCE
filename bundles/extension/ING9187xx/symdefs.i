...
--define_symbol nibble_for_char=0x0001d501
--define_symbol platform_32k_rc_auto_tune=0x0001d59d
--define_symbol platform_32k_rc_tune=0x0001d619
--define_symbol platform_calibrate_32k=0x0001d62d
--define_symbol platform_config=0x0001d631
--define_symbol platform_get_heap_status=0x0001d6e9
--define_symbol platform_get_us_time=0x0001d701
--define_symbol platform_get_version=0x0001d705
--define_symbol platform_hrng=0x0001d70d
--define_symbol platform_install_isr_stack=0x0001d715
--define_symbol platform_patch_rf_init_data=0x0001d721
--define_symbol platform_printf=0x0001d72d
--define_symbol platform_raise_assertion=0x0001d741
--define_symbol platform_rand=0x0001d755
--define_symbol platform_read_info=0x0001d759
--define_symbol platform_read_persistent_reg=0x0001d775
--define_symbol platform_reset=0x0001d785
--define_symbol platform_set_evt_callback=0x0001d7b9
--define_symbol platform_set_irq_callback=0x0001d7cd
--define_symbol platform_set_rf_clk_source=0x0001d805
--define_symbol platform_set_rf_init_data=0x0001d811
--define_symbol platform_set_rf_power_mapping=0x0001d81d
--define_symbol platform_shutdown=0x0001d829
--define_symbol platform_switch_app=0x0001d82d
--define_symbol platform_trace_raw=0x0001d859
--define_symbol platform_write_persistent_reg=0x0001d86d
--define_symbol printf_hexdump=0x0001d87d
--define_symbol pvPortMalloc=0x0001e349
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e431
--define_symbol pvTimerGetTimerID=0x0001e449
--define_symbol pxPortInitialiseStack=0x0001e475
--define_symbol reverse_128=0x0001e61d
--define_symbol reverse_24=0x0001e623
--define_symbol reverse_48=0x0001e629
--define_symbol reverse_56=0x0001e62f
--define_symbol reverse_64=0x0001e635
--define_symbol reverse_bd_addr=0x0001e63b
--define_symbol reverse_bytes=0x0001e641
--define_symbol sm_add_event_handler=0x0001e7ad
--define_symbol sm_address_resolution_lookup=0x0001e8d9
--define_symbol sm_authenticated=0x0001ec25
--define_symbol sm_authorization_decline=0x0001ec33
--define_symbol sm_authorization_grant=0x0001ec53
--define_symbol sm_authorization_state=0x0001ec73
--define_symbol sm_bonding_decline=0x0001ec8d
--define_symbol sm_config=0x0001f059
--define_symbol sm_config_conn=0x0001f071
--define_symbol sm_encryption_key_size=0x0001f1cf
--define_symbol sm_just_works_confirm=0x0001f5f5
--define_symbol sm_le_device_key=0x0001f821
--define_symbol sm_passkey_input=0x0001f8b7
...
--define_symbol sysSetPublicDeviceAddr=0x00020d15
...
--define_symbol vPortExitCritical=0x0002154d
--define_symbol vPortFree=0x00021579
--define_symbol vPortSuppressTicksAndSleep=0x0002160d
--define_symbol vPortValidateInterruptPriority=0x000216e5
--define_symbol vQueueDelete=0x00021739
--define_symbol vQueueWaitForMessageRestricted=0x00021765
--define_symbol vTaskDelay=0x000217ad
--define_symbol vTaskInternalSetTimeOutState=0x000217f9
--define_symbol vTaskMissedYield=0x00021809
--define_symbol vTaskPlaceOnEventList=0x00021815
--define_symbol vTaskPlaceOnEventListRestricted=0x0002184d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002188d
--define_symbol vTaskStartScheduler=0x00021939
--define_symbol vTaskStepTick=0x000219c9
--define_symbol vTaskSuspendAll=0x000219f9
--define_symbol vTaskSwitchContext=0x00021a09
--define_symbol xPortStartScheduler=0x00021ab1
--define_symbol xQueueAddToSet=0x00021b6d
--define_symbol xQueueCreateCountingSemaphore=0x00021b91
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021bcd
--define_symbol xQueueCreateMutex=0x00021c11
--define_symbol xQueueCreateMutexStatic=0x00021c27
--define_symbol xQueueCreateSet=0x00021c41
--define_symbol xQueueGenericCreate=0x00021c49
--define_symbol xQueueGenericCreateStatic=0x00021c95
--define_symbol xQueueGenericReset=0x00021cfd
--define_symbol xQueueGenericSend=0x00021d89
--define_symbol xQueueGenericSendFromISR=0x00021ef5
--define_symbol xQueueGiveFromISR=0x00021fb5
--define_symbol xQueueGiveMutexRecursive=0x00022059
--define_symbol xQueueIsQueueEmptyFromISR=0x00022099
--define_symbol xQueueIsQueueFullFromISR=0x000220bd
--define_symbol xQueuePeek=0x000220e5
--define_symbol xQueuePeekFromISR=0x0002220d
--define_symbol xQueueReceive=0x00022279
--define_symbol xQueueReceiveFromISR=0x000223a5
--define_symbol xQueueRemoveFromSet=0x00022439
--define_symbol xQueueSelectFromSet=0x0002245b
--define_symbol xQueueSelectFromSetFromISR=0x0002246d
--define_symbol xQueueSemaphoreTake=0x00022481
--define_symbol xQueueTakeMutexRecursive=0x000225ed
--define_symbol xTaskCheckForTimeOut=0x00022631
--define_symbol xTaskCreate=0x000226a1
--define_symbol xTaskCreateStatic=0x000226fd
--define_symbol xTaskGetCurrentTaskHandle=0x0002276d
--define_symbol xTaskGetSchedulerState=0x00022779
--define_symbol xTaskGetTickCount=0x00022795
--define_symbol xTaskGetTickCountFromISR=0x000227a1
--define_symbol xTaskIncrementTick=0x000227b1
--define_symbol xTaskPriorityDisinherit=0x0002287d
--define_symbol xTaskPriorityInherit=0x00022911
--define_symbol xTaskRemoveFromEventList=0x000229a5
--define_symbol xTaskResumeAll=0x00022a25
--define_symbol xTimerCreate=0x00022aed
--define_symbol xTimerCreateStatic=0x00022b21
--define_symbol xTimerCreateTimerTask=0x00022b59
--define_symbol xTimerGenericCommand=0x00022bc5
--define_symbol xTimerGetExpiryTime=0x00022c35
