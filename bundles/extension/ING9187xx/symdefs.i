...
--define_symbol nibble_for_char=0x0001d889
--define_symbol platform_32k_rc_auto_tune=0x0001d925
--define_symbol platform_32k_rc_tune=0x0001d9a1
--define_symbol platform_calibrate_32k=0x0001d9b5
--define_symbol platform_config=0x0001d9b9
--define_symbol platform_get_heap_status=0x0001da8d
--define_symbol platform_get_task_handle=0x0001daa5
--define_symbol platform_get_us_time=0x0001dac5
--define_symbol platform_get_version=0x0001dac9
--define_symbol platform_hrng=0x0001dad1
--define_symbol platform_install_isr_stack=0x0001dad9
--define_symbol platform_patch_rf_init_data=0x0001dae5
--define_symbol platform_printf=0x0001daf1
--define_symbol platform_raise_assertion=0x0001db05
--define_symbol platform_rand=0x0001db19
--define_symbol platform_read_info=0x0001db1d
--define_symbol platform_read_persistent_reg=0x0001db39
--define_symbol platform_reset=0x0001db49
--define_symbol platform_set_evt_callback=0x0001db7d
--define_symbol platform_set_irq_callback=0x0001db91
--define_symbol platform_set_rf_clk_source=0x0001dbc9
--define_symbol platform_set_rf_init_data=0x0001dbd5
--define_symbol platform_set_rf_power_mapping=0x0001dbe1
--define_symbol platform_set_timer=0x0001dbed
--define_symbol platform_shutdown=0x0001dbf1
--define_symbol platform_switch_app=0x0001dbf5
--define_symbol platform_trace_raw=0x0001dc21
--define_symbol platform_write_persistent_reg=0x0001dc39
--define_symbol printf_hexdump=0x0001dc49
--define_symbol pvPortMalloc=0x0001e751
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e839
--define_symbol pvTimerGetTimerID=0x0001e851
--define_symbol pxPortInitialiseStack=0x0001e87d
--define_symbol reverse_128=0x0001ea25
--define_symbol reverse_24=0x0001ea2b
--define_symbol reverse_48=0x0001ea31
--define_symbol reverse_56=0x0001ea37
--define_symbol reverse_64=0x0001ea3d
--define_symbol reverse_bd_addr=0x0001ea43
--define_symbol reverse_bytes=0x0001ea49
--define_symbol sm_add_event_handler=0x0001ebd5
--define_symbol sm_address_resolution_lookup=0x0001ed2d
--define_symbol sm_authenticated=0x0001f085
--define_symbol sm_authorization_decline=0x0001f093
--define_symbol sm_authorization_grant=0x0001f0b3
--define_symbol sm_authorization_state=0x0001f0d3
--define_symbol sm_bonding_decline=0x0001f0ed
--define_symbol sm_config=0x0001f50d
--define_symbol sm_config_conn=0x0001f525
--define_symbol sm_encryption_key_size=0x0001f6db
--define_symbol sm_just_works_confirm=0x0001fc15
--define_symbol sm_le_device_key=0x0001ff51
--define_symbol sm_passkey_input=0x0001ffe7
--define_symbol sm_private_random_address_generation_get=0x00020395
--define_symbol sm_private_random_address_generation_get_mode=0x0002039d
--define_symbol sm_private_random_address_generation_set_mode=0x000203a9
--define_symbol sm_private_random_address_generation_set_update_period=0x000203d1
--define_symbol sm_register_oob_data_callback=0x0002050d
--define_symbol sm_request_pairing=0x00020519
...
--define_symbol sscanf_bd_addr=0x00021345
--define_symbol sysSetPublicDeviceAddr=0x000216ad
...
--define_symbol vListInitialise=0x00021eab
--define_symbol vListInitialiseItem=0x00021ec1
--define_symbol vListInsert=0x00021ec7
--define_symbol vListInsertEnd=0x00021ef7
--define_symbol vPortEndScheduler=0x00021f11
--define_symbol vPortEnterCritical=0x00021f39
--define_symbol vPortExitCritical=0x00021f7d
--define_symbol vPortFree=0x00021fad
--define_symbol vPortSuppressTicksAndSleep=0x00022041
--define_symbol vPortValidateInterruptPriority=0x00022149
--define_symbol vQueueDelete=0x000221a1
--define_symbol vQueueWaitForMessageRestricted=0x000221cd
--define_symbol vTaskDelay=0x00022215
--define_symbol vTaskInternalSetTimeOutState=0x00022261
--define_symbol vTaskMissedYield=0x00022271
--define_symbol vTaskPlaceOnEventList=0x0002227d
--define_symbol vTaskPlaceOnEventListRestricted=0x000222b5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000222f5
--define_symbol vTaskPrioritySet=0x000223a1
--define_symbol vTaskResume=0x00022469
--define_symbol vTaskStartScheduler=0x000224ed
--define_symbol vTaskStepTick=0x0002257d
--define_symbol vTaskSuspend=0x000225ad
...
--define_symbol xQueueAddToSet=0x000227e1
--define_symbol xQueueCreateCountingSemaphore=0x00022805
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022841
--define_symbol xQueueCreateMutex=0x00022885
--define_symbol xQueueCreateMutexStatic=0x0002289b
--define_symbol xQueueCreateSet=0x000228b5
--define_symbol xQueueGenericCreate=0x000228bd
--define_symbol xQueueGenericCreateStatic=0x00022909
--define_symbol xQueueGenericReset=0x00022971
--define_symbol xQueueGenericSend=0x000229fd
--define_symbol xQueueGenericSendFromISR=0x00022b69
--define_symbol xQueueGiveFromISR=0x00022c29
--define_symbol xQueueGiveMutexRecursive=0x00022ccd
--define_symbol xQueueIsQueueEmptyFromISR=0x00022d0d
--define_symbol xQueueIsQueueFullFromISR=0x00022d31
--define_symbol xQueuePeek=0x00022d59
--define_symbol xQueuePeekFromISR=0x00022e81
--define_symbol xQueueReceive=0x00022eed
--define_symbol xQueueReceiveFromISR=0x00023019
--define_symbol xQueueRemoveFromSet=0x000230ad
--define_symbol xQueueSelectFromSet=0x000230cf
--define_symbol xQueueSelectFromSetFromISR=0x000230e1
--define_symbol xQueueSemaphoreTake=0x000230f5
--define_symbol xQueueTakeMutexRecursive=0x00023261
--define_symbol xTaskCheckForTimeOut=0x000232a5
--define_symbol xTaskCreate=0x00023315
--define_symbol xTaskCreateStatic=0x00023371
--define_symbol xTaskGetCurrentTaskHandle=0x000233e1
--define_symbol xTaskGetSchedulerState=0x000233ed
--define_symbol xTaskGetTickCount=0x00023409
--define_symbol xTaskGetTickCountFromISR=0x00023415
--define_symbol xTaskIncrementTick=0x00023425
--define_symbol xTaskPriorityDisinherit=0x000234f1
--define_symbol xTaskPriorityInherit=0x00023585
--define_symbol xTaskRemoveFromEventList=0x00023619
--define_symbol xTaskResumeAll=0x00023699
--define_symbol xTaskResumeFromISR=0x00023761
--define_symbol xTimerCreate=0x000237ed
--define_symbol xTimerCreateStatic=0x00023821
--define_symbol xTimerCreateTimerTask=0x00023859
--define_symbol xTimerGenericCommand=0x000238c5
--define_symbol xTimerGetExpiryTime=0x00023935
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00023955
