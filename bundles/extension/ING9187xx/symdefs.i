...
--define_symbol ll_malloc=0x0000ce85
--define_symbol ll_query_timing_info=0x0000cfbd
--define_symbol ll_raw_packet_alloc=0x0000d009
--define_symbol ll_raw_packet_free=0x0000d0bd
--define_symbol ll_raw_packet_get_rx_data=0x0000d0e7
--define_symbol ll_raw_packet_recv=0x0000d17d
--define_symbol ll_raw_packet_send=0x0000d211
--define_symbol ll_raw_packet_set_param=0x0000d281
--define_symbol ll_raw_packet_set_tx_data=0x0000d2e7
--define_symbol ll_set_adv_coded_scheme=0x0000d4b1
--define_symbol ll_set_conn_coded_scheme=0x0000d4e1
--define_symbol ll_set_conn_latency=0x0000d50d
--define_symbol ll_set_conn_tx_power=0x0000d53d
--define_symbol ll_set_def_antenna=0x0000d585
--define_symbol ll_set_initiating_coded_scheme=0x0000d5a1
--define_symbol ll_set_max_conn_number=0x0000d5ad
--define_symbol nibble_for_char=0x0001d22d
--define_symbol platform_32k_rc_auto_tune=0x0001d2cd
--define_symbol platform_32k_rc_tune=0x0001d349
--define_symbol platform_calibrate_32k=0x0001d35d
--define_symbol platform_config=0x0001d361
--define_symbol platform_get_heap_status=0x0001d411
--define_symbol platform_get_us_time=0x0001d429
--define_symbol platform_get_version=0x0001d42d
--define_symbol platform_hrng=0x0001d435
--define_symbol platform_install_isr_stack=0x0001d43d
--define_symbol platform_patch_rf_init_data=0x0001d449
--define_symbol platform_printf=0x0001d455
--define_symbol platform_raise_assertion=0x0001d469
--define_symbol platform_rand=0x0001d47d
--define_symbol platform_read_info=0x0001d481
--define_symbol platform_read_persistent_reg=0x0001d49d
--define_symbol platform_reset=0x0001d4ad
--define_symbol platform_set_evt_callback=0x0001d4e1
--define_symbol platform_set_irq_callback=0x0001d4f5
--define_symbol platform_set_rf_clk_source=0x0001d52d
--define_symbol platform_set_rf_init_data=0x0001d539
--define_symbol platform_set_rf_power_mapping=0x0001d545
--define_symbol platform_shutdown=0x0001d551
--define_symbol platform_switch_app=0x0001d555
--define_symbol platform_trace_raw=0x0001d581
--define_symbol platform_write_persistent_reg=0x0001d595
--define_symbol printf_hexdump=0x0001d5a5
--define_symbol pvPortMalloc=0x0001e065
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e14d
--define_symbol pvTimerGetTimerID=0x0001e165
--define_symbol pxPortInitialiseStack=0x0001e191
--define_symbol reverse_128=0x0001e339
--define_symbol reverse_24=0x0001e33f
--define_symbol reverse_48=0x0001e345
--define_symbol reverse_56=0x0001e34b
--define_symbol reverse_64=0x0001e351
--define_symbol reverse_bd_addr=0x0001e357
--define_symbol reverse_bytes=0x0001e35d
--define_symbol sm_add_event_handler=0x0001e4a9
--define_symbol sm_address_resolution_lookup=0x0001e5d5
--define_symbol sm_authenticated=0x0001e6af
--define_symbol sm_authorization_decline=0x0001e6bd
--define_symbol sm_authorization_grant=0x0001e6dd
--define_symbol sm_authorization_state=0x0001e6fd
--define_symbol sm_bonding_decline=0x0001e719
--define_symbol sm_config=0x0001eaf1
--define_symbol sm_encryption_key_size=0x0001ebfd
--define_symbol sm_just_works_confirm=0x0001f3b9
--define_symbol sm_le_device_key=0x0001f609
--define_symbol sm_passkey_input=0x0001f6a1
--define_symbol sm_private_random_address_generation_get=0x0001fa2d
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa35
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa41
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fa69
--define_symbol sm_register_oob_data_callback=0x0001faa1
--define_symbol sm_request_pairing=0x0001faad
--define_symbol sm_send_security_request=0x000204e7
--define_symbol sm_set_accepted_stk_generation_methods=0x0002050d
--define_symbol sm_set_authentication_requirements=0x00020519
--define_symbol sm_set_encryption_key_size_range=0x00020525
--define_symbol sscanf_bd_addr=0x00020821
--define_symbol sysSetPublicDeviceAddr=0x00020b85
--define_symbol uuid128_to_str=0x00021129
--define_symbol uuid_add_bluetooth_prefix=0x00021181
--define_symbol uuid_has_bluetooth_prefix=0x000211a1
--define_symbol uxQueueMessagesWaiting=0x000211e5
--define_symbol uxQueueMessagesWaitingFromISR=0x0002120d
--define_symbol uxQueueSpacesAvailable=0x00021229
--define_symbol uxTaskGetStackHighWaterMark=0x00021255
--define_symbol vPortEnterCritical=0x0002130d
--define_symbol vPortExitCritical=0x0002134d
--define_symbol vPortFree=0x00021379
--define_symbol vPortSuppressTicksAndSleep=0x0002140d
--define_symbol vPortValidateInterruptPriority=0x000214e5
--define_symbol vQueueDelete=0x00021539
--define_symbol vQueueWaitForMessageRestricted=0x00021565
--define_symbol vTaskDelay=0x000215ad
--define_symbol vTaskInternalSetTimeOutState=0x000215f9
--define_symbol vTaskMissedYield=0x00021609
--define_symbol vTaskPlaceOnEventList=0x00021615
--define_symbol vTaskPlaceOnEventListRestricted=0x0002164d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002168d
--define_symbol vTaskStartScheduler=0x00021739
--define_symbol vTaskStepTick=0x000217c9
--define_symbol vTaskSuspendAll=0x000217f9
--define_symbol vTaskSwitchContext=0x00021809
--define_symbol xPortStartScheduler=0x000218b1
--define_symbol xQueueAddToSet=0x0002196d
--define_symbol xQueueCreateCountingSemaphore=0x00021991
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000219cd
--define_symbol xQueueCreateMutex=0x00021a11
--define_symbol xQueueCreateMutexStatic=0x00021a27
--define_symbol xQueueCreateSet=0x00021a41
--define_symbol xQueueGenericCreate=0x00021a49
--define_symbol xQueueGenericCreateStatic=0x00021a95
--define_symbol xQueueGenericReset=0x00021afd
--define_symbol xQueueGenericSend=0x00021b89
--define_symbol xQueueGenericSendFromISR=0x00021cf5
--define_symbol xQueueGiveFromISR=0x00021db5
--define_symbol xQueueGiveMutexRecursive=0x00021e59
--define_symbol xQueueIsQueueEmptyFromISR=0x00021e99
--define_symbol xQueueIsQueueFullFromISR=0x00021ebd
--define_symbol xQueuePeek=0x00021ee5
--define_symbol xQueuePeekFromISR=0x0002200d
--define_symbol xQueueReceive=0x00022079
--define_symbol xQueueReceiveFromISR=0x000221a5
--define_symbol xQueueRemoveFromSet=0x00022239
--define_symbol xQueueSelectFromSet=0x0002225b
--define_symbol xQueueSelectFromSetFromISR=0x0002226d
--define_symbol xQueueSemaphoreTake=0x00022281
--define_symbol xQueueTakeMutexRecursive=0x000223ed
--define_symbol xTaskCheckForTimeOut=0x00022431
--define_symbol xTaskCreate=0x000224a1
--define_symbol xTaskCreateStatic=0x000224fd
--define_symbol xTaskGetCurrentTaskHandle=0x0002256d
--define_symbol xTaskGetSchedulerState=0x00022579
--define_symbol xTaskGetTickCount=0x00022595
--define_symbol xTaskGetTickCountFromISR=0x000225a1
--define_symbol xTaskIncrementTick=0x000225b1
--define_symbol xTaskPriorityDisinherit=0x0002267d
--define_symbol xTaskPriorityInherit=0x00022711
--define_symbol xTaskRemoveFromEventList=0x000227a5
--define_symbol xTaskResumeAll=0x00022825
--define_symbol xTimerCreate=0x000228ed
--define_symbol xTimerCreateStatic=0x00022921
--define_symbol xTimerCreateTimerTask=0x00022959
--define_symbol xTimerGenericCommand=0x000229c5
--define_symbol xTimerGetExpiryTime=0x00022a35
