...
--define_symbol platform_32k_rc_auto_tune=0x0001d6f1
--define_symbol platform_32k_rc_tune=0x0001d76d
--define_symbol platform_calibrate_32k=0x0001d781
--define_symbol platform_config=0x0001d785
--define_symbol platform_get_heap_status=0x0001d845
--define_symbol platform_get_us_time=0x0001d85d
--define_symbol platform_get_version=0x0001d861
--define_symbol platform_hrng=0x0001d869
--define_symbol platform_install_isr_stack=0x0001d871
--define_symbol platform_patch_rf_init_data=0x0001d87d
--define_symbol platform_printf=0x0001d889
--define_symbol platform_raise_assertion=0x0001d89d
--define_symbol platform_rand=0x0001d8b1
--define_symbol platform_read_info=0x0001d8b5
--define_symbol platform_read_persistent_reg=0x0001d8d1
--define_symbol platform_reset=0x0001d8e1
--define_symbol platform_set_evt_callback=0x0001d915
--define_symbol platform_set_irq_callback=0x0001d929
--define_symbol platform_set_rf_clk_source=0x0001d961
--define_symbol platform_set_rf_init_data=0x0001d96d
--define_symbol platform_set_rf_power_mapping=0x0001d979
--define_symbol platform_shutdown=0x0001d985
--define_symbol platform_switch_app=0x0001d989
--define_symbol platform_trace_raw=0x0001d9b5
--define_symbol platform_write_persistent_reg=0x0001d9cd
--define_symbol printf_hexdump=0x0001d9dd
--define_symbol pvPortMalloc=0x0001e4e5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e5cd
--define_symbol pvTimerGetTimerID=0x0001e5e5
--define_symbol pxPortInitialiseStack=0x0001e611
--define_symbol reverse_128=0x0001e7b9
--define_symbol reverse_24=0x0001e7bf
--define_symbol reverse_48=0x0001e7c5
--define_symbol reverse_56=0x0001e7cb
--define_symbol reverse_64=0x0001e7d1
--define_symbol reverse_bd_addr=0x0001e7d7
--define_symbol reverse_bytes=0x0001e7dd
--define_symbol sm_add_event_handler=0x0001e949
--define_symbol sm_address_resolution_lookup=0x0001eaa1
--define_symbol sm_authenticated=0x0001eded
--define_symbol sm_authorization_decline=0x0001edfb
--define_symbol sm_authorization_grant=0x0001ee1b
--define_symbol sm_authorization_state=0x0001ee3b
--define_symbol sm_bonding_decline=0x0001ee55
--define_symbol sm_config=0x0001f275
--define_symbol sm_config_conn=0x0001f28d
--define_symbol sm_encryption_key_size=0x0001f413
--define_symbol sm_just_works_confirm=0x0001f941
--define_symbol sm_le_device_key=0x0001fc7d
--define_symbol sm_passkey_input=0x0001fd13
--define_symbol sm_private_random_address_generation_get=0x000200b9
--define_symbol sm_private_random_address_generation_get_mode=0x000200c1
--define_symbol sm_private_random_address_generation_set_mode=0x000200cd
--define_symbol sm_private_random_address_generation_set_update_period=0x000200f5
--define_symbol sm_register_oob_data_callback=0x00020231
--define_symbol sm_request_pairing=0x0002023d
--define_symbol sm_send_security_request=0x00020c37
--define_symbol sm_set_accepted_stk_generation_methods=0x00020c5d
--define_symbol sm_set_authentication_requirements=0x00020c69
--define_symbol sm_set_encryption_key_size_range=0x00020c75
--define_symbol sscanf_bd_addr=0x00020fd1
--define_symbol sysSetPublicDeviceAddr=0x00021339
--define_symbol uuid128_to_str=0x0002192d
--define_symbol uuid_add_bluetooth_prefix=0x00021985
--define_symbol uuid_has_bluetooth_prefix=0x000219a5
--define_symbol uxListRemove=0x000219c1
--define_symbol uxQueueMessagesWaiting=0x000219e9
--define_symbol uxQueueMessagesWaitingFromISR=0x00021a11
--define_symbol uxQueueSpacesAvailable=0x00021a2d
--define_symbol uxTaskGetStackHighWaterMark=0x00021a59
--define_symbol vListInitialise=0x00021aff
--define_symbol vListInitialiseItem=0x00021b15
--define_symbol vListInsert=0x00021b1b
--define_symbol vListInsertEnd=0x00021b4b
--define_symbol vPortEnterCritical=0x00021b65
--define_symbol vPortExitCritical=0x00021ba9
--define_symbol vPortFree=0x00021bd9
--define_symbol vPortSuppressTicksAndSleep=0x00021c6d
--define_symbol vPortValidateInterruptPriority=0x00021d8d
--define_symbol vQueueDelete=0x00021de5
--define_symbol vQueueWaitForMessageRestricted=0x00021e11
--define_symbol vTaskDelay=0x00021e59
--define_symbol vTaskInternalSetTimeOutState=0x00021ea5
--define_symbol vTaskMissedYield=0x00021eb5
--define_symbol vTaskPlaceOnEventList=0x00021ec1
--define_symbol vTaskPlaceOnEventListRestricted=0x00021ef9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021f39
--define_symbol vTaskResume=0x00021fe5
--define_symbol vTaskStartScheduler=0x00022069
--define_symbol vTaskStepTick=0x000220f9
--define_symbol vTaskSuspend=0x00022129
--define_symbol vTaskSuspendAll=0x000221e5
--define_symbol vTaskSwitchContext=0x000221f5
--define_symbol xPortStartScheduler=0x0002229d
--define_symbol xQueueAddToSet=0x00022361
--define_symbol xQueueCreateCountingSemaphore=0x00022385
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000223c1
--define_symbol xQueueCreateMutex=0x00022405
--define_symbol xQueueCreateMutexStatic=0x0002241b
--define_symbol xQueueCreateSet=0x00022435
--define_symbol xQueueGenericCreate=0x0002243d
--define_symbol xQueueGenericCreateStatic=0x00022489
--define_symbol xQueueGenericReset=0x000224f1
--define_symbol xQueueGenericSend=0x0002257d
--define_symbol xQueueGenericSendFromISR=0x000226e9
--define_symbol xQueueGiveFromISR=0x000227a9
--define_symbol xQueueGiveMutexRecursive=0x0002284d
--define_symbol xQueueIsQueueEmptyFromISR=0x0002288d
--define_symbol xQueueIsQueueFullFromISR=0x000228b1
--define_symbol xQueuePeek=0x000228d9
--define_symbol xQueuePeekFromISR=0x00022a01
--define_symbol xQueueReceive=0x00022a6d
--define_symbol xQueueReceiveFromISR=0x00022b99
--define_symbol xQueueRemoveFromSet=0x00022c2d
--define_symbol xQueueSelectFromSet=0x00022c4f
--define_symbol xQueueSelectFromSetFromISR=0x00022c61
--define_symbol xQueueSemaphoreTake=0x00022c75
--define_symbol xQueueTakeMutexRecursive=0x00022de1
--define_symbol xTaskCheckForTimeOut=0x00022e25
--define_symbol xTaskCreate=0x00022e95
--define_symbol xTaskCreateStatic=0x00022ef1
--define_symbol xTaskGetCurrentTaskHandle=0x00022f61
--define_symbol xTaskGetSchedulerState=0x00022f6d
--define_symbol xTaskGetTickCount=0x00022f89
--define_symbol xTaskGetTickCountFromISR=0x00022f95
--define_symbol xTaskIncrementTick=0x00022fa5
--define_symbol xTaskPriorityDisinherit=0x00023071
--define_symbol xTaskPriorityInherit=0x00023105
--define_symbol xTaskRemoveFromEventList=0x00023199
--define_symbol xTaskResumeAll=0x00023219
--define_symbol xTaskResumeFromISR=0x000232e1
--define_symbol xTimerCreate=0x0002336d
--define_symbol xTimerCreateStatic=0x000233a1
--define_symbol xTimerCreateTimerTask=0x000233d9
--define_symbol xTimerGenericCommand=0x00023445
--define_symbol xTimerGetExpiryTime=0x000234b5
