...
--define_symbol sysSetPublicDeviceAddr=0x00020ded
--define_symbol uuid128_to_str=0x000213c5
--define_symbol uuid_add_bluetooth_prefix=0x0002141d
--define_symbol uuid_has_bluetooth_prefix=0x0002143d
--define_symbol uxQueueMessagesWaiting=0x00021481
--define_symbol uxQueueMessagesWaitingFromISR=0x000214a9
--define_symbol uxQueueSpacesAvailable=0x000214c5
--define_symbol uxTaskGetStackHighWaterMark=0x000214f1
--define_symbol vPortEnterCritical=0x00021615
--define_symbol vPortExitCritical=0x00021655
--define_symbol vPortFree=0x00021681
--define_symbol vPortSuppressTicksAndSleep=0x00021715
--define_symbol vPortValidateInterruptPriority=0x000217ed
--define_symbol vQueueDelete=0x00021841
--define_symbol vQueueWaitForMessageRestricted=0x0002186d
--define_symbol vTaskDelay=0x000218b5
--define_symbol vTaskInternalSetTimeOutState=0x00021901
--define_symbol vTaskMissedYield=0x00021911
--define_symbol vTaskPlaceOnEventList=0x0002191d
--define_symbol vTaskPlaceOnEventListRestricted=0x00021955
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021995
--define_symbol vTaskResume=0x00021a41
--define_symbol vTaskStartScheduler=0x00021ac5
--define_symbol vTaskStepTick=0x00021b55
--define_symbol vTaskSuspend=0x00021b85
--define_symbol vTaskSuspendAll=0x00021c41
--define_symbol vTaskSwitchContext=0x00021c51
--define_symbol xPortStartScheduler=0x00021cf9
