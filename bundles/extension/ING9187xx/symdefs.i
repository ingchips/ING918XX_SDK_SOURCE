...
--define_symbol nibble_for_char=0x0001d759
--define_symbol platform_32k_rc_auto_tune=0x0001d7f5
--define_symbol platform_32k_rc_tune=0x0001d871
--define_symbol platform_calibrate_32k=0x0001d885
--define_symbol platform_config=0x0001d889
--define_symbol platform_get_heap_status=0x0001d949
--define_symbol platform_get_task_handle=0x0001d961
...
--define_symbol platform_install_isr_stack=0x0001d995
--define_symbol platform_patch_rf_init_data=0x0001d9a1
--define_symbol platform_printf=0x0001d9ad
--define_symbol platform_raise_assertion=0x0001d9c1
--define_symbol platform_rand=0x0001d9d5
--define_symbol platform_read_info=0x0001d9d9
--define_symbol platform_read_persistent_reg=0x0001d9f5
--define_symbol platform_reset=0x0001da05
--define_symbol platform_set_evt_callback=0x0001da39
--define_symbol platform_set_irq_callback=0x0001da4d
--define_symbol platform_set_rf_clk_source=0x0001da85
--define_symbol platform_set_rf_init_data=0x0001da91
--define_symbol platform_set_rf_power_mapping=0x0001da9d
--define_symbol platform_set_timer=0x0001daa9
--define_symbol platform_shutdown=0x0001daad
--define_symbol platform_switch_app=0x0001dab1
--define_symbol platform_trace_raw=0x0001dadd
--define_symbol platform_write_persistent_reg=0x0001daf5
--define_symbol printf_hexdump=0x0001db05
--define_symbol pvPortMalloc=0x0001e60d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e6f5
--define_symbol pvTimerGetTimerID=0x0001e70d
--define_symbol pxPortInitialiseStack=0x0001e739
--define_symbol reverse_128=0x0001e8e1
--define_symbol reverse_24=0x0001e8e7
--define_symbol reverse_48=0x0001e8ed
--define_symbol reverse_56=0x0001e8f3
--define_symbol reverse_64=0x0001e8f9
--define_symbol reverse_bd_addr=0x0001e8ff
--define_symbol reverse_bytes=0x0001e905
--define_symbol sm_add_event_handler=0x0001ea91
--define_symbol sm_address_resolution_lookup=0x0001ebe9
--define_symbol sm_authenticated=0x0001ef35
--define_symbol sm_authorization_decline=0x0001ef43
--define_symbol sm_authorization_grant=0x0001ef63
--define_symbol sm_authorization_state=0x0001ef83
--define_symbol sm_bonding_decline=0x0001ef9d
--define_symbol sm_config=0x0001f3bd
--define_symbol sm_config_conn=0x0001f3d5
--define_symbol sm_encryption_key_size=0x0001f58b
--define_symbol sm_just_works_confirm=0x0001fac5
--define_symbol sm_le_device_key=0x0001fe01
--define_symbol sm_passkey_input=0x0001fe97
--define_symbol sm_private_random_address_generation_get=0x00020245
--define_symbol sm_private_random_address_generation_get_mode=0x0002024d
--define_symbol sm_private_random_address_generation_set_mode=0x00020259
--define_symbol sm_private_random_address_generation_set_update_period=0x00020281
--define_symbol sm_register_oob_data_callback=0x000203bd
--define_symbol sm_request_pairing=0x000203c9
--define_symbol sm_send_security_request=0x00020dcf
--define_symbol sm_set_accepted_stk_generation_methods=0x00020df5
--define_symbol sm_set_authentication_requirements=0x00020e01
--define_symbol sm_set_encryption_key_size_range=0x00020e0d
--define_symbol sscanf_bd_addr=0x000211d1
--define_symbol sysSetPublicDeviceAddr=0x00021539
--define_symbol uuid128_to_str=0x00021b2d
--define_symbol uuid_add_bluetooth_prefix=0x00021b85
--define_symbol uuid_has_bluetooth_prefix=0x00021ba5
--define_symbol uxListRemove=0x00021bc1
--define_symbol uxQueueMessagesWaiting=0x00021be9
--define_symbol uxQueueMessagesWaitingFromISR=0x00021c11
--define_symbol uxQueueSpacesAvailable=0x00021c2d
--define_symbol uxTaskGetStackHighWaterMark=0x00021c59
--define_symbol uxTaskPriorityGet=0x00021c79
--define_symbol uxTaskPriorityGetFromISR=0x00021c95
--define_symbol vListInitialise=0x00021d47
--define_symbol vListInitialiseItem=0x00021d5d
--define_symbol vListInsert=0x00021d63
--define_symbol vListInsertEnd=0x00021d93
--define_symbol vPortEnterCritical=0x00021dad
--define_symbol vPortExitCritical=0x00021df1
--define_symbol vPortFree=0x00021e21
--define_symbol vPortSuppressTicksAndSleep=0x00021eb5
--define_symbol vPortValidateInterruptPriority=0x00021fd5
--define_symbol vQueueDelete=0x0002202d
--define_symbol vQueueWaitForMessageRestricted=0x00022059
--define_symbol vTaskDelay=0x000220a1
--define_symbol vTaskInternalSetTimeOutState=0x000220ed
--define_symbol vTaskMissedYield=0x000220fd
--define_symbol vTaskPlaceOnEventList=0x00022109
--define_symbol vTaskPlaceOnEventListRestricted=0x00022141
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022181
--define_symbol vTaskPrioritySet=0x0002222d
--define_symbol vTaskResume=0x000222f5
--define_symbol vTaskStartScheduler=0x00022379
--define_symbol vTaskStepTick=0x00022409
--define_symbol vTaskSuspend=0x00022439
--define_symbol vTaskSuspendAll=0x000224f5
--define_symbol vTaskSwitchContext=0x00022505
--define_symbol xPortStartScheduler=0x000225ad
--define_symbol xQueueAddToSet=0x00022671
--define_symbol xQueueCreateCountingSemaphore=0x00022695
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000226d1
--define_symbol xQueueCreateMutex=0x00022715
--define_symbol xQueueCreateMutexStatic=0x0002272b
--define_symbol xQueueCreateSet=0x00022745
--define_symbol xQueueGenericCreate=0x0002274d
--define_symbol xQueueGenericCreateStatic=0x00022799
--define_symbol xQueueGenericReset=0x00022801
--define_symbol xQueueGenericSend=0x0002288d
--define_symbol xQueueGenericSendFromISR=0x000229f9
--define_symbol xQueueGiveFromISR=0x00022ab9
--define_symbol xQueueGiveMutexRecursive=0x00022b5d
--define_symbol xQueueIsQueueEmptyFromISR=0x00022b9d
--define_symbol xQueueIsQueueFullFromISR=0x00022bc1
--define_symbol xQueuePeek=0x00022be9
--define_symbol xQueuePeekFromISR=0x00022d11
--define_symbol xQueueReceive=0x00022d7d
--define_symbol xQueueReceiveFromISR=0x00022ea9
--define_symbol xQueueRemoveFromSet=0x00022f3d
--define_symbol xQueueSelectFromSet=0x00022f5f
--define_symbol xQueueSelectFromSetFromISR=0x00022f71
--define_symbol xQueueSemaphoreTake=0x00022f85
--define_symbol xQueueTakeMutexRecursive=0x000230f1
--define_symbol xTaskCheckForTimeOut=0x00023135
--define_symbol xTaskCreate=0x000231a5
--define_symbol xTaskCreateStatic=0x00023201
--define_symbol xTaskGetCurrentTaskHandle=0x00023271
--define_symbol xTaskGetSchedulerState=0x0002327d
--define_symbol xTaskGetTickCount=0x00023299
--define_symbol xTaskGetTickCountFromISR=0x000232a5
--define_symbol xTaskIncrementTick=0x000232b5
--define_symbol xTaskPriorityDisinherit=0x00023381
--define_symbol xTaskPriorityInherit=0x00023415
--define_symbol xTaskRemoveFromEventList=0x000234a9
--define_symbol xTaskResumeAll=0x00023529
--define_symbol xTaskResumeFromISR=0x000235f1
--define_symbol xTimerCreate=0x0002367d
--define_symbol xTimerCreateStatic=0x000236b1
--define_symbol xTimerCreateTimerTask=0x000236e9
--define_symbol xTimerGenericCommand=0x00023755
--define_symbol xTimerGetExpiryTime=0x000237c5
--define_symbol xTimerGetTimerDaemonTaskHandle=0x000237e5
