...
--define_symbol sysSetPublicDeviceAddr=0x00020bfd
--define_symbol uuid128_to_str=0x000211a1
--define_symbol uuid_add_bluetooth_prefix=0x000211f9
--define_symbol uuid_has_bluetooth_prefix=0x00021219
--define_symbol uxQueueMessagesWaiting=0x0002125d
--define_symbol uxQueueMessagesWaitingFromISR=0x00021285
--define_symbol uxQueueSpacesAvailable=0x000212a1
--define_symbol uxTaskGetStackHighWaterMark=0x000212cd
--define_symbol vPortEnterCritical=0x00021385
--define_symbol vPortExitCritical=0x000213c5
--define_symbol vPortFree=0x000213f1
--define_symbol vPortSuppressTicksAndSleep=0x00021485
--define_symbol vPortValidateInterruptPriority=0x0002155d
--define_symbol vQueueDelete=0x000215b1
--define_symbol vQueueWaitForMessageRestricted=0x000215dd
--define_symbol vTaskDelay=0x00021625
--define_symbol vTaskInternalSetTimeOutState=0x00021671
--define_symbol vTaskMissedYield=0x00021681
--define_symbol vTaskPlaceOnEventList=0x0002168d
--define_symbol vTaskPlaceOnEventListRestricted=0x000216c5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021705
--define_symbol vTaskStartScheduler=0x000217b1
--define_symbol vTaskStepTick=0x00021841
--define_symbol vTaskSuspendAll=0x00021871
--define_symbol vTaskSwitchContext=0x00021881
--define_symbol xPortStartScheduler=0x00021929
--define_symbol xQueueAddToSet=0x000219e5
--define_symbol xQueueCreateCountingSemaphore=0x00021a09
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021a45
--define_symbol xQueueCreateMutex=0x00021a89
--define_symbol xQueueCreateMutexStatic=0x00021a9f
--define_symbol xQueueCreateSet=0x00021ab9
--define_symbol xQueueGenericCreate=0x00021ac1
--define_symbol xQueueGenericCreateStatic=0x00021b0d
--define_symbol xQueueGenericReset=0x00021b75
--define_symbol xQueueGenericSend=0x00021c01
--define_symbol xQueueGenericSendFromISR=0x00021d6d
--define_symbol xQueueGiveFromISR=0x00021e2d
--define_symbol xQueueGiveMutexRecursive=0x00021ed1
--define_symbol xQueueIsQueueEmptyFromISR=0x00021f11
--define_symbol xQueueIsQueueFullFromISR=0x00021f35
--define_symbol xQueuePeek=0x00021f5d
--define_symbol xQueuePeekFromISR=0x00022085
--define_symbol xQueueReceive=0x000220f1
--define_symbol xQueueReceiveFromISR=0x0002221d
--define_symbol xQueueRemoveFromSet=0x000222b1
--define_symbol xQueueSelectFromSet=0x000222d3
--define_symbol xQueueSelectFromSetFromISR=0x000222e5
--define_symbol xQueueSemaphoreTake=0x000222f9
--define_symbol xQueueTakeMutexRecursive=0x00022465
--define_symbol xTaskCheckForTimeOut=0x000224a9
--define_symbol xTaskCreate=0x00022519
--define_symbol xTaskCreateStatic=0x00022575
--define_symbol xTaskGetCurrentTaskHandle=0x000225e5
--define_symbol xTaskGetSchedulerState=0x000225f1
--define_symbol xTaskGetTickCount=0x0002260d
--define_symbol xTaskGetTickCountFromISR=0x00022619
--define_symbol xTaskIncrementTick=0x00022629
--define_symbol xTaskPriorityDisinherit=0x000226f5
--define_symbol xTaskPriorityInherit=0x00022789
--define_symbol xTaskRemoveFromEventList=0x0002281d
--define_symbol xTaskResumeAll=0x0002289d
--define_symbol xTimerCreate=0x00022965
--define_symbol xTimerCreateStatic=0x00022999
--define_symbol xTimerCreateTimerTask=0x000229d1
--define_symbol xTimerGenericCommand=0x00022a3d
--define_symbol xTimerGetExpiryTime=0x00022aad
