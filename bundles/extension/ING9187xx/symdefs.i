...
--define_symbol nibble_for_char=0x0001d5a1
--define_symbol platform_32k_rc_auto_tune=0x0001d63d
--define_symbol platform_32k_rc_tune=0x0001d6b9
--define_symbol platform_calibrate_32k=0x0001d6cd
--define_symbol platform_config=0x0001d6d1
--define_symbol platform_get_heap_status=0x0001d789
--define_symbol platform_get_us_time=0x0001d7a1
--define_symbol platform_get_version=0x0001d7a5
--define_symbol platform_hrng=0x0001d7ad
--define_symbol platform_install_isr_stack=0x0001d7b5
--define_symbol platform_patch_rf_init_data=0x0001d7c1
--define_symbol platform_printf=0x0001d7cd
--define_symbol platform_raise_assertion=0x0001d7e1
--define_symbol platform_rand=0x0001d7f5
--define_symbol platform_read_info=0x0001d7f9
--define_symbol platform_read_persistent_reg=0x0001d815
--define_symbol platform_reset=0x0001d825
--define_symbol platform_set_evt_callback=0x0001d859
--define_symbol platform_set_irq_callback=0x0001d86d
--define_symbol platform_set_rf_clk_source=0x0001d8a5
--define_symbol platform_set_rf_init_data=0x0001d8b1
--define_symbol platform_set_rf_power_mapping=0x0001d8bd
--define_symbol platform_shutdown=0x0001d8c9
--define_symbol platform_switch_app=0x0001d8cd
--define_symbol platform_trace_raw=0x0001d8f9
--define_symbol platform_write_persistent_reg=0x0001d90d
--define_symbol printf_hexdump=0x0001d91d
--define_symbol pvPortMalloc=0x0001e421
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e509
--define_symbol pvTimerGetTimerID=0x0001e521
--define_symbol pxPortInitialiseStack=0x0001e54d
--define_symbol reverse_128=0x0001e6f5
--define_symbol reverse_24=0x0001e6fb
--define_symbol reverse_48=0x0001e701
--define_symbol reverse_56=0x0001e707
--define_symbol reverse_64=0x0001e70d
--define_symbol reverse_bd_addr=0x0001e713
--define_symbol reverse_bytes=0x0001e719
--define_symbol sm_add_event_handler=0x0001e885
--define_symbol sm_address_resolution_lookup=0x0001e9b1
--define_symbol sm_authenticated=0x0001ecfd
--define_symbol sm_authorization_decline=0x0001ed0b
--define_symbol sm_authorization_grant=0x0001ed2b
--define_symbol sm_authorization_state=0x0001ed4b
--define_symbol sm_bonding_decline=0x0001ed65
--define_symbol sm_config=0x0001f131
--define_symbol sm_config_conn=0x0001f149
--define_symbol sm_encryption_key_size=0x0001f2a7
--define_symbol sm_just_works_confirm=0x0001f6cd
--define_symbol sm_le_device_key=0x0001f8f9
--define_symbol sm_passkey_input=0x0001f98f
--define_symbol sm_private_random_address_generation_get=0x0001fcd5
--define_symbol sm_private_random_address_generation_get_mode=0x0001fcdd
--define_symbol sm_private_random_address_generation_set_mode=0x0001fce9
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fd11
--define_symbol sm_register_oob_data_callback=0x0001fe4d
--define_symbol sm_request_pairing=0x0001fe59
...
--define_symbol sscanf_bd_addr=0x00020aa9
--define_symbol sysSetPublicDeviceAddr=0x00020de1
--define_symbol uuid128_to_str=0x000213b9
--define_symbol uuid_add_bluetooth_prefix=0x00021411
--define_symbol uuid_has_bluetooth_prefix=0x00021431
--define_symbol uxQueueMessagesWaiting=0x00021475
--define_symbol uxQueueMessagesWaitingFromISR=0x0002149d
--define_symbol uxQueueSpacesAvailable=0x000214b9
--define_symbol uxTaskGetStackHighWaterMark=0x000214e5
--define_symbol vPortEnterCritical=0x00021609
--define_symbol vPortExitCritical=0x00021649
--define_symbol vPortFree=0x00021675
--define_symbol vPortSuppressTicksAndSleep=0x00021709
--define_symbol vPortValidateInterruptPriority=0x000217e1
--define_symbol vQueueDelete=0x00021835
--define_symbol vQueueWaitForMessageRestricted=0x00021861
--define_symbol vTaskDelay=0x000218a9
--define_symbol vTaskInternalSetTimeOutState=0x000218f5
--define_symbol vTaskMissedYield=0x00021905
--define_symbol vTaskPlaceOnEventList=0x00021911
--define_symbol vTaskPlaceOnEventListRestricted=0x00021949
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021989
--define_symbol vTaskResume=0x00021a35
--define_symbol vTaskStartScheduler=0x00021ab9
--define_symbol vTaskStepTick=0x00021b49
--define_symbol vTaskSuspend=0x00021b79
--define_symbol vTaskSuspendAll=0x00021c35
--define_symbol vTaskSwitchContext=0x00021c45
--define_symbol xPortStartScheduler=0x00021ced
--define_symbol xQueueAddToSet=0x00021da9
--define_symbol xQueueCreateCountingSemaphore=0x00021dcd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021e09
--define_symbol xQueueCreateMutex=0x00021e4d
--define_symbol xQueueCreateMutexStatic=0x00021e63
--define_symbol xQueueCreateSet=0x00021e7d
--define_symbol xQueueGenericCreate=0x00021e85
--define_symbol xQueueGenericCreateStatic=0x00021ed1
--define_symbol xQueueGenericReset=0x00021f39
--define_symbol xQueueGenericSend=0x00021fc5
--define_symbol xQueueGenericSendFromISR=0x00022131
--define_symbol xQueueGiveFromISR=0x000221f1
--define_symbol xQueueGiveMutexRecursive=0x00022295
--define_symbol xQueueIsQueueEmptyFromISR=0x000222d5
--define_symbol xQueueIsQueueFullFromISR=0x000222f9
--define_symbol xQueuePeek=0x00022321
--define_symbol xQueuePeekFromISR=0x00022449
--define_symbol xQueueReceive=0x000224b5
--define_symbol xQueueReceiveFromISR=0x000225e1
--define_symbol xQueueRemoveFromSet=0x00022675
--define_symbol xQueueSelectFromSet=0x00022697
--define_symbol xQueueSelectFromSetFromISR=0x000226a9
--define_symbol xQueueSemaphoreTake=0x000226bd
--define_symbol xQueueTakeMutexRecursive=0x00022829
--define_symbol xTaskCheckForTimeOut=0x0002286d
--define_symbol xTaskCreate=0x000228dd
--define_symbol xTaskCreateStatic=0x00022939
--define_symbol xTaskGetCurrentTaskHandle=0x000229a9
--define_symbol xTaskGetSchedulerState=0x000229b5
--define_symbol xTaskGetTickCount=0x000229d1
--define_symbol xTaskGetTickCountFromISR=0x000229dd
--define_symbol xTaskIncrementTick=0x000229ed
--define_symbol xTaskPriorityDisinherit=0x00022ab9
--define_symbol xTaskPriorityInherit=0x00022b4d
--define_symbol xTaskRemoveFromEventList=0x00022be1
--define_symbol xTaskResumeAll=0x00022c61
--define_symbol xTaskResumeFromISR=0x00022d29
--define_symbol xTimerCreate=0x00022db5
--define_symbol xTimerCreateStatic=0x00022de9
--define_symbol xTimerCreateTimerTask=0x00022e21
--define_symbol xTimerGenericCommand=0x00022e8d
--define_symbol xTimerGetExpiryTime=0x00022efd
