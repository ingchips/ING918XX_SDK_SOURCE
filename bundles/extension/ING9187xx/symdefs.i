...
--define_symbol sm_authenticated=0x0001ef49
--define_symbol sm_authorization_decline=0x0001ef57
--define_symbol sm_authorization_grant=0x0001ef77
--define_symbol sm_authorization_state=0x0001ef97
--define_symbol sm_bonding_decline=0x0001efb1
--define_symbol sm_config=0x0001f3d1
--define_symbol sm_config_conn=0x0001f3e9
--define_symbol sm_encryption_key_size=0x0001f59f
--define_symbol sm_just_works_confirm=0x0001fad9
--define_symbol sm_le_device_key=0x0001fe15
--define_symbol sm_passkey_input=0x0001feab
--define_symbol sm_private_random_address_generation_get=0x00020259
--define_symbol sm_private_random_address_generation_get_mode=0x00020261
--define_symbol sm_private_random_address_generation_set_mode=0x0002026d
--define_symbol sm_private_random_address_generation_set_update_period=0x00020295
--define_symbol sm_register_oob_data_callback=0x000203d1
--define_symbol sm_request_pairing=0x000203dd
--define_symbol sm_send_security_request=0x00020de3
--define_symbol sm_set_accepted_stk_generation_methods=0x00020e09
--define_symbol sm_set_authentication_requirements=0x00020e15
--define_symbol sm_set_encryption_key_size_range=0x00020e21
--define_symbol sscanf_bd_addr=0x000211e5
--define_symbol sysSetPublicDeviceAddr=0x0002154d
--define_symbol uuid128_to_str=0x00021b41
--define_symbol uuid_add_bluetooth_prefix=0x00021b99
--define_symbol uuid_has_bluetooth_prefix=0x00021bb9
--define_symbol uxListRemove=0x00021bd5
--define_symbol uxQueueMessagesWaiting=0x00021bfd
--define_symbol uxQueueMessagesWaitingFromISR=0x00021c25
--define_symbol uxQueueSpacesAvailable=0x00021c41
--define_symbol uxTaskGetStackHighWaterMark=0x00021c6d
--define_symbol uxTaskPriorityGet=0x00021c8d
--define_symbol uxTaskPriorityGetFromISR=0x00021ca9
...
--define_symbol vPortEnterCritical=0x00021dc1
--define_symbol vPortExitCritical=0x00021e05
--define_symbol vPortFree=0x00021e35
--define_symbol vPortSuppressTicksAndSleep=0x00021ec9
--define_symbol vPortValidateInterruptPriority=0x00021fe9
--define_symbol vQueueDelete=0x00022041
--define_symbol vQueueWaitForMessageRestricted=0x0002206d
--define_symbol vTaskDelay=0x000220b5
--define_symbol vTaskInternalSetTimeOutState=0x00022101
--define_symbol vTaskMissedYield=0x00022111
--define_symbol vTaskPlaceOnEventList=0x0002211d
--define_symbol vTaskPlaceOnEventListRestricted=0x00022155
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022195
--define_symbol vTaskPrioritySet=0x00022241
--define_symbol vTaskResume=0x00022309
--define_symbol vTaskStartScheduler=0x0002238d
--define_symbol vTaskStepTick=0x0002241d
--define_symbol vTaskSuspend=0x0002244d
--define_symbol vTaskSuspendAll=0x00022509
--define_symbol vTaskSwitchContext=0x00022519
--define_symbol xPortStartScheduler=0x000225c1
--define_symbol xQueueAddToSet=0x00022685
--define_symbol xQueueCreateCountingSemaphore=0x000226a9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000226e5
--define_symbol xQueueCreateMutex=0x00022729
--define_symbol xQueueCreateMutexStatic=0x0002273f
--define_symbol xQueueCreateSet=0x00022759
--define_symbol xQueueGenericCreate=0x00022761
--define_symbol xQueueGenericCreateStatic=0x000227ad
--define_symbol xQueueGenericReset=0x00022815
--define_symbol xQueueGenericSend=0x000228a1
--define_symbol xQueueGenericSendFromISR=0x00022a0d
--define_symbol xQueueGiveFromISR=0x00022acd
--define_symbol xQueueGiveMutexRecursive=0x00022b71
--define_symbol xQueueIsQueueEmptyFromISR=0x00022bb1
--define_symbol xQueueIsQueueFullFromISR=0x00022bd5
--define_symbol xQueuePeek=0x00022bfd
--define_symbol xQueuePeekFromISR=0x00022d25
--define_symbol xQueueReceive=0x00022d91
--define_symbol xQueueReceiveFromISR=0x00022ebd
--define_symbol xQueueRemoveFromSet=0x00022f51
--define_symbol xQueueSelectFromSet=0x00022f73
--define_symbol xQueueSelectFromSetFromISR=0x00022f85
--define_symbol xQueueSemaphoreTake=0x00022f99
--define_symbol xQueueTakeMutexRecursive=0x00023105
--define_symbol xTaskCheckForTimeOut=0x00023149
--define_symbol xTaskCreate=0x000231b9
--define_symbol xTaskCreateStatic=0x00023215
--define_symbol xTaskGetCurrentTaskHandle=0x00023285
--define_symbol xTaskGetSchedulerState=0x00023291
--define_symbol xTaskGetTickCount=0x000232ad
--define_symbol xTaskGetTickCountFromISR=0x000232b9
--define_symbol xTaskIncrementTick=0x000232c9
--define_symbol xTaskPriorityDisinherit=0x00023395
--define_symbol xTaskPriorityInherit=0x00023429
--define_symbol xTaskRemoveFromEventList=0x000234bd
--define_symbol xTaskResumeAll=0x0002353d
--define_symbol xTaskResumeFromISR=0x00023605
--define_symbol xTimerCreate=0x00023691
--define_symbol xTimerCreateStatic=0x000236c5
--define_symbol xTimerCreateTimerTask=0x000236fd
--define_symbol xTimerGenericCommand=0x00023769
--define_symbol xTimerGetExpiryTime=0x000237d9
--define_symbol xTimerGetTimerDaemonTaskHandle=0x000237f9
