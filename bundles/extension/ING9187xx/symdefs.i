...
--define_symbol nibble_for_char=0x0001d791
--define_symbol platform_32k_rc_auto_tune=0x0001d82d
--define_symbol platform_32k_rc_tune=0x0001d8a9
--define_symbol platform_calibrate_32k=0x0001d8bd
--define_symbol platform_config=0x0001d8c1
--define_symbol platform_get_heap_status=0x0001d995
--define_symbol platform_get_task_handle=0x0001d9ad
--define_symbol platform_get_us_time=0x0001d9cd
--define_symbol platform_get_version=0x0001d9d1
--define_symbol platform_hrng=0x0001d9d9
--define_symbol platform_install_isr_stack=0x0001d9e1
--define_symbol platform_patch_rf_init_data=0x0001d9ed
...
--define_symbol platform_set_evt_callback=0x0001da85
--define_symbol platform_set_irq_callback=0x0001da99
--define_symbol platform_set_rf_clk_source=0x0001dad1
--define_symbol platform_set_rf_init_data=0x0001dadd
--define_symbol platform_set_rf_power_mapping=0x0001dae9
--define_symbol platform_set_timer=0x0001daf5
--define_symbol platform_shutdown=0x0001daf9
--define_symbol platform_switch_app=0x0001dafd
--define_symbol platform_trace_raw=0x0001db29
--define_symbol platform_write_persistent_reg=0x0001db41
--define_symbol printf_hexdump=0x0001db51
--define_symbol pvPortMalloc=0x0001e659
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e741
--define_symbol pvTimerGetTimerID=0x0001e759
--define_symbol pxPortInitialiseStack=0x0001e785
--define_symbol reverse_128=0x0001e92d
--define_symbol reverse_24=0x0001e933
--define_symbol reverse_48=0x0001e939
--define_symbol reverse_56=0x0001e93f
--define_symbol reverse_64=0x0001e945
--define_symbol reverse_bd_addr=0x0001e94b
--define_symbol reverse_bytes=0x0001e951
...
--define_symbol sscanf_bd_addr=0x0002121d
--define_symbol sysSetPublicDeviceAddr=0x00021585
--define_symbol uuid128_to_str=0x00021b69
--define_symbol uuid_add_bluetooth_prefix=0x00021bc1
--define_symbol uuid_has_bluetooth_prefix=0x00021be1
--define_symbol uxListRemove=0x00021bfd
--define_symbol uxQueueMessagesWaiting=0x00021c25
--define_symbol uxQueueMessagesWaitingFromISR=0x00021c4d
--define_symbol uxQueueSpacesAvailable=0x00021c69
--define_symbol uxTaskGetStackHighWaterMark=0x00021c95
--define_symbol uxTaskPriorityGet=0x00021cb5
--define_symbol uxTaskPriorityGetFromISR=0x00021cd1
--define_symbol vListInitialise=0x00021d83
--define_symbol vListInitialiseItem=0x00021d99
--define_symbol vListInsert=0x00021d9f
--define_symbol vListInsertEnd=0x00021dcf
--define_symbol vPortEndScheduler=0x00021de9
--define_symbol vPortEnterCritical=0x00021e11
--define_symbol vPortExitCritical=0x00021e55
--define_symbol vPortFree=0x00021e85
--define_symbol vPortSuppressTicksAndSleep=0x00021f19
--define_symbol vPortValidateInterruptPriority=0x00022021
--define_symbol vQueueDelete=0x00022079
--define_symbol vQueueWaitForMessageRestricted=0x000220a5
--define_symbol vTaskDelay=0x000220ed
--define_symbol vTaskInternalSetTimeOutState=0x00022139
--define_symbol vTaskMissedYield=0x00022149
--define_symbol vTaskPlaceOnEventList=0x00022155
--define_symbol vTaskPlaceOnEventListRestricted=0x0002218d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000221cd
--define_symbol vTaskPrioritySet=0x00022279
--define_symbol vTaskResume=0x00022341
--define_symbol vTaskStartScheduler=0x000223c5
--define_symbol vTaskStepTick=0x00022455
--define_symbol vTaskSuspend=0x00022485
--define_symbol vTaskSuspendAll=0x00022541
--define_symbol vTaskSwitchContext=0x00022551
--define_symbol xPortStartScheduler=0x000225f9
--define_symbol xQueueAddToSet=0x000226b9
--define_symbol xQueueCreateCountingSemaphore=0x000226dd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022719
--define_symbol xQueueCreateMutex=0x0002275d
--define_symbol xQueueCreateMutexStatic=0x00022773
--define_symbol xQueueCreateSet=0x0002278d
--define_symbol xQueueGenericCreate=0x00022795
--define_symbol xQueueGenericCreateStatic=0x000227e1
--define_symbol xQueueGenericReset=0x00022849
--define_symbol xQueueGenericSend=0x000228d5
--define_symbol xQueueGenericSendFromISR=0x00022a41
--define_symbol xQueueGiveFromISR=0x00022b01
--define_symbol xQueueGiveMutexRecursive=0x00022ba5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022be5
--define_symbol xQueueIsQueueFullFromISR=0x00022c09
--define_symbol xQueuePeek=0x00022c31
--define_symbol xQueuePeekFromISR=0x00022d59
--define_symbol xQueueReceive=0x00022dc5
--define_symbol xQueueReceiveFromISR=0x00022ef1
--define_symbol xQueueRemoveFromSet=0x00022f85
--define_symbol xQueueSelectFromSet=0x00022fa7
--define_symbol xQueueSelectFromSetFromISR=0x00022fb9
--define_symbol xQueueSemaphoreTake=0x00022fcd
--define_symbol xQueueTakeMutexRecursive=0x00023139
--define_symbol xTaskCheckForTimeOut=0x0002317d
--define_symbol xTaskCreate=0x000231ed
--define_symbol xTaskCreateStatic=0x00023249
--define_symbol xTaskGetCurrentTaskHandle=0x000232b9
--define_symbol xTaskGetSchedulerState=0x000232c5
--define_symbol xTaskGetTickCount=0x000232e1
--define_symbol xTaskGetTickCountFromISR=0x000232ed
--define_symbol xTaskIncrementTick=0x000232fd
--define_symbol xTaskPriorityDisinherit=0x000233c9
--define_symbol xTaskPriorityInherit=0x0002345d
--define_symbol xTaskRemoveFromEventList=0x000234f1
--define_symbol xTaskResumeAll=0x00023571
--define_symbol xTaskResumeFromISR=0x00023639
--define_symbol xTimerCreate=0x000236c5
--define_symbol xTimerCreateStatic=0x000236f9
--define_symbol xTimerCreateTimerTask=0x00023731
--define_symbol xTimerGenericCommand=0x0002379d
--define_symbol xTimerGetExpiryTime=0x0002380d
--define_symbol xTimerGetTimerDaemonTaskHandle=0x0002382d
