...
--define_symbol nibble_for_char=0x0001d5d9
--define_symbol platform_32k_rc_auto_tune=0x0001d675
--define_symbol platform_32k_rc_tune=0x0001d6f1
--define_symbol platform_calibrate_32k=0x0001d705
--define_symbol platform_config=0x0001d709
--define_symbol platform_get_heap_status=0x0001d7c9
--define_symbol platform_get_us_time=0x0001d7e1
--define_symbol platform_get_version=0x0001d7e5
--define_symbol platform_hrng=0x0001d7ed
--define_symbol platform_install_isr_stack=0x0001d7f5
--define_symbol platform_patch_rf_init_data=0x0001d801
--define_symbol platform_printf=0x0001d80d
--define_symbol platform_raise_assertion=0x0001d821
--define_symbol platform_rand=0x0001d835
--define_symbol platform_read_info=0x0001d839
--define_symbol platform_read_persistent_reg=0x0001d855
--define_symbol platform_reset=0x0001d865
--define_symbol platform_set_evt_callback=0x0001d899
--define_symbol platform_set_irq_callback=0x0001d8ad
--define_symbol platform_set_rf_clk_source=0x0001d8e5
--define_symbol platform_set_rf_init_data=0x0001d8f1
--define_symbol platform_set_rf_power_mapping=0x0001d8fd
--define_symbol platform_shutdown=0x0001d909
--define_symbol platform_switch_app=0x0001d90d
--define_symbol platform_trace_raw=0x0001d939
--define_symbol platform_write_persistent_reg=0x0001d951
--define_symbol printf_hexdump=0x0001d961
--define_symbol pvPortMalloc=0x0001e469
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e551
--define_symbol pvTimerGetTimerID=0x0001e569
--define_symbol pxPortInitialiseStack=0x0001e595
--define_symbol reverse_128=0x0001e73d
--define_symbol reverse_24=0x0001e743
--define_symbol reverse_48=0x0001e749
--define_symbol reverse_56=0x0001e74f
--define_symbol reverse_64=0x0001e755
--define_symbol reverse_bd_addr=0x0001e75b
--define_symbol reverse_bytes=0x0001e761
--define_symbol sm_add_event_handler=0x0001e8cd
--define_symbol sm_address_resolution_lookup=0x0001ea25
--define_symbol sm_authenticated=0x0001ed71
--define_symbol sm_authorization_decline=0x0001ed7f
--define_symbol sm_authorization_grant=0x0001ed9f
--define_symbol sm_authorization_state=0x0001edbf
--define_symbol sm_bonding_decline=0x0001edd9
--define_symbol sm_config=0x0001f1f9
--define_symbol sm_config_conn=0x0001f211
--define_symbol sm_encryption_key_size=0x0001f397
--define_symbol sm_just_works_confirm=0x0001f8c5
--define_symbol sm_le_device_key=0x0001fc01
--define_symbol sm_passkey_input=0x0001fc97
--define_symbol sm_private_random_address_generation_get=0x0002003d
--define_symbol sm_private_random_address_generation_get_mode=0x00020045
--define_symbol sm_private_random_address_generation_set_mode=0x00020051
--define_symbol sm_private_random_address_generation_set_update_period=0x00020079
--define_symbol sm_register_oob_data_callback=0x000201b5
--define_symbol sm_request_pairing=0x000201c1
--define_symbol sm_send_security_request=0x00020bbb
--define_symbol sm_set_accepted_stk_generation_methods=0x00020be1
--define_symbol sm_set_authentication_requirements=0x00020bed
--define_symbol sm_set_encryption_key_size_range=0x00020bf9
--define_symbol sscanf_bd_addr=0x00020f55
--define_symbol sysSetPublicDeviceAddr=0x000212bd
--define_symbol uuid128_to_str=0x000218b1
--define_symbol uuid_add_bluetooth_prefix=0x00021909
--define_symbol uuid_has_bluetooth_prefix=0x00021929
--define_symbol uxQueueMessagesWaiting=0x0002196d
--define_symbol uxQueueMessagesWaitingFromISR=0x00021995
--define_symbol uxQueueSpacesAvailable=0x000219b1
--define_symbol uxTaskGetStackHighWaterMark=0x000219dd
--define_symbol vPortEnterCritical=0x00021ae9
--define_symbol vPortExitCritical=0x00021b2d
--define_symbol vPortFree=0x00021b5d
--define_symbol vPortSuppressTicksAndSleep=0x00021bf1
--define_symbol vPortValidateInterruptPriority=0x00021d11
--define_symbol vQueueDelete=0x00021d69
--define_symbol vQueueWaitForMessageRestricted=0x00021d95
--define_symbol vTaskDelay=0x00021ddd
--define_symbol vTaskInternalSetTimeOutState=0x00021e29
--define_symbol vTaskMissedYield=0x00021e39
--define_symbol vTaskPlaceOnEventList=0x00021e45
--define_symbol vTaskPlaceOnEventListRestricted=0x00021e7d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021ebd
--define_symbol vTaskResume=0x00021f69
--define_symbol vTaskStartScheduler=0x00021fed
--define_symbol vTaskStepTick=0x0002207d
--define_symbol vTaskSuspend=0x000220ad
--define_symbol vTaskSuspendAll=0x00022169
--define_symbol vTaskSwitchContext=0x00022179
--define_symbol xPortStartScheduler=0x00022221
--define_symbol xQueueAddToSet=0x000222e5
--define_symbol xQueueCreateCountingSemaphore=0x00022309
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022345
--define_symbol xQueueCreateMutex=0x00022389
--define_symbol xQueueCreateMutexStatic=0x0002239f
--define_symbol xQueueCreateSet=0x000223b9
--define_symbol xQueueGenericCreate=0x000223c1
--define_symbol xQueueGenericCreateStatic=0x0002240d
--define_symbol xQueueGenericReset=0x00022475
--define_symbol xQueueGenericSend=0x00022501
--define_symbol xQueueGenericSendFromISR=0x0002266d
--define_symbol xQueueGiveFromISR=0x0002272d
--define_symbol xQueueGiveMutexRecursive=0x000227d1
--define_symbol xQueueIsQueueEmptyFromISR=0x00022811
--define_symbol xQueueIsQueueFullFromISR=0x00022835
--define_symbol xQueuePeek=0x0002285d
--define_symbol xQueuePeekFromISR=0x00022985
--define_symbol xQueueReceive=0x000229f1
--define_symbol xQueueReceiveFromISR=0x00022b1d
--define_symbol xQueueRemoveFromSet=0x00022bb1
--define_symbol xQueueSelectFromSet=0x00022bd3
--define_symbol xQueueSelectFromSetFromISR=0x00022be5
--define_symbol xQueueSemaphoreTake=0x00022bf9
--define_symbol xQueueTakeMutexRecursive=0x00022d65
--define_symbol xTaskCheckForTimeOut=0x00022da9
--define_symbol xTaskCreate=0x00022e19
--define_symbol xTaskCreateStatic=0x00022e75
--define_symbol xTaskGetCurrentTaskHandle=0x00022ee5
--define_symbol xTaskGetSchedulerState=0x00022ef1
--define_symbol xTaskGetTickCount=0x00022f0d
--define_symbol xTaskGetTickCountFromISR=0x00022f19
--define_symbol xTaskIncrementTick=0x00022f29
--define_symbol xTaskPriorityDisinherit=0x00022ff5
--define_symbol xTaskPriorityInherit=0x00023089
--define_symbol xTaskRemoveFromEventList=0x0002311d
--define_symbol xTaskResumeAll=0x0002319d
--define_symbol xTaskResumeFromISR=0x00023265
--define_symbol xTimerCreate=0x000232f1
--define_symbol xTimerCreateStatic=0x00023325
--define_symbol xTimerCreateTimerTask=0x0002335d
--define_symbol xTimerGenericCommand=0x000233c9
--define_symbol xTimerGetExpiryTime=0x00023439
