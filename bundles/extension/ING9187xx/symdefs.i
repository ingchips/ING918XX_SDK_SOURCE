...
--define_symbol nibble_for_char=0x0001d1ed
--define_symbol platform_32k_rc_auto_tune=0x0001d28d
--define_symbol platform_32k_rc_tune=0x0001d309
--define_symbol platform_calibrate_32k=0x0001d31d
--define_symbol platform_config=0x0001d321
--define_symbol platform_get_heap_status=0x0001d3d1
...
--define_symbol platform_install_isr_stack=0x0001d3fd
--define_symbol platform_patch_rf_init_data=0x0001d409
--define_symbol platform_printf=0x0001d415
--define_symbol platform_raise_assertion=0x0001d429
--define_symbol platform_rand=0x0001d43d
--define_symbol platform_read_info=0x0001d441
--define_symbol platform_read_persistent_reg=0x0001d45d
--define_symbol platform_reset=0x0001d46d
--define_symbol platform_set_evt_callback=0x0001d4a1
--define_symbol platform_set_irq_callback=0x0001d4b5
--define_symbol platform_set_rf_clk_source=0x0001d4ed
--define_symbol platform_set_rf_init_data=0x0001d4f9
--define_symbol platform_set_rf_power_mapping=0x0001d505
--define_symbol platform_shutdown=0x0001d511
--define_symbol platform_switch_app=0x0001d515
--define_symbol platform_trace_raw=0x0001d541
--define_symbol platform_write_persistent_reg=0x0001d555
--define_symbol printf_hexdump=0x0001d565
--define_symbol pvPortMalloc=0x0001e025
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e10d
--define_symbol pvTimerGetTimerID=0x0001e125
--define_symbol pxPortInitialiseStack=0x0001e151
--define_symbol reverse_128=0x0001e2f9
--define_symbol reverse_24=0x0001e2ff
--define_symbol reverse_48=0x0001e305
--define_symbol reverse_56=0x0001e30b
--define_symbol reverse_64=0x0001e311
--define_symbol reverse_bd_addr=0x0001e317
--define_symbol reverse_bytes=0x0001e31d
--define_symbol sm_add_event_handler=0x0001e469
--define_symbol sm_address_resolution_lookup=0x0001e595
--define_symbol sm_authenticated=0x0001e66f
--define_symbol sm_authorization_decline=0x0001e67d
--define_symbol sm_authorization_grant=0x0001e69d
--define_symbol sm_authorization_state=0x0001e6bd
--define_symbol sm_bonding_decline=0x0001e6d9
--define_symbol sm_config=0x0001eab1
--define_symbol sm_encryption_key_size=0x0001ebbd
--define_symbol sm_just_works_confirm=0x0001f379
--define_symbol sm_le_device_key=0x0001f5c9
--define_symbol sm_passkey_input=0x0001f661
...
--define_symbol sm_send_security_request=0x000204a7
--define_symbol sm_set_accepted_stk_generation_methods=0x000204cd
--define_symbol sm_set_authentication_requirements=0x000204d9
--define_symbol sm_set_encryption_key_size_range=0x000204e5
--define_symbol sscanf_bd_addr=0x000207e1
--define_symbol sysSetPublicDeviceAddr=0x00020b45
--define_symbol uuid128_to_str=0x000210e9
--define_symbol uuid_add_bluetooth_prefix=0x00021141
--define_symbol uuid_has_bluetooth_prefix=0x00021161
--define_symbol uxQueueMessagesWaiting=0x000211a5
--define_symbol uxQueueMessagesWaitingFromISR=0x000211cd
--define_symbol uxQueueSpacesAvailable=0x000211e9
--define_symbol uxTaskGetStackHighWaterMark=0x00021215
--define_symbol vPortEnterCritical=0x000212cd
--define_symbol vPortExitCritical=0x0002130d
--define_symbol vPortFree=0x00021339
--define_symbol vPortSuppressTicksAndSleep=0x000213cd
--define_symbol vPortValidateInterruptPriority=0x000214a5
--define_symbol vQueueDelete=0x000214f9
--define_symbol vQueueWaitForMessageRestricted=0x00021525
--define_symbol vTaskDelay=0x0002156d
--define_symbol vTaskInternalSetTimeOutState=0x000215b9
--define_symbol vTaskMissedYield=0x000215c9
--define_symbol vTaskPlaceOnEventList=0x000215d5
--define_symbol vTaskPlaceOnEventListRestricted=0x0002160d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002164d
--define_symbol vTaskStartScheduler=0x000216f9
--define_symbol vTaskStepTick=0x00021789
--define_symbol vTaskSuspendAll=0x000217b9
--define_symbol vTaskSwitchContext=0x000217c9
--define_symbol xPortStartScheduler=0x00021871
--define_symbol xQueueAddToSet=0x0002192d
--define_symbol xQueueCreateCountingSemaphore=0x00021951
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002198d
--define_symbol xQueueCreateMutex=0x000219d1
--define_symbol xQueueCreateMutexStatic=0x000219e7
--define_symbol xQueueCreateSet=0x00021a01
--define_symbol xQueueGenericCreate=0x00021a09
--define_symbol xQueueGenericCreateStatic=0x00021a55
--define_symbol xQueueGenericReset=0x00021abd
--define_symbol xQueueGenericSend=0x00021b49
--define_symbol xQueueGenericSendFromISR=0x00021cb5
--define_symbol xQueueGiveFromISR=0x00021d75
--define_symbol xQueueGiveMutexRecursive=0x00021e19
--define_symbol xQueueIsQueueEmptyFromISR=0x00021e59
--define_symbol xQueueIsQueueFullFromISR=0x00021e7d
--define_symbol xQueuePeek=0x00021ea5
--define_symbol xQueuePeekFromISR=0x00021fcd
--define_symbol xQueueReceive=0x00022039
--define_symbol xQueueReceiveFromISR=0x00022165
--define_symbol xQueueRemoveFromSet=0x000221f9
--define_symbol xQueueSelectFromSet=0x0002221b
--define_symbol xQueueSelectFromSetFromISR=0x0002222d
--define_symbol xQueueSemaphoreTake=0x00022241
--define_symbol xQueueTakeMutexRecursive=0x000223ad
--define_symbol xTaskCheckForTimeOut=0x000223f1
--define_symbol xTaskCreate=0x00022461
--define_symbol xTaskCreateStatic=0x000224bd
--define_symbol xTaskGetCurrentTaskHandle=0x0002252d
--define_symbol xTaskGetSchedulerState=0x00022539
--define_symbol xTaskGetTickCount=0x00022555
--define_symbol xTaskGetTickCountFromISR=0x00022561
--define_symbol xTaskIncrementTick=0x00022571
--define_symbol xTaskPriorityDisinherit=0x0002263d
--define_symbol xTaskPriorityInherit=0x000226d1
--define_symbol xTaskRemoveFromEventList=0x00022765
--define_symbol xTaskResumeAll=0x000227e5
--define_symbol xTimerCreate=0x000228ad
--define_symbol xTimerCreateStatic=0x000228e1
--define_symbol xTimerCreateTimerTask=0x00022919
--define_symbol xTimerGenericCommand=0x00022985
--define_symbol xTimerGetExpiryTime=0x000229f5
