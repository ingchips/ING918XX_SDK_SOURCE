...
--define_symbol ll_ackable_packet_alloc=0x0000cd1b
--define_symbol ll_ackable_packet_get_status=0x0000ce03
--define_symbol ll_ackable_packet_run=0x0000ce75
--define_symbol ll_ackable_packet_set_tx_data=0x0000cf1d
--define_symbol ll_free=0x0000cf37
...
--define_symbol ll_raw_packet_free=0x0000d1c9
--define_symbol ll_raw_packet_get_rx_data=0x0000d1f3
--define_symbol ll_raw_packet_recv=0x0000d289
--define_symbol ll_raw_packet_send=0x0000d31d
--define_symbol ll_raw_packet_set_param=0x0000d38d
--define_symbol ll_raw_packet_set_tx_data=0x0000d3f3
--define_symbol ll_scan_set_fixed_channel=0x0000d4b5
--define_symbol ll_set_adv_coded_scheme=0x0000d5c9
--define_symbol ll_set_conn_coded_scheme=0x0000d5f9
--define_symbol ll_set_conn_latency=0x0000d625
--define_symbol ll_set_conn_tx_power=0x0000d655
--define_symbol ll_set_def_antenna=0x0000d69d
--define_symbol ll_set_initiating_coded_scheme=0x0000d6b9
--define_symbol ll_set_max_conn_number=0x0000d6c5
--define_symbol nibble_for_char=0x0001d379
--define_symbol platform_32k_rc_auto_tune=0x0001d419
--define_symbol platform_32k_rc_tune=0x0001d495
--define_symbol platform_calibrate_32k=0x0001d4a9
--define_symbol platform_config=0x0001d4ad
--define_symbol platform_get_heap_status=0x0001d565
...
--define_symbol platform_patch_rf_init_data=0x0001d59d
--define_symbol platform_printf=0x0001d5a9
--define_symbol platform_raise_assertion=0x0001d5bd
--define_symbol platform_rand=0x0001d5d1
--define_symbol platform_read_info=0x0001d5d5
--define_symbol platform_read_persistent_reg=0x0001d5f1
--define_symbol platform_reset=0x0001d601
--define_symbol platform_set_evt_callback=0x0001d635
--define_symbol platform_set_irq_callback=0x0001d649
...
--define_symbol platform_shutdown=0x0001d6a5
--define_symbol platform_switch_app=0x0001d6a9
--define_symbol platform_trace_raw=0x0001d6d5
--define_symbol platform_write_persistent_reg=0x0001d6e9
--define_symbol printf_hexdump=0x0001d6f9
--define_symbol pvPortMalloc=0x0001e1c1
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e2a9
--define_symbol pvTimerGetTimerID=0x0001e2c1
--define_symbol pxPortInitialiseStack=0x0001e2ed
--define_symbol reverse_128=0x0001e495
--define_symbol reverse_24=0x0001e49b
--define_symbol reverse_48=0x0001e4a1
--define_symbol reverse_56=0x0001e4a7
--define_symbol reverse_64=0x0001e4ad
--define_symbol reverse_bd_addr=0x0001e4b3
--define_symbol reverse_bytes=0x0001e4b9
--define_symbol sm_add_event_handler=0x0001e625
--define_symbol sm_address_resolution_lookup=0x0001e751
--define_symbol sm_authenticated=0x0001e82b
--define_symbol sm_authorization_decline=0x0001e839
--define_symbol sm_authorization_grant=0x0001e859
--define_symbol sm_authorization_state=0x0001e879
--define_symbol sm_bonding_decline=0x0001e895
--define_symbol sm_config=0x0001ec6d
--define_symbol sm_encryption_key_size=0x0001ed79
--define_symbol sm_just_works_confirm=0x0001f531
--define_symbol sm_le_device_key=0x0001f789
--define_symbol sm_passkey_input=0x0001f821
--define_symbol sm_private_random_address_generation_get=0x0001fbad
--define_symbol sm_private_random_address_generation_get_mode=0x0001fbb5
--define_symbol sm_private_random_address_generation_set_mode=0x0001fbc1
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fbe9
--define_symbol sm_register_oob_data_callback=0x0001fc21
--define_symbol sm_request_pairing=0x0001fc2d
...
--define_symbol sscanf_bd_addr=0x000209ad
--define_symbol sysSetPublicDeviceAddr=0x00020d0d
--define_symbol uuid128_to_str=0x000212b1
--define_symbol uuid_add_bluetooth_prefix=0x00021309
--define_symbol uuid_has_bluetooth_prefix=0x00021329
--define_symbol uxQueueMessagesWaiting=0x0002136d
--define_symbol uxQueueMessagesWaitingFromISR=0x00021395
--define_symbol uxQueueSpacesAvailable=0x000213b1
--define_symbol uxTaskGetStackHighWaterMark=0x000213dd
--define_symbol vPortEnterCritical=0x00021495
--define_symbol vPortExitCritical=0x000214d5
--define_symbol vPortFree=0x00021501
--define_symbol vPortSuppressTicksAndSleep=0x00021595
--define_symbol vPortValidateInterruptPriority=0x0002166d
--define_symbol vQueueDelete=0x000216c1
--define_symbol vQueueWaitForMessageRestricted=0x000216ed
--define_symbol vTaskDelay=0x00021735
--define_symbol vTaskInternalSetTimeOutState=0x00021781
--define_symbol vTaskMissedYield=0x00021791
--define_symbol vTaskPlaceOnEventList=0x0002179d
--define_symbol vTaskPlaceOnEventListRestricted=0x000217d5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021815
--define_symbol vTaskStartScheduler=0x000218c1
--define_symbol vTaskStepTick=0x00021951
--define_symbol vTaskSuspendAll=0x00021981
--define_symbol vTaskSwitchContext=0x00021991
--define_symbol xPortStartScheduler=0x00021a39
--define_symbol xQueueAddToSet=0x00021af5
--define_symbol xQueueCreateCountingSemaphore=0x00021b19
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021b55
--define_symbol xQueueCreateMutex=0x00021b99
--define_symbol xQueueCreateMutexStatic=0x00021baf
--define_symbol xQueueCreateSet=0x00021bc9
--define_symbol xQueueGenericCreate=0x00021bd1
--define_symbol xQueueGenericCreateStatic=0x00021c1d
--define_symbol xQueueGenericReset=0x00021c85
--define_symbol xQueueGenericSend=0x00021d11
--define_symbol xQueueGenericSendFromISR=0x00021e7d
--define_symbol xQueueGiveFromISR=0x00021f3d
--define_symbol xQueueGiveMutexRecursive=0x00021fe1
--define_symbol xQueueIsQueueEmptyFromISR=0x00022021
--define_symbol xQueueIsQueueFullFromISR=0x00022045
--define_symbol xQueuePeek=0x0002206d
--define_symbol xQueuePeekFromISR=0x00022195
--define_symbol xQueueReceive=0x00022201
--define_symbol xQueueReceiveFromISR=0x0002232d
--define_symbol xQueueRemoveFromSet=0x000223c1
--define_symbol xQueueSelectFromSet=0x000223e3
--define_symbol xQueueSelectFromSetFromISR=0x000223f5
--define_symbol xQueueSemaphoreTake=0x00022409
--define_symbol xQueueTakeMutexRecursive=0x00022575
--define_symbol xTaskCheckForTimeOut=0x000225b9
--define_symbol xTaskCreate=0x00022629
--define_symbol xTaskCreateStatic=0x00022685
--define_symbol xTaskGetCurrentTaskHandle=0x000226f5
--define_symbol xTaskGetSchedulerState=0x00022701
--define_symbol xTaskGetTickCount=0x0002271d
--define_symbol xTaskGetTickCountFromISR=0x00022729
--define_symbol xTaskIncrementTick=0x00022739
--define_symbol xTaskPriorityDisinherit=0x00022805
--define_symbol xTaskPriorityInherit=0x00022899
--define_symbol xTaskRemoveFromEventList=0x0002292d
--define_symbol xTaskResumeAll=0x000229ad
--define_symbol xTimerCreate=0x00022a75
--define_symbol xTimerCreateStatic=0x00022aa9
--define_symbol xTimerCreateTimerTask=0x00022ae1
--define_symbol xTimerGenericCommand=0x00022b4d
--define_symbol xTimerGetExpiryTime=0x00022bbd
