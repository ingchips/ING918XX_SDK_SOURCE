...
--define_symbol ll_free=0x0000cc2b
...
--define_symbol nibble_for_char=0x0001cf15
--define_symbol platform_32k_rc_auto_tune=0x0001cfcd
--define_symbol platform_32k_rc_tune=0x0001d049
--define_symbol platform_calibrate_32k=0x0001d05d
--define_symbol platform_config=0x0001d061
--define_symbol platform_get_heap_status=0x0001d111
...
--define_symbol platform_patch_rf_init_data=0x0001d13d
--define_symbol platform_printf=0x0001d149
--define_symbol platform_raise_assertion=0x0001d15d
--define_symbol platform_rand=0x0001d171
--define_symbol platform_read_info=0x0001d175
--define_symbol platform_read_persistent_reg=0x0001d191
--define_symbol platform_reset=0x0001d1a1
--define_symbol platform_set_evt_callback=0x0001d1d5
--define_symbol platform_set_irq_callback=0x0001d1e9
--define_symbol platform_set_rf_clk_source=0x0001d221
--define_symbol platform_set_rf_init_data=0x0001d22d
--define_symbol platform_set_rf_power_mapping=0x0001d239
--define_symbol platform_shutdown=0x0001d245
--define_symbol platform_switch_app=0x0001d249
--define_symbol platform_trace_raw=0x0001d275
--define_symbol platform_write_persistent_reg=0x0001d289
--define_symbol printf_hexdump=0x0001d299
--define_symbol pvPortMalloc=0x0001ddc1
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dea9
--define_symbol pvTimerGetTimerID=0x0001dec1
--define_symbol pxPortInitialiseStack=0x0001deed
--define_symbol reverse_128=0x0001e095
--define_symbol reverse_24=0x0001e09b
--define_symbol reverse_48=0x0001e0a1
--define_symbol reverse_56=0x0001e0a7
--define_symbol reverse_64=0x0001e0ad
--define_symbol reverse_bd_addr=0x0001e0b3
--define_symbol reverse_bytes=0x0001e0b9
--define_symbol sm_add_event_handler=0x0001e205
--define_symbol sm_address_resolution_lookup=0x0001e331
--define_symbol sm_authenticated=0x0001e40b
--define_symbol sm_authorization_decline=0x0001e419
--define_symbol sm_authorization_grant=0x0001e439
--define_symbol sm_authorization_state=0x0001e459
--define_symbol sm_bonding_decline=0x0001e475
--define_symbol sm_config=0x0001e84d
--define_symbol sm_encryption_key_size=0x0001e959
--define_symbol sm_just_works_confirm=0x0001f129
--define_symbol sm_le_device_key=0x0001f379
--define_symbol sm_passkey_input=0x0001f411
--define_symbol sm_private_random_address_generation_get=0x0001f79d
--define_symbol sm_private_random_address_generation_get_mode=0x0001f7a5
--define_symbol sm_private_random_address_generation_set_mode=0x0001f7b1
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f7d9
--define_symbol sm_register_oob_data_callback=0x0001f811
--define_symbol sm_request_pairing=0x0001f81d
--define_symbol sm_send_security_request=0x00020257
--define_symbol sm_set_accepted_stk_generation_methods=0x0002027d
--define_symbol sm_set_authentication_requirements=0x00020289
--define_symbol sm_set_encryption_key_size_range=0x00020295
--define_symbol sscanf_bd_addr=0x00020591
--define_symbol sysSetPublicDeviceAddr=0x000208ad
--define_symbol uuid128_to_str=0x00020e51
--define_symbol uuid_add_bluetooth_prefix=0x00020ea9
--define_symbol uuid_has_bluetooth_prefix=0x00020ec9
--define_symbol uxQueueMessagesWaiting=0x00020f0d
--define_symbol uxQueueMessagesWaitingFromISR=0x00020f35
--define_symbol uxQueueSpacesAvailable=0x00020f51
--define_symbol vPortEnterCritical=0x00021015
--define_symbol vPortExitCritical=0x00021055
--define_symbol vPortFree=0x00021081
--define_symbol vPortSuppressTicksAndSleep=0x00021115
--define_symbol vPortValidateInterruptPriority=0x000211ed
--define_symbol vQueueDelete=0x00021241
--define_symbol vQueueWaitForMessageRestricted=0x0002126d
--define_symbol vTaskDelay=0x000212b5
--define_symbol vTaskInternalSetTimeOutState=0x00021301
--define_symbol vTaskMissedYield=0x00021311
--define_symbol vTaskPlaceOnEventList=0x0002131d
--define_symbol vTaskPlaceOnEventListRestricted=0x00021355
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021395
--define_symbol vTaskStartScheduler=0x00021441
--define_symbol vTaskStepTick=0x000214d1
--define_symbol vTaskSuspendAll=0x00021501
--define_symbol vTaskSwitchContext=0x00021511
--define_symbol xPortStartScheduler=0x000215b9
--define_symbol xQueueAddToSet=0x00021675
--define_symbol xQueueCreateCountingSemaphore=0x00021699
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000216d5
--define_symbol xQueueCreateMutex=0x00021719
--define_symbol xQueueCreateMutexStatic=0x0002172f
--define_symbol xQueueCreateSet=0x00021749
--define_symbol xQueueGenericCreate=0x00021751
--define_symbol xQueueGenericCreateStatic=0x0002179d
--define_symbol xQueueGenericReset=0x00021805
--define_symbol xQueueGenericSend=0x00021891
--define_symbol xQueueGenericSendFromISR=0x000219fd
--define_symbol xQueueGiveFromISR=0x00021abd
--define_symbol xQueueGiveMutexRecursive=0x00021b61
--define_symbol xQueueIsQueueEmptyFromISR=0x00021ba1
--define_symbol xQueueIsQueueFullFromISR=0x00021bc5
--define_symbol xQueuePeek=0x00021bed
--define_symbol xQueuePeekFromISR=0x00021d15
--define_symbol xQueueReceive=0x00021d81
--define_symbol xQueueReceiveFromISR=0x00021ead
--define_symbol xQueueRemoveFromSet=0x00021f41
--define_symbol xQueueSelectFromSet=0x00021f63
--define_symbol xQueueSelectFromSetFromISR=0x00021f75
--define_symbol xQueueSemaphoreTake=0x00021f89
--define_symbol xQueueTakeMutexRecursive=0x000220f5
--define_symbol xTaskCheckForTimeOut=0x00022139
--define_symbol xTaskCreate=0x000221a9
--define_symbol xTaskCreateStatic=0x00022205
--define_symbol xTaskGetCurrentTaskHandle=0x00022275
--define_symbol xTaskGetSchedulerState=0x00022281
--define_symbol xTaskGetTickCount=0x0002229d
--define_symbol xTaskGetTickCountFromISR=0x000222a9
--define_symbol xTaskIncrementTick=0x000222b9
--define_symbol xTaskPriorityDisinherit=0x00022385
--define_symbol xTaskPriorityInherit=0x00022419
--define_symbol xTaskRemoveFromEventList=0x000224ad
--define_symbol xTaskResumeAll=0x0002252d
--define_symbol xTimerCreate=0x000225f5
--define_symbol xTimerCreateStatic=0x00022629
--define_symbol xTimerCreateTimerTask=0x00022661
--define_symbol xTimerGenericCommand=0x000226cd
--define_symbol xTimerGetExpiryTime=0x0002273d
