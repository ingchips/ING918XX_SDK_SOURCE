...
--define_symbol nibble_for_char=0x0001d1c5
--define_symbol platform_32k_rc_auto_tune=0x0001d27d
--define_symbol platform_32k_rc_tune=0x0001d2f9
--define_symbol platform_calibrate_32k=0x0001d30d
--define_symbol platform_config=0x0001d311
--define_symbol platform_get_heap_status=0x0001d3c1
--define_symbol platform_get_us_time=0x0001d3d9
--define_symbol platform_get_version=0x0001d3dd
--define_symbol platform_hrng=0x0001d3e5
--define_symbol platform_install_isr_stack=0x0001d3ed
--define_symbol platform_patch_rf_init_data=0x0001d3f9
--define_symbol platform_printf=0x0001d405
--define_symbol platform_raise_assertion=0x0001d419
--define_symbol platform_rand=0x0001d42d
--define_symbol platform_read_info=0x0001d431
--define_symbol platform_read_persistent_reg=0x0001d44d
--define_symbol platform_reset=0x0001d45d
--define_symbol platform_set_evt_callback=0x0001d491
--define_symbol platform_set_irq_callback=0x0001d4a5
--define_symbol platform_set_rf_clk_source=0x0001d4dd
--define_symbol platform_set_rf_init_data=0x0001d4e9
--define_symbol platform_set_rf_power_mapping=0x0001d4f5
--define_symbol platform_shutdown=0x0001d501
--define_symbol platform_switch_app=0x0001d505
--define_symbol platform_trace_raw=0x0001d531
--define_symbol platform_write_persistent_reg=0x0001d545
--define_symbol printf_hexdump=0x0001d555
--define_symbol pvPortMalloc=0x0001e085
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e16d
--define_symbol pvTimerGetTimerID=0x0001e185
--define_symbol pxPortInitialiseStack=0x0001e1b1
--define_symbol reverse_128=0x0001e359
--define_symbol reverse_24=0x0001e35f
--define_symbol reverse_48=0x0001e365
--define_symbol reverse_56=0x0001e36b
--define_symbol reverse_64=0x0001e371
--define_symbol reverse_bd_addr=0x0001e377
--define_symbol reverse_bytes=0x0001e37d
--define_symbol sm_add_event_handler=0x0001e4c9
--define_symbol sm_address_resolution_lookup=0x0001e5f5
--define_symbol sm_authenticated=0x0001e6cf
--define_symbol sm_authorization_decline=0x0001e6dd
--define_symbol sm_authorization_grant=0x0001e6fd
--define_symbol sm_authorization_state=0x0001e71d
--define_symbol sm_bonding_decline=0x0001e739
--define_symbol sm_config=0x0001eb11
--define_symbol sm_encryption_key_size=0x0001ec1d
--define_symbol sm_just_works_confirm=0x0001f3ed
--define_symbol sm_le_device_key=0x0001f63d
--define_symbol sm_passkey_input=0x0001f6d5
--define_symbol sm_private_random_address_generation_get=0x0001fa61
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa69
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa75
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fa9d
--define_symbol sm_register_oob_data_callback=0x0001fad5
--define_symbol sm_request_pairing=0x0001fae1
--define_symbol sm_send_security_request=0x0002051b
--define_symbol sm_set_accepted_stk_generation_methods=0x00020541
--define_symbol sm_set_authentication_requirements=0x0002054d
--define_symbol sm_set_encryption_key_size_range=0x00020559
--define_symbol sscanf_bd_addr=0x00020855
--define_symbol sysSetPublicDeviceAddr=0x00020b71
--define_symbol uuid128_to_str=0x00021115
--define_symbol uuid_add_bluetooth_prefix=0x0002116d
--define_symbol uuid_has_bluetooth_prefix=0x0002118d
--define_symbol uxQueueMessagesWaiting=0x000211d1
--define_symbol uxQueueMessagesWaitingFromISR=0x000211f9
--define_symbol uxQueueSpacesAvailable=0x00021215
--define_symbol uxTaskGetStackHighWaterMark=0x00021241
--define_symbol vPortEnterCritical=0x000212f9
--define_symbol vPortExitCritical=0x00021339
--define_symbol vPortFree=0x00021365
--define_symbol vPortSuppressTicksAndSleep=0x000213f9
--define_symbol vPortValidateInterruptPriority=0x000214d1
--define_symbol vQueueDelete=0x00021525
--define_symbol vQueueWaitForMessageRestricted=0x00021551
--define_symbol vTaskDelay=0x00021599
--define_symbol vTaskInternalSetTimeOutState=0x000215e5
--define_symbol vTaskMissedYield=0x000215f5
--define_symbol vTaskPlaceOnEventList=0x00021601
--define_symbol vTaskPlaceOnEventListRestricted=0x00021639
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021679
--define_symbol vTaskStartScheduler=0x00021725
--define_symbol vTaskStepTick=0x000217b5
--define_symbol vTaskSuspendAll=0x000217e5
--define_symbol vTaskSwitchContext=0x000217f5
--define_symbol xPortStartScheduler=0x0002189d
--define_symbol xQueueAddToSet=0x00021959
--define_symbol xQueueCreateCountingSemaphore=0x0002197d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000219b9
--define_symbol xQueueCreateMutex=0x000219fd
--define_symbol xQueueCreateMutexStatic=0x00021a13
--define_symbol xQueueCreateSet=0x00021a2d
--define_symbol xQueueGenericCreate=0x00021a35
--define_symbol xQueueGenericCreateStatic=0x00021a81
--define_symbol xQueueGenericReset=0x00021ae9
--define_symbol xQueueGenericSend=0x00021b75
--define_symbol xQueueGenericSendFromISR=0x00021ce1
--define_symbol xQueueGiveFromISR=0x00021da1
--define_symbol xQueueGiveMutexRecursive=0x00021e45
--define_symbol xQueueIsQueueEmptyFromISR=0x00021e85
--define_symbol xQueueIsQueueFullFromISR=0x00021ea9
--define_symbol xQueuePeek=0x00021ed1
--define_symbol xQueuePeekFromISR=0x00021ff9
--define_symbol xQueueReceive=0x00022065
--define_symbol xQueueReceiveFromISR=0x00022191
--define_symbol xQueueRemoveFromSet=0x00022225
--define_symbol xQueueSelectFromSet=0x00022247
--define_symbol xQueueSelectFromSetFromISR=0x00022259
--define_symbol xQueueSemaphoreTake=0x0002226d
--define_symbol xQueueTakeMutexRecursive=0x000223d9
--define_symbol xTaskCheckForTimeOut=0x0002241d
--define_symbol xTaskCreate=0x0002248d
--define_symbol xTaskCreateStatic=0x000224e9
--define_symbol xTaskGetCurrentTaskHandle=0x00022559
--define_symbol xTaskGetSchedulerState=0x00022565
--define_symbol xTaskGetTickCount=0x00022581
--define_symbol xTaskGetTickCountFromISR=0x0002258d
--define_symbol xTaskIncrementTick=0x0002259d
--define_symbol xTaskPriorityDisinherit=0x00022669
--define_symbol xTaskPriorityInherit=0x000226fd
--define_symbol xTaskRemoveFromEventList=0x00022791
--define_symbol xTaskResumeAll=0x00022811
--define_symbol xTimerCreate=0x000228d9
--define_symbol xTimerCreateStatic=0x0002290d
--define_symbol xTimerCreateTimerTask=0x00022945
--define_symbol xTimerGenericCommand=0x000229b1
--define_symbol xTimerGetExpiryTime=0x00022a21
