...
--define_symbol nibble_for_char=0x0001d3d1
--define_symbol platform_32k_rc_auto_tune=0x0001d46d
--define_symbol platform_32k_rc_tune=0x0001d4e9
--define_symbol platform_calibrate_32k=0x0001d4fd
--define_symbol platform_config=0x0001d501
--define_symbol platform_get_heap_status=0x0001d5b9
--define_symbol platform_get_us_time=0x0001d5d1
--define_symbol platform_get_version=0x0001d5d5
--define_symbol platform_hrng=0x0001d5dd
--define_symbol platform_install_isr_stack=0x0001d5e5
--define_symbol platform_patch_rf_init_data=0x0001d5f1
--define_symbol platform_printf=0x0001d5fd
--define_symbol platform_raise_assertion=0x0001d611
--define_symbol platform_rand=0x0001d625
--define_symbol platform_read_info=0x0001d629
--define_symbol platform_read_persistent_reg=0x0001d645
--define_symbol platform_reset=0x0001d655
--define_symbol platform_set_evt_callback=0x0001d689
--define_symbol platform_set_irq_callback=0x0001d69d
--define_symbol platform_set_rf_clk_source=0x0001d6d5
--define_symbol platform_set_rf_init_data=0x0001d6e1
--define_symbol platform_set_rf_power_mapping=0x0001d6ed
--define_symbol platform_shutdown=0x0001d6f9
--define_symbol platform_switch_app=0x0001d6fd
--define_symbol platform_trace_raw=0x0001d729
--define_symbol platform_write_persistent_reg=0x0001d73d
--define_symbol printf_hexdump=0x0001d74d
--define_symbol pvPortMalloc=0x0001e219
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e301
--define_symbol pvTimerGetTimerID=0x0001e319
--define_symbol pxPortInitialiseStack=0x0001e345
--define_symbol reverse_128=0x0001e4ed
--define_symbol reverse_24=0x0001e4f3
--define_symbol reverse_48=0x0001e4f9
--define_symbol reverse_56=0x0001e4ff
--define_symbol reverse_64=0x0001e505
--define_symbol reverse_bd_addr=0x0001e50b
--define_symbol reverse_bytes=0x0001e511
--define_symbol sm_add_event_handler=0x0001e67d
--define_symbol sm_address_resolution_lookup=0x0001e7a9
--define_symbol sm_authenticated=0x0001e883
--define_symbol sm_authorization_decline=0x0001e891
--define_symbol sm_authorization_grant=0x0001e8b1
--define_symbol sm_authorization_state=0x0001e8d1
--define_symbol sm_bonding_decline=0x0001e8ed
--define_symbol sm_config=0x0001ecc5
--define_symbol sm_encryption_key_size=0x0001edd1
--define_symbol sm_just_works_confirm=0x0001f585
--define_symbol sm_le_device_key=0x0001f7dd
--define_symbol sm_passkey_input=0x0001f875
--define_symbol sm_private_random_address_generation_get=0x0001fc01
--define_symbol sm_private_random_address_generation_get_mode=0x0001fc09
--define_symbol sm_private_random_address_generation_set_mode=0x0001fc15
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fc3d
--define_symbol sm_register_oob_data_callback=0x0001fc75
--define_symbol sm_request_pairing=0x0001fc81
--define_symbol sm_send_security_request=0x000206d1
--define_symbol sm_set_accepted_stk_generation_methods=0x000206f9
--define_symbol sm_set_authentication_requirements=0x00020705
--define_symbol sm_set_encryption_key_size_range=0x00020711
--define_symbol sscanf_bd_addr=0x00020a01
--define_symbol sysSetPublicDeviceAddr=0x00020d45
--define_symbol uuid128_to_str=0x000212ed
--define_symbol uuid_add_bluetooth_prefix=0x00021345
--define_symbol uuid_has_bluetooth_prefix=0x00021365
--define_symbol uxQueueMessagesWaiting=0x000213a9
--define_symbol uxQueueMessagesWaitingFromISR=0x000213d1
--define_symbol uxQueueSpacesAvailable=0x000213ed
--define_symbol uxTaskGetStackHighWaterMark=0x00021419
--define_symbol vPortEnterCritical=0x0002153d
--define_symbol vPortExitCritical=0x0002157d
--define_symbol vPortFree=0x000215a9
--define_symbol vPortSuppressTicksAndSleep=0x0002163d
--define_symbol vPortValidateInterruptPriority=0x00021715
--define_symbol vQueueDelete=0x00021769
--define_symbol vQueueWaitForMessageRestricted=0x00021795
--define_symbol vTaskDelay=0x000217dd
--define_symbol vTaskInternalSetTimeOutState=0x00021829
--define_symbol vTaskMissedYield=0x00021839
--define_symbol vTaskPlaceOnEventList=0x00021845
--define_symbol vTaskPlaceOnEventListRestricted=0x0002187d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000218bd
--define_symbol vTaskStartScheduler=0x00021969
--define_symbol vTaskStepTick=0x000219f9
--define_symbol vTaskSuspendAll=0x00021a29
--define_symbol vTaskSwitchContext=0x00021a39
--define_symbol xPortStartScheduler=0x00021ae1
--define_symbol xQueueAddToSet=0x00021b9d
--define_symbol xQueueCreateCountingSemaphore=0x00021bc1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021bfd
--define_symbol xQueueCreateMutex=0x00021c41
--define_symbol xQueueCreateMutexStatic=0x00021c57
--define_symbol xQueueCreateSet=0x00021c71
--define_symbol xQueueGenericCreate=0x00021c79
--define_symbol xQueueGenericCreateStatic=0x00021cc5
--define_symbol xQueueGenericReset=0x00021d2d
--define_symbol xQueueGenericSend=0x00021db9
--define_symbol xQueueGenericSendFromISR=0x00021f25
--define_symbol xQueueGiveFromISR=0x00021fe5
--define_symbol xQueueGiveMutexRecursive=0x00022089
--define_symbol xQueueIsQueueEmptyFromISR=0x000220c9
--define_symbol xQueueIsQueueFullFromISR=0x000220ed
--define_symbol xQueuePeek=0x00022115
--define_symbol xQueuePeekFromISR=0x0002223d
--define_symbol xQueueReceive=0x000222a9
--define_symbol xQueueReceiveFromISR=0x000223d5
--define_symbol xQueueRemoveFromSet=0x00022469
--define_symbol xQueueSelectFromSet=0x0002248b
--define_symbol xQueueSelectFromSetFromISR=0x0002249d
--define_symbol xQueueSemaphoreTake=0x000224b1
--define_symbol xQueueTakeMutexRecursive=0x0002261d
--define_symbol xTaskCheckForTimeOut=0x00022661
--define_symbol xTaskCreate=0x000226d1
--define_symbol xTaskCreateStatic=0x0002272d
--define_symbol xTaskGetCurrentTaskHandle=0x0002279d
--define_symbol xTaskGetSchedulerState=0x000227a9
--define_symbol xTaskGetTickCount=0x000227c5
--define_symbol xTaskGetTickCountFromISR=0x000227d1
--define_symbol xTaskIncrementTick=0x000227e1
--define_symbol xTaskPriorityDisinherit=0x000228ad
--define_symbol xTaskPriorityInherit=0x00022941
--define_symbol xTaskRemoveFromEventList=0x000229d5
--define_symbol xTaskResumeAll=0x00022a55
--define_symbol xTimerCreate=0x00022b1d
--define_symbol xTimerCreateStatic=0x00022b51
--define_symbol xTimerCreateTimerTask=0x00022b89
--define_symbol xTimerGenericCommand=0x00022bf5
--define_symbol xTimerGetExpiryTime=0x00022c65
