...
nibble_for_char = 0x0001d3c5;
platform_32k_rc_auto_tune = 0x0001d461;
platform_32k_rc_tune = 0x0001d4dd;
platform_calibrate_32k = 0x0001d4f1;
platform_config = 0x0001d4f5;
platform_get_heap_status = 0x0001d5ad;
platform_get_us_time = 0x0001d5c5;
platform_get_version = 0x0001d5c9;
platform_hrng = 0x0001d5d1;
platform_install_isr_stack = 0x0001d5d9;
platform_patch_rf_init_data = 0x0001d5e5;
platform_printf = 0x0001d5f1;
platform_raise_assertion = 0x0001d605;
platform_rand = 0x0001d619;
platform_read_info = 0x0001d61d;
platform_read_persistent_reg = 0x0001d639;
platform_reset = 0x0001d649;
platform_set_evt_callback = 0x0001d67d;
platform_set_irq_callback = 0x0001d691;
platform_set_rf_clk_source = 0x0001d6c9;
platform_set_rf_init_data = 0x0001d6d5;
platform_set_rf_power_mapping = 0x0001d6e1;
platform_shutdown = 0x0001d6ed;
platform_switch_app = 0x0001d6f1;
platform_trace_raw = 0x0001d71d;
platform_write_persistent_reg = 0x0001d731;
printf_hexdump = 0x0001d741;
pvPortMalloc = 0x0001e20d;
pvTaskIncrementMutexHeldCount = 0x0001e2f5;
pvTimerGetTimerID = 0x0001e30d;
pxPortInitialiseStack = 0x0001e339;
reverse_128 = 0x0001e4e1;
reverse_24 = 0x0001e4e7;
reverse_48 = 0x0001e4ed;
reverse_56 = 0x0001e4f3;
reverse_64 = 0x0001e4f9;
reverse_bd_addr = 0x0001e4ff;
reverse_bytes = 0x0001e505;
sm_add_event_handler = 0x0001e671;
sm_address_resolution_lookup = 0x0001e79d;
sm_authenticated = 0x0001e877;
sm_authorization_decline = 0x0001e885;
sm_authorization_grant = 0x0001e8a5;
sm_authorization_state = 0x0001e8c5;
sm_bonding_decline = 0x0001e8e1;
sm_config = 0x0001ecb9;
sm_encryption_key_size = 0x0001edc5;
sm_just_works_confirm = 0x0001f579;
sm_le_device_key = 0x0001f7d1;
sm_passkey_input = 0x0001f869;
sm_private_random_address_generation_get = 0x0001fbf5;
sm_private_random_address_generation_get_mode = 0x0001fbfd;
sm_private_random_address_generation_set_mode = 0x0001fc09;
sm_private_random_address_generation_set_update_period = 0x0001fc31;
sm_register_oob_data_callback = 0x0001fc69;
sm_request_pairing = 0x0001fc75;
sm_send_security_request = 0x000206c5;
sm_set_accepted_stk_generation_methods = 0x000206ed;
sm_set_authentication_requirements = 0x000206f9;
sm_set_encryption_key_size_range = 0x00020705;
sscanf_bd_addr = 0x000209f5;
sysSetPublicDeviceAddr = 0x00020d39;
uuid128_to_str = 0x000212e1;
uuid_add_bluetooth_prefix = 0x00021339;
uuid_has_bluetooth_prefix = 0x00021359;
uxQueueMessagesWaiting = 0x0002139d;
uxQueueMessagesWaitingFromISR = 0x000213c5;
uxQueueSpacesAvailable = 0x000213e1;
uxTaskGetStackHighWaterMark = 0x0002140d;
vPortEnterCritical = 0x00021531;
vPortExitCritical = 0x00021571;
vPortFree = 0x0002159d;
vPortSuppressTicksAndSleep = 0x00021631;
vPortValidateInterruptPriority = 0x00021709;
vQueueDelete = 0x0002175d;
vQueueWaitForMessageRestricted = 0x00021789;
vTaskDelay = 0x000217d1;
vTaskInternalSetTimeOutState = 0x0002181d;
vTaskMissedYield = 0x0002182d;
vTaskPlaceOnEventList = 0x00021839;
vTaskPlaceOnEventListRestricted = 0x00021871;
vTaskPriorityDisinheritAfterTimeout = 0x000218b1;
vTaskStartScheduler = 0x0002195d;
vTaskStepTick = 0x000219ed;
vTaskSuspendAll = 0x00021a1d;
vTaskSwitchContext = 0x00021a2d;
xPortStartScheduler = 0x00021ad5;
xQueueAddToSet = 0x00021b91;
xQueueCreateCountingSemaphore = 0x00021bb5;
xQueueCreateCountingSemaphoreStatic = 0x00021bf1;
xQueueCreateMutex = 0x00021c35;
xQueueCreateMutexStatic = 0x00021c4b;
xQueueCreateSet = 0x00021c65;
xQueueGenericCreate = 0x00021c6d;
xQueueGenericCreateStatic = 0x00021cb9;
xQueueGenericReset = 0x00021d21;
xQueueGenericSend = 0x00021dad;
xQueueGenericSendFromISR = 0x00021f19;
xQueueGiveFromISR = 0x00021fd9;
xQueueGiveMutexRecursive = 0x0002207d;
xQueueIsQueueEmptyFromISR = 0x000220bd;
xQueueIsQueueFullFromISR = 0x000220e1;
xQueuePeek = 0x00022109;
xQueuePeekFromISR = 0x00022231;
xQueueReceive = 0x0002229d;
xQueueReceiveFromISR = 0x000223c9;
xQueueRemoveFromSet = 0x0002245d;
xQueueSelectFromSet = 0x0002247f;
xQueueSelectFromSetFromISR = 0x00022491;
xQueueSemaphoreTake = 0x000224a5;
xQueueTakeMutexRecursive = 0x00022611;
xTaskCheckForTimeOut = 0x00022655;
xTaskCreate = 0x000226c5;
xTaskCreateStatic = 0x00022721;
xTaskGetCurrentTaskHandle = 0x00022791;
xTaskGetSchedulerState = 0x0002279d;
xTaskGetTickCount = 0x000227b9;
xTaskGetTickCountFromISR = 0x000227c5;
xTaskIncrementTick = 0x000227d5;
xTaskPriorityDisinherit = 0x000228a1;
xTaskPriorityInherit = 0x00022935;
xTaskRemoveFromEventList = 0x000229c9;
xTaskResumeAll = 0x00022a49;
xTimerCreate = 0x00022b11;
xTimerCreateStatic = 0x00022b45;
xTimerCreateTimerTask = 0x00022b7d;
xTimerGenericCommand = 0x00022be9;
xTimerGetExpiryTime = 0x00022c59;
