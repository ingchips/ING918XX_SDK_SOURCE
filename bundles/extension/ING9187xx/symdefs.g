...
platform_32k_rc_auto_tune = 0x0001d6f1;
platform_32k_rc_tune = 0x0001d76d;
platform_calibrate_32k = 0x0001d781;
platform_config = 0x0001d785;
platform_get_heap_status = 0x0001d845;
platform_get_us_time = 0x0001d85d;
platform_get_version = 0x0001d861;
platform_hrng = 0x0001d869;
platform_install_isr_stack = 0x0001d871;
platform_patch_rf_init_data = 0x0001d87d;
platform_printf = 0x0001d889;
platform_raise_assertion = 0x0001d89d;
platform_rand = 0x0001d8b1;
platform_read_info = 0x0001d8b5;
platform_read_persistent_reg = 0x0001d8d1;
platform_reset = 0x0001d8e1;
platform_set_evt_callback = 0x0001d915;
platform_set_irq_callback = 0x0001d929;
platform_set_rf_clk_source = 0x0001d961;
platform_set_rf_init_data = 0x0001d96d;
platform_set_rf_power_mapping = 0x0001d979;
platform_shutdown = 0x0001d985;
platform_switch_app = 0x0001d989;
platform_trace_raw = 0x0001d9b5;
platform_write_persistent_reg = 0x0001d9cd;
printf_hexdump = 0x0001d9dd;
pvPortMalloc = 0x0001e4e5;
pvTaskIncrementMutexHeldCount = 0x0001e5cd;
pvTimerGetTimerID = 0x0001e5e5;
pxPortInitialiseStack = 0x0001e611;
reverse_128 = 0x0001e7b9;
reverse_24 = 0x0001e7bf;
reverse_48 = 0x0001e7c5;
reverse_56 = 0x0001e7cb;
reverse_64 = 0x0001e7d1;
reverse_bd_addr = 0x0001e7d7;
reverse_bytes = 0x0001e7dd;
sm_add_event_handler = 0x0001e949;
sm_address_resolution_lookup = 0x0001eaa1;
sm_authenticated = 0x0001eded;
sm_authorization_decline = 0x0001edfb;
sm_authorization_grant = 0x0001ee1b;
sm_authorization_state = 0x0001ee3b;
sm_bonding_decline = 0x0001ee55;
sm_config = 0x0001f275;
sm_config_conn = 0x0001f28d;
sm_encryption_key_size = 0x0001f413;
sm_just_works_confirm = 0x0001f941;
sm_le_device_key = 0x0001fc7d;
sm_passkey_input = 0x0001fd13;
sm_private_random_address_generation_get = 0x000200b9;
sm_private_random_address_generation_get_mode = 0x000200c1;
sm_private_random_address_generation_set_mode = 0x000200cd;
sm_private_random_address_generation_set_update_period = 0x000200f5;
sm_register_oob_data_callback = 0x00020231;
sm_request_pairing = 0x0002023d;
sm_send_security_request = 0x00020c37;
sm_set_accepted_stk_generation_methods = 0x00020c5d;
sm_set_authentication_requirements = 0x00020c69;
sm_set_encryption_key_size_range = 0x00020c75;
sscanf_bd_addr = 0x00020fd1;
sysSetPublicDeviceAddr = 0x00021339;
uuid128_to_str = 0x0002192d;
uuid_add_bluetooth_prefix = 0x00021985;
uuid_has_bluetooth_prefix = 0x000219a5;
uxListRemove = 0x000219c1;
uxQueueMessagesWaiting = 0x000219e9;
uxQueueMessagesWaitingFromISR = 0x00021a11;
uxQueueSpacesAvailable = 0x00021a2d;
uxTaskGetStackHighWaterMark = 0x00021a59;
vListInitialise = 0x00021aff;
vListInitialiseItem = 0x00021b15;
vListInsert = 0x00021b1b;
vListInsertEnd = 0x00021b4b;
vPortEnterCritical = 0x00021b65;
vPortExitCritical = 0x00021ba9;
vPortFree = 0x00021bd9;
vPortSuppressTicksAndSleep = 0x00021c6d;
vPortValidateInterruptPriority = 0x00021d8d;
vQueueDelete = 0x00021de5;
vQueueWaitForMessageRestricted = 0x00021e11;
vTaskDelay = 0x00021e59;
vTaskInternalSetTimeOutState = 0x00021ea5;
vTaskMissedYield = 0x00021eb5;
vTaskPlaceOnEventList = 0x00021ec1;
vTaskPlaceOnEventListRestricted = 0x00021ef9;
vTaskPriorityDisinheritAfterTimeout = 0x00021f39;
vTaskResume = 0x00021fe5;
vTaskStartScheduler = 0x00022069;
vTaskStepTick = 0x000220f9;
vTaskSuspend = 0x00022129;
vTaskSuspendAll = 0x000221e5;
vTaskSwitchContext = 0x000221f5;
xPortStartScheduler = 0x0002229d;
xQueueAddToSet = 0x00022361;
xQueueCreateCountingSemaphore = 0x00022385;
xQueueCreateCountingSemaphoreStatic = 0x000223c1;
xQueueCreateMutex = 0x00022405;
xQueueCreateMutexStatic = 0x0002241b;
xQueueCreateSet = 0x00022435;
xQueueGenericCreate = 0x0002243d;
xQueueGenericCreateStatic = 0x00022489;
xQueueGenericReset = 0x000224f1;
xQueueGenericSend = 0x0002257d;
xQueueGenericSendFromISR = 0x000226e9;
xQueueGiveFromISR = 0x000227a9;
xQueueGiveMutexRecursive = 0x0002284d;
xQueueIsQueueEmptyFromISR = 0x0002288d;
xQueueIsQueueFullFromISR = 0x000228b1;
xQueuePeek = 0x000228d9;
xQueuePeekFromISR = 0x00022a01;
xQueueReceive = 0x00022a6d;
xQueueReceiveFromISR = 0x00022b99;
xQueueRemoveFromSet = 0x00022c2d;
xQueueSelectFromSet = 0x00022c4f;
xQueueSelectFromSetFromISR = 0x00022c61;
xQueueSemaphoreTake = 0x00022c75;
xQueueTakeMutexRecursive = 0x00022de1;
xTaskCheckForTimeOut = 0x00022e25;
xTaskCreate = 0x00022e95;
xTaskCreateStatic = 0x00022ef1;
xTaskGetCurrentTaskHandle = 0x00022f61;
xTaskGetSchedulerState = 0x00022f6d;
xTaskGetTickCount = 0x00022f89;
xTaskGetTickCountFromISR = 0x00022f95;
xTaskIncrementTick = 0x00022fa5;
xTaskPriorityDisinherit = 0x00023071;
xTaskPriorityInherit = 0x00023105;
xTaskRemoveFromEventList = 0x00023199;
xTaskResumeAll = 0x00023219;
xTaskResumeFromISR = 0x000232e1;
xTimerCreate = 0x0002336d;
xTimerCreateStatic = 0x000233a1;
xTimerCreateTimerTask = 0x000233d9;
xTimerGenericCommand = 0x00023445;
xTimerGetExpiryTime = 0x000234b5;
