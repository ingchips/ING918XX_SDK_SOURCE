...
platform_get_heap_status = 0x0001d839;
platform_get_us_time = 0x0001d851;
platform_get_version = 0x0001d855;
platform_hrng = 0x0001d85d;
platform_install_isr_stack = 0x0001d865;
platform_patch_rf_init_data = 0x0001d871;
platform_printf = 0x0001d87d;
platform_raise_assertion = 0x0001d891;
platform_rand = 0x0001d8a5;
platform_read_info = 0x0001d8a9;
platform_read_persistent_reg = 0x0001d8c5;
platform_reset = 0x0001d8d5;
platform_set_evt_callback = 0x0001d909;
platform_set_irq_callback = 0x0001d91d;
platform_set_rf_clk_source = 0x0001d955;
platform_set_rf_init_data = 0x0001d961;
platform_set_rf_power_mapping = 0x0001d96d;
platform_shutdown = 0x0001d979;
platform_switch_app = 0x0001d97d;
platform_trace_raw = 0x0001d9a9;
platform_write_persistent_reg = 0x0001d9c1;
printf_hexdump = 0x0001d9d1;
pvPortMalloc = 0x0001e4d9;
pvTaskIncrementMutexHeldCount = 0x0001e5c1;
pvTimerGetTimerID = 0x0001e5d9;
pxPortInitialiseStack = 0x0001e605;
reverse_128 = 0x0001e7ad;
reverse_24 = 0x0001e7b3;
reverse_48 = 0x0001e7b9;
reverse_56 = 0x0001e7bf;
reverse_64 = 0x0001e7c5;
reverse_bd_addr = 0x0001e7cb;
reverse_bytes = 0x0001e7d1;
sm_add_event_handler = 0x0001e93d;
sm_address_resolution_lookup = 0x0001ea95;
sm_authenticated = 0x0001ede1;
sm_authorization_decline = 0x0001edef;
sm_authorization_grant = 0x0001ee0f;
sm_authorization_state = 0x0001ee2f;
sm_bonding_decline = 0x0001ee49;
sm_config = 0x0001f269;
sm_config_conn = 0x0001f281;
sm_encryption_key_size = 0x0001f407;
sm_just_works_confirm = 0x0001f935;
sm_le_device_key = 0x0001fc71;
sm_passkey_input = 0x0001fd07;
sm_private_random_address_generation_get = 0x000200ad;
sm_private_random_address_generation_get_mode = 0x000200b5;
sm_private_random_address_generation_set_mode = 0x000200c1;
sm_private_random_address_generation_set_update_period = 0x000200e9;
sm_register_oob_data_callback = 0x00020225;
sm_request_pairing = 0x00020231;
sm_send_security_request = 0x00020c2b;
sm_set_accepted_stk_generation_methods = 0x00020c51;
sm_set_authentication_requirements = 0x00020c5d;
sm_set_encryption_key_size_range = 0x00020c69;
sscanf_bd_addr = 0x00020fc5;
sysSetPublicDeviceAddr = 0x0002132d;
uuid128_to_str = 0x00021921;
uuid_add_bluetooth_prefix = 0x00021979;
uuid_has_bluetooth_prefix = 0x00021999;
uxListRemove = 0x000219b5;
uxQueueMessagesWaiting = 0x000219dd;
uxQueueMessagesWaitingFromISR = 0x00021a05;
uxQueueSpacesAvailable = 0x00021a21;
uxTaskGetStackHighWaterMark = 0x00021a4d;
vListInitialise = 0x00021af3;
vListInitialiseItem = 0x00021b09;
vListInsert = 0x00021b0f;
vListInsertEnd = 0x00021b3f;
vPortEnterCritical = 0x00021b59;
vPortExitCritical = 0x00021b9d;
vPortFree = 0x00021bcd;
vPortSuppressTicksAndSleep = 0x00021c61;
vPortValidateInterruptPriority = 0x00021d81;
vQueueDelete = 0x00021dd9;
vQueueWaitForMessageRestricted = 0x00021e05;
vTaskDelay = 0x00021e4d;
vTaskInternalSetTimeOutState = 0x00021e99;
vTaskMissedYield = 0x00021ea9;
vTaskPlaceOnEventList = 0x00021eb5;
vTaskPlaceOnEventListRestricted = 0x00021eed;
vTaskPriorityDisinheritAfterTimeout = 0x00021f2d;
vTaskResume = 0x00021fd9;
vTaskStartScheduler = 0x0002205d;
vTaskStepTick = 0x000220ed;
vTaskSuspend = 0x0002211d;
vTaskSuspendAll = 0x000221d9;
vTaskSwitchContext = 0x000221e9;
xPortStartScheduler = 0x00022291;
xQueueAddToSet = 0x00022355;
xQueueCreateCountingSemaphore = 0x00022379;
xQueueCreateCountingSemaphoreStatic = 0x000223b5;
xQueueCreateMutex = 0x000223f9;
xQueueCreateMutexStatic = 0x0002240f;
xQueueCreateSet = 0x00022429;
xQueueGenericCreate = 0x00022431;
xQueueGenericCreateStatic = 0x0002247d;
xQueueGenericReset = 0x000224e5;
xQueueGenericSend = 0x00022571;
xQueueGenericSendFromISR = 0x000226dd;
xQueueGiveFromISR = 0x0002279d;
xQueueGiveMutexRecursive = 0x00022841;
xQueueIsQueueEmptyFromISR = 0x00022881;
xQueueIsQueueFullFromISR = 0x000228a5;
xQueuePeek = 0x000228cd;
xQueuePeekFromISR = 0x000229f5;
xQueueReceive = 0x00022a61;
xQueueReceiveFromISR = 0x00022b8d;
xQueueRemoveFromSet = 0x00022c21;
xQueueSelectFromSet = 0x00022c43;
xQueueSelectFromSetFromISR = 0x00022c55;
xQueueSemaphoreTake = 0x00022c69;
xQueueTakeMutexRecursive = 0x00022dd5;
xTaskCheckForTimeOut = 0x00022e19;
xTaskCreate = 0x00022e89;
xTaskCreateStatic = 0x00022ee5;
xTaskGetCurrentTaskHandle = 0x00022f55;
xTaskGetSchedulerState = 0x00022f61;
xTaskGetTickCount = 0x00022f7d;
xTaskGetTickCountFromISR = 0x00022f89;
xTaskIncrementTick = 0x00022f99;
xTaskPriorityDisinherit = 0x00023065;
xTaskPriorityInherit = 0x000230f9;
xTaskRemoveFromEventList = 0x0002318d;
xTaskResumeAll = 0x0002320d;
xTaskResumeFromISR = 0x000232d5;
xTimerCreate = 0x00023361;
xTimerCreateStatic = 0x00023395;
xTimerCreateTimerTask = 0x000233cd;
xTimerGenericCommand = 0x00023439;
xTimerGetExpiryTime = 0x000234a9;
