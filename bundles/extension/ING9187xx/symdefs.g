...
ll_config = 0x0000d069;
ll_free = 0x0000d075;
ll_hint_on_ce_len = 0x0000d081;
ll_legacy_adv_set_interval = 0x0000d0c1;
ll_malloc = 0x0000d0d1;
ll_query_timing_info = 0x0000d209;
ll_raw_packet_alloc = 0x0000d255;
ll_raw_packet_free = 0x0000d309;
ll_raw_packet_get_rx_data = 0x0000d333;
ll_raw_packet_recv = 0x0000d3c9;
ll_raw_packet_send = 0x0000d45d;
ll_raw_packet_set_param = 0x0000d4cd;
ll_raw_packet_set_tx_data = 0x0000d533;
ll_scan_set_fixed_channel = 0x0000d5f5;
ll_set_adv_access_address = 0x0000d709;
ll_set_adv_coded_scheme = 0x0000d715;
ll_set_conn_coded_scheme = 0x0000d745;
...
platform_32k_rc_auto_tune = 0x0001d67d;
platform_32k_rc_tune = 0x0001d6f9;
platform_calibrate_32k = 0x0001d70d;
platform_config = 0x0001d711;
platform_get_heap_status = 0x0001d7d1;
platform_get_us_time = 0x0001d7e9;
platform_get_version = 0x0001d7ed;
platform_hrng = 0x0001d7f5;
platform_install_isr_stack = 0x0001d7fd;
platform_patch_rf_init_data = 0x0001d809;
platform_printf = 0x0001d815;
platform_raise_assertion = 0x0001d829;
platform_rand = 0x0001d83d;
platform_read_info = 0x0001d841;
platform_read_persistent_reg = 0x0001d85d;
platform_reset = 0x0001d86d;
platform_set_evt_callback = 0x0001d8a1;
platform_set_irq_callback = 0x0001d8b5;
platform_set_rf_clk_source = 0x0001d8ed;
platform_set_rf_init_data = 0x0001d8f9;
platform_set_rf_power_mapping = 0x0001d905;
platform_shutdown = 0x0001d911;
platform_switch_app = 0x0001d915;
platform_trace_raw = 0x0001d941;
platform_write_persistent_reg = 0x0001d959;
printf_hexdump = 0x0001d969;
...
reverse_48 = 0x0001e751;
reverse_56 = 0x0001e757;
reverse_64 = 0x0001e75d;
reverse_bd_addr = 0x0001e763;
reverse_bytes = 0x0001e769;
sm_add_event_handler = 0x0001e8d5;
sm_address_resolution_lookup = 0x0001ea2d;
sm_authenticated = 0x0001ed79;
sm_authorization_decline = 0x0001ed87;
sm_authorization_grant = 0x0001eda7;
sm_authorization_state = 0x0001edc7;
sm_bonding_decline = 0x0001ede1;
sm_config = 0x0001f201;
sm_config_conn = 0x0001f219;
sm_encryption_key_size = 0x0001f39f;
sm_just_works_confirm = 0x0001f8cd;
sm_le_device_key = 0x0001fc09;
sm_passkey_input = 0x0001fc9f;
sm_private_random_address_generation_get = 0x00020045;
sm_private_random_address_generation_get_mode = 0x0002004d;
sm_private_random_address_generation_set_mode = 0x00020059;
sm_private_random_address_generation_set_update_period = 0x00020081;
sm_register_oob_data_callback = 0x000201bd;
sm_request_pairing = 0x000201c9;
sm_send_security_request = 0x00020bc3;
sm_set_accepted_stk_generation_methods = 0x00020be9;
sm_set_authentication_requirements = 0x00020bf5;
sm_set_encryption_key_size_range = 0x00020c01;
sscanf_bd_addr = 0x00020f5d;
sysSetPublicDeviceAddr = 0x000212c5;
uuid128_to_str = 0x000218b9;
uuid_add_bluetooth_prefix = 0x00021911;
uuid_has_bluetooth_prefix = 0x00021931;
uxQueueMessagesWaiting = 0x00021975;
uxQueueMessagesWaitingFromISR = 0x0002199d;
uxQueueSpacesAvailable = 0x000219b9;
uxTaskGetStackHighWaterMark = 0x000219e5;
vPortEnterCritical = 0x00021af1;
vPortExitCritical = 0x00021b35;
vPortFree = 0x00021b65;
vPortSuppressTicksAndSleep = 0x00021bf9;
vPortValidateInterruptPriority = 0x00021d19;
vQueueDelete = 0x00021d71;
vQueueWaitForMessageRestricted = 0x00021d9d;
vTaskDelay = 0x00021de5;
vTaskInternalSetTimeOutState = 0x00021e31;
vTaskMissedYield = 0x00021e41;
vTaskPlaceOnEventList = 0x00021e4d;
vTaskPlaceOnEventListRestricted = 0x00021e85;
vTaskPriorityDisinheritAfterTimeout = 0x00021ec5;
vTaskResume = 0x00021f71;
vTaskStartScheduler = 0x00021ff5;
vTaskStepTick = 0x00022085;
vTaskSuspend = 0x000220b5;
vTaskSuspendAll = 0x00022171;
vTaskSwitchContext = 0x00022181;
xPortStartScheduler = 0x00022229;
xQueueAddToSet = 0x000222ed;
xQueueCreateCountingSemaphore = 0x00022311;
xQueueCreateCountingSemaphoreStatic = 0x0002234d;
xQueueCreateMutex = 0x00022391;
xQueueCreateMutexStatic = 0x000223a7;
xQueueCreateSet = 0x000223c1;
xQueueGenericCreate = 0x000223c9;
xQueueGenericCreateStatic = 0x00022415;
xQueueGenericReset = 0x0002247d;
xQueueGenericSend = 0x00022509;
xQueueGenericSendFromISR = 0x00022675;
xQueueGiveFromISR = 0x00022735;
xQueueGiveMutexRecursive = 0x000227d9;
xQueueIsQueueEmptyFromISR = 0x00022819;
xQueueIsQueueFullFromISR = 0x0002283d;
xQueuePeek = 0x00022865;
xQueuePeekFromISR = 0x0002298d;
xQueueReceive = 0x000229f9;
xQueueReceiveFromISR = 0x00022b25;
xQueueRemoveFromSet = 0x00022bb9;
xQueueSelectFromSet = 0x00022bdb;
xQueueSelectFromSetFromISR = 0x00022bed;
xQueueSemaphoreTake = 0x00022c01;
xQueueTakeMutexRecursive = 0x00022d6d;
xTaskCheckForTimeOut = 0x00022db1;
xTaskCreate = 0x00022e21;
xTaskCreateStatic = 0x00022e7d;
xTaskGetCurrentTaskHandle = 0x00022eed;
xTaskGetSchedulerState = 0x00022ef9;
xTaskGetTickCount = 0x00022f15;
xTaskGetTickCountFromISR = 0x00022f21;
xTaskIncrementTick = 0x00022f31;
xTaskPriorityDisinherit = 0x00022ffd;
xTaskPriorityInherit = 0x00023091;
xTaskRemoveFromEventList = 0x00023125;
xTaskResumeAll = 0x000231a5;
xTaskResumeFromISR = 0x0002326d;
xTimerCreate = 0x000232f9;
xTimerCreateStatic = 0x0002332d;
xTimerCreateTimerTask = 0x00023365;
xTimerGenericCommand = 0x000233d1;
xTimerGetExpiryTime = 0x00023441;
