...
--define_symbol ll_raw_packet_recv=0x0000d875
--define_symbol ll_raw_packet_send=0x0000d931
--define_symbol ll_raw_packet_set_bare_data=0x0000da19
--define_symbol ll_raw_packet_set_bare_mode=0x0000da57
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000db5d
--define_symbol ll_raw_packet_set_param=0x0000db7f
--define_symbol ll_raw_packet_set_rx_cte=0x0000dbdd
--define_symbol ll_raw_packet_set_tx_cte=0x0000dc73
--define_symbol ll_raw_packet_set_tx_data=0x0000dcb1
--define_symbol ll_scan_set_fixed_channel=0x0000dd6d
--define_symbol ll_scanner_enable_iq_sampling=0x0000dd79
--define_symbol ll_set_adv_access_address=0x0000df29
--define_symbol ll_set_adv_coded_scheme=0x0000df35
--define_symbol ll_set_conn_coded_scheme=0x0000df65
--define_symbol ll_set_conn_interval_unit=0x0000df91
--define_symbol ll_set_conn_latency=0x0000df9d
--define_symbol ll_set_conn_tx_power=0x0000dfcd
--define_symbol ll_set_def_antenna=0x0000e015
--define_symbol ll_set_initiating_coded_scheme=0x0000e031
--define_symbol ll_set_max_conn_number=0x0000e03d
--define_symbol nibble_for_char=0x0001ef8d
--define_symbol platform_32k_rc_auto_tune=0x0001f029
--define_symbol platform_32k_rc_tune=0x0001f0a5
--define_symbol platform_calibrate_32k=0x0001f0b9
--define_symbol platform_config=0x0001f0bd
--define_symbol platform_get_heap_status=0x0001f191
--define_symbol platform_get_task_handle=0x0001f1a9
--define_symbol platform_get_us_time=0x0001f1c9
--define_symbol platform_get_version=0x0001f1cd
--define_symbol platform_hrng=0x0001f1d5
--define_symbol platform_install_isr_stack=0x0001f1dd
--define_symbol platform_patch_rf_init_data=0x0001f1e9
--define_symbol platform_printf=0x0001f1f5
--define_symbol platform_raise_assertion=0x0001f209
--define_symbol platform_rand=0x0001f21d
--define_symbol platform_read_info=0x0001f221
--define_symbol platform_read_persistent_reg=0x0001f23d
--define_symbol platform_reset=0x0001f24d
--define_symbol platform_set_evt_callback=0x0001f281
--define_symbol platform_set_irq_callback=0x0001f295
--define_symbol platform_set_rf_clk_source=0x0001f2cd
--define_symbol platform_set_rf_init_data=0x0001f2d9
--define_symbol platform_set_rf_power_mapping=0x0001f2e5
--define_symbol platform_set_timer=0x0001f2f1
--define_symbol platform_shutdown=0x0001f2f5
--define_symbol platform_switch_app=0x0001f2f9
--define_symbol platform_trace_raw=0x0001f325
--define_symbol platform_write_persistent_reg=0x0001f33d
--define_symbol printf_hexdump=0x0001f34d
--define_symbol pvPortMalloc=0x0001fe55
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ff3d
--define_symbol pvTimerGetTimerID=0x0001ff55
--define_symbol pxPortInitialiseStack=0x0001ff81
--define_symbol reverse_128=0x00020161
--define_symbol reverse_24=0x00020167
--define_symbol reverse_48=0x0002016d
--define_symbol reverse_56=0x00020173
--define_symbol reverse_64=0x00020179
--define_symbol reverse_bd_addr=0x0002017f
--define_symbol reverse_bytes=0x00020185
--define_symbol sm_add_event_handler=0x00020465
--define_symbol sm_address_resolution_lookup=0x000205bd
--define_symbol sm_authenticated=0x00020915
--define_symbol sm_authorization_decline=0x00020923
--define_symbol sm_authorization_grant=0x00020943
--define_symbol sm_authorization_state=0x00020963
--define_symbol sm_bonding_decline=0x0002097d
--define_symbol sm_config=0x00020d9d
--define_symbol sm_config_conn=0x00020db5
--define_symbol sm_encryption_key_size=0x00020f6b
--define_symbol sm_just_works_confirm=0x00021475
--define_symbol sm_le_device_key=0x000217b1
--define_symbol sm_passkey_input=0x00021847
--define_symbol sm_private_random_address_generation_get=0x00021bf5
--define_symbol sm_private_random_address_generation_get_mode=0x00021bfd
--define_symbol sm_private_random_address_generation_set_mode=0x00021c09
--define_symbol sm_private_random_address_generation_set_update_period=0x00021c31
--define_symbol sm_register_oob_data_callback=0x00021d6d
--define_symbol sm_request_pairing=0x00021d79
--define_symbol sm_send_security_request=0x00022797
--define_symbol sm_set_accepted_stk_generation_methods=0x000227bd
--define_symbol sm_set_authentication_requirements=0x000227c9
--define_symbol sm_set_encryption_key_size_range=0x000227d5
--define_symbol sscanf_bd_addr=0x00022ba5
--define_symbol sysSetPublicDeviceAddr=0x00022f0d
...
--define_symbol vListInitialise=0x0002389f
--define_symbol vListInitialiseItem=0x000238b5
--define_symbol vListInsert=0x000238bb
--define_symbol vListInsertEnd=0x000238eb
--define_symbol vPortEndScheduler=0x00023905
--define_symbol vPortEnterCritical=0x0002392d
--define_symbol vPortExitCritical=0x00023971
--define_symbol vPortFree=0x000239a1
--define_symbol vPortSuppressTicksAndSleep=0x00023a35
--define_symbol vPortValidateInterruptPriority=0x00023b3d
--define_symbol vQueueDelete=0x00023b95
--define_symbol vQueueWaitForMessageRestricted=0x00023bc1
--define_symbol vTaskDelay=0x00023c09
--define_symbol vTaskInternalSetTimeOutState=0x00023c55
--define_symbol vTaskMissedYield=0x00023c65
--define_symbol vTaskPlaceOnEventList=0x00023c71
--define_symbol vTaskPlaceOnEventListRestricted=0x00023ca9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00023ce9
--define_symbol vTaskPrioritySet=0x00023d95
--define_symbol vTaskResume=0x00023e5d
--define_symbol vTaskStartScheduler=0x00023ee1
--define_symbol vTaskStepTick=0x00023f71
--define_symbol vTaskSuspend=0x00023fa1
--define_symbol vTaskSuspendAll=0x0002405d
--define_symbol vTaskSwitchContext=0x0002406d
--define_symbol xPortStartScheduler=0x00024115
--define_symbol xQueueAddToSet=0x000241d5
--define_symbol xQueueCreateCountingSemaphore=0x000241f9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00024235
--define_symbol xQueueCreateMutex=0x00024279
--define_symbol xQueueCreateMutexStatic=0x0002428f
--define_symbol xQueueCreateSet=0x000242a9
--define_symbol xQueueGenericCreate=0x000242b1
--define_symbol xQueueGenericCreateStatic=0x000242fd
--define_symbol xQueueGenericReset=0x00024365
--define_symbol xQueueGenericSend=0x000243f1
--define_symbol xQueueGenericSendFromISR=0x0002455d
--define_symbol xQueueGiveFromISR=0x0002461d
--define_symbol xQueueGiveMutexRecursive=0x000246c1
--define_symbol xQueueIsQueueEmptyFromISR=0x00024701
--define_symbol xQueueIsQueueFullFromISR=0x00024725
--define_symbol xQueuePeek=0x0002474d
--define_symbol xQueuePeekFromISR=0x00024875
--define_symbol xQueueReceive=0x000248e1
--define_symbol xQueueReceiveFromISR=0x00024a0d
--define_symbol xQueueRemoveFromSet=0x00024aa1
--define_symbol xQueueSelectFromSet=0x00024ac3
--define_symbol xQueueSelectFromSetFromISR=0x00024ad5
--define_symbol xQueueSemaphoreTake=0x00024ae9
--define_symbol xQueueTakeMutexRecursive=0x00024c55
--define_symbol xTaskCheckForTimeOut=0x00024c99
--define_symbol xTaskCreate=0x00024d09
--define_symbol xTaskCreateStatic=0x00024d65
--define_symbol xTaskGetCurrentTaskHandle=0x00024dd5
--define_symbol xTaskGetSchedulerState=0x00024de1
--define_symbol xTaskGetTickCount=0x00024dfd
--define_symbol xTaskGetTickCountFromISR=0x00024e09
--define_symbol xTaskIncrementTick=0x00024e19
--define_symbol xTaskPriorityDisinherit=0x00024ee5
--define_symbol xTaskPriorityInherit=0x00024f79
--define_symbol xTaskRemoveFromEventList=0x0002500d
--define_symbol xTaskResumeAll=0x0002508d
--define_symbol xTaskResumeFromISR=0x00025155
--define_symbol xTimerCreate=0x000251e1
--define_symbol xTimerCreateStatic=0x00025215
--define_symbol xTimerCreateTimerTask=0x0002524d
--define_symbol xTimerGenericCommand=0x000252b9
--define_symbol xTimerGetExpiryTime=0x00025329
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00025349
