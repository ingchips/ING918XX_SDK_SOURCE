...
--define_symbol nibble_for_char=0x0001ea49
--define_symbol platform_32k_rc_auto_tune=0x0001eae5
--define_symbol platform_32k_rc_tune=0x0001eb61
--define_symbol platform_calibrate_32k=0x0001eb75
--define_symbol platform_config=0x0001eb79
--define_symbol platform_get_heap_status=0x0001ec31
--define_symbol platform_get_us_time=0x0001ec49
--define_symbol platform_get_version=0x0001ec4d
--define_symbol platform_hrng=0x0001ec55
--define_symbol platform_install_isr_stack=0x0001ec5d
--define_symbol platform_patch_rf_init_data=0x0001ec69
--define_symbol platform_printf=0x0001ec75
--define_symbol platform_raise_assertion=0x0001ec89
--define_symbol platform_rand=0x0001ec9d
--define_symbol platform_read_info=0x0001eca1
--define_symbol platform_read_persistent_reg=0x0001ecbd
--define_symbol platform_reset=0x0001eccd
--define_symbol platform_set_evt_callback=0x0001ed01
--define_symbol platform_set_irq_callback=0x0001ed15
--define_symbol platform_set_rf_clk_source=0x0001ed4d
--define_symbol platform_set_rf_init_data=0x0001ed59
--define_symbol platform_set_rf_power_mapping=0x0001ed65
--define_symbol platform_shutdown=0x0001ed71
--define_symbol platform_switch_app=0x0001ed75
--define_symbol platform_trace_raw=0x0001eda1
--define_symbol platform_write_persistent_reg=0x0001edb5
--define_symbol printf_hexdump=0x0001edc5
--define_symbol pvPortMalloc=0x0001f8c9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f9b1
--define_symbol pvTimerGetTimerID=0x0001f9c9
--define_symbol pxPortInitialiseStack=0x0001f9f5
--define_symbol reverse_128=0x0001fbd5
--define_symbol reverse_24=0x0001fbdb
--define_symbol reverse_48=0x0001fbe1
--define_symbol reverse_56=0x0001fbe7
--define_symbol reverse_64=0x0001fbed
--define_symbol reverse_bd_addr=0x0001fbf3
--define_symbol reverse_bytes=0x0001fbf9
--define_symbol sm_add_event_handler=0x0001feb9
--define_symbol sm_address_resolution_lookup=0x0001ffe5
--define_symbol sm_authenticated=0x00020331
--define_symbol sm_authorization_decline=0x0002033f
--define_symbol sm_authorization_grant=0x0002035f
--define_symbol sm_authorization_state=0x0002037f
--define_symbol sm_bonding_decline=0x00020399
--define_symbol sm_config=0x00020765
--define_symbol sm_config_conn=0x0002077d
--define_symbol sm_encryption_key_size=0x000208db
--define_symbol sm_just_works_confirm=0x00020d01
--define_symbol sm_le_device_key=0x00020f2d
--define_symbol sm_passkey_input=0x00020fc3
--define_symbol sm_private_random_address_generation_get=0x00021309
--define_symbol sm_private_random_address_generation_get_mode=0x00021311
--define_symbol sm_private_random_address_generation_set_mode=0x0002131d
--define_symbol sm_private_random_address_generation_set_update_period=0x00021345
--define_symbol sm_register_oob_data_callback=0x00021481
--define_symbol sm_request_pairing=0x0002148d
--define_symbol sm_send_security_request=0x00021dcb
--define_symbol sm_set_accepted_stk_generation_methods=0x00021df1
--define_symbol sm_set_authentication_requirements=0x00021dfd
--define_symbol sm_set_encryption_key_size_range=0x00021e09
--define_symbol sscanf_bd_addr=0x000220dd
--define_symbol sysSetPublicDeviceAddr=0x00022415
--define_symbol uuid128_to_str=0x00022b7d
--define_symbol uuid_add_bluetooth_prefix=0x00022bd5
--define_symbol uuid_has_bluetooth_prefix=0x00022bf5
--define_symbol uxQueueMessagesWaiting=0x00022c39
--define_symbol uxQueueMessagesWaitingFromISR=0x00022c61
--define_symbol uxQueueSpacesAvailable=0x00022c7d
--define_symbol uxTaskGetStackHighWaterMark=0x00022ca9
--define_symbol vPortEnterCritical=0x00022dcd
--define_symbol vPortExitCritical=0x00022e0d
--define_symbol vPortFree=0x00022e39
--define_symbol vPortSuppressTicksAndSleep=0x00022ecd
--define_symbol vPortValidateInterruptPriority=0x00022fa5
--define_symbol vQueueDelete=0x00022ff9
--define_symbol vQueueWaitForMessageRestricted=0x00023025
--define_symbol vTaskDelay=0x0002306d
--define_symbol vTaskInternalSetTimeOutState=0x000230b9
--define_symbol vTaskMissedYield=0x000230c9
--define_symbol vTaskPlaceOnEventList=0x000230d5
--define_symbol vTaskPlaceOnEventListRestricted=0x0002310d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002314d
--define_symbol vTaskResume=0x000231f9
--define_symbol vTaskStartScheduler=0x0002327d
--define_symbol vTaskStepTick=0x0002330d
--define_symbol vTaskSuspend=0x0002333d
--define_symbol vTaskSuspendAll=0x000233f9
--define_symbol vTaskSwitchContext=0x00023409
--define_symbol xPortStartScheduler=0x000234b1
--define_symbol xQueueAddToSet=0x0002356d
--define_symbol xQueueCreateCountingSemaphore=0x00023591
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000235cd
--define_symbol xQueueCreateMutex=0x00023611
--define_symbol xQueueCreateMutexStatic=0x00023627
--define_symbol xQueueCreateSet=0x00023641
--define_symbol xQueueGenericCreate=0x00023649
--define_symbol xQueueGenericCreateStatic=0x00023695
--define_symbol xQueueGenericReset=0x000236fd
--define_symbol xQueueGenericSend=0x00023789
--define_symbol xQueueGenericSendFromISR=0x000238f5
--define_symbol xQueueGiveFromISR=0x000239b5
--define_symbol xQueueGiveMutexRecursive=0x00023a59
--define_symbol xQueueIsQueueEmptyFromISR=0x00023a99
--define_symbol xQueueIsQueueFullFromISR=0x00023abd
--define_symbol xQueuePeek=0x00023ae5
--define_symbol xQueuePeekFromISR=0x00023c0d
--define_symbol xQueueReceive=0x00023c79
--define_symbol xQueueReceiveFromISR=0x00023da5
--define_symbol xQueueRemoveFromSet=0x00023e39
--define_symbol xQueueSelectFromSet=0x00023e5b
--define_symbol xQueueSelectFromSetFromISR=0x00023e6d
--define_symbol xQueueSemaphoreTake=0x00023e81
--define_symbol xQueueTakeMutexRecursive=0x00023fed
--define_symbol xTaskCheckForTimeOut=0x00024031
--define_symbol xTaskCreate=0x000240a1
--define_symbol xTaskCreateStatic=0x000240fd
--define_symbol xTaskGetCurrentTaskHandle=0x0002416d
--define_symbol xTaskGetSchedulerState=0x00024179
--define_symbol xTaskGetTickCount=0x00024195
--define_symbol xTaskGetTickCountFromISR=0x000241a1
--define_symbol xTaskIncrementTick=0x000241b1
--define_symbol xTaskPriorityDisinherit=0x0002427d
--define_symbol xTaskPriorityInherit=0x00024311
--define_symbol xTaskRemoveFromEventList=0x000243a5
--define_symbol xTaskResumeAll=0x00024425
--define_symbol xTaskResumeFromISR=0x000244ed
--define_symbol xTimerCreate=0x00024579
--define_symbol xTimerCreateStatic=0x000245ad
--define_symbol xTimerCreateTimerTask=0x000245e5
--define_symbol xTimerGenericCommand=0x00024651
--define_symbol xTimerGetExpiryTime=0x000246c1
