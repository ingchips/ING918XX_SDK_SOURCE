...
--define_symbol nibble_for_char=0x0001e92d
--define_symbol platform_32k_rc_auto_tune=0x0001e9c9
--define_symbol platform_32k_rc_tune=0x0001ea45
--define_symbol platform_calibrate_32k=0x0001ea59
--define_symbol platform_config=0x0001ea5d
--define_symbol platform_get_heap_status=0x0001eb15
...
--define_symbol platform_patch_rf_init_data=0x0001eb4d
--define_symbol platform_printf=0x0001eb59
--define_symbol platform_raise_assertion=0x0001eb6d
--define_symbol platform_rand=0x0001eb81
--define_symbol platform_read_info=0x0001eb85
--define_symbol platform_read_persistent_reg=0x0001eba1
--define_symbol platform_reset=0x0001ebb1
--define_symbol platform_set_evt_callback=0x0001ebe5
--define_symbol platform_set_irq_callback=0x0001ebf9
--define_symbol platform_set_rf_clk_source=0x0001ec31
--define_symbol platform_set_rf_init_data=0x0001ec3d
--define_symbol platform_set_rf_power_mapping=0x0001ec49
--define_symbol platform_shutdown=0x0001ec55
--define_symbol platform_switch_app=0x0001ec59
--define_symbol platform_trace_raw=0x0001ec85
--define_symbol platform_write_persistent_reg=0x0001ec99
--define_symbol printf_hexdump=0x0001eca9
--define_symbol pvPortMalloc=0x0001f775
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f85d
--define_symbol pvTimerGetTimerID=0x0001f875
--define_symbol pxPortInitialiseStack=0x0001f8a1
--define_symbol reverse_128=0x0001fa81
--define_symbol reverse_24=0x0001fa87
--define_symbol reverse_48=0x0001fa8d
--define_symbol reverse_56=0x0001fa93
--define_symbol reverse_64=0x0001fa99
--define_symbol reverse_bd_addr=0x0001fa9f
--define_symbol reverse_bytes=0x0001faa5
--define_symbol sm_add_event_handler=0x0001fd65
--define_symbol sm_address_resolution_lookup=0x0001fe91
--define_symbol sm_authenticated=0x000201dd
--define_symbol sm_authorization_decline=0x000201eb
--define_symbol sm_authorization_grant=0x0002020b
--define_symbol sm_authorization_state=0x0002022b
--define_symbol sm_bonding_decline=0x00020245
--define_symbol sm_config=0x00020611
--define_symbol sm_config_conn=0x00020629
--define_symbol sm_encryption_key_size=0x00020787
--define_symbol sm_just_works_confirm=0x00020bad
--define_symbol sm_le_device_key=0x00020dd9
--define_symbol sm_passkey_input=0x00020e6f
--define_symbol sm_private_random_address_generation_get=0x000211b5
--define_symbol sm_private_random_address_generation_get_mode=0x000211bd
--define_symbol sm_private_random_address_generation_set_mode=0x000211c9
--define_symbol sm_private_random_address_generation_set_update_period=0x000211f1
--define_symbol sm_register_oob_data_callback=0x0002132d
--define_symbol sm_request_pairing=0x00021339
--define_symbol sm_send_security_request=0x00021c77
--define_symbol sm_set_accepted_stk_generation_methods=0x00021c9d
--define_symbol sm_set_authentication_requirements=0x00021ca9
--define_symbol sm_set_encryption_key_size_range=0x00021cb5
--define_symbol sscanf_bd_addr=0x00021f89
--define_symbol sysSetPublicDeviceAddr=0x000222cd
--define_symbol uuid128_to_str=0x00022a05
--define_symbol uuid_add_bluetooth_prefix=0x00022a5d
--define_symbol uuid_has_bluetooth_prefix=0x00022a7d
--define_symbol uxQueueMessagesWaiting=0x00022ac1
--define_symbol uxQueueMessagesWaitingFromISR=0x00022ae9
--define_symbol uxQueueSpacesAvailable=0x00022b05
--define_symbol uxTaskGetStackHighWaterMark=0x00022b31
--define_symbol vPortEnterCritical=0x00022c55
--define_symbol vPortExitCritical=0x00022c95
--define_symbol vPortFree=0x00022cc1
--define_symbol vPortSuppressTicksAndSleep=0x00022d55
--define_symbol vPortValidateInterruptPriority=0x00022e2d
--define_symbol vQueueDelete=0x00022e81
--define_symbol vQueueWaitForMessageRestricted=0x00022ead
--define_symbol vTaskDelay=0x00022ef5
--define_symbol vTaskInternalSetTimeOutState=0x00022f41
--define_symbol vTaskMissedYield=0x00022f51
--define_symbol vTaskPlaceOnEventList=0x00022f5d
--define_symbol vTaskPlaceOnEventListRestricted=0x00022f95
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022fd5
--define_symbol vTaskStartScheduler=0x00023081
--define_symbol vTaskStepTick=0x00023111
--define_symbol vTaskSuspendAll=0x00023141
--define_symbol vTaskSwitchContext=0x00023151
--define_symbol xPortStartScheduler=0x000231f9
--define_symbol xQueueAddToSet=0x000232b5
--define_symbol xQueueCreateCountingSemaphore=0x000232d9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023315
--define_symbol xQueueCreateMutex=0x00023359
--define_symbol xQueueCreateMutexStatic=0x0002336f
--define_symbol xQueueCreateSet=0x00023389
--define_symbol xQueueGenericCreate=0x00023391
--define_symbol xQueueGenericCreateStatic=0x000233dd
--define_symbol xQueueGenericReset=0x00023445
--define_symbol xQueueGenericSend=0x000234d1
--define_symbol xQueueGenericSendFromISR=0x0002363d
--define_symbol xQueueGiveFromISR=0x000236fd
--define_symbol xQueueGiveMutexRecursive=0x000237a1
--define_symbol xQueueIsQueueEmptyFromISR=0x000237e1
--define_symbol xQueueIsQueueFullFromISR=0x00023805
--define_symbol xQueuePeek=0x0002382d
--define_symbol xQueuePeekFromISR=0x00023955
--define_symbol xQueueReceive=0x000239c1
--define_symbol xQueueReceiveFromISR=0x00023aed
--define_symbol xQueueRemoveFromSet=0x00023b81
--define_symbol xQueueSelectFromSet=0x00023ba3
--define_symbol xQueueSelectFromSetFromISR=0x00023bb5
--define_symbol xQueueSemaphoreTake=0x00023bc9
--define_symbol xQueueTakeMutexRecursive=0x00023d35
--define_symbol xTaskCheckForTimeOut=0x00023d79
--define_symbol xTaskCreate=0x00023de9
--define_symbol xTaskCreateStatic=0x00023e45
--define_symbol xTaskGetCurrentTaskHandle=0x00023eb5
--define_symbol xTaskGetSchedulerState=0x00023ec1
--define_symbol xTaskGetTickCount=0x00023edd
--define_symbol xTaskGetTickCountFromISR=0x00023ee9
--define_symbol xTaskIncrementTick=0x00023ef9
--define_symbol xTaskPriorityDisinherit=0x00023fc5
--define_symbol xTaskPriorityInherit=0x00024059
--define_symbol xTaskRemoveFromEventList=0x000240ed
--define_symbol xTaskResumeAll=0x0002416d
--define_symbol xTimerCreate=0x00024235
--define_symbol xTimerCreateStatic=0x00024269
--define_symbol xTimerCreateTimerTask=0x000242a1
--define_symbol xTimerGenericCommand=0x0002430d
--define_symbol xTimerGetExpiryTime=0x0002437d
