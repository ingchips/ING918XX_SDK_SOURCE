...
--define_symbol ll_raw_packet_send=0x0000d459
--define_symbol ll_raw_packet_set_param=0x0000d4c9
--define_symbol ll_raw_packet_set_rx_cte=0x0000d52f
--define_symbol ll_raw_packet_set_tx_cte=0x0000d58d
--define_symbol ll_raw_packet_set_tx_data=0x0000d5cb
--define_symbol ll_set_adv_coded_scheme=0x0000d7a1
--define_symbol ll_set_conn_coded_scheme=0x0000d7d1
--define_symbol ll_set_conn_latency=0x0000d7fd
--define_symbol ll_set_conn_tx_power=0x0000d82d
--define_symbol ll_set_def_antenna=0x0000d875
--define_symbol ll_set_initiating_coded_scheme=0x0000d891
--define_symbol nibble_for_char=0x0001e269
--define_symbol platform_32k_rc_auto_tune=0x0001e321
--define_symbol platform_32k_rc_tune=0x0001e39d
--define_symbol platform_calibrate_32k=0x0001e3b1
--define_symbol platform_config=0x0001e3b5
--define_symbol platform_get_heap_status=0x0001e465
...
--define_symbol platform_printf=0x0001e49d
--define_symbol platform_raise_assertion=0x0001e4b1
--define_symbol platform_rand=0x0001e4c5
--define_symbol platform_read_info=0x0001e4c9
...
--define_symbol platform_write_persistent_reg=0x0001e5dd
--define_symbol printf_hexdump=0x0001e5ed
...
--define_symbol sm_add_event_handler=0x0001f6e5
--define_symbol sm_address_resolution_lookup=0x0001f811
--define_symbol sm_authenticated=0x0001f8eb
--define_symbol sm_authorization_decline=0x0001f8f9
--define_symbol sm_authorization_grant=0x0001f919
--define_symbol sm_authorization_state=0x0001f939
--define_symbol sm_bonding_decline=0x0001f955
--define_symbol sm_config=0x0001fd2d
--define_symbol sm_encryption_key_size=0x0001fe39
--define_symbol sm_just_works_confirm=0x00020609
--define_symbol sm_le_device_key=0x00020859
--define_symbol sm_passkey_input=0x000208f1
--define_symbol sm_private_random_address_generation_get=0x00020c7d
--define_symbol sm_private_random_address_generation_get_mode=0x00020c85
--define_symbol sm_private_random_address_generation_set_mode=0x00020c91
--define_symbol sm_private_random_address_generation_set_update_period=0x00020cb9
--define_symbol sm_register_oob_data_callback=0x00020cf1
--define_symbol sm_request_pairing=0x00020cfd
--define_symbol sm_send_security_request=0x00021737
--define_symbol sm_set_accepted_stk_generation_methods=0x0002175d
--define_symbol sm_set_authentication_requirements=0x00021769
--define_symbol sm_set_encryption_key_size_range=0x00021775
--define_symbol sscanf_bd_addr=0x00021a71
--define_symbol sysSetPublicDeviceAddr=0x00021d8d
--define_symbol uuid128_to_str=0x000224c1
--define_symbol uuid_add_bluetooth_prefix=0x00022519
--define_symbol uuid_has_bluetooth_prefix=0x00022539
--define_symbol uxQueueMessagesWaiting=0x0002257d
--define_symbol uxQueueMessagesWaitingFromISR=0x000225a5
--define_symbol uxQueueSpacesAvailable=0x000225c1
--define_symbol vPortEnterCritical=0x00022685
--define_symbol vPortExitCritical=0x000226c5
--define_symbol vPortFree=0x000226f1
--define_symbol vPortSuppressTicksAndSleep=0x00022785
--define_symbol vPortValidateInterruptPriority=0x0002285d
--define_symbol vQueueDelete=0x000228b1
--define_symbol vQueueWaitForMessageRestricted=0x000228dd
--define_symbol vTaskDelay=0x00022925
--define_symbol vTaskInternalSetTimeOutState=0x00022971
--define_symbol vTaskMissedYield=0x00022981
--define_symbol vTaskPlaceOnEventList=0x0002298d
--define_symbol vTaskPlaceOnEventListRestricted=0x000229c5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022a05
--define_symbol vTaskStartScheduler=0x00022ab1
--define_symbol vTaskStepTick=0x00022b41
--define_symbol vTaskSuspendAll=0x00022b71
--define_symbol vTaskSwitchContext=0x00022b81
--define_symbol xPortStartScheduler=0x00022c29
--define_symbol xQueueAddToSet=0x00022ce5
--define_symbol xQueueCreateCountingSemaphore=0x00022d09
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022d45
--define_symbol xQueueCreateMutex=0x00022d89
--define_symbol xQueueCreateMutexStatic=0x00022d9f
--define_symbol xQueueCreateSet=0x00022db9
--define_symbol xQueueGenericCreate=0x00022dc1
--define_symbol xQueueGenericCreateStatic=0x00022e0d
--define_symbol xQueueGenericReset=0x00022e75
--define_symbol xQueueGenericSend=0x00022f01
--define_symbol xQueueGenericSendFromISR=0x0002306d
--define_symbol xQueueGiveFromISR=0x0002312d
--define_symbol xQueueGiveMutexRecursive=0x000231d1
--define_symbol xQueueIsQueueEmptyFromISR=0x00023211
--define_symbol xQueueIsQueueFullFromISR=0x00023235
--define_symbol xQueuePeek=0x0002325d
--define_symbol xQueuePeekFromISR=0x00023385
--define_symbol xQueueReceive=0x000233f1
--define_symbol xQueueReceiveFromISR=0x0002351d
--define_symbol xQueueRemoveFromSet=0x000235b1
--define_symbol xQueueSelectFromSet=0x000235d3
--define_symbol xQueueSelectFromSetFromISR=0x000235e5
--define_symbol xQueueSemaphoreTake=0x000235f9
--define_symbol xQueueTakeMutexRecursive=0x00023765
--define_symbol xTaskCheckForTimeOut=0x000237a9
--define_symbol xTaskCreate=0x00023819
--define_symbol xTaskCreateStatic=0x00023875
--define_symbol xTaskGetCurrentTaskHandle=0x000238e5
--define_symbol xTaskGetSchedulerState=0x000238f1
--define_symbol xTaskGetTickCount=0x0002390d
--define_symbol xTaskGetTickCountFromISR=0x00023919
--define_symbol xTaskIncrementTick=0x00023929
--define_symbol xTaskPriorityDisinherit=0x000239f5
--define_symbol xTaskPriorityInherit=0x00023a89
--define_symbol xTaskRemoveFromEventList=0x00023b1d
--define_symbol xTaskResumeAll=0x00023b9d
--define_symbol xTimerCreate=0x00023c65
--define_symbol xTimerCreateStatic=0x00023c99
--define_symbol xTimerCreateTimerTask=0x00023cd1
--define_symbol xTimerGenericCommand=0x00023d3d
--define_symbol xTimerGetExpiryTime=0x00023dad
