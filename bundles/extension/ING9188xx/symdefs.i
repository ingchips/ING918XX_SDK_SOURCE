...
--define_symbol ll_raw_packet_get_iq_samples=0x0000d28f
--define_symbol ll_raw_packet_get_rx_data=0x0000d2fb
--define_symbol ll_raw_packet_recv=0x0000d391
--define_symbol ll_raw_packet_send=0x0000d415
--define_symbol ll_raw_packet_set_param=0x0000d475
--define_symbol ll_raw_packet_set_rx_cte=0x0000d4db
--define_symbol ll_raw_packet_set_tx_cte=0x0000d539
--define_symbol ll_raw_packet_set_tx_data=0x0000d577
--define_symbol ll_set_adv_coded_scheme=0x0000d74d
--define_symbol ll_set_conn_coded_scheme=0x0000d77d
--define_symbol ll_set_conn_latency=0x0000d7a9
--define_symbol ll_set_conn_tx_power=0x0000d7d9
--define_symbol ll_set_def_antenna=0x0000d821
--define_symbol ll_set_initiating_coded_scheme=0x0000d83d
--define_symbol nibble_for_char=0x0001e215
--define_symbol platform_32k_rc_auto_tune=0x0001e2cd
--define_symbol platform_32k_rc_tune=0x0001e349
--define_symbol platform_calibrate_32k=0x0001e35d
--define_symbol platform_config=0x0001e361
--define_symbol platform_get_heap_status=0x0001e411
--define_symbol platform_get_us_time=0x0001e429
--define_symbol platform_get_version=0x0001e42d
--define_symbol platform_hrng=0x0001e435
--define_symbol platform_patch_rf_init_data=0x0001e43d
--define_symbol platform_printf=0x0001e449
--define_symbol platform_raise_assertion=0x0001e45d
--define_symbol platform_rand=0x0001e471
--define_symbol platform_read_info=0x0001e475
--define_symbol platform_read_persistent_reg=0x0001e491
--define_symbol platform_reset=0x0001e4a1
--define_symbol platform_set_evt_callback=0x0001e4d5
--define_symbol platform_set_irq_callback=0x0001e4e9
--define_symbol platform_set_rf_clk_source=0x0001e521
--define_symbol platform_set_rf_init_data=0x0001e52d
--define_symbol platform_set_rf_power_mapping=0x0001e539
--define_symbol platform_shutdown=0x0001e545
--define_symbol platform_switch_app=0x0001e549
--define_symbol platform_trace_raw=0x0001e575
--define_symbol platform_write_persistent_reg=0x0001e589
--define_symbol printf_hexdump=0x0001e599
--define_symbol pvPortMalloc=0x0001f0bd
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f1a5
--define_symbol pvTimerGetTimerID=0x0001f1bd
--define_symbol pxPortInitialiseStack=0x0001f1e9
--define_symbol reverse_128=0x0001f3c9
--define_symbol reverse_24=0x0001f3cf
--define_symbol reverse_48=0x0001f3d5
--define_symbol reverse_56=0x0001f3db
--define_symbol reverse_64=0x0001f3e1
--define_symbol reverse_bd_addr=0x0001f3e7
--define_symbol reverse_bytes=0x0001f3ed
--define_symbol sm_add_event_handler=0x0001f68d
--define_symbol sm_address_resolution_lookup=0x0001f7b9
--define_symbol sm_authenticated=0x0001f893
--define_symbol sm_authorization_decline=0x0001f8a1
--define_symbol sm_authorization_grant=0x0001f8c1
--define_symbol sm_authorization_state=0x0001f8e1
--define_symbol sm_bonding_decline=0x0001f8fd
--define_symbol sm_config=0x0001fcd5
--define_symbol sm_encryption_key_size=0x0001fde1
--define_symbol sm_just_works_confirm=0x000205b1
--define_symbol sm_le_device_key=0x00020801
--define_symbol sm_passkey_input=0x00020899
--define_symbol sm_private_random_address_generation_get=0x00020c25
--define_symbol sm_private_random_address_generation_get_mode=0x00020c2d
--define_symbol sm_private_random_address_generation_set_mode=0x00020c39
--define_symbol sm_private_random_address_generation_set_update_period=0x00020c61
--define_symbol sm_register_oob_data_callback=0x00020c99
--define_symbol sm_request_pairing=0x00020ca5
--define_symbol sm_send_security_request=0x000216df
--define_symbol sm_set_accepted_stk_generation_methods=0x00021705
--define_symbol sm_set_authentication_requirements=0x00021711
--define_symbol sm_set_encryption_key_size_range=0x0002171d
--define_symbol sscanf_bd_addr=0x00021a19
--define_symbol sysSetPublicDeviceAddr=0x00021d35
--define_symbol uuid128_to_str=0x00022469
--define_symbol uuid_add_bluetooth_prefix=0x000224c1
--define_symbol uuid_has_bluetooth_prefix=0x000224e1
--define_symbol uxQueueMessagesWaiting=0x00022525
--define_symbol uxQueueMessagesWaitingFromISR=0x0002254d
--define_symbol uxQueueSpacesAvailable=0x00022569
--define_symbol vPortEnterCritical=0x0002262d
--define_symbol vPortExitCritical=0x0002266d
--define_symbol vPortFree=0x00022699
--define_symbol vPortSuppressTicksAndSleep=0x0002272d
--define_symbol vPortValidateInterruptPriority=0x00022805
--define_symbol vQueueDelete=0x00022859
--define_symbol vQueueWaitForMessageRestricted=0x00022885
--define_symbol vTaskDelay=0x000228cd
--define_symbol vTaskInternalSetTimeOutState=0x00022919
--define_symbol vTaskMissedYield=0x00022929
--define_symbol vTaskPlaceOnEventList=0x00022935
--define_symbol vTaskPlaceOnEventListRestricted=0x0002296d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000229ad
--define_symbol vTaskStartScheduler=0x00022a59
--define_symbol vTaskStepTick=0x00022ae9
--define_symbol vTaskSuspendAll=0x00022b19
--define_symbol vTaskSwitchContext=0x00022b29
--define_symbol xPortStartScheduler=0x00022bd1
--define_symbol xQueueAddToSet=0x00022c8d
--define_symbol xQueueCreateCountingSemaphore=0x00022cb1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022ced
--define_symbol xQueueCreateMutex=0x00022d31
--define_symbol xQueueCreateMutexStatic=0x00022d47
--define_symbol xQueueCreateSet=0x00022d61
--define_symbol xQueueGenericCreate=0x00022d69
--define_symbol xQueueGenericCreateStatic=0x00022db5
--define_symbol xQueueGenericReset=0x00022e1d
--define_symbol xQueueGenericSend=0x00022ea9
--define_symbol xQueueGenericSendFromISR=0x00023015
--define_symbol xQueueGiveFromISR=0x000230d5
--define_symbol xQueueGiveMutexRecursive=0x00023179
--define_symbol xQueueIsQueueEmptyFromISR=0x000231b9
--define_symbol xQueueIsQueueFullFromISR=0x000231dd
--define_symbol xQueuePeek=0x00023205
--define_symbol xQueuePeekFromISR=0x0002332d
--define_symbol xQueueReceive=0x00023399
--define_symbol xQueueReceiveFromISR=0x000234c5
--define_symbol xQueueRemoveFromSet=0x00023559
--define_symbol xQueueSelectFromSet=0x0002357b
--define_symbol xQueueSelectFromSetFromISR=0x0002358d
--define_symbol xQueueSemaphoreTake=0x000235a1
--define_symbol xQueueTakeMutexRecursive=0x0002370d
--define_symbol xTaskCheckForTimeOut=0x00023751
--define_symbol xTaskCreate=0x000237c1
--define_symbol xTaskCreateStatic=0x0002381d
--define_symbol xTaskGetCurrentTaskHandle=0x0002388d
--define_symbol xTaskGetSchedulerState=0x00023899
--define_symbol xTaskGetTickCount=0x000238b5
--define_symbol xTaskGetTickCountFromISR=0x000238c1
--define_symbol xTaskIncrementTick=0x000238d1
--define_symbol xTaskPriorityDisinherit=0x0002399d
--define_symbol xTaskPriorityInherit=0x00023a31
--define_symbol xTaskRemoveFromEventList=0x00023ac5
--define_symbol xTaskResumeAll=0x00023b45
--define_symbol xTimerCreate=0x00023c0d
--define_symbol xTimerCreateStatic=0x00023c41
--define_symbol xTimerCreateTimerTask=0x00023c79
--define_symbol xTimerGenericCommand=0x00023ce5
--define_symbol xTimerGetExpiryTime=0x00023d55
