...
--define_symbol nibble_for_char=0x0001db9d
--define_symbol platform_32k_rc_auto_tune=0x0001dc55
--define_symbol platform_32k_rc_tune=0x0001dcd1
--define_symbol platform_calibrate_32k=0x0001dce5
--define_symbol platform_config=0x0001dce9
--define_symbol platform_get_heap_status=0x0001dd99
--define_symbol platform_get_us_time=0x0001ddb1
--define_symbol platform_get_version=0x0001ddb5
--define_symbol platform_hrng=0x0001ddbd
--define_symbol platform_patch_rf_init_data=0x0001ddc5
--define_symbol platform_printf=0x0001ddd1
--define_symbol platform_raise_assertion=0x0001dde5
--define_symbol platform_rand=0x0001ddf9
--define_symbol platform_read_info=0x0001ddfd
--define_symbol platform_read_persistent_reg=0x0001de19
--define_symbol platform_reset=0x0001de29
--define_symbol platform_set_evt_callback=0x0001de5d
--define_symbol platform_set_irq_callback=0x0001de71
--define_symbol platform_set_rf_clk_source=0x0001dea9
--define_symbol platform_set_rf_init_data=0x0001deb5
--define_symbol platform_set_rf_power_mapping=0x0001dec1
--define_symbol platform_shutdown=0x0001decd
--define_symbol platform_switch_app=0x0001ded1
--define_symbol platform_trace_raw=0x0001defd
--define_symbol platform_write_persistent_reg=0x0001df11
--define_symbol printf_hexdump=0x0001df21
--define_symbol pvPortMalloc=0x0001ea1d
--define_symbol pvTaskIncrementMutexHeldCount=0x0001eb05
--define_symbol pvTimerGetTimerID=0x0001eb1d
--define_symbol pxPortInitialiseStack=0x0001eb49
--define_symbol reverse_128=0x0001ed29
--define_symbol reverse_24=0x0001ed2f
--define_symbol reverse_48=0x0001ed35
--define_symbol reverse_56=0x0001ed3b
--define_symbol reverse_64=0x0001ed41
--define_symbol reverse_bd_addr=0x0001ed47
--define_symbol reverse_bytes=0x0001ed4d
--define_symbol sm_add_event_handler=0x0001efed
--define_symbol sm_address_resolution_lookup=0x0001f119
--define_symbol sm_authenticated=0x0001f1f3
--define_symbol sm_authorization_decline=0x0001f201
--define_symbol sm_authorization_grant=0x0001f221
--define_symbol sm_authorization_state=0x0001f241
--define_symbol sm_bonding_decline=0x0001f25d
--define_symbol sm_config=0x0001f635
--define_symbol sm_encryption_key_size=0x0001f741
--define_symbol sm_just_works_confirm=0x0001ff11
--define_symbol sm_le_device_key=0x00020161
--define_symbol sm_passkey_input=0x000201f9
--define_symbol sm_private_random_address_generation_get=0x00020585
--define_symbol sm_private_random_address_generation_get_mode=0x0002058d
--define_symbol sm_private_random_address_generation_set_mode=0x00020599
--define_symbol sm_private_random_address_generation_set_update_period=0x000205c1
--define_symbol sm_register_oob_data_callback=0x000205f9
--define_symbol sm_request_pairing=0x00020605
--define_symbol sm_send_security_request=0x0002103f
--define_symbol sm_set_accepted_stk_generation_methods=0x00021065
--define_symbol sm_set_authentication_requirements=0x00021071
--define_symbol sm_set_encryption_key_size_range=0x0002107d
--define_symbol sscanf_bd_addr=0x00021379
--define_symbol sysSetPublicDeviceAddr=0x00021691
...
--define_symbol uxQueueMessagesWaiting=0x00021e81
--define_symbol uxQueueMessagesWaitingFromISR=0x00021ea9
--define_symbol uxQueueSpacesAvailable=0x00021ec5
--define_symbol vPortEnterCritical=0x00021f89
--define_symbol vPortExitCritical=0x00021fc9
--define_symbol vPortFree=0x00021ff5
--define_symbol vPortSuppressTicksAndSleep=0x00022089
--define_symbol vPortValidateInterruptPriority=0x00022161
--define_symbol vQueueDelete=0x000221b5
--define_symbol vQueueWaitForMessageRestricted=0x000221e1
--define_symbol vTaskDelay=0x00022229
--define_symbol vTaskInternalSetTimeOutState=0x00022275
--define_symbol vTaskMissedYield=0x00022285
--define_symbol vTaskPlaceOnEventList=0x00022291
--define_symbol vTaskPlaceOnEventListRestricted=0x000222c9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022309
--define_symbol vTaskStartScheduler=0x000223b5
--define_symbol vTaskStepTick=0x00022445
--define_symbol vTaskSuspendAll=0x00022475
--define_symbol vTaskSwitchContext=0x00022485
--define_symbol xPortStartScheduler=0x0002252d
--define_symbol xQueueAddToSet=0x000225e9
--define_symbol xQueueCreateCountingSemaphore=0x0002260d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022649
--define_symbol xQueueCreateMutex=0x0002268d
--define_symbol xQueueCreateMutexStatic=0x000226a3
--define_symbol xQueueCreateSet=0x000226bd
--define_symbol xQueueGenericCreate=0x000226c5
--define_symbol xQueueGenericCreateStatic=0x00022711
--define_symbol xQueueGenericReset=0x00022779
--define_symbol xQueueGenericSend=0x00022805
--define_symbol xQueueGenericSendFromISR=0x00022971
--define_symbol xQueueGiveFromISR=0x00022a31
--define_symbol xQueueGiveMutexRecursive=0x00022ad5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022b15
--define_symbol xQueueIsQueueFullFromISR=0x00022b39
--define_symbol xQueuePeek=0x00022b61
--define_symbol xQueuePeekFromISR=0x00022c89
--define_symbol xQueueReceive=0x00022cf5
--define_symbol xQueueReceiveFromISR=0x00022e21
--define_symbol xQueueRemoveFromSet=0x00022eb5
--define_symbol xQueueSelectFromSet=0x00022ed7
--define_symbol xQueueSelectFromSetFromISR=0x00022ee9
--define_symbol xQueueSemaphoreTake=0x00022efd
--define_symbol xQueueTakeMutexRecursive=0x00023069
--define_symbol xTaskCheckForTimeOut=0x000230ad
--define_symbol xTaskCreate=0x0002311d
--define_symbol xTaskCreateStatic=0x00023179
--define_symbol xTaskGetCurrentTaskHandle=0x000231e9
--define_symbol xTaskGetSchedulerState=0x000231f5
--define_symbol xTaskGetTickCount=0x00023211
--define_symbol xTaskGetTickCountFromISR=0x0002321d
--define_symbol xTaskIncrementTick=0x0002322d
--define_symbol xTaskPriorityDisinherit=0x000232f9
--define_symbol xTaskPriorityInherit=0x0002338d
--define_symbol xTaskRemoveFromEventList=0x00023421
--define_symbol xTaskResumeAll=0x000234a1
--define_symbol xTimerCreate=0x00023569
--define_symbol xTimerCreateStatic=0x0002359d
--define_symbol xTimerCreateTimerTask=0x000235d5
--define_symbol xTimerGenericCommand=0x00023641
--define_symbol xTimerGetExpiryTime=0x000236b1
