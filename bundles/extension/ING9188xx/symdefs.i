...
--define_symbol sysSetPublicDeviceAddr=0x00022409
--define_symbol uuid128_to_str=0x00022b71
--define_symbol uuid_add_bluetooth_prefix=0x00022bc9
--define_symbol uuid_has_bluetooth_prefix=0x00022be9
--define_symbol uxQueueMessagesWaiting=0x00022c2d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022c55
--define_symbol uxQueueSpacesAvailable=0x00022c71
--define_symbol uxTaskGetStackHighWaterMark=0x00022c9d
--define_symbol vPortEnterCritical=0x00022dc1
--define_symbol vPortExitCritical=0x00022e01
--define_symbol vPortFree=0x00022e2d
--define_symbol vPortSuppressTicksAndSleep=0x00022ec1
--define_symbol vPortValidateInterruptPriority=0x00022f99
--define_symbol vQueueDelete=0x00022fed
--define_symbol vQueueWaitForMessageRestricted=0x00023019
--define_symbol vTaskDelay=0x00023061
--define_symbol vTaskInternalSetTimeOutState=0x000230ad
--define_symbol vTaskMissedYield=0x000230bd
--define_symbol vTaskPlaceOnEventList=0x000230c9
--define_symbol vTaskPlaceOnEventListRestricted=0x00023101
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00023141
--define_symbol vTaskResume=0x000231ed
--define_symbol vTaskStartScheduler=0x00023271
--define_symbol vTaskStepTick=0x00023301
--define_symbol vTaskSuspend=0x00023331
--define_symbol vTaskSuspendAll=0x000233ed
--define_symbol vTaskSwitchContext=0x000233fd
--define_symbol xPortStartScheduler=0x000234a5
--define_symbol xQueueAddToSet=0x00023561
--define_symbol xQueueCreateCountingSemaphore=0x00023585
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000235c1
--define_symbol xQueueCreateMutex=0x00023605
--define_symbol xQueueCreateMutexStatic=0x0002361b
--define_symbol xQueueCreateSet=0x00023635
--define_symbol xQueueGenericCreate=0x0002363d
--define_symbol xQueueGenericCreateStatic=0x00023689
--define_symbol xQueueGenericReset=0x000236f1
--define_symbol xQueueGenericSend=0x0002377d
--define_symbol xQueueGenericSendFromISR=0x000238e9
--define_symbol xQueueGiveFromISR=0x000239a9
--define_symbol xQueueGiveMutexRecursive=0x00023a4d
--define_symbol xQueueIsQueueEmptyFromISR=0x00023a8d
--define_symbol xQueueIsQueueFullFromISR=0x00023ab1
--define_symbol xQueuePeek=0x00023ad9
--define_symbol xQueuePeekFromISR=0x00023c01
--define_symbol xQueueReceive=0x00023c6d
--define_symbol xQueueReceiveFromISR=0x00023d99
--define_symbol xQueueRemoveFromSet=0x00023e2d
--define_symbol xQueueSelectFromSet=0x00023e4f
--define_symbol xQueueSelectFromSetFromISR=0x00023e61
--define_symbol xQueueSemaphoreTake=0x00023e75
--define_symbol xQueueTakeMutexRecursive=0x00023fe1
--define_symbol xTaskCheckForTimeOut=0x00024025
--define_symbol xTaskCreate=0x00024095
--define_symbol xTaskCreateStatic=0x000240f1
--define_symbol xTaskGetCurrentTaskHandle=0x00024161
--define_symbol xTaskGetSchedulerState=0x0002416d
--define_symbol xTaskGetTickCount=0x00024189
--define_symbol xTaskGetTickCountFromISR=0x00024195
--define_symbol xTaskIncrementTick=0x000241a5
--define_symbol xTaskPriorityDisinherit=0x00024271
--define_symbol xTaskPriorityInherit=0x00024305
--define_symbol xTaskRemoveFromEventList=0x00024399
--define_symbol xTaskResumeAll=0x00024419
--define_symbol xTaskResumeFromISR=0x000244e1
--define_symbol xTimerCreate=0x0002456d
--define_symbol xTimerCreateStatic=0x000245a1
--define_symbol xTimerCreateTimerTask=0x000245d9
--define_symbol xTimerGenericCommand=0x00024645
--define_symbol xTimerGetExpiryTime=0x000246b5
