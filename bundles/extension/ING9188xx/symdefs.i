...
--define_symbol nibble_for_char=0x0001e991
--define_symbol platform_32k_rc_auto_tune=0x0001ea2d
--define_symbol platform_32k_rc_tune=0x0001eaa9
--define_symbol platform_calibrate_32k=0x0001eabd
--define_symbol platform_config=0x0001eac1
--define_symbol platform_get_heap_status=0x0001eb79
--define_symbol platform_get_us_time=0x0001eb91
--define_symbol platform_get_version=0x0001eb95
--define_symbol platform_hrng=0x0001eb9d
--define_symbol platform_install_isr_stack=0x0001eba5
--define_symbol platform_patch_rf_init_data=0x0001ebb1
--define_symbol platform_printf=0x0001ebbd
--define_symbol platform_raise_assertion=0x0001ebd1
--define_symbol platform_rand=0x0001ebe5
--define_symbol platform_read_info=0x0001ebe9
--define_symbol platform_read_persistent_reg=0x0001ec05
--define_symbol platform_reset=0x0001ec15
--define_symbol platform_set_evt_callback=0x0001ec49
--define_symbol platform_set_irq_callback=0x0001ec5d
--define_symbol platform_set_rf_clk_source=0x0001ec95
--define_symbol platform_set_rf_init_data=0x0001eca1
--define_symbol platform_set_rf_power_mapping=0x0001ecad
--define_symbol platform_shutdown=0x0001ecb9
--define_symbol platform_switch_app=0x0001ecbd
--define_symbol platform_trace_raw=0x0001ece9
--define_symbol platform_write_persistent_reg=0x0001ecfd
--define_symbol printf_hexdump=0x0001ed0d
--define_symbol pvPortMalloc=0x0001f7d9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f8c1
--define_symbol pvTimerGetTimerID=0x0001f8d9
--define_symbol pxPortInitialiseStack=0x0001f905
--define_symbol reverse_128=0x0001fae5
--define_symbol reverse_24=0x0001faeb
--define_symbol reverse_48=0x0001faf1
--define_symbol reverse_56=0x0001faf7
--define_symbol reverse_64=0x0001fafd
--define_symbol reverse_bd_addr=0x0001fb03
--define_symbol reverse_bytes=0x0001fb09
--define_symbol sm_add_event_handler=0x0001fdc9
--define_symbol sm_address_resolution_lookup=0x0001fef5
...
--define_symbol sm_config=0x00020675
--define_symbol sm_config_conn=0x0002068d
--define_symbol sm_encryption_key_size=0x000207eb
--define_symbol sm_just_works_confirm=0x00020c11
--define_symbol sm_le_device_key=0x00020e3d
--define_symbol sm_passkey_input=0x00020ed3
...
--define_symbol sscanf_bd_addr=0x00021fed
--define_symbol sysSetPublicDeviceAddr=0x00022331
--define_symbol uuid128_to_str=0x00022a69
--define_symbol uuid_add_bluetooth_prefix=0x00022ac1
--define_symbol uuid_has_bluetooth_prefix=0x00022ae1
--define_symbol uxQueueMessagesWaiting=0x00022b25
--define_symbol uxQueueMessagesWaitingFromISR=0x00022b4d
--define_symbol uxQueueSpacesAvailable=0x00022b69
--define_symbol uxTaskGetStackHighWaterMark=0x00022b95
--define_symbol vPortEnterCritical=0x00022cb9
--define_symbol vPortExitCritical=0x00022cf9
--define_symbol vPortFree=0x00022d25
--define_symbol vPortSuppressTicksAndSleep=0x00022db9
--define_symbol vPortValidateInterruptPriority=0x00022e91
--define_symbol vQueueDelete=0x00022ee5
--define_symbol vQueueWaitForMessageRestricted=0x00022f11
--define_symbol vTaskDelay=0x00022f59
--define_symbol vTaskInternalSetTimeOutState=0x00022fa5
--define_symbol vTaskMissedYield=0x00022fb5
--define_symbol vTaskPlaceOnEventList=0x00022fc1
--define_symbol vTaskPlaceOnEventListRestricted=0x00022ff9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00023039
--define_symbol vTaskStartScheduler=0x000230e5
--define_symbol vTaskStepTick=0x00023175
...
--define_symbol xQueueAddToSet=0x00023319
--define_symbol xQueueCreateCountingSemaphore=0x0002333d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023379
--define_symbol xQueueCreateMutex=0x000233bd
--define_symbol xQueueCreateMutexStatic=0x000233d3
--define_symbol xQueueCreateSet=0x000233ed
--define_symbol xQueueGenericCreate=0x000233f5
--define_symbol xQueueGenericCreateStatic=0x00023441
--define_symbol xQueueGenericReset=0x000234a9
--define_symbol xQueueGenericSend=0x00023535
--define_symbol xQueueGenericSendFromISR=0x000236a1
--define_symbol xQueueGiveFromISR=0x00023761
--define_symbol xQueueGiveMutexRecursive=0x00023805
--define_symbol xQueueIsQueueEmptyFromISR=0x00023845
--define_symbol xQueueIsQueueFullFromISR=0x00023869
--define_symbol xQueuePeek=0x00023891
--define_symbol xQueuePeekFromISR=0x000239b9
--define_symbol xQueueReceive=0x00023a25
--define_symbol xQueueReceiveFromISR=0x00023b51
--define_symbol xQueueRemoveFromSet=0x00023be5
--define_symbol xQueueSelectFromSet=0x00023c07
--define_symbol xQueueSelectFromSetFromISR=0x00023c19
--define_symbol xQueueSemaphoreTake=0x00023c2d
--define_symbol xQueueTakeMutexRecursive=0x00023d99
--define_symbol xTaskCheckForTimeOut=0x00023ddd
--define_symbol xTaskCreate=0x00023e4d
--define_symbol xTaskCreateStatic=0x00023ea9
--define_symbol xTaskGetCurrentTaskHandle=0x00023f19
--define_symbol xTaskGetSchedulerState=0x00023f25
--define_symbol xTaskGetTickCount=0x00023f41
--define_symbol xTaskGetTickCountFromISR=0x00023f4d
--define_symbol xTaskIncrementTick=0x00023f5d
--define_symbol xTaskPriorityDisinherit=0x00024029
--define_symbol xTaskPriorityInherit=0x000240bd
--define_symbol xTaskRemoveFromEventList=0x00024151
--define_symbol xTaskResumeAll=0x000241d1
--define_symbol xTimerCreate=0x00024299
--define_symbol xTimerCreateStatic=0x000242cd
--define_symbol xTimerCreateTimerTask=0x00024305
--define_symbol xTimerGenericCommand=0x00024371
--define_symbol xTimerGetExpiryTime=0x000243e1
