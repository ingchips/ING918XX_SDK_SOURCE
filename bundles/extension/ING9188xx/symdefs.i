...
--define_symbol nibble_for_char=0x0001eae5
--define_symbol platform_32k_rc_auto_tune=0x0001eb81
--define_symbol platform_32k_rc_tune=0x0001ebfd
--define_symbol platform_calibrate_32k=0x0001ec11
--define_symbol platform_config=0x0001ec15
--define_symbol platform_get_heap_status=0x0001ecd5
--define_symbol platform_get_us_time=0x0001eced
--define_symbol platform_get_version=0x0001ecf1
--define_symbol platform_hrng=0x0001ecf9
--define_symbol platform_install_isr_stack=0x0001ed01
--define_symbol platform_patch_rf_init_data=0x0001ed0d
--define_symbol platform_printf=0x0001ed19
--define_symbol platform_raise_assertion=0x0001ed2d
--define_symbol platform_rand=0x0001ed41
--define_symbol platform_read_info=0x0001ed45
--define_symbol platform_read_persistent_reg=0x0001ed61
--define_symbol platform_reset=0x0001ed71
--define_symbol platform_set_evt_callback=0x0001eda5
--define_symbol platform_set_irq_callback=0x0001edb9
--define_symbol platform_set_rf_clk_source=0x0001edf1
--define_symbol platform_set_rf_init_data=0x0001edfd
--define_symbol platform_set_rf_power_mapping=0x0001ee09
--define_symbol platform_shutdown=0x0001ee15
--define_symbol platform_switch_app=0x0001ee19
--define_symbol platform_trace_raw=0x0001ee45
--define_symbol platform_write_persistent_reg=0x0001ee5d
--define_symbol printf_hexdump=0x0001ee6d
--define_symbol pvPortMalloc=0x0001f975
--define_symbol pvTaskIncrementMutexHeldCount=0x0001fa5d
--define_symbol pvTimerGetTimerID=0x0001fa75
--define_symbol pxPortInitialiseStack=0x0001faa1
--define_symbol reverse_128=0x0001fc81
--define_symbol reverse_24=0x0001fc87
--define_symbol reverse_48=0x0001fc8d
--define_symbol reverse_56=0x0001fc93
--define_symbol reverse_64=0x0001fc99
--define_symbol reverse_bd_addr=0x0001fc9f
--define_symbol reverse_bytes=0x0001fca5
--define_symbol sm_add_event_handler=0x0001ff65
--define_symbol sm_address_resolution_lookup=0x000200bd
--define_symbol sm_authenticated=0x00020409
--define_symbol sm_authorization_decline=0x00020417
--define_symbol sm_authorization_grant=0x00020437
--define_symbol sm_authorization_state=0x00020457
--define_symbol sm_bonding_decline=0x00020471
--define_symbol sm_config=0x00020891
--define_symbol sm_config_conn=0x000208a9
--define_symbol sm_encryption_key_size=0x00020a2f
--define_symbol sm_just_works_confirm=0x00020f5d
--define_symbol sm_le_device_key=0x00021299
--define_symbol sm_passkey_input=0x0002132f
--define_symbol sm_private_random_address_generation_get=0x000216d5
--define_symbol sm_private_random_address_generation_get_mode=0x000216dd
--define_symbol sm_private_random_address_generation_set_mode=0x000216e9
--define_symbol sm_private_random_address_generation_set_update_period=0x00021711
--define_symbol sm_register_oob_data_callback=0x0002184d
--define_symbol sm_request_pairing=0x00021859
--define_symbol sm_send_security_request=0x00022253
--define_symbol sm_set_accepted_stk_generation_methods=0x00022279
--define_symbol sm_set_authentication_requirements=0x00022285
--define_symbol sm_set_encryption_key_size_range=0x00022291
--define_symbol sscanf_bd_addr=0x000225ed
--define_symbol sysSetPublicDeviceAddr=0x00022955
--define_symbol uuid128_to_str=0x000230d9
--define_symbol uuid_add_bluetooth_prefix=0x00023131
--define_symbol uuid_has_bluetooth_prefix=0x00023151
--define_symbol uxListRemove=0x0002316d
--define_symbol uxQueueMessagesWaiting=0x00023195
--define_symbol uxQueueMessagesWaitingFromISR=0x000231bd
--define_symbol uxQueueSpacesAvailable=0x000231d9
--define_symbol uxTaskGetStackHighWaterMark=0x00023205
--define_symbol vListInitialise=0x000232ab
--define_symbol vListInitialiseItem=0x000232c1
--define_symbol vListInsert=0x000232c7
--define_symbol vListInsertEnd=0x000232f7
--define_symbol vPortEnterCritical=0x00023311
--define_symbol vPortExitCritical=0x00023355
--define_symbol vPortFree=0x00023385
--define_symbol vPortSuppressTicksAndSleep=0x00023419
--define_symbol vPortValidateInterruptPriority=0x00023539
--define_symbol vQueueDelete=0x00023591
--define_symbol vQueueWaitForMessageRestricted=0x000235bd
--define_symbol vTaskDelay=0x00023605
--define_symbol vTaskInternalSetTimeOutState=0x00023651
--define_symbol vTaskMissedYield=0x00023661
--define_symbol vTaskPlaceOnEventList=0x0002366d
--define_symbol vTaskPlaceOnEventListRestricted=0x000236a5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000236e5
--define_symbol vTaskResume=0x00023791
--define_symbol vTaskStartScheduler=0x00023815
--define_symbol vTaskStepTick=0x000238a5
--define_symbol vTaskSuspend=0x000238d5
--define_symbol vTaskSuspendAll=0x00023991
--define_symbol vTaskSwitchContext=0x000239a1
--define_symbol xPortStartScheduler=0x00023a49
--define_symbol xQueueAddToSet=0x00023b0d
--define_symbol xQueueCreateCountingSemaphore=0x00023b31
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023b6d
--define_symbol xQueueCreateMutex=0x00023bb1
--define_symbol xQueueCreateMutexStatic=0x00023bc7
--define_symbol xQueueCreateSet=0x00023be1
--define_symbol xQueueGenericCreate=0x00023be9
--define_symbol xQueueGenericCreateStatic=0x00023c35
--define_symbol xQueueGenericReset=0x00023c9d
--define_symbol xQueueGenericSend=0x00023d29
--define_symbol xQueueGenericSendFromISR=0x00023e95
--define_symbol xQueueGiveFromISR=0x00023f55
--define_symbol xQueueGiveMutexRecursive=0x00023ff9
--define_symbol xQueueIsQueueEmptyFromISR=0x00024039
--define_symbol xQueueIsQueueFullFromISR=0x0002405d
--define_symbol xQueuePeek=0x00024085
--define_symbol xQueuePeekFromISR=0x000241ad
--define_symbol xQueueReceive=0x00024219
--define_symbol xQueueReceiveFromISR=0x00024345
--define_symbol xQueueRemoveFromSet=0x000243d9
--define_symbol xQueueSelectFromSet=0x000243fb
--define_symbol xQueueSelectFromSetFromISR=0x0002440d
--define_symbol xQueueSemaphoreTake=0x00024421
--define_symbol xQueueTakeMutexRecursive=0x0002458d
--define_symbol xTaskCheckForTimeOut=0x000245d1
--define_symbol xTaskCreate=0x00024641
--define_symbol xTaskCreateStatic=0x0002469d
--define_symbol xTaskGetCurrentTaskHandle=0x0002470d
--define_symbol xTaskGetSchedulerState=0x00024719
--define_symbol xTaskGetTickCount=0x00024735
--define_symbol xTaskGetTickCountFromISR=0x00024741
--define_symbol xTaskIncrementTick=0x00024751
--define_symbol xTaskPriorityDisinherit=0x0002481d
--define_symbol xTaskPriorityInherit=0x000248b1
--define_symbol xTaskRemoveFromEventList=0x00024945
--define_symbol xTaskResumeAll=0x000249c5
--define_symbol xTaskResumeFromISR=0x00024a8d
--define_symbol xTimerCreate=0x00024b19
--define_symbol xTimerCreateStatic=0x00024b4d
--define_symbol xTimerCreateTimerTask=0x00024b85
--define_symbol xTimerGenericCommand=0x00024bf1
--define_symbol xTimerGetExpiryTime=0x00024c61
