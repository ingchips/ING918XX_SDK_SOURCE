...
nibble_for_char = 0x0001e92d;
platform_32k_rc_auto_tune = 0x0001e9c9;
platform_32k_rc_tune = 0x0001ea45;
platform_calibrate_32k = 0x0001ea59;
platform_config = 0x0001ea5d;
platform_get_heap_status = 0x0001eb15;
...
platform_patch_rf_init_data = 0x0001eb4d;
platform_printf = 0x0001eb59;
platform_raise_assertion = 0x0001eb6d;
platform_rand = 0x0001eb81;
platform_read_info = 0x0001eb85;
platform_read_persistent_reg = 0x0001eba1;
platform_reset = 0x0001ebb1;
platform_set_evt_callback = 0x0001ebe5;
platform_set_irq_callback = 0x0001ebf9;
platform_set_rf_clk_source = 0x0001ec31;
platform_set_rf_init_data = 0x0001ec3d;
platform_set_rf_power_mapping = 0x0001ec49;
platform_shutdown = 0x0001ec55;
platform_switch_app = 0x0001ec59;
platform_trace_raw = 0x0001ec85;
platform_write_persistent_reg = 0x0001ec99;
printf_hexdump = 0x0001eca9;
pvPortMalloc = 0x0001f775;
pvTaskIncrementMutexHeldCount = 0x0001f85d;
pvTimerGetTimerID = 0x0001f875;
pxPortInitialiseStack = 0x0001f8a1;
reverse_128 = 0x0001fa81;
reverse_24 = 0x0001fa87;
reverse_48 = 0x0001fa8d;
reverse_56 = 0x0001fa93;
reverse_64 = 0x0001fa99;
reverse_bd_addr = 0x0001fa9f;
reverse_bytes = 0x0001faa5;
sm_add_event_handler = 0x0001fd65;
sm_address_resolution_lookup = 0x0001fe91;
sm_authenticated = 0x000201dd;
sm_authorization_decline = 0x000201eb;
sm_authorization_grant = 0x0002020b;
sm_authorization_state = 0x0002022b;
sm_bonding_decline = 0x00020245;
sm_config = 0x00020611;
sm_config_conn = 0x00020629;
sm_encryption_key_size = 0x00020787;
sm_just_works_confirm = 0x00020bad;
sm_le_device_key = 0x00020dd9;
sm_passkey_input = 0x00020e6f;
sm_private_random_address_generation_get = 0x000211b5;
sm_private_random_address_generation_get_mode = 0x000211bd;
sm_private_random_address_generation_set_mode = 0x000211c9;
sm_private_random_address_generation_set_update_period = 0x000211f1;
sm_register_oob_data_callback = 0x0002132d;
sm_request_pairing = 0x00021339;
sm_send_security_request = 0x00021c77;
sm_set_accepted_stk_generation_methods = 0x00021c9d;
sm_set_authentication_requirements = 0x00021ca9;
sm_set_encryption_key_size_range = 0x00021cb5;
sscanf_bd_addr = 0x00021f89;
sysSetPublicDeviceAddr = 0x000222cd;
uuid128_to_str = 0x00022a05;
uuid_add_bluetooth_prefix = 0x00022a5d;
uuid_has_bluetooth_prefix = 0x00022a7d;
uxQueueMessagesWaiting = 0x00022ac1;
uxQueueMessagesWaitingFromISR = 0x00022ae9;
uxQueueSpacesAvailable = 0x00022b05;
uxTaskGetStackHighWaterMark = 0x00022b31;
vPortEnterCritical = 0x00022c55;
vPortExitCritical = 0x00022c95;
vPortFree = 0x00022cc1;
vPortSuppressTicksAndSleep = 0x00022d55;
vPortValidateInterruptPriority = 0x00022e2d;
vQueueDelete = 0x00022e81;
vQueueWaitForMessageRestricted = 0x00022ead;
vTaskDelay = 0x00022ef5;
vTaskInternalSetTimeOutState = 0x00022f41;
vTaskMissedYield = 0x00022f51;
vTaskPlaceOnEventList = 0x00022f5d;
vTaskPlaceOnEventListRestricted = 0x00022f95;
vTaskPriorityDisinheritAfterTimeout = 0x00022fd5;
vTaskStartScheduler = 0x00023081;
vTaskStepTick = 0x00023111;
vTaskSuspendAll = 0x00023141;
vTaskSwitchContext = 0x00023151;
xPortStartScheduler = 0x000231f9;
xQueueAddToSet = 0x000232b5;
xQueueCreateCountingSemaphore = 0x000232d9;
xQueueCreateCountingSemaphoreStatic = 0x00023315;
xQueueCreateMutex = 0x00023359;
xQueueCreateMutexStatic = 0x0002336f;
xQueueCreateSet = 0x00023389;
xQueueGenericCreate = 0x00023391;
xQueueGenericCreateStatic = 0x000233dd;
xQueueGenericReset = 0x00023445;
xQueueGenericSend = 0x000234d1;
xQueueGenericSendFromISR = 0x0002363d;
xQueueGiveFromISR = 0x000236fd;
xQueueGiveMutexRecursive = 0x000237a1;
xQueueIsQueueEmptyFromISR = 0x000237e1;
xQueueIsQueueFullFromISR = 0x00023805;
xQueuePeek = 0x0002382d;
xQueuePeekFromISR = 0x00023955;
xQueueReceive = 0x000239c1;
xQueueReceiveFromISR = 0x00023aed;
xQueueRemoveFromSet = 0x00023b81;
xQueueSelectFromSet = 0x00023ba3;
xQueueSelectFromSetFromISR = 0x00023bb5;
xQueueSemaphoreTake = 0x00023bc9;
xQueueTakeMutexRecursive = 0x00023d35;
xTaskCheckForTimeOut = 0x00023d79;
xTaskCreate = 0x00023de9;
xTaskCreateStatic = 0x00023e45;
xTaskGetCurrentTaskHandle = 0x00023eb5;
xTaskGetSchedulerState = 0x00023ec1;
xTaskGetTickCount = 0x00023edd;
xTaskGetTickCountFromISR = 0x00023ee9;
xTaskIncrementTick = 0x00023ef9;
xTaskPriorityDisinherit = 0x00023fc5;
xTaskPriorityInherit = 0x00024059;
xTaskRemoveFromEventList = 0x000240ed;
xTaskResumeAll = 0x0002416d;
xTimerCreate = 0x00024235;
xTimerCreateStatic = 0x00024269;
xTimerCreateTimerTask = 0x000242a1;
xTimerGenericCommand = 0x0002430d;
xTimerGetExpiryTime = 0x0002437d;
