...
ll_free = 0x0000d4a7;
ll_hint_on_ce_len = 0x0000d4b1;
ll_legacy_adv_set_interval = 0x0000d4f1;
ll_malloc = 0x0000d501;
ll_query_timing_info = 0x0000d639;
ll_raw_packet_alloc = 0x0000d685;
ll_raw_packet_free = 0x0000d739;
ll_raw_packet_get_iq_samples = 0x0000d763;
ll_raw_packet_get_rx_data = 0x0000d7fd;
ll_raw_packet_recv = 0x0000d895;
ll_raw_packet_send = 0x0000d929;
ll_raw_packet_set_param = 0x0000d999;
ll_raw_packet_set_rx_cte = 0x0000d9ff;
ll_raw_packet_set_tx_cte = 0x0000da95;
ll_raw_packet_set_tx_data = 0x0000dad3;
ll_scan_set_fixed_channel = 0x0000db95;
ll_set_adv_access_address = 0x0000dca9;
ll_set_adv_coded_scheme = 0x0000dcb5;
ll_set_conn_coded_scheme = 0x0000dce5;
ll_set_conn_latency = 0x0000dd11;
ll_set_conn_tx_power = 0x0000dd41;
ll_set_def_antenna = 0x0000dd89;
ll_set_initiating_coded_scheme = 0x0000dda5;
ll_set_max_conn_number = 0x0000ddb1;
nibble_for_char = 0x0001ea4d;
platform_32k_rc_auto_tune = 0x0001eae9;
platform_32k_rc_tune = 0x0001eb65;
platform_calibrate_32k = 0x0001eb79;
platform_config = 0x0001eb7d;
platform_get_heap_status = 0x0001ec3d;
platform_get_us_time = 0x0001ec55;
platform_get_version = 0x0001ec59;
platform_hrng = 0x0001ec61;
platform_install_isr_stack = 0x0001ec69;
platform_patch_rf_init_data = 0x0001ec75;
platform_printf = 0x0001ec81;
platform_raise_assertion = 0x0001ec95;
platform_rand = 0x0001eca9;
platform_read_info = 0x0001ecad;
platform_read_persistent_reg = 0x0001ecc9;
platform_reset = 0x0001ecd9;
platform_set_evt_callback = 0x0001ed0d;
platform_set_irq_callback = 0x0001ed21;
platform_set_rf_clk_source = 0x0001ed59;
platform_set_rf_init_data = 0x0001ed65;
platform_set_rf_power_mapping = 0x0001ed71;
platform_shutdown = 0x0001ed7d;
platform_switch_app = 0x0001ed81;
platform_trace_raw = 0x0001edad;
platform_write_persistent_reg = 0x0001edc5;
printf_hexdump = 0x0001edd5;
pvPortMalloc = 0x0001f8dd;
pvTaskIncrementMutexHeldCount = 0x0001f9c5;
pvTimerGetTimerID = 0x0001f9dd;
pxPortInitialiseStack = 0x0001fa09;
reverse_128 = 0x0001fbe9;
reverse_24 = 0x0001fbef;
reverse_48 = 0x0001fbf5;
reverse_56 = 0x0001fbfb;
reverse_64 = 0x0001fc01;
reverse_bd_addr = 0x0001fc07;
reverse_bytes = 0x0001fc0d;
sm_add_event_handler = 0x0001fecd;
sm_address_resolution_lookup = 0x00020025;
sm_authenticated = 0x00020371;
sm_authorization_decline = 0x0002037f;
sm_authorization_grant = 0x0002039f;
sm_authorization_state = 0x000203bf;
sm_bonding_decline = 0x000203d9;
sm_config = 0x000207f9;
sm_config_conn = 0x00020811;
sm_encryption_key_size = 0x00020997;
sm_just_works_confirm = 0x00020ec5;
sm_le_device_key = 0x00021201;
sm_passkey_input = 0x00021297;
sm_private_random_address_generation_get = 0x0002163d;
sm_private_random_address_generation_get_mode = 0x00021645;
sm_private_random_address_generation_set_mode = 0x00021651;
sm_private_random_address_generation_set_update_period = 0x00021679;
sm_register_oob_data_callback = 0x000217b5;
sm_request_pairing = 0x000217c1;
sm_send_security_request = 0x000221bb;
sm_set_accepted_stk_generation_methods = 0x000221e1;
sm_set_authentication_requirements = 0x000221ed;
sm_set_encryption_key_size_range = 0x000221f9;
sscanf_bd_addr = 0x00022555;
sysSetPublicDeviceAddr = 0x000228bd;
uuid128_to_str = 0x00023041;
uuid_add_bluetooth_prefix = 0x00023099;
uuid_has_bluetooth_prefix = 0x000230b9;
uxQueueMessagesWaiting = 0x000230fd;
uxQueueMessagesWaitingFromISR = 0x00023125;
uxQueueSpacesAvailable = 0x00023141;
uxTaskGetStackHighWaterMark = 0x0002316d;
vPortEnterCritical = 0x00023279;
vPortExitCritical = 0x000232bd;
vPortFree = 0x000232ed;
vPortSuppressTicksAndSleep = 0x00023381;
vPortValidateInterruptPriority = 0x000234a1;
vQueueDelete = 0x000234f9;
vQueueWaitForMessageRestricted = 0x00023525;
vTaskDelay = 0x0002356d;
vTaskInternalSetTimeOutState = 0x000235b9;
vTaskMissedYield = 0x000235c9;
vTaskPlaceOnEventList = 0x000235d5;
vTaskPlaceOnEventListRestricted = 0x0002360d;
vTaskPriorityDisinheritAfterTimeout = 0x0002364d;
vTaskResume = 0x000236f9;
vTaskStartScheduler = 0x0002377d;
vTaskStepTick = 0x0002380d;
vTaskSuspend = 0x0002383d;
vTaskSuspendAll = 0x000238f9;
vTaskSwitchContext = 0x00023909;
xPortStartScheduler = 0x000239b1;
xQueueAddToSet = 0x00023a75;
xQueueCreateCountingSemaphore = 0x00023a99;
xQueueCreateCountingSemaphoreStatic = 0x00023ad5;
xQueueCreateMutex = 0x00023b19;
xQueueCreateMutexStatic = 0x00023b2f;
xQueueCreateSet = 0x00023b49;
xQueueGenericCreate = 0x00023b51;
xQueueGenericCreateStatic = 0x00023b9d;
xQueueGenericReset = 0x00023c05;
xQueueGenericSend = 0x00023c91;
xQueueGenericSendFromISR = 0x00023dfd;
xQueueGiveFromISR = 0x00023ebd;
xQueueGiveMutexRecursive = 0x00023f61;
xQueueIsQueueEmptyFromISR = 0x00023fa1;
xQueueIsQueueFullFromISR = 0x00023fc5;
xQueuePeek = 0x00023fed;
xQueuePeekFromISR = 0x00024115;
xQueueReceive = 0x00024181;
xQueueReceiveFromISR = 0x000242ad;
xQueueRemoveFromSet = 0x00024341;
xQueueSelectFromSet = 0x00024363;
xQueueSelectFromSetFromISR = 0x00024375;
xQueueSemaphoreTake = 0x00024389;
xQueueTakeMutexRecursive = 0x000244f5;
xTaskCheckForTimeOut = 0x00024539;
xTaskCreate = 0x000245a9;
xTaskCreateStatic = 0x00024605;
xTaskGetCurrentTaskHandle = 0x00024675;
xTaskGetSchedulerState = 0x00024681;
xTaskGetTickCount = 0x0002469d;
xTaskGetTickCountFromISR = 0x000246a9;
xTaskIncrementTick = 0x000246b9;
xTaskPriorityDisinherit = 0x00024785;
xTaskPriorityInherit = 0x00024819;
xTaskRemoveFromEventList = 0x000248ad;
xTaskResumeAll = 0x0002492d;
xTaskResumeFromISR = 0x000249f5;
xTimerCreate = 0x00024a81;
xTimerCreateStatic = 0x00024ab5;
xTimerCreateTimerTask = 0x00024aed;
xTimerGenericCommand = 0x00024b59;
xTimerGetExpiryTime = 0x00024bc9;
