...
nibble_for_char = 0x0001ead9;
platform_32k_rc_auto_tune = 0x0001eb75;
platform_32k_rc_tune = 0x0001ebf1;
platform_calibrate_32k = 0x0001ec05;
platform_config = 0x0001ec09;
platform_get_heap_status = 0x0001ecc9;
platform_get_us_time = 0x0001ece1;
platform_get_version = 0x0001ece5;
platform_hrng = 0x0001eced;
platform_install_isr_stack = 0x0001ecf5;
platform_patch_rf_init_data = 0x0001ed01;
platform_printf = 0x0001ed0d;
platform_raise_assertion = 0x0001ed21;
platform_rand = 0x0001ed35;
platform_read_info = 0x0001ed39;
platform_read_persistent_reg = 0x0001ed55;
platform_reset = 0x0001ed65;
platform_set_evt_callback = 0x0001ed99;
platform_set_irq_callback = 0x0001edad;
platform_set_rf_clk_source = 0x0001ede5;
platform_set_rf_init_data = 0x0001edf1;
platform_set_rf_power_mapping = 0x0001edfd;
platform_shutdown = 0x0001ee09;
platform_switch_app = 0x0001ee0d;
platform_trace_raw = 0x0001ee39;
platform_write_persistent_reg = 0x0001ee51;
printf_hexdump = 0x0001ee61;
pvPortMalloc = 0x0001f969;
pvTaskIncrementMutexHeldCount = 0x0001fa51;
pvTimerGetTimerID = 0x0001fa69;
pxPortInitialiseStack = 0x0001fa95;
reverse_128 = 0x0001fc75;
reverse_24 = 0x0001fc7b;
reverse_48 = 0x0001fc81;
reverse_56 = 0x0001fc87;
reverse_64 = 0x0001fc8d;
reverse_bd_addr = 0x0001fc93;
reverse_bytes = 0x0001fc99;
sm_add_event_handler = 0x0001ff59;
sm_address_resolution_lookup = 0x000200b1;
sm_authenticated = 0x000203fd;
sm_authorization_decline = 0x0002040b;
sm_authorization_grant = 0x0002042b;
sm_authorization_state = 0x0002044b;
sm_bonding_decline = 0x00020465;
sm_config = 0x00020885;
sm_config_conn = 0x0002089d;
sm_encryption_key_size = 0x00020a23;
sm_just_works_confirm = 0x00020f51;
sm_le_device_key = 0x0002128d;
sm_passkey_input = 0x00021323;
sm_private_random_address_generation_get = 0x000216c9;
sm_private_random_address_generation_get_mode = 0x000216d1;
sm_private_random_address_generation_set_mode = 0x000216dd;
sm_private_random_address_generation_set_update_period = 0x00021705;
sm_register_oob_data_callback = 0x00021841;
sm_request_pairing = 0x0002184d;
sm_send_security_request = 0x00022247;
sm_set_accepted_stk_generation_methods = 0x0002226d;
sm_set_authentication_requirements = 0x00022279;
sm_set_encryption_key_size_range = 0x00022285;
sscanf_bd_addr = 0x000225e1;
sysSetPublicDeviceAddr = 0x00022949;
uuid128_to_str = 0x000230cd;
uuid_add_bluetooth_prefix = 0x00023125;
uuid_has_bluetooth_prefix = 0x00023145;
uxListRemove = 0x00023161;
uxQueueMessagesWaiting = 0x00023189;
uxQueueMessagesWaitingFromISR = 0x000231b1;
uxQueueSpacesAvailable = 0x000231cd;
uxTaskGetStackHighWaterMark = 0x000231f9;
vListInitialise = 0x0002329f;
vListInitialiseItem = 0x000232b5;
vListInsert = 0x000232bb;
vListInsertEnd = 0x000232eb;
vPortEnterCritical = 0x00023305;
vPortExitCritical = 0x00023349;
vPortFree = 0x00023379;
vPortSuppressTicksAndSleep = 0x0002340d;
vPortValidateInterruptPriority = 0x0002352d;
vQueueDelete = 0x00023585;
vQueueWaitForMessageRestricted = 0x000235b1;
vTaskDelay = 0x000235f9;
vTaskInternalSetTimeOutState = 0x00023645;
vTaskMissedYield = 0x00023655;
vTaskPlaceOnEventList = 0x00023661;
vTaskPlaceOnEventListRestricted = 0x00023699;
vTaskPriorityDisinheritAfterTimeout = 0x000236d9;
vTaskResume = 0x00023785;
vTaskStartScheduler = 0x00023809;
vTaskStepTick = 0x00023899;
vTaskSuspend = 0x000238c9;
vTaskSuspendAll = 0x00023985;
vTaskSwitchContext = 0x00023995;
xPortStartScheduler = 0x00023a3d;
xQueueAddToSet = 0x00023b01;
xQueueCreateCountingSemaphore = 0x00023b25;
xQueueCreateCountingSemaphoreStatic = 0x00023b61;
xQueueCreateMutex = 0x00023ba5;
xQueueCreateMutexStatic = 0x00023bbb;
xQueueCreateSet = 0x00023bd5;
xQueueGenericCreate = 0x00023bdd;
xQueueGenericCreateStatic = 0x00023c29;
xQueueGenericReset = 0x00023c91;
xQueueGenericSend = 0x00023d1d;
xQueueGenericSendFromISR = 0x00023e89;
xQueueGiveFromISR = 0x00023f49;
xQueueGiveMutexRecursive = 0x00023fed;
xQueueIsQueueEmptyFromISR = 0x0002402d;
xQueueIsQueueFullFromISR = 0x00024051;
xQueuePeek = 0x00024079;
xQueuePeekFromISR = 0x000241a1;
xQueueReceive = 0x0002420d;
xQueueReceiveFromISR = 0x00024339;
xQueueRemoveFromSet = 0x000243cd;
xQueueSelectFromSet = 0x000243ef;
xQueueSelectFromSetFromISR = 0x00024401;
xQueueSemaphoreTake = 0x00024415;
xQueueTakeMutexRecursive = 0x00024581;
xTaskCheckForTimeOut = 0x000245c5;
xTaskCreate = 0x00024635;
xTaskCreateStatic = 0x00024691;
xTaskGetCurrentTaskHandle = 0x00024701;
xTaskGetSchedulerState = 0x0002470d;
xTaskGetTickCount = 0x00024729;
xTaskGetTickCountFromISR = 0x00024735;
xTaskIncrementTick = 0x00024745;
xTaskPriorityDisinherit = 0x00024811;
xTaskPriorityInherit = 0x000248a5;
xTaskRemoveFromEventList = 0x00024939;
xTaskResumeAll = 0x000249b9;
xTaskResumeFromISR = 0x00024a81;
xTimerCreate = 0x00024b0d;
xTimerCreateStatic = 0x00024b41;
xTimerCreateTimerTask = 0x00024b79;
xTimerGenericCommand = 0x00024be5;
xTimerGetExpiryTime = 0x00024c55;
