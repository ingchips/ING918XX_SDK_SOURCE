...
nibble_for_char = 0x0001e681;
platform_32k_rc_auto_tune = 0x0001e721;
platform_32k_rc_tune = 0x0001e79d;
platform_calibrate_32k = 0x0001e7b1;
platform_config = 0x0001e7b5;
platform_get_heap_status = 0x0001e865;
platform_get_us_time = 0x0001e87d;
platform_get_version = 0x0001e881;
platform_hrng = 0x0001e889;
platform_install_isr_stack = 0x0001e891;
platform_patch_rf_init_data = 0x0001e89d;
platform_printf = 0x0001e8a9;
platform_raise_assertion = 0x0001e8bd;
platform_rand = 0x0001e8d1;
platform_read_info = 0x0001e8d5;
platform_read_persistent_reg = 0x0001e8f1;
platform_reset = 0x0001e901;
platform_set_evt_callback = 0x0001e935;
platform_set_irq_callback = 0x0001e949;
platform_set_rf_clk_source = 0x0001e981;
platform_set_rf_init_data = 0x0001e98d;
platform_set_rf_power_mapping = 0x0001e999;
platform_shutdown = 0x0001e9a5;
platform_switch_app = 0x0001e9a9;
platform_trace_raw = 0x0001e9d5;
platform_write_persistent_reg = 0x0001e9e9;
printf_hexdump = 0x0001e9f9;
pvPortMalloc = 0x0001f4b9;
pvTaskIncrementMutexHeldCount = 0x0001f5a1;
pvTimerGetTimerID = 0x0001f5b9;
pxPortInitialiseStack = 0x0001f5e5;
reverse_128 = 0x0001f7c5;
reverse_24 = 0x0001f7cb;
reverse_48 = 0x0001f7d1;
reverse_56 = 0x0001f7d7;
reverse_64 = 0x0001f7dd;
reverse_bd_addr = 0x0001f7e3;
reverse_bytes = 0x0001f7e9;
sm_add_event_handler = 0x0001fa89;
sm_address_resolution_lookup = 0x0001fbb5;
sm_authenticated = 0x0001fc8f;
sm_authorization_decline = 0x0001fc9d;
sm_authorization_grant = 0x0001fcbd;
sm_authorization_state = 0x0001fcdd;
sm_bonding_decline = 0x0001fcf9;
sm_config = 0x000200d1;
sm_encryption_key_size = 0x000201dd;
sm_just_works_confirm = 0x00020999;
sm_le_device_key = 0x00020be9;
sm_passkey_input = 0x00020c81;
...
sm_register_oob_data_callback = 0x00021081;
sm_request_pairing = 0x0002108d;
sm_send_security_request = 0x00021ac7;
sm_set_accepted_stk_generation_methods = 0x00021aed;
sm_set_authentication_requirements = 0x00021af9;
sm_set_encryption_key_size_range = 0x00021b05;
sscanf_bd_addr = 0x00021e01;
sysSetPublicDeviceAddr = 0x00022165;
uuid128_to_str = 0x00022899;
uuid_add_bluetooth_prefix = 0x000228f1;
uuid_has_bluetooth_prefix = 0x00022911;
uxQueueMessagesWaiting = 0x00022955;
uxQueueMessagesWaitingFromISR = 0x0002297d;
uxQueueSpacesAvailable = 0x00022999;
uxTaskGetStackHighWaterMark = 0x000229c5;
vPortEnterCritical = 0x00022a7d;
vPortExitCritical = 0x00022abd;
vPortFree = 0x00022ae9;
vPortSuppressTicksAndSleep = 0x00022b7d;
vPortValidateInterruptPriority = 0x00022c55;
vQueueDelete = 0x00022ca9;
vQueueWaitForMessageRestricted = 0x00022cd5;
vTaskDelay = 0x00022d1d;
vTaskInternalSetTimeOutState = 0x00022d69;
vTaskMissedYield = 0x00022d79;
vTaskPlaceOnEventList = 0x00022d85;
vTaskPlaceOnEventListRestricted = 0x00022dbd;
vTaskPriorityDisinheritAfterTimeout = 0x00022dfd;
vTaskStartScheduler = 0x00022ea9;
vTaskStepTick = 0x00022f39;
vTaskSuspendAll = 0x00022f69;
vTaskSwitchContext = 0x00022f79;
xPortStartScheduler = 0x00023021;
xQueueAddToSet = 0x000230dd;
xQueueCreateCountingSemaphore = 0x00023101;
xQueueCreateCountingSemaphoreStatic = 0x0002313d;
xQueueCreateMutex = 0x00023181;
xQueueCreateMutexStatic = 0x00023197;
xQueueCreateSet = 0x000231b1;
xQueueGenericCreate = 0x000231b9;
xQueueGenericCreateStatic = 0x00023205;
xQueueGenericReset = 0x0002326d;
xQueueGenericSend = 0x000232f9;
xQueueGenericSendFromISR = 0x00023465;
xQueueGiveFromISR = 0x00023525;
xQueueGiveMutexRecursive = 0x000235c9;
xQueueIsQueueEmptyFromISR = 0x00023609;
xQueueIsQueueFullFromISR = 0x0002362d;
xQueuePeek = 0x00023655;
xQueuePeekFromISR = 0x0002377d;
xQueueReceive = 0x000237e9;
xQueueReceiveFromISR = 0x00023915;
xQueueRemoveFromSet = 0x000239a9;
xQueueSelectFromSet = 0x000239cb;
xQueueSelectFromSetFromISR = 0x000239dd;
xQueueSemaphoreTake = 0x000239f1;
xQueueTakeMutexRecursive = 0x00023b5d;
xTaskCheckForTimeOut = 0x00023ba1;
xTaskCreate = 0x00023c11;
xTaskCreateStatic = 0x00023c6d;
xTaskGetCurrentTaskHandle = 0x00023cdd;
xTaskGetSchedulerState = 0x00023ce9;
xTaskGetTickCount = 0x00023d05;
xTaskGetTickCountFromISR = 0x00023d11;
xTaskIncrementTick = 0x00023d21;
xTaskPriorityDisinherit = 0x00023ded;
xTaskPriorityInherit = 0x00023e81;
xTaskRemoveFromEventList = 0x00023f15;
xTaskResumeAll = 0x00023f95;
xTimerCreate = 0x0002405d;
xTimerCreateStatic = 0x00024091;
xTimerCreateTimerTask = 0x000240c9;
xTimerGenericCommand = 0x00024135;
xTimerGetExpiryTime = 0x000241a5;
