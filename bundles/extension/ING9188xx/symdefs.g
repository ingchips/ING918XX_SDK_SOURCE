...
nibble_for_char = 0x0001e991;
platform_32k_rc_auto_tune = 0x0001ea2d;
platform_32k_rc_tune = 0x0001eaa9;
platform_calibrate_32k = 0x0001eabd;
platform_config = 0x0001eac1;
platform_get_heap_status = 0x0001eb79;
platform_get_us_time = 0x0001eb91;
platform_get_version = 0x0001eb95;
platform_hrng = 0x0001eb9d;
platform_install_isr_stack = 0x0001eba5;
platform_patch_rf_init_data = 0x0001ebb1;
platform_printf = 0x0001ebbd;
platform_raise_assertion = 0x0001ebd1;
platform_rand = 0x0001ebe5;
platform_read_info = 0x0001ebe9;
platform_read_persistent_reg = 0x0001ec05;
platform_reset = 0x0001ec15;
platform_set_evt_callback = 0x0001ec49;
platform_set_irq_callback = 0x0001ec5d;
platform_set_rf_clk_source = 0x0001ec95;
platform_set_rf_init_data = 0x0001eca1;
platform_set_rf_power_mapping = 0x0001ecad;
platform_shutdown = 0x0001ecb9;
platform_switch_app = 0x0001ecbd;
platform_trace_raw = 0x0001ece9;
platform_write_persistent_reg = 0x0001ecfd;
printf_hexdump = 0x0001ed0d;
pvPortMalloc = 0x0001f7d9;
pvTaskIncrementMutexHeldCount = 0x0001f8c1;
pvTimerGetTimerID = 0x0001f8d9;
pxPortInitialiseStack = 0x0001f905;
reverse_128 = 0x0001fae5;
reverse_24 = 0x0001faeb;
reverse_48 = 0x0001faf1;
reverse_56 = 0x0001faf7;
reverse_64 = 0x0001fafd;
reverse_bd_addr = 0x0001fb03;
reverse_bytes = 0x0001fb09;
sm_add_event_handler = 0x0001fdc9;
sm_address_resolution_lookup = 0x0001fef5;
...
sm_config = 0x00020675;
sm_config_conn = 0x0002068d;
sm_encryption_key_size = 0x000207eb;
sm_just_works_confirm = 0x00020c11;
sm_le_device_key = 0x00020e3d;
sm_passkey_input = 0x00020ed3;
...
sscanf_bd_addr = 0x00021fed;
sysSetPublicDeviceAddr = 0x00022331;
uuid128_to_str = 0x00022a69;
uuid_add_bluetooth_prefix = 0x00022ac1;
uuid_has_bluetooth_prefix = 0x00022ae1;
uxQueueMessagesWaiting = 0x00022b25;
uxQueueMessagesWaitingFromISR = 0x00022b4d;
uxQueueSpacesAvailable = 0x00022b69;
uxTaskGetStackHighWaterMark = 0x00022b95;
vPortEnterCritical = 0x00022cb9;
vPortExitCritical = 0x00022cf9;
vPortFree = 0x00022d25;
vPortSuppressTicksAndSleep = 0x00022db9;
vPortValidateInterruptPriority = 0x00022e91;
vQueueDelete = 0x00022ee5;
vQueueWaitForMessageRestricted = 0x00022f11;
vTaskDelay = 0x00022f59;
vTaskInternalSetTimeOutState = 0x00022fa5;
vTaskMissedYield = 0x00022fb5;
vTaskPlaceOnEventList = 0x00022fc1;
vTaskPlaceOnEventListRestricted = 0x00022ff9;
vTaskPriorityDisinheritAfterTimeout = 0x00023039;
vTaskStartScheduler = 0x000230e5;
vTaskStepTick = 0x00023175;
vTaskSuspendAll = 0x000231a5;
vTaskSwitchContext = 0x000231b5;
xPortStartScheduler = 0x0002325d;
xQueueAddToSet = 0x00023319;
xQueueCreateCountingSemaphore = 0x0002333d;
xQueueCreateCountingSemaphoreStatic = 0x00023379;
xQueueCreateMutex = 0x000233bd;
xQueueCreateMutexStatic = 0x000233d3;
xQueueCreateSet = 0x000233ed;
xQueueGenericCreate = 0x000233f5;
xQueueGenericCreateStatic = 0x00023441;
xQueueGenericReset = 0x000234a9;
xQueueGenericSend = 0x00023535;
xQueueGenericSendFromISR = 0x000236a1;
xQueueGiveFromISR = 0x00023761;
xQueueGiveMutexRecursive = 0x00023805;
xQueueIsQueueEmptyFromISR = 0x00023845;
xQueueIsQueueFullFromISR = 0x00023869;
xQueuePeek = 0x00023891;
xQueuePeekFromISR = 0x000239b9;
xQueueReceive = 0x00023a25;
xQueueReceiveFromISR = 0x00023b51;
xQueueRemoveFromSet = 0x00023be5;
xQueueSelectFromSet = 0x00023c07;
xQueueSelectFromSetFromISR = 0x00023c19;
xQueueSemaphoreTake = 0x00023c2d;
xQueueTakeMutexRecursive = 0x00023d99;
xTaskCheckForTimeOut = 0x00023ddd;
xTaskCreate = 0x00023e4d;
xTaskCreateStatic = 0x00023ea9;
xTaskGetCurrentTaskHandle = 0x00023f19;
xTaskGetSchedulerState = 0x00023f25;
xTaskGetTickCount = 0x00023f41;
xTaskGetTickCountFromISR = 0x00023f4d;
xTaskIncrementTick = 0x00023f5d;
xTaskPriorityDisinherit = 0x00024029;
xTaskPriorityInherit = 0x000240bd;
xTaskRemoveFromEventList = 0x00024151;
xTaskResumeAll = 0x000241d1;
xTimerCreate = 0x00024299;
xTimerCreateStatic = 0x000242cd;
xTimerCreateTimerTask = 0x00024305;
xTimerGenericCommand = 0x00024371;
xTimerGetExpiryTime = 0x000243e1;
