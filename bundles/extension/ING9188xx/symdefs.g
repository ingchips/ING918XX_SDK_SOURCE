...
sysSetPublicDeviceAddr = 0x00022409;
uuid128_to_str = 0x00022b71;
uuid_add_bluetooth_prefix = 0x00022bc9;
uuid_has_bluetooth_prefix = 0x00022be9;
uxQueueMessagesWaiting = 0x00022c2d;
uxQueueMessagesWaitingFromISR = 0x00022c55;
uxQueueSpacesAvailable = 0x00022c71;
uxTaskGetStackHighWaterMark = 0x00022c9d;
vPortEnterCritical = 0x00022dc1;
vPortExitCritical = 0x00022e01;
vPortFree = 0x00022e2d;
vPortSuppressTicksAndSleep = 0x00022ec1;
vPortValidateInterruptPriority = 0x00022f99;
vQueueDelete = 0x00022fed;
vQueueWaitForMessageRestricted = 0x00023019;
vTaskDelay = 0x00023061;
vTaskInternalSetTimeOutState = 0x000230ad;
vTaskMissedYield = 0x000230bd;
vTaskPlaceOnEventList = 0x000230c9;
vTaskPlaceOnEventListRestricted = 0x00023101;
vTaskPriorityDisinheritAfterTimeout = 0x00023141;
vTaskResume = 0x000231ed;
vTaskStartScheduler = 0x00023271;
vTaskStepTick = 0x00023301;
vTaskSuspend = 0x00023331;
vTaskSuspendAll = 0x000233ed;
vTaskSwitchContext = 0x000233fd;
xPortStartScheduler = 0x000234a5;
xQueueAddToSet = 0x00023561;
xQueueCreateCountingSemaphore = 0x00023585;
xQueueCreateCountingSemaphoreStatic = 0x000235c1;
xQueueCreateMutex = 0x00023605;
xQueueCreateMutexStatic = 0x0002361b;
xQueueCreateSet = 0x00023635;
xQueueGenericCreate = 0x0002363d;
xQueueGenericCreateStatic = 0x00023689;
xQueueGenericReset = 0x000236f1;
xQueueGenericSend = 0x0002377d;
xQueueGenericSendFromISR = 0x000238e9;
xQueueGiveFromISR = 0x000239a9;
xQueueGiveMutexRecursive = 0x00023a4d;
xQueueIsQueueEmptyFromISR = 0x00023a8d;
xQueueIsQueueFullFromISR = 0x00023ab1;
xQueuePeek = 0x00023ad9;
xQueuePeekFromISR = 0x00023c01;
xQueueReceive = 0x00023c6d;
xQueueReceiveFromISR = 0x00023d99;
xQueueRemoveFromSet = 0x00023e2d;
xQueueSelectFromSet = 0x00023e4f;
xQueueSelectFromSetFromISR = 0x00023e61;
xQueueSemaphoreTake = 0x00023e75;
xQueueTakeMutexRecursive = 0x00023fe1;
xTaskCheckForTimeOut = 0x00024025;
xTaskCreate = 0x00024095;
xTaskCreateStatic = 0x000240f1;
xTaskGetCurrentTaskHandle = 0x00024161;
xTaskGetSchedulerState = 0x0002416d;
xTaskGetTickCount = 0x00024189;
xTaskGetTickCountFromISR = 0x00024195;
xTaskIncrementTick = 0x000241a5;
xTaskPriorityDisinherit = 0x00024271;
xTaskPriorityInherit = 0x00024305;
xTaskRemoveFromEventList = 0x00024399;
xTaskResumeAll = 0x00024419;
xTaskResumeFromISR = 0x000244e1;
xTimerCreate = 0x0002456d;
xTimerCreateStatic = 0x000245a1;
xTimerCreateTimerTask = 0x000245d9;
xTimerGenericCommand = 0x00024645;
xTimerGetExpiryTime = 0x000246b5;
