...
sysSetPublicDeviceAddr = 0x000205e5;
uuid128_to_str = 0x00020b89;
uuid_add_bluetooth_prefix = 0x00020be1;
uuid_has_bluetooth_prefix = 0x00020c01;
uxQueueMessagesWaiting = 0x00020c45;
uxQueueMessagesWaitingFromISR = 0x00020c6d;
uxQueueSpacesAvailable = 0x00020c89;
uxTaskGetStackHighWaterMark = 0x00020cb5;
vPortEnterCritical = 0x00020d6d;
vPortExitCritical = 0x00020dad;
vPortFree = 0x00020dd9;
vPortSuppressTicksAndSleep = 0x00020e6d;
vPortValidateInterruptPriority = 0x00020f45;
vQueueDelete = 0x00020f99;
vQueueWaitForMessageRestricted = 0x00020fc5;
vTaskDelay = 0x0002100d;
vTaskInternalSetTimeOutState = 0x00021059;
vTaskMissedYield = 0x00021069;
vTaskPlaceOnEventList = 0x00021075;
vTaskPlaceOnEventListRestricted = 0x000210ad;
vTaskPriorityDisinheritAfterTimeout = 0x000210ed;
vTaskStartScheduler = 0x00021199;
vTaskStepTick = 0x00021229;
vTaskSuspendAll = 0x00021259;
vTaskSwitchContext = 0x00021269;
xPortStartScheduler = 0x00021311;
xQueueAddToSet = 0x000213cd;
xQueueCreateCountingSemaphore = 0x000213f1;
xQueueCreateCountingSemaphoreStatic = 0x0002142d;
xQueueCreateMutex = 0x00021471;
xQueueCreateMutexStatic = 0x00021487;
xQueueCreateSet = 0x000214a1;
xQueueGenericCreate = 0x000214a9;
xQueueGenericCreateStatic = 0x000214f5;
xQueueGenericReset = 0x0002155d;
xQueueGenericSend = 0x000215e9;
xQueueGenericSendFromISR = 0x00021755;
xQueueGiveFromISR = 0x00021815;
xQueueGiveMutexRecursive = 0x000218b9;
xQueueIsQueueEmptyFromISR = 0x000218f9;
xQueueIsQueueFullFromISR = 0x0002191d;
xQueuePeek = 0x00021945;
xQueuePeekFromISR = 0x00021a6d;
xQueueReceive = 0x00021ad9;
xQueueReceiveFromISR = 0x00021c05;
xQueueRemoveFromSet = 0x00021c99;
xQueueSelectFromSet = 0x00021cbb;
xQueueSelectFromSetFromISR = 0x00021ccd;
xQueueSemaphoreTake = 0x00021ce1;
xQueueTakeMutexRecursive = 0x00021e4d;
xTaskCheckForTimeOut = 0x00021e91;
xTaskCreate = 0x00021f01;
xTaskCreateStatic = 0x00021f5d;
xTaskGetCurrentTaskHandle = 0x00021fcd;
xTaskGetSchedulerState = 0x00021fd9;
xTaskGetTickCount = 0x00021ff5;
xTaskGetTickCountFromISR = 0x00022001;
xTaskIncrementTick = 0x00022011;
xTaskPriorityDisinherit = 0x000220dd;
xTaskPriorityInherit = 0x00022171;
xTaskRemoveFromEventList = 0x00022205;
xTaskResumeAll = 0x00022285;
xTimerCreate = 0x0002234d;
xTimerCreateStatic = 0x00022381;
xTimerCreateTimerTask = 0x000223b9;
xTimerGenericCommand = 0x00022425;
xTimerGetExpiryTime = 0x00022495;
