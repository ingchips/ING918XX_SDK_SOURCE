...
--define_symbol sysSetPublicDeviceAddr=0x000207d9
--define_symbol uuid128_to_str=0x00020db1
--define_symbol uuid_add_bluetooth_prefix=0x00020e09
--define_symbol uuid_has_bluetooth_prefix=0x00020e29
--define_symbol uxQueueMessagesWaiting=0x00020e6d
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e95
--define_symbol uxQueueSpacesAvailable=0x00020eb1
--define_symbol uxTaskGetStackHighWaterMark=0x00020edd
--define_symbol vPortEnterCritical=0x00021001
--define_symbol vPortExitCritical=0x00021041
--define_symbol vPortFree=0x0002106d
--define_symbol vPortSuppressTicksAndSleep=0x00021101
--define_symbol vPortValidateInterruptPriority=0x000211d9
--define_symbol vQueueDelete=0x0002122d
--define_symbol vQueueWaitForMessageRestricted=0x00021259
--define_symbol vTaskDelay=0x000212a1
--define_symbol vTaskInternalSetTimeOutState=0x000212ed
--define_symbol vTaskMissedYield=0x000212fd
--define_symbol vTaskPlaceOnEventList=0x00021309
--define_symbol vTaskPlaceOnEventListRestricted=0x00021341
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021381
--define_symbol vTaskResume=0x0002142d
--define_symbol vTaskStartScheduler=0x000214b1
--define_symbol vTaskStepTick=0x00021541
--define_symbol vTaskSuspend=0x00021571
--define_symbol vTaskSuspendAll=0x0002162d
--define_symbol vTaskSwitchContext=0x0002163d
--define_symbol xPortStartScheduler=0x000216e5
--define_symbol xQueueAddToSet=0x000217a1
--define_symbol xQueueCreateCountingSemaphore=0x000217c5
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021801
--define_symbol xQueueCreateMutex=0x00021845
--define_symbol xQueueCreateMutexStatic=0x0002185b
--define_symbol xQueueCreateSet=0x00021875
--define_symbol xQueueGenericCreate=0x0002187d
--define_symbol xQueueGenericCreateStatic=0x000218c9
--define_symbol xQueueGenericReset=0x00021931
--define_symbol xQueueGenericSend=0x000219bd
--define_symbol xQueueGenericSendFromISR=0x00021b29
--define_symbol xQueueGiveFromISR=0x00021be9
--define_symbol xQueueGiveMutexRecursive=0x00021c8d
--define_symbol xQueueIsQueueEmptyFromISR=0x00021ccd
--define_symbol xQueueIsQueueFullFromISR=0x00021cf1
--define_symbol xQueuePeek=0x00021d19
--define_symbol xQueuePeekFromISR=0x00021e41
--define_symbol xQueueReceive=0x00021ead
--define_symbol xQueueReceiveFromISR=0x00021fd9
--define_symbol xQueueRemoveFromSet=0x0002206d
--define_symbol xQueueSelectFromSet=0x0002208f
--define_symbol xQueueSelectFromSetFromISR=0x000220a1
--define_symbol xQueueSemaphoreTake=0x000220b5
--define_symbol xQueueTakeMutexRecursive=0x00022221
--define_symbol xTaskCheckForTimeOut=0x00022265
--define_symbol xTaskCreate=0x000222d5
--define_symbol xTaskCreateStatic=0x00022331
--define_symbol xTaskGetCurrentTaskHandle=0x000223a1
--define_symbol xTaskGetSchedulerState=0x000223ad
--define_symbol xTaskGetTickCount=0x000223c9
--define_symbol xTaskGetTickCountFromISR=0x000223d5
--define_symbol xTaskIncrementTick=0x000223e5
--define_symbol xTaskPriorityDisinherit=0x000224b1
--define_symbol xTaskPriorityInherit=0x00022545
--define_symbol xTaskRemoveFromEventList=0x000225d9
--define_symbol xTaskResumeAll=0x00022659
--define_symbol xTaskResumeFromISR=0x00022721
--define_symbol xTimerCreate=0x000227ad
--define_symbol xTimerCreateStatic=0x000227e1
--define_symbol xTimerCreateTimerTask=0x00022819
--define_symbol xTimerGenericCommand=0x00022885
--define_symbol xTimerGetExpiryTime=0x000228f5
