...
--define_symbol nibble_for_char=0x0001d03d
--define_symbol platform_32k_rc_auto_tune=0x0001d0d9
--define_symbol platform_32k_rc_tune=0x0001d155
--define_symbol platform_calibrate_32k=0x0001d169
--define_symbol platform_config=0x0001d16d
--define_symbol platform_get_heap_status=0x0001d22d
--define_symbol platform_get_us_time=0x0001d245
--define_symbol platform_get_version=0x0001d249
--define_symbol platform_hrng=0x0001d251
--define_symbol platform_install_isr_stack=0x0001d259
--define_symbol platform_patch_rf_init_data=0x0001d265
--define_symbol platform_printf=0x0001d271
--define_symbol platform_raise_assertion=0x0001d285
--define_symbol platform_rand=0x0001d299
--define_symbol platform_read_info=0x0001d29d
--define_symbol platform_read_persistent_reg=0x0001d2b9
--define_symbol platform_reset=0x0001d2c9
--define_symbol platform_set_evt_callback=0x0001d2fd
--define_symbol platform_set_irq_callback=0x0001d311
--define_symbol platform_set_rf_clk_source=0x0001d349
--define_symbol platform_set_rf_init_data=0x0001d355
--define_symbol platform_set_rf_power_mapping=0x0001d361
--define_symbol platform_shutdown=0x0001d36d
--define_symbol platform_switch_app=0x0001d371
--define_symbol platform_trace_raw=0x0001d39d
--define_symbol platform_write_persistent_reg=0x0001d3b5
--define_symbol printf_hexdump=0x0001d3c5
--define_symbol pvPortMalloc=0x0001ded1
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dfb9
--define_symbol pvTimerGetTimerID=0x0001dfd1
--define_symbol pxPortInitialiseStack=0x0001dffd
--define_symbol reverse_128=0x0001e1a5
--define_symbol reverse_24=0x0001e1ab
--define_symbol reverse_48=0x0001e1b1
--define_symbol reverse_56=0x0001e1b7
--define_symbol reverse_64=0x0001e1bd
--define_symbol reverse_bd_addr=0x0001e1c3
--define_symbol reverse_bytes=0x0001e1c9
--define_symbol sm_add_event_handler=0x0001e335
--define_symbol sm_address_resolution_lookup=0x0001e48d
--define_symbol sm_authenticated=0x0001e7d9
--define_symbol sm_authorization_decline=0x0001e7e7
--define_symbol sm_authorization_grant=0x0001e807
--define_symbol sm_authorization_state=0x0001e827
--define_symbol sm_bonding_decline=0x0001e841
--define_symbol sm_config=0x0001ec61
--define_symbol sm_config_conn=0x0001ec79
--define_symbol sm_encryption_key_size=0x0001edff
--define_symbol sm_just_works_confirm=0x0001f32d
--define_symbol sm_le_device_key=0x0001f669
--define_symbol sm_passkey_input=0x0001f6ff
--define_symbol sm_private_random_address_generation_get=0x0001faa5
--define_symbol sm_private_random_address_generation_get_mode=0x0001faad
--define_symbol sm_private_random_address_generation_set_mode=0x0001fab9
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fae1
--define_symbol sm_register_oob_data_callback=0x0001fc1d
--define_symbol sm_request_pairing=0x0001fc29
--define_symbol sm_send_security_request=0x00020623
--define_symbol sm_set_accepted_stk_generation_methods=0x00020649
--define_symbol sm_set_authentication_requirements=0x00020655
--define_symbol sm_set_encryption_key_size_range=0x00020661
--define_symbol sscanf_bd_addr=0x000209bd
--define_symbol sysSetPublicDeviceAddr=0x00020d25
--define_symbol uuid128_to_str=0x00021319
--define_symbol uuid_add_bluetooth_prefix=0x00021371
--define_symbol uuid_has_bluetooth_prefix=0x00021391
--define_symbol uxListRemove=0x000213ad
--define_symbol uxQueueMessagesWaiting=0x000213d5
--define_symbol uxQueueMessagesWaitingFromISR=0x000213fd
--define_symbol uxQueueSpacesAvailable=0x00021419
--define_symbol uxTaskGetStackHighWaterMark=0x00021445
--define_symbol vListInitialise=0x000214eb
--define_symbol vListInitialiseItem=0x00021501
--define_symbol vListInsert=0x00021507
--define_symbol vListInsertEnd=0x00021537
--define_symbol vPortEnterCritical=0x00021551
--define_symbol vPortExitCritical=0x00021595
--define_symbol vPortFree=0x000215c5
--define_symbol vPortSuppressTicksAndSleep=0x00021659
--define_symbol vPortValidateInterruptPriority=0x00021779
--define_symbol vQueueDelete=0x000217d1
--define_symbol vQueueWaitForMessageRestricted=0x000217fd
--define_symbol vTaskDelay=0x00021845
--define_symbol vTaskInternalSetTimeOutState=0x00021891
--define_symbol vTaskMissedYield=0x000218a1
--define_symbol vTaskPlaceOnEventList=0x000218ad
--define_symbol vTaskPlaceOnEventListRestricted=0x000218e5
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021925
--define_symbol vTaskResume=0x000219d1
--define_symbol vTaskStartScheduler=0x00021a55
--define_symbol vTaskStepTick=0x00021ae5
--define_symbol vTaskSuspend=0x00021b15
--define_symbol vTaskSuspendAll=0x00021bd1
--define_symbol vTaskSwitchContext=0x00021be1
--define_symbol xPortStartScheduler=0x00021c89
--define_symbol xQueueAddToSet=0x00021d4d
--define_symbol xQueueCreateCountingSemaphore=0x00021d71
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021dad
--define_symbol xQueueCreateMutex=0x00021df1
--define_symbol xQueueCreateMutexStatic=0x00021e07
--define_symbol xQueueCreateSet=0x00021e21
--define_symbol xQueueGenericCreate=0x00021e29
--define_symbol xQueueGenericCreateStatic=0x00021e75
--define_symbol xQueueGenericReset=0x00021edd
--define_symbol xQueueGenericSend=0x00021f69
--define_symbol xQueueGenericSendFromISR=0x000220d5
--define_symbol xQueueGiveFromISR=0x00022195
--define_symbol xQueueGiveMutexRecursive=0x00022239
--define_symbol xQueueIsQueueEmptyFromISR=0x00022279
--define_symbol xQueueIsQueueFullFromISR=0x0002229d
--define_symbol xQueuePeek=0x000222c5
--define_symbol xQueuePeekFromISR=0x000223ed
--define_symbol xQueueReceive=0x00022459
--define_symbol xQueueReceiveFromISR=0x00022585
--define_symbol xQueueRemoveFromSet=0x00022619
--define_symbol xQueueSelectFromSet=0x0002263b
--define_symbol xQueueSelectFromSetFromISR=0x0002264d
--define_symbol xQueueSemaphoreTake=0x00022661
--define_symbol xQueueTakeMutexRecursive=0x000227cd
--define_symbol xTaskCheckForTimeOut=0x00022811
--define_symbol xTaskCreate=0x00022881
--define_symbol xTaskCreateStatic=0x000228dd
--define_symbol xTaskGetCurrentTaskHandle=0x0002294d
--define_symbol xTaskGetSchedulerState=0x00022959
--define_symbol xTaskGetTickCount=0x00022975
--define_symbol xTaskGetTickCountFromISR=0x00022981
--define_symbol xTaskIncrementTick=0x00022991
--define_symbol xTaskPriorityDisinherit=0x00022a5d
--define_symbol xTaskPriorityInherit=0x00022af1
--define_symbol xTaskRemoveFromEventList=0x00022b85
--define_symbol xTaskResumeAll=0x00022c05
--define_symbol xTaskResumeFromISR=0x00022ccd
--define_symbol xTimerCreate=0x00022d59
--define_symbol xTimerCreateStatic=0x00022d8d
--define_symbol xTimerCreateTimerTask=0x00022dc5
--define_symbol xTimerGenericCommand=0x00022e31
--define_symbol xTimerGetExpiryTime=0x00022ea1
