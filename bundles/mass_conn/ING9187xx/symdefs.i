...
--define_symbol nibble_for_char=0x0001cc89
--define_symbol platform_32k_rc_auto_tune=0x0001cd29
--define_symbol platform_32k_rc_tune=0x0001cda5
--define_symbol platform_calibrate_32k=0x0001cdb9
--define_symbol platform_config=0x0001cdbd
--define_symbol platform_get_heap_status=0x0001ce6d
--define_symbol platform_get_us_time=0x0001ce85
--define_symbol platform_get_version=0x0001ce89
--define_symbol platform_hrng=0x0001ce91
--define_symbol platform_install_isr_stack=0x0001ce99
--define_symbol platform_patch_rf_init_data=0x0001cea5
...
--define_symbol platform_read_persistent_reg=0x0001cef9
--define_symbol platform_reset=0x0001cf09
--define_symbol platform_set_evt_callback=0x0001cf3d
--define_symbol platform_set_irq_callback=0x0001cf51
...
--define_symbol platform_shutdown=0x0001cfad
--define_symbol platform_switch_app=0x0001cfb1
--define_symbol platform_trace_raw=0x0001cfdd
--define_symbol platform_write_persistent_reg=0x0001cff1
--define_symbol printf_hexdump=0x0001d001
--define_symbol pvPortMalloc=0x0001dac5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dbad
--define_symbol pvTimerGetTimerID=0x0001dbc5
--define_symbol pxPortInitialiseStack=0x0001dbf1
--define_symbol reverse_128=0x0001dd99
--define_symbol reverse_24=0x0001dd9f
--define_symbol reverse_48=0x0001dda5
--define_symbol reverse_56=0x0001ddab
--define_symbol reverse_64=0x0001ddb1
--define_symbol reverse_bd_addr=0x0001ddb7
--define_symbol reverse_bytes=0x0001ddbd
...
--define_symbol sysSetPublicDeviceAddr=0x000205d1
--define_symbol uuid128_to_str=0x00020b75
--define_symbol uuid_add_bluetooth_prefix=0x00020bcd
--define_symbol uuid_has_bluetooth_prefix=0x00020bed
--define_symbol uxQueueMessagesWaiting=0x00020c31
--define_symbol uxQueueMessagesWaitingFromISR=0x00020c59
--define_symbol uxQueueSpacesAvailable=0x00020c75
--define_symbol uxTaskGetStackHighWaterMark=0x00020ca1
--define_symbol vPortEnterCritical=0x00020d59
--define_symbol vPortExitCritical=0x00020d99
--define_symbol vPortFree=0x00020dc5
--define_symbol vPortSuppressTicksAndSleep=0x00020e59
--define_symbol vPortValidateInterruptPriority=0x00020f31
--define_symbol vQueueDelete=0x00020f85
--define_symbol vQueueWaitForMessageRestricted=0x00020fb1
--define_symbol vTaskDelay=0x00020ff9
--define_symbol vTaskInternalSetTimeOutState=0x00021045
--define_symbol vTaskMissedYield=0x00021055
--define_symbol vTaskPlaceOnEventList=0x00021061
--define_symbol vTaskPlaceOnEventListRestricted=0x00021099
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000210d9
--define_symbol vTaskStartScheduler=0x00021185
--define_symbol vTaskStepTick=0x00021215
--define_symbol vTaskSuspendAll=0x00021245
--define_symbol vTaskSwitchContext=0x00021255
--define_symbol xPortStartScheduler=0x000212fd
--define_symbol xQueueAddToSet=0x000213b9
--define_symbol xQueueCreateCountingSemaphore=0x000213dd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021419
--define_symbol xQueueCreateMutex=0x0002145d
--define_symbol xQueueCreateMutexStatic=0x00021473
--define_symbol xQueueCreateSet=0x0002148d
--define_symbol xQueueGenericCreate=0x00021495
--define_symbol xQueueGenericCreateStatic=0x000214e1
--define_symbol xQueueGenericReset=0x00021549
--define_symbol xQueueGenericSend=0x000215d5
--define_symbol xQueueGenericSendFromISR=0x00021741
--define_symbol xQueueGiveFromISR=0x00021801
--define_symbol xQueueGiveMutexRecursive=0x000218a5
--define_symbol xQueueIsQueueEmptyFromISR=0x000218e5
--define_symbol xQueueIsQueueFullFromISR=0x00021909
--define_symbol xQueuePeek=0x00021931
--define_symbol xQueuePeekFromISR=0x00021a59
--define_symbol xQueueReceive=0x00021ac5
--define_symbol xQueueReceiveFromISR=0x00021bf1
--define_symbol xQueueRemoveFromSet=0x00021c85
--define_symbol xQueueSelectFromSet=0x00021ca7
--define_symbol xQueueSelectFromSetFromISR=0x00021cb9
--define_symbol xQueueSemaphoreTake=0x00021ccd
--define_symbol xQueueTakeMutexRecursive=0x00021e39
--define_symbol xTaskCheckForTimeOut=0x00021e7d
--define_symbol xTaskCreate=0x00021eed
--define_symbol xTaskCreateStatic=0x00021f49
--define_symbol xTaskGetCurrentTaskHandle=0x00021fb9
--define_symbol xTaskGetSchedulerState=0x00021fc5
--define_symbol xTaskGetTickCount=0x00021fe1
--define_symbol xTaskGetTickCountFromISR=0x00021fed
--define_symbol xTaskIncrementTick=0x00021ffd
--define_symbol xTaskPriorityDisinherit=0x000220c9
--define_symbol xTaskPriorityInherit=0x0002215d
--define_symbol xTaskRemoveFromEventList=0x000221f1
--define_symbol xTaskResumeAll=0x00022271
--define_symbol xTimerCreate=0x00022339
--define_symbol xTimerCreateStatic=0x0002236d
--define_symbol xTimerCreateTimerTask=0x000223a5
--define_symbol xTimerGenericCommand=0x00022411
--define_symbol xTimerGetExpiryTime=0x00022481
