...
--define_symbol nibble_for_char=0x0001cc31
--define_symbol platform_32k_rc_auto_tune=0x0001ccd1
--define_symbol platform_32k_rc_tune=0x0001cd4d
--define_symbol platform_calibrate_32k=0x0001cd61
--define_symbol platform_config=0x0001cd65
--define_symbol platform_get_heap_status=0x0001ce15
--define_symbol platform_get_us_time=0x0001ce2d
--define_symbol platform_get_version=0x0001ce31
--define_symbol platform_hrng=0x0001ce39
--define_symbol platform_install_isr_stack=0x0001ce41
--define_symbol platform_patch_rf_init_data=0x0001ce4d
--define_symbol platform_printf=0x0001ce59
--define_symbol platform_raise_assertion=0x0001ce6d
--define_symbol platform_rand=0x0001ce81
--define_symbol platform_read_info=0x0001ce85
--define_symbol platform_read_persistent_reg=0x0001cea1
--define_symbol platform_reset=0x0001ceb1
--define_symbol platform_set_evt_callback=0x0001cee5
--define_symbol platform_set_irq_callback=0x0001cef9
--define_symbol platform_set_rf_clk_source=0x0001cf31
--define_symbol platform_set_rf_init_data=0x0001cf3d
--define_symbol platform_set_rf_power_mapping=0x0001cf49
--define_symbol platform_shutdown=0x0001cf55
--define_symbol platform_switch_app=0x0001cf59
--define_symbol platform_trace_raw=0x0001cf85
--define_symbol platform_write_persistent_reg=0x0001cf99
--define_symbol printf_hexdump=0x0001cfa9
...
--define_symbol sm_just_works_confirm=0x0001edc1
--define_symbol sm_le_device_key=0x0001f011
--define_symbol sm_passkey_input=0x0001f0a9
--define_symbol sm_private_random_address_generation_get=0x0001f435
--define_symbol sm_private_random_address_generation_get_mode=0x0001f43d
--define_symbol sm_private_random_address_generation_set_mode=0x0001f449
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f471
--define_symbol sm_register_oob_data_callback=0x0001f4a9
--define_symbol sm_request_pairing=0x0001f4b5
--define_symbol sm_send_security_request=0x0001feef
--define_symbol sm_set_accepted_stk_generation_methods=0x0001ff15
--define_symbol sm_set_authentication_requirements=0x0001ff21
--define_symbol sm_set_encryption_key_size_range=0x0001ff2d
--define_symbol sscanf_bd_addr=0x00020229
--define_symbol sysSetPublicDeviceAddr=0x0002058d
--define_symbol uuid128_to_str=0x00020b31
--define_symbol uuid_add_bluetooth_prefix=0x00020b89
--define_symbol uuid_has_bluetooth_prefix=0x00020ba9
--define_symbol uxQueueMessagesWaiting=0x00020bed
--define_symbol uxQueueMessagesWaitingFromISR=0x00020c15
--define_symbol uxQueueSpacesAvailable=0x00020c31
--define_symbol uxTaskGetStackHighWaterMark=0x00020c5d
--define_symbol vPortEnterCritical=0x00020d15
--define_symbol vPortExitCritical=0x00020d55
--define_symbol vPortFree=0x00020d81
--define_symbol vPortSuppressTicksAndSleep=0x00020e15
--define_symbol vPortValidateInterruptPriority=0x00020eed
--define_symbol vQueueDelete=0x00020f41
--define_symbol vQueueWaitForMessageRestricted=0x00020f6d
--define_symbol vTaskDelay=0x00020fb5
--define_symbol vTaskInternalSetTimeOutState=0x00021001
--define_symbol vTaskMissedYield=0x00021011
--define_symbol vTaskPlaceOnEventList=0x0002101d
--define_symbol vTaskPlaceOnEventListRestricted=0x00021055
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021095
--define_symbol vTaskStartScheduler=0x00021141
--define_symbol vTaskStepTick=0x000211d1
--define_symbol vTaskSuspendAll=0x00021201
--define_symbol vTaskSwitchContext=0x00021211
--define_symbol xPortStartScheduler=0x000212b9
--define_symbol xQueueAddToSet=0x00021375
--define_symbol xQueueCreateCountingSemaphore=0x00021399
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000213d5
--define_symbol xQueueCreateMutex=0x00021419
--define_symbol xQueueCreateMutexStatic=0x0002142f
--define_symbol xQueueCreateSet=0x00021449
--define_symbol xQueueGenericCreate=0x00021451
--define_symbol xQueueGenericCreateStatic=0x0002149d
--define_symbol xQueueGenericReset=0x00021505
--define_symbol xQueueGenericSend=0x00021591
--define_symbol xQueueGenericSendFromISR=0x000216fd
--define_symbol xQueueGiveFromISR=0x000217bd
--define_symbol xQueueGiveMutexRecursive=0x00021861
--define_symbol xQueueIsQueueEmptyFromISR=0x000218a1
--define_symbol xQueueIsQueueFullFromISR=0x000218c5
--define_symbol xQueuePeek=0x000218ed
--define_symbol xQueuePeekFromISR=0x00021a15
--define_symbol xQueueReceive=0x00021a81
--define_symbol xQueueReceiveFromISR=0x00021bad
--define_symbol xQueueRemoveFromSet=0x00021c41
--define_symbol xQueueSelectFromSet=0x00021c63
--define_symbol xQueueSelectFromSetFromISR=0x00021c75
--define_symbol xQueueSemaphoreTake=0x00021c89
--define_symbol xQueueTakeMutexRecursive=0x00021df5
--define_symbol xTaskCheckForTimeOut=0x00021e39
--define_symbol xTaskCreate=0x00021ea9
--define_symbol xTaskCreateStatic=0x00021f05
--define_symbol xTaskGetCurrentTaskHandle=0x00021f75
--define_symbol xTaskGetSchedulerState=0x00021f81
--define_symbol xTaskGetTickCount=0x00021f9d
--define_symbol xTaskGetTickCountFromISR=0x00021fa9
--define_symbol xTaskIncrementTick=0x00021fb9
--define_symbol xTaskPriorityDisinherit=0x00022085
--define_symbol xTaskPriorityInherit=0x00022119
--define_symbol xTaskRemoveFromEventList=0x000221ad
--define_symbol xTaskResumeAll=0x0002222d
--define_symbol xTimerCreate=0x000222f5
--define_symbol xTimerCreateStatic=0x00022329
--define_symbol xTimerCreateTimerTask=0x00022361
--define_symbol xTimerGenericCommand=0x000223cd
--define_symbol xTimerGetExpiryTime=0x0002243d
