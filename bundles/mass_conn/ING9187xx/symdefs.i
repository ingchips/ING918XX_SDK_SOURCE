...
--define_symbol nibble_for_char=0x0001ce91
--define_symbol platform_32k_rc_auto_tune=0x0001cf2d
--define_symbol platform_32k_rc_tune=0x0001cfa9
--define_symbol platform_calibrate_32k=0x0001cfbd
--define_symbol platform_config=0x0001cfc1
--define_symbol platform_get_heap_status=0x0001d079
--define_symbol platform_get_us_time=0x0001d091
--define_symbol platform_get_version=0x0001d095
--define_symbol platform_hrng=0x0001d09d
--define_symbol platform_install_isr_stack=0x0001d0a5
...
--define_symbol pvPortMalloc=0x0001dcdd
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ddc5
--define_symbol pvTimerGetTimerID=0x0001dddd
--define_symbol pxPortInitialiseStack=0x0001de09
--define_symbol reverse_128=0x0001dfb1
--define_symbol reverse_24=0x0001dfb7
--define_symbol reverse_48=0x0001dfbd
--define_symbol reverse_56=0x0001dfc3
--define_symbol reverse_64=0x0001dfc9
--define_symbol reverse_bd_addr=0x0001dfcf
--define_symbol reverse_bytes=0x0001dfd5
--define_symbol sm_add_event_handler=0x0001e141
--define_symbol sm_address_resolution_lookup=0x0001e26d
--define_symbol sm_authenticated=0x0001e5b9
--define_symbol sm_authorization_decline=0x0001e5c7
--define_symbol sm_authorization_grant=0x0001e5e7
--define_symbol sm_authorization_state=0x0001e607
--define_symbol sm_bonding_decline=0x0001e621
--define_symbol sm_config=0x0001e9ed
--define_symbol sm_config_conn=0x0001ea05
--define_symbol sm_encryption_key_size=0x0001eb63
--define_symbol sm_just_works_confirm=0x0001ef89
--define_symbol sm_le_device_key=0x0001f1b5
--define_symbol sm_passkey_input=0x0001f24b
...
--define_symbol sm_register_oob_data_callback=0x0001f709
--define_symbol sm_request_pairing=0x0001f715
--define_symbol sm_send_security_request=0x00020053
--define_symbol sm_set_accepted_stk_generation_methods=0x00020079
--define_symbol sm_set_authentication_requirements=0x00020085
--define_symbol sm_set_encryption_key_size_range=0x00020091
--define_symbol sscanf_bd_addr=0x00020365
--define_symbol sysSetPublicDeviceAddr=0x000206a9
--define_symbol uuid128_to_str=0x00020c51
--define_symbol uuid_add_bluetooth_prefix=0x00020ca9
--define_symbol uuid_has_bluetooth_prefix=0x00020cc9
--define_symbol uxQueueMessagesWaiting=0x00020d0d
--define_symbol uxQueueMessagesWaitingFromISR=0x00020d35
--define_symbol uxQueueSpacesAvailable=0x00020d51
--define_symbol uxTaskGetStackHighWaterMark=0x00020d7d
