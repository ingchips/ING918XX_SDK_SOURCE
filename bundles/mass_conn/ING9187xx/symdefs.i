...
--define_symbol nibble_for_char=0x0001cf21
--define_symbol platform_32k_rc_auto_tune=0x0001cfbd
--define_symbol platform_32k_rc_tune=0x0001d039
--define_symbol platform_calibrate_32k=0x0001d04d
--define_symbol platform_config=0x0001d051
--define_symbol platform_get_heap_status=0x0001d109
--define_symbol platform_get_us_time=0x0001d121
--define_symbol platform_get_version=0x0001d125
--define_symbol platform_hrng=0x0001d12d
--define_symbol platform_install_isr_stack=0x0001d135
--define_symbol platform_patch_rf_init_data=0x0001d141
--define_symbol platform_printf=0x0001d14d
--define_symbol platform_raise_assertion=0x0001d161
--define_symbol platform_rand=0x0001d175
--define_symbol platform_read_info=0x0001d179
--define_symbol platform_read_persistent_reg=0x0001d195
--define_symbol platform_reset=0x0001d1a5
--define_symbol platform_set_evt_callback=0x0001d1d9
--define_symbol platform_set_irq_callback=0x0001d1ed
--define_symbol platform_set_rf_clk_source=0x0001d225
--define_symbol platform_set_rf_init_data=0x0001d231
--define_symbol platform_set_rf_power_mapping=0x0001d23d
--define_symbol platform_shutdown=0x0001d249
--define_symbol platform_switch_app=0x0001d24d
--define_symbol platform_trace_raw=0x0001d279
--define_symbol platform_write_persistent_reg=0x0001d28d
--define_symbol printf_hexdump=0x0001d29d
--define_symbol pvPortMalloc=0x0001dda5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001de8d
--define_symbol pvTimerGetTimerID=0x0001dea5
--define_symbol pxPortInitialiseStack=0x0001ded1
--define_symbol reverse_128=0x0001e079
--define_symbol reverse_24=0x0001e07f
--define_symbol reverse_48=0x0001e085
--define_symbol reverse_56=0x0001e08b
--define_symbol reverse_64=0x0001e091
--define_symbol reverse_bd_addr=0x0001e097
--define_symbol reverse_bytes=0x0001e09d
--define_symbol sm_add_event_handler=0x0001e209
--define_symbol sm_address_resolution_lookup=0x0001e335
--define_symbol sm_authenticated=0x0001e681
--define_symbol sm_authorization_decline=0x0001e68f
--define_symbol sm_authorization_grant=0x0001e6af
--define_symbol sm_authorization_state=0x0001e6cf
--define_symbol sm_bonding_decline=0x0001e6e9
--define_symbol sm_config=0x0001eab5
--define_symbol sm_config_conn=0x0001eacd
--define_symbol sm_encryption_key_size=0x0001ec2b
--define_symbol sm_just_works_confirm=0x0001f051
--define_symbol sm_le_device_key=0x0001f27d
--define_symbol sm_passkey_input=0x0001f313
...
--define_symbol sm_register_oob_data_callback=0x0001f7d1
--define_symbol sm_request_pairing=0x0001f7dd
--define_symbol sm_send_security_request=0x0002011b
--define_symbol sm_set_accepted_stk_generation_methods=0x00020141
--define_symbol sm_set_authentication_requirements=0x0002014d
--define_symbol sm_set_encryption_key_size_range=0x00020159
--define_symbol sscanf_bd_addr=0x0002042d
--define_symbol sysSetPublicDeviceAddr=0x00020771
--define_symbol uuid128_to_str=0x00020d49
--define_symbol uuid_add_bluetooth_prefix=0x00020da1
--define_symbol uuid_has_bluetooth_prefix=0x00020dc1
--define_symbol uxQueueMessagesWaiting=0x00020e05
--define_symbol uxQueueMessagesWaitingFromISR=0x00020e2d
--define_symbol uxQueueSpacesAvailable=0x00020e49
--define_symbol uxTaskGetStackHighWaterMark=0x00020e75
--define_symbol vPortEnterCritical=0x00020f99
--define_symbol vPortExitCritical=0x00020fd9
--define_symbol vPortFree=0x00021005
--define_symbol vPortSuppressTicksAndSleep=0x00021099
--define_symbol vPortValidateInterruptPriority=0x00021171
--define_symbol vQueueDelete=0x000211c5
--define_symbol vQueueWaitForMessageRestricted=0x000211f1
--define_symbol vTaskDelay=0x00021239
--define_symbol vTaskInternalSetTimeOutState=0x00021285
--define_symbol vTaskMissedYield=0x00021295
--define_symbol vTaskPlaceOnEventList=0x000212a1
--define_symbol vTaskPlaceOnEventListRestricted=0x000212d9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021319
--define_symbol vTaskResume=0x000213c5
--define_symbol vTaskStartScheduler=0x00021449
--define_symbol vTaskStepTick=0x000214d9
--define_symbol vTaskSuspend=0x00021509
--define_symbol vTaskSuspendAll=0x000215c5
--define_symbol vTaskSwitchContext=0x000215d5
--define_symbol xPortStartScheduler=0x0002167d
--define_symbol xQueueAddToSet=0x00021739
--define_symbol xQueueCreateCountingSemaphore=0x0002175d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021799
--define_symbol xQueueCreateMutex=0x000217dd
--define_symbol xQueueCreateMutexStatic=0x000217f3
--define_symbol xQueueCreateSet=0x0002180d
--define_symbol xQueueGenericCreate=0x00021815
--define_symbol xQueueGenericCreateStatic=0x00021861
--define_symbol xQueueGenericReset=0x000218c9
--define_symbol xQueueGenericSend=0x00021955
--define_symbol xQueueGenericSendFromISR=0x00021ac1
--define_symbol xQueueGiveFromISR=0x00021b81
--define_symbol xQueueGiveMutexRecursive=0x00021c25
--define_symbol xQueueIsQueueEmptyFromISR=0x00021c65
--define_symbol xQueueIsQueueFullFromISR=0x00021c89
--define_symbol xQueuePeek=0x00021cb1
--define_symbol xQueuePeekFromISR=0x00021dd9
--define_symbol xQueueReceive=0x00021e45
--define_symbol xQueueReceiveFromISR=0x00021f71
--define_symbol xQueueRemoveFromSet=0x00022005
--define_symbol xQueueSelectFromSet=0x00022027
--define_symbol xQueueSelectFromSetFromISR=0x00022039
--define_symbol xQueueSemaphoreTake=0x0002204d
--define_symbol xQueueTakeMutexRecursive=0x000221b9
--define_symbol xTaskCheckForTimeOut=0x000221fd
--define_symbol xTaskCreate=0x0002226d
--define_symbol xTaskCreateStatic=0x000222c9
--define_symbol xTaskGetCurrentTaskHandle=0x00022339
--define_symbol xTaskGetSchedulerState=0x00022345
--define_symbol xTaskGetTickCount=0x00022361
--define_symbol xTaskGetTickCountFromISR=0x0002236d
--define_symbol xTaskIncrementTick=0x0002237d
--define_symbol xTaskPriorityDisinherit=0x00022449
--define_symbol xTaskPriorityInherit=0x000224dd
--define_symbol xTaskRemoveFromEventList=0x00022571
--define_symbol xTaskResumeAll=0x000225f1
--define_symbol xTaskResumeFromISR=0x000226b9
--define_symbol xTimerCreate=0x00022745
--define_symbol xTimerCreateStatic=0x00022779
--define_symbol xTimerCreateTimerTask=0x000227b1
--define_symbol xTimerGenericCommand=0x0002281d
--define_symbol xTimerGetExpiryTime=0x0002288d
