...
--define_symbol platform_get_heap_status=0x0001d17d
--define_symbol platform_get_us_time=0x0001d195
--define_symbol platform_get_version=0x0001d199
--define_symbol platform_hrng=0x0001d1a1
--define_symbol platform_install_isr_stack=0x0001d1a9
--define_symbol platform_patch_rf_init_data=0x0001d1b5
--define_symbol platform_printf=0x0001d1c1
--define_symbol platform_raise_assertion=0x0001d1d5
--define_symbol platform_rand=0x0001d1e9
--define_symbol platform_read_info=0x0001d1ed
--define_symbol platform_read_persistent_reg=0x0001d209
--define_symbol platform_reset=0x0001d219
...
--define_symbol platform_shutdown=0x0001d2bd
--define_symbol platform_switch_app=0x0001d2c1
--define_symbol platform_trace_raw=0x0001d2ed
...
--define_symbol sm_address_resolution_lookup=0x0001e3a9
--define_symbol sm_authenticated=0x0001e6f5
--define_symbol sm_authorization_decline=0x0001e703
--define_symbol sm_authorization_grant=0x0001e723
--define_symbol sm_authorization_state=0x0001e743
--define_symbol sm_bonding_decline=0x0001e75d
--define_symbol sm_config=0x0001eb29
--define_symbol sm_config_conn=0x0001eb41
--define_symbol sm_encryption_key_size=0x0001ec9f
--define_symbol sm_just_works_confirm=0x0001f0c5
--define_symbol sm_le_device_key=0x0001f2f1
--define_symbol sm_passkey_input=0x0001f387
--define_symbol sm_private_random_address_generation_get=0x0001f6cd
--define_symbol sm_private_random_address_generation_get_mode=0x0001f6d5
--define_symbol sm_private_random_address_generation_set_mode=0x0001f6e1
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f709
--define_symbol sm_register_oob_data_callback=0x0001f845
--define_symbol sm_request_pairing=0x0001f851
--define_symbol sm_send_security_request=0x0002018f
--define_symbol sm_set_accepted_stk_generation_methods=0x000201b5
--define_symbol sm_set_authentication_requirements=0x000201c1
--define_symbol sm_set_encryption_key_size_range=0x000201cd
--define_symbol sscanf_bd_addr=0x000204a1
--define_symbol sysSetPublicDeviceAddr=0x000207e5
--define_symbol uuid128_to_str=0x00020dbd
--define_symbol uuid_add_bluetooth_prefix=0x00020e15
--define_symbol uuid_has_bluetooth_prefix=0x00020e35
--define_symbol uxQueueMessagesWaiting=0x00020e79
--define_symbol uxQueueMessagesWaitingFromISR=0x00020ea1
--define_symbol uxQueueSpacesAvailable=0x00020ebd
--define_symbol uxTaskGetStackHighWaterMark=0x00020ee9
--define_symbol vPortEnterCritical=0x0002100d
--define_symbol vPortExitCritical=0x0002104d
--define_symbol vPortFree=0x00021079
--define_symbol vPortSuppressTicksAndSleep=0x0002110d
--define_symbol vPortValidateInterruptPriority=0x000211e5
--define_symbol vQueueDelete=0x00021239
--define_symbol vQueueWaitForMessageRestricted=0x00021265
--define_symbol vTaskDelay=0x000212ad
--define_symbol vTaskInternalSetTimeOutState=0x000212f9
--define_symbol vTaskMissedYield=0x00021309
--define_symbol vTaskPlaceOnEventList=0x00021315
--define_symbol vTaskPlaceOnEventListRestricted=0x0002134d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002138d
--define_symbol vTaskResume=0x00021439
--define_symbol vTaskStartScheduler=0x000214bd
--define_symbol vTaskStepTick=0x0002154d
--define_symbol vTaskSuspend=0x0002157d
--define_symbol vTaskSuspendAll=0x00021639
--define_symbol vTaskSwitchContext=0x00021649
--define_symbol xPortStartScheduler=0x000216f1
--define_symbol xQueueAddToSet=0x000217ad
--define_symbol xQueueCreateCountingSemaphore=0x000217d1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002180d
--define_symbol xQueueCreateMutex=0x00021851
--define_symbol xQueueCreateMutexStatic=0x00021867
--define_symbol xQueueCreateSet=0x00021881
--define_symbol xQueueGenericCreate=0x00021889
--define_symbol xQueueGenericCreateStatic=0x000218d5
--define_symbol xQueueGenericReset=0x0002193d
--define_symbol xQueueGenericSend=0x000219c9
--define_symbol xQueueGenericSendFromISR=0x00021b35
--define_symbol xQueueGiveFromISR=0x00021bf5
--define_symbol xQueueGiveMutexRecursive=0x00021c99
--define_symbol xQueueIsQueueEmptyFromISR=0x00021cd9
--define_symbol xQueueIsQueueFullFromISR=0x00021cfd
--define_symbol xQueuePeek=0x00021d25
--define_symbol xQueuePeekFromISR=0x00021e4d
--define_symbol xQueueReceive=0x00021eb9
--define_symbol xQueueReceiveFromISR=0x00021fe5
--define_symbol xQueueRemoveFromSet=0x00022079
--define_symbol xQueueSelectFromSet=0x0002209b
--define_symbol xQueueSelectFromSetFromISR=0x000220ad
--define_symbol xQueueSemaphoreTake=0x000220c1
--define_symbol xQueueTakeMutexRecursive=0x0002222d
--define_symbol xTaskCheckForTimeOut=0x00022271
--define_symbol xTaskCreate=0x000222e1
--define_symbol xTaskCreateStatic=0x0002233d
--define_symbol xTaskGetCurrentTaskHandle=0x000223ad
--define_symbol xTaskGetSchedulerState=0x000223b9
--define_symbol xTaskGetTickCount=0x000223d5
--define_symbol xTaskGetTickCountFromISR=0x000223e1
--define_symbol xTaskIncrementTick=0x000223f1
--define_symbol xTaskPriorityDisinherit=0x000224bd
--define_symbol xTaskPriorityInherit=0x00022551
--define_symbol xTaskRemoveFromEventList=0x000225e5
--define_symbol xTaskResumeAll=0x00022665
--define_symbol xTaskResumeFromISR=0x0002272d
--define_symbol xTimerCreate=0x000227b9
--define_symbol xTimerCreateStatic=0x000227ed
--define_symbol xTimerCreateTimerTask=0x00022825
--define_symbol xTimerGenericCommand=0x00022891
--define_symbol xTimerGetExpiryTime=0x00022901
