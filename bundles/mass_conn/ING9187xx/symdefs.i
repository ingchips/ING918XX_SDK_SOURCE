...
--define_symbol ll_malloc=0x0000cc71
--define_symbol ll_query_timing_info=0x0000cda9
--define_symbol ll_set_adv_coded_scheme=0x0000cf55
--define_symbol ll_set_conn_coded_scheme=0x0000cf85
--define_symbol ll_set_conn_latency=0x0000cfb1
--define_symbol ll_set_conn_tx_power=0x0000cfe1
--define_symbol ll_set_def_antenna=0x0000d029
--define_symbol ll_set_initiating_coded_scheme=0x0000d045
--define_symbol ll_set_max_conn_number=0x0000d051
...
--define_symbol pvPortMalloc=0x0001da65
--define_symbol pvTaskIncrementMutexHeldCount=0x0001db4d
--define_symbol pvTimerGetTimerID=0x0001db65
--define_symbol pxPortInitialiseStack=0x0001db91
--define_symbol reverse_128=0x0001dd39
--define_symbol reverse_24=0x0001dd3f
--define_symbol reverse_48=0x0001dd45
--define_symbol reverse_56=0x0001dd4b
--define_symbol reverse_64=0x0001dd51
--define_symbol reverse_bd_addr=0x0001dd57
--define_symbol reverse_bytes=0x0001dd5d
--define_symbol sm_add_event_handler=0x0001dea9
--define_symbol sm_address_resolution_lookup=0x0001dfd5
--define_symbol sm_authenticated=0x0001e0af
--define_symbol sm_authorization_decline=0x0001e0bd
--define_symbol sm_authorization_grant=0x0001e0dd
--define_symbol sm_authorization_state=0x0001e0fd
--define_symbol sm_bonding_decline=0x0001e119
--define_symbol sm_config=0x0001e4f1
--define_symbol sm_encryption_key_size=0x0001e5fd
...
--define_symbol sysSetPublicDeviceAddr=0x00020585
--define_symbol uuid128_to_str=0x00020b29
--define_symbol uuid_add_bluetooth_prefix=0x00020b81
--define_symbol uuid_has_bluetooth_prefix=0x00020ba1
--define_symbol uxQueueMessagesWaiting=0x00020be5
--define_symbol uxQueueMessagesWaitingFromISR=0x00020c0d
--define_symbol uxQueueSpacesAvailable=0x00020c29
--define_symbol uxTaskGetStackHighWaterMark=0x00020c55
--define_symbol vPortEnterCritical=0x00020d0d
--define_symbol vPortExitCritical=0x00020d4d
--define_symbol vPortFree=0x00020d79
--define_symbol vPortSuppressTicksAndSleep=0x00020e0d
--define_symbol vPortValidateInterruptPriority=0x00020ee5
--define_symbol vQueueDelete=0x00020f39
--define_symbol vQueueWaitForMessageRestricted=0x00020f65
--define_symbol vTaskDelay=0x00020fad
--define_symbol vTaskInternalSetTimeOutState=0x00020ff9
--define_symbol vTaskMissedYield=0x00021009
--define_symbol vTaskPlaceOnEventList=0x00021015
--define_symbol vTaskPlaceOnEventListRestricted=0x0002104d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002108d
--define_symbol vTaskStartScheduler=0x00021139
--define_symbol vTaskStepTick=0x000211c9
--define_symbol vTaskSuspendAll=0x000211f9
--define_symbol vTaskSwitchContext=0x00021209
--define_symbol xPortStartScheduler=0x000212b1
--define_symbol xQueueAddToSet=0x0002136d
--define_symbol xQueueCreateCountingSemaphore=0x00021391
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000213cd
--define_symbol xQueueCreateMutex=0x00021411
--define_symbol xQueueCreateMutexStatic=0x00021427
--define_symbol xQueueCreateSet=0x00021441
--define_symbol xQueueGenericCreate=0x00021449
--define_symbol xQueueGenericCreateStatic=0x00021495
--define_symbol xQueueGenericReset=0x000214fd
--define_symbol xQueueGenericSend=0x00021589
--define_symbol xQueueGenericSendFromISR=0x000216f5
--define_symbol xQueueGiveFromISR=0x000217b5
--define_symbol xQueueGiveMutexRecursive=0x00021859
--define_symbol xQueueIsQueueEmptyFromISR=0x00021899
--define_symbol xQueueIsQueueFullFromISR=0x000218bd
--define_symbol xQueuePeek=0x000218e5
--define_symbol xQueuePeekFromISR=0x00021a0d
--define_symbol xQueueReceive=0x00021a79
--define_symbol xQueueReceiveFromISR=0x00021ba5
--define_symbol xQueueRemoveFromSet=0x00021c39
--define_symbol xQueueSelectFromSet=0x00021c5b
--define_symbol xQueueSelectFromSetFromISR=0x00021c6d
--define_symbol xQueueSemaphoreTake=0x00021c81
--define_symbol xQueueTakeMutexRecursive=0x00021ded
--define_symbol xTaskCheckForTimeOut=0x00021e31
--define_symbol xTaskCreate=0x00021ea1
--define_symbol xTaskCreateStatic=0x00021efd
--define_symbol xTaskGetCurrentTaskHandle=0x00021f6d
--define_symbol xTaskGetSchedulerState=0x00021f79
--define_symbol xTaskGetTickCount=0x00021f95
--define_symbol xTaskGetTickCountFromISR=0x00021fa1
--define_symbol xTaskIncrementTick=0x00021fb1
--define_symbol xTaskPriorityDisinherit=0x0002207d
--define_symbol xTaskPriorityInherit=0x00022111
--define_symbol xTaskRemoveFromEventList=0x000221a5
--define_symbol xTaskResumeAll=0x00022225
--define_symbol xTimerCreate=0x000222ed
--define_symbol xTimerCreateStatic=0x00022321
--define_symbol xTimerCreateTimerTask=0x00022359
--define_symbol xTimerGenericCommand=0x000223c5
--define_symbol xTimerGetExpiryTime=0x00022435
