...
--define_symbol nibble_for_char=0x0001cdf1
--define_symbol platform_32k_rc_auto_tune=0x0001ce8d
--define_symbol platform_32k_rc_tune=0x0001cf09
--define_symbol platform_calibrate_32k=0x0001cf1d
--define_symbol platform_config=0x0001cf21
--define_symbol platform_get_heap_status=0x0001cfe1
--define_symbol platform_get_task_handle=0x0001cff9
--define_symbol platform_get_us_time=0x0001d019
--define_symbol platform_get_version=0x0001d01d
--define_symbol platform_hrng=0x0001d025
--define_symbol platform_install_isr_stack=0x0001d02d
...
--define_symbol pvPortMalloc=0x0001dca9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dd91
--define_symbol pvTimerGetTimerID=0x0001dda9
--define_symbol pxPortInitialiseStack=0x0001ddd5
--define_symbol reverse_128=0x0001df7d
--define_symbol reverse_24=0x0001df83
--define_symbol reverse_48=0x0001df89
--define_symbol reverse_56=0x0001df8f
--define_symbol reverse_64=0x0001df95
--define_symbol reverse_bd_addr=0x0001df9b
--define_symbol reverse_bytes=0x0001dfa1
--define_symbol sm_add_event_handler=0x0001e10d
--define_symbol sm_address_resolution_lookup=0x0001e265
--define_symbol sm_authenticated=0x0001e5b1
--define_symbol sm_authorization_decline=0x0001e5bf
--define_symbol sm_authorization_grant=0x0001e5df
--define_symbol sm_authorization_state=0x0001e5ff
--define_symbol sm_bonding_decline=0x0001e619
--define_symbol sm_config=0x0001ea39
--define_symbol sm_config_conn=0x0001ea51
--define_symbol sm_encryption_key_size=0x0001ec07
--define_symbol sm_just_works_confirm=0x0001f141
--define_symbol sm_le_device_key=0x0001f47d
--define_symbol sm_passkey_input=0x0001f513
--define_symbol sm_private_random_address_generation_get=0x0001f8c1
--define_symbol sm_private_random_address_generation_get_mode=0x0001f8c9
--define_symbol sm_private_random_address_generation_set_mode=0x0001f8d5
--define_symbol sm_private_random_address_generation_set_update_period=0x0001f8fd
--define_symbol sm_register_oob_data_callback=0x0001fa39
--define_symbol sm_request_pairing=0x0001fa45
...
--define_symbol sscanf_bd_addr=0x000207d9
--define_symbol sysSetPublicDeviceAddr=0x00020b41
...
--define_symbol uxListRemove=0x000211c9
...
--define_symbol uxTaskPriorityGet=0x00021281
--define_symbol uxTaskPriorityGetFromISR=0x0002129d
--define_symbol vListInitialise=0x0002134f
--define_symbol vListInitialiseItem=0x00021365
--define_symbol vListInsert=0x0002136b
--define_symbol vListInsertEnd=0x0002139b
--define_symbol vPortEnterCritical=0x000213b5
--define_symbol vPortExitCritical=0x000213f9
--define_symbol vPortFree=0x00021429
--define_symbol vPortSuppressTicksAndSleep=0x000214bd
--define_symbol vPortValidateInterruptPriority=0x000215dd
--define_symbol vQueueDelete=0x00021635
--define_symbol vQueueWaitForMessageRestricted=0x00021661
--define_symbol vTaskDelay=0x000216a9
--define_symbol vTaskInternalSetTimeOutState=0x000216f5
--define_symbol vTaskMissedYield=0x00021705
--define_symbol vTaskPlaceOnEventList=0x00021711
--define_symbol vTaskPlaceOnEventListRestricted=0x00021749
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021789
--define_symbol vTaskPrioritySet=0x00021835
--define_symbol vTaskResume=0x000218fd
--define_symbol vTaskStartScheduler=0x00021981
--define_symbol vTaskStepTick=0x00021a11
--define_symbol vTaskSuspend=0x00021a41
--define_symbol vTaskSuspendAll=0x00021afd
--define_symbol vTaskSwitchContext=0x00021b0d
--define_symbol xPortStartScheduler=0x00021bb5
--define_symbol xQueueAddToSet=0x00021c79
--define_symbol xQueueCreateCountingSemaphore=0x00021c9d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021cd9
--define_symbol xQueueCreateMutex=0x00021d1d
--define_symbol xQueueCreateMutexStatic=0x00021d33
--define_symbol xQueueCreateSet=0x00021d4d
--define_symbol xQueueGenericCreate=0x00021d55
--define_symbol xQueueGenericCreateStatic=0x00021da1
--define_symbol xQueueGenericReset=0x00021e09
--define_symbol xQueueGenericSend=0x00021e95
--define_symbol xQueueGenericSendFromISR=0x00022001
--define_symbol xQueueGiveFromISR=0x000220c1
--define_symbol xQueueGiveMutexRecursive=0x00022165
--define_symbol xQueueIsQueueEmptyFromISR=0x000221a5
--define_symbol xQueueIsQueueFullFromISR=0x000221c9
--define_symbol xQueuePeek=0x000221f1
--define_symbol xQueuePeekFromISR=0x00022319
--define_symbol xQueueReceive=0x00022385
--define_symbol xQueueReceiveFromISR=0x000224b1
--define_symbol xQueueRemoveFromSet=0x00022545
--define_symbol xQueueSelectFromSet=0x00022567
--define_symbol xQueueSelectFromSetFromISR=0x00022579
--define_symbol xQueueSemaphoreTake=0x0002258d
--define_symbol xQueueTakeMutexRecursive=0x000226f9
--define_symbol xTaskCheckForTimeOut=0x0002273d
--define_symbol xTaskCreate=0x000227ad
--define_symbol xTaskCreateStatic=0x00022809
--define_symbol xTaskGetCurrentTaskHandle=0x00022879
--define_symbol xTaskGetSchedulerState=0x00022885
--define_symbol xTaskGetTickCount=0x000228a1
--define_symbol xTaskGetTickCountFromISR=0x000228ad
--define_symbol xTaskIncrementTick=0x000228bd
--define_symbol xTaskPriorityDisinherit=0x00022989
--define_symbol xTaskPriorityInherit=0x00022a1d
--define_symbol xTaskRemoveFromEventList=0x00022ab1
--define_symbol xTaskResumeAll=0x00022b31
--define_symbol xTaskResumeFromISR=0x00022bf9
--define_symbol xTimerCreate=0x00022c85
--define_symbol xTimerCreateStatic=0x00022cb9
--define_symbol xTimerCreateTimerTask=0x00022cf1
--define_symbol xTimerGenericCommand=0x00022d5d
--define_symbol xTimerGetExpiryTime=0x00022dcd
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00022ded
