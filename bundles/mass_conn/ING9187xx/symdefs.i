...
--define_symbol nibble_for_char=0x0001d031
--define_symbol platform_32k_rc_auto_tune=0x0001d0cd
--define_symbol platform_32k_rc_tune=0x0001d149
--define_symbol platform_calibrate_32k=0x0001d15d
--define_symbol platform_config=0x0001d161
--define_symbol platform_get_heap_status=0x0001d221
--define_symbol platform_get_us_time=0x0001d239
--define_symbol platform_get_version=0x0001d23d
--define_symbol platform_hrng=0x0001d245
--define_symbol platform_install_isr_stack=0x0001d24d
--define_symbol platform_patch_rf_init_data=0x0001d259
--define_symbol platform_printf=0x0001d265
--define_symbol platform_raise_assertion=0x0001d279
--define_symbol platform_rand=0x0001d28d
--define_symbol platform_read_info=0x0001d291
--define_symbol platform_read_persistent_reg=0x0001d2ad
--define_symbol platform_reset=0x0001d2bd
--define_symbol platform_set_evt_callback=0x0001d2f1
--define_symbol platform_set_irq_callback=0x0001d305
--define_symbol platform_set_rf_clk_source=0x0001d33d
--define_symbol platform_set_rf_init_data=0x0001d349
--define_symbol platform_set_rf_power_mapping=0x0001d355
...
--define_symbol printf_hexdump=0x0001d3b9
--define_symbol pvPortMalloc=0x0001dec5
--define_symbol pvTaskIncrementMutexHeldCount=0x0001dfad
--define_symbol pvTimerGetTimerID=0x0001dfc5
--define_symbol pxPortInitialiseStack=0x0001dff1
--define_symbol reverse_128=0x0001e199
--define_symbol reverse_24=0x0001e19f
--define_symbol reverse_48=0x0001e1a5
--define_symbol reverse_56=0x0001e1ab
--define_symbol reverse_64=0x0001e1b1
--define_symbol reverse_bd_addr=0x0001e1b7
--define_symbol reverse_bytes=0x0001e1bd
--define_symbol sm_add_event_handler=0x0001e329
--define_symbol sm_address_resolution_lookup=0x0001e481
--define_symbol sm_authenticated=0x0001e7cd
--define_symbol sm_authorization_decline=0x0001e7db
--define_symbol sm_authorization_grant=0x0001e7fb
--define_symbol sm_authorization_state=0x0001e81b
--define_symbol sm_bonding_decline=0x0001e835
--define_symbol sm_config=0x0001ec55
--define_symbol sm_config_conn=0x0001ec6d
--define_symbol sm_encryption_key_size=0x0001edf3
--define_symbol sm_just_works_confirm=0x0001f321
--define_symbol sm_le_device_key=0x0001f65d
--define_symbol sm_passkey_input=0x0001f6f3
--define_symbol sm_private_random_address_generation_get=0x0001fa99
--define_symbol sm_private_random_address_generation_get_mode=0x0001faa1
--define_symbol sm_private_random_address_generation_set_mode=0x0001faad
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fad5
--define_symbol sm_register_oob_data_callback=0x0001fc11
--define_symbol sm_request_pairing=0x0001fc1d
--define_symbol sm_send_security_request=0x00020617
--define_symbol sm_set_accepted_stk_generation_methods=0x0002063d
--define_symbol sm_set_authentication_requirements=0x00020649
--define_symbol sm_set_encryption_key_size_range=0x00020655
...
--define_symbol uxListRemove=0x000213a1
--define_symbol uxQueueMessagesWaiting=0x000213c9
--define_symbol uxQueueMessagesWaitingFromISR=0x000213f1
--define_symbol uxQueueSpacesAvailable=0x0002140d
--define_symbol uxTaskGetStackHighWaterMark=0x00021439
--define_symbol vListInitialise=0x000214df
--define_symbol vListInitialiseItem=0x000214f5
--define_symbol vListInsert=0x000214fb
--define_symbol vListInsertEnd=0x0002152b
--define_symbol vPortEnterCritical=0x00021545
--define_symbol vPortExitCritical=0x00021589
--define_symbol vPortFree=0x000215b9
--define_symbol vPortSuppressTicksAndSleep=0x0002164d
--define_symbol vPortValidateInterruptPriority=0x0002176d
--define_symbol vQueueDelete=0x000217c5
--define_symbol vQueueWaitForMessageRestricted=0x000217f1
--define_symbol vTaskDelay=0x00021839
--define_symbol vTaskInternalSetTimeOutState=0x00021885
--define_symbol vTaskMissedYield=0x00021895
--define_symbol vTaskPlaceOnEventList=0x000218a1
--define_symbol vTaskPlaceOnEventListRestricted=0x000218d9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021919
--define_symbol vTaskResume=0x000219c5
--define_symbol vTaskStartScheduler=0x00021a49
--define_symbol vTaskStepTick=0x00021ad9
--define_symbol vTaskSuspend=0x00021b09
--define_symbol vTaskSuspendAll=0x00021bc5
--define_symbol vTaskSwitchContext=0x00021bd5
--define_symbol xPortStartScheduler=0x00021c7d
--define_symbol xQueueAddToSet=0x00021d41
--define_symbol xQueueCreateCountingSemaphore=0x00021d65
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00021da1
--define_symbol xQueueCreateMutex=0x00021de5
--define_symbol xQueueCreateMutexStatic=0x00021dfb
--define_symbol xQueueCreateSet=0x00021e15
--define_symbol xQueueGenericCreate=0x00021e1d
--define_symbol xQueueGenericCreateStatic=0x00021e69
--define_symbol xQueueGenericReset=0x00021ed1
--define_symbol xQueueGenericSend=0x00021f5d
--define_symbol xQueueGenericSendFromISR=0x000220c9
--define_symbol xQueueGiveFromISR=0x00022189
--define_symbol xQueueGiveMutexRecursive=0x0002222d
--define_symbol xQueueIsQueueEmptyFromISR=0x0002226d
--define_symbol xQueueIsQueueFullFromISR=0x00022291
--define_symbol xQueuePeek=0x000222b9
--define_symbol xQueuePeekFromISR=0x000223e1
--define_symbol xQueueReceive=0x0002244d
--define_symbol xQueueReceiveFromISR=0x00022579
--define_symbol xQueueRemoveFromSet=0x0002260d
--define_symbol xQueueSelectFromSet=0x0002262f
--define_symbol xQueueSelectFromSetFromISR=0x00022641
--define_symbol xQueueSemaphoreTake=0x00022655
--define_symbol xQueueTakeMutexRecursive=0x000227c1
--define_symbol xTaskCheckForTimeOut=0x00022805
--define_symbol xTaskCreate=0x00022875
--define_symbol xTaskCreateStatic=0x000228d1
--define_symbol xTaskGetCurrentTaskHandle=0x00022941
--define_symbol xTaskGetSchedulerState=0x0002294d
--define_symbol xTaskGetTickCount=0x00022969
--define_symbol xTaskGetTickCountFromISR=0x00022975
--define_symbol xTaskIncrementTick=0x00022985
--define_symbol xTaskPriorityDisinherit=0x00022a51
--define_symbol xTaskPriorityInherit=0x00022ae5
--define_symbol xTaskRemoveFromEventList=0x00022b79
--define_symbol xTaskResumeAll=0x00022bf9
--define_symbol xTaskResumeFromISR=0x00022cc1
--define_symbol xTimerCreate=0x00022d4d
--define_symbol xTimerCreateStatic=0x00022d81
--define_symbol xTimerCreateTimerTask=0x00022db9
--define_symbol xTimerGenericCommand=0x00022e25
--define_symbol xTimerGetExpiryTime=0x00022e95
