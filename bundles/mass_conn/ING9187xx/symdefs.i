...
--define_symbol ll_config=0x0000ce4f
--define_symbol ll_free=0x0000ce51
...
--define_symbol nibble_for_char=0x0001cfb5
--define_symbol platform_32k_rc_auto_tune=0x0001d051
--define_symbol platform_32k_rc_tune=0x0001d0cd
--define_symbol platform_calibrate_32k=0x0001d0e1
--define_symbol platform_config=0x0001d0e5
--define_symbol platform_get_heap_status=0x0001d1a5
--define_symbol platform_get_us_time=0x0001d1bd
--define_symbol platform_get_version=0x0001d1c1
--define_symbol platform_hrng=0x0001d1c9
--define_symbol platform_install_isr_stack=0x0001d1d1
--define_symbol platform_patch_rf_init_data=0x0001d1dd
--define_symbol platform_printf=0x0001d1e9
--define_symbol platform_raise_assertion=0x0001d1fd
--define_symbol platform_rand=0x0001d211
--define_symbol platform_read_info=0x0001d215
--define_symbol platform_read_persistent_reg=0x0001d231
--define_symbol platform_reset=0x0001d241
--define_symbol platform_set_evt_callback=0x0001d275
--define_symbol platform_set_irq_callback=0x0001d289
--define_symbol platform_set_rf_clk_source=0x0001d2c1
--define_symbol platform_set_rf_init_data=0x0001d2cd
--define_symbol platform_set_rf_power_mapping=0x0001d2d9
--define_symbol platform_shutdown=0x0001d2e5
--define_symbol platform_switch_app=0x0001d2e9
--define_symbol platform_trace_raw=0x0001d315
--define_symbol platform_write_persistent_reg=0x0001d32d
--define_symbol printf_hexdump=0x0001d33d
--define_symbol pvPortMalloc=0x0001de49
--define_symbol pvTaskIncrementMutexHeldCount=0x0001df31
--define_symbol pvTimerGetTimerID=0x0001df49
--define_symbol pxPortInitialiseStack=0x0001df75
--define_symbol reverse_128=0x0001e11d
--define_symbol reverse_24=0x0001e123
--define_symbol reverse_48=0x0001e129
--define_symbol reverse_56=0x0001e12f
--define_symbol reverse_64=0x0001e135
--define_symbol reverse_bd_addr=0x0001e13b
--define_symbol reverse_bytes=0x0001e141
--define_symbol sm_add_event_handler=0x0001e2ad
--define_symbol sm_address_resolution_lookup=0x0001e405
--define_symbol sm_authenticated=0x0001e751
--define_symbol sm_authorization_decline=0x0001e75f
--define_symbol sm_authorization_grant=0x0001e77f
--define_symbol sm_authorization_state=0x0001e79f
--define_symbol sm_bonding_decline=0x0001e7b9
--define_symbol sm_config=0x0001ebd9
--define_symbol sm_config_conn=0x0001ebf1
--define_symbol sm_encryption_key_size=0x0001ed77
--define_symbol sm_just_works_confirm=0x0001f2a5
--define_symbol sm_le_device_key=0x0001f5e1
--define_symbol sm_passkey_input=0x0001f677
--define_symbol sm_private_random_address_generation_get=0x0001fa1d
--define_symbol sm_private_random_address_generation_get_mode=0x0001fa25
--define_symbol sm_private_random_address_generation_set_mode=0x0001fa31
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fa59
--define_symbol sm_register_oob_data_callback=0x0001fb95
--define_symbol sm_request_pairing=0x0001fba1
--define_symbol sm_send_security_request=0x0002059b
--define_symbol sm_set_accepted_stk_generation_methods=0x000205c1
--define_symbol sm_set_authentication_requirements=0x000205cd
--define_symbol sm_set_encryption_key_size_range=0x000205d9
--define_symbol sscanf_bd_addr=0x00020935
--define_symbol sysSetPublicDeviceAddr=0x00020c9d
--define_symbol uuid128_to_str=0x00021291
--define_symbol uuid_add_bluetooth_prefix=0x000212e9
--define_symbol uuid_has_bluetooth_prefix=0x00021309
--define_symbol uxQueueMessagesWaiting=0x0002134d
--define_symbol uxQueueMessagesWaitingFromISR=0x00021375
--define_symbol uxQueueSpacesAvailable=0x00021391
--define_symbol uxTaskGetStackHighWaterMark=0x000213bd
--define_symbol vPortEnterCritical=0x000214c9
--define_symbol vPortExitCritical=0x0002150d
--define_symbol vPortFree=0x0002153d
--define_symbol vPortSuppressTicksAndSleep=0x000215d1
--define_symbol vPortValidateInterruptPriority=0x000216f1
--define_symbol vQueueDelete=0x00021749
--define_symbol vQueueWaitForMessageRestricted=0x00021775
--define_symbol vTaskDelay=0x000217bd
--define_symbol vTaskInternalSetTimeOutState=0x00021809
--define_symbol vTaskMissedYield=0x00021819
--define_symbol vTaskPlaceOnEventList=0x00021825
--define_symbol vTaskPlaceOnEventListRestricted=0x0002185d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002189d
