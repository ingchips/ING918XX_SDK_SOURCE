...
--define_symbol nibble_for_char=0x0001e121
--define_symbol platform_32k_rc_auto_tune=0x0001e1bd
--define_symbol platform_32k_rc_tune=0x0001e239
--define_symbol platform_calibrate_32k=0x0001e24d
--define_symbol platform_config=0x0001e251
--define_symbol platform_get_heap_status=0x0001e325
--define_symbol platform_get_task_handle=0x0001e33d
--define_symbol platform_get_us_time=0x0001e35d
--define_symbol platform_get_version=0x0001e361
--define_symbol platform_hrng=0x0001e369
--define_symbol platform_install_isr_stack=0x0001e371
--define_symbol platform_patch_rf_init_data=0x0001e37d
--define_symbol platform_printf=0x0001e389
--define_symbol platform_raise_assertion=0x0001e39d
--define_symbol platform_rand=0x0001e3b1
--define_symbol platform_read_info=0x0001e3b5
--define_symbol platform_read_persistent_reg=0x0001e3d1
--define_symbol platform_reset=0x0001e3e1
--define_symbol platform_set_evt_callback=0x0001e415
--define_symbol platform_set_irq_callback=0x0001e429
--define_symbol platform_set_rf_clk_source=0x0001e461
--define_symbol platform_set_rf_init_data=0x0001e46d
--define_symbol platform_set_rf_power_mapping=0x0001e479
--define_symbol platform_set_timer=0x0001e485
--define_symbol platform_shutdown=0x0001e489
--define_symbol platform_switch_app=0x0001e48d
--define_symbol platform_trace_raw=0x0001e4b9
--define_symbol platform_write_persistent_reg=0x0001e4d1
--define_symbol printf_hexdump=0x0001e4e1
--define_symbol pvPortMalloc=0x0001efed
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f0d5
--define_symbol pvTimerGetTimerID=0x0001f0ed
--define_symbol pxPortInitialiseStack=0x0001f119
--define_symbol reverse_128=0x0001f2f9
--define_symbol reverse_24=0x0001f2ff
--define_symbol reverse_48=0x0001f305
--define_symbol reverse_56=0x0001f30b
--define_symbol reverse_64=0x0001f311
--define_symbol reverse_bd_addr=0x0001f317
--define_symbol reverse_bytes=0x0001f31d
--define_symbol sm_add_event_handler=0x0001f5dd
--define_symbol sm_address_resolution_lookup=0x0001f735
--define_symbol sm_authenticated=0x0001fa8d
--define_symbol sm_authorization_decline=0x0001fa9b
--define_symbol sm_authorization_grant=0x0001fabb
--define_symbol sm_authorization_state=0x0001fadb
--define_symbol sm_bonding_decline=0x0001faf5
--define_symbol sm_config=0x0001ff15
--define_symbol sm_config_conn=0x0001ff2d
--define_symbol sm_encryption_key_size=0x000200e3
--define_symbol sm_just_works_confirm=0x000205ed
--define_symbol sm_le_device_key=0x00020929
--define_symbol sm_passkey_input=0x000209bf
--define_symbol sm_private_random_address_generation_get=0x00020d6d
--define_symbol sm_private_random_address_generation_get_mode=0x00020d75
--define_symbol sm_private_random_address_generation_set_mode=0x00020d81
--define_symbol sm_private_random_address_generation_set_update_period=0x00020da9
--define_symbol sm_register_oob_data_callback=0x00020ee5
--define_symbol sm_request_pairing=0x00020ef1
--define_symbol sm_send_security_request=0x0002190f
--define_symbol sm_set_accepted_stk_generation_methods=0x00021935
--define_symbol sm_set_authentication_requirements=0x00021941
--define_symbol sm_set_encryption_key_size_range=0x0002194d
--define_symbol sscanf_bd_addr=0x00021ca9
--define_symbol sysSetPublicDeviceAddr=0x00022011
--define_symbol uuid128_to_str=0x00022789
--define_symbol uuid_add_bluetooth_prefix=0x000227e1
--define_symbol uuid_has_bluetooth_prefix=0x00022801
--define_symbol uxListRemove=0x0002281d
--define_symbol uxQueueMessagesWaiting=0x00022845
--define_symbol uxQueueMessagesWaitingFromISR=0x0002286d
--define_symbol uxQueueSpacesAvailable=0x00022889
--define_symbol uxTaskGetStackHighWaterMark=0x000228b5
--define_symbol uxTaskPriorityGet=0x000228d5
--define_symbol uxTaskPriorityGetFromISR=0x000228f1
--define_symbol vListInitialise=0x000229a3
--define_symbol vListInitialiseItem=0x000229b9
--define_symbol vListInsert=0x000229bf
--define_symbol vListInsertEnd=0x000229ef
--define_symbol vPortEndScheduler=0x00022a09
--define_symbol vPortEnterCritical=0x00022a31
--define_symbol vPortExitCritical=0x00022a75
--define_symbol vPortFree=0x00022aa5
--define_symbol vPortSuppressTicksAndSleep=0x00022b39
--define_symbol vPortValidateInterruptPriority=0x00022c41
--define_symbol vQueueDelete=0x00022c99
--define_symbol vQueueWaitForMessageRestricted=0x00022cc5
--define_symbol vTaskDelay=0x00022d0d
--define_symbol vTaskInternalSetTimeOutState=0x00022d59
--define_symbol vTaskMissedYield=0x00022d69
--define_symbol vTaskPlaceOnEventList=0x00022d75
--define_symbol vTaskPlaceOnEventListRestricted=0x00022dad
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022ded
--define_symbol vTaskPrioritySet=0x00022e99
...
--define_symbol xTimerGetTimerDaemonTaskHandle=0x0002444d
