...
--define_symbol nibble_for_char=0x0001df55
--define_symbol platform_32k_rc_auto_tune=0x0001dff5
--define_symbol platform_32k_rc_tune=0x0001e071
--define_symbol platform_calibrate_32k=0x0001e085
--define_symbol platform_config=0x0001e089
--define_symbol platform_get_heap_status=0x0001e139
--define_symbol platform_get_us_time=0x0001e151
--define_symbol platform_get_version=0x0001e155
--define_symbol platform_hrng=0x0001e15d
--define_symbol platform_install_isr_stack=0x0001e165
--define_symbol platform_patch_rf_init_data=0x0001e171
--define_symbol platform_printf=0x0001e17d
--define_symbol platform_raise_assertion=0x0001e191
--define_symbol platform_rand=0x0001e1a5
--define_symbol platform_read_info=0x0001e1a9
--define_symbol platform_read_persistent_reg=0x0001e1c5
--define_symbol platform_reset=0x0001e1d5
--define_symbol platform_set_evt_callback=0x0001e209
--define_symbol platform_set_irq_callback=0x0001e21d
--define_symbol platform_set_rf_clk_source=0x0001e255
--define_symbol platform_set_rf_init_data=0x0001e261
--define_symbol platform_set_rf_power_mapping=0x0001e26d
...
--define_symbol platform_write_persistent_reg=0x0001e2bd
--define_symbol printf_hexdump=0x0001e2cd
--define_symbol pvPortMalloc=0x0001ed91
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ee79
--define_symbol pvTimerGetTimerID=0x0001ee91
--define_symbol pxPortInitialiseStack=0x0001eebd
--define_symbol reverse_128=0x0001f09d
--define_symbol reverse_24=0x0001f0a3
--define_symbol reverse_48=0x0001f0a9
--define_symbol reverse_56=0x0001f0af
--define_symbol reverse_64=0x0001f0b5
--define_symbol reverse_bd_addr=0x0001f0bb
--define_symbol reverse_bytes=0x0001f0c1
--define_symbol sm_add_event_handler=0x0001f361
--define_symbol sm_address_resolution_lookup=0x0001f48d
--define_symbol sm_authenticated=0x0001f567
--define_symbol sm_authorization_decline=0x0001f575
--define_symbol sm_authorization_grant=0x0001f595
--define_symbol sm_authorization_state=0x0001f5b5
--define_symbol sm_bonding_decline=0x0001f5d1
--define_symbol sm_config=0x0001f9a9
--define_symbol sm_encryption_key_size=0x0001fab5
--define_symbol sm_just_works_confirm=0x00020271
--define_symbol sm_le_device_key=0x000204c1
--define_symbol sm_passkey_input=0x00020559
--define_symbol sm_private_random_address_generation_get=0x000208e5
--define_symbol sm_private_random_address_generation_get_mode=0x000208ed
--define_symbol sm_private_random_address_generation_set_mode=0x000208f9
--define_symbol sm_private_random_address_generation_set_update_period=0x00020921
--define_symbol sm_register_oob_data_callback=0x00020959
--define_symbol sm_request_pairing=0x00020965
--define_symbol sm_send_security_request=0x0002139f
--define_symbol sm_set_accepted_stk_generation_methods=0x000213c5
--define_symbol sm_set_authentication_requirements=0x000213d1
--define_symbol sm_set_encryption_key_size_range=0x000213dd
--define_symbol sscanf_bd_addr=0x000216d9
--define_symbol sysSetPublicDeviceAddr=0x00021a3d
--define_symbol uuid128_to_str=0x00022171
--define_symbol uuid_add_bluetooth_prefix=0x000221c9
--define_symbol uuid_has_bluetooth_prefix=0x000221e9
--define_symbol uxQueueMessagesWaiting=0x0002222d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022255
--define_symbol uxQueueSpacesAvailable=0x00022271
--define_symbol uxTaskGetStackHighWaterMark=0x0002229d
--define_symbol vPortEnterCritical=0x00022355
--define_symbol vPortExitCritical=0x00022395
--define_symbol vPortFree=0x000223c1
--define_symbol vPortSuppressTicksAndSleep=0x00022455
--define_symbol vPortValidateInterruptPriority=0x0002252d
--define_symbol vQueueDelete=0x00022581
--define_symbol vQueueWaitForMessageRestricted=0x000225ad
--define_symbol vTaskDelay=0x000225f5
--define_symbol vTaskInternalSetTimeOutState=0x00022641
--define_symbol vTaskMissedYield=0x00022651
--define_symbol vTaskPlaceOnEventList=0x0002265d
--define_symbol vTaskPlaceOnEventListRestricted=0x00022695
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000226d5
--define_symbol vTaskStartScheduler=0x00022781
--define_symbol vTaskStepTick=0x00022811
--define_symbol vTaskSuspendAll=0x00022841
--define_symbol vTaskSwitchContext=0x00022851
--define_symbol xPortStartScheduler=0x000228f9
--define_symbol xQueueAddToSet=0x000229b5
--define_symbol xQueueCreateCountingSemaphore=0x000229d9
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a15
--define_symbol xQueueCreateMutex=0x00022a59
--define_symbol xQueueCreateMutexStatic=0x00022a6f
--define_symbol xQueueCreateSet=0x00022a89
--define_symbol xQueueGenericCreate=0x00022a91
--define_symbol xQueueGenericCreateStatic=0x00022add
--define_symbol xQueueGenericReset=0x00022b45
--define_symbol xQueueGenericSend=0x00022bd1
--define_symbol xQueueGenericSendFromISR=0x00022d3d
--define_symbol xQueueGiveFromISR=0x00022dfd
--define_symbol xQueueGiveMutexRecursive=0x00022ea1
--define_symbol xQueueIsQueueEmptyFromISR=0x00022ee1
--define_symbol xQueueIsQueueFullFromISR=0x00022f05
--define_symbol xQueuePeek=0x00022f2d
--define_symbol xQueuePeekFromISR=0x00023055
--define_symbol xQueueReceive=0x000230c1
--define_symbol xQueueReceiveFromISR=0x000231ed
--define_symbol xQueueRemoveFromSet=0x00023281
--define_symbol xQueueSelectFromSet=0x000232a3
--define_symbol xQueueSelectFromSetFromISR=0x000232b5
--define_symbol xQueueSemaphoreTake=0x000232c9
--define_symbol xQueueTakeMutexRecursive=0x00023435
--define_symbol xTaskCheckForTimeOut=0x00023479
--define_symbol xTaskCreate=0x000234e9
--define_symbol xTaskCreateStatic=0x00023545
--define_symbol xTaskGetCurrentTaskHandle=0x000235b5
--define_symbol xTaskGetSchedulerState=0x000235c1
--define_symbol xTaskGetTickCount=0x000235dd
--define_symbol xTaskGetTickCountFromISR=0x000235e9
--define_symbol xTaskIncrementTick=0x000235f9
--define_symbol xTaskPriorityDisinherit=0x000236c5
--define_symbol xTaskPriorityInherit=0x00023759
--define_symbol xTaskRemoveFromEventList=0x000237ed
--define_symbol xTaskResumeAll=0x0002386d
--define_symbol xTimerCreate=0x00023935
--define_symbol xTimerCreateStatic=0x00023969
--define_symbol xTimerCreateTimerTask=0x000239a1
--define_symbol xTimerGenericCommand=0x00023a0d
--define_symbol xTimerGetExpiryTime=0x00023a7d
