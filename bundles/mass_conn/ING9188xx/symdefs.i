...
--define_symbol nibble_for_char=0x0001e2d1
--define_symbol platform_32k_rc_auto_tune=0x0001e36d
--define_symbol platform_32k_rc_tune=0x0001e3e9
--define_symbol platform_calibrate_32k=0x0001e3fd
--define_symbol platform_config=0x0001e401
--define_symbol platform_get_heap_status=0x0001e4c1
--define_symbol platform_get_us_time=0x0001e4d9
--define_symbol platform_get_version=0x0001e4dd
--define_symbol platform_hrng=0x0001e4e5
--define_symbol platform_install_isr_stack=0x0001e4ed
--define_symbol platform_patch_rf_init_data=0x0001e4f9
--define_symbol platform_printf=0x0001e505
--define_symbol platform_raise_assertion=0x0001e519
--define_symbol platform_rand=0x0001e52d
--define_symbol platform_read_info=0x0001e531
--define_symbol platform_read_persistent_reg=0x0001e54d
--define_symbol platform_reset=0x0001e55d
--define_symbol platform_set_evt_callback=0x0001e591
--define_symbol platform_set_irq_callback=0x0001e5a5
--define_symbol platform_set_rf_clk_source=0x0001e5dd
--define_symbol platform_set_rf_init_data=0x0001e5e9
--define_symbol platform_set_rf_power_mapping=0x0001e5f5
--define_symbol platform_shutdown=0x0001e601
--define_symbol platform_switch_app=0x0001e605
--define_symbol platform_trace_raw=0x0001e631
--define_symbol platform_write_persistent_reg=0x0001e649
--define_symbol printf_hexdump=0x0001e659
--define_symbol pvPortMalloc=0x0001f165
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f24d
--define_symbol pvTimerGetTimerID=0x0001f265
--define_symbol pxPortInitialiseStack=0x0001f291
--define_symbol reverse_128=0x0001f471
--define_symbol reverse_24=0x0001f477
--define_symbol reverse_48=0x0001f47d
--define_symbol reverse_56=0x0001f483
--define_symbol reverse_64=0x0001f489
--define_symbol reverse_bd_addr=0x0001f48f
--define_symbol reverse_bytes=0x0001f495
--define_symbol sm_add_event_handler=0x0001f755
--define_symbol sm_address_resolution_lookup=0x0001f8ad
--define_symbol sm_authenticated=0x0001fbf9
--define_symbol sm_authorization_decline=0x0001fc07
--define_symbol sm_authorization_grant=0x0001fc27
--define_symbol sm_authorization_state=0x0001fc47
--define_symbol sm_bonding_decline=0x0001fc61
--define_symbol sm_config=0x00020081
--define_symbol sm_config_conn=0x00020099
--define_symbol sm_encryption_key_size=0x0002021f
--define_symbol sm_just_works_confirm=0x0002074d
--define_symbol sm_le_device_key=0x00020a89
--define_symbol sm_passkey_input=0x00020b1f
--define_symbol sm_private_random_address_generation_get=0x00020ec5
--define_symbol sm_private_random_address_generation_get_mode=0x00020ecd
--define_symbol sm_private_random_address_generation_set_mode=0x00020ed9
--define_symbol sm_private_random_address_generation_set_update_period=0x00020f01
--define_symbol sm_register_oob_data_callback=0x0002103d
--define_symbol sm_request_pairing=0x00021049
...
--define_symbol sscanf_bd_addr=0x00021ddd
--define_symbol sysSetPublicDeviceAddr=0x00022145
--define_symbol uuid128_to_str=0x000228c9
--define_symbol uuid_add_bluetooth_prefix=0x00022921
--define_symbol uuid_has_bluetooth_prefix=0x00022941
--define_symbol uxQueueMessagesWaiting=0x00022985
--define_symbol uxQueueMessagesWaitingFromISR=0x000229ad
--define_symbol uxQueueSpacesAvailable=0x000229c9
--define_symbol uxTaskGetStackHighWaterMark=0x000229f5
--define_symbol vPortEnterCritical=0x00022b01
--define_symbol vPortExitCritical=0x00022b45
--define_symbol vPortFree=0x00022b75
--define_symbol vPortSuppressTicksAndSleep=0x00022c09
--define_symbol vPortValidateInterruptPriority=0x00022d29
--define_symbol vQueueDelete=0x00022d81
--define_symbol vQueueWaitForMessageRestricted=0x00022dad
--define_symbol vTaskDelay=0x00022df5
--define_symbol vTaskInternalSetTimeOutState=0x00022e41
--define_symbol vTaskMissedYield=0x00022e51
--define_symbol vTaskPlaceOnEventList=0x00022e5d
--define_symbol vTaskPlaceOnEventListRestricted=0x00022e95
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022ed5
--define_symbol vTaskResume=0x00022f81
--define_symbol vTaskStartScheduler=0x00023005
--define_symbol vTaskStepTick=0x00023095
--define_symbol vTaskSuspend=0x000230c5
--define_symbol vTaskSuspendAll=0x00023181
--define_symbol vTaskSwitchContext=0x00023191
--define_symbol xPortStartScheduler=0x00023239
--define_symbol xQueueAddToSet=0x000232fd
--define_symbol xQueueCreateCountingSemaphore=0x00023321
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002335d
--define_symbol xQueueCreateMutex=0x000233a1
--define_symbol xQueueCreateMutexStatic=0x000233b7
--define_symbol xQueueCreateSet=0x000233d1
--define_symbol xQueueGenericCreate=0x000233d9
--define_symbol xQueueGenericCreateStatic=0x00023425
--define_symbol xQueueGenericReset=0x0002348d
--define_symbol xQueueGenericSend=0x00023519
--define_symbol xQueueGenericSendFromISR=0x00023685
--define_symbol xQueueGiveFromISR=0x00023745
--define_symbol xQueueGiveMutexRecursive=0x000237e9
--define_symbol xQueueIsQueueEmptyFromISR=0x00023829
--define_symbol xQueueIsQueueFullFromISR=0x0002384d
--define_symbol xQueuePeek=0x00023875
--define_symbol xQueuePeekFromISR=0x0002399d
--define_symbol xQueueReceive=0x00023a09
--define_symbol xQueueReceiveFromISR=0x00023b35
--define_symbol xQueueRemoveFromSet=0x00023bc9
--define_symbol xQueueSelectFromSet=0x00023beb
--define_symbol xQueueSelectFromSetFromISR=0x00023bfd
--define_symbol xQueueSemaphoreTake=0x00023c11
--define_symbol xQueueTakeMutexRecursive=0x00023d7d
--define_symbol xTaskCheckForTimeOut=0x00023dc1
--define_symbol xTaskCreate=0x00023e31
--define_symbol xTaskCreateStatic=0x00023e8d
--define_symbol xTaskGetCurrentTaskHandle=0x00023efd
--define_symbol xTaskGetSchedulerState=0x00023f09
--define_symbol xTaskGetTickCount=0x00023f25
--define_symbol xTaskGetTickCountFromISR=0x00023f31
--define_symbol xTaskIncrementTick=0x00023f41
--define_symbol xTaskPriorityDisinherit=0x0002400d
--define_symbol xTaskPriorityInherit=0x000240a1
--define_symbol xTaskRemoveFromEventList=0x00024135
--define_symbol xTaskResumeAll=0x000241b5
--define_symbol xTaskResumeFromISR=0x0002427d
--define_symbol xTimerCreate=0x00024309
--define_symbol xTimerCreateStatic=0x0002433d
--define_symbol xTimerCreateTimerTask=0x00024375
--define_symbol xTimerGenericCommand=0x000243e1
--define_symbol xTimerGetExpiryTime=0x00024451
