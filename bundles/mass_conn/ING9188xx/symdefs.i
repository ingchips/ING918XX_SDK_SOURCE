...
--define_symbol sm_just_works_confirm=0x00020495
--define_symbol sm_le_device_key=0x000206ed
--define_symbol sm_passkey_input=0x00020785
--define_symbol sm_private_random_address_generation_get=0x00020b11
--define_symbol sm_private_random_address_generation_get_mode=0x00020b19
--define_symbol sm_private_random_address_generation_set_mode=0x00020b25
--define_symbol sm_private_random_address_generation_set_update_period=0x00020b4d
--define_symbol sm_register_oob_data_callback=0x00020b85
--define_symbol sm_request_pairing=0x00020b91
--define_symbol sm_send_security_request=0x000215e1
--define_symbol sm_set_accepted_stk_generation_methods=0x00021609
--define_symbol sm_set_authentication_requirements=0x00021615
--define_symbol sm_set_encryption_key_size_range=0x00021621
--define_symbol sscanf_bd_addr=0x00021911
--define_symbol sysSetPublicDeviceAddr=0x00021c3d
--define_symbol uuid128_to_str=0x00022371
--define_symbol uuid_add_bluetooth_prefix=0x000223c9
--define_symbol uuid_has_bluetooth_prefix=0x000223e9
--define_symbol uxQueueMessagesWaiting=0x0002242d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022455
--define_symbol uxQueueSpacesAvailable=0x00022471
--define_symbol uxTaskGetStackHighWaterMark=0x0002249d
--define_symbol vPortEnterCritical=0x000225c1
--define_symbol vPortExitCritical=0x00022601
--define_symbol vPortFree=0x0002262d
--define_symbol vPortSuppressTicksAndSleep=0x000226c1
--define_symbol vPortValidateInterruptPriority=0x00022799
--define_symbol vQueueDelete=0x000227ed
--define_symbol vQueueWaitForMessageRestricted=0x00022819
--define_symbol vTaskDelay=0x00022861
--define_symbol vTaskInternalSetTimeOutState=0x000228ad
--define_symbol vTaskMissedYield=0x000228bd
--define_symbol vTaskPlaceOnEventList=0x000228c9
--define_symbol vTaskPlaceOnEventListRestricted=0x00022901
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022941
--define_symbol vTaskStartScheduler=0x000229ed
--define_symbol vTaskStepTick=0x00022a7d
--define_symbol vTaskSuspendAll=0x00022aad
--define_symbol vTaskSwitchContext=0x00022abd
--define_symbol xPortStartScheduler=0x00022b65
--define_symbol xQueueAddToSet=0x00022c21
--define_symbol xQueueCreateCountingSemaphore=0x00022c45
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022c81
--define_symbol xQueueCreateMutex=0x00022cc5
--define_symbol xQueueCreateMutexStatic=0x00022cdb
--define_symbol xQueueCreateSet=0x00022cf5
--define_symbol xQueueGenericCreate=0x00022cfd
--define_symbol xQueueGenericCreateStatic=0x00022d49
--define_symbol xQueueGenericReset=0x00022db1
--define_symbol xQueueGenericSend=0x00022e3d
--define_symbol xQueueGenericSendFromISR=0x00022fa9
--define_symbol xQueueGiveFromISR=0x00023069
--define_symbol xQueueGiveMutexRecursive=0x0002310d
--define_symbol xQueueIsQueueEmptyFromISR=0x0002314d
--define_symbol xQueueIsQueueFullFromISR=0x00023171
--define_symbol xQueuePeek=0x00023199
--define_symbol xQueuePeekFromISR=0x000232c1
--define_symbol xQueueReceive=0x0002332d
--define_symbol xQueueReceiveFromISR=0x00023459
--define_symbol xQueueRemoveFromSet=0x000234ed
--define_symbol xQueueSelectFromSet=0x0002350f
--define_symbol xQueueSelectFromSetFromISR=0x00023521
--define_symbol xQueueSemaphoreTake=0x00023535
--define_symbol xQueueTakeMutexRecursive=0x000236a1
--define_symbol xTaskCheckForTimeOut=0x000236e5
--define_symbol xTaskCreate=0x00023755
--define_symbol xTaskCreateStatic=0x000237b1
--define_symbol xTaskGetCurrentTaskHandle=0x00023821
--define_symbol xTaskGetSchedulerState=0x0002382d
--define_symbol xTaskGetTickCount=0x00023849
--define_symbol xTaskGetTickCountFromISR=0x00023855
--define_symbol xTaskIncrementTick=0x00023865
--define_symbol xTaskPriorityDisinherit=0x00023931
--define_symbol xTaskPriorityInherit=0x000239c5
--define_symbol xTaskRemoveFromEventList=0x00023a59
--define_symbol xTaskResumeAll=0x00023ad9
--define_symbol xTimerCreate=0x00023ba1
--define_symbol xTimerCreateStatic=0x00023bd5
--define_symbol xTimerCreateTimerTask=0x00023c0d
--define_symbol xTimerGenericCommand=0x00023c79
--define_symbol xTimerGetExpiryTime=0x00023ce9
