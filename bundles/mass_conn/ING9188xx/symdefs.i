...
--define_symbol ll_malloc=0x0000d0b1
--define_symbol ll_query_timing_info=0x0000d1e9
--define_symbol ll_set_adv_coded_scheme=0x0000d395
--define_symbol ll_set_conn_coded_scheme=0x0000d3c5
--define_symbol ll_set_conn_latency=0x0000d3f1
--define_symbol ll_set_conn_tx_power=0x0000d421
--define_symbol ll_set_def_antenna=0x0000d469
--define_symbol ll_set_initiating_coded_scheme=0x0000d485
--define_symbol ll_set_max_conn_number=0x0000d491
--define_symbol nibble_for_char=0x0001df4d
--define_symbol platform_32k_rc_auto_tune=0x0001dfed
--define_symbol platform_32k_rc_tune=0x0001e069
--define_symbol platform_calibrate_32k=0x0001e07d
--define_symbol platform_config=0x0001e081
--define_symbol platform_get_heap_status=0x0001e131
--define_symbol platform_get_us_time=0x0001e149
--define_symbol platform_get_version=0x0001e14d
--define_symbol platform_hrng=0x0001e155
--define_symbol platform_install_isr_stack=0x0001e15d
--define_symbol platform_patch_rf_init_data=0x0001e169
--define_symbol platform_printf=0x0001e175
--define_symbol platform_raise_assertion=0x0001e189
--define_symbol platform_rand=0x0001e19d
--define_symbol platform_read_info=0x0001e1a1
--define_symbol platform_read_persistent_reg=0x0001e1bd
--define_symbol platform_reset=0x0001e1cd
--define_symbol platform_set_evt_callback=0x0001e201
--define_symbol platform_set_irq_callback=0x0001e215
--define_symbol platform_set_rf_clk_source=0x0001e24d
--define_symbol platform_set_rf_init_data=0x0001e259
--define_symbol platform_set_rf_power_mapping=0x0001e265
--define_symbol platform_shutdown=0x0001e271
--define_symbol platform_switch_app=0x0001e275
--define_symbol platform_trace_raw=0x0001e2a1
--define_symbol platform_write_persistent_reg=0x0001e2b5
--define_symbol printf_hexdump=0x0001e2c5
--define_symbol pvPortMalloc=0x0001ed89
--define_symbol pvTaskIncrementMutexHeldCount=0x0001ee71
--define_symbol pvTimerGetTimerID=0x0001ee89
--define_symbol pxPortInitialiseStack=0x0001eeb5
--define_symbol reverse_128=0x0001f095
--define_symbol reverse_24=0x0001f09b
--define_symbol reverse_48=0x0001f0a1
--define_symbol reverse_56=0x0001f0a7
--define_symbol reverse_64=0x0001f0ad
--define_symbol reverse_bd_addr=0x0001f0b3
--define_symbol reverse_bytes=0x0001f0b9
--define_symbol sm_add_event_handler=0x0001f359
--define_symbol sm_address_resolution_lookup=0x0001f485
--define_symbol sm_authenticated=0x0001f55f
--define_symbol sm_authorization_decline=0x0001f56d
--define_symbol sm_authorization_grant=0x0001f58d
--define_symbol sm_authorization_state=0x0001f5ad
--define_symbol sm_bonding_decline=0x0001f5c9
--define_symbol sm_config=0x0001f9a1
--define_symbol sm_encryption_key_size=0x0001faad
--define_symbol sm_just_works_confirm=0x00020269
--define_symbol sm_le_device_key=0x000204b9
--define_symbol sm_passkey_input=0x00020551
--define_symbol sm_private_random_address_generation_get=0x000208dd
--define_symbol sm_private_random_address_generation_get_mode=0x000208e5
--define_symbol sm_private_random_address_generation_set_mode=0x000208f1
--define_symbol sm_private_random_address_generation_set_update_period=0x00020919
--define_symbol sm_register_oob_data_callback=0x00020951
--define_symbol sm_request_pairing=0x0002095d
--define_symbol sm_send_security_request=0x00021397
--define_symbol sm_set_accepted_stk_generation_methods=0x000213bd
--define_symbol sm_set_authentication_requirements=0x000213c9
--define_symbol sm_set_encryption_key_size_range=0x000213d5
--define_symbol sscanf_bd_addr=0x000216d1
--define_symbol sysSetPublicDeviceAddr=0x00021a35
--define_symbol uuid128_to_str=0x00022169
--define_symbol uuid_add_bluetooth_prefix=0x000221c1
--define_symbol uuid_has_bluetooth_prefix=0x000221e1
--define_symbol uxQueueMessagesWaiting=0x00022225
--define_symbol uxQueueMessagesWaitingFromISR=0x0002224d
--define_symbol uxQueueSpacesAvailable=0x00022269
--define_symbol uxTaskGetStackHighWaterMark=0x00022295
--define_symbol vPortEnterCritical=0x0002234d
--define_symbol vPortExitCritical=0x0002238d
--define_symbol vPortFree=0x000223b9
--define_symbol vPortSuppressTicksAndSleep=0x0002244d
--define_symbol vPortValidateInterruptPriority=0x00022525
--define_symbol vQueueDelete=0x00022579
--define_symbol vQueueWaitForMessageRestricted=0x000225a5
--define_symbol vTaskDelay=0x000225ed
--define_symbol vTaskInternalSetTimeOutState=0x00022639
--define_symbol vTaskMissedYield=0x00022649
--define_symbol vTaskPlaceOnEventList=0x00022655
--define_symbol vTaskPlaceOnEventListRestricted=0x0002268d
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x000226cd
--define_symbol vTaskStartScheduler=0x00022779
--define_symbol vTaskStepTick=0x00022809
--define_symbol vTaskSuspendAll=0x00022839
--define_symbol vTaskSwitchContext=0x00022849
--define_symbol xPortStartScheduler=0x000228f1
--define_symbol xQueueAddToSet=0x000229ad
--define_symbol xQueueCreateCountingSemaphore=0x000229d1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a0d
--define_symbol xQueueCreateMutex=0x00022a51
--define_symbol xQueueCreateMutexStatic=0x00022a67
--define_symbol xQueueCreateSet=0x00022a81
--define_symbol xQueueGenericCreate=0x00022a89
--define_symbol xQueueGenericCreateStatic=0x00022ad5
--define_symbol xQueueGenericReset=0x00022b3d
--define_symbol xQueueGenericSend=0x00022bc9
--define_symbol xQueueGenericSendFromISR=0x00022d35
--define_symbol xQueueGiveFromISR=0x00022df5
--define_symbol xQueueGiveMutexRecursive=0x00022e99
--define_symbol xQueueIsQueueEmptyFromISR=0x00022ed9
--define_symbol xQueueIsQueueFullFromISR=0x00022efd
--define_symbol xQueuePeek=0x00022f25
--define_symbol xQueuePeekFromISR=0x0002304d
--define_symbol xQueueReceive=0x000230b9
--define_symbol xQueueReceiveFromISR=0x000231e5
--define_symbol xQueueRemoveFromSet=0x00023279
--define_symbol xQueueSelectFromSet=0x0002329b
--define_symbol xQueueSelectFromSetFromISR=0x000232ad
--define_symbol xQueueSemaphoreTake=0x000232c1
--define_symbol xQueueTakeMutexRecursive=0x0002342d
--define_symbol xTaskCheckForTimeOut=0x00023471
--define_symbol xTaskCreate=0x000234e1
--define_symbol xTaskCreateStatic=0x0002353d
--define_symbol xTaskGetCurrentTaskHandle=0x000235ad
--define_symbol xTaskGetSchedulerState=0x000235b9
--define_symbol xTaskGetTickCount=0x000235d5
--define_symbol xTaskGetTickCountFromISR=0x000235e1
--define_symbol xTaskIncrementTick=0x000235f1
--define_symbol xTaskPriorityDisinherit=0x000236bd
--define_symbol xTaskPriorityInherit=0x00023751
--define_symbol xTaskRemoveFromEventList=0x000237e5
--define_symbol xTaskResumeAll=0x00023865
--define_symbol xTimerCreate=0x0002392d
--define_symbol xTimerCreateStatic=0x00023961
--define_symbol xTimerCreateTimerTask=0x00023999
--define_symbol xTimerGenericCommand=0x00023a05
--define_symbol xTimerGetExpiryTime=0x00023a75
