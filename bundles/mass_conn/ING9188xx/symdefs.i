...
--define_symbol sysSetPublicDeviceAddr=0x00021aad
--define_symbol uuid128_to_str=0x000221e1
--define_symbol uuid_add_bluetooth_prefix=0x00022239
--define_symbol uuid_has_bluetooth_prefix=0x00022259
--define_symbol uxQueueMessagesWaiting=0x0002229d
--define_symbol uxQueueMessagesWaitingFromISR=0x000222c5
--define_symbol uxQueueSpacesAvailable=0x000222e1
--define_symbol uxTaskGetStackHighWaterMark=0x0002230d
--define_symbol vPortEnterCritical=0x000223c5
--define_symbol vPortExitCritical=0x00022405
--define_symbol vPortFree=0x00022431
--define_symbol vPortSuppressTicksAndSleep=0x000224c5
--define_symbol vPortValidateInterruptPriority=0x0002259d
...
--define_symbol vTaskStartScheduler=0x000227f1
--define_symbol vTaskStepTick=0x00022881
...
--define_symbol xQueueAddToSet=0x00022a25
--define_symbol xQueueCreateCountingSemaphore=0x00022a49
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a85
--define_symbol xQueueCreateMutex=0x00022ac9
--define_symbol xQueueCreateMutexStatic=0x00022adf
--define_symbol xQueueCreateSet=0x00022af9
--define_symbol xQueueGenericCreate=0x00022b01
--define_symbol xQueueGenericCreateStatic=0x00022b4d
--define_symbol xQueueGenericReset=0x00022bb5
--define_symbol xQueueGenericSend=0x00022c41
--define_symbol xQueueGenericSendFromISR=0x00022dad
--define_symbol xQueueGiveFromISR=0x00022e6d
--define_symbol xQueueGiveMutexRecursive=0x00022f11
--define_symbol xQueueIsQueueEmptyFromISR=0x00022f51
--define_symbol xQueueIsQueueFullFromISR=0x00022f75
--define_symbol xQueuePeek=0x00022f9d
--define_symbol xQueuePeekFromISR=0x000230c5
--define_symbol xQueueReceive=0x00023131
--define_symbol xQueueReceiveFromISR=0x0002325d
--define_symbol xQueueRemoveFromSet=0x000232f1
--define_symbol xQueueSelectFromSet=0x00023313
--define_symbol xQueueSelectFromSetFromISR=0x00023325
--define_symbol xQueueSemaphoreTake=0x00023339
--define_symbol xQueueTakeMutexRecursive=0x000234a5
--define_symbol xTaskCheckForTimeOut=0x000234e9
--define_symbol xTaskCreate=0x00023559
--define_symbol xTaskCreateStatic=0x000235b5
--define_symbol xTaskGetCurrentTaskHandle=0x00023625
--define_symbol xTaskGetSchedulerState=0x00023631
--define_symbol xTaskGetTickCount=0x0002364d
--define_symbol xTaskGetTickCountFromISR=0x00023659
--define_symbol xTaskIncrementTick=0x00023669
--define_symbol xTaskPriorityDisinherit=0x00023735
--define_symbol xTaskPriorityInherit=0x000237c9
--define_symbol xTaskRemoveFromEventList=0x0002385d
--define_symbol xTaskResumeAll=0x000238dd
--define_symbol xTimerCreate=0x000239a5
--define_symbol xTimerCreateStatic=0x000239d9
--define_symbol xTimerCreateTimerTask=0x00023a11
--define_symbol xTimerGenericCommand=0x00023a7d
--define_symbol xTimerGetExpiryTime=0x00023aed
