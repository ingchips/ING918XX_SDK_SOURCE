...
--define_symbol sm_config=0x0001fec5
--define_symbol sm_config_conn=0x0001fedd
--define_symbol sm_encryption_key_size=0x00020093
--define_symbol sm_just_works_confirm=0x000205cd
--define_symbol sm_le_device_key=0x00020909
--define_symbol sm_passkey_input=0x0002099f
--define_symbol sm_private_random_address_generation_get=0x00020d4d
--define_symbol sm_private_random_address_generation_get_mode=0x00020d55
--define_symbol sm_private_random_address_generation_set_mode=0x00020d61
--define_symbol sm_private_random_address_generation_set_update_period=0x00020d89
--define_symbol sm_register_oob_data_callback=0x00020ec5
--define_symbol sm_request_pairing=0x00020ed1
...
--define_symbol sscanf_bd_addr=0x00021c65
--define_symbol sysSetPublicDeviceAddr=0x00021fcd
...
--define_symbol vPortEnterCritical=0x000229d5
--define_symbol vPortExitCritical=0x00022a19
--define_symbol vPortFree=0x00022a49
--define_symbol vPortSuppressTicksAndSleep=0x00022add
--define_symbol vPortValidateInterruptPriority=0x00022bfd
--define_symbol vQueueDelete=0x00022c55
--define_symbol vQueueWaitForMessageRestricted=0x00022c81
--define_symbol vTaskDelay=0x00022cc9
--define_symbol vTaskInternalSetTimeOutState=0x00022d15
--define_symbol vTaskMissedYield=0x00022d25
--define_symbol vTaskPlaceOnEventList=0x00022d31
--define_symbol vTaskPlaceOnEventListRestricted=0x00022d69
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022da9
--define_symbol vTaskPrioritySet=0x00022e55
--define_symbol vTaskResume=0x00022f1d
--define_symbol vTaskStartScheduler=0x00022fa1
--define_symbol vTaskStepTick=0x00023031
--define_symbol vTaskSuspend=0x00023061
--define_symbol vTaskSuspendAll=0x0002311d
--define_symbol vTaskSwitchContext=0x0002312d
--define_symbol xPortStartScheduler=0x000231d5
