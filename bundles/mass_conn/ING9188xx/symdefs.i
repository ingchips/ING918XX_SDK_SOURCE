...
--define_symbol platform_32k_rc_auto_tune=0x0001e04d
--define_symbol platform_32k_rc_tune=0x0001e0c9
--define_symbol platform_calibrate_32k=0x0001e0dd
--define_symbol platform_config=0x0001e0e1
--define_symbol platform_get_heap_status=0x0001e191
--define_symbol platform_get_us_time=0x0001e1a9
--define_symbol platform_get_version=0x0001e1ad
--define_symbol platform_hrng=0x0001e1b5
--define_symbol platform_install_isr_stack=0x0001e1bd
--define_symbol platform_patch_rf_init_data=0x0001e1c9
--define_symbol platform_printf=0x0001e1d5
--define_symbol platform_raise_assertion=0x0001e1e9
--define_symbol platform_rand=0x0001e1fd
--define_symbol platform_read_info=0x0001e201
--define_symbol platform_read_persistent_reg=0x0001e21d
--define_symbol platform_reset=0x0001e22d
--define_symbol platform_set_evt_callback=0x0001e261
--define_symbol platform_set_irq_callback=0x0001e275
--define_symbol platform_set_rf_clk_source=0x0001e2ad
--define_symbol platform_set_rf_init_data=0x0001e2b9
--define_symbol platform_set_rf_power_mapping=0x0001e2c5
...
--define_symbol platform_write_persistent_reg=0x0001e315
--define_symbol printf_hexdump=0x0001e325
--define_symbol pvPortMalloc=0x0001ede9
--define_symbol pvTaskIncrementMutexHeldCount=0x0001eed1
--define_symbol pvTimerGetTimerID=0x0001eee9
--define_symbol pxPortInitialiseStack=0x0001ef15
--define_symbol reverse_128=0x0001f0f5
--define_symbol reverse_24=0x0001f0fb
--define_symbol reverse_48=0x0001f101
--define_symbol reverse_56=0x0001f107
--define_symbol reverse_64=0x0001f10d
--define_symbol reverse_bd_addr=0x0001f113
--define_symbol reverse_bytes=0x0001f119
...
--define_symbol sysSetPublicDeviceAddr=0x00021a81
--define_symbol uuid128_to_str=0x000221b5
--define_symbol uuid_add_bluetooth_prefix=0x0002220d
--define_symbol uuid_has_bluetooth_prefix=0x0002222d
--define_symbol uxQueueMessagesWaiting=0x00022271
--define_symbol uxQueueMessagesWaitingFromISR=0x00022299
--define_symbol uxQueueSpacesAvailable=0x000222b5
--define_symbol uxTaskGetStackHighWaterMark=0x000222e1
--define_symbol vPortEnterCritical=0x00022399
--define_symbol vPortExitCritical=0x000223d9
--define_symbol vPortFree=0x00022405
--define_symbol vPortSuppressTicksAndSleep=0x00022499
--define_symbol vPortValidateInterruptPriority=0x00022571
--define_symbol vQueueDelete=0x000225c5
--define_symbol vQueueWaitForMessageRestricted=0x000225f1
--define_symbol vTaskDelay=0x00022639
--define_symbol vTaskInternalSetTimeOutState=0x00022685
--define_symbol vTaskMissedYield=0x00022695
--define_symbol vTaskPlaceOnEventList=0x000226a1
--define_symbol vTaskPlaceOnEventListRestricted=0x000226d9
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00022719
--define_symbol vTaskStartScheduler=0x000227c5
--define_symbol vTaskStepTick=0x00022855
--define_symbol vTaskSuspendAll=0x00022885
--define_symbol vTaskSwitchContext=0x00022895
--define_symbol xPortStartScheduler=0x0002293d
--define_symbol xQueueAddToSet=0x000229f9
--define_symbol xQueueCreateCountingSemaphore=0x00022a1d
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00022a59
--define_symbol xQueueCreateMutex=0x00022a9d
--define_symbol xQueueCreateMutexStatic=0x00022ab3
--define_symbol xQueueCreateSet=0x00022acd
--define_symbol xQueueGenericCreate=0x00022ad5
--define_symbol xQueueGenericCreateStatic=0x00022b21
--define_symbol xQueueGenericReset=0x00022b89
--define_symbol xQueueGenericSend=0x00022c15
--define_symbol xQueueGenericSendFromISR=0x00022d81
--define_symbol xQueueGiveFromISR=0x00022e41
--define_symbol xQueueGiveMutexRecursive=0x00022ee5
--define_symbol xQueueIsQueueEmptyFromISR=0x00022f25
--define_symbol xQueueIsQueueFullFromISR=0x00022f49
--define_symbol xQueuePeek=0x00022f71
--define_symbol xQueuePeekFromISR=0x00023099
--define_symbol xQueueReceive=0x00023105
--define_symbol xQueueReceiveFromISR=0x00023231
--define_symbol xQueueRemoveFromSet=0x000232c5
--define_symbol xQueueSelectFromSet=0x000232e7
--define_symbol xQueueSelectFromSetFromISR=0x000232f9
--define_symbol xQueueSemaphoreTake=0x0002330d
--define_symbol xQueueTakeMutexRecursive=0x00023479
--define_symbol xTaskCheckForTimeOut=0x000234bd
--define_symbol xTaskCreate=0x0002352d
--define_symbol xTaskCreateStatic=0x00023589
--define_symbol xTaskGetCurrentTaskHandle=0x000235f9
--define_symbol xTaskGetSchedulerState=0x00023605
--define_symbol xTaskGetTickCount=0x00023621
--define_symbol xTaskGetTickCountFromISR=0x0002362d
--define_symbol xTaskIncrementTick=0x0002363d
--define_symbol xTaskPriorityDisinherit=0x00023709
--define_symbol xTaskPriorityInherit=0x0002379d
--define_symbol xTaskRemoveFromEventList=0x00023831
--define_symbol xTaskResumeAll=0x000238b1
--define_symbol xTimerCreate=0x00023979
--define_symbol xTimerCreateStatic=0x000239ad
--define_symbol xTimerCreateTimerTask=0x000239e5
--define_symbol xTimerGenericCommand=0x00023a51
--define_symbol xTimerGetExpiryTime=0x00023ac1
